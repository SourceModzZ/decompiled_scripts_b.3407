...
BOOL func_21(Ped pedParam0) // Position - 0xB8F
{
...
void func_22(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xBC0
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xC90
{
	Hash statName;
...
void func_37(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEA7
{
	if (bParam0)
	{
...
int func_39(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1010
{
	int num;
...
void func_49(BOOL bParam0) // Position - 0x1275
{
	int i;
...
void func_61(Vehicle veParam0) // Position - 0x14D8
{
...
BOOL func_62(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1574
{
	int i;
	int num;
	Ped ped;
...
Ped func_64(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1661
{
	Ped pedInVehicleSeat;
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A34
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C24
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2186
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Vehicle veParam0) // Position - 0x2196
{
	Hash entityModel;
...
BOOL func_80(Hash hParam0) // Position - 0x21DC
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_81(Hash hParam0) // Position - 0x2286
{
	return func_139(hParam0) && !func_82(hParam0);
}

BOOL func_82(Hash hParam0) // Position - 0x22A0
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x22D5
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x23DC
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Position - 0x2467
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24A8
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Position - 0x250D
{
	int i;
...
BOOL func_88(int iParam0) // Position - 0x2548
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2558
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x25B8
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x25E7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x25FC
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x2630
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x29E7
{
	return Global_33105;
}

int func_95(int iParam0) // Position - 0x29F2
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_96() // Position - 0x2D35
{
	return Global_101765.f_400 > 0;
}

int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2D46
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2DC3
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2E50
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2EAC
{
	func_104();
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3157
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3180
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8F4C
{
	if (bParam6)
...
BOOL func_105(Vehicle veParam0) // Position - 0x900C
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x9044
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x908C
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x91E9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x9534
{
...
int func_110(Player plParam0) // Position - 0x9560
{
...
int func_111(Player plParam0) // Position - 0x957D
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x95A0
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x95E4
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
BOOL func_115(BOOL bParam0) // Position - 0x961D
{
	return func_116(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x962F
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x9640
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x969C
{
	if (func_11(plParam0))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x96EB
{
	int num;
	int num2;
...
int func_120(int iParam0) // Position - 0x9749
{
	return iParam0 % 32;
}

int func_121(int iParam0) // Position - 0x9756
{
	int num;
...
int func_122(int iParam0) // Position - 0x976D
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x979A
{
	return iParam0 / 32;
}

BOOL func_124(Player plParam0) // Position - 0x97A7
{
...
BOOL func_125(Player plParam0) // Position - 0x97DC
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_126(int iParam0) // Position - 0x9823
{
	switch (iParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9D58
{
	int num;
	int num2;
...
BOOL func_128(int iParam0, var uParam1) // Position - 0x9D79
{
	*uParam1 = -1;
...
int func_129(int iParam0) // Position - 0xA03B
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0xA0D9
{
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA303
{
	var gamerHandle;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA318
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA339
{
	*uParam1 = -1f;
...
void func_135(Vehicle veParam0) // Position - 0xA63A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA66C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA6A0
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA6BD
{
...
BOOL func_139(Hash hParam0) // Position - 0xAC0E
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAC9D
{
	int num;
	int num2;
	int i;
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xB3A0
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xB411
{
	if (bParam0)
...
BOOL func_144(int iParam0) // Position - 0xB4BA
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xB4DE
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xB4FC
{
	return IS_BIT_SET(Global_1887694[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_147(int iParam0) // Position - 0xB514
{
	return func_148(&(Global_2672942.f_194), iParam0);
}

BOOL func_148(var uParam0, int iParam1) // Position - 0xB528
{
	int num;
	int num2;
	int num3;
...
int func_149(var uParam0, var uParam1, var uParam2) // Position - 0xB54B
{
	int i;
	int modType;
...
BOOL func_150(Vehicle veParam0) // Position - 0xB749
{
	int i;
	int modType;
	Hash hashKey;
...
void func_151(var uParam0) // Position - 0xB823
{
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xB88E
{
	int value;
	int value2;
	float num;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xB977
{
	int i;
...
BOOL func_154(Hash hParam0) // Position - 0xB9D9
{
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xBA04
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBDE3
{
...
BOOL func_157() // Position - 0xBE07
{
	return true;
}

void func_158(Vehicle veParam0, int iParam1) // Position - 0xBE14
{
	int vehicleMod;
...
BOOL func_159(int iParam0) // Position - 0xBE8C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160() // Position - 0xBEAC
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_161(Vehicle veParam0) // Position - 0xBEBD
{
	int _int;
...
int func_162(var uParam0) // Position - 0xBF02
{
...
BOOL func_163(int iParam0) // Position - 0xBF22
{
	switch (iParam0)
	{
		case 161:
...
int func_164(int iParam0) // Position - 0xBF75
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_165(Vehicle veParam0) // Position - 0xC027
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC0AE
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC0FB
{
...
void func_168(var uParam0) // Position - 0xC11C
{
...
void func_169(var uParam0) // Position - 0xC16A
{
...
Vector3 func_170(float fParam0, var uParam1, var uParam2) // Position - 0xC224
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_171(var uParam0) // Position - 0xC251
{
	Player player;
...
void func_172(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC329
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_173(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC492
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_174(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD769
{
	Hash entityModel;
	int num;
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xDF8F
{
	int num;
	int num2;
...
int func_176(int iParam0, int iParam1) // Position - 0xDFCE
{
	int num;
	int num2;
...
int func_177() // Position - 0xE014
{
	return Global_33106;
}

int func_178(int iParam0) // Position - 0xE01F
{
	int num;
	int num2;
...
char* func_179(int iParam0) // Position - 0xE3C0
{
	switch (iParam0)
	{
		case 0:
...
int func_180(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE9FD
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_181(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xFA2F
{
	Hash entityModel;
	int num;
...
void func_182(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1299D
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_183() // Position - 0x12A2F
{
...
BOOL func_184() // Position - 0x12A61
{
	return true;
}

int func_185() // Position - 0x12A6A
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x12C59
{
	int profileSetting;
...
int func_188() // Position - 0x12D11
{
	return 1;
}

int func_189() // Position - 0x12D1A
{
	return 1;
}

void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12D23
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x12FD8
{
...
Hash func_192(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13298
{
	var outProp;
	int componentId;
	int num;
...
int func_193(Hash hParam0, int iParam1) // Position - 0x133B2
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x13759
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x13809
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1386A
{
	int i;
	int j;
...
int func_197(Ped pedParam0, int iParam1) // Position - 0x1390B
{
...
int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1396B
{
	ePedComponentType componentId;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x139C2
{
	int pedPropIndex;
...
int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x13A09
{
	Hash entityModel;
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13B05
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13C43
{
	var outfit;
	int i;
	int num;
...
int func_203(Hash hParam0) // Position - 0x13CFE
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x13D5D
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, int iParam2) // Position - 0x13DE3
{
	Hash entityModel;
	int num;
	Hash hash;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1423F
{
	Hash componentHash;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x142E8
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14390
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x143E3
{
	var unk;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x149E7
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14C64
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15089
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2) // Position - 0x1537C
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15415
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15D44
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x15E6E
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x15EB6
{
	int i;
	var unk;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17CFE
{
	int num;
	Hash outfit;
...
int func_219(int iParam0) // Position - 0x17EE8
{
	switch (iParam0)
	{
		case 0:
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17F98
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1800C
{
	func_267();
...
void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x1804D
{
	switch (iParam0)
	{
		case 2:
...
void func_223(int iParam0) // Position - 0x18159
{
	BOOL flag;
	int num;
	var unk;
...
void func_224(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18314
{
	int num;
	int num2;
...
BOOL func_225(int iParam0, int iParam1, var uParam2) // Position - 0x186B6
{
	*uParam2 = 979;
...
int func_226(int iParam0, int iParam1) // Position - 0x18ABB
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1) // Position - 0x18EB6
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x192B1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A154
{
	int num;
	int num2;
	int num3;
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A192
{
...
BOOL func_231(int iParam0) // Position - 0x1CDB6
{
	return Global_44199 == iParam0;
}

int func_232(int iParam0) // Position - 0x1CDC4
{
	switch (iParam0)
	{
		case -1:
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1CE98
{
	int num;
...
void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CEB8
{
	int num;
	int num2;
	Hash outfit;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D13F
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D242
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1D521
{
	BOOL flag;
	int value;
	var unk;
...
void func_302(var uParam0) // Position - 0x34F5A
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_305(&uLocal_120, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_120, 1);
	func_303(&uLocal_120, -2392.8381f, -2427.6187f, 43.1663f, -1.9378f, -0.4041f, -53.486f, "HS4_LSA_LAND_NIMB", 1, 1, uParam0->f_4, 0);
	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x34FAE
{
	func_304(uParam0, sParam7, iParam8, iParam9, uParam10);
	uParam0->f_9 = { fParam1 };
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x34FDE
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x3500B
{
