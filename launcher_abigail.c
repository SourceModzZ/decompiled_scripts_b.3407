	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_304(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19FE
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28A9
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2931
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4879
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55FA
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5635
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58A9
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E34
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6ADB
{
	int i;
...
int func_97() // Position - 0x8843
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8853
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8870
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8880
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BC3
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8BD4
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C1A
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CA0
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CD3
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D24
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DC6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DE8
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DFF
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E0C
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E46
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E81
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EBD
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8ED6
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F39
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F4F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F65
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FA7
{
...
struct<2> func_119(int iParam0) // Position - 0x8FCF
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x941C
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6F4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA3A
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAADF
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB7A
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xABD8
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC31
{
...
int func_129(Ped pedParam0) // Position - 0xACB4
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACE5
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACFA
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADAD
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADC8
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE14
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE5D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE7D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE9E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF6E
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFC1
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0B7
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB122
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB161
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2B0
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2CA
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB323
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB364
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB386
{
...
BOOL func_150() // Position - 0xB3C5
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3D3
{
	int num;
...
void func_153(int iParam0) // Position - 0xB42D
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB450
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4F4
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB583
{
...
void func_161(Vehicle veParam0) // Position - 0xB5DA
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB606
{
...
void func_164(int iParam0) // Position - 0xB7A8
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7DB
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB865
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8D9
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8E7
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB93E
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB94D
{
...
BOOL func_171(int iParam0) // Position - 0xB98E
{
	int num;
	...
	num = func_173(&(Global_113249[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_172(int iParam0) // Position - 0xB9D3
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA05
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB3C
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB8B
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB9C
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD7D
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD9F
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDB0
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDF9
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xBE1D
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC28E
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2BA
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC2D1
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC360
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCB43
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCB5E
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCBEC
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCC50
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xCCE7
{
...
BOOL func_191(int iParam0) // Position - 0xCD11
{
	eCharacter character;
...
BOOL func_196() // Position - 0xD4A3
{
	return Global_101765.f_400 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD4B4
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD4EC
{
	return Global_1575086;
}

BOOL func_199() // Position - 0xD4F8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD514
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD59C
{
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD5D7
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD62D
{
...
float func_204(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD6C8
{
...
void func_205(var uParam0, var uParam1, char* sParam2) // Position - 0xD702
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD9FE
{
...
BOOL func_207(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xDA4C
{
	Global_22443 = 0;
...
BOOL func_210(Player plParam0) // Position - 0xDDB4
{
	return func_211(plParam0, 20);
}

BOOL func_211(Player plParam0, int iParam1) // Position - 0xDDC4
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_212() // Position - 0xDDDC
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDF3C
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
float func_217(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xE036
{
	Vector3 entityCoords;
...
void func_218(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE094
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xE185
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xE1C1
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xE1FA
{
	BOOL flag;
	int i;
...
BOOL func_222() // Position - 0xE298
{
	return Global_98997;
}

void func_223(var uParam0) // Position - 0xE2A4
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE2BB
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0) // Position - 0xE3A3
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE3CB
{
	var unk;
...
void func_227(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE63B
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_228(int iParam0) // Position - 0xE993
{
...
BOOL func_229(var uParam0) // Position - 0xE9B3
{
...
BOOL func_230(var uParam0) // Position - 0xE9CB
{
...
void func_231(var uParam0) // Position - 0xE9F0
{
	int i;
	int taskSequenceId;
...
void func_232(Object* pobParam0) // Position - 0xECEE
{
...
void func_233(var uParam0) // Position - 0xED19
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xED99
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_235(Ped pedParam0, Vehicle veParam1) // Position - 0xEF57
{
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEF87
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF243
{
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF277
{
	float xSize;
...
BOOL func_239(Ped pedParam0, int iParam1) // Position - 0xF2ED
{
	return func_240(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_240(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF305
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_241(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF3C6
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_242(Ped pedParam0, int iParam1) // Position - 0xF4F2
{
...
BOOL func_244(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF601
{
	var unk;
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF692
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xF6B3
{
	float num;
	float num2;
...
void func_247(var uParam0) // Position - 0xF6F2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(Ped pedParam0, Ped pedParam1) // Position - 0xF70D
{
	int i;
...
BOOL func_249(Ped pedParam0) // Position - 0xF74C
{
...
BOOL func_250(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF774
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_251(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF86F
{
	float entityCoords;
	float num;
...
BOOL func_252(Ped pedParam0, float fParam1) // Position - 0xF97B
{
	var outProjectile;
	var outCoords;
...
BOOL func_253(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFA10
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_254(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFA9E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_255(int iParam0) // Position - 0xFAE6
{
...
void func_256(Vehicle veParam0) // Position - 0xFB30
{
	int taskSequenceId;
...
BOOL func_257(int iParam0) // Position - 0xFBCD
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_258(int iParam0) // Position - 0xFC62
{
...
BOOL func_261(int iParam0) // Position - 0xFCE1
{
	if (func_262() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_262() // Position - 0xFD15
{
...
BOOL func_263(int iParam0) // Position - 0xFD53
{
...
BOOL func_264(var uParam0) // Position - 0xFD7B
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_265(var uParam0) // Position - 0xFDC2
{
	int num;
	int i;
	BOOL flag;
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF74
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0xFFB7
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10054
{
...
BOOL func_269(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x100B0
{
	Hash model;
...
int func_270(var uParam0, eCharacter echParam1) // Position - 0x1013E
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x10184
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x101B5
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_273(var uParam0) // Position - 0x101F1
{
	Hash model;
	BOOL flag;
...
BOOL func_274(int iParam0) // Position - 0x102FC
{
	var unk;
	eCharacter character;
...
BOOL func_275(int iParam0) // Position - 0x1034D
{
	const char* string2;
...
BOOL func_276(int iParam0) // Position - 0x10406
{
	var unk;
...
BOOL func_277(int iParam0) // Position - 0x104C7
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_278(int iParam0, char* sParam1) // Position - 0x1054C
{
...
BOOL func_279(int iParam0) // Position - 0x1062E
{
...
BOOL func_280(int iParam0) // Position - 0x10659
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10684
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_282(int iParam0) // Position - 0x106AF
{
	if (func_258(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_283() // Position - 0x106E4
{
...
BOOL func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x106FE
{
	int i;
...
BOOL func_285(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10763
{
	int num;
	char* str;
...
BOOL func_286(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x107DB
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x10856
{
	char* str;
...
void func_288(char* sParam0) // Position - 0x108DD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_291(sParam0))
			func_289();
...
void func_289() // Position - 0x108FC
{
	Global_21308 = 0;
	func_290();
	return;
...
void func_290() // Position - 0x1090C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
BOOL func_291(char* sParam0) // Position - 0x1092D
{
	var string1;
...
struct<6> func_292() // Position - 0x1094D
{
	var unk;
...
void func_293(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10971
{
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x10991
{
	func_295(&(uParam0->f_41), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x109A3
{
	int i;
...
void func_296(Object* pobParam0, BOOL bParam1) // Position - 0x109E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_297(var uParam0, BOOL bParam1) // Position - 0x10A1C
{
	func_298(&(uParam0->f_35), bParam1);
	return;
}

void func_298(var uParam0, BOOL bParam1) // Position - 0x10A2E
{
	int i;
...
void func_299(Vehicle* pveParam0) // Position - 0x10A6B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_300(var uParam0, int iParam1) // Position - 0x10AA3
{
	func_301(&(uParam0->f_28), iParam1);
	return;
}

void func_301(var uParam0, int iParam1) // Position - 0x10AB5
{
	int i;
...
void func_302(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10AF6
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_303(Ped* ppedParam0) // Position - 0x10B46
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_304(int iParam0) // Position - 0x10B87
{
	if (*iParam0 == -1)
		return;
...
void func_305(char* sParam0) // Position - 0x10BC4
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_306(var uParam0) // Position - 0x10BD6
{
	*uParam0 = -1;
...
void func_307() // Position - 0x10C09
{
...
Hash func_308(eCharacter echParam0) // Position - 0x10C23
{
	if (!func_36(echParam0))
