...
void func_20() // Position - 0xBE8
{
	...
	if (Global_79564 == false)
	{
		...
		while (num2 < 161)
		{
			if (func_41(num2, Global_21083) == 1)
				num = 1;
...
{
	return func_39(*Global_4718592.f_134976);
}
...
void func_50() // Position - 0x154D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(character) && !func_17(14) || Global_113110)
			{
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1714
{
	...
	if (Global_114162.f_7692.f_650 < 30)
	{
		num = iParam0;
...
void func_59(int iParam0) // Position - 0x1920
{
	...
	Global_44751[iParam0] = MISC::GET_GAME_TIMER();
	return;
}

void func_60() // Position - 0x1975
{
	Global_44750 = MISC::GET_GAME_TIMER();
	return;
}
...
void func_67(int iParam0) // Position - 0x1D7C
{
	...
	for (i = 0; i < Global_114162.f_7692.f_198; i = i + 1)
	{
		if (Global_114162.f_7692.f_137[i /*15*/] == iParam0)
		{
			func_68(Global_114162.f_7692.f_137[i /*15*/].f_6);
...
int func_68(int iParam0) // Position - 0x1E38
{
	...
	{
		if (func_41(iParam0, Global_21083) == 1)
		{
			func_73(iParam0, Global_21083, 0);
		
			if (func_72(iParam0, Global_21083) == 0)
			{
				num = Global_21083;
				func_69(iParam0, num);
			}
