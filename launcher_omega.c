...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_276(&unk64, &num, unk61, 1f))
	{
		func_275();
	...
	while (true)
	{
		...
		func_214(num);
		func_207(&iLocal_91, &(num.f_9), unk61);
	
		if (num == 44)
		{
			func_199(&num, unk61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_198();
		}
		else if (num == 45)
		{
			func_199(&num, unk61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_196(&num);
		}
...
void func_3(int iParam0, var uParam1) // Position - 0x33F
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xBC1
{
	var unk;
...
void func_21(var uParam0) // Position - 0xCB8
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCE8
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19C1
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x286C
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x28F4
{
...
BOOL func_29(var uParam0) // Position - 0x2934
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2962
{
...
int func_31(var uParam0) // Position - 0x2A3E
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A80
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2AE3
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B71
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E1B
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x343A
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3569
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36B0
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36ED
{
...
int func_47(eCharacter echParam0) // Position - 0x3712
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3721
{
...
var func_50(int iParam0, int iParam1) // Position - 0x38EA
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3963
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3978
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EC1
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4228
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x431B
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x483C
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x55BD
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x55F8
{
	int num;
...
void func_67(int iParam0) // Position - 0x586C
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x58A8
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DF7
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E3B
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65BA
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6601
{
...
BOOL func_73(int iParam0) // Position - 0x665C
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x666C
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66CC
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A83
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6A8E
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A9E
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B40
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_86(Player plParam0) // Position - 0x7632
{
...
BOOL func_94(Player plParam0) // Position - 0x84E9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97() // Position - 0x87D1
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x87E1
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x87FE
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x880E
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B51
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8B62
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BA8
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C2E
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C61
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CB2
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D54
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D76
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8D8D
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8D9A
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DD4
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E0F
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E4B
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E64
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8EC7
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8EDD
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EF3
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F35
{
...
struct<2> func_119(int iParam0) // Position - 0x8F5D
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93AA
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA682
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9C8
{
	int num;
...
void func_124(int iParam0) // Position - 0xAA6D
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAB08
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAB66
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABBF
{
...
int func_129(int iParam0) // Position - 0xAC42
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC73
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC88
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD3B
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD56
{
	int i;
...
int func_135(int iParam0) // Position - 0xADA2
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xADEB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE0B
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE2C
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAEFC
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF4F
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB045
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0B0
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0EF
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB23E
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB258
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2B1
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB2F2
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB314
{
...
BOOL func_150() // Position - 0xB353
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB361
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3BB
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB3DE
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB482
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB511
{
...
void func_161(var uParam0) // Position - 0xB568
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB594
{
...
void func_164(int iParam0) // Position - 0xB736
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB769
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB7F3
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB867
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB875
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB8CC
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB8DB
{
...
BOOL func_171(int iParam0) // Position - 0xB91C
{
	int num;
...
void func_172(int iParam0) // Position - 0xB961
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB993
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBACA
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB19
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB2A
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD0B
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBD2D
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBD3E
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD87
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBDAB
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC58F
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC5AA
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC638
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC69C
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC733
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC75D
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_195() || Global_113182 || Global_33090 || func_194() || func_193(8, -1) || func_101() || func_192() || func_191() || func_190() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_195() || Global_33090 || func_194() || func_193(8, -1) || func_191() || func_101() || func_192() || func_190() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_195() || Global_113182 || Global_33090 || func_194() || func_193(8, -1) || func_191() || func_101() || func_192() || func_190() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_195() || Global_113182 || Global_33090 || func_194() || func_193(8, -1) || func_101() || func_192() || func_190() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_195() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_193(8, -1) || func_190() || func_189() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_188() // Position - 0xCE7A
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCE88
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCEEF
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF00
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCF38
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCF44
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_196(var uParam0) // Position - 0xCF60
{
	var unk;
	float num;
	float num2;
	...
	if (unk_0x1DD05E817C89C737() - uLocal_96 > 1250)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !unk_0xCB5CAFF0A4A8B74B(uParam0->f_28[0]))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && !func_197(unk_0x4A8C381C258A124D(), uParam0->f_28[0], 50f, 1))
			{
				unk = { unk_0xD1A6A821F5AC81DB(uParam0->f_28[0], 1) };
				num = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
				num3 = num - unk;
				num4 = num.f_1 - unk.f_1;
			
				if (num4 != 0f)
					num2 = unk_0x4964D7A2BFD2F9A3(num3, num4);
				else if (num3 < 0f)
					num2 = -90f;
				else
					num2 = 90f;
		...
		uLocal_96 = unk_0x1DD05E817C89C737();
	}

	return;
}

BOOL func_197(var uParam0, var uParam1, float fParam2, int iParam3) // Position - 0xD049
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam3), unk_0xD1A6A821F5AC81DB(uParam1, iParam3)) <= fParam2 * fParam2;
}

void func_198() // Position - 0xD06B
{
	float num;
	float num2;
	float num3;
	...
	unk_0x88F483FBD433696A(uLocal_94, "SET_COLOUR");
	...
	unk_0x88F483FBD433696A(uLocal_94, "SET_DISTANCE");
	unk_0x74BF156C860580D4(10f);
	unk_0xE6B753D52F4CA222();
	unk_0x61055542D9D877AE(uLocal_95);
	num = 0.1f;
	num2 = 0.24f;
	num3 = 0.21f;
	num4 = 0.51f;
	...
	unk_0x6D16B99FEB0AFFF1(uLocal_94, num, num2, num3, num4, 100, 100, 100, 255, 0);

	if (unk_0x1DD05E817C89C737() - uLocal_96 > 1250)
	{
		unk_0xF37CDE164C892195(uLocal_97, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		uLocal_96 = unk_0x1DD05E817C89C737();
	}
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xD15D
{
	var unk;
	...
	if (!(*uParam8 == 3))
	{
		if (func_187(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_206(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			if (func_206(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_200(int iParam0) // Position - 0xD27F
{
	Global_23436 = iParam0;
	return;
}

BOOL func_201(char* sParam0) // Position - 0xD28C
{
	var unk;
...
struct<6> func_202() // Position - 0xD2AC
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD2D0
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD30B
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD361
{
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD3FC
{
	var unk;
...
void func_207(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD436
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_208(int iParam0, BOOL bParam1) // Position - 0xD527
{
	if (iParam0 == -1)
		return;
...
int func_209(int iParam0) // Position - 0xD563
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_210(var uParam0, int iParam1) // Position - 0xD59C
{
	BOOL flag;
	int i;
...
BOOL func_211() // Position - 0xD63A
{
	return Global_98972;
}

void func_212(var uParam0) // Position - 0xD646
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_213(uParam0);
...
void func_213(var uParam0) // Position - 0xD65D
{
	BOOL flag;
	int num;
	int i;
...
void func_214(int iParam0) // Position - 0xD745
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD76D
{
	var unk;
	...
	if (func_252(*panParam0) || func_250(*panParam0) || Global_79785 == 1)
		return true;
...
void func_216(int iParam0, var uParam1, int iParam2) // Position - 0xD9DD
{
	var unk;
	var unk2;
...
BOOL func_217(int iParam0) // Position - 0xDD35
{
...
BOOL func_218(var uParam0) // Position - 0xDD55
{
...
BOOL func_219(var uParam0) // Position - 0xDD6D
{
...
void func_220(var uParam0) // Position - 0xDD92
{
	int i;
	var unk;
...
void func_221(var uParam0) // Position - 0xE096
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_222(var uParam0) // Position - 0xE0C1
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE141
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_224(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_224(var uParam0, var uParam1) // Position - 0xE2FF
{
	var unk;
...
BOOL func_225(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE32F
{
	int i;
	int num;
...
BOOL func_226(int iParam0) // Position - 0xE5EB
{
...
BOOL func_227(var uParam0, int iParam1) // Position - 0xE61F
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_238(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_228(var uParam0, int iParam1) // Position - 0xE695
{
	return func_229(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE6AD
{
	BOOL flag;
	var unk;
	int num;

	num = func_237(uParam0, uParam1);
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE76E
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_231(var uParam0, int iParam1) // Position - 0xE89A
{
	int num;
...
BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE9A9
{
	var unk;
	var unk4;
	float num;

	unk = { func_235(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_235(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };
...
float func_234(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEA3A
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_235(float fParam0, var uParam1, var uParam2) // Position - 0xEA5B
{
	float num;
	float num2;
...
void func_236(var uParam0) // Position - 0xEA9A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_237(var uParam0, var uParam1) // Position - 0xEAB5
{
	int i;
...
int func_238(var uParam0) // Position - 0xEAF4
{
...
BOOL func_239(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEB1C
{
	float num;
	float num2;
	int num3;
...
BOOL func_240(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEC17
{
	float num;
	float num2;
...
BOOL func_241(var uParam0, float fParam1) // Position - 0xED23
{
	var unk;
	var unk2;
...
BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEDB8
{
	var unk;
	var unk4;
	float num;

	unk = { func_235(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_243(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEE46
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_244(int iParam0) // Position - 0xEE8E
{
...
void func_245(var uParam0) // Position - 0xEED8
{
	var unk;
...
BOOL func_246(int iParam0) // Position - 0xEF75
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_247(int iParam0) // Position - 0xF00A
{
...
BOOL func_250(int iParam0) // Position - 0xF089
{
	if (func_251() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_251() // Position - 0xF0BD
{
...
BOOL func_252(int iParam0) // Position - 0xF0FB
{
...
void func_253() // Position - 0xF123
{
	uLocal_96 = unk_0x1DD05E817C89C737();
	return;
}

void func_254() // Position - 0xF131
{
	uLocal_94 = unk_0x8DE4F68A9728925E("digiscanner");

	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_94))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0xC13AFEAFC3F7AD96("digiscanner"))
		uLocal_95 = unk_0x08732C0099FA1813("digiscanner");

	uLocal_97 = unk_0xCA369FBC0DE29517();
	uLocal_96 = unk_0x1DD05E817C89C737();
	return;
}

BOOL func_255(var uParam0) // Position - 0xF199
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_256(var uParam0) // Position - 0xF1E0
{
	int num;
	int i;
	BOOL flag;
...
void func_257(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3AF
{
	func_258(uParam0);
...
void func_258(var uParam0) // Position - 0xF3F2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_259(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF48E
{
...
BOOL func_260(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF4EA
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_299(echParam1);
...
int func_261(var uParam0, eCharacter echParam1) // Position - 0xF578
{
	int num;
...
BOOL func_262(var uParam0) // Position - 0xF5BE
{
	if (func_219(uParam0))
	{
...
BOOL func_263(var uParam0) // Position - 0xF5E8
{
	int i;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF619
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_265(var uParam0) // Position - 0xF655
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_266(int iParam0) // Position - 0xF8D9
{
	var unk;
	eCharacter character;
...
BOOL func_267(int iParam0) // Position - 0xF92A
{
	var unk;
...
BOOL func_268(int iParam0) // Position - 0xF9E3
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0xFAA4
{
	int i;
	var unk;
	int num;
...
BOOL func_270(int iParam0, char* sParam1) // Position - 0xFB29
{
...
BOOL func_271(int iParam0) // Position - 0xFC0B
{
...
BOOL func_272(int iParam0) // Position - 0xFC36
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0xFC61
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0xFC8C
{
	if (func_247(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFCDB
{
	int i;
...
BOOL func_277(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFD40
{
	int num;
	char* str;
...
BOOL func_278(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFDB8
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_279(var uParam0, BOOL bParam1) // Position - 0xFE33
{
	char* str;
	...
	if (bParam1)
	{
		...
		if (*uParam0 == 44 && unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			unk_0xB3B56385ECA230B4(&uParam0->f_41[1]);
...
void func_280(char* sParam0) // Position - 0xFF03
{
...
int func_283(var uParam0) // Position - 0xFF53
{
	if (func_219(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_284(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFF89
{
...
void func_285(var uParam0, BOOL bParam1) // Position - 0xFFA9
{
	func_286(&(uParam0->f_41), bParam1);
	return;
}

void func_286(var uParam0, BOOL bParam1) // Position - 0xFFBB
{
	int i;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0xFFF9
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_288(var uParam0, BOOL bParam1) // Position - 0x10036
{
	func_289(&(uParam0->f_35), bParam1);
	return;
}

void func_289(var uParam0, BOOL bParam1) // Position - 0x10048
{
	int i;
...
void func_290(var uParam0) // Position - 0x10085
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_291(var uParam0, int iParam1) // Position - 0x100BD
{
	func_292(&(uParam0->f_28), iParam1);
	return;
}

void func_292(var uParam0, int iParam1) // Position - 0x100CF
{
	int i;
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10110
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_294(var uParam0) // Position - 0x10160
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_295(int iParam0) // Position - 0x101A1
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x101DE
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x101F0
{
	*uParam0 = -1;
...
void func_298() // Position - 0x10223
{
...
int func_299(eCharacter echParam0) // Position - 0x1023D
{
	if (!func_36(echParam0))
