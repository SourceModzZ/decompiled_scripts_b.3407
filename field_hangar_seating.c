...
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("FIELD_HANGAR_seating", Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_11, true, 0))
		return false;
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x282C
{
	var unk;
	float num;
	var unk4;
...
Vector3 func_104() // Position - 0x28BF
{
	return 0.37f, -0.5f, 2f;
}

Vector3 func_105() // Position - 0x28D2
{
	return -0.37f, -0.5f, 0f;
}

void func_106(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x28E5
{
	if (func_5())
	{
		switch (iParam0)
		{
			case 0:
				*uParam1 = { func_107(2150.3225f, 4789.504f, -47.375f, 0f, 0, 0) };
				*uParam2 = 0f;
				break;
		
			case 1:
				*uParam1 = { func_107(2150.3225f, 4789.504f, -47.375f, 0f, 0, 1) };
				*uParam2 = 0f;
				break;
		
			case 2:
				*uParam1 = { func_107(2150.3225f, 4789.504f, -47.375f, 0f, 0, 2) };
				*uParam2 = 0f;
				break;
		}
	}
...
Vector3 func_107(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x29EF
{
	var unk;
...
Vector3 func_108(int iParam0, int iParam1) // Position - 0x2A1A
{
	switch (iParam0)
	{
		case 0:
...
void func_109() // Position - 0x2A75
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x2A7D
{
	int i;
...
BOOL func_111(BOOL bParam0) // Position - 0x2B93
{
	bParam0;
