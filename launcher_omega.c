...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19C1
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x286C
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28F4
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x483C
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55BD
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55F8
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x586C
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DF7
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A9E
{
	int i;
...
int func_97() // Position - 0x8806
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8816
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8833
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8843
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B86
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8B97
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BDD
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C63
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C96
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CE7
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D89
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DAB
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DC2
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8DCF
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E09
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E44
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E80
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E99
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8EFC
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F12
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F28
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F6A
{
...
struct<2> func_119(int iParam0) // Position - 0x8F92
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93DF
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6B7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9FD
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAAA2
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB3D
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAB9B
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABF4
{
...
int func_129(Ped pedParam0) // Position - 0xAC77
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACA8
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACBD
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD70
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD8B
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xADD7
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE20
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE40
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE61
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF31
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF84
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB07A
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0E5
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB124
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB273
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB28D
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2E6
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB327
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB349
{
...
BOOL func_150() // Position - 0xB388
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB396
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3F0
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB413
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4B7
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB546
{
...
void func_161(Vehicle veParam0) // Position - 0xB59D
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB5C9
{
...
void func_164(int iParam0) // Position - 0xB76B
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB79E
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB828
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB89C
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8AA
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB901
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB910
{
...
BOOL func_171(int iParam0) // Position - 0xB951
{
	int num;
...
void func_172(int iParam0) // Position - 0xB996
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9C8
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBAFF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB4E
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB5F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD40
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD62
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBD73
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDBC
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBDE0
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC5C4
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC5DF
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC66D
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC6D1
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC768
{
...
BOOL func_187(int iParam0) // Position - 0xC792
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCEAF
{
	return Global_101752.f_1;
}

BOOL func_189() // Position - 0xCEBD
{
	if (Global_98610 != -1)
...
BOOL func_192() // Position - 0xCF24
{
	return Global_101765.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF35
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCF6D
{
	return Global_1575086;
}

BOOL func_195() // Position - 0xCF79
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_196(var uParam0) // Position - 0xCF95
{
	var entityCoords;
	float entityCoords2;
	float heading;
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xD192
{
	var unk;
...
void func_200(int iParam0) // Position - 0xD2B4
{
	Global_23453 = iParam0;
	return;
}

BOOL func_201(char* sParam0) // Position - 0xD2C1
{
	var string1;
...
struct<6> func_202() // Position - 0xD2E1
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD305
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD340
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD396
{
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD431
{
...
void func_207(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD46B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_208(int iParam0, BOOL bParam1) // Position - 0xD55C
{
	if (iParam0 == -1)
		return;
...
int func_209(int iParam0) // Position - 0xD598
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_210(var uParam0, int iParam1) // Position - 0xD5D1
{
	BOOL flag;
	int i;
...
BOOL func_211() // Position - 0xD66F
{
	return Global_98997;
}

void func_212(var uParam0) // Position - 0xD67B
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_213(uParam0);
...
void func_213(var uParam0) // Position - 0xD692
{
	BOOL flag;
	int num;
	int i;
...
void func_214(int iParam0) // Position - 0xD77A
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD7A2
{
	var unk;
	...
	if (func_252(*panParam0) || func_250(*panParam0) || Global_79810 == 1)
		return true;
...
void func_216(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDA12
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_217(int iParam0) // Position - 0xDD6A
{
...
BOOL func_218(var uParam0) // Position - 0xDD8A
{
...
BOOL func_219(var uParam0) // Position - 0xDDA2
{
...
void func_220(var uParam0) // Position - 0xDDC7
{
	int i;
	int taskSequenceId;
...
void func_221(Object* pobParam0) // Position - 0xE0CB
{
...
void func_222(var uParam0) // Position - 0xE0F6
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE176
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_224(Ped pedParam0, Vehicle veParam1) // Position - 0xE334
{
...
BOOL func_225(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE364
{
	int i;
	int num;
...
BOOL func_226(int iParam0) // Position - 0xE620
{
...
BOOL func_227(Ped pedParam0, int iParam1) // Position - 0xE654
{
	float xSize;
...
BOOL func_228(Ped pedParam0, int iParam1) // Position - 0xE6CA
{
	return func_229(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE6E2
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_230(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE7A3
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_231(Ped pedParam0, int iParam1) // Position - 0xE8CF
{
...
BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE9DE
{
	var unk;
...
float func_234(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEA6F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_235(float fParam0, var uParam1, var uParam2) // Position - 0xEA90
{
	float num;
	float num2;
...
void func_236(var uParam0) // Position - 0xEACF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_237(Ped pedParam0, Ped pedParam1) // Position - 0xEAEA
{
	int i;
...
BOOL func_238(Ped pedParam0) // Position - 0xEB29
{
...
BOOL func_239(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEB51
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_240(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEC4C
{
	float entityCoords;
	float num;
...
BOOL func_241(Ped pedParam0, float fParam1) // Position - 0xED58
{
	var outProjectile;
	var outCoords;
...
BOOL func_242(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEDED
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_243(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEE7B
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_244(int iParam0) // Position - 0xEEC3
{
...
void func_245(Vehicle veParam0) // Position - 0xEF0D
{
	int taskSequenceId;
...
BOOL func_246(int iParam0) // Position - 0xEFAA
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_247(int iParam0) // Position - 0xF03F
{
...
BOOL func_250(int iParam0) // Position - 0xF0BE
{
	if (func_251() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_251() // Position - 0xF0F2
{
...
BOOL func_252(int iParam0) // Position - 0xF130
{
...
void func_253() // Position - 0xF158
{
	iLocal_96 = MISC::GET_GAME_TIMER();
	return;
}

void func_254() // Position - 0xF166
{
...
BOOL func_255(var uParam0) // Position - 0xF1CE
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_256(var uParam0) // Position - 0xF215
{
	int num;
	int i;
	BOOL flag;
...
void func_257(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3E4
{
	func_258(pveParam0);
...
void func_258(Vehicle* pveParam0) // Position - 0xF427
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_259(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF4C3
{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF51F
{
	Hash model;
...
int func_261(var uParam0, eCharacter echParam1) // Position - 0xF5AD
{
	int num;
...
BOOL func_262(var uParam0) // Position - 0xF5F3
{
	if (func_219(uParam0))
	{
...
BOOL func_263(var uParam0) // Position - 0xF61D
{
	int i;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF64E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_265(var uParam0) // Position - 0xF68A
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_266(int iParam0) // Position - 0xF90E
{
	var unk;
	eCharacter character;
...
BOOL func_267(int iParam0) // Position - 0xF95F
{
	const char* string2;
...
BOOL func_268(int iParam0) // Position - 0xFA18
{
	var unk;
...
BOOL func_269(int iParam0) // Position - 0xFAD9
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_270(int iParam0, char* sParam1) // Position - 0xFB5E
{
...
BOOL func_271(int iParam0) // Position - 0xFC40
{
...
BOOL func_272(int iParam0) // Position - 0xFC6B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_273(int iParam0) // Position - 0xFC96
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0xFCC1
{
	if (func_247(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFD10
{
	int i;
...
BOOL func_277(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFD75
{
	int num;
	char* str;
...
BOOL func_278(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFDED
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_279(var uParam0, BOOL bParam1) // Position - 0xFE68
{
	char* str;
...
void func_280(char* sParam0) // Position - 0xFF38
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_201(sParam0))
			func_281();
...
int func_283(var uParam0) // Position - 0xFF88
{
	if (func_219(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_284(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFFBE
{
...
void func_285(var uParam0, BOOL bParam1) // Position - 0xFFDE
{
	func_286(&(uParam0->f_41), bParam1);
	return;
}

void func_286(var uParam0, BOOL bParam1) // Position - 0xFFF0
{
	int i;
...
void func_287(Object* pobParam0, BOOL bParam1) // Position - 0x1002F
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_288(var uParam0, BOOL bParam1) // Position - 0x1006A
{
	func_289(&(uParam0->f_35), bParam1);
	return;
}

void func_289(var uParam0, BOOL bParam1) // Position - 0x1007C
{
	int i;
...
void func_290(Vehicle* pveParam0) // Position - 0x100B9
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_291(var uParam0, int iParam1) // Position - 0x100F1
{
	func_292(&(uParam0->f_28), iParam1);
	return;
}

void func_292(var uParam0, int iParam1) // Position - 0x10103
{
	int i;
...
void func_293(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10144
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_294(Ped* ppedParam0) // Position - 0x10194
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_295(int iParam0) // Position - 0x101D5
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x10212
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x10224
{
	*uParam0 = -1;
...
void func_298() // Position - 0x10257
{
...
Hash func_299(eCharacter echParam0) // Position - 0x10271
{
	if (!func_36(echParam0))
