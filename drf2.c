...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		...
		func_264(&pedLocal_397, &veLocal_400, caLocal_402, iLocal_58);
	}

	iLocal_80 = func_263();
	func_262(&uLocal_59, iLocal_80);
	FIRE::STOP_FIRE_IN_RANGE(-1899.7563f, -561.3688f, 10.78784f, 100f);
	MISC::SET_BIT(&(Global_114162.f_10020.f_25), 6);
	...
	while (true)
	{
		...
		switch (iLocal_58)
		{
			case 0:
				...
				func_256(&uLocal_46, hLocal_53, hLocal_54, hLocal_55, hLocal_56, hLocal_57, func_263());
			...
			case 1:
				if (!flag5)
				{
					if (func_252(&uLocal_46))
					{
						func_242(&pedLocal_397, hLocal_53, uLocal_417, fLocal_423, iLocal_430, iLocal_431, iLocal_432);
						func_232(&uLocal_59, func_263());
						func_254(&uLocal_246);
						flag5 = true;
					}
				}
					...
					if (!flag6)
					{
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
								func_145(&uLocal_405, PLAYER::PLAYER_PED_ID(), 0, 2);
						
							if (!ENTITY::IS_ENTITY_DEAD(pedLocal_397, false))
								func_145(&uLocal_411, pedLocal_397, 0, 2);
			...
			case 2:
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&uLocal_405, 0))
					func_140(pedLocal_397, true, false);
			
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&uLocal_411, 0))
					func_140(pedLocal_397, false, true);
			
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					func_139(pedLocal_397, &veLocal_399, &veLocal_400, &caLocal_402, &uLocal_81, uLocal_420, fLocal_425, hLocal_55);
					func_137(func_263());
					func_254(&uLocal_249);
					func_136(&uLocal_273, false, false, false, true);
					func_135(&uLocal_273, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_135(&uLocal_273, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					flag6 = false;
					PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
					iLocal_58 = 3;
			...
			case 3:
				...
				if (CAM::IS_SCREEN_FADED_OUT() || flag8)
				{
					...
					while (func_143(&uLocal_249) < 0.4f)
					{
						SYSTEM::WAIT(0);
						func_128();
					}
				...
				if (!flag3)
				{
					...
					{
						uLocal_59.f_20 = 0;
						func_115(&(uLocal_59.f_12), &uLocal_59, func_263());
						bLocal_433 = true;
					}
				
					if (func_105(&uLocal_249, &uLocal_273, &flag2))
					{
						if (flag2)
						{
							uLocal_59.f_20 = 0;
					...
					else if (func_143(&uLocal_249) >= 14f)
					{
						uLocal_59.f_20 = 2;
						flag3 = true;
						HUD::CLEAR_HELP(true);
					}
					else if (!flag4 && func_143(&uLocal_249) >= 7f)
					{
				...
				else if (func_143(&uLocal_249) > 5f && func_142() || CUTSCENE::HAS_CUTSCENE_LOADED() && uLocal_59.f_20 != 1 || func_143(&uLocal_249) > num || func_101(iLocal_80, pedLocal_397, &caLocal_402))
				{
					func_98();
			...
			case 14:
				...
				if (func_97() && CUTSCENE::IS_CUTSCENE_PLAYING() && !CAM::IS_SCREEN_FADING_OUT() && !CAM::IS_SCREEN_FADED_OUT())
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), true, false);
							ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
							func_94(PLAYER::PLAYER_PED_ID(), -1902.6094f, -559.9267f, 10.7916f);
							...
							if (ENTITY::DOES_ENTITY_EXIST(veLocal_400))
							{
								...
								{
									ENTITY::SET_ENTITY_COORDS(veLocal_400, func_84(veLocal_400), true, false, false, true);
							...
							if (CAM::IS_SCREEN_FADED_OUT())
							{
								if (!bLocal_434)
								{
									STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_83({ 12.8015f, -560.0015f, -1901.3314f } - { 12.8354f, -562.9188f, -1903.8698f }), 100f, 0);
									bLocal_434 = true;
									SYSTEM::WAIT(0);
								}
				...
				else
				{
					if (!bLocal_434)
					{
						...
						{
							if (iLocal_80 == 4)
								STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_83({ 11.9712f, -560.4745f, -1903.8552f } - { 12.4125f, -557.8768f, -1905.4998f }), 100f, 0);
							else
								STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_83({ 12.8015f, -560.0015f, -1901.3314f } - { 12.8354f, -562.9188f, -1903.8698f }), 100f, 0);
					...
					if (!bLocal_435)
					{
						if (CUTSCENE::GET_CUTSCENE_CONCAT_SECTION_PLAYING() >= 16)
						{
							...
							else if (func_143(&unk4) > func_81(func_263()))
							{
								if (func_263() == 4)
								{
			...
			case 15:
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_398) || func_79(pedLocal_398, PLAYER::PLAYER_PED_ID(), true) > 300f)
				{
				...
				else
				{
					...
					if (func_82(&uLocal_264))
					{
						if (func_143(&uLocal_264) > 2.5f)
						{
					...
					if (!bLocal_437)
					{
						...
						if (func_143(&uLocal_261) > 2f)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(veLocal_400) && !ENTITY::IS_ENTITY_DEAD(veLocal_400, false))
							{
								...
								ENTITY::SET_ENTITY_INVINCIBLE(veLocal_400, false, 0);
					...
					if (bLocal_436 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
					{
						if (func_59(&uLocal_255, 0.5f))
						{
							...
							else if (HUD::GET_BLIP_COLOUR(blLocal_401) != 3)
							{
								...
								if (func_82(&uLocal_258))
								{
									if (func_143(&uLocal_258) < 7500f / 1000f)
									{
			...
			case 16:
				if (!func_82(&uLocal_252))
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					func_254(&uLocal_252);
				}
				else if (func_143(&uLocal_252) > 2f)
				{
					func_2(_GET_CURRENT_PLAYER_CHARACTER(), 24, func_44(iLocal_80));
					func_282();
			...
			case 17:
				...
				if (func_143(&uLocal_252) > 4f || CAM::IS_SCREEN_FADED_OUT())
				{
...
int func_2(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1128
{
	...
	return func_3(func_43(echParam0), 0, iParam1, iParam2, false);
}
...
void func_6(int iParam0) // Position - 0x1A37
{
	...
	if (iParam0 == 12)
	{
		func_15(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_15(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_15(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_15(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_15(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_15(8277, 0, -1, true);
		return;
	}

	if (func_14(iParam0))
	{
		func_15(func_13(iParam0), 0, -1, true);
		return;
	}

	if (func_12(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_11(iParam0));
		_MPPLY_STAT_SET_INT(func_11(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114162.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114162.f_20568.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_8() /*5571*/].f_681.f_10), iParam0);
	}
...
char* func_7(int iParam0) // Position - 0x1C00
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x1D36
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x1D52
{
	Hash statHash;
	int outValue;
...
Hash func_11(int iParam0) // Position - 0x1D70
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_12(int iParam0) // Position - 0x1D92
{
	switch (iParam0)
	{
		case 38:
...
int func_13(int iParam0) // Position - 0x1DAF
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_14(int iParam0) // Position - 0x1EB4
{
	switch (iParam0)
	{
		case 18:
...
void func_15(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1F43
{
	Hash statName;
...
Hash func_16(int iParam0, int iParam1) // Position - 0x1F71
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_17(iParam1));
}

int func_17(int iParam0) // Position - 0x1F86
{
	int num;
	int num2;
...
int func_18() // Position - 0x1FBA
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1FC6
{
	if (iParam2 == -1)
		iParam2 = func_18();
...
void func_20(int iParam0) // Position - 0x1FE4
{
	func_41(93, iParam0);
	func_41(29, iParam0);
	func_41(30, iParam0);
...
BOOL func_21(int iParam0) // Position - 0x2004
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_14(iParam0))
	{
		...
		num7 = func_22(func_13(iParam0), -1);
	...
	if (func_12(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_11(iParam0));
...
int func_22(int iParam0, int iParam1) // Position - 0x220F
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x223E
{
	if (iParam1 == -1)
		iParam1 = func_18();
...
int func_24(BOOL bParam0) // Position - 0x225A
{
	var outValue;
	int value;
	int outValue2;
...
int func_25(int iParam0, int iParam1) // Position - 0x2311
{
	if (iParam0 >= 78)
		return 0;
...
int func_26(int iParam0, int iParam1) // Position - 0x232C
{
...
BOOL func_27(var uParam0, int iParam1) // Position - 0x23C9
{
	int i;
	var unk;
...
int func_28(var uParam0, int iParam1) // Position - 0x247A
{
	int i;
...
BOOL func_29(var uParam0, int iParam1) // Position - 0x24F5
{
	return uParam0->[iParam1] == 78;
}

void func_30(var uParam0) // Position - 0x2506
{
	int i;
...
void func_31(var uParam0, int iParam1) // Position - 0x253A
{
	uParam0->[iParam1] = 78;
	return;
}

void func_32(var uParam0, int iParam1) // Position - 0x254A
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_33(var uParam0) // Position - 0x2567
{
	return uParam0->f_80;
}

BOOL func_34(var uParam0, int iParam1) // Position - 0x2573
{
	return func_35(uParam0, iParam1) != -1;
}

int func_35(var uParam0, int iParam1) // Position - 0x2585
{
	int i;
...
BOOL func_36(var uParam0) // Position - 0x25B2
{
	return uParam0->f_79 == 1;
}

BOOL func_37(int iParam0) // Position - 0x25C0
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_38(int iParam0) // Position - 0x2610
{
	return Global_44199 == iParam0;
}

BOOL func_39(int iParam0, int iParam1) // Position - 0x261E
{
...
void func_40(Hash hParam0, int iParam1) // Position - 0x266F
{
	int outValue;
...
void func_41(int iParam0, int iParam1) // Position - 0x2692
{
	int outValue;
...
int func_43(eCharacter echParam0) // Position - 0x2764
{
	return Global_2201[echParam0 /*29*/].f_17;
}

int func_44(int iParam0) // Position - 0x2775
{
	switch (iParam0)
	{
		case 0:
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27D0
{
	func_46();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_46() // Position - 0x27E9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_47(character) && !func_38(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_47(Global_114162.f_2367.f_539.f_4321))
...
BOOL func_47(eCharacter echParam0) // Position - 0x28E6
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x28F2
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x292F
{
...
Hash func_50(eCharacter echParam0) // Position - 0x2954
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_51(Vehicle veParam0) // Position - 0x2963
{
	Vehicle playersLastVehicle;
	Hash entityModel;

	if (func_54(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_52(veParam0))
	{
		playersLastVehicle = PLAYER::GET_PLAYERS_LAST_VEHICLE();
	
		if (func_52(playersLastVehicle))
		{
...
BOOL func_52(Vehicle veParam0) // Position - 0x29F4
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x2A1E
{
...
BOOL func_54(Ped pedParam0) // Position - 0x2A3F
{
...
BOOL func_55(Vehicle veParam0) // Position - 0x2A5F
{
	Vehicle playersLastVehicle;
	Hash entityModel;
...
void func_56(int* piParam0, float fParam1) // Position - 0x2ACB
{
	piParam0->f_1 = func_57(IS_BIT_SET(*piParam0, 4)) - fParam1;
...
float func_57(BOOL bParam0) // Position - 0x2AF6
{
	float num;
	float num2;
	int networkTime;
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x2B4E
{
	iParam2 = iParam2;
...
BOOL func_59(int* piParam0, float fParam1) // Position - 0x2B67
{
	if (func_60(piParam0, fParam1))
	{
		func_141(piParam0);
		return true;
	}
...
BOOL func_60(int* piParam0, float fParam1) // Position - 0x2B85
{
	if (func_82(piParam0))
		if (func_143(piParam0) > fParam1)
			return true;

	return false;
}

var func_61(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2BA7
{
	if (bParam0)
		return uParam1;
...
void func_62() // Position - 0x2BBE
{
	...
	if (!func_82(&uLocal_267))
		func_254(&uLocal_267);

	if (!func_82(&uLocal_270))
		func_254(&uLocal_270);
	...
	if (iLocal_427 < 7)
	{
		if (iLocal_427 <= 0)
		{
			if (func_143(&uLocal_267) > 0.2f)
			{
				...
				func_63(&uLocal_81, "DrfAud", "DRF_RUNOFF", &unk, 8, 0, 0);
				iLocal_427 = 1;
				func_127(&uLocal_267);
			}
		}
		else if (func_143(&uLocal_267) > 12f)
		{
	...
	if (iLocal_429 < 8)
	{
		if (iLocal_429 <= 0)
		{
			if (func_143(&uLocal_270) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(pedLocal_398))
			{
				...
				TEXT_LABEL_APPEND_INT(&unk, randomIntInRange + 1, 16);
				func_63(&uLocal_81, "DrfAud", "DRF_CHASE", &unk, 8, 0, 0);
				iLocal_429 = 1;
				func_127(&uLocal_270);
			}
		}
		else if (func_143(&uLocal_270) > 10.3f)
		{
...
int func_63(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2E89
{
	...
	Global_2883585 = 0;
	return func_64(sParam2, iParam4, false);
}

int func_64(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2EDD
{
	Global_22443 = 0;
...
BOOL func_67(Player plParam0) // Position - 0x3245
{
	return func_68(plParam0, 20);
}

BOOL func_68(Player plParam0, int iParam1) // Position - 0x3255
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x326D
{
	return -1;
}

void func_70() // Position - 0x3276
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x33FC
{
	if (func_38(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_76(int iParam0, int iParam1) // Position - 0x34F5
{
	switch (iParam0)
	{
		case 5:
...
void func_78(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3584
{
...
float func_79(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x35DA
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3638
{
...
float func_81(int iParam0) // Position - 0x36D3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_82(int* piParam0) // Position - 0x370D
{
	return IS_BIT_SET(*piParam0, 1);
}

Vector3 func_83(float fParam0, var uParam1, var uParam2) // Position - 0x371A
{
	float num;
	float num2;
...
Vector3 func_84(Vehicle veParam0) // Position - 0x3759
{
	var forwardVector;
	var rightVector;
	var upVector;
...
void func_85(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x37BE
{
	if (bParam0)
	{
...
BOOL func_86() // Position - 0x390D
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_87(Player plParam0, int iParam1) // Position - 0x3927
{
	BOOL flag;
...
int func_88(int iParam0, BOOL bParam1) // Position - 0x3980
{
	int num;
	int num2;
...
BOOL func_89(Player plParam0) // Position - 0x39C1
{
	Player player;
...
BOOL func_90(Player plParam0) // Position - 0x39E3
{
...
BOOL func_91() // Position - 0x3A22
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_92(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3A30
{
	int num;
...
void func_93(int iParam0) // Position - 0x3A63
{
	if (iParam0 == 1)
...
Vector3 func_94(Ped pedParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3A86
{
	var groundZ;
...
BOOL func_95(Ped pedParam0) // Position - 0x3ACC
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_96() // Position - 0x3AEA
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(veLocal_399, false) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_399, false))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_400))
		{
			...
			{
				VEHICLE::SET_VEHICLE_FIXED(veLocal_400);
				ENTITY::SET_ENTITY_INVINCIBLE(veLocal_400, true, 0);
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			if (!bLocal_434)
			{
				STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_83({ 12.4748f, -560.2881f, -1904.7095f } - { 12.4125f, -557.8768f, -1905.4998f }), 100f, 0);
				bLocal_434 = true;
				SYSTEM::WAIT(0);
			}
...
void func_98() // Position - 0x3ECF
{
	func_99();
	return;
}

void func_99() // Position - 0x3EDB
{
	Global_21308 = 0;
	func_100();
	return;
...
BOOL func_101(int iParam0, Ped pedParam1, var uParam2) // Position - 0x3F0C
{
	int num;
	var animDict;
	var animDictionary;
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x40F8
{
...
BOOL func_105(int* piParam0, int* piParam1, var uParam2) // Position - 0x4146
{
	BOOL isControlJustPressed;
	BOOL isControlJustPressed2;

	if (func_82(piParam0) && func_143(piParam0) > 1.3f)
	{
	...
	func_106(piParam1, 1128792064, 1, false, true, 1065353216);
	return false;
}

void func_106(int* piParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x41C4
{
	...
	if (!func_111(piParam0->f_1, 256) || func_111(piParam0->f_1, 8192) && PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL))
	{
		...
		if (MISC::IS_PC_VERSION())
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_111(piParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
				...
				if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*piParam0, "SET_DATA_SLOT"))
				{
					...
					for (j = 0; j < piParam0->f_2[i /*15*/].f_14; j = j + 1)
					{
						...
						if (!MISC::IS_STRING_NULL_OR_EMPTY(controlInstructionalButtonsString))
							func_110(controlInstructionalButtonsString);
					}
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(piParam0->f_2[i /*15*/]))
						func_109(piParam0->f_2[i /*15*/]);
				
					if (MISC::IS_PC_VERSION())
					{
						if (func_111(piParam0->f_1, 4096))
						{
		...
		value2 = bParam4 ? func_111(piParam0->f_1, 32) ? 1f : 0f : -1f;
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_108(&(piParam0->f_1), 256);
		func_107(&(piParam0->f_1), 128);
	}
...
void func_107(var uParam0, int iParam1) // Position - 0x447E
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_108(var uParam0, int iParam1) // Position - 0x4493
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_109(const char* sParam0) // Position - 0x44A4
{
...
void func_110(const char* sParam0) // Position - 0x44B6
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_111(int iParam0, int iParam1) // Position - 0x44C4
{
	return iParam0 && iParam1 != false;
}

BOOL func_112(int* piParam0) // Position - 0x44D3
{
	if (*piParam0 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
		{
			func_108(&(piParam0->f_1), 1);
			return true;
		}
	}
...
void func_113(int* piParam0) // Position - 0x44FA
{
	if (*piParam0 != 0)
	{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x451D
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_115(const char* sParam0, var uParam1, int iParam2) // Position - 0x4530
{
	BOOL playbackFlags;

	playbackFlags = func_126(uParam1->f_20);
	playbackFlags = playbackFlags | 4;
	playbackFlags = playbackFlags || func_116(uParam1, iParam2);
	playbackFlags = playbackFlags | 98304;
	CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST(sParam0, playbackFlags, 8);
	return;
}

BOOL func_116(var uParam0, int iParam1) // Position - 0x4568
{
	var unk;
	var string1;

	string1 = { func_117(uParam0, &unk, iParam1, true) };
...
struct<4> func_117(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4681
{
	var unk;
	int num;
	...
	if (func_125() <= 0)
		if (!func_124())
			num = func_121(1, 2, 3, 4, 12);
		else if (func_120() >= 1)
			num = func_121(5, 6, 7, 0, 0);
		else
			num = func_121(5, 7, 0, 0, 0);
	else if (func_125() >= 2)
		num = func_121(10, 11, 0, 0, 0);
	else if (!func_124())
		if (iParam2 != 4)
			num = func_121(8, 9, 0, 0, 0);
		else
			num = 9;
	else if (iParam2 != 4)
		num = func_121(8, 9, 10, 0, 0);
	else
		num = func_121(9, 10, 0, 0, 0);

	func_119(uParam0, num);

	if (bParam3)
		func_118(&(Global_114162.f_19965), num, true);
...
void func_118(var uParam0, int iParam1, BOOL bParam2) // Position - 0x4764
{
...
void func_119(var uParam0, int iParam1) // Position - 0x47A3
{
	uParam0->f_19 = iParam1;
	return;
}

int func_120() // Position - 0x47B1
{
	int i;
	int num;
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x47DF
{
	int i;
	int randomIntInRange;
	var unk;
	...
	if (iParam0 > 0 && iParam0 < 13 && !func_123(&(Global_114162.f_19965), iParam0))
		unk[iParam0] = 0;
	else if (iParam1 > 0 && iParam1 < 13 && !func_123(&(Global_114162.f_19965), iParam1))
		unk[iParam1] = 0;
	else if (iParam2 > 0 && iParam2 < 13 && !func_123(&(Global_114162.f_19965), iParam2))
		unk[iParam2] = 0;
	else if (iParam3 > 0 && iParam3 < 13 && !func_123(&(Global_114162.f_19965), iParam3))
		unk[iParam3] = 0;
	else if (iParam4 > 0 && iParam4 < 13 && !func_123(&(Global_114162.f_19965), iParam4))
		unk[iParam4] = 0;

	randomIntInRange = func_122(&unk, 13, 1, 13);
...
int func_122(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x49A1
{
	BOOL flag;
	int i;
	int j;
...
BOOL func_123(var uParam0, int iParam1) // Position - 0x4A14
{
	if (iParam1 < 0 || iParam1 > 12)
		return false;
...
BOOL func_124() // Position - 0x4A3F
{
	return Global_98155 > 0;
}

int func_125() // Position - 0x4A4D
{
	int i;
	int num;
...
BOOL func_126(int iParam0) // Position - 0x4A7B
{
	if (iParam0 == 0)
		return 1;
	else if (iParam0 == 1)
...
void func_127(int* piParam0) // Position - 0x4AA8
{
	func_56(piParam0, 0f);
	return;
}

void func_128() // Position - 0x4AB7
{
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
	func_129(0);
...
void func_129(int iParam0) // Position - 0x4AE4
{
	if (func_134())
		return;
...
void func_130(int iParam0) // Position - 0x4B17
{
	if (func_134())
		return;
...
void func_131(BOOL bParam0, BOOL bParam1) // Position - 0x4BA1
{
	if (bParam0)
	{
		if (func_133(0))
...
BOOL func_132() // Position - 0x4C15
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_133(int iParam0) // Position - 0x4C23
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
...
BOOL func_134() // Position - 0x4C7A
{
	return IS_BIT_SET(Global_1958240, 19);
}

int func_135(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4C89
{
	int num;
	int num2;
...
void func_136(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4D52
{
	if (*uParam0 == 0)
...
void func_137(int iParam0) // Position - 0x4DCC
{
	switch (iParam0)
	{
		case 0:
...
void func_138(int iParam0) // Position - 0x4E26
{
	if (Global_98610 != -1)
	{
...
void func_139(Ped pedParam0, var uParam1, var uParam2, var uParam3, var uParam4, Vector3 vParam5, var uParam6, var uParam7, float fParam8, Hash hParam9) // Position - 0x4E4A
{
	Hash entityModel;
...
void func_140(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4FE4
{
	int num;
	var animDictionary;
	var animDictionary2;
...
void func_141(int* piParam0) // Position - 0x5119
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
float func_143(int* piParam0) // Position - 0x5152
{
	if (func_82(piParam0))
		if (func_144(piParam0))
			return piParam0->f_2;
		else
			return func_57(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;

	return piParam0->f_1;
}

BOOL func_144(int* piParam0) // Position - 0x518E
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_145(const char* sParam0, Ped pedParam1, Hash hParam2, int iParam3) // Position - 0x519B
{
	var unk;
	int i;
	...
	unk.f_39 = 9;
	unk.f_49 = 9;
	func_146(pedParam1, &unk, iParam3);
...
void func_146(Ped pedParam0, var uParam1, int iParam2) // Position - 0x5256
{
	int i;
	var unk;
	var unk2;
	...
	unk2.f_49 = 9;
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	func_227(pedParam0, &unk2, 0, -1);
	func_227(pedParam0, uParam1, iParam2, -1);
	num = 0;
	num2 = 0;
	...
	for (i = 0; i < 12; i = i + 1)
	{
		...
		{
			if (func_224(entityModel, func_226(i), func_225(pedParam0, unk2.f_13[i], unk2[i], func_226(i)), &unk))
			{
				unk67 = { func_158(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
				num = 1;
			}
		
			if (func_156(entityModel, func_226(i), func_225(pedParam0, unk2.f_13[i], unk2[i], func_226(i)), &unk))
			{
				unk67 = { func_158(entityModel, 1, uParam1->f_62, -1) };
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		{
			if (func_224(entityModel, 14, func_148(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_158(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
			...
			if (func_156(entityModel, 14, func_148(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_158(entityModel, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = unk67.f_3;
				uParam1->[1] = unk67.f_4;
	...
	if (num2 || num)
	{
		num3 = func_225(pedParam0, uParam1->f_13[1], uParam1->[1], 1);
		num4 = func_225(pedParam0, uParam1->f_13[2], uParam1->[2], 2);
		num5 = func_147(entityModel, num4, num3);
	
		if (num5 != -99)
		{
			unk67 = { func_158(entityModel, 0, num5, -1) };
...
int func_147(Hash hParam0, int iParam1, int iParam2) // Position - 0x54CB
{
	switch (hParam0)
	{
...
int func_148(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5622
{
	Hash entityModel;
	...
	for (i = 0; i <= numberOfPedPropDrawableVariations - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= numberOfPedPropTextureVariations - 1; j = j + 1)
			{
				...
				{
					num = num + func_149(pedParam0, iParam3);
					return num;
				}
				else
				{
...
int func_149(Ped pedParam0, int iParam1) // Position - 0x571E
{
	Hash entityModel;
...
int func_150(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x585C
{
	var outfit;
	int i;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		if (shopPedQueryPropIndex != -1)
			return func_153(hParam0) + shopPedQueryPropIndex;
	}
	else
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_152(iParam2));
		shopPedQueryComponentIndex = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(hParam1);
	
		if (shopPedQueryComponentIndex != -1)
			return func_151(hParam0, func_152(iParam2)) + shopPedQueryComponentIndex;
	}

	return -99;
}

int func_151(Hash hParam0, ePedComponentType epctParam1) // Position - 0x5917
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_152(int iParam0) // Position - 0x5CBE
{
	switch (iParam0)
	{
		case 0:
...
int func_153(Hash hParam0) // Position - 0x5D6E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_154(Hash hParam0) // Position - 0x5DCF
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_155(int iParam0) // Position - 0x5E2E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_156(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x5EB4
{
	int num;
...
int func_157(Hash hParam0) // Position - 0x613E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_158(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6179
{
	func_223();
...
void func_159(int iParam0, int iParam1) // Position - 0x61CB
{
	switch (iParam0)
	{
		case 0:
...
void func_160(int iParam0) // Position - 0x62BB
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			func_169(num6, iParam0, 155, -1);
			return;
	}

	func_161(&Global_79347[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_161(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x7532
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_166(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_166(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_165(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_165(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_165(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_22(func_164(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_22(func_163(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_162(iParam1, iParam0->f_2, &num2))
			{
				num = func_22(num2, Global_79344);
...
BOOL func_162(int iParam0, int iParam1, var uParam2) // Position - 0x78D4
{
	*uParam2 = 979;
...
int func_163(int iParam0, int iParam1) // Position - 0x7CD9
{
	switch (iParam1)
	{
		case 0:
...
int func_164(int iParam0, int iParam1) // Position - 0x80D6
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_165(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x84D1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_166(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9374
{
	int num;
	int num2;
	int num3;
	...
	if (func_167(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
		num4 = func_22(num3, num);
...
BOOL func_167(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x93B2
{
...
int func_168(int iParam0) // Position - 0xBFD5
{
	switch (iParam0)
	{
		case -1:
...
void func_169(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xC0CD
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_161(&Global_79347[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_161(&Global_79347[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_161(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_161(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_152(iParam0));
...
void func_170(int iParam0) // Position - 0xC354
{
	BOOL flag;
	int num;
	var unk;
...
void func_171(int iParam0) // Position - 0xC4AB
{
	BOOL flag;
	int num;
	var unk;
...
void func_172(int iParam0) // Position - 0xC9B9
{
	BOOL flag;
	int num;
	var unk;
...
void func_173(int iParam0) // Position - 0xCA2E
{
	BOOL flag;
	int num;
	var unk;
...
void func_174(int iParam0) // Position - 0xCAA2
{
	BOOL flag;
	int num;
	var unk;
...
void func_175(int iParam0) // Position - 0xCB89
{
	BOOL flag;
	int num;
	var unk;
...
void func_176(int iParam0) // Position - 0xCEEC
{
	BOOL flag;
	int num;
	var unk;
...
void func_177(int iParam0) // Position - 0xD0FD
{
	BOOL flag;
	int num;
	var unk;
...
void func_178(int iParam0) // Position - 0xD32D
{
	BOOL flag;
	int num;
	var unk;
...
void func_179(int iParam0) // Position - 0xD43D
{
	BOOL flag;
	int num;
	var unk;
...
void func_180(int iParam0) // Position - 0xDDDC
{
	BOOL flag;
	int num;
	var unk;
...
void func_181(int iParam0) // Position - 0xE94F
{
	if (iParam0 < 136)
		func_183(iParam0);
	else
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_169(3, iParam0, 242, -1);

	return;
}

void func_182(int iParam0) // Position - 0xE984
{
	BOOL flag;
	int num;
	var unk;
...
void func_183(int iParam0) // Position - 0xF588
{
	BOOL flag;
	int num;
	var unk;
...
void func_184(int iParam0) // Position - 0x10498
{
	BOOL flag;
	int num;
	var unk;
...
void func_185(int iParam0) // Position - 0x105C5
{
	BOOL flag;
	int num;
	var unk;
...
void func_186(int iParam0, int iParam1) // Position - 0x106C3
{
	switch (iParam0)
	{
		case 0:
...
void func_187(int iParam0) // Position - 0x107B3
{
	BOOL flag;
	int num;
	var unk;
...
void func_188(int iParam0) // Position - 0x11CA4
{
	BOOL flag;
	int num;
	var unk;
...
void func_189(int iParam0) // Position - 0x11DF5
{
	BOOL flag;
	int num;
	var unk;
...
void func_190(int iParam0) // Position - 0x12300
{
	BOOL flag;
	int num;
	var unk;
...
void func_191(int iParam0) // Position - 0x1296E
{
	BOOL flag;
	int num;
	var unk;
...
void func_192(int iParam0) // Position - 0x129E2
{
	BOOL flag;
	int num;
	var unk;
...
void func_193(int iParam0) // Position - 0x12AB2
{
	BOOL flag;
	int num;
	var unk;
...
void func_194(int iParam0) // Position - 0x12FE2
{
	BOOL flag;
	int num;
	var unk;
...
void func_195(int iParam0) // Position - 0x13179
{
	BOOL flag;
	int num;
	var unk;
...
void func_196(int iParam0) // Position - 0x13977
{
	BOOL flag;
	int num;
	var unk;
...
void func_197(int iParam0) // Position - 0x13A87
{
	BOOL flag;
	int num;
	var unk;
...
void func_198(int iParam0) // Position - 0x149B4
{
	BOOL flag;
	int num;
	var unk;
...
void func_199(int iParam0) // Position - 0x15671
{
	if (iParam0 < 107)
		func_202(iParam0);
	else if (iParam0 < 227)
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_169(3, iParam0, 318, -1);

	return;
}

void func_200(int iParam0) // Position - 0x156B7
{
	BOOL flag;
	int num;
	var unk;
...
void func_201(int iParam0) // Position - 0x1615C
{
	BOOL flag;
	int num;
	var unk;
...
void func_202(int iParam0) // Position - 0x16F4B
{
	BOOL flag;
	int num;
	var unk;
...
void func_203(int iParam0) // Position - 0x17B94
{
	BOOL flag;
	int num;
	var unk;
...
void func_204(int iParam0) // Position - 0x17E0D
{
	BOOL flag;
	int num;
	var unk;
...
void func_205(int iParam0, int iParam1) // Position - 0x17F53
{
	switch (iParam0)
	{
		case 0:
...
void func_206(int iParam0) // Position - 0x18045
{
	BOOL flag;
	int num;
	var unk;
...
void func_207(int iParam0) // Position - 0x18DCF
{
	BOOL flag;
	int num;
	var unk;
...
void func_208(int iParam0) // Position - 0x18F49
{
	BOOL flag;
	int num;
	var unk;
...
void func_209(int iParam0) // Position - 0x194C0
{
	BOOL flag;
	int num;
	var unk;
...
void func_210(int iParam0) // Position - 0x199EA
{
	BOOL flag;
	int num;
	var unk;
...
void func_211(int iParam0) // Position - 0x19A5E
{
	BOOL flag;
	int num;
	var unk;
...
void func_212(int iParam0) // Position - 0x19B2E
{
	BOOL flag;
	int num;
	var unk;
...
void func_213(int iParam0) // Position - 0x1A006
{
	BOOL flag;
	int num;
	var unk;
...
void func_214(int iParam0) // Position - 0x1A26F
{
	BOOL flag;
	int num;
	var unk;
...
void func_215(int iParam0) // Position - 0x1A545
{
	BOOL flag;
	int num;
	var unk;
...
void func_216(int iParam0) // Position - 0x1A70E
{
	BOOL flag;
	int num;
	var unk;
...
void func_217(int iParam0) // Position - 0x1B262
{
	BOOL flag;
	int num;
	var unk;
...
void func_218(int iParam0) // Position - 0x1BEAC
{
	if (iParam0 < 60)
		func_220(iParam0);
	else
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_169(3, iParam0, 181, -1);

	return;
}

void func_219(int iParam0) // Position - 0x1BEE1
{
	BOOL flag;
	int num;
	var unk;
...
void func_220(int iParam0) // Position - 0x1CD79
{
	BOOL flag;
	int num;
	var unk;
...
void func_221(int iParam0) // Position - 0x1D405
{
	BOOL flag;
	int num;
	var unk;
...
void func_222(int iParam0) // Position - 0x1D4EC
{
	BOOL flag;
	int num;
	var unk;
...
void func_223() // Position - 0x1D5EA
{
...
BOOL func_224(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1D663
{
	int num;
...
int func_225(Ped pedParam0, int iParam1, var uParam2, int iParam3) // Position - 0x1D96A
{
...
int func_226(int iParam0) // Position - 0x1D9C1
{
	switch (iParam0)
	{
		case 0:
...
void func_227(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1DA71
{
	eCharacter character;
	ePedComponentType i;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			func_231(pedParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = PV_COMP_HEAD; i < PV_COMP_TASK; i = i + 1)
		{
			func_230(pedParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
		...
		{
			if (func_228(161, iParam3))
				uParam1->f_59 = func_22(2053, iParam3);
			else
				uParam1->f_59 = func_22(753, iParam3);
		
			uParam1->f_60 = func_22(754, iParam3);
			uParam1->f_61 = func_22(755, iParam3);
		}
...
BOOL func_228(int iParam0, int iParam1) // Position - 0x1DC0B
{
	Hash statHash;
	BOOL outValue;
...
Hash func_229(int iParam0, int iParam1) // Position - 0x1DC2F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_17(iParam1));
}

void func_230(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x1DC44
{
	eCharacter character;
...
void func_231(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x1E18D
{
	eCharacter character;
...
void func_232(const char* sParam0, int iParam1) // Position - 0x1E3CE
{
	int bitShift;
	BOOL playbackFlags;
	...
	playbackFlags = 15;
	playbackFlags = playbackFlags || func_240(iParam1, true);
	playbackFlags = playbackFlags || SYSTEM::SHIFT_LEFT(64, bitShift);
	playbackFlags = playbackFlags || SYSTEM::SHIFT_LEFT(func_233(iParam1), bitShift);
	CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST(sParam0, playbackFlags, 8);
	return;
}

int func_233(int iParam0) // Position - 0x1E425
{
	var unk;
	var string1;

	string1 = { func_234(iParam0, true, true, &unk) };
...
struct<4> func_234(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3) // Position - 0x1E52E
{
	var unk;
	int num;
	int address;
	...
	if (!func_239(&(Global_114162.f_19965), 8) && bParam1 && iParam0 != 4 && func_237(3) > 0 && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f)
	{
		num = 8;
		*uParam3 = 4;
	}
	...
	{
		if (!func_239(&(Global_114162.f_19965), 1) && func_237(5) > 0)
		{
			MISC::SET_BIT(&address, 1);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 2) && func_237(7) >= 2)
		{
			MISC::SET_BIT(&address, 2);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 3) && func_237(8) > 0 || func_237(9) > 0 && func_237(7) > 0 && bParam1 && iParam0 != 4)
		{
			MISC::SET_BIT(&address, 3);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 4) && func_237(1) > 0 && func_237(1) < 3)
		{
			MISC::SET_BIT(&address, 4);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 5) && func_237(1) >= 3)
		{
			MISC::SET_BIT(&address, 5);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 6) && func_237(0) > 0)
		{
			MISC::SET_BIT(&address, 6);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 7))
		{
			MISC::SET_BIT(&address, 7);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 8) && bParam1 && func_237(3) > 0 && iParam0 != 4)
		{
			MISC::SET_BIT(&address, 8);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 9))
		{
			MISC::SET_BIT(&address, 9);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 10))
		{
			MISC::SET_BIT(&address, 10);
			num2 = num2 + 1;
		}
	
		if (!func_239(&(Global_114162.f_19965), 11))
		{
		...
		{
			if (iParam0 != 4)
				num = func_236(7, 9, 10, 11, 0);
			else
				num = func_236(7, 9, 10, 0, 0);
		}
		else
		{
	...
	if (bParam2)
		func_235(&(Global_114162.f_19965), num, true);
...
void func_235(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1E88E
{
...
int func_236(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1E8C7
{
	int i;
	int randomIntInRange;
	var unk;
	...
	if (iParam0 > 0 && iParam0 < 12 && !func_239(&(Global_114162.f_19965), iParam0))
	{
		unk[iParam0] = 0;
		flag = true;
	}

	if (iParam1 > 0 && iParam1 < 12 && !func_239(&(Global_114162.f_19965), iParam1))
	{
		unk[iParam1] = 0;
		flag = true;
	}

	if (iParam2 > 0 && iParam2 < 12 && !func_239(&(Global_114162.f_19965), iParam2))
	{
		unk[iParam2] = 0;
		flag = true;
	}

	if (iParam3 > 0 && iParam3 < 12 && !func_239(&(Global_114162.f_19965), iParam3))
	{
		unk[iParam3] = 0;
		flag = true;
	}

	if (iParam4 > 0 && iParam4 < 12 && !func_239(&(Global_114162.f_19965), iParam4))
	{
		unk[iParam4] = 0;
		flag = true;
	}
	...
	randomIntInRange = func_122(&unk, 12, 1, 12);
...
int func_237(int iParam0) // Position - 0x1EA92
{
	switch (iParam0)
	{
		case 0:
			return func_238(&Global_98156, 1);
	
		case 1:
			return func_238(&Global_98158, 3);
	
		case 2:
			return func_238(&Global_98162, 1);
	
		case 3:
			return func_238(&Global_98164, 1);
	
		case 4:
			return func_238(&Global_98166, 1);
	
		case 5:
			return func_238(&Global_98168, 1);
	
		case 6:
			return func_238(&Global_98170, 1);
	
		case 7:
			return func_238(&Global_98172, 2);
	
		case 8:
			return func_238(&Global_98175, 1);
	
		case 9:
			return func_238(&Global_98177, 1);
	}

	return 0;
}

int func_238(var uParam0, int iParam1) // Position - 0x1EB74
{
	int i;
	int num;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0x1EBA1
{
	if (iParam1 < 0 || iParam1 > 11)
		return false;
...
BOOL func_240(int iParam0, BOOL bParam1) // Position - 0x1EBC6
{
	switch (iParam0)
	{
		case 0:
			if (func_241(19) && !func_241(20))
				if (func_241(44))
					return 32;
				else
					return 16;
		...
		case 1:
			if (func_241(20) && !func_241(59))
				if (!func_241(21) || func_241(72) || func_241(73))
					if (func_241(21))
						return 64;
					else if (func_241(29))
						return 32;
		...
		case 4:
			if (func_241(48) && func_241(61) && func_241(22))
				if (func_241(27))
					return 64;
				else if (func_241(24))
					return 32;
				else if (!func_241(84) && !func_241(85))
					return 16;
			break;
	}
...
BOOL func_241(int iParam0) // Position - 0x1ECE0
{
...
void func_242(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1ED0C
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_243(int iParam0, BOOL bParam1) // Position - 0x1ED85
{
	char* string2;
	Interior interior;
	...
	string2 = "NULL";
	interior = 0;
	string2 = func_247(iParam0, &interior);
...
BOOL func_244(int iParam0) // Position - 0x1EE31
{
	int num;
...
struct<2> func_245(int iParam0) // Position - 0x1EE62
{
	int num;
...
void func_246(int iParam0, BOOL bParam1) // Position - 0x1EE8F
{
	int offset;

	offset = { func_245(iParam0) };
...
char* func_247(int iParam0, var uParam1) // Position - 0x1EED2
{
	Vector3 vector;

	vector = { func_248(iParam0) };
	*uParam1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vector, vector.f_3);
	return vector.f_4;
}

struct<5> func_248(int iParam0) // Position - 0x1EEF7
{
	var unk;
	var unk6;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x21B59
{
...
var func_250(var uParam0) // Position - 0x21B83
{
	return uParam0;
}

struct<6> func_251(int iParam0, BOOL bParam1) // Position - 0x21B8D
{
	var unk;
...
BOOL func_252(var uParam0) // Position - 0x22743
{
...
BOOL func_253(var uParam0) // Position - 0x22775
{
	int i;
...
void func_254(int* piParam0) // Position - 0x227BC
{
	if (!func_82(piParam0))
		func_127(piParam0);
...
void func_255() // Position - 0x227D4
{
	Global_23848.f_5 = 1;
	return;
}

void func_256(var uParam0, Hash hParam1, Hash hParam2, Hash hParam3, Hash hParam4, Hash hParam5, int iParam6) // Position - 0x227E2
{
	func_259(uParam0, hParam1);
	func_259(uParam0, hParam3);
	func_259(uParam0, hParam2);
	func_259(uParam0, hParam5);

	if (iParam6 == 4)
		func_259(uParam0, hParam4);
...
void func_257() // Position - 0x22862
{
...
void func_258(var uParam0) // Position - 0x2287A
{
	int i;
...
int func_259(var uParam0, Hash hParam1) // Position - 0x228AA
{
	int i;
	int num;
...
int func_260(var uParam0) // Position - 0x22907
{
	int i;
...
BOOL func_261() // Position - 0x22933
{
	int weaponHash;
...
void func_262(char* sParam0, int iParam1) // Position - 0x2299A
{
	switch (iParam1)
	{
		case 0:
...
int func_263() // Position - 0x22A7D
{
	return 1;
}

void func_264(var uParam0, Vehicle* pveParam1, Cam caParam2, int iParam3) // Position - 0x22A86
{
	HUD::DISPLAY_HUD(true);
	HUD::DISPLAY_RADAR(true);
	func_268();
...
void func_265() // Position - 0x22B60
{
	int i;
...
void func_266() // Position - 0x22B9E
{
	int num;
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		{
			case 0:
				func_267(&Global_98156, 1);
				break;
		
			case 1:
				func_267(&Global_98158, 3);
				break;
		
			case 2:
				func_267(&Global_98162, 1);
				break;
		
			case 3:
				func_267(&Global_98164, 1);
				break;
		
			case 4:
				func_267(&Global_98166, 1);
				break;
		
			case 5:
				func_267(&Global_98168, 1);
				break;
		
			case 6:
				func_267(&Global_98170, 1);
				break;
		
			case 7:
				func_267(&Global_98172, 2);
				break;
		
			case 8:
				func_267(&Global_98175, 1);
				break;
		
			case 9:
				func_267(&Global_98177, 1);
				break;
		}
	}
...
void func_267(var uParam0, int iParam1) // Position - 0x22C78
{
	int i;
...
void func_268() // Position - 0x22C9A
{
	Global_21308 = 0;
	func_77();
	return;
...
void func_269() // Position - 0x22CAA
{
	int num;
...
void func_270() // Position - 0x22D1B
{
	Global_101748 = 1;
...
BOOL func_271(int iParam0) // Position - 0x22E08
{
	int num;
	int num2;
	...
	func_272(&(Global_114162.f_2367.f_539), num2);
...
void func_272(var uParam0, int iParam1) // Position - 0x22F18
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_274(Global_114162.f_18537[i], &unk, &num2))
			{
				Global_114162.f_18537[i] = 318;
				func_273(&uParam0->f_2296[i]);
...
void func_273(var uParam0) // Position - 0x230DE
{
	*uParam0 = -15;
	return;
}

BOOL func_274(int iParam0, var uParam1, var uParam2) // Position - 0x230EC
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_274(8, uParam1, uParam2);
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x23A5B
{
	if (bParam1)
...
BOOL func_277() // Position - 0x23ACB
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x23B09
{
...
void func_279(BOOL bParam0, BOOL bParam1) // Position - 0x23B31
{
	int num;
	int num2;
	var unk;
...
BOOL func_280(int iParam0) // Position - 0x23C01
{
	switch (iParam0)
	{
		case 71:
...
void func_281(int iParam0, int iParam1) // Position - 0x23C3F
{
	if (iParam0 == 146 || iParam0 == -1)
		return;
...
void func_282() // Position - 0x23C84
{
	Global_23848.f_5 = 0;
	return;
}

var func_283(BOOL bParam0, var uParam1, var uParam2) // Position - 0x23C92
{
	if (bParam0)
		return uParam1;
...
BOOL _GET_RANDOM_BOOL() // Position - 0x23CA9
{
