...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_322(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (num == 4)
	{
		...
		uLocal_269 = unk_0x1DD05E817C89C737();
	}
	...
	while (true)
	{
		...
		func_225(num);
		func_218(&iLocal_91, &(num.f_9), unk61);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_215(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_214(&num, uLocal_95, true, 0);
			else if (num == 3)
				func_215(&num, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_200(&uLocal_103, unk_0xD1A6A821F5AC81DB(num.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
	
		num2 = 0;
	
		if (func_199(num))
		{
			if (unk_0x1DD05E817C89C737() - uLocal_92 > 5000)
			{
				num2 = 1;
				uLocal_92 = unk_0x1DD05E817C89C737();
			}
		}
...
void func_3(int iParam0, var uParam1) // Position - 0x40D
{
	func_21(uParam1);
...
void func_21(var uParam0) // Position - 0xD86
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xDB6
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A8F
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x293A
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x29C2
{
...
BOOL func_29(var uParam0) // Position - 0x2A02
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2A30
{
...
int func_31(var uParam0) // Position - 0x2B0C
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2B4E
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2BB1
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2C3F
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2EE9
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3508
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3637
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x377E
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x37BB
{
...
int func_47(eCharacter echParam0) // Position - 0x37E0
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x37EF
{
...
var func_50(int iParam0, int iParam1) // Position - 0x39B8
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3A31
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A46
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F8F
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x42F6
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x43E9
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x490A
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x568B
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x56C6
{
	int num;
...
void func_67(int iParam0) // Position - 0x593A
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5976
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EC5
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F09
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6688
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66CF
{
...
BOOL func_73(int iParam0) // Position - 0x672A
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x673A
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x679A
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B51
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6B5C
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B6C
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C0E
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7388
{
...
int func_81() // Position - 0x7683
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7692
{
...
int func_83() // Position - 0x76BC
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x76D4
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x76E9
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7700
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7758
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7802
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7897
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x78DB
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A5F
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A6D
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8539
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x85BB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8613
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x861C
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x88A3
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x88B3
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88D0
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88E0
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C23
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8C34
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C7A
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D00
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D33
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D84
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8E26
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E48
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E5F
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E6C
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8EA6
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EE1
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F1D
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F36
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F99
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8FAF
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8FC5
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9007
{
...
struct<2> func_119(int iParam0) // Position - 0x902F
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x947C
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA754
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA9A
{
	int num;
...
void func_124(int iParam0) // Position - 0xAB3F
{
	var unk;
...
void func_125(int iParam0) // Position - 0xABDA
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAC38
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC91
{
...
int func_129(int iParam0) // Position - 0xAD14
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD45
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD5A
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE0D
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE28
{
	int i;
...
int func_135(int iParam0) // Position - 0xAE74
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAEBD
{
...
BOOL func_137(int iParam0) // Position - 0xAEDD
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAFAD
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xB000
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB0F6
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB161
{
	var unk;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB1A0
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB2EF
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_145(int iParam0, int iParam1) // Position - 0xB309
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB362
{
	int num;
	int num2;
...
BOOL func_147(int iParam0) // Position - 0xB3A3
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB3C5
{
...
BOOL func_149() // Position - 0xB404
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB412
{
	int num;
...
void func_152(int iParam0) // Position - 0xB46C
{
	if (iParam0 == 1)
...
BOOL func_153(var uParam0) // Position - 0xB48F
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB533
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5C2
{
...
void func_160(var uParam0) // Position - 0xB619
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB645
{
...
void func_163(int iParam0) // Position - 0xB7E7
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB81A
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB8A4
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB918
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_167(int iParam0) // Position - 0xB926
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB97D
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_169(int iParam0) // Position - 0xB98C
{
...
BOOL func_170(int iParam0) // Position - 0xB9CD
{
	int num;
...
void func_171(int iParam0) // Position - 0xBA12
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA44
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB7B
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBCA
{
	return func_175(iParam0, Global_44181);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBBDB
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBDBC
{
	if (Global_44181 == 15)
		return false;
...
int func_177() // Position - 0xBDDE
{
	return func_178(unk_0x1AF90EB93E0012D6(), 0);
}

int func_178(var uParam0, int iParam1) // Position - 0xBDEF
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE38
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE5C
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC2CC
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2F8
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC30F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC39E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_185() // Position - 0xCB81
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_186(var uParam0) // Position - 0xCB9C
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCC2A
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC8E
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCD25
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_190(int iParam0) // Position - 0xCD4F
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_198() || Global_113182 || Global_33090 || func_197() || func_196(8, -1) || func_101() || func_195() || func_194() || func_193() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_198() || Global_33090 || func_197() || func_196(8, -1) || func_194() || func_101() || func_195() || func_193() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_198() || Global_113182 || Global_33090 || func_197() || func_196(8, -1) || func_194() || func_101() || func_195() || func_193() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_198() || Global_113182 || Global_33090 || func_197() || func_196(8, -1) || func_101() || func_195() || func_193() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_198() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_196(8, -1) || func_193() || func_192() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_191() // Position - 0xD46C
{
	return Global_101727.f_1;
}

BOOL func_192() // Position - 0xD47A
{
	if (Global_98585 != -1)
...
BOOL func_195() // Position - 0xD4E1
{
	return Global_101740.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD4F2
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD52A
{
	return Global_1575084;
}

BOOL func_198() // Position - 0xD536
{
	if (!unk_0x76CD105BCAC6EB9F())
...
BOOL func_199(int iParam0) // Position - 0xD552
{
	switch (iParam0)
	{
		case 5:
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD575
{
	switch (*uParam0)
	{
		case 0:
			if (unk_0x1DD05E817C89C737() - uLocal_269 > 5000)
				*uParam0 = 1;
			break;
	
		case 1:
			if (func_213(unk_0x4A8C381C258A124D(), uParam1, 1) <= 20f)
		...
		case 2:
			...
			else if (func_213(unk_0x4A8C381C258A124D(), uParam1, 1) >= 25f)
			{
				func_154();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD612
{
...
BOOL func_202(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD660
{
	Global_22426 = 0;
...
BOOL func_205(int iParam0) // Position - 0xD9C8
{
	return func_206(iParam0, 20);
}

BOOL func_206(int iParam0, int iParam1) // Position - 0xD9D8
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

void func_207() // Position - 0xD9F0
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDB50
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_212(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC4A
{
...
float func_213(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDCA0
{
	var unk;
...
void func_214(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDCDA
{
	var unk;
	int num;
	...
	unk_0x10425721983AE158(0, uParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | num, 0, 0, 0, 0);
	unk_0x10425721983AE158(0, uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 1 | num, 0, 0, 0, 0);
	unk_0x93C0674FC00824D0(unk);
	unk_0x4BD42B0527065BB6(uParam0->f_28[iParam10], unk);
	unk_0xD0557B139A542F12(&unk);
	return;
}

BOOL func_215(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDD77
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_213(unk_0x4A8C381C258A124D(), uParam1, 1) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDDFF
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDE3A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE5B
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_213(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_221(uParam0, 1);
			}
			else
			{
				...
				if (func_213(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_223(uParam0);
			}
		}
	}
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xDF4C
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xDF88
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xDFC1
{
	BOOL flag;
	int i;
...
BOOL func_222() // Position - 0xE05F
{
	return Global_98972;
}

void func_223(var uParam0) // Position - 0xE06B
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE082
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0) // Position - 0xE16A
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE192
{
	var unk;
	...
	if (func_263(*panParam0) || func_261(*panParam0) || Global_79785 == 1)
		return true;
...
void func_227(int iParam0, var uParam1, int iParam2) // Position - 0xE402
{
	var unk;
	var unk2;
...
BOOL func_228(int iParam0) // Position - 0xE75A
{
...
BOOL func_229(var uParam0) // Position - 0xE77A
{
...
BOOL func_230(var uParam0) // Position - 0xE792
{
...
void func_231(var uParam0) // Position - 0xE7B7
{
	int i;
	var unk;
...
void func_232(var uParam0) // Position - 0xEABB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_233(var uParam0) // Position - 0xEAE6
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB66
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_235(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_235(var uParam0, var uParam1) // Position - 0xED24
{
	var unk;
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xED54
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF010
{
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF044
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_249(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF0BA
{
	return func_240(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF0D2
{
	BOOL flag;
	var unk;
	int num;

	num = func_248(uParam0, uParam1);
	...
	if (!func_244(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_241(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF193
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_242(var uParam0, int iParam1) // Position - 0xF2BF
{
	int num;
...
BOOL func_244(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF3CE
{
	var unk;
	var unk4;
	float num;

	unk = { func_246(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_246(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_245(unk4, unk);
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF45F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xF480
{
	float num;
	float num2;
...
void func_247(var uParam0) // Position - 0xF4BF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(var uParam0, var uParam1) // Position - 0xF4DA
{
	int i;
...
int func_249(var uParam0) // Position - 0xF519
{
...
BOOL func_250(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF541
{
	float num;
	float num2;
	int num3;
...
BOOL func_251(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF63C
{
	float num;
	float num2;
...
BOOL func_252(var uParam0, float fParam1) // Position - 0xF748
{
	var unk;
	var unk2;
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF7DD
{
	var unk;
	var unk4;
	float num;

	unk = { func_246(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_254(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF86B
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_255(int iParam0) // Position - 0xF8B3
{
...
void func_256(var uParam0) // Position - 0xF8FD
{
	var unk;
...
BOOL func_257(int iParam0) // Position - 0xF99A
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_258(int iParam0) // Position - 0xFA2F
{
...
BOOL func_261(int iParam0) // Position - 0xFAAE
{
	if (func_262() && Global_101688.f_11 == 6 && iParam0 == func_178(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_262() // Position - 0xFAE2
{
...
BOOL func_263(int iParam0) // Position - 0xFB20
{
...
void func_264() // Position - 0xFB48
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
		if (func_265(unk_0x4A8C381C258A124D(), unk, num, 1))
			func_162();

	return;
}

BOOL func_265(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFB8B
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

void func_266(var uParam0) // Position - 0xFBA9
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
		unk_0x0FB8E752BCC547A9(uParam0->f_28[0], 64, 1);
		unk_0x0FB8E752BCC547A9(uParam0->f_28[0], 249, 1);
...
void func_267(var uParam0) // Position - 0xFC19
{
	int i;
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		for (i = 0; i <= 5; i = i + 1)
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[i]))
				unk_0x5D7CD709B34C90F0(uParam0->f_41[i], 0);
		}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFCB3
{
...
void func_271(var uParam0, char* sParam1) // Position - 0xFE5F
{
...
void func_272(var uParam0) // Position - 0xFE88
{
	int i;
...
BOOL func_273(var uParam0) // Position - 0xFEB5
{
	uParam0->f_16 = 3;
...
BOOL func_274(var uParam0) // Position - 0xFEE0
{
	int num;
	var unk4;
	var unk7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_275(&uParam0->f_41[0], num[1], unk4 + unk10, 0f);
			
				if (unk_0xFC8BFE4B41177C22(uParam0->f_41[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
					unk_0x4D306DD94DD6FDBA(uParam0->f_41[0], uParam0->f_35[0], 0, unk10, unk13, 0, 0, 0, 0, 2, 1, 0);
				else
					flag = false;
			}
...
void func_275(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10167
{
	func_232(uParam0);
...
void func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1018E
{
	func_277(uParam0);
...
void func_277(var uParam0) // Position - 0x101D1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_278(var uParam0) // Position - 0x1026D
{
	int i;
...
BOOL func_279(var uParam0) // Position - 0x1029E
{
	int num;
	var unk5;
	var unk8;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[0]))
			{
				func_275(&uParam0->f_41[0], num[1], unk5 + unk8, 0f);
			
				if (unk_0xFC8BFE4B41177C22(uParam0->f_41[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
					unk_0x4D306DD94DD6FDBA(uParam0->f_41[0], uParam0->f_35[0], 0, unk8, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1, 0);
				else
					flag = false;
			}
		
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
				func_276(&uParam0->f_35[1], num[2], unk11, num3);
		
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				func_280(&uParam0->f_28[0], num[3], unk11, num3, 6);
		
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[1]))
				func_280(&uParam0->f_28[1], num[3], unk11, num3, 6);
...
void func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x105EE
{
	func_281(uParam0);
	*uParam0 = unk_0xB1DBFEB95C0EFB88(iParam6, uParam1, uParam2, fParam5, 0, 0);
	return;
}

void func_281(var uParam0) // Position - 0x1060F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_282(var uParam0) // Position - 0x10650
{
	int num;
	var unk3;
	float num2;
...
BOOL func_283(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10848
{
	if (func_284(uParam0, echParam1, uParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_284(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x108A4
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_326(echParam1);
...
int func_285(var uParam0, eCharacter echParam1) // Position - 0x10932
{
	int num;
...
BOOL func_286(var uParam0) // Position - 0x10978
{
	if (func_230(uParam0))
	{
...
void func_287(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x109A2
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_288(var uParam0) // Position - 0x109DE
{
	int num;
	var unk6;
	float num2;
	...
	num = 5;
	unk6 = { 190.2424f, -956.479f, 29.08f };
	num2 = 69.171f;
	num[0] = iLocal_90;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_283(&uParam0->f_28[0], CHAR_BARRY, unk6, num2, "RC LAUNCHER: BARRY 2", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				unk_0xB2BD5837A8D3CEDA(uParam0->f_28[0], unk6, 1, 0, 0, 1);
...
void func_289(var uParam0, var uParam1) // Position - 0x10D7D
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_275(uParam0, uParam1, unk, num);
	return;
}

float func_290(float fParam0) // Position - 0x10DAD
{
	return fParam0 * 57.29578f;
}

BOOL func_291(var uParam0) // Position - 0x10DBD
{
	int num;
	var unk8;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
				if (func_283(&uParam0->f_28[0], CHAR_BARRY, unk8, num2, "RC LAUNCHER: BARRY 1", 1))
					unk_0x7F08C4791E6D6969(uParam0->f_28[0], 1, 0, 0, 0, 1);
				else
					flag = false;
...
BOOL func_292(int iParam0) // Position - 0x1121C
{
	var unk;
	eCharacter character;
...
BOOL func_293(int iParam0) // Position - 0x1126D
{
	var unk;
...
BOOL func_294(int iParam0) // Position - 0x11326
{
	var unk;
...
BOOL func_295(int iParam0) // Position - 0x113E7
{
	int i;
	var unk;
	int num;
...
BOOL func_296(int iParam0, char* sParam1) // Position - 0x1146C
{
...
BOOL func_297(int iParam0) // Position - 0x1154E
{
...
BOOL func_298(int iParam0) // Position - 0x11579
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_299(int iParam0) // Position - 0x115A4
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_300(int iParam0) // Position - 0x115CF
{
	if (func_258(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_301() // Position - 0x11604
{
...
BOOL func_302(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1161E
{
	int num;
	int i;
...
BOOL func_303(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x116AF
{
	int num;
	char* str;
...
BOOL func_304(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11727
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_305(var uParam0, BOOL bParam1) // Position - 0x117A2
{
	char* str;
	...
	if (unk_0xC450B06E5AAA0985(uLocal_94))
		unk_0xFE54B8568B2ABD12(&uLocal_94);
...
void func_306(char* sParam0) // Position - 0x11837
{
...
void func_307() // Position - 0x11856
{
	Global_21291 = 0;
	func_308();
	return;
...
void func_308() // Position - 0x11866
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
BOOL func_309(char* sParam0) // Position - 0x11887
{
	var unk;
...
struct<6> func_310() // Position - 0x118A7
{
	var unk;
...
int func_311(var uParam0) // Position - 0x118CB
{
	if (func_230(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_312(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11901
{
...
void func_313(var uParam0, BOOL bParam1) // Position - 0x11921
{
	func_314(&(uParam0->f_41), bParam1);
	return;
}

void func_314(var uParam0, BOOL bParam1) // Position - 0x11933
{
	int i;
...
void func_315(var uParam0, BOOL bParam1) // Position - 0x11971
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x119AC
{
	func_317(&(uParam0->f_35), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x119BE
{
	int i;
...
void func_318(var uParam0) // Position - 0x119FB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_319(var uParam0, int iParam1) // Position - 0x11A33
{
	func_320(&(uParam0->f_28), iParam1);
	return;
}

void func_320(var uParam0, int iParam1) // Position - 0x11A45
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_321(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_321(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11A86
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_322(int iParam0) // Position - 0x11AD6
{
	if (*iParam0 == -1)
		return;
...
void func_323(char* sParam0) // Position - 0x11B13
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_324(var uParam0) // Position - 0x11B25
{
	*uParam0 = -1;
...
void func_325() // Position - 0x11B58
{
...
int func_326(eCharacter echParam0) // Position - 0x11B72
{
	if (!func_36(echParam0))
