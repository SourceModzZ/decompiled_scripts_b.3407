...
void main() // Position - 0x0
{
	...
	iLocal_96 = func_308(CHAR_ABIGAIL);
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_304(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_284(&unk230, &num, unk61, 1f))
	{
		func_283();
	...
	while (true)
	{
		...
		func_225(num);
		func_218(&iLocal_98, &(num.f_9), unk61);
		...
		switch (num)
		{
			...
			case 1:
				func_200(&num, unk61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
...
void func_3(int iParam0, var uParam1) // Position - 0x37C
{
	func_21(uParam1);
...
void func_21(var uParam0) // Position - 0xCF5
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD25
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2931
{
...
BOOL func_29(var uParam0) // Position - 0x2971
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x299F
{
...
int func_31(var uParam0) // Position - 0x2A7B
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2ABD
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B20
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BAE
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E58
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3477
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35A6
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36ED
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x372A
{
...
int func_47(eCharacter echParam0) // Position - 0x374F
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3927
{
...
var func_54(int iParam0, int iParam1) // Position - 0x39A0
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39B5
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EFE
{
	eCharacter character;
...
int func_64(int iParam0, int iParam1) // Position - 0x4879
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x55FA
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5635
{
	int num;
...
void func_67(int iParam0) // Position - 0x58A9
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x58E5
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E34
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E78
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65F7
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x663E
{
...
BOOL func_73(int iParam0) // Position - 0x6699
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66A9
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6709
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AC0
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6ACB
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6ADB
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B7D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72F7
{
...
int func_81() // Position - 0x75F2
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7601
{
...
int func_83() // Position - 0x762B
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7643
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7658
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x766F
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76C7
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7771
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7806
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x784A
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x79CE
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x79DC
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84A4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8526
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x857E
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8587
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x880E
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x881E
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x883B
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x884B
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B8E
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8B9F
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BE5
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C6B
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C9E
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CEF
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D91
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DB3
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DCA
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8DD7
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E11
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E4C
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E88
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8EA1
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F04
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8F1A
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F30
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F72
{
...
struct<2> func_119(int iParam0) // Position - 0x8F9A
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93E7
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6BF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA05
{
	int num;
...
void func_124(int iParam0) // Position - 0xAAAA
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAB45
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xABA3
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABFC
{
...
int func_129(int iParam0) // Position - 0xAC7F
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACB0
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACC5
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD78
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD93
{
	int i;
...
int func_135(int iParam0) // Position - 0xADDF
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAE28
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE48
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE69
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF39
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF8C
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB082
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0ED
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB12C
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB27B
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB295
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2EE
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB32F
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB351
{
...
BOOL func_150() // Position - 0xB390
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB39E
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3F8
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB41B
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4BF
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB54E
{
...
void func_161(var uParam0) // Position - 0xB5A5
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB5D1
{
...
void func_164(int iParam0) // Position - 0xB773
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7A6
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB830
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8A4
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8B2
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB909
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB918
{
...
BOOL func_171(int iParam0) // Position - 0xB959
{
	int num;
...
void func_172(int iParam0) // Position - 0xB99E
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9D0
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB07
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB56
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB67
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD48
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBD6A
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBD7B
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDC4
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xBDE8
{
	switch (iParam0)
	{
		case 0:
...
var func_182(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC25C
{
	var unk;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC288
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC29F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC32E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCB11
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCB2C
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCBBA
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCC1E
{
	var unk;
...
BOOL func_190(var uParam0) // Position - 0xCCB5
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_191(int iParam0) // Position - 0xCCDF
{
	eCharacter character;
...
BOOL func_192() // Position - 0xD3FC
{
	return Global_101727.f_1;
}

BOOL func_193() // Position - 0xD40A
{
	if (Global_98585 != -1)
...
BOOL func_196() // Position - 0xD471
{
	return Global_101740.f_400 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD482
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD4BA
{
	return Global_1575084;
}

BOOL func_199() // Position - 0xD4C6
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD4E2
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD56A
{
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD5A5
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD5FB
{
...
float func_204(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD696
{
	var unk;
...
void func_205(var uParam0, var uParam1, char* sParam2) // Position - 0xD6D0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(*uParam1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
		switch (*uParam0)
		{
			case 0:
				uParam0->f_166 = unk_0x1DD05E817C89C737() + unk_0xC5935DFB3F39785A(1000, 2000);
				_CONVERSATION_INITIALIZE_ACTOR(&(uParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				unk_0x10425721983AE158(*uParam1, sLocal_97, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*uParam0 = 1;
				break;
		
			case 1:
				if (unk_0x1DD05E817C89C737() > uParam0->f_166)
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_90, uLocal_93, 8f, 0, 1, 0))
					{
						unk_0x10425721983AE158(*uParam1, sLocal_97, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*uParam0 = 3;
					}
				...
				if (unk_0x13CCB1AD131C1082(*uParam1, sLocal_97, "outro", 3) && unk_0x82E64DE58A6B84A8(*uParam1, sLocal_97, "outro") > 0.99f)
					unk_0x10425721983AE158(*uParam1, sLocal_97, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				break;
		
			case 3:
				if (unk_0x13CCB1AD131C1082(*uParam1, sLocal_97, "intro", 3) && unk_0x82E64DE58A6B84A8(*uParam1, sLocal_97, "intro") > 0.99f)
					*uParam0 = 4;
				break;
			...
			case 4:
				...
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_90, uLocal_93, 8f, 0, 1, 0))
						unk_0x10425721983AE158(*uParam1, sLocal_97, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			case 5:
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (unk_0x13CCB1AD131C1082(*uParam1, sLocal_97, "loop_talk", 3))
					{
						if (unk_0x82E64DE58A6B84A8(*uParam1, sLocal_97, "loop_talk") > 0.99f)
						{
							uParam0->f_166 = unk_0x1DD05E817C89C737() + unk_0xC5935DFB3F39785A(7000, 10000);
						
							if (!unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_90, uLocal_93, 8f, 0, 1, 0))
							{
								unk_0x10425721983AE158(*uParam1, sLocal_97, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*uParam0 = 1;
							}
							else
							{
								unk_0x10425721983AE158(*uParam1, sLocal_97, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*uParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (unk_0x13CCB1AD131C1082(*uParam1, sLocal_97, "loop_look", 3) && unk_0x82E64DE58A6B84A8(*uParam1, sLocal_97, "loop_look") > 0.99f)
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_90, uLocal_93, 8f, 0, 1, 0))
					{
						if (unk_0x1DD05E817C89C737() > uParam0->f_166)
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD9CC
{
...
BOOL func_207(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xDA1A
{
	Global_22426 = 0;
...
BOOL func_210(int iParam0) // Position - 0xDD82
{
	return func_211(iParam0, 20);
}

BOOL func_211(int iParam0, int iParam1) // Position - 0xDD92
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

void func_212() // Position - 0xDDAA
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDF0A
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
float func_217(var uParam0, var uParam1, int iParam2) // Position - 0xE004
{
	var unk;
	var unk4;
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE062
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xE153
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xE18F
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xE1C8
{
	BOOL flag;
	int i;
...
BOOL func_222() // Position - 0xE266
{
	return Global_98972;
}

void func_223(var uParam0) // Position - 0xE272
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE289
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0) // Position - 0xE371
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE399
{
	var unk;
...
void func_227(int iParam0, var uParam1, int iParam2) // Position - 0xE609
{
	var unk;
	var unk2;
...
BOOL func_228(int iParam0) // Position - 0xE961
{
...
BOOL func_229(var uParam0) // Position - 0xE981
{
...
BOOL func_230(var uParam0) // Position - 0xE999
{
...
void func_231(var uParam0) // Position - 0xE9BE
{
	int i;
	var unk;
...
void func_232(var uParam0) // Position - 0xECBC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_233(var uParam0) // Position - 0xECE7
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xED67
{
	int i;
	int num;
	var unk;
...
BOOL func_235(var uParam0, var uParam1) // Position - 0xEF25
{
	var unk;
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEF55
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF211
{
...
BOOL func_238(var uParam0, int iParam1) // Position - 0xF245
{
	float num;
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF2BB
{
	return func_240(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_240(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF2D3
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF394
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_242(var uParam0, int iParam1) // Position - 0xF4C0
{
	int num;
...
BOOL func_244(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF5CF
{
	var unk;
	var unk4;
	float num;
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF660
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xF681
{
	float num;
	float num2;
...
void func_247(var uParam0) // Position - 0xF6C0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(var uParam0, var uParam1) // Position - 0xF6DB
{
	int i;
...
int func_249(var uParam0) // Position - 0xF71A
{
...
BOOL func_250(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF742
{
	float num;
	float num2;
	int num3;
...
BOOL func_251(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF83D
{
	float num;
	float num2;
...
BOOL func_252(var uParam0, float fParam1) // Position - 0xF949
{
	var unk;
	var unk2;
...
BOOL func_253(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF9DE
{
	var unk;
	var unk4;
	float num;
...
BOOL func_254(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFA6C
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_255(int iParam0) // Position - 0xFAB4
{
...
void func_256(var uParam0) // Position - 0xFAFE
{
	var unk;
...
BOOL func_257(int iParam0) // Position - 0xFB9B
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_258(int iParam0) // Position - 0xFC30
{
...
BOOL func_261(int iParam0) // Position - 0xFCAF
{
	if (func_262() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_262() // Position - 0xFCE3
{
...
BOOL func_263(int iParam0) // Position - 0xFD21
{
...
BOOL func_264(var uParam0) // Position - 0xFD49
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_265(var uParam0) // Position - 0xFD90
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_271(&num) || !unk_0xE100DD4F82A51BDE(sLocal_97))
				return false;
...
void func_266(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF42
{
	func_267(uParam0);
...
void func_267(var uParam0) // Position - 0xFF85
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_268(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10021
{
	if (func_269(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_269(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1007D
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_308(echParam1);
...
int func_270(var uParam0, eCharacter echParam1) // Position - 0x1010B
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x10151
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x10182
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_273(var uParam0) // Position - 0x101BE
{
	int num;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!unk_0x6252BC0DD8A320DB(num) || !unk_0xE100DD4F82A51BDE(sLocal_97))
				return false;
...
BOOL func_274(int iParam0) // Position - 0x102C9
{
	var unk;
	eCharacter character;
...
BOOL func_275(int iParam0) // Position - 0x1031A
{
	var unk;
...
BOOL func_276(int iParam0) // Position - 0x103D3
{
	var unk;
...
BOOL func_277(int iParam0) // Position - 0x10494
{
	int i;
	var unk;
	int num;
...
BOOL func_278(int iParam0, char* sParam1) // Position - 0x10519
{
...
BOOL func_279(int iParam0) // Position - 0x105FB
{
...
BOOL func_280(int iParam0) // Position - 0x10626
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10651
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_282(int iParam0) // Position - 0x1067C
{
	if (func_258(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_283() // Position - 0x106B1
{
...
BOOL func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x106CB
{
	int i;
...
BOOL func_285(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10730
{
	int num;
	char* str;
...
BOOL func_286(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x107A8
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x10823
{
	char* str;
	...
	if (unk_0xC450B06E5AAA0985(uLocal_99))
		unk_0xFE54B8568B2ABD12(&uLocal_99);
...
void func_288(char* sParam0) // Position - 0x108AA
{
...
void func_289() // Position - 0x108C9
{
	Global_21291 = 0;
	func_290();
	return;
...
void func_290() // Position - 0x108D9
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
BOOL func_291(char* sParam0) // Position - 0x108FA
{
	var unk;
...
struct<6> func_292() // Position - 0x1091A
{
	var unk;
...
void func_293(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1093E
{
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x1095E
{
	func_295(&(uParam0->f_41), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x10970
{
	int i;
...
void func_296(var uParam0, BOOL bParam1) // Position - 0x109AE
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_297(var uParam0, BOOL bParam1) // Position - 0x109E9
{
	func_298(&(uParam0->f_35), bParam1);
	return;
}

void func_298(var uParam0, BOOL bParam1) // Position - 0x109FB
{
	int i;
...
void func_299(var uParam0) // Position - 0x10A38
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_300(var uParam0, int iParam1) // Position - 0x10A70
{
	func_301(&(uParam0->f_28), iParam1);
	return;
}

void func_301(var uParam0, int iParam1) // Position - 0x10A82
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_302(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_302(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10AC3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_303(var uParam0) // Position - 0x10B13
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_304(int iParam0) // Position - 0x10B54
{
	if (*iParam0 == -1)
		return;
...
void func_305(char* sParam0) // Position - 0x10B91
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_306(var uParam0) // Position - 0x10BA3
{
	*uParam0 = -1;
...
void func_307() // Position - 0x10BD6
{
...
int func_308(eCharacter echParam0) // Position - 0x10BF0
{
	if (!func_36(echParam0))
