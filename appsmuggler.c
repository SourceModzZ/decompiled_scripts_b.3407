...
void main() // Position - 0x0
{
	...
	while (func_511())
	{
		...
		if (!IS_BIT_SET(iLocal_536, 5) && func_509())
		{
			func_507();
			func_484();
		}
	
		if (!IS_BIT_SET(iLocal_536, 8) && IS_BIT_SET(iLocal_536, 5))
			func_478();
		...
		if (!IS_BIT_SET(iLocal_536, 2))
		{
			func_6();
		}
		else if (!_STOPWATCH_IS_INITIALIZED(&uLocal_569))
		{
			_STOPWATCH_INITIALIZE(&uLocal_569, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_569, 200, false))
		{
			if (!Global_1944438.f_3889 && CAM::IS_SCREEN_FADED_OUT())
			{
				func_1(1);
				Global_1944292 = 1;
				func_525(0, true);
...
void func_6() // Position - 0x261
{
	...
	if (IS_BIT_SET(iLocal_536, 0))
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_1284))
		{
			scaleformMovieMethodReturnValueInt = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_1284);
			...
			switch (scaleformMovieMethodReturnValueInt)
			{
				...
				case 29:
					...
					{
						iLocal_566 = 2;
						GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SHOW_SCREEN", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
					}
					break;
...
{
	if (func_16(plParam0))
		if (func_16(Global_1887694[plParam0 /*611*/].f_10))
...
int func_45(Player plParam0) // Position - 0x121D
{
	int i;
	Player player;
...
BOOL func_46(Player plParam0) // Position - 0x1289
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
int func_47() // Position - 0x1327
{
	return func_48() - 1;
}

int func_48() // Position - 0x1335
{
	return func_49(PLAYER::PLAYER_ID());
}

int func_49(Player plParam0) // Position - 0x1345
{
	Player player;

	player = Global_1887694[plParam0 /*611*/].f_10;

	if (func_16(player) && Global_1887694[player /*611*/].f_10.f_431 == 1)
		return 8;

	return 4;
}

BOOL func_50(Player plParam0) // Position - 0x137E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_51(Global_2657994[plParam0 /*467*/].f_324.f_8) == 23;

	return false;
}

int func_51(int iParam0) // Position - 0x13C5
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x18FA
{
	Player player;
...
BOOL func_53(Player plParam0) // Position - 0x195A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL _IS_PLAYER_IN_ANIMAL_FORM(Player plParam0) // Position - 0x197F
{
	Ped playerPed;
	Hash entityModel;
...
BOOL func_55(Player plParam0) // Position - 0x19EB
{
	Player player;
...
int func_56(int iParam0) // Position - 0x1A0E
{
	switch (iParam0)
	{
		case 162:
...
int func_57(int iParam0) // Position - 0x1B60
{
	return Global_1917230.f_11.f_147[func_58(iParam0)];
}

int func_58(int iParam0) // Position - 0x1B78
{
	switch (iParam0)
	{
		case 148:
...
BOOL func_59(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2137
{
...
BOOL func_60(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2171
{
	return func_61(2, iParam0, false, bParam1, bParam2);
}

BOOL func_61(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2185
{
	int num;
	int num2;
...
int func_62(int iParam0) // Position - 0x224B
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0) // Position - 0x2285
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0, BOOL bParam1) // Position - 0x22CB
{
	Player player;
...
int func_65(int iParam0) // Position - 0x2368
{
	switch (iParam0)
	{
		case 0:
...
int func_66(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23A8
{
	return func_61(1, iParam0, false, bParam1, bParam2);
}

int func_67(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23BC
{
	return func_61(0, iParam0, false, bParam1, bParam2);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Player plParam5) // Position - 0x23D0
{
	switch (iParam0)
	{
		case 148:
...
int func_69(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x26A3
{
	int num;
...
int func_70(int iParam0, Player plParam1) // Position - 0x26C6
{
	switch (iParam0)
	{
		case 2:
...
int func_71(int iParam0, int iParam1, int iParam2) // Position - 0x26E0
{
	switch (iParam0)
	{
		case 0:
...
int func_72(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x26FA
{
	int num;
...
int func_73(int iParam0, Player plParam1) // Position - 0x271D
{
	var unk;
...
Vector3 func_74(Player plParam0) // Position - 0x2884
{
	return Global_1887694[plParam0 /*611*/].f_10.f_308;
}

BOOL func_75(Player plParam0, BOOL bParam1) // Position - 0x289C
{
	if (!func_16(plParam0))
		return false;
	...
	return func_16(Global_1887694[plParam0 /*611*/].f_10);
}

int func_76(int iParam0, int iParam1, int iParam2) // Position - 0x28D4
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, int iParam1, Player plParam2, int iParam3) // Position - 0x2B37
{
	int num;
...
int func_78(int iParam0, Player plParam1) // Position - 0x2B64
{
	switch (iParam0)
	{
		case 14:
...
BOOL func_79(int iParam0) // Position - 0x2BB6
{
	return false;
}

int func_80(int iParam0, int iParam1, int iParam2) // Position - 0x2BBF
{
	switch (iParam0)
	{
		case 13:
...
int func_81(int iParam0) // Position - 0x2D6E
{
	switch (iParam0)
	{
		case 0:
...
int func_82(int iParam0, int iParam1, int iParam2) // Position - 0x2DBA
{
	int num;
...
BOOL func_83(int iParam0) // Position - 0x2DDE
{
	return true;
}

int func_84(int iParam0, int iParam1) // Position - 0x2DE7
{
	switch (iParam0)
	{
		case 12:
...
int func_85(int iParam0, int iParam1) // Position - 0x2F36
{
	int num;
...
int func_86(int iParam0, int iParam1) // Position - 0x2FCA
{
	int num;
	int num2;
	int num3;
...
int func_87(int iParam0) // Position - 0x3063
{
	switch (iParam0)
	{
		case 5:
...
int func_88(int iParam0, int iParam1) // Position - 0x3093
{
	if (func_92(iParam0))
	{
...
BOOL func_89(int iParam0) // Position - 0x30E1
{
	switch (iParam0)
	{
		case 15:
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x3132
{
	return Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_92(int iParam0) // Position - 0x3147
{
	switch (iParam0)
	{
		case 14:
...
int func_93(int iParam0, int iParam1) // Position - 0x319D
{
	switch (iParam0)
	{
		case 32:
...
int func_94(int iParam0, int iParam1, int iParam2, Player plParam3, int iParam4) // Position - 0x342F
{
	int num;
...
BOOL func_95(int iParam0) // Position - 0x3482
{
	switch (iParam0)
	{
		case 2:
...
int func_96(int iParam0, int iParam1, Player plParam2, int iParam3, int iParam4) // Position - 0x34A8
{
	int num;
...
int func_97(int iParam0) // Position - 0x3544
{
	return 1;
}

int func_98(int iParam0) // Position - 0x354D
{
	return 4;
}

BOOL func_99(int iParam0) // Position - 0x3556
{
	switch (iParam0)
	{
		case 3:
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3594
{
	int num;
...
int func_101(int iParam0, int iParam1, int iParam2, Player plParam3, int iParam4) // Position - 0x364F
{
	int num;
...
BOOL func_102(int iParam0) // Position - 0x36A2
{
	switch (iParam0)
	{
		case 23:
...
int func_103(int iParam0, int iParam1, Player plParam2, int iParam3, int iParam4) // Position - 0x36BC
{
	int num;
	int num2;
...
int func_104(int iParam0) // Position - 0x383A
{
	switch (iParam0)
	{
		case 15:
...
int func_105(int iParam0) // Position - 0x3854
{
	if (!func_110(iParam0))
	{
		if (func_111(iParam0))
...
BOOL func_106(int iParam0) // Position - 0x38AE
{
	switch (iParam0)
	{
		case 12:
...
int func_107(Player plParam0) // Position - 0x38C8
{
...
BOOL func_108(int iParam0) // Position - 0x390A
{
	switch (iParam0)
	{
		case 26:
...
int func_109(int iParam0) // Position - 0x3924
{
	if (iParam0 > 25)
		return 3;
	else if (iParam0 > 10)
...
BOOL func_110(int iParam0) // Position - 0x3946
{
	switch (iParam0)
	{
		case 15:
...
BOOL func_111(int iParam0) // Position - 0x399C
{
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x39BE
{
	switch (iParam0)
	{
		case 1:
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3AF0
{
	int num;
...
BOOL func_114(int iParam0) // Position - 0x3B36
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B7A
{
	int num;
...
BOOL func_116(int iParam0) // Position - 0x3C57
{
	switch (iParam0)
	{
		case 14:
...
BOOL func_117(int iParam0) // Position - 0x3C8F
{
	switch (iParam0)
	{
		case 0:
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3CF1
{
	switch (iParam0)
	{
		case 0:
...
int func_119(int iParam0, int iParam1, int iParam2) // Position - 0x403E
{
	int num;
...
int func_120(int iParam0, int iParam1) // Position - 0x405F
{
	switch (iParam0)
	{
		case 6:
...
int func_121(int iParam0) // Position - 0x421F
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, Player plParam5) // Position - 0x42F7
{
	switch (iParam0)
	{
		case 148:
...
int func_123(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x45E6
{
	int num;
...
int func_124(int iParam0, int iParam1) // Position - 0x465C
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_125(int iParam0, int iParam1) // Position - 0x4676
{
	return func_124(iParam0, iParam1) > 0;
}

int func_126(int iParam0, int iParam1, Player plParam2) // Position - 0x4688
{
	switch (iParam1)
	{
		case 2:
...
int func_127(int iParam0, int iParam1) // Position - 0x46A2
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1) // Position - 0x46D6
{
	switch (iParam0)
	{
		case 2:
...
int func_129(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x46F0
{
	int num;
...
int func_130(int iParam0, int iParam1) // Position - 0x4A7B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_131(int iParam0, int iParam1) // Position - 0x4B01
{
	return func_130(iParam0, iParam1) > 0;
}

int func_132(int iParam0, int iParam1, Player plParam2) // Position - 0x4B13
{
	var unk;
...
int func_133(int iParam0, int iParam1) // Position - 0x4BAB
{
	switch (iParam1)
	{
		case 96:
...
int func_134(int iParam0, int iParam1) // Position - 0x4E8A
{
	switch (iParam0)
	{
		case 53:
...
int func_135(int iParam0, int iParam1, Player plParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4EA4
{
	int num;
...
int func_136(int iParam0, int iParam1) // Position - 0x517F
{
	switch (iParam0)
	{
		case 4:
...
BOOL func_137(int iParam0, int iParam1) // Position - 0x51B6
{
	return func_136(iParam0, iParam1) > 0;
}

int func_138(int iParam0, int iParam1) // Position - 0x51C8
{
	switch (iParam1)
	{
		case 6:
...
int func_139(int iParam0, int iParam1) // Position - 0x51F2
{
	switch (iParam1)
	{
		case 46:
...
int func_140(int iParam0, int iParam1) // Position - 0x5324
{
	switch (iParam0)
	{
		case 16:
...
int func_141(int iParam0) // Position - 0x533E
{
	switch (iParam0)
	{
		case 0:
...
int func_142(int iParam0, int iParam1, int iParam2) // Position - 0x538A
{
	int num;
...
int func_143(int iParam0, int iParam1) // Position - 0x552B
{
	int num;
...
int func_144(int iParam0, int iParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5B12
{
	int num;
...
int func_145(int iParam0) // Position - 0x5C88
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_146(int iParam0) // Position - 0x5CCC
{
	return func_145(iParam0) > 0;
}

int func_147(int iParam0, int iParam1) // Position - 0x5CDC
{
	return 2;
}

int func_148(int iParam0, int iParam1) // Position - 0x5CE5
{
	switch (iParam1)
	{
		case 136:
...
int func_149(int iParam0, int iParam1) // Position - 0x5D2D
{
	BOOL flag;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x5D8C
{
	Hash statHash;
	int outValue;
...
Hash func_151(int iParam0, int iParam1) // Position - 0x5DBB
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_152(iParam1));
}

int func_152(int iParam0) // Position - 0x5DD0
{
	int num;
	int num2;
...
int func_153() // Position - 0x5E04
{
	return Global_1574926;
}

int func_154(int iParam0, int iParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5E10
{
	int num;
...
int func_155(int iParam0) // Position - 0x60D6
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_156(int iParam0) // Position - 0x6148
{
	return func_155(iParam0) > 0;
}

int func_157(int iParam0, int iParam1) // Position - 0x6158
{
	switch (iParam0)
	{
		case 1:
...
int func_158(int iParam0, int iParam1) // Position - 0x6250
{
	switch (iParam1)
	{
		case 0:
...
int func_159(int iParam0, int iParam1) // Position - 0x65F0
{
	switch (iParam0)
	{
		case 1:
...
int func_160(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66E9
{
	int num;
...
int func_161(int iParam0) // Position - 0x6A6C
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_162(int iParam0) // Position - 0x6AE0
{
	return func_161(iParam0) > 0;
}

int func_163(int iParam0, int iParam1) // Position - 0x6AF0
{
	switch (iParam0)
	{
		case 2:
...
int func_164(int iParam0, int iParam1, int iParam2) // Position - 0x6B3C
{
	int num;
...
int func_165(int iParam0) // Position - 0x6E45
{
	if (func_166(iParam0))
		return 2;
...
BOOL func_166(int iParam0) // Position - 0x6E5B
{
	switch (iParam0)
	{
		case 7:
...
int func_167(int iParam0, int iParam1, int iParam2) // Position - 0x6EA5
{
	int num;
...
int func_168(int iParam0) // Position - 0x6ECF
{
	switch (iParam0)
	{
		case 0:
...
int func_169(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6FA8
{
	switch (iParam0)
	{
		case 148:
...
int func_170(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7270
{
	int num;
...
int func_171(int iParam0, int iParam1) // Position - 0x72AE
{
	if (func_125(iParam0, iParam1))
...
int func_172(int iParam0, int iParam1) // Position - 0x72D6
{
	switch (iParam0)
	{
		case 2:
...
int func_173(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x72F0
{
	int num;
...
int func_174(int iParam0, int iParam1) // Position - 0x767E
{
	if (func_131(iParam0, iParam1))
...
int func_175(int iParam0, int iParam1) // Position - 0x76A6
{
	switch (iParam0)
	{
		case 0:
...
int func_176(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x7734
{
	int num;
...
int func_177(int iParam0, int iParam1) // Position - 0x7957
{
	if (func_137(iParam0, iParam1))
...
int func_178(int iParam0, int iParam1) // Position - 0x797F
{
	switch (iParam0)
	{
		case 4:
...
int func_179(int iParam0, int iParam1) // Position - 0x79B6
{
	switch (iParam0)
	{
		case 0:
...
int func_180(int iParam0, int iParam1, int iParam2) // Position - 0x7A27
{
	int num;
...
int func_183(int iParam0, int iParam1) // Position - 0x7BFC
{
	int num;
...
int func_184(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x81DB
{
	int num;
...
int func_185(int iParam0, int iParam1) // Position - 0x82DA
{
	if (func_146(iParam0))
...
int func_186(int iParam0, int iParam1) // Position - 0x82FE
{
	switch (iParam0)
	{
		case 0:
...
int func_187(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x8344
{
	int num;
...
int func_188(int iParam0, int iParam1) // Position - 0x84BE
{
	if (func_156(iParam0))
...
int func_189(int iParam0, int iParam1) // Position - 0x84E2
{
	switch (iParam0)
	{
		case 11:
...
int func_190(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x855C
{
	int num;
...
int func_191(int iParam0) // Position - 0x8891
{
	if (func_162(iParam0))
...
int func_192(int iParam0) // Position - 0x88B3
{
	switch (iParam0)
	{
		case 1:
...
int func_193(int iParam0, int iParam1, int iParam2) // Position - 0x892F
{
	int num;
...
int func_194(int iParam0) // Position - 0x8BF7
{
	if (func_166(iParam0))
	{
		if (func_195(iParam0))
...
BOOL func_195(int iParam0) // Position - 0x8C1A
{
	switch (iParam0)
	{
		case 7:
...
int func_196(int iParam0) // Position - 0x8C64
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_197(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x8D46
{
	return func_21(plParam0, iParam1, bParam2) == -1;
}

BOOL func_198(int iParam0) // Position - 0x8D5A
{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x8DA9
{
	uParam0->f_1 = 0;
	return;
}

void func_200(char* sParam0, char* sParam1, char* sParam2, char* sParam3, BOOL bParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, const char* sParam9, const char* sParam10) // Position - 0x8DB6
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "SHOW_OVERLAY");
	func_202(sParam0);
...
void func_201(int iParam0) // Position - 0x8E66
{
	if (iLocal_567 != iParam0)
		iLocal_567 = iParam0;

	return;
}

void func_202(const char* sParam0) // Position - 0x8E7B
{
...
BOOL func_203(Player plParam0) // Position - 0x8E8D
{
	return 0 == func_107(plParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x8E9D
{
	if (iParam1 == -1)
		iParam1 = func_153();
...
void func_205(int iParam0, BOOL bParam1) // Position - 0x8EB9
{
	int num;
	var unk;
	var unk5;
	...
	if (iParam0 != 8)
		num = uLocal_744[func_219(iParam0)];
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x90E0
{
	if (iParam2 == -1)
		iParam2 = func_153();
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x90FE
{
...
BOOL func_208(char* sParam0, int iParam1, const char* sParam2) // Position - 0x9115
{
...
int func_209(int iParam0, int iParam1) // Position - 0x9133
{
	float num;
	float value;
...
float func_210(int iParam0, int iParam1) // Position - 0x915C
{
	float num;
	float num2;
	int value;
...
int func_211(int iParam0, int iParam1) // Position - 0x9274
{
	return func_212(iParam0) * iParam1;
}

int func_212(int iParam0) // Position - 0x9285
{
	switch (iParam0)
	{
		case 8:
		...
		case 4:
			return Global_262145.f_22501;
	
		case 5:
			return Global_262145.f_22502;
	
		case 6:
			return Global_262145.f_22503;
	
		case 7:
			return Global_262145.f_22504;
...
int func_213() // Position - 0x9325
{
	int i;

	for (i = 0; i < 9; i = i + 1)
	{
		if (uLocal_744[i] > 0 && i != 0)
			return func_214(i);
	}
...
int func_214(int iParam0) // Position - 0x935F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_215() // Position - 0x93CA
{
	return IS_BIT_SET(iLocal_536, 10);
}

BOOL func_216() // Position - 0x93D8
{
	if (_STOPWATCH_IS_INITIALIZED(&(Global_2710098.f_26)) && _STOPWATCH_HAS_TIME_PASSED(&(Global_2710098.f_26), Global_2710098.f_28, false))
	{
		_STOPWATCH_DESTROY(&(Global_2710098.f_26));
		return false;
	}

	return _STOPWATCH_IS_INITIALIZED(&(Global_2710098.f_26));
}

BOOL func_217(int iParam0) // Position - 0x941B
{
	switch (iParam0)
	{
		case 8:
	...
	return uLocal_744[func_219(iParam0)] > 0;
}

BOOL func_218(Player plParam0) // Position - 0x944D
{
	return func_220(plParam0) == 0;
}

int func_219(int iParam0) // Position - 0x945D
{
	switch (iParam0)
	{
		case 8:
...
int func_220(Player plParam0) // Position - 0x94C8
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && func_221(plParam0))
		return Global_1845270[plParam0 /*892*/].f_268.f_299.f_3;

	return 0;
}

BOOL func_221(Player plParam0) // Position - 0x94FA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_222(int iParam0) // Position - 0x9520
{
	switch (iParam0)
	{
		case 2:
...
void func_224() // Position - 0x96A3
{
	func_225(6117, -1);
	return;
}

void func_225(int iParam0, int iParam1) // Position - 0x96B3
{
	BOOL flag;

	flag = func_150(iParam0, func_152(iParam1));
	flag = flag + 1;
	func_226(iParam0, flag, iParam1, true);
	return;
}

void func_226(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x96DA
{
	Hash statName;
...
void func_227(int iParam0, BOOL bParam1) // Position - 0x9708
{
	...
	Global_1942173.f_53 = 0;

	if (func_247(PLAYER::PLAYER_ID()))
		MISC::SET_BIT(&Global_1982243, 16);
	else
		MISC::SET_BIT(&Global_1982243, 18);
...
BOOL func_228(Player plParam0, BOOL bParam1) // Position - 0x97E3
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_51(Global_2657994[plParam0 /*467*/].f_324.f_8) == 12;

	return false;
}

void func_229(int iParam0, int iParam1, int iParam2) // Position - 0x9871
{
	if (iParam1 != -1)
		func_249(iParam1);
...
void func_230(int iParam0, int iParam1) // Position - 0x9898
{
...
void func_231(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5) // Position - 0x9900
{
	Hash eventData;
...
var func_232() // Position - 0x994D
{
	return Global_2739945.f_5266.f_349;
}

int func_233() // Position - 0x995F
{
	return Global_2739945.f_5266.f_348;
}

int func_234() // Position - 0x9971
{
	return Global_2739945.f_5266.f_347;
}

int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x9983
{
	int address;
	int i;
	Player player;
...
BOOL func_236(Player plParam0, int iParam1) // Position - 0x99E8
{
	BOOL flag;
...
int func_237(int iParam0, BOOL bParam1) // Position - 0x9A41
{
	int num;
	int num2;
...
void func_238(int iParam0) // Position - 0x9A82
{
	Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_32 = iParam0;
	return;
}

BOOL func_239(Player plParam0, int iParam1) // Position - 0x9A9B
{
	if (func_240(plParam0, false))
		return func_44(Global_1887694[plParam0 /*611*/].f_10.f_33) == iParam1;

	return false;
}

BOOL func_240(Player plParam0, BOOL bParam1) // Position - 0x9AC5
{
	if (func_16(plParam0))
...
BOOL func_241(BOOL bParam0) // Position - 0x9B09
{
	return func_75(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_242() // Position - 0x9B1B
{
	return func_15(PLAYER::PLAYER_ID());
}

void func_243(int iParam0) // Position - 0x9B2B
{
...
void func_244(int iParam0, int iParam1) // Position - 0x9B4E
{
...
void func_245(int iParam0, int iParam1, int iParam2) // Position - 0x9B7A
{
	int num;
...
BOOL func_246(int iParam0) // Position - 0x9BA7
{
...
BOOL func_247(Player plParam0) // Position - 0x9BC7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_248(int iParam0) // Position - 0x9C0D
{
...
void func_249(int iParam0) // Position - 0x9C2E
{
...
void func_250(int iParam0) // Position - 0x9C51
{
	MISC::CLEAR_BIT(&(Global_2739945.f_5266.f_50), iParam0);
	return;
}

void func_251(int iParam0) // Position - 0x9C68
{
	MISC::SET_BIT(&(Global_2739945.f_5266.f_50), iParam0);
	return;
}

BOOL func_252(int iParam0) // Position - 0x9C7F
{
...
int func_253() // Position - 0x9CA0
{
	return iLocal_568;
}

void func_254() // Position - 0x9CAB
{
	func_225(6115, -1);
	return;
}

BOOL func_255(BOOL bParam0) // Position - 0x9CBB
{
	int num;
...
BOOL func_256(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x9CF1
{
	int num;
	int num2;
	Hash hashKey;
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (func_270(78225582, joaat("CATEGORY_INVENTORY_CONTRABAND_MISSION"), num, -1018905335, 1, num2, 1, 4, hashKey, 3))
				*uParam0 = 1;
			else
				*uParam0 = 3;
...
void func_257(int iParam0) // Position - 0x9E16
{
	Global_4538076 = iParam0;
	return;
}

int func_258(int iParam0) // Position - 0x9E24
{
...
int func_259(int iParam0) // Position - 0x9E4B
{
	if (iParam0 >= 0 && iParam0 < 15)
...
BOOL func_260(int iParam0) // Position - 0x9E74
{
	if (iParam0 >= 0 && iParam0 < 15)
...
void func_261(int iParam0) // Position - 0x9E9F
{
	BOOL flag;
...
void func_262(var uParam0) // Position - 0x9EF3
{
	uParam0->f_65 = 0;
...
void func_263(var uParam0) // Position - 0x9FF6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_264(int iParam0) // Position - 0xA03E
{
	if (iParam0 >= 0 && iParam0 < 15)
...
void func_267() // Position - 0xA25D
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
	return;
}

int func_268(Player plParam0) // Position - 0xA26D
{
	var address;
...
int func_269(int iParam0, int iParam1, int iParam2) // Position - 0xA288
{
...
BOOL func_270(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5, int iParam6, int iParam7, Hash hParam8, int iParam9) // Position - 0xA97F
{
	BOOL flag;
	int num;
	Hash itemData;
...
BOOL func_271(Hash hParam0) // Position - 0xAAA1
{
	switch (hParam0)
	{
		case -221807075:
...
BOOL func_272(var uParam0, int iParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0xAB30
{
	BOOL flag;
	int i;
	BOOL flag2;
	...
	*uParam0 = 0;
	...
	{
		*uParam0 = func_273(transactionId, iParam1, joaat("SERVICE_INVALID"), hParam3, hParam2, 0, true, iParam4, iParam5, 0, flag);
		return true;
	}
...
int func_273(int iParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xAC2D
{
	int i;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xADA5
{
...
int func_276() // Position - 0xADBC
{
	return iLocal_567;
}

void func_277() // Position - 0xADC7
{
	switch (func_276())
	{
		case 2:
...
void func_278() // Position - 0xAEFB
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "HIDE_OVERLAY");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_201(0);
	MISC::CLEAR_BIT(&iLocal_536, 1);
	return;
}

void func_279() // Position - 0xAF20
{
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Link", "GTAO_SMG_Hangar_Computer_Sounds", true);
	return;
}

void func_280() // Position - 0xAF35
{
	if (func_281())
	{
		if (!IS_BIT_SET(iLocal_536, 0))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "GET_CURRENT_SELECTION");
			iLocal_1284 = GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_282() // Position - 0xAF8C
{
	if (iLocal_540 != func_321())
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_577))
		{
			_STOPWATCH_INITIALIZE(&uLocal_577, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_577, 750, false))
		{
			_STOPWATCH_DESTROY(&uLocal_577);
			func_283();
		}
	}
...
void func_284() // Position - 0xB024
{
	if (func_216())
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "UPDATE_SELL_COOLDOWN");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_286(Global_2710098.f_26, Global_2710098.f_28));
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_285(Global_2710098.f_28));
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
	else
	{
...
int func_285(int iParam0) // Position - 0xB084
{
	return iParam0 / 1000;
}

int func_286(int iParam0, var uParam1, int iParam2) // Position - 0xB092
{
	int num;
...
void func_287() // Position - 0xB0B7
{
	int i;
	int num;
	int num2;

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "UPDATE_STEAL_COOLDOWN");
	...
	for (i = 1; i <= 8; i = i + 1)
	{
		...
		if (func_198(num))
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_286(Global_2710098[num2 /*2*/], Global_2710098.f_17[num2]));
		else
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
	}
...
void func_288(int iParam0) // Position - 0xB11B
{
	int value;
	int value2;
	int value3;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "ADD_CARGO");
...
void func_289() // Position - 0xB1AE
{
	...
	if (func_290(iLocal_565))
		value = 1;

	if (func_215())
	{
		num = func_213();
		value8 = iLocal_540 * func_212(num);
		num2 = func_210(num, iLocal_540) * 100f;
	
		if (num2 > 0f)
		{
			num3 = func_209(num, iLocal_540);
			value8 = value8 + num3;
		}
	}

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "SET_STATS");
	...
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_540);
...
BOOL func_290(int iParam0) // Position - 0xB2D5
{
	switch (iParam0)
	{
		case 4:
...
float func_291(float fParam0, float fParam1, float fParam2) // Position - 0xB2FB
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_292() // Position - 0xB322
{
	return func_150(6117, -1);
}

float func_293(int iParam0, int iParam1) // Position - 0xB332
{
	return (SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1)) * 100f;
}

int func_294() // Position - 0xB34D
{
	return func_150(6115, -1);
}

int func_295() // Position - 0xB35D
{
	return func_150(6120, -1);
}

int func_296() // Position - 0xB36D
{
	return func_150(6119, -1);
}

int func_297() // Position - 0xB37D
{
	return func_150(6121, -1);
}

int func_298() // Position - 0xB38D
{
	return func_150(6118, -1);
}

int func_299() // Position - 0xB39D
{
	return func_150(6116, -1);
}

const char* func_300(Player plParam0) // Position - 0xB3AD
{
	const char* str;
	Player player;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
	{
		str = func_307(&(Global_1887694[plParam0 /*611*/].f_10.f_105));
		return str;
	}
	...
	if (player != _INVALID_PLAYER_INDEX())
	{
		str = func_307(&(Global_1887694[player /*611*/].f_10.f_105));
...
BOOL IS_XBOX_PLATFORM() // Position - 0xB4E1
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_302(Player plParam0) // Position - 0xB4F7
{
	var gamerHandle;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xB54C
{
	var gamerHandle;
...
BOOL func_304(Player plParam0) // Position - 0xB563
{
	var gamerHandle;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xB61D
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_306(Any* panParam0) // Position - 0xB62D
{
	int i;
...
const char* func_307(var uParam0) // Position - 0xB681
{
	return uParam0;
}

const char* func_308(Player plParam0, BOOL bParam1) // Position - 0xB68B
{
	if (!bParam1)
...
const char* func_309() // Position - 0xB6B2
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

BOOL func_310(Player plParam0, BOOL bParam1) // Position - 0xB6C2
{
	return func_311(plParam0, bParam1, 1);
}

BOOL func_311(Player plParam0, BOOL bParam1, int iParam2) // Position - 0xB6D3
{
	Player player;
	...
	if (func_16(player) && Global_1887694[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_312() // Position - 0xB72F
{
	int i;
	int num;
...
void func_313() // Position - 0xB76C
{
	...
	{
		num = func_214(i);
		uLocal_744[i] = func_314(num);
	}

	return;
}

int func_314(int iParam0) // Position - 0xB79C
{
	int i;
	int num;
	int num2;
...
int func_315(int iParam0) // Position - 0xB7F9
{
	switch (iParam0)
	{
...
int func_316(BOOL bParam0) // Position - 0xB8A9
{
	switch (bParam0)
	{
		case 1:
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xB999
{
	if (iParam1 == -1)
		iParam1 = func_153();
...
int func_318(int iParam0) // Position - 0xB9B5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_319() // Position - 0xBC1F
{
	return func_320() != 0;
}

int func_320() // Position - 0xBC2D
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_299;
}

int func_321() // Position - 0xBC46
{
	return func_220(PLAYER::PLAYER_ID());
}

void func_322() // Position - 0xBC56
{
	if (_STOPWATCH_IS_INITIALIZED(&uLocal_573))
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_573, 1000, false))
		{
			func_287();
			func_284();
			_STOPWATCH_RESET(&uLocal_573, false, false);
		}
	}
	else
	{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xBC93
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
void func_324() // Position - 0xBCD0
{
	Player player;

	plLocal_537 = plLocal_537 + 1;
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(player) && func_221(player) && !func_75(player, false) && !func_331())
		if (!func_330())
			func_327(player, plLocal_537);
	else if (func_330())
		func_325();

	if (IS_BIT_SET(iLocal_541, plLocal_537))
...
void func_325() // Position - 0xBD81
{
	...
	if (num != -1 && num < 31)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "REMOVE_ACTIVE_ORGANISATION");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_LITERAL_STRING(&uLocal_786[num /*16*/]);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		TEXT_LABEL_ASSIGN_STRING(&uLocal_786[num /*16*/], "", 64);
		MISC::CLEAR_BIT(&iLocal_541, plLocal_537);
		func_326(PLAYER::INT_TO_PLAYERINDEX(plLocal_537));
	}

	return;
}

void func_326(Player plParam0) // Position - 0xBE0A
{
	int i;

	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_553[i] == plParam0)
		{
			uLocal_542[i] = 0;
			uLocal_553[i] = -1;
			return;
...
void func_327(Player plParam0, Player plParam1) // Position - 0xBE44
{
	int i;
	...
	if (func_15(plParam0))
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "ADD_ACTIVE_ORGANISATION");
		...
		MISC::SET_BIT(&iLocal_541, plParam1);
	}
	else
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "ADD_ACTIVE_ORGANISATION");
	...
	for (i = 0; i < 31; i = i + 1)
	{
		if (uLocal_754[i] == -1)
		{
			uLocal_754[i] = plParam1;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_786[i /*16*/], playerName, 64);
			return;
		}
	}
...
void func_328(Player plParam0, int iParam1) // Position - 0xBFD7
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_553[i] == -1)
		{
			uLocal_542[i] = iParam1;
			uLocal_553[i] = plParam0;
			return;
		}
	}
...
const char* func_329(Player plParam0) // Position - 0xC014
{
	Player player;
	const char* str;
...
BOOL func_331() // Position - 0xC09A
{
	int i;

	for (i = 0; i < 10; i = i + 1)
	{
		if (uLocal_553[i] == plLocal_537)
			if (!func_15(PLAYER::INT_TO_PLAYERINDEX(plLocal_537)))
				return true;
			else
				return uLocal_542[i] != func_32(PLAYER::INT_TO_PLAYERINDEX(plLocal_537));
	}

	return false;
}

void func_332() // Position - 0xC0EF
{
	int controlValue;
	int controlValue2;
	int controlValue3;
	...
	else if (IS_BIT_SET(iLocal_536, 15))
	{
		func_338();
		return;
	}
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	if (PAD::IS_USING_CURSOR(FRONTEND_CONTROL))
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
	
		func_336(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
	
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
	
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	else
	{
		func_336(FRONTEND_CONTROL, INPUT_FRONTEND_UP, true);
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_UP))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
	
		func_336(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN, true);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_DOWN))
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
	}

	func_336(FRONTEND_CONTROL, INPUT_FRONTEND_LEFT, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_LEFT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);

	func_336(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT, true);

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_RIGHT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_X))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_Y))
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);

	if (PAD::IS_USING_CURSOR(FRONTEND_CONTROL))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		if (controlValue != 127 || iLocal_1995 != 127 || controlValue2 != 127 || iLocal_1996 != 127)
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "SET_ANALOG_STICK_INPUT");
			iLocal_1995 = controlValue;
			iLocal_1996 = controlValue2;
	...
	if (controlValue3 != 127 || iLocal_1997 != 127 || controlValue4 != 127 || iLocal_1998 != 127)
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_1283, "SET_ANALOG_STICK_INPUT");
		iLocal_1997 = controlValue3;
		iLocal_1998 = controlValue4;
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(false);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_1997);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_1998);
...
BOOL func_333() // Position - 0xC64C
{
	if (func_276() == 6)
		return false;

	return iLocal_1285 != 0;
}

void func_334() // Position - 0xC665
{
	if (!func_509())
		func_525(0, true);
	...
	{
		iLocal_566 = 0;
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SHOW_SCREEN", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		AUDIO::PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", true);
		return;
	}
	...
	if (func_335())
		...
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_1283, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);

	AUDIO::PLAY_SOUND_FRONTEND(-1, "Click_Back", "GTAO_SMG_Hangar_Computer_Sounds", true);
	return;
}

BOOL func_335() // Position - 0xC710
{
	return IS_BIT_SET(iLocal_536, 1);
}

void func_336(eControlType ectParam0, eControlAction ecaParam1, BOOL bParam2) // Position - 0xC71D
{
	if (!func_337())
	{
...
BOOL func_337() // Position - 0xC73F
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

void func_338() // Position - 0xC74D
{
	BOOL flag;
	int num;
	int num2;
	...
	flag = false;
	HUD::SET_WARNING_MESSAGE_WITH_HEADER("HAPP_SKP_W_T", "HAPP_SKP_W_M", 36, 0, true, Global_262145.f_15836, 0, 0, true, 0);
	func_336(FRONTEND_CONTROL, INPUT_FRONTEND_CANCEL, true);
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT))
	{
		if (MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_15836, false, true, false, -1, 0))
		{
		...
		else
		{
			...
			func_439(571220422, Global_262145.f_15836, 0);
			MISC::CLEAR_BIT(&iLocal_536, 15);
		}
	}
	...
	if (flag)
	{
		...
		if (num == 2)
		{
			...
			func_343(15966, true);
			Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_299.f_5 = 1;
			func_283();
...
void func_339() // Position - 0xC8D5
{
	if (func_333())
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_1285);

	return;
}

void func_340(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC8EB
{
	int num;
...
BOOL func_342(int iParam0, BOOL bParam1) // Position - 0xC94D
{
	if (Global_1575074)
		return false;
...
void func_343(int iParam0, BOOL bParam1) // Position - 0xC9D3
{
	BOOL flag;
	int num;
	...
	if (!func_406(num, bParam1 == _STAT_GET_PACKED_BOOL(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_405(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_403(iParam0, &num))
			flag = false;
	}
...
void func_344(var uParam0) // Position - 0xCA63
{
	uParam0->f_6 = func_387(*uParam0, uParam0->f_2);
	...
	if (uParam0->f_6 > uParam0->f_2.f_1)
	{
		...
		if (uParam0->f_2.f_1 == 0 && uParam0->f_6 > 0 && uParam0->f_2.f_2 > 1)
			func_379(uParam0->f_2);
	}

	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		func_375(uParam0->f_2);
	
		if (func_367(*uParam0, uParam0->f_1, false, false))
		{
			func_353(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2739945.f_7118.f_1 && func_405(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_345(var uParam0) // Position - 0xCB47
{
	var unk;
	BOOL flag;
	...
	unk = 10;
	flag = false;
	func_349(*uParam0, uParam0->f_2, &unk, &flag);

	if (uParam0->f_6 <= uParam0->f_2.f_1)
		return false;

	if (!flag)
		if (func_348(&unk, uParam0->f_2.f_1, uParam0->f_6, &(uParam0->f_2.f_3)))
			if (func_346(*uParam0, uParam0->f_2, uParam0->f_2.f_3))
				return false;
		else
			return false;
...
BOOL func_346(var uParam0, var uParam1, var uParam2) // Position - 0xCBB7
{
	int num;

	num = func_347(uParam0, uParam1, uParam2);
...
int func_347(int iParam0, int iParam1, int iParam2) // Position - 0xCBDF
{
	switch (iParam0)
	{
		case 17:
...
BOOL func_348(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xCCF8
{
	int num;
	int i;
...
void func_349(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xCD4A
{
	int i;
	int j;
...
void func_350(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xDF3F
{
	int i;
...
void func_353(int iParam0, int iParam1) // Position - 0xE1E5
{
	int num;
	BOOL address;
	int offset;
	...
	address = func_150(num, -1);
	offset = func_364(iParam0, iParam1);

	if (!IS_BIT_SET(address, offset))
	{
		func_357(iParam0, iParam1);
		MISC::SET_BIT(&address, offset);
		func_226(num, address, -1, true);
	}
...
void func_354(int iParam0, int iParam1) // Position - 0xE236
{
	int num;
	int offset;
...
int func_355(int iParam0) // Position - 0xE2F1
{
	return func_356(iParam0) / 8;
}

int func_356(int iParam0) // Position - 0xE302
{
	switch (iParam0)
	{
		case 2:
...
void func_357(int iParam0, int iParam1) // Position - 0xE475
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_362();
	hash = func_361();
	hash2 = func_360(iParam1);
	hash3 = func_358(iParam0);
	num2 = -1;
	unk_0x9C4B3BAF947660BB(entityCoords, num, hash, hash2, hash3, num2);
	return;
}

Hash func_358(int iParam0) // Position - 0xE4C8
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xE4E8
{
	switch (iParam0)
	{
		case 0:
...
Hash func_360(int iParam0) // Position - 0xE6A8
{
	switch (iParam0)
	{
		case 0:
...
Hash func_361() // Position - 0xE714
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_362() // Position - 0xE724
{
	if (Global_1668413 == 0)
		func_363();
...
int func_364(int iParam0, int iParam1) // Position - 0xE76B
{
	if (iParam1 == 4)
		iParam1 = 3;

	return (func_365(iParam0) * 4) + iParam1;
}

int func_365(int iParam0) // Position - 0xE787
{
	return func_356(iParam0) % 8;
}

int func_366(int iParam0) // Position - 0xE798
{
	int num;
...
BOOL func_367(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE7EE
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_373(iParam0, iParam1, 0);
	num3 = (num2 + func_370(iParam0, iParam1)) - 1;
	i = 0;
...
BOOL func_368(int iParam0, int iParam1) // Position - 0xE88B
{
	BOOL flag;
	BOOL flag2;

	flag = func_369(iParam0, iParam1);
	flag2 = func_387(iParam0, iParam1);
	return flag2 >= flag;
}

int func_369(int iParam0, int iParam1) // Position - 0xE8AC
{
	int i;
...
int func_370(int iParam0, int iParam1) // Position - 0xF955
{
	if (func_371(iParam0))
	{
		switch (iParam1)
...
BOOL func_371(int iParam0) // Position - 0xF9C8
{
	int num;
...
int func_372(int iParam0) // Position - 0xF9F0
{
	switch (iParam0)
	{
		case 25:
...
int func_373(int iParam0, int iParam1, int iParam2) // Position - 0xFAF0
{
	int num;
	int i;
	int num2;
...
int func_374(int iParam0) // Position - 0xFB5C
{
	if (func_371(iParam0))
		return 13;
...
void func_375(int iParam0) // Position - 0xFB77
{
	int num;
	int num2;
	int offset;
...
int func_376(int iParam0) // Position - 0xFBB5
{
	return iParam0 % 32;
}

int func_377(int iParam0) // Position - 0xFBC2
{
	return iParam0 / 32;
}

int func_378(int iParam0) // Position - 0xFBCF
{
	switch (iParam0)
	{
		case 16:
...
void func_379(var uParam0) // Position - 0x10FDC
{
	int num;
	int num2;
	int num3;
...
int func_380(int iParam0) // Position - 0x11018
{
	switch (iParam0)
	{
		case 2:
...
void func_381(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x11B41
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_362();
	hash = func_386(uParam0.f_6 >= uParam0.f_2.f_2);
	hash2 = func_382(uParam0, uParam0.f_1, uParam0.f_2);
	unk3 = uParam0.f_6;
...
Hash func_382(int iParam0, var uParam1, int iParam2) // Position - 0x11BAA
{
	var unk;
	...
	TEXT_LABEL_APPEND_STRING(&unk, func_385(uParam1), 64);
	TEXT_LABEL_APPEND_STRING(&unk, "_OBJ_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_383((iParam2 - func_373(iParam0, uParam1, 0)) + 1), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_383(int iParam0) // Position - 0x11E99
{
	var unk;
...
char* func_384(var uParam0) // Position - 0x11EB3
{
	return uParam0;
}

char* func_385(int iParam0) // Position - 0x11EBD
{
	switch (iParam0)
	{
		case 0:
...
Hash func_386(BOOL bParam0) // Position - 0x11F11
{
	if (bParam0)
...
BOOL func_387(int iParam0, int iParam1) // Position - 0x11F34
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 76:
					flag = _STAT_GET_PACKED_INT(&func_156, -1);
					break;
			
				case 77:
					flag = func_150(12459, -1);
					break;
			
				case 78:
					flag2 = func_150(12444, -1);
				...
				case 79:
					...
					{
						flag = flag + func_402(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_402(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 11:
			switch (iParam1)
			{
				...
				case 103:
					flag = func_150(12044, -1);
					flag = flag + func_150(12042, -1);
					break;
		...
		case 2:
			switch (iParam1)
			{
				...
				case 22:
					...
					if (_STAT_GET_PACKED_BOOL(&func_268, -1))
						flag = flag + 1;
		...
		case 16:
			...
			{
				case 163:
					if (func_150(5448, -1) > false)
						flag = true;
					break;
			
				case 164:
					if (func_150(5453, -1) > true)
						flag = true;
					break;
				...
				case 167:
					if (func_150(5465, -1) > false)
						flag = true;
					break;
			
				case 168:
					if (func_150(5457, -1) >= true || func_150(5455, -1) >= true)
						flag = true;
					break;
			
				case 169:
					flag2 = func_150(5395, -1);
		...
		case 30:
			...
			{
				case 325:
					if (func_150(1209, -1) > false)
						flag = true;
					break;
			
				case 326:
					if (func_150(11921, -1) > false)
						flag = true;
					break;
			
				case 327:
					flag = func_397(40, -1) + func_397(41, -1);
					break;
			
				case 328:
					flag = func_150(11920, -1);
					break;
		...
		case 12:
			switch (iParam1)
			{
				...
				case 117:
					...
					if (func_150(11811, -1) >= 10)
						flag = flag + 1;
				
					if (func_150(11813, -1) >= 10)
						flag = flag + 1;
				...
				case 118:
					flag = func_150(11928, -1);
					break;
			
				case 119:
					flag = func_150(11927, -1);
					break;
		...
		case 5:
			switch (iParam1)
			{
				...
				case 45:
					if (_STAT_GET_PACKED_BOOL(&func_266, -1))
						flag = flag + 1;
		...
		case 32:
			switch (iParam1)
			{
				...
				case 352:
					flag = func_399(func_150(11964, -1));
					break;
		...
		case 13:
			switch (iParam1)
			{
				...
				case 125:
					if (func_150(9910, -1) > false)
						flag = true;
					break;
			
				case 126:
					if (IS_BIT_SET(func_150(9905, -1), 0))
						flag = true;
					break;
			
				case 127:
					if (func_388(128, -1) || func_388(129, -1) || func_388(130, -1))
						flag = true;
					break;
				...
				case 129:
					flag = func_150(9910, -1);
					break;
			
				case 130:
					if (IS_BIT_SET(func_150(9905, -1), 2))
						flag = true;
					break;
			
				case 131:
					flag = func_150(11930, -1);
					break;
		...
		case 20:
			...
			{
				case 215:
					if (func_150(9631, -1) == true && _STAT_GET_PACKED_BOOL(31737, -1))
						flag = true;
					break;
				...
				case 225:
					flag = func_150(9622, -1);
					break;
			
				case 226:
					flag = func_150(11932, -1);
					break;
		...
		case 22:
			switch (iParam1)
			{
				...
				case 243:
					if (IS_BIT_SET(func_150(9526, -1), 0) || IS_BIT_SET(func_150(9511, -1), 1))
						flag = true;
					break;
			
				case 244:
					if (IS_BIT_SET(func_150(9511, -1), 1))
						flag = true;
					break;
			
				case 245:
					if (func_150(9586, -1) > false)
						flag = true;
					break;
				...
				case 248:
					flag = func_150(11933, -1);
					break;
			
				case 249:
					flag = func_399(func_150(9586, -1));
					break;
				...
				case 252:
					if (func_150(9544, -1) > false)
						flag = flag + 1;
				
					if (func_150(9545, -1) > false)
						flag = flag + 1;
				
					if (func_150(9546, -1) > false)
						flag = flag + 1;
				
					if (func_150(9547, -1) > false)
						flag = flag + 1;
				
					if (func_150(9548, -1) > false)
						flag = flag + 1;
				
					if (func_150(9549, -1) > false)
						flag = flag + 1;
					break;
			
				case 253:
					flag = func_150(11926, -1);
					break;
			}
			break;
		...
		case 23:
			...
			{
				case 254:
					flag2 = func_150(8726, -1);
				
					if (func_399(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
				...
				case 257:
					if (IS_BIT_SET(func_150(8726, -1), 10))
						flag = true;
					break;
		...
		case 21:
			switch (iParam1)
			{
				...
				case 238:
					...
					if (_STAT_GET_PACKED_BOOL(&func_267, -1))
						flag = flag + 1;
					break;
		...
		case 26:
			switch (iParam1)
			{
				...
				case 294:
					if (func_150(7864, -1) > false || func_150(7865, -1) > false)
						flag = true;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 138:
					if (func_150(7231, -1) > false)
						flag = true;
					break;
			
				case 139:
					flag = func_150(12010, -1);
					break;
				...
				case 144:
					if (_STAT_GET_PACKED_BOOL(41989, -1))
						...
						flag = func_150(7212, -1);
					break;
			
				case 145:
					flag = func_150(7231, -1);
					break;
				...
				case 147:
					flag = func_150(7230, -1);
					break;
			
				case 148:
					flag = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_150(12025, -1) / 60));
					break;
			
				case 149:
					flag = func_150(7234, -1);
					break;
			}
			break;
		...
		case 15:
			switch (iParam1)
			{
				...
				case 154:
					flag = func_150(6116, -1);
					break;
			
				case 155:
					if (func_150(6118, -1) > false)
						flag = true;
					break;
				...
				case 162:
					flag = func_150(6119, -1);
					flag = flag + func_150(6120, -1);
					break;
			}
			break;
		...
		case 17:
			...
			{
				case 176:
					if (func_150(5303, -1) > false)
						flag = true;
					break;
			
				case 177:
					if (func_150(5332, -1) > false)
						flag = true;
					break;
				...
				case 180:
					if (func_150(11941, -1) > false)
						flag = true;
					break;
			
				case 181:
					flag = func_150(11940, -1);
					break;
			
				case 182:
					flag = func_150(5332, -1);
					break;
				...
				case 187:
					flag = func_150(11941, -1);
					break;
			
				case 188:
					flag = func_150(5333, -1);
					break;
			}
			break;
		...
		case 18:
			switch (iParam1)
			{
				...
				case 196:
					if (func_150(3913, -1) > false || func_150(3903, -1) > false)
						flag = flag + 1;
				
					if (func_150(3946, -1) > false || func_150(3932, -1) > false)
						flag = flag + 1;
				
					if (func_150(3948, -1) > false || func_150(3936, -1) > false)
						flag = flag + 1;
				
					if (func_150(3950, -1) > false || func_150(3940, -1) > false)
						flag = flag + 1;
				
					if (func_150(3952, -1) > false || func_150(3944, -1) > false)
						flag = flag + 1;
					break;
			
				case 197:
					flag = func_150(10411, -1);
					break;
			
				case 198:
					flag = flag + func_150(3954, -1);
					flag = flag + func_150(3955, -1);
					flag = flag + func_150(3956, -1);
					flag = flag + func_150(3957, -1);
					flag = flag + func_150(3958, -1);
					break;
			
				case 199:
					flag = func_150(11943, -1);
					break;
			
				case 200:
					flag = func_150(11969, -1);
					break;
			
				case 201:
					flag = func_150(11942, -1);
					break;
			}
			break;
		...
		case 19:
			switch (iParam1)
			{
				...
				case 206:
					if (func_150(3639, -1) > false)
						flag = true;
					break;
			
				case 207:
					if (func_150(3667, -1) > false)
						flag = true;
					break;
				...
				case 213:
					flag = flag + func_150(11970, -1);
					break;
			
				case 214:
					flag = func_150(3671, -1);
					break;
			}
			break;
		...
		case 29:
			...
			{
				case 317:
					if (func_150(1210, -1) > false || _STAT_GET_PACKED_BOOL(42023, -1))
						flag = true;
					break;
				...
				case 319:
					flag = func_150(819, -1);
					flag = flag + func_150(12029, -1);
					flag = flag + func_150(12030, -1);
					break;
				...
				case 321:
					flag = flag + func_399(func_150(11929, -1));
					flag = flag + func_399(func_150(11966, -1));
					flag = flag + func_399(func_150(11967, -1));
					flag = flag + func_399(func_150(11968, -1));
					break;
		...
		case 27:
			switch (iParam1)
			{
				...
				case 306:
					...
					if (_STAT_GET_PACKED_BOOL(&func_269, -1))
						flag = flag + 1;
...
BOOL func_388(int iParam0, int iParam1) // Position - 0x175DB
{
	Hash statHash;
	BOOL outValue;

	statHash = func_389(iParam0, iParam1);
...
Hash func_389(int iParam0, int iParam1) // Position - 0x175FF
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_152(iParam1));
}

BOOL func_390() // Position - 0x17615
{
	int num;
	BOOL flag;
	...
	flag = func_150(11960, -1);

	if (Global_2739945.f_6934.f_3 - flag >= 2)
	{
		func_391(41244, false, -1);
		return 0;
	}
...
void func_391(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1765C
{
	if (iParam2 == -1)
		iParam2 = func_153();
...
BOOL func_392() // Position - 0x17684
{
	BOOL flag;
	BOOL flag2;

	flag = _STAT_GET_PACKED_INT(41244, -1);
	flag2 = func_150(11960, -1);
	...
	func_391(41244, flag, -1);
	func_226(11960, Global_2739945.f_6934.f_3, -1, true);
	return flag;
}

BOOL func_393() // Position - 0x176FD
{
	BOOL address;
	int i;
	Hash weaponHash;
	...
	for (i = 0; i < 103; i = i + 1)
	{
		weaponHash = func_395(i);
		num = func_394(i);
	
		if (num == 17239)
		{
		}
		else if (IS_BIT_SET(func_150(num, -1), i % 32))
		{
	...
	func_391(41242, address, -1);
	return func_399(address);
}

int func_394(int iParam0) // Position - 0x177F3
{
	iParam0 = iParam0 / 32;
...
Hash func_395(int iParam0) // Position - 0x17866
{
	switch (iParam0)
	{
		case 34:
...
var func_396(BOOL bParam0, var uParam1, var uParam2) // Position - 0x17EA7
{
	if (bParam0)
		return uParam1;
...
BOOL func_397(int iParam0, int iParam1) // Position - 0x17EBE
{
	Hash statHash;
	int outValue;
...
Hash func_398(int iParam0, int iParam1) // Position - 0x17EE2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_152(iParam1));
}

BOOL func_399(BOOL bParam0) // Position - 0x17EF8
{
	int num;
	BOOL flag;
...
void func_400(var uParam0, int iParam1) // Position - 0x17F38
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_401() // Position - 0x17F4D
{
	int num;
	int num2;
	...
	func_391(41247, num2, -1);
	return num2;
}

int func_402(BOOL bParam0) // Position - 0x18193
{
	if (bParam0)
		return 1;
...
BOOL func_403(int iParam0, var uParam1) // Position - 0x181A5
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_404(iParam0, *uParam1, i);
	
		if (uParam1->f_2 != -1)
		{
			uParam1->f_2.f_2 = func_369(*uParam1, uParam1->f_2);
			uParam1->f_2.f_1 = func_387(*uParam1, uParam1->f_2);
...
int func_404(int iParam0, int iParam1, int iParam2) // Position - 0x1821D
{
	switch (iParam1)
	{
		case 0:
			switch (iParam2)
			{
				...
				case 2:
					if (func_402(_STAT_GET_PACKED_BOOL(51286, -1)) + func_402(_STAT_GET_PACKED_BOOL(51287, -1)) + func_402(_STAT_GET_PACKED_BOOL(51288, -1)) + func_402(_STAT_GET_PACKED_BOOL(51289, -1)) + func_402(_STAT_GET_PACKED_BOOL(51290, -1)) + func_402(_STAT_GET_PACKED_BOOL(51291, -1)) == 1)
						return 3;
...
int func_405(int iParam0) // Position - 0x1A259
{
	int num;
	int num2;
	int num3;
...
BOOL func_406(int iParam0, BOOL bParam1) // Position - 0x1A29F
{
	if (iParam0 == -1)
		return false;
...
int func_407(int iParam0) // Position - 0x1A2BB
{
	switch (iParam0)
	{
		case 51280:
...
void func_408() // Position - 0x1B298
{
	if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
...
BOOL func_409(var uParam0, var uParam1) // Position - 0x1B2BF
{
	switch (*uParam0)
	{
		case 0:
			if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
			{
				if (func_256(uParam1, false, true, iLocal_565))
				{
					if (*uParam1 == 2)
					{
						*uParam1 = 0;
			...
			{
				MONEY::_NETWORK_SPENT_SKIP_CARGO_SOURCE_SETUP(Global_262145.f_15836, false, true, iLocal_565);
				*uParam0 = 1;
			}
			break;
	
		case 1:
			func_410(3, uParam1, false);
			return *uParam1 != 1;
	}
...
void func_410(int iParam0, var uParam1, BOOL bParam2) // Position - 0x1B334
{
	int num;
	int num2;
	int num3;
	...
	if (!_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
	{
		if (num >= iParam0)
		{
			...
			func_434(num2);
			Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_299.f_3 = num2;
	...
	else if (num >= iParam0)
	{
		if (func_430(iParam0, uParam1))
		{
			if (*uParam1 == 2)
			{
				...
				func_434(num3);
				Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_299.f_3 = num3;
				*uParam1 = 2;
				func_431(iParam0, bParam2);
			}
			else if (*uParam1 == 3)
...
void func_411() // Position - 0x1B42F
{
	BOOL flag;
	BOOL flag2;
	int num;
	...
	if (flag2 > flag)
	{
		for (i = 0; i < 50; i = i + 1)
		{
			for (j = 0; j < 4; j = j + 1)
			{
				if (i == _STAT_GET_PACKED_INT(func_428(j), -1))
				{
					if (_STAT_GET_PACKED_INT(func_318(i), -1) != 0)
					{
						func_391(func_318(i), false, -1);
						func_391(func_428(i), 100, -1);
						Global_1958100[i] = false;
						num = num + 1;
					}
				}
			}
	...
	else if (flag2 < flag)
	{
		...
		num3 = flag - flag2;
		num4 = func_427(randomIntInRange);
...
void func_412() // Position - 0x1B58B
{
	BOOL flag;
	int instance_id;
	int i;
	...
	{
		instance_id = Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_9;
	...
	if (flag)
	{
		for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
		{
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
			{
				...
				{
					if (func_414(playerIndex))
					{
						instance_id2 = Global_2657994[playerIndex /*467*/].f_324.f_9;
					
						if (NETWORK::NETWORK_GET_HOST_OF_SCRIPT("AM_MP_HANGAR", instance_id2, 0) == playerIndex)
						{
							if (Global_1958099 > 0)
							{
								if (!_STOPWATCH_IS_INITIALIZED(&Global_1958162))
								{
									func_413(playerIndex, &Global_1958100);
									_STOPWATCH_INITIALIZE(&Global_1958162, false, false);
									Global_1958099 = Global_1958099 - 1;
								}
							}
						}
					}
...
void func_413(Player plParam0, var uParam1) // Position - 0x1B674
{
	Hash eventData;
	int i;

	eventData.f_3 = 50;
	eventData = -1544003568;
	eventData.f_1 = PLAYER::PLAYER_ID();
...
BOOL func_414(Player plParam0) // Position - 0x1B6C8
{
	if (func_319())
		if (plParam0 != _INVALID_PLAYER_INDEX())
			if (func_247(plParam0))
				return Global_2657994[plParam0 /*467*/].f_324.f_11 == PLAYER::PLAYER_ID();

	return false;
}

void func_415(int iParam0) // Position - 0x1B700
{
	int num;
	int num2;
	int num3;
	...
	if (func_425(num))
	{
		num2 = func_424(iParam0);
		num3 = func_417(num2, num);
		func_391(func_318(num), func_416(num3), -1);
		Global_1958100[num] = func_416(num3);
	}

	return;
}

BOOL func_416(int iParam0) // Position - 0x1B74B
{
	switch (iParam0)
	{
		case joaat("sm_prop_smug_crate_l_medical"):
...
int func_417(int iParam0, int iParam1) // Position - 0x1B804
{
	var unk;
	var unk3;
	...
	if (iParam1 > 0)
	{
		func_423(&unk, iParam0);
		func_421(&unk3, iParam1);
	
		if (func_419(&unk, &unk3, iParam1))
			return func_418(unk);
	}
	else if (iParam1 == 0)
	{
...
int func_418(int iParam0, var uParam1) // Position - 0x1B857
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_419(var uParam0, var uParam1, int iParam2) // Position - 0x1BA07
{
	int num;
	int i;
...
int func_420(var uParam0, int iParam1) // Position - 0x1BA78
{
	int i;
	int num;
	var unk;
...
void func_421(var uParam0, int iParam1) // Position - 0x1BAC6
{
	int num;

	num = func_316(Global_1958100[iParam1]);
	*uParam0 = func_315(num);
	uParam0->f_1 = func_422(num);
	return;
}

int func_422(int iParam0) // Position - 0x1BAEF
{
	switch (iParam0)
	{
		case joaat("sm_prop_smug_crate_l_medical"):
...
void func_423(var uParam0, int iParam1) // Position - 0x1BB9F
{
	int randomIntInRange;
...
int func_424(int iParam0) // Position - 0x1BBBA
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_425(int iParam0) // Position - 0x1BC1A
{
	return iParam0 >= 0 && iParam0 < 50;
}

int func_426() // Position - 0x1BC30
{
	int i;

	for (i = 0; i < 50; i = i + 1)
	{
		if (Global_1958100[i] == false)
			return i;
	}
...
int func_427(int iParam0) // Position - 0x1BC5D
{
	switch (iParam0)
	{
		case 0:
...
int func_428(int iParam0) // Position - 0x1BCC2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_429() // Position - 0x1BD04
{
	int i;
	int num;
...
BOOL func_430(int iParam0, var uParam1) // Position - 0x1BD42
{
	Hash hash;
	...
	switch (*uParam1)
	{
		case 0:
			...
			if (func_270(78225582, joaat("CATEGORY_CONTRABAND_QNTY"), hash, -886368739, iParam0, 0, 1, 4, 0, 3))
				*uParam1 = 1;
			else
				*uParam1 = 3;
...
void func_431(int iParam0, BOOL bParam1) // Position - 0x1BE02
{
	int address;
	int i;
	int j;
	...
	if (bParam1)
		func_432(address, &unk);

	func_412();
	return;
}

void func_432(int iParam0, var uParam1) // Position - 0x1BEA9
{
	int i;
	int num;
	var text;
...
struct<4> func_433(int iParam0) // Position - 0x1BF2D
{
	var unk;
...
void func_434(int iParam0) // Position - 0x1BFE0
{
	func_435(6104, iParam0, -1);
...
void func_435(int iParam0, int iParam1, int iParam2) // Position - 0x1C003
{
	BOOL flag;
	int num;
	...
	if (!func_406(num, iParam1 == func_150(iParam0, -1)))
	{
		flag = false;
	}
	else
...
BOOL func_436(int iParam0, var uParam1) // Position - 0x1C097
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_437(iParam0, *uParam1, i);
...
int func_437(int iParam0, int iParam1, int iParam2) // Position - 0x1C10F
{
	switch (iParam1)
	{
		case 0:
...
int func_438(int iParam0) // Position - 0x1D055
{
	switch (iParam0)
	{
		case 12460:
...
void func_439(int iParam0, Any anParam1, int iParam2) // Position - 0x1D46B
{
	if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() && NETWORK::IS_STORE_AVAILABLE_TO_USER())
	{
		func_440(iParam0, anParam1);
		Global_76829 = true;
...
void func_440(Hash hParam0, int iParam1) // Position - 0x1D497
{
...
void func_441() // Position - 0x1D4AB
{
	if (Global_76827)
	{
		func_336(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT, true);
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT) && !HUD::IS_WARNING_MESSAGE_ACTIVE())
		{
			...
			func_442(Global_76830, Global_76831, 113158192, 1);
		...
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "BACK", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			func_442(Global_76830, Global_76831, 113158192, 0);
			Global_76827 = false;
			Global_76829 = false;
		}
	}
...
void func_442(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1D57F
{
	var entityCoords;
...
void func_443() // Position - 0x1D5CE
{
	...
	func_464(0f, 0f, 1f, 1f, 0, 0, 0, 255);
	GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_1283, 255, 255, 255, 255, 0);
	...
	if (func_333() && !HUD::IS_WARNING_MESSAGE_ACTIVE())
	{
		...
		func_463(1);
		func_462(1);
		func_456(&iLocal_1285, &uLocal_1986, &uLocal_1286, func_461(&uLocal_1286));
	}
...
void func_444(BOOL bParam0) // Position - 0x1D694
{
	if (bParam0)
		func_446();
...
void func_445(int iParam0, int iParam1) // Position - 0x1D6E5
{
...
void func_446() // Position - 0x1D71B
{
	Global_2739945.f_4668 = 0;
	return;
}

void func_447(int iParam0) // Position - 0x1D72B
{
	if (func_453())
		return;
...
void func_448(int iParam0) // Position - 0x1D75E
{
	if (func_453())
		return;
...
BOOL func_449() // Position - 0x1D7E8
{
...
void func_450(BOOL bParam0, BOOL bParam1) // Position - 0x1D80F
{
	if (bParam0)
	{
		if (func_452(0))
...
BOOL func_451() // Position - 0x1D883
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_452(int iParam0) // Position - 0x1D891
{
	if (iParam0 == 1)
...
BOOL func_453() // Position - 0x1D8E8
{
	return IS_BIT_SET(Global_1958240, 19);
}

void func_454() // Position - 0x1D8F7
{
...
void func_455() // Position - 0x1D907
{
	Global_23848.f_134 = 1;
	return;
}

void func_456(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1D915
{
	int i;
			...
			for (i = 0; i < uParam2->f_693; i = i + 1)
			{
				if (IS_BIT_SET(uParam2->f_689, i))
				{
					...
					if (!IS_BIT_SET(uParam2->f_690, i))
					{
						...
						func_459(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action, true));
					
						if (action2 < 365)
							func_459(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action2, true));
					}
					else
					{
						control2 = uParam2->f_1[i /*57*/].f_54;
						controlGroup = uParam2->f_1[i /*57*/].f_55;
						func_459(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(control2, controlGroup, true));
					}
...
void func_457() // Position - 0x1DCBD
{
...
void func_458(int iParam0, var uParam1) // Position - 0x1DCDB
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
	return;
}

void func_459(const char* sParam0) // Position - 0x1DCFA
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_460(var uParam0) // Position - 0x1DD08
{
	Global_1982837 = 0;
	uParam0->f_692 = 0;
	return;
...
BOOL func_461(var uParam0) // Position - 0x1DD1B
{
	return Global_1982837 || uParam0->f_692;
}

void func_462(int iParam0) // Position - 0x1DD32
{
	Global_1577952 = iParam0;
	return;
}

void func_463(int iParam0) // Position - 0x1DD40
{
	Global_1675263.f_1163 = iParam0;
	return;
}

void func_464(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1DD51
{
	GRAPHICS::DRAW_RECT(fParam0 + (fParam2 * 0.5f), fParam1 + (fParam3 * 0.5f), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, false);
	return;
}

void func_465() // Position - 0x1DD80
{
	func_466(true);
...
void func_466(BOOL bParam0) // Position - 0x1DDBC
{
	if (bParam0)
		if (func_467())
...
BOOL func_467() // Position - 0x1DDE1
{
	return IS_BIT_SET(Global_2684721.f_2, 11);
}

void func_468() // Position - 0x1DDF2
{
	char* entryHeader;
	char* entryLine1;
...
BOOL func_469() // Position - 0x1DEB0
{
	return Global_1575074;
}

void func_470() // Position - 0x1DEBC
{
	if (!IS_BIT_SET(iLocal_536, 9))
	{
		if (!func_335())
		{
			if (!func_509())
			{
				...
				if (!func_474(2) && !IS_BIT_SET(Global_1944286, 2) && IS_BIT_SET(iLocal_536, 13))
				{
...
void func_471(int iParam0) // Position - 0x1DF49
{
	switch (iParam0)
	{
		case 0:
...
void func_472(int iParam0) // Position - 0x1DFE8
{
	int i;
	int num;
...
void _DISPLAY_HELP_TEXT_0(const char* text, int iParam1) // Position - 0x1E01F
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(text);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, false, true, iParam1);
	return;
...
BOOL func_474(int iParam0) // Position - 0x1E036
{
	switch (iParam0)
	{
		case 0:
			return func_475(15967);
	
		case 1:
			return func_475(15970);
	
		case 2:
			return func_475(15973);
	
		case 3:
			return func_475(15976);
	
		case 4:
			return func_475(15979);
	
		case 5:
			return func_475(15982);
	
		case 6:
			return func_475(15985);
	
		case 7:
			return func_475(15988);
	
		case 8:
			return func_475(15991);
...
BOOL func_475(int iParam0) // Position - 0x1E0D6
{
	int i;
	int num;
...
void func_476() // Position - 0x1E107
{
	func_477(2, 203, "HAPP_SU_B", &uLocal_1286, true, 365);
	return;
}

void func_477(int iParam0, int iParam1, char* sParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1E121
{
	int offset;
...
void func_478() // Position - 0x1E19E
{
	var unk;
	int i;
	int num;
	...
	if (!IS_BIT_SET(iLocal_536, 7) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		for (i = 0; i < num; i = i + 1)
		{
			num2 = i;
			...
			{
				unk = { func_481(num2) };
				iLocal_539 = func_480(num2);
				MISC::SET_BIT(&Global_1944286, i);
				func_471(num2);
				break;
			}
		}
	...
	if (!IS_BIT_SET(iLocal_536, 7) && !MISC::IS_STRING_NULL_OR_EMPTY(&unk))
	{
		_DISPLAY_HELP_TEXT_0(&unk, iLocal_539);
		MISC::SET_BIT(&iLocal_536, 7);
	}
	else if (IS_BIT_SET(iLocal_536, 7))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_575))
		{
			_STOPWATCH_INITIALIZE(&uLocal_575, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_575, iLocal_539, false))
		{
			MISC::CLEAR_BIT(&iLocal_536, 7);
			iLocal_539 = 0;
			_STOPWATCH_DESTROY(&uLocal_575);
		
			if (func_479())
				MISC::SET_BIT(&iLocal_536, 8);
		}
	}
...
BOOL func_479() // Position - 0x1E27E
{
	if (func_474(0) && func_474(1) && func_474(2) && func_474(3) && func_474(4) && func_474(6) && func_474(7) && func_474(8))
		return true;

	return false;
}

int func_480(int iParam0) // Position - 0x1E2DA
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_481(int iParam0) // Position - 0x1E356
{
	var unk;
...
BOOL func_482(int iParam0) // Position - 0x1E408
{
	int num;

	num = iParam0;

	if (!IS_BIT_SET(iLocal_536, 9) && iParam0 != 2)
		return false;

	switch (iParam0)
	{
		case 0:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && IS_BIT_SET(iLocal_536, 11))
				return true;
			break;
	
		case 1:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && IS_BIT_SET(iLocal_536, 12))
				return true;
			break;
	
		case 2:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && IS_BIT_SET(iLocal_536, 13))
				return true;
			break;
	
		case 3:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && IS_BIT_SET(iLocal_536, 9) && iLocal_566 == 0)
				return true;
			break;
	
		case 4:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && iLocal_566 == 1)
				return true;
			break;
	
		case 5:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && iLocal_566 == 1 && IS_BIT_SET(Global_1944286, 4) || func_474(4))
				return true;
			break;
	
		case 6:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && iLocal_566 == 2)
				return true;
			break;
	
		case 7:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && iLocal_566 == 2 && IS_BIT_SET(Global_1944286, 6) || func_474(6))
				return true;
			break;
	
		case 8:
			if (!func_474(iParam0) && !IS_BIT_SET(Global_1944286, num) && IS_BIT_SET(iLocal_536, 14) && iLocal_566 == 2 && IS_BIT_SET(Global_1944286, 6) || func_474(6) && IS_BIT_SET(Global_1944286, 7) || func_474(7))
				return true;
			break;
	}
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1E642
{
...
void func_484() // Position - 0x1E664
{
	if (iLocal_538 != -1)
		func_485(iLocal_538);
...
void func_485(int iParam0) // Position - 0x1E67A
{
	if (_CONVERSATION_ADD_LINE(&uLocal_579, "SMGCAUD", func_506(iParam0), 8, 0, 0, 0))
		iLocal_538 = -1;

	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1E69F
{
	func_505(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	...
	Global_23439 = 0;
	Global_2883585 = 0;
	return func_487(sParam2, iParam3, false);
}

BOOL func_487(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1E6ED
{
	Global_22443 = 0;
...
void func_488() // Position - 0x1E9BB
{
	if (!func_489())
		return;
...
BOOL func_489() // Position - 0x1E9F2
{
...
BOOL func_490(Player plParam0) // Position - 0x1EA55
{
	return func_14(plParam0, 20);
}

void func_491() // Position - 0x1EA65
{
	int i;
...
void func_492() // Position - 0x1EA95
{
...
BOOL func_493() // Position - 0x1EB2A
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1EBC3
{
	if (func_501(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1EC65
{
	func_496();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_496() // Position - 0x1EC7E
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_497(character) && !func_501(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_497(Global_114162.f_2367.f_539.f_4321))
...
BOOL func_497(eCharacter echParam0) // Position - 0x1ED7B
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1ED87
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1EDC4
{
	if (func_497(character))
		return func_500(character);
	else
...
Hash func_500(eCharacter echParam0) // Position - 0x1EDE9
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_501(int iParam0) // Position - 0x1EDF8
{
	return Global_44199 == iParam0;
}

void func_502() // Position - 0x1EE06
{
	int i;
...
BOOL func_503(int iParam0, int iParam1) // Position - 0x1EE5C
{
	switch (iParam0)
	{
		case 5:
...
void func_504() // Position - 0x1EE94
{
...
void func_505(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1EEEB
{
...
char* func_506(int iParam0) // Position - 0x1EF41
{
	switch (iParam0)
	{
		case 0:
...
void func_507() // Position - 0x1EF7B
{
	BOOL flag;

	if (!IS_BIT_SET(iLocal_536, 4) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		if (iLocal_566 == 0)
		{
	...
	else if (IS_BIT_SET(iLocal_536, 4))
	{
		if (!_STOPWATCH_IS_INITIALIZED(&uLocal_571))
		{
			_STOPWATCH_INITIALIZE(&uLocal_571, false, false);
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_571, iLocal_539, false))
		{
			MISC::CLEAR_BIT(&iLocal_536, 4);
			iLocal_539 = 0;
			_STOPWATCH_DESTROY(&uLocal_571);
...
BOOL func_508() // Position - 0x1F076
{
...
BOOL func_509() // Position - 0x1F0A8
{
	return _STAT_GET_PACKED_BOOL(15966, -1);
}

void func_510() // Position - 0x1F0B8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_525(0, true);
	else if (func_337())
...
BOOL func_511() // Position - 0x1F0F3
{
	return Global_76658;
}

void func_512() // Position - 0x1F0FF
{
	func_510();
	iLocal_1283 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("HANGAR_CARGO");

	if (!func_509())
		iLocal_1285 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("INSTRUCTIONAL_BUTTONS");
	...
	func_513(314, true, -1, true);
	return;
}

void func_513(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1F1E2
{
	Hash statName;

	statName = func_514(iParam0, iParam2);
...
Hash func_514(int iParam0, int iParam1) // Position - 0x1F205
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_152(iParam1));
}

int func_515(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F21A
{
	int num;
...
void func_516() // Position - 0x1F24D
{
	int i;
...
void func_517() // Position - 0x1F299
{
	if (func_508())
	{
		MISC::SET_BIT(&iLocal_536, 5);
	...
	else
	{
		...
		iLocal_539 = 800;
		func_519(true);
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_579, 2, 0, "NERVOUSRON", 0, 1);
	}

	return;
}

void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1F2D5
{
...
void func_519(BOOL bParam0) // Position - 0x1F370
{
	if (bParam0)
		Global_1835552 = 1;
	else
...
void func_520(int iParam0) // Position - 0x1F38A
{
...
void func_521() // Position - 0x1F3A4
{
	Global_1574755 = true;
...
void func_522(BOOL bParam0) // Position - 0x1F3CD
{
	if (bParam0)
	{
		func_523();
...
void func_523() // Position - 0x1F430
{
...
BOOL func_524() // Position - 0x1F459
{
	if (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_1283))
		return false;

	if (func_333())
		if (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_1285))
			return false;

	return true;
}

void func_525(int iParam0, BOOL bParam1) // Position - 0x1F487
{
...
void func_526() // Position - 0x1F4F4
{
	if (!Global_1574755)
		return;
...
void func_527() // Position - 0x1F50B
{
