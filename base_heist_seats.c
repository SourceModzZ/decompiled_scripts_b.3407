...
{
	MISC::CLEAR_BIT(&Global_1836281, 1);
	func_3(&uLocal_45);
	func_2();
	return;
}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0x12F
{
...
void func_11() // Position - 0x213
{
	...
	if (Global_1845107 == PLAYER::PLAYER_ID() && !IS_BIT_SET(Global_1882925[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*149*/].f_43.f_27, 5))
	{
		if (func_19(&uLocal_45, true, true))
			func_18(&uLocal_45);
	
		if (func_19(&uLocal_45, false, false))
		{
			MISC::SET_BIT(&Global_1836281, 1);
		
			if (iLocal_482 == 0 && !IS_BIT_SET(Global_1882925[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*149*/].f_43.f_27, 3) && !func_17() && !func_16() && !HUD::IS_PAUSE_MENU_ACTIVE() && !func_15(0) && !func_14() && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_RRIGHT))
				func_12(&uLocal_45);
		}
		else
		{
...
void func_12(var uParam0) // Position - 0x34E
{
	func_13(&(uParam0->f_421), 10);
	return;
}

void func_13(int* piParam0, int iParam1) // Position - 0x361
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_14() // Position - 0x371
{
	return Global_76658;
}

BOOL func_15(int iParam0) // Position - 0x37D
{
	if (iParam0 == 1)
...
void func_18(var uParam0) // Position - 0x410
{
	func_13(&(uParam0->f_421), 9);
	return;
}

BOOL func_19(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x423
{
	return uParam0->f_421.f_4 > 2 && bParam1 || func_8(&(uParam0->f_421), 11) && bParam2 || uParam0->f_421.f_4 < 8;
}

void func_20(var uParam0) // Position - 0x463
{
	var animDict;
	var animName;
	int num;
...
void func_21(var uParam0, BOOL bParam1) // Position - 0x894
{
...
int func_22(var uParam0) // Position - 0x9DF
{
	if (uParam0->f_421.f_8 == 2)
		return uParam0->f_421.f_8.f_1;

	return (uParam0->f_421.f_8.f_1 + 1) % func_23(uParam0->f_421.f_8);
}

int func_23(int iParam0) // Position - 0xA15
{
	switch (iParam0)
	{
		case 0:
...
var func_24(BOOL bParam0, var uParam1, var uParam2) // Position - 0xA4C
{
	if (bParam0)
		return uParam1;
...
BOOL func_25() // Position - 0xA63
{
	return func_26(PLAYER::PLAYER_ID());
}

BOOL func_26(Player plParam0) // Position - 0xA73
{
...
void func_27(var uParam0) // Position - 0xA92
{
	Vector3 vector;
	float num;
...
BOOL func_28(BOOL bParam0) // Position - 0xC1A
{
...
BOOL func_29(Ped pedParam0) // Position - 0xD05
{
	int weaponHash;
...
BOOL func_30(var uParam0) // Position - 0xD62
{
	return func_8(&(uParam0->f_421), 9);
}

void func_31(var uParam0) // Position - 0xD75
{
	var animDict;
	var animnName;

	if (func_22(uParam0) != uParam0->f_421.f_8.f_1 && uParam0->f_421.f_8.f_2 < 6 && uParam0->f_421.f_8.f_2 != 3 && uParam0->f_421.f_8.f_2 != 4)
	{
		func_21(uParam0, true);
		func_47(uParam0, &animDict);
...
void func_32(var uParam0) // Position - 0xE3E
{
	var animDict;
...
void func_33(var uParam0) // Position - 0xEB4
{
	int weaponHash;
...
void func_34() // Position - 0xF3D
{
	Global_23848.f_6 = 1;
	return;
}

void func_35(BOOL bParam0) // Position - 0xF4B
{
	if (bParam0)
		if (func_36())
...
BOOL func_36() // Position - 0xF70
{
	return IS_BIT_SET(Global_2684721.f_2, 11);
}

void func_37() // Position - 0xF81
{
	MISC::SET_BIT(&Global_8920, 4);
	return;
}

void func_38(int iParam0) // Position - 0xF91
{
	if (func_43())
		return;
...
void func_39(int iParam0) // Position - 0xFC4
{
	if (func_43())
		return;
...
void func_41(BOOL bParam0, BOOL bParam1) // Position - 0x1075
{
	if (bParam0)
	{
		if (func_15(0))
...
BOOL func_42() // Position - 0x10E9
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_43() // Position - 0x10F7
{
	return IS_BIT_SET(Global_1958240, 19);
}

Vector3 func_44(var uParam0) // Position - 0x1106
{
	var unk;

	unk = { uParam0->[uParam0->f_421.f_2 /*14*/].f_8.f_3 };

	if (func_25() && uParam0->f_421.f_8 == 0)
		unk.f_2 = unk.f_2 - 4f;

	return unk;
}

Vector3 func_45(var uParam0) // Position - 0x1146
{
	return uParam0->[uParam0->f_421.f_2 /*14*/].f_8;
}

void func_46(var uParam0, char* sParam1) // Position - 0x115D
{
...
void func_47(var uParam0, char* sParam1) // Position - 0x125D
{
...
void func_48(var uParam0) // Position - 0x13A1
{
...
int func_49(var uParam0) // Position - 0x13E2
{
	int randomIntInRange;
	...
	switch (uParam0->f_421.f_8)
	{
		...
		default:
			randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, func_23(uParam0->f_421.f_8));
			break;
	}
...
int func_50(int iParam0) // Position - 0x142A
{
	if (iParam0 >= 11)
		return 0;
	else if (iParam0 >= 9)
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1473
{
	int i;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x163D
{
	Player player;
...
BOOL func_55(var uParam0) // Position - 0x169D
{
	return uParam0->f_421 & 31 > 0;
}

BOOL func_56(Ped pedParam0, var uParam1) // Position - 0x16AF
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, uParam1->f_1, uParam1->f_1.f_3, uParam1->f_1.f_6, false, true, 0);
}

BOOL func_57(var uParam0) // Position - 0x16D4
{
	int i;
...
void func_58(var uParam0, int iParam1) // Position - 0x171F
{
	uParam0->f_421.f_4 = iParam1;
	return;
}

void func_59(int* piParam0, int iParam1) // Position - 0x1730
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_60(var uParam0) // Position - 0x1740
{
	if (uParam0->f_421.f_4 == 6)
	{
	}
...
float func_61(var uParam0) // Position - 0x17CA
{
...
void func_62(var uParam0) // Position - 0x181D
{
...
void func_63(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x187A
{
	int offset;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x18D1
{
	return -1;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x18DA
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x195E
{
	switch (func_69())
	{
		case 0:
...
int func_69() // Position - 0x19B5
{
	return Global_33105;
}

BOOL func_70() // Position - 0x19C0
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x19CF
{
...
BOOL func_72() // Position - 0x19E6
{
	return Global_2696433;
}

BOOL func_73() // Position - 0x19F2
{
	return Global_2684721.f_695;
}

BOOL func_74(Ped pedParam0) // Position - 0x1A01
{
...
BOOL func_75() // Position - 0x1A35
{
	if (Global_1845107 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1845107, true, 0))
			return false;
...
void func_77(var uParam0, int iParam1) // Position - 0x1F95
{
...
BOOL func_78(var uParam0, int iParam1) // Position - 0x1FB0
{
	var unk;
	var unk4;
	var unk7;
...
float func_79(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2053
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_80(float fParam0, var uParam1, var uParam2) // Position - 0x2074
{
	float num;
	float num2;
...
BOOL func_81(Player plParam0) // Position - 0x20B3
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (IS_BIT_SET(Global_1882925[plParam0 /*149*/].f_43.f_27, 3))
				return true;

	return false;
}

void func_82(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x20E5
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x215D
{
	float num;
	float num2;
	float num3;
...
Vector3 func_84(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x21A1
{
	return fParam0 + func_83(0f, 0.01f, 0.015f, fParam3);
}

Vector3 func_85() // Position - 0x21BF
{
	return 0f, -0.7f, -1f;
}

Vector3 func_86() // Position - 0x21CE
{
	return 0f, 0.1f, 1f;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x21DD
{
	int i;
...
BOOL func_88(BOOL bParam0) // Position - 0x22F3
{
	bParam0;
