...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (_SHOULD_NETWORK_SCRIPT_TERMINATE() || unk_0xF859473E4AD09F30())
			func_43();
		...
		if (unk_0x76CD105BCAC6EB9F())
		{
			...
			if (!func_28() || func_25(unk_0x259BE71D8A81D4FA(), 0))
				if (!Global_1836234 && !func_24(3) && !func_21(unk_0x259BE71D8A81D4FA(), 0) && !unk_0x3555462DB47B7AB1() && unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()) && !func_19(unk_0x259BE71D8A81D4FA()) && !func_17(func_18(unk_0x259BE71D8A81D4FA())) && !func_15(unk_0x259BE71D8A81D4FA(), 146) && !func_10(unk_0x259BE71D8A81D4FA()))
					if (func_9(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 4, 100, false))
						if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
							if (unk_0xC5F2281709805477(unk_0x4A8C381C258A124D()) || unk_0xFE90F09EC43D7D44(unk_0x4A8C381C258A124D()))
								if (!func_8(&(iLocal_137.f_1)))
									func_5(&(iLocal_137.f_1));
								else if (func_2(&(iLocal_137.f_1)) > 20f)
								...
								unk_0x873D736C20070A10(unk_0x259BE71D8A81D4FA());
						else if (func_8(&(iLocal_137.f_1)))
							func_1(&(iLocal_137.f_1));
		}
		else
		{
			func_43();
...
void func_5(var uParam0) // Position - 0x2FD
{
	if (!func_8(uParam0))
		func_6(uParam0);
...
void func_6(var uParam0) // Position - 0x315
{
	func_7(uParam0, 0f);
	return;
}

void func_7(var uParam0, float fParam1) // Position - 0x324
{
...
BOOL func_9(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x35C
{
	var unk;
	var unk47;
	var unk93;
...
{
	if (func_14(iParam0))
		if (func_13(iParam0, false))
			return Global_1887549[iParam0 /*611*/].f_10.f_33;

	return -1;
}

BOOL func_13(int iParam0, BOOL bParam1) // Position - 0x1114
{
	if (func_14(iParam0))
...
BOOL func_14(int iParam0) // Position - 0x1158
{
	int num;
...
BOOL func_15(int iParam0, int iParam1) // Position - 0x117A
{
...
BOOL func_16(int iParam0) // Position - 0x119A
{
	int num;
...
BOOL func_19(int iParam0) // Position - 0x121A
{
...
{
	return IS_BIT_SET(Global_1836233, iParam0);
}

BOOL func_25(int iParam0, int iParam1) // Position - 0x131C
{
	int num;
	...
	if (Global_1845221[num /*889*/] == iParam1)
		return true;

	return false;
}

BOOL func_26(int iParam0) // Position - 0x1355
{
	if (!func_14(iParam0))
		return false;
...
BOOL func_28() // Position - 0x137F
{
	...
	if (Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/] == -1)
		return false;
...
BOOL func_30() // Position - 0x13DF
{
	...
	{
		case 0:
			if (Global_1836234 || func_24(3))
				iLocal_137.f_4 = unk_0xA7B0B03284E7503C(1413.7028f, 2341.5168f, -232.3945f, 2016.2095f, 2998.893f, 161.0299f, 0, 1, 1, 1, 1);
		
			func_31(&uLocal_104[unk_0xAE032CEDCF23C6D5()], 1);
			iLocal_137 = 1;
			break;
	
		case 1:
			if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 1693.1636f, 2559.6162f, 44.5649f) >= 1030225f)
				iLocal_137 = 2;
			break;
	
		case 2:
			if (Global_1836234 || func_24(3))
				unk_0xD7B6A43ACC36D868(iLocal_137.f_4, 0);
...
int _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x153C
{
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x15C0
{
	switch (func_27())
	{
		case 0:
...
void func_45(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x167D
{
	...
	unk_0x6F4A865F87C7A3AD(&iLocal_102, 2, 0);
	unk_0x7B13DC83218D9AF5(&uLocal_104, 33, 0);
...
BOOL _NETWORK_WAIT_FOR_HOST_BROADCAST_DATA() // Position - 0x16CA
{
	int num;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1723
{
	int i;
...
void func_49(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x184A
{
	if (!unk_0x76CD105BCAC6EB9F())
		func_44();
...
int func_51(int iParam0) // Position - 0x2009
{
	switch (iParam0)
	{
		case 150:
...
int func_52(int iParam0, BOOL bParam1) // Position - 0x2325
{
	switch (iParam0)
	{
		case 226:
