...
BOOL func_2(Player plParam0, BOOL bParam1) // Position - 0x226
{
	Ped playerPed;
	...
	{
		if (IS_BIT_SET(Global_2657994[plParam0 /*467*/].f_324.f_6, 15))
		{
			if (bParam1)
			{
...
BOOL func_3(Vehicle veParam0, BOOL bParam1) // Position - 0x2A4
{
	if (Global_79564)
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x2F5
{
	Vehicle vehiclePedIsIn;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x37A
{
	return -1;
}

BOOL func_6(Player plParam0) // Position - 0x383
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_7(Player plParam0) // Position - 0x3A8
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_8(Player plParam0) // Position - 0x3D1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_10(Player plParam0) // Position - 0x411
{
...
int func_12(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x459
{
	if (bParam1)
		if (func_13(plParam0))
			return 1;
...
BOOL func_13(Player plParam0) // Position - 0x48B
{
	return func_14(plParam0);
}

BOOL func_14(Player plParam0) // Position - 0x499
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

BOOL func_15(Ped pedParam0) // Position - 0x4B0
{
