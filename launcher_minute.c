...
void main() // Position - 0x0
{
	...
	if (!func_282(&unk64, &num, unk61, 1f))
	{
		func_281();
	...
	if (num == 32)
	{
		unk_0xA63572E348CC4CFB({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 0, 1);
		unk_0xC4BCE90F7242F354({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 0);
		unk_0x2094BC4B6731BA68(unk61, 40f, 1, 0, 0, 0);
	}
	else if (num == 34)
	{
		uLocal_95 = func_257();
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			{
				if (!func_219(329.513f, 3402.691f, 36.258f, unk_0xD1A6A821F5AC81DB(num.f_35[1], 1), 1056964608))
				{
		...
		func_215(num);
		func_208(&iLocal_94, &(num.f_9), unk61);
	
		if (num == 32)
			func_204(&num, unk61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		else if (num == 34)
			func_199(&num, unk61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
	
		if (func_185(&num, 0))
		{
			if (func_184(num))
				func_181(num, &uLocal_96);
...
void func_3(int iParam0, var uParam1) // Position - 0x45A
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xCDC
{
	var unk;
...
void func_21(var uParam0) // Position - 0xDD3
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xE03
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1ADC
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2987
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2A0F
{
...
BOOL func_29(var uParam0) // Position - 0x2A4F
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2A7D
{
...
int func_31(var uParam0) // Position - 0x2B59
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2B9B
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2BFE
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2C8C
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2F36
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3555
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3684
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x37CB
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3808
{
...
int func_47(eCharacter echParam0) // Position - 0x382D
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x383C
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3A05
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3A7E
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A93
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3FDC
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4343
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x4436
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x4957
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x56D8
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5713
{
	int num;
...
void func_67(int iParam0) // Position - 0x5987
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x59C3
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F12
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F56
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66D5
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x671C
{
...
BOOL func_73(int iParam0) // Position - 0x6777
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6787
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x67E7
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B9E
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6BA9
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BB9
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C5B
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x73D5
{
...
int func_81() // Position - 0x76D0
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76DF
{
...
int func_83() // Position - 0x7709
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7721
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7736
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x774D
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x77A5
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x784F
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x78E4
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7928
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7AAC
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7ABA
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8581
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8603
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x865B
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8664
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x88EB
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x88FB
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8918
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8928
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C6B
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8C7C
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8CC2
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D48
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D7B
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8DCC
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8E6E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E90
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8EA7
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EB4
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8EEE
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F29
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F65
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F7E
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8FE1
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8FF7
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x900D
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x904F
{
...
struct<2> func_119(int iParam0) // Position - 0x9077
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x94C4
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA79C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAAE2
{
	int num;
...
void func_124(int iParam0) // Position - 0xAB87
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAC22
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAC80
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xACD9
{
...
int func_129(int iParam0) // Position - 0xAD5C
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD8D
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADA2
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE55
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE70
{
	int i;
...
int func_135(int iParam0) // Position - 0xAEBC
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAF05
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAF25
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAF46
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xB016
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xB069
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB15F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB1CA
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB209
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB358
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB372
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB3CB
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB40C
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB42E
{
...
BOOL func_150() // Position - 0xB46D
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB47B
{
	int num;
...
void func_153(int iParam0) // Position - 0xB4D5
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB4F8
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB59C
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB62B
{
...
void func_161(var uParam0) // Position - 0xB682
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB6AE
{
...
void func_164(int iParam0) // Position - 0xB850
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB883
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB90D
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB981
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB98F
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB9E6
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB9F5
{
...
BOOL func_171(int iParam0) // Position - 0xBA36
{
	int num;
...
void func_172(int iParam0) // Position - 0xBA7B
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBAAD
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBBE4
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC33
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBC44
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBE25
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBE47
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBE58
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBEA1
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xBEC5
{
	switch (iParam0)
	{
		case 0:
...
var func_182(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC336
{
	var unk;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC362
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC379
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC408
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCBEB
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCC06
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCC94
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCCF8
{
	var unk;
...
BOOL func_190(int iParam0) // Position - 0xCD8F
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD4AC
{
	return Global_101727.f_1;
}

BOOL func_192() // Position - 0xD4BA
{
	if (Global_98585 != -1)
...
BOOL func_195() // Position - 0xD521
{
	return Global_101740.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD532
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD56A
{
	return Global_1575084;
}

BOOL func_198() // Position - 0xD576
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD592
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_203(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD61A
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD655
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6AB
{
...
float func_203(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD746
{
	var unk;
...
int func_204(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD780
{
	var unk;
	...
	if (!(*uParam10 == 3))
	{
		if (func_190(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_203(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			else if (func_206(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && func_203(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
			{
			...
			if (func_203(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_205(int iParam0) // Position - 0xD8CB
{
	Global_23436 = iParam0;
	return;
}

BOOL func_206(char* sParam0) // Position - 0xD8D8
{
	var unk;
...
struct<6> func_207() // Position - 0xD8F8
{
	var unk;
...
void func_208(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD91C
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_203(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_211(uParam0, 1);
			}
			else
			{
				...
				if (func_203(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_213(uParam0);
			}
		}
	}
...
void func_209(int iParam0, BOOL bParam1) // Position - 0xDA0D
{
	if (iParam0 == -1)
		return;
...
int func_210(int iParam0) // Position - 0xDA49
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_211(var uParam0, int iParam1) // Position - 0xDA82
{
	BOOL flag;
	int i;
...
BOOL func_212() // Position - 0xDB20
{
	return Global_98972;
}

void func_213(var uParam0) // Position - 0xDB2C
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xDB43
{
	BOOL flag;
	int num;
	int i;
...
void func_215(int iParam0) // Position - 0xDC2B
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
void func_216(var uParam0) // Position - 0xDC53
{
	int i;
	var unk;
...
void func_217(var uParam0) // Position - 0xDF57
{
	var unk;
...
void func_218(var uParam0) // Position - 0xDFF4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_219(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xE01F
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_220(var uParam0) // Position - 0xE058
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE0B5
{
	var unk;
...
void func_223(int iParam0, var uParam1, int iParam2) // Position - 0xE325
{
	var unk;
	var unk2;
...
BOOL func_224(int iParam0) // Position - 0xE67D
{
...
BOOL func_225(var uParam0) // Position - 0xE69D
{
...
BOOL func_226(var uParam0) // Position - 0xE6B5
{
...
void func_227(var uParam0) // Position - 0xE6DA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE75A
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_229(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_229(var uParam0, var uParam1) // Position - 0xE918
{
	var unk;
...
BOOL func_230(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE948
{
	int i;
	int num;
...
BOOL func_231(int iParam0) // Position - 0xEC04
{
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xEC38
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_243(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_233(var uParam0, int iParam1) // Position - 0xECAE
{
	return func_234(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_234(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xECC6
{
	BOOL flag;
	var unk;
	int num;

	num = func_242(uParam0, uParam1);
	...
	if (!func_238(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_235(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_235(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xED87
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_236(var uParam0, int iParam1) // Position - 0xEEB3
{
	int num;
...
BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEFC2
{
	var unk;
	var unk4;
	float num;

	unk = { func_240(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_240(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_239(unk4, unk);
...
float func_239(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF053
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_240(float fParam0, var uParam1, var uParam2) // Position - 0xF074
{
	float num;
	float num2;
...
void func_241(var uParam0) // Position - 0xF0B3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_242(var uParam0, var uParam1) // Position - 0xF0CE
{
	int i;
...
int func_243(var uParam0) // Position - 0xF10D
{
...
BOOL func_244(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF135
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_248(uParam0, bParam1, num, num2))
				return true;
		
			if (func_245(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_245(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF230
{
	float num;
	float num2;
...
BOOL func_246(var uParam0, float fParam1) // Position - 0xF33C
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_247(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_247(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF3D1
{
	var unk;
	var unk4;
	float num;

	unk = { func_240(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_248(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF45F
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_249(int iParam0) // Position - 0xF4A7
{
...
BOOL func_250(int iParam0) // Position - 0xF4F1
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_251(int iParam0) // Position - 0xF586
{
...
BOOL func_254(int iParam0) // Position - 0xF605
{
	if (func_255() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_255() // Position - 0xF639
{
...
BOOL func_256(int iParam0) // Position - 0xF677
{
...
BOOL func_259(var uParam0) // Position - 0xF72C
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
			{
				...
				unk_0xCCA6D8A84EE8C88A(num[1], 1);
			}
...
void func_260(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFA4F
{
	func_261(uParam0);
...
void func_261(var uParam0) // Position - 0xFA92
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_262(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFB2E
{
...
BOOL func_263(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB8A
{
	int num;
...
int func_264(var uParam0, eCharacter echParam1) // Position - 0xFC18
{
	int num;
...
void func_265(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFC5E
{
	func_218(uParam0);
...
BOOL func_266(var uParam0) // Position - 0xFC85
{
	if (func_226(uParam0))
	{
...
BOOL func_267(var uParam0) // Position - 0xFCAF
{
	int i;
...
void func_268(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0xFCE0
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_269(var uParam0) // Position - 0xFD1C
{
	int num;
	int i;
...
BOOL func_270(var uParam0) // Position - 0xFE2F
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			...
			if (!func_267(&num) || !unk_0xE100DD4F82A51BDE("rcmminute1"))
				return false;
...
void func_271(var uParam0, var uParam1) // Position - 0x10154
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		unk_0xD45558BDBDE86734(uParam0, 0);
...
BOOL func_272(int iParam0) // Position - 0x1018A
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x101DB
{
	var unk;
...
BOOL func_274(int iParam0) // Position - 0x10294
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x10355
{
	int i;
	var unk;
	int num;
...
BOOL func_276(int iParam0, char* sParam1) // Position - 0x103DA
{
...
BOOL func_277(int iParam0) // Position - 0x104BC
{
...
BOOL func_278(int iParam0) // Position - 0x104E7
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10512
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x1053D
{
	if (func_251(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_281() // Position - 0x10572
{
...
BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1058C
{
	int i;
...
BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x105F1
{
	int num;
	char* str;
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10669
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x106E4
{
	char* str;
	...
	if (*uParam0 == 32)
		unk_0xA63572E348CC4CFB({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 1, 1);
	else if (*uParam0 == 34)
...
void func_286(char* sParam0) // Position - 0x107D1
{
...
void func_287() // Position - 0x107F0
{
	Global_21291 = 0;
	func_288();
	return;
...
void func_288() // Position - 0x10800
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
int func_289(var uParam0) // Position - 0x10821
{
	if (func_226(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_290(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10857
{
...
void func_291(var uParam0, BOOL bParam1) // Position - 0x10877
{
	func_292(&(uParam0->f_41), bParam1);
	return;
}

void func_292(var uParam0, BOOL bParam1) // Position - 0x10889
{
	int i;
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x108C7
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x10902
{
	func_295(&(uParam0->f_35), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x10914
{
	int i;
...
void func_296(var uParam0) // Position - 0x10951
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_297(var uParam0, int iParam1) // Position - 0x10989
{
	func_298(&(uParam0->f_28), iParam1);
	return;
}

void func_298(var uParam0, int iParam1) // Position - 0x1099B
{
	int i;
...
void func_299(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x109DC
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_300(var uParam0) // Position - 0x10A2C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_301(int iParam0) // Position - 0x10A6D
{
	if (*iParam0 == -1)
		return;
...
void func_302(char* sParam0) // Position - 0x10AAA
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_303(var uParam0) // Position - 0x10ABC
{
	*uParam0 = -1;
...
void func_304() // Position - 0x10AEF
{
...
int func_305(eCharacter echParam0) // Position - 0x10B09
{
	if (!func_36(echParam0))
