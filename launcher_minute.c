...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1ADC
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2987
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A0F
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4957
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x56D8
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5713
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5987
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F12
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BB9
{
	int i;
...
int func_97() // Position - 0x8920
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8930
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x894D
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x895D
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8CA0
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8CB1
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8CF7
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D7D
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8DB0
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8E01
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8EA3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8EC5
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8EDC
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EE9
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8F23
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F5E
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F9A
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8FB3
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x9016
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x902C
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x9042
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9084
{
...
struct<2> func_119(int iParam0) // Position - 0x90AC
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x94F9
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA7D1
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAB17
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xABBC
{
	var name;
...
void func_125(int iParam0) // Position - 0xAC57
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xACB5
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAD0E
{
...
int func_129(Ped pedParam0) // Position - 0xAD91
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xADC2
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADD7
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE8A
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAEA5
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAEF1
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAF3A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAF5A
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAF7B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xB04B
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB09E
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB194
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB1FF
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB23E
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB38D
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB3A7
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB400
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB441
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB463
{
...
BOOL func_150() // Position - 0xB4A2
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB4B0
{
	int num;
...
void func_153(int iParam0) // Position - 0xB50A
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB52D
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5D1
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB660
{
...
void func_161(Vehicle veParam0) // Position - 0xB6B7
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB6E3
{
...
void func_164(int iParam0) // Position - 0xB885
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB8B8
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB942
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB9B6
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB9C4
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBA1B
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xBA2A
{
...
BOOL func_171(int iParam0) // Position - 0xBA6B
{
	int num;
...
void func_172(int iParam0) // Position - 0xBAB0
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBAE2
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBC19
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC68
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBC79
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBE5A
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBE7C
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBE8D
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBED6
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xBEFA
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC36A
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC396
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC3AD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC43C
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCC1F
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCC3A
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCCC8
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCD2C
{
...
BOOL func_190(int iParam0) // Position - 0xCDC3
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD4E0
{
	return Global_101752.f_1;
}

BOOL func_192() // Position - 0xD4EE
{
	if (Global_98610 != -1)
...
BOOL func_195() // Position - 0xD555
{
	return Global_101765.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD566
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD59E
{
	return Global_1575086;
}

BOOL func_198() // Position - 0xD5AA
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD5C6
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD64E
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD689
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6DF
{
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD77A
{
...
int func_204(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD7B4
{
	var unk;
...
void func_205(int iParam0) // Position - 0xD8FF
{
	Global_23453 = iParam0;
	return;
}

BOOL func_206(char* sParam0) // Position - 0xD90C
{
	var string1;
...
struct<6> func_207() // Position - 0xD92C
{
	var unk;
...
void func_208(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD950
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, BOOL bParam1) // Position - 0xDA41
{
	if (iParam0 == -1)
		return;
...
int func_210(int iParam0) // Position - 0xDA7D
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_211(var uParam0, int iParam1) // Position - 0xDAB6
{
	BOOL flag;
	int i;
...
BOOL func_212() // Position - 0xDB54
{
	return Global_98997;
}

void func_213(var uParam0) // Position - 0xDB60
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xDB77
{
	BOOL flag;
	int num;
	int i;
...
void func_215(int iParam0) // Position - 0xDC5F
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
void func_216(var uParam0) // Position - 0xDC87
{
	int i;
	int taskSequenceId;
...
void func_217(Ped pedParam0) // Position - 0xDF8B
{
	int taskSequenceId;
...
void func_218(Object* pobParam0) // Position - 0xE028
{
...
BOOL func_219(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xE053
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_220(Vehicle veParam0) // Position - 0xE08C
{
...
void func_223(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE359
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_224(int iParam0) // Position - 0xE6B1
{
...
BOOL func_225(var uParam0) // Position - 0xE6D1
{
...
BOOL func_226(var uParam0) // Position - 0xE6E9
{
...
void func_227(var uParam0) // Position - 0xE70E
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE78E
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_229(Ped pedParam0, Vehicle veParam1) // Position - 0xE94C
{
...
BOOL func_230(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE97C
{
	int i;
	int num;
...
BOOL func_231(int iParam0) // Position - 0xEC38
{
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xEC6C
{
	float xSize;
...
BOOL func_233(Ped pedParam0, int iParam1) // Position - 0xECE2
{
	return func_234(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xECFA
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_235(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEDBB
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_236(Ped pedParam0, int iParam1) // Position - 0xEEE7
{
...
BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEFF6
{
	var unk;
...
float func_239(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF087
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_240(float fParam0, var uParam1, var uParam2) // Position - 0xF0A8
{
	float num;
	float num2;
...
void func_241(var uParam0) // Position - 0xF0E7
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_242(Ped pedParam0, Ped pedParam1) // Position - 0xF102
{
	int i;
...
BOOL func_243(Ped pedParam0) // Position - 0xF141
{
...
BOOL func_244(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF169
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_245(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF264
{
	float entityCoords;
	float num;
...
BOOL func_246(Ped pedParam0, float fParam1) // Position - 0xF370
{
	var outProjectile;
	var outCoords;
...
BOOL func_247(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF405
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_248(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF493
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_249(int iParam0) // Position - 0xF4DB
{
...
BOOL func_250(int iParam0) // Position - 0xF525
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_251(int iParam0) // Position - 0xF5BA
{
...
BOOL func_254(int iParam0) // Position - 0xF639
{
	if (func_255() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_255() // Position - 0xF66D
{
...
BOOL func_256(int iParam0) // Position - 0xF6AB
{
...
BOOL func_259(var uParam0) // Position - 0xF760
{
	int num;
	int i;
	BOOL flag;
...
void func_260(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFA83
{
	func_261(pveParam0);
...
void func_261(Vehicle* pveParam0) // Position - 0xFAC6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFB62
{
...
BOOL func_263(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFBBE
{
	Hash model;
...
int func_264(var uParam0, eCharacter echParam1) // Position - 0xFC4C
{
	int num;
...
void func_265(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFC92
{
	func_218(pobParam0);
...
BOOL func_266(var uParam0) // Position - 0xFCB9
{
	if (func_226(uParam0))
	{
...
BOOL func_267(var uParam0) // Position - 0xFCE3
{
	int i;
...
void func_268(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0xFD14
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_269(var uParam0) // Position - 0xFD50
{
	int num;
	int i;
...
BOOL func_270(var uParam0) // Position - 0xFE63
{
	int num;
	int i;
	BOOL flag;
...
void func_271(Vehicle veParam0, Hash hParam1) // Position - 0x10188
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
...
BOOL func_272(int iParam0) // Position - 0x101BE
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x1020F
{
	const char* string2;
...
BOOL func_274(int iParam0) // Position - 0x102C8
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x10389
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_276(int iParam0, char* sParam1) // Position - 0x1040E
{
...
BOOL func_277(int iParam0) // Position - 0x104F0
{
...
BOOL func_278(int iParam0) // Position - 0x1051B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10546
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10571
{
	if (func_251(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_281() // Position - 0x105A6
{
...
BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x105C0
{
	int i;
...
BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10625
{
	int num;
	char* str;
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1069D
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x10718
{
	char* str;
...
void func_286(char* sParam0) // Position - 0x10805
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_206(sParam0))
			func_287();
...
void func_287() // Position - 0x10824
{
	Global_21308 = 0;
	func_288();
	return;
...
void func_288() // Position - 0x10834
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
int func_289(var uParam0) // Position - 0x10855
{
	if (func_226(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_290(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1088B
{
...
void func_291(var uParam0, BOOL bParam1) // Position - 0x108AB
{
	func_292(&(uParam0->f_41), bParam1);
	return;
}

void func_292(var uParam0, BOOL bParam1) // Position - 0x108BD
{
	int i;
...
void func_293(Object* pobParam0, BOOL bParam1) // Position - 0x108FB
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x10936
{
	func_295(&(uParam0->f_35), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x10948
{
	int i;
...
void func_296(Vehicle* pveParam0) // Position - 0x10985
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_297(var uParam0, int iParam1) // Position - 0x109BD
{
	func_298(&(uParam0->f_28), iParam1);
	return;
}

void func_298(var uParam0, int iParam1) // Position - 0x109CF
{
	int i;
...
void func_299(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10A10
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_300(Ped* ppedParam0) // Position - 0x10A60
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_301(int iParam0) // Position - 0x10AA1
{
	if (*iParam0 == -1)
		return;
...
void func_302(char* sParam0) // Position - 0x10ADE
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_303(var uParam0) // Position - 0x10AF0
{
	*uParam0 = -1;
...
void func_304() // Position - 0x10B23
{
...
Hash func_305(eCharacter echParam0) // Position - 0x10B3D
{
	if (!func_36(echParam0))
