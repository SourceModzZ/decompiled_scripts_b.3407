		...
		if (Global_21083.f_1 != 9)
		{
			switch (Global_21083.f_1)
			{
				case 7:
					if (iLocal_19 == 1)
					{
						if (func_8(FRONTEND_CONTROL, Global_21052, 0))
						{
				...
				case 8:
					if (func_8(FRONTEND_CONTROL, Global_21051, 0))
					{
						func_4();
						Global_21061 = 1;
...
void func_5() // Position - 0x1C6
{
	if (Global_21071)
	{
		func_6(Global_21064, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
		func_6(Global_21064, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_21064, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_21064, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);
	}
...
void func_9() // Position - 0x38F
{
	if (Global_21071)
	{
		func_6(Global_21064, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
		func_6(Global_21064, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_21064, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_21064, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);
	}
...
void func_10() // Position - 0x421
{
	if (iLocal_19 == 0)
	{
		...
		func_11(Global_21064, "SET_DATA_SLOT_EMPTY", 23f, -1082130432, -1082130432, -1082130432, -1082130432);
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_11(Global_21064, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432);
		iLocal_19 = 1;
	}
	else if (iLocal_19 == 1)
	{
