	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x198F
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x283A
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28C2
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4809
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x558A
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55C5
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5839
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC4
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A6B
{
	int i;
...
int func_97() // Position - 0x87D3
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x87E3
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8800
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8810
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B53
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8B64
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BAA
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C30
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C63
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CB4
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D56
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D78
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8D8F
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8D9C
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DD6
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E11
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E4D
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E66
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8EC9
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8EDF
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8EF5
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F37
{
...
struct<2> func_119(int iParam0) // Position - 0x8F5F
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93AC
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA684
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9CA
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAA6F
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB0A
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAB68
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABC1
{
...
int func_129(Ped pedParam0) // Position - 0xAC44
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC75
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC8A
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD3D
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD58
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xADA4
{
	int i;
...
BOOL func_136(Vehicle veParam0) // Position - 0xADED
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE0D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE2E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAEFE
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF51
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB047
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0B2
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0F1
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB240
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB25A
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2B3
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB2F4
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB316
{
...
BOOL func_150() // Position - 0xB355
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB363
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3BD
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB3E0
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB484
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB513
{
...
void func_161(Vehicle veParam0) // Position - 0xB56A
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB596
{
...
void func_164(int iParam0) // Position - 0xB738
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB76B
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB7F5
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB869
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB877
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB8CE
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB8DD
{
...
BOOL func_171(int iParam0) // Position - 0xB91E
{
	int num;
...
void func_172(int iParam0) // Position - 0xB963
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB995
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBACC
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB1B
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB2C
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD0D
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD2F
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBD40
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD89
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBDAD
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC593
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC5AE
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC63C
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC6A0
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC737
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_187(int iParam0) // Position - 0xC761
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCE7E
{
	return Global_101752.f_1;
}

BOOL func_189() // Position - 0xCE8C
{
	if (Global_98610 != -1)
...
BOOL func_192() // Position - 0xCEF3
{
	return Global_101765.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF04
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCF3C
{
	return Global_1575086;
}

BOOL func_195() // Position - 0xCF48
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCF64
{
	var unk;
...
BOOL func_197(char* sParam0) // Position - 0xD026
{
	var string1;
...
struct<6> func_198() // Position - 0xD046
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD06A
{
...
void func_200(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD0A5
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0FB
{
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD196
{
...
void func_203(var uParam0, var uParam1, const char* sParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD1D0
{
	float num;
	float num2;
	float num3;
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD2EE
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD32A
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD363
{
	BOOL flag;
	int i;
...
void func_207(var uParam0) // Position - 0xD401
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(uParam0);
...
void func_208(var uParam0) // Position - 0xD418
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_209() // Position - 0xD500
{
	return Global_98997;
}

void func_210(int iParam0) // Position - 0xD50C
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD534
{
	var unk;
	...
	if (func_248(*panParam0) || func_246(*panParam0) || Global_79810 == 1)
		return true;
...
void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD7A4
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_213(int iParam0) // Position - 0xDAFC
{
...
BOOL func_214(var uParam0) // Position - 0xDB1C
{
...
BOOL func_215(var uParam0) // Position - 0xDB34
{
...
void func_216(var uParam0) // Position - 0xDB59
{
	int i;
	int taskSequenceId;
...
void func_217(Object* pobParam0) // Position - 0xDE5D
{
...
void func_218(var uParam0) // Position - 0xDE88
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF08
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE0C6
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0F6
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE3B2
{
...
BOOL func_223(Vehicle veParam0, int iParam1) // Position - 0xE3E6
{
	float xSize;
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE45C
{
	return func_225(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE474
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE535
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE661
{
...
BOOL func_229(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE770
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE801
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE822
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE861
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Vehicle veParam0, Ped pedParam1) // Position - 0xE87C
{
	int i;
...
BOOL func_234(Vehicle veParam0) // Position - 0xE8BB
{
...
BOOL func_235(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8E3
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9DE
{
	float entityCoords;
	float num;
...
BOOL func_237(Vehicle veParam0, float fParam1) // Position - 0xEAEA
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB7F
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC0D
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xEC55
{
...
void func_241(Vehicle veParam0) // Position - 0xEC9F
{
	int taskSequenceId;
...
BOOL func_242(int iParam0) // Position - 0xED3C
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xEDD1
{
...
BOOL func_246(int iParam0) // Position - 0xEE50
{
	if (func_247() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_247() // Position - 0xEE84
{
...
BOOL func_248(int iParam0) // Position - 0xEEC2
{
...
BOOL func_249(var uParam0) // Position - 0xEEEA
{
	if (!func_250(uParam0))
		return false;
...
BOOL func_250(var uParam0) // Position - 0xEF09
{
	int num;
	int i;
	BOOL flag;
...
void func_251(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF0F5
{
	func_252(pveParam0);
...
void func_252(Vehicle* pveParam0) // Position - 0xF138
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_253(var uParam0) // Position - 0xF1D4
{
	int i;
...
BOOL func_254(int iParam0) // Position - 0xF205
{
	var unk;
	eCharacter character;
...
BOOL func_255(int iParam0) // Position - 0xF256
{
	const char* string2;
...
BOOL func_256(int iParam0) // Position - 0xF30F
{
	var unk;
...
BOOL func_257(int iParam0) // Position - 0xF3D0
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_258(int iParam0, char* sParam1) // Position - 0xF455
{
...
BOOL func_259(int iParam0) // Position - 0xF537
{
...
BOOL func_260(int iParam0) // Position - 0xF562
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_261(int iParam0) // Position - 0xF58D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_262(int iParam0) // Position - 0xF5B8
{
	if (func_243(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF607
{
	int i;
...
BOOL func_265(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF66C
{
	int num;
	char* str;
...
BOOL func_266(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF6E4
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_267(var uParam0, BOOL bParam1) // Position - 0xF75F
{
	if (bParam1)
	{
...
int func_268(var uParam0) // Position - 0xF7B5
{
	if (func_215(uParam0))
	{
...
void func_269(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF7EB
{
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xF80B
{
	func_271(&(uParam0->f_41), bParam1);
	return;
}

void func_271(var uParam0, BOOL bParam1) // Position - 0xF81D
{
	int i;
...
void func_272(Object* pobParam0, BOOL bParam1) // Position - 0xF85B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_273(var uParam0, BOOL bParam1) // Position - 0xF896
{
	func_274(&(uParam0->f_35), bParam1);
	return;
}

void func_274(var uParam0, BOOL bParam1) // Position - 0xF8A8
{
	int i;
...
void func_275(Vehicle* pveParam0) // Position - 0xF8E5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_276(var uParam0, int iParam1) // Position - 0xF91D
{
	func_277(&(uParam0->f_28), iParam1);
	return;
}

void func_277(var uParam0, int iParam1) // Position - 0xF92F
{
	int i;
...
void func_278(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF970
{
...
void func_279(Ped* ppedParam0) // Position - 0xF9C0
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_280(int iParam0) // Position - 0xFA01
{
	if (*iParam0 == -1)
		return;
...
void func_281(char* sParam0) // Position - 0xFA3E
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_282(var uParam0) // Position - 0xFA50
{
	*uParam0 = -1;
