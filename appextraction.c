...
void func_7() // Position - 0x1FB
{
	...
	if (IS_BIT_SET(Global_4546023, 23))
	{
		...
		unk_0x330108B080A2132F(Global_4546024);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546304));
		unk_0x330108B080A2132F(Global_4546025);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546304.f_1));
		unk_0x330108B080A2132F(Global_4546026);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546304.f_2));
		func_8("CELL_BODYG" /*Guard*/);
		unk_0x330108B080A2132F(Global_4546027);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546307));
		unk_0x330108B080A2132F(Global_4546028);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546307.f_1));
		unk_0x330108B080A2132F(Global_4546029);
		unk_0x330108B080A2132F(SYSTEM::FLOOR(Global_4546307.f_2));
	}
	else
	{
		unk_0x557F1E2300EF1A3E(0);
...
void func_11() // Position - 0x417
{
	if (Global_21054)
	{
		func_12(Global_21047, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
		func_12(Global_21047, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
