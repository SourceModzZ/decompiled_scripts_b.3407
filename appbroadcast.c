...
{
	return func_28(526, -1) || unk_0xB233964AC562A357() && func_27() != 0 && !func_23(0);
}
...
Hash func_25(int iParam0, int iParam1) // Position - 0x614
{
...
Hash func_29(int iParam0, int iParam1) // Position - 0x68D
{
...
BOOL func_33(Player plParam0, BOOL bParam1) // Position - 0x6EA
{
	if (func_38() != 0)
...
BOOL func_34(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x711
{
	if (bParam1)
		if (func_35(plParam0))
			return 1;
...
BOOL func_35(Player plParam0) // Position - 0x743
{
	return func_36(plParam0);
}

BOOL func_36(Player plParam0) // Position - 0x751
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

int func_37(Player plParam0) // Position - 0x768
{
...
void func_46() // Position - 0x8F1
{
	...
	func_54(Global_21064, "SET_DATA_SLOT_EMPTY", SYSTEM::TO_FLOAT(13), -1082130432, -1082130432, -1082130432, -1082130432);

	if (func_17())
		if (Global_2696372)
			func_53(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &uLocal_44, 0, 0, 0, 0);
		else
			func_53(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &uLocal_40, 0, 0, 0, 0);
	else
		func_53(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(12), -1f, -1f, &uLocal_48, 0, 0, 0, 0);

	func_54(Global_21064, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(13), -1082130432, -1082130432, -1082130432, -1082130432);
	func_50(&uLocal_36);
...
void func_47(int iParam0, const char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, int* piParam6) // Position - 0xA01
{
...
void func_48(int iParam0, int iParam1, char* sParam2, int iParam3, int* piParam4, int iParam5) // Position - 0xA31
{
	if (iParam1 == 1)
	{
		func_53(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 0f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_21071)
	{
		func_53(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		MISC::SET_BIT(piParam4, iParam3);
		func_49(iParam5, true);
		return;
	}

	func_53(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	MISC::SET_BIT(piParam4, iParam3);
	func_49(iParam5, true);
	return;
}
...
void func_50(const char* sParam0) // Position - 0xAFE
{
	func_51(Global_21064, "SET_HEADER", sParam0, 0, 0, 0, 0);
	return;
}

void func_51(int iParam0, char* sParam1, const char* sParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6) // Position - 0xB16
{
...
void func_52(const char* sParam0) // Position - 0xB71
{
...
void func_53(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0xB83
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
...
void func_54(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xC36
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
