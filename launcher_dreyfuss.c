...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_299(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_278(&unk64, &num, unk61, 1f))
	{
		func_277();
	...
	while (true)
	{
		...
		func_210(num);
		func_203(&iLocal_96, &(num.f_9), unk61);
	
		if (num == 8)
			func_199(&num, unk61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
...
void func_3(int iParam0, var uParam1) // Position - 0x332
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xBB4
{
	var unk;
...
void func_21(var uParam0) // Position - 0xCAB
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCDB
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19B4
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x285F
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x28E7
{
...
BOOL func_29(var uParam0) // Position - 0x2927
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2955
{
...
int func_31(var uParam0) // Position - 0x2A31
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A73
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2AD6
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B64
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E0E
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x342D
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x355C
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36A3
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E0
{
...
int func_47(eCharacter echParam0) // Position - 0x3705
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3714
{
...
var func_50(int iParam0, int iParam1) // Position - 0x38DD
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3956
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396B
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB4
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x421A
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x430D
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x482E
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x55AF
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x55EA
{
	int num;
...
void func_67(int iParam0) // Position - 0x585E
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x589A
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DE9
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E2D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65AC
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65F3
{
...
BOOL func_73(int iParam0) // Position - 0x664E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x665E
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66BE
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A75
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6A80
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A90
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B32
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72AC
{
...
int func_81() // Position - 0x75A7
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75B6
{
...
int func_83() // Position - 0x75E0
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x75F8
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x760D
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7624
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x767C
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7726
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77BB
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x77FF
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7983
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7991
{
	var unk;
...
BOOL func_94(Player plParam0) // Position - 0x84DE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97() // Position - 0x87C6
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x87D6
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x87F3
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8803
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B46
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8B57
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8B9D
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C23
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C56
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CA7
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D49
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D6B
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8D82
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8D8F
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DC9
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E04
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E40
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E59
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8EBC
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8ED2
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EE8
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F2A
{
...
struct<2> func_119(int iParam0) // Position - 0x8F52
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x939F
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA677
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9BD
{
	int num;
...
void func_124(int iParam0) // Position - 0xAA62
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAAFD
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAB5B
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABB4
{
...
int func_129(int iParam0) // Position - 0xAC37
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC68
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC7D
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD30
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD4B
{
	int i;
...
int func_135(int iParam0) // Position - 0xAD97
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xADE0
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE00
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE21
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAEF1
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF44
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB03A
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0A5
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0E4
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB233
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB24D
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2A6
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB2E7
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB309
{
...
BOOL func_150() // Position - 0xB348
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB356
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3B0
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB3D3
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB477
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB506
{
...
void func_161(var uParam0) // Position - 0xB55D
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB589
{
...
void func_164(int iParam0) // Position - 0xB72B
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB75E
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB7E8
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB85C
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB86A
{
	if (iParam0 == 1)
...
BOOL func_171(int iParam0) // Position - 0xB911
{
	int num;
...
void func_172(int iParam0) // Position - 0xB956
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB988
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBABF
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB0E
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB1F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD00
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBD22
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBD33
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD7C
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
int func_181() // Position - 0xBDA0
{
	if (func_184(2))
	{
		if (func_183(unk_0x4A8C381C258A124D(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()))
		{
			...
			else if (!func_182(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_160(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xBE41
{
	if (func_136(uParam0))
...
float func_183(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xBE74
{
	var unk;
...
BOOL func_184(int iParam0) // Position - 0xBEAE
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113182 || Global_33090 || func_191() || func_190(8, -1) || func_101() || func_189() || func_188() || func_187() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_192() || Global_33090 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113182 || Global_33090 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_192() || Global_113182 || Global_33090 || func_191() || func_190(8, -1) || func_101() || func_189() || func_187() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_185() // Position - 0xC5CF
{
	return Global_101727.f_1;
}

BOOL func_186() // Position - 0xC5DD
{
	if (Global_98585 != -1)
...
BOOL func_189() // Position - 0xC644
{
	return Global_101740.f_400 > 0;
}

BOOL func_190(int iParam0, int iParam1) // Position - 0xC655
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xC68D
{
	return Global_1575084;
}

BOOL func_192() // Position - 0xC699
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_193(var uParam0, int iParam1) // Position - 0xC6B5
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_194() // Position - 0xCE98
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_195(var uParam0) // Position - 0xCEB3
{
	float num;
...
void func_196(int iParam0, var uParam1) // Position - 0xCF41
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_197(BOOL bParam0) // Position - 0xCFA5
{
	var unk;
...
BOOL func_198(var uParam0) // Position - 0xD03C
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD066
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_183(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD0EE
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD129
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD17F
{
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD21A
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_183(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_206(uParam0, 1);
			}
			else
			{
				...
				if (func_183(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_208(uParam0);
			}
		}
	}
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD30B
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD347
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD380
{
	BOOL flag;
	int i;
...
BOOL func_207() // Position - 0xD41E
{
	return Global_98972;
}

void func_208(var uParam0) // Position - 0xD42A
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD441
{
	BOOL flag;
	int num;
	int i;
...
void func_210(int iParam0) // Position - 0xD529
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD551
{
	var unk;
	...
	if (func_248(*panParam0) || func_246(*panParam0) || Global_79785 == 1)
		return true;
...
void func_212(int iParam0, var uParam1, int iParam2) // Position - 0xD7C1
{
	var unk;
	var unk2;
...
BOOL func_213(int iParam0) // Position - 0xDB19
{
...
BOOL func_214(var uParam0) // Position - 0xDB39
{
...
BOOL func_215(var uParam0) // Position - 0xDB51
{
...
void func_216(var uParam0) // Position - 0xDB76
{
	int i;
	var unk;
...
void func_217(var uParam0) // Position - 0xDE7A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_218(var uParam0) // Position - 0xDEA5
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF25
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_220(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE0E3
{
	var unk;
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE113
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE3CF
{
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE403
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_234(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE479
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE491
{
	BOOL flag;
	var unk;
	int num;

	num = func_233(uParam0, uParam1);
	...
	if (!func_229(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_226(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE552
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE67E
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE78D
{
	var unk;
	var unk4;
	float num;

	unk = { func_231(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_231(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_230(unk4, unk);
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE81E
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE83F
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE87E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(var uParam0, var uParam1) // Position - 0xE899
{
	int i;
...
int func_234(var uParam0) // Position - 0xE8D8
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE900
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_239(uParam0, bParam1, num, num2))
				return true;
		
			if (func_236(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9FB
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEB07
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_238(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB9C
{
	var unk;
	var unk4;
	float num;

	unk = { func_231(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC2A
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_240(int iParam0) // Position - 0xEC72
{
...
void func_241(var uParam0) // Position - 0xECBC
{
	var unk;
...
BOOL func_242(int iParam0) // Position - 0xED59
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xEDEE
{
...
BOOL func_246(int iParam0) // Position - 0xEE6D
{
	if (func_247() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_247() // Position - 0xEEA1
{
...
BOOL func_248(int iParam0) // Position - 0xEEDF
{
...
BOOL func_251(var uParam0) // Position - 0xEF55
{
	int num;
	int i;
	BOOL flag;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
				{
					...
					unk_0xCCA6D8A84EE8C88A(iLocal_91, 1);
				}
			}
...
void func_252(int iParam0) // Position - 0xF170
{
...
void func_253(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF1C2
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_254(int iParam0, int iParam1) // Position - 0xF21A
{
	switch (iParam0)
	{
		case 12:
...
void func_255(int iParam0, BOOL bParam1) // Position - 0xF303
{
	if (bParam1)
...
BOOL func_256(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF32C
{
	BOOL flag;
	int num;
	int num2;
...
int func_258() // Position - 0xFCC1
{
	return Global_33088;
}

int func_259(var uParam0, int iParam1) // Position - 0xFCCC
{
	int i;
...
void func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13777
{
	func_261(uParam0);
...
void func_261(var uParam0) // Position - 0x137BA
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_262(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13856
{
	if (func_263(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_263(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x138B2
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_303(echParam1);
...
int func_264(var uParam0, eCharacter echParam1) // Position - 0x13940
{
	int num;
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x13F77
{
	...
	func_282(str);
	unk_0xCCA6D8A84EE8C88A(iLocal_91, 0);
	unk_0xD7B6A43ACC36D868(uLocal_97, 0);
	func_252(1);
...
void func_291(var uParam0, BOOL bParam1) // Position - 0x1413A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_294(var uParam0) // Position - 0x141C4
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_296(var uParam0, int iParam1) // Position - 0x1420E
{
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_297(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_297(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1424F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_298(var uParam0) // Position - 0x1429F
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_303(eCharacter echParam0) // Position - 0x1437C
{
	if (!func_36(echParam0))
