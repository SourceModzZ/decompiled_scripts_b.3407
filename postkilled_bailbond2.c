...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x1DD05E817C89C737() - unk3 > 100)
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				{
					if (SYSTEM::VDIST2(vector, unk_0xD1A6A821F5AC81DB(iLocal_77[num], 0)) >= (float)num3 * num3 && unk_0xF6C26AE940C14749(iLocal_77[num]))
					{
						func_7(&uLocal_102[num /*8*/], false);
						func_6(&iLocal_77[num], 1, 0, 1);
					}
					else
					{
						func_5(iLocal_77[num], &uLocal_102[num /*8*/], -1, 0, 0, 0, -1082130432, 0, -1, -1, true, 0, false);
					}
				}
				else if (unk_0xFC8BFE4B41177C22(iLocal_77[num]))
				{
					func_6(&iLocal_77[num], 1, 0, 1);
				}
			
				if (func_3(iLocal_77.f_5[num2]))
					if (SYSTEM::VDIST2(vector, uLocal_86[num2 /*3*/]) >= (float)num3 * num3)
						if (unk_0xF6C26AE940C14749(iLocal_77.f_5[num2]) || unk_0xCECDBB848D53DEB2(unk_0x4A8C381C258A124D(), iLocal_77.f_5[num2], 0))
							func_2(&iLocal_77.f_5[num2]);
				else if (unk_0xFC8BFE4B41177C22(iLocal_77.f_5[num2]))
					func_2(&iLocal_77.f_5[num2]);
...
BOOL func_1() // Position - 0x213
{
	...
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_77.f_5[i]))
			return false;
	}

	for (i = 0; i <= iLocal_77 - 1; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(iLocal_77[i]))
			return false;
	}
...
void func_2(var uParam0) // Position - 0x26C
{
...
BOOL func_3(var uParam0) // Position - 0x2A4
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0x2CE
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
int func_5(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x2EF
{
	BOOL flag;
...
void func_6(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4DF
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_7(var uParam0, BOOL bParam1) // Position - 0x52F
{
	BOOL flag;
	var unk;
...
BOOL func_8(var uParam0) // Position - 0x5A9
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (!unk_0x4FAFF4BCB7633475(uParam0))
			return true;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x749
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x786
{
...
int func_16(eCharacter echParam0) // Position - 0x7AB
{
...
void func_19() // Position - 0x9AC
{
	...
	unk_0x06CD913C241C765E("ENEMIES", &uLocal_143);
	unk_0xD414C47AFF81382A(5, joaat("PLAYER"), uLocal_143);
	unk_0xD414C47AFF81382A(5, uLocal_143, joaat("PLAYER"));

	for (i = 0; i <= iLocal_77.f_5 - 1; i = i + 1)
	{
		if (func_3(iLocal_77.f_5[i]))
		{
			unk_0xEE0BCDB1B5E36BCB(iLocal_77.f_5[i], 1, 1);
			uLocal_86[i /*3*/] = { unk_0xD1A6A821F5AC81DB(iLocal_77.f_5[i], 0) };
		}
	}
	...
	for (i = 0; i <= iLocal_77 - 1; i = i + 1)
	{
		...
		{
			unk_0xEE0BCDB1B5E36BCB(iLocal_77[i], 1, 1);
			unk_0x3CEA1FD137ACE2D9(iLocal_77[i], uLocal_143);
			func_5(iLocal_77[i], &uLocal_102[i /*8*/], -1, 0, 0, 0, -1082130432, 0, -1, -1, true, 0, false);
		}
	}
...
void func_20() // Position - 0xA79
{
	...
	unk_0x40D1AAC4EFD3C281(5, joaat("PLAYER"), uLocal_143);
	unk_0x40D1AAC4EFD3C281(5, uLocal_143, joaat("PLAYER"));

	for (i = 0; i <= iLocal_77 - 1; i = i + 1)
	{
		func_7(&uLocal_102[i /*8*/], false);
		func_6(&iLocal_77[i], 1, 0, 1);
	}
