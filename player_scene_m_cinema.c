...
int func_7(int iParam0, Entity eParam1) // Position - 0x431
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_8(Global_101434) && eParam1 != 0)
		{
			Global_101434 = 0;
		}
	}
...
Entity func_8(var uParam0) // Position - 0x515
{
	return uParam0;
}
...
void func_11() // Position - 0x574
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(character) && !func_16(14) || Global_113110)
			{
