...
Hash func_65(Hash hParam0, int iParam1) // Position - 0x4708
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_66(Hash hParam0, Any* panParam1) // Position - 0x5489
{
	int i;
	int numDlcWeapons;
...
Hash func_67(int iParam0) // Position - 0x54C4
{
	int num;
...
void func_68(Ped pedParam0) // Position - 0x5738
{
	eCharacter character;
...
BOOL func_70(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CC3
{
...
int func_79(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x696A
{
	int i;
...
int func_98() // Position - 0x86D5
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x86E5
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8702
{
	return func_75(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8712
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8A55
{
	return Global_101765.f_399 > 0;
}

var func_103() // Position - 0x8A66
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8AAC
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8B32
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8B65
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x8BB6
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x8C58
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C7A
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x8C91
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x8C9E
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8CD8
{
...
void func_113(var uParam0, int iParam1) // Position - 0x8D13
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8D4F
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_115(int iParam0) // Position - 0x8D73
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DD6
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DEC
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E02
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E43
{
...
struct<2> func_120(int iParam0) // Position - 0x8E6B
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x92B7
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA4FC
{
	switch (iParam0)
	{
		case 0:
...
void func_125(int iParam0) // Position - 0xA884
{
	var name;
...
void func_126(int iParam0) // Position - 0xA91F
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_128(Ped pedParam0) // Position - 0xA97D
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xA9D6
{
...
int func_130(Ped pedParam0) // Position - 0xAA59
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAA8A
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAA9F
{
	int num;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAB52
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xAB6D
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xABB9
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xAC02
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC22
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xAC43
{
	switch (iParam0)
	{
		case 5:
...
void func_141(char* sParam0) // Position - 0xAD13
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

BOOL func_142(int iParam0) // Position - 0xAD25
{
	if (iParam0 == -1)
		iParam0 = func_152();
...
BOOL func_143(int iParam0) // Position - 0xADBA
{
...
BOOL func_146(int iParam0) // Position - 0xAE39
{
	if (func_148() && Global_101713.f_11 == 6 && iParam0 == func_147(&(Global_101713.f_3), 0))
		return true;

	return false;
}

int func_147(const char* sParam0, int iParam1) // Position - 0xAE6D
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xAEF4
{
	return func_150(iParam0, Global_44199);
}

BOOL func_150(int iParam0, int iParam1) // Position - 0xAF05
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_151(int iParam0) // Position - 0xB0E6
{
...
int func_152() // Position - 0xB10E
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

BOOL func_153(int iParam0) // Position - 0xB11F
{
	int num;
	...
	num = func_155(&(Global_113249[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_154(int iParam0) // Position - 0xB164
{
...
int func_155(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB196
{
	int i;
...
void func_156(var uParam0, int iParam1) // Position - 0xB2CD
{
	int i;
...
BOOL func_157(int iParam0) // Position - 0xB31C
{
	if (Global_44199 == 15)
		return false;
...
BOOL func_158(int iParam0) // Position - 0xB33E
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113209 || Global_33108 || func_165() || func_164(8, -1) || func_102() || func_163() || func_162() || func_161() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_166() || Global_33108 || func_165() || func_164(8, -1) || func_162() || func_102() || func_163() || func_161() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113209 || Global_33108 || func_165() || func_164(8, -1) || func_162() || func_102() || func_163() || func_161() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113209 || Global_33108 || func_165() || func_164(8, -1) || func_102() || func_163() || func_161() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_166() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_164(8, -1) || func_161() || func_160() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_166() || Global_33108 || func_165() || func_164(8, -1) || func_163() || func_162() || func_161() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_166() || func_163() || Global_113209 || Global_33108 || func_165() || Global_45410 || func_164(8, -1) || func_162() || func_160() || func_161() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_166() || Global_113209 || Global_33108 || func_165() || func_164(8, -1) || func_162() || func_160() || func_102() || func_163() || func_161())
							return false;
						break;
				}
			}
...
BOOL func_159() // Position - 0xBA5B
{
	return Global_101752.f_1;
}

BOOL func_160() // Position - 0xBA69
{
	if (Global_98610 != -1)
...
BOOL func_163() // Position - 0xBAD0
{
	return Global_101765.f_400 > 0;
}

BOOL func_164(int iParam0, int iParam1) // Position - 0xBAE1
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_165() // Position - 0xBB19
{
	return Global_1575086;
}

BOOL func_166() // Position - 0xBB25
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_168(int iParam0) // Position - 0xBBBE
{
	int offset;
	int i;
...
void func_169(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xBC00
{
	func_170(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_170(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xBC21
{
	int i;
...
BOOL func_172(int iParam0) // Position - 0xBF0B
{
	int num;
	int i;
...
void func_174(BOOL bParam0) // Position - 0xBF5D
{
	func_175(51, bParam0);
	func_175(52, bParam0);
	func_175(53, bParam0);
...
void func_175(int iParam0, BOOL bParam1) // Position - 0xBF95
{
	if (iParam0 == -1)
		return;
...
void func_176(int iParam0, int iParam1, BOOL bParam2) // Position - 0xBFF2
{
	if (iParam0 == -1)
		return;
...
BOOL func_177(int iParam0, int iParam1) // Position - 0xC02D
{
	if (iParam0 == -1)
		return false;
...
BOOL func_179(int iParam0) // Position - 0xC074
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0xC09F
{
	func_59();
	return Global_114162.f_2367.f_539.f_4321;
}

int func_181(int iParam0) // Position - 0xC0B8
{
	int num;
	int offset;
...
int func_183(int iParam0) // Position - 0xC130
{
	int num;
	int offset;
