...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		switch (num)
		{
			...
			case 1:
				if (func_78(true))
					uLocal_107 = unk_0x1DD05E817C89C737();
			
				if (!func_77() && !Global_98591)
				{
					if (num != 2)
					{
						if (!unk_0x94A7730DEC6E86C8() && !flag && !func_76(5))
						{
							func_73();
							...
							if (func_72())
							{
										...
										switch (func_69("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/))
										{
											...
											case 1:
												...
												if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/))
													Global_114135.f_19101.f_22[15] = Global_114135.f_19101.f_22[15] + 1;
								...
								switch (iLocal_104)
								{
									case 0:
										if (func_70() == 0)
										{
											...
											{
												if (!unk_0x4C705AAF75363287() && func_60())
												{
													iLocal_105 = 9;
									...
									case 2:
										...
										if (func_61(&uLocal_116) > 15f)
										{
											...
											fLocal_109 = unk_0xD2AA6F822D3A55D2(10f, 40f) + func_61(&uLocal_116);
											iLocal_104 = 3;
										}
										else if (bLocal_110)
										{
								...
								if (unk_0x6D05C5731A838CB3(0, 86) && !unk_0xD1F1A906BA9226BE(unk_0x4A8C381C258A124D()) && !Global_33240 && unk_0x1DD05E817C89C737() - uLocal_107 > 3000)
								{
									num2 = func_70();
									...
									if (num2 == 0)
									{
										...
										unk_0x97A5024CE91641F1(&uLocal_97);
										func_87(&uLocal_116);
										ms = 0;
									}
									else if (num2 == 2)
							...
							else
							{
								...
								if (func_34("TC_JOBOFFERED" /*~s~Taxi job offered. To accept, press ~INPUT_VEH_HORN~~s~*/))
									func_30("TC_JOBOFFERED" /*~s~Taxi job offered. To accept, press ~INPUT_VEH_HORN~~s~*/, 1);
								...
								if (func_34("TC_H_TOODAMAGED" /*This taxi is too damaged. Repair it, or get a taxi in better condition to be offered or ask for taxi jobs.*/))
									func_30("TC_H_TOODAMAGED" /*This taxi is too damaged. Repair it, or get a taxi in better condition to be offered or ask for taxi jobs.*/, 1);
							
								if (func_34("TC_ANOTHERJOB" /*~s~For another taxi job, press ~INPUT_VEH_HORN~*/))
									func_30("TC_ANOTHERJOB" /*~s~For another taxi job, press ~INPUT_VEH_HORN~*/, 1);
							
								if (unk_0x1DD05E817C89C737() - uLocal_108 > 60000 && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TC_HOWTOSTART" /*~s~While driving a taxi, become available for jobs by pressing ~INPUT_VEH_HORN~*/) && bLocal_114)
									bLocal_114 = false;
			...
			case 4:
				if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
					unk_0x07A608749EC88F3A(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1);
			
				if (unk_0xA6E4F7A73ABC4A76(&uLocal_97))
				{
			...
			case 10:
				if (!unk_0xF40767E41852FB72(iLocal_96))
				{
			...
			case 11:
				...
				if (!func_5())
				{
					...
					if (iLocal_96 != 0)
					{
						if (unk_0xF40767E41852FB72(iLocal_96))
						{
							unk_0xC3CF96F73FC43848(iLocal_96);
							iLocal_96 = 0;
						}
					}
...
void func_2() // Position - 0x9EB
{
	...
	if (unk_0x1226C55CA7D2269A() || func_4())
	{
		unk_0x012C74D626CB4559(StackVal, 0, 0, 0);
	}
	else if (unk_0x0BA1A956D36B210F() || func_3() || unk_0x761778199FE1211C())
	{
...
BOOL func_3() // Position - 0xA37
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_4() // Position - 0xA4D
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

BOOL func_5() // Position - 0xA63
{
	return Global_101727.f_1;
}

void func_6(var uParam0) // Position - 0xA71
{
	if (*uParam0 == -1)
		return;
...
void func_7() // Position - 0xAAE
{
	func_8();
	return;
}

int func_8() // Position - 0xABB
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xB06
{
...
void func_10(int iParam0, int iParam1) // Position - 0xB2E
{
...
void func_11(int iParam0, BOOL bParam1) // Position - 0xB46
{
	func_12();
...
void func_12() // Position - 0xB96
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		Global_114135.f_19101.f_1[i /*2*/].f_1 = 0;
	}

	return;
}

void func_13(int iParam0, int iParam1, int iParam2) // Position - 0xBC1
{
	BOOL flag;
...
int func_15() // Position - 0x1165
{
	return Global_33087;
}

int func_16(int iParam0, int iParam1) // Position - 0x1170
{
	int num;
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x11C1
{
	if (iParam2 == -1)
		iParam2 = func_18();
...
int func_18() // Position - 0x11DF
{
	return Global_1574926;
}

int func_19(int iParam0) // Position - 0x11EB
{
	int num;
...
int func_22() // Position - 0x12E8
{
	return joaat("taxi");
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x12F5
{
...
void func_24(char* sParam0, BOOL bParam1) // Position - 0x1317
{
	eCharacter character;
...
void func_25(char* sParam0, var uParam1, int iParam2) // Position - 0x1387
{
...
int func_26(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x13A6
{
	int i;
...
void func_27(var uParam0, int iParam1) // Position - 0x14DD
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x152C
{
	return func_29(iParam0, Global_44181);
}

BOOL func_29(int iParam0, int iParam1) // Position - 0x153D
{
	if (iParam1 == 15)
		return 1;
...
void func_30(char* sParam0, int iParam1) // Position - 0x171E
{
	int i;
	int j;
...
void func_32(int iParam0) // Position - 0x18E2
{
...
void func_33(int iParam0, int iParam1) // Position - 0x197C
{
...
BOOL func_34(char* sParam0) // Position - 0x1A8C
{
	int i;
...
void func_35(int iParam0, char* sParam1, var uParam2, BOOL bParam3) // Position - 0x1AC7
{
	var unk;
	var unk7;
...
int func_36(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1BB1
{
...
int func_37(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1C05
{
	Global_22426 = 0;
...
BOOL func_40(int iParam0) // Position - 0x1F6D
{
	return func_41(iParam0, 20);
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x1F7D
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1F95
{
	return -1;
}

void func_43() // Position - 0x1F9E
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2124
{
	if (func_76(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x21C6
{
	func_49();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_49() // Position - 0x21DF
{
	eCharacter character;
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_50(character) && !func_76(14) || Global_113083)
			{
...
BOOL func_50(eCharacter echParam0) // Position - 0x22DC
{
	return echParam0 < CHAR_MULTIPLAYER;
}

int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x22E8
{
...
int func_52(eCharacter echParam0) // Position - 0x230D
{
	return Global_2201[echParam0 /*29*/];
}

void func_53() // Position - 0x231C
{
	int i;
...
BOOL func_54(int iParam0, int iParam1) // Position - 0x2373
{
	switch (iParam0)
	{
		case 5:
...
void func_55(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x23AB
{
...
char* func_56(int iParam0) // Position - 0x2401
{
	if (iParam0 == 0)
		return "OJTX_EXC_OFF";
	else if (iParam0 == 1)
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x24AA
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x24C1
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x250F
{
...
float func_61(var uParam0) // Position - 0x25E9
{
	if (func_65(uParam0))
		if (func_63(uParam0))
			return uParam0->f_2;
		else
			return func_62(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;

	return uParam0->f_1;
}

float func_62(BOOL bParam0) // Position - 0x2625
{
	float num;
	float num2;
	int value;
...
BOOL func_63(var uParam0) // Position - 0x267D
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_64(var uParam0) // Position - 0x268A
{
	if (!func_65(uParam0))
		func_79(uParam0);
...
BOOL func_65(var uParam0) // Position - 0x26A2
{
	return IS_BIT_SET(*uParam0, 1);
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x26AF
{
	unk_0x39DCBE5519BD783A(message);
	return unk_0x7EBCD400E7DE179C(0);
}

void func_67(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x26C2
{
	func_68(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_68(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x26E3
{
	int i;
...
int func_69(char* sParam0) // Position - 0x28B6
{
...
int func_70() // Position - 0x28DD
{
	...
	else
	{
		...
		num = SYSTEM::ROUND(unk_0x4C7724D572378B05(unk));
		num2 = unk_0x8D91ADE44AC79BC9(unk);
...
BOOL func_71(var uParam0) // Position - 0x2949
{
	int num;
	int num2;
...
BOOL func_76(int iParam0) // Position - 0x2AFE
{
	return Global_44181 == iParam0;
}

BOOL func_77() // Position - 0x2B0C
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_78(BOOL bParam0) // Position - 0x2B21
{
...
void func_79(var uParam0) // Position - 0x2D13
{
	func_80(uParam0, 0f);
	return;
}

void func_80(var uParam0, float fParam1) // Position - 0x2D22
{
	uParam0->f_1 = func_62(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
void func_81(var uParam0) // Position - 0x2D4D
{
	eCharacter character;
	var unk;
...
void func_82(int iParam0, int iParam1) // Position - 0x2DDA
{
	func_83(iParam0, iParam1);
	return;
}

void func_83(int iParam0, int iParam1) // Position - 0x2DEA
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_84(int iParam0, int iParam1) // Position - 0x2DFB
{
	return iParam0 && iParam1 != false;
}

void func_85() // Position - 0x2E0A
{
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x2E54
{
	eCharacter i;
	int num;
...
void func_87(var uParam0) // Position - 0x2E91
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_88(int iParam0) // Position - 0x2EA7
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_89(int iParam0, int iParam1) // Position - 0x2EC9
{
	BOOL flag;
...
int func_90(int iParam0) // Position - 0x2F13
{
	int num;
	int num2;
...
void func_91() // Position - 0x2F6A
{
	...
	if (unk_0x09112CCF7824FE38(&uLocal_97) != 0)
		unk_0xFD49725F3FE7EE13(&uLocal_97);
...
void func_92(int iParam0, int iParam1) // Position - 0x2FF6
{
	func_93(iParam0, iParam1);
	return;
}

void func_93(int iParam0, int iParam1) // Position - 0x3006
{
