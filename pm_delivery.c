...
void func_9() // Position - 0x973
{
	...
	if (func_22(&uLocal_37, uLocal_65, Global_25, true, veLocal_94, sLocal_102, "", sLocal_103, true, 0, true, INVALID))
	{
...
BOOL func_78(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41B1
{
	...
	if (func_86() || func_85(*Global_4718592.f_194133) || func_84())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112869.f_222[iParam0], false))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112869.f_222[iParam0], true, true);
		return Global_112869.f_222[iParam0];
	}
...
{
	return func_114(Global_112869.f_20, Global_112869.f_29);
}
...
int func_116(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x59D5
{
	var script;
	...
	func_117(veParam0, iParam2);
	return 1;
}

void func_117(Vehicle veParam0, int iParam1) // Position - 0x5A15
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_118(veParam0, &(Global_114162.f_32754.f_5510));
	return;
}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_141(veParam0, 0, false) || func_141(veParam0, 1, false) || func_141(veParam0, 2, false) || func_140(veParam0) != 145 || func_139(veParam0) || func_138(veParam0) || func_137(veParam0) || func_136(veParam0) || !func_124(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_138(veParam0);
		func_138(veParam0);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x6965
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x697B
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_131() // Position - 0x6991
{
	return false;
}

BOOL func_132() // Position - 0x699A
{
	return true;
}

BOOL func_133() // Position - 0x69A3
{
	return true;
}

BOOL func_134() // Position - 0x69AC
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x69C5
{
	int profileSetting;
...
BOOL func_136(Vehicle veParam0) // Position - 0x6A7D
{
	Hash entityModel;
...
BOOL func_137(Vehicle veParam0) // Position - 0x6AC4
{
	int i;
...
BOOL func_138(Vehicle veParam0) // Position - 0x6AFF
{
	int i;
...
BOOL func_139(Vehicle veParam0) // Position - 0x6B7B
{
	int i;
...
int func_140(Vehicle veParam0) // Position - 0x6C63
{
	int i;
...
BOOL func_141(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x6CC6
{
	int i;
	var garageName;
	int num;
...
BOOL func_142(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6D34
{
...
void func_143(int iParam0) // Position - 0x6E0C
{
