...
BOOL func_14(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1221
{
	...
	if (func_22() || func_21(*Global_4718592.f_194133) || func_20())
	{
						...
						if (func_130(true, false, true))
						{
							if (!func_129())
							{
								if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
									{
										while (!func_117(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_75, 1, 1056964608, false, true, false) || _CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
										{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x4214
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x4352
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x436E
{
	Hash statHash;
	int outValue;
...
Hash func_73(int iParam0) // Position - 0x438C
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_74(int iParam0) // Position - 0x43AE
{
	switch (iParam0)
	{
		case 38:
...
int func_75(int iParam0) // Position - 0x43CB
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_76(int iParam0) // Position - 0x44D0
{
	switch (iParam0)
	{
		case 18:
...
void func_77(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x455F
{
	Hash statName;
...
Hash func_78(int iParam0, int iParam1) // Position - 0x458D
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_79(iParam1));
}

int func_79(int iParam0) // Position - 0x45A2
{
	int num;
	int num2;
...
int func_80() // Position - 0x45D6
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x45E2
{
	if (iParam2 == -1)
		iParam2 = func_80();
...
void func_82(int iParam0) // Position - 0x4600
{
	func_101(93, iParam0);
	func_101(29, iParam0);
	func_101(30, iParam0);
...
BOOL func_83(int iParam0) // Position - 0x4620
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_84(int iParam0, int iParam1) // Position - 0x482B
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x485A
{
	if (iParam1 == -1)
		iParam1 = func_80();
...
int func_86(BOOL bParam0) // Position - 0x4876
{
	var outValue;
	int value;
	int outValue2;
...
int func_87(int iParam0, int iParam1) // Position - 0x492D
{
	if (iParam0 >= 78)
		return 0;
...
int func_88(int iParam0, int iParam1) // Position - 0x4948
{
...
BOOL func_89(var uParam0, int iParam1) // Position - 0x49E5
{
	int i;
	var unk;
...
int func_90(var uParam0, int iParam1) // Position - 0x4A96
{
	int i;
...
BOOL func_91(var uParam0, int iParam1) // Position - 0x4B11
{
	return uParam0->[iParam1] == 78;
}

void func_92(var uParam0) // Position - 0x4B22
{
	int i;
...
void func_93(var uParam0, int iParam1) // Position - 0x4B56
{
	uParam0->[iParam1] = 78;
	return;
}

void func_94(var uParam0, int iParam1) // Position - 0x4B66
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_95(var uParam0) // Position - 0x4B83
{
	return uParam0->f_80;
}

BOOL func_96(var uParam0, int iParam1) // Position - 0x4B8F
{
	return func_97(uParam0, iParam1) != -1;
}

int func_97(var uParam0, int iParam1) // Position - 0x4BA1
{
	int i;
...
BOOL func_98(var uParam0) // Position - 0x4BCE
{
	return uParam0->f_79 == 1;
}

BOOL func_99(int iParam0) // Position - 0x4BDC
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x4C2C
{
...
void func_101(int iParam0, int iParam1) // Position - 0x4C7D
{
	int outValue;
...
int func_103(eCharacter echParam0) // Position - 0x4D4F
{
	return Global_2201[echParam0 /*29*/].f_17;
}

BOOL func_104(float fParam0, float fParam1, float fParam2) // Position - 0x4D60
{
	float num;
	float num2;
...
BOOL func_106(int iParam0) // Position - 0x4E13
{
...
Vector3 func_108(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4E8F
{
	Vehicle playersLastVehicle;
...
Vector3 func_109(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4, var uParam5, var uParam6) // Position - 0x5490
{
	float num;
	float value;
	float num2;
...
void func_110(Ped pedParam0, var uParam1, var uParam2, char* sParam3, char* sParam4) // Position - 0x54DD
{
	int num;
	int num2;
	int num3;
...
float func_111(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x5695
{
	float num;
	float num2;
	float num3;
...
float func_112(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x56FA
{
	var entityCoords;
	var entityCoords2;
...
void func_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x5726
{
	BOOL flag;
	float dx;
...
BOOL func_114(Vehicle veParam0, float fParam1, float fParam2) // Position - 0x5827
{
	float entityHeading;
	float num;
	float num2;
...
BOOL func_117(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x58DF
{
...
void func_118(Vehicle veParam0) // Position - 0x5936
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_119(BOOL bParam0, BOOL bParam1) // Position - 0x5962
{
...
void func_120(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5AB3
{
	if (bParam0)
	{
...
BOOL func_121() // Position - 0x5C02
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_122(Player plParam0, int iParam1) // Position - 0x5C1C
{
	BOOL flag;
...
int func_123(int iParam0, BOOL bParam1) // Position - 0x5C75
{
	int num;
	int num2;
...
BOOL func_124(Player plParam0) // Position - 0x5CB6
{
	Player player;
...
BOOL func_125(Player plParam0) // Position - 0x5CD8
{
...
BOOL func_126() // Position - 0x5D17
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_127(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5D25
{
	int num;
...
void func_128(int iParam0) // Position - 0x5D58
{
	if (iParam0 == 1)
...
BOOL func_130(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D9C
{
	Vehicle vehiclePedIsIn;
...
BOOL func_131(int iParam0) // Position - 0x5E81
{
	return _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(func_132(iParam0));
}

char* func_132(int iParam0) // Position - 0x5E93
{
	char* str;
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x5ED5
{
	int outValue;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x5F2D
{
	func_135();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_135() // Position - 0x5F46
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_136(character) && !func_53(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_136(Global_114162.f_2367.f_539.f_4321))
...
BOOL func_136(eCharacter echParam0) // Position - 0x6043
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x604F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x608C
{
...
Hash func_139(eCharacter echParam0) // Position - 0x60B1
{
	return Global_2201[echParam0 /*29*/];
}

void func_140() // Position - 0x60C0
{
	if (!PED::IS_PED_INJURED(pedLocal_60))
	{
...
void func_145(Ped pedParam0, var uParam1) // Position - 0x63EB
{
	float angle;
...
void func_147(int iParam0) // Position - 0x653B
{
	switch (iParam0)
	{
		case 0:
...
void func_148(var uParam0) // Position - 0x6616
{
	*uParam0 = -99;
	return;
}

void func_149() // Position - 0x6624
{
	blLocal_65 = 0;
...
Blip func_150(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x664E
{
	iParam2 = iParam2;
	return func_151(pedParam0, bParam1, 145);
}

Blip func_151(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x6664
{
	Blip blip;
...
Blip func_152(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x66AE
{
	Blip blip;
...
var func_153(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6752
{
	if (bParam0)
		return uParam1;
...
void func_154(BOOL bParam0) // Position - 0x6769
{
...
void func_156(Blip blParam0, var uParam1) // Position - 0x68AD
{
	if (HUD::DOES_BLIP_EXIST(blParam0))
	{
...
BOOL func_157(int iParam0) // Position - 0x690B
{
	return IS_BIT_SET(Global_114158, iParam0);
}

void func_158() // Position - 0x691A
{
	if (!PED::IS_PED_INJURED(pedLocal_60))
...
Blip func_163(Pickup pkParam0) // Position - 0x6AEB
{
	return func_164(pkParam0);
}

Blip func_164(Pickup pkParam0) // Position - 0x6AF9
{
	Blip blip;
...
void func_170(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x6F5E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x6F75
{
	char* str;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x73FD
{
...
int func_181(BOOL bParam0) // Position - 0x7F04
{
	if (func_183())
	{
		Global_114152 = true;
		...
		if (func_182(Global_114151))
			func_147(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_182(Global_114151))
...
BOOL func_182(int iParam0) // Position - 0x7F57
{
	switch (iParam0)
	{
		case 29:
...
BOOL func_183() // Position - 0x7F86
{
	switch (func_184(&Global_33165, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_184(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x7FBC
{
	int i;
...
void func_185(var uParam0, int iParam1) // Position - 0x80F4
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x8143
{
	return func_187(iParam0, Global_44199);
}

BOOL func_187(int iParam0, int iParam1) // Position - 0x8154
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_188(int iParam0) // Position - 0x8335
{
	if (Global_44199 == 15)
		return false;
...
int func_191(float fParam0, BOOL bParam1) // Position - 0x846F
{
	var unk;
	int num;
	int num2;
...
void func_192(int iParam0, var uParam1) // Position - 0x8520
{
	switch (iParam0)
	{
		case 0:
...
int func_194(int iParam0) // Position - 0x9726
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_195(int iParam0) // Position - 0x9A6C
{
	var unk;
	var unk3;
...
struct<2> func_196(int iParam0) // Position - 0x9AA2
{
	var unk;
...
BOOL func_200() // Position - 0x9F82
{
	return Global_113880 > 0;
}

BOOL func_201() // Position - 0x9F90
{
	if (Global_98610 != -1)
		return true;
...
int func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xA010
{
...
void func_207() // Position - 0xA21C
{
	func_208();
	return;
}

int func_208() // Position - 0xA229
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xA274
{
...
int func_210() // Position - 0xA29C
{
	return 1;
}

void func_211(int iParam0) // Position - 0xA2A5
{
	Global_114148 = iParam0;
	return;
}

void func_212() // Position - 0xA2B3
{
	switch (iLocal_138)
	{
		case 0:
...
void func_219(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAD9C
{
	int outValue;
	Hash statHash;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xB338
{
...
BOOL func_225(var uParam0) // Position - 0xB3D3
{
	int i;
...
BOOL func_226(var uParam0) // Position - 0xB431
{
	return func_227(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

BOOL func_227(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xB448
{
...
int func_228(int iParam0) // Position - 0xB533
{
	int i;
...
void func_229(var uParam0, Hash hParam1) // Position - 0xB55C
{
	func_230(uParam0, 0, hParam1, "NULL", 0);
	return;
}

void func_230(var uParam0, int iParam1, Hash hParam2, char* sParam3, int iParam4) // Position - 0xB570
{
	int i;
...
void func_231(var uParam0, char* sParam1) // Position - 0xB651
{
	func_230(uParam0, 1, -1, sParam1, 0);
	return;
}

void func_232() // Position - 0xB664
{
	func_285();
...
void func_235(Blip blParam0, var uParam1) // Position - 0xBDDB
{
	int value;
	int num;
...
void func_236(var uParam0) // Position - 0xBE7A
{
	int i;
...
void func_237(int* piParam0) // Position - 0xBEFC
{
	func_238(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_238(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0xBF12
{
...
void func_239(int iParam0) // Position - 0xBFE3
{
	if (iParam0 == -1)
		iParam0 = func_204();
...
void func_241(int iParam0) // Position - 0xC057
{
	Global_114151 = iParam0;
	return;
}

BOOL func_242(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xC065
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (!func_277(Global_114162.f_24999.f_43[iParam3]))
			return false;
...
BOOL func_243(eCharacter echParam0) // Position - 0xC3FF
{
	int num;
...
BOOL func_244(int iParam0) // Position - 0xC420
{
	return func_245(iParam0, 1);
}

int func_245(int iParam0, int iParam1) // Position - 0xC42F
{
	var unk;
	var unk2;
	int num;
...
void func_246(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xC482
{
	func_247(func_258(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_247(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xC4A0
{
	int num;
	int num2;
	int num3;
	...
	while (num5 < 0)
	{
		...
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_248(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_248(float fParam0, float fParam1, float fParam2) // Position - 0xC6A1
{
	float num;
...
int func_249(int iParam0, int iParam1) // Position - 0xC6E3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_250(int iParam0) // Position - 0xC785
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_251(int iParam0) // Position - 0xC798
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_252(int iParam0) // Position - 0xC7AB
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_253(int iParam0) // Position - 0xC7BE
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_254(int iParam0) // Position - 0xC7D0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_255(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC7F2
{
	if (bParam0)
		return uParam1;
...
int func_256(int iParam0) // Position - 0xC809
{
	return iParam0 & 15;
}

BOOL func_257(int iParam0, int iParam1) // Position - 0xC816
{
	int num;
	int num2;
...
void func_259(var uParam0, int iParam1) // Position - 0xC968
{
	if (iParam1 <= 0)
		return;
...
void func_260(var uParam0, int iParam1) // Position - 0xC9EE
{
...
void func_261(var uParam0, int iParam1) // Position - 0xCA21
{
	int num;
	int num2;
...
void func_262(var uParam0, int iParam1) // Position - 0xCA72
{
...
void func_263(var uParam0, int iParam1) // Position - 0xCAAC
{
...
void func_264(var uParam0, int iParam1) // Position - 0xCAE7
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_265(int iParam0) // Position - 0xCB23
{
	int num;
	int num2;
	int num3;
...
BOOL func_266(int iParam0, int iParam1) // Position - 0xCBFF
{
...
BOOL func_267(int iParam0) // Position - 0xCC1F
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_275() || Global_113209 || Global_33108 || func_274() || func_55(8, -1) || func_273() || func_272() || func_271() || func_270() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_275() || Global_33108 || func_274() || func_55(8, -1) || func_271() || func_273() || func_272() || func_270() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_275() || Global_113209 || Global_33108 || func_274() || func_55(8, -1) || func_271() || func_273() || func_272() || func_270() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_275() || Global_113209 || Global_33108 || func_274() || func_55(8, -1) || func_273() || func_272() || func_270() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_275() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_55(8, -1) || func_270() || func_269() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_275() || Global_33108 || func_274() || func_55(8, -1) || func_272() || func_271() || func_270() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_275() || func_272() || Global_113209 || Global_33108 || func_274() || Global_45410 || func_55(8, -1) || func_271() || func_269() || func_270() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_275() || Global_113209 || Global_33108 || func_274() || func_55(8, -1) || func_271() || func_269() || func_273() || func_272() || func_270())
							return false;
						break;
				}
			}
...
BOOL func_268() // Position - 0xD33C
{
	return Global_101752.f_1;
}

BOOL func_269() // Position - 0xD34A
{
	if (Global_98610 != -1)
...
BOOL func_273() // Position - 0xD3C2
{
	return Global_101765.f_399 > 0;
}

BOOL func_274() // Position - 0xD3D3
{
	return Global_1575086;
}

BOOL func_275() // Position - 0xD3DF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_277(int iParam0) // Position - 0xD423
{
	return func_257(func_258(), iParam0);
}

BOOL func_278(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xD435
{
	BOOL num;
	eCharacter character;
...
int func_279(eCharacter echParam0) // Position - 0xD519
{
...
BOOL func_280(int iParam0) // Position - 0xD53D
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xD5D9
{
	int profileSetting;
...
BOOL func_283(int iParam0) // Position - 0xD691
{
...
BOOL func_284(int iParam0) // Position - 0xD6BC
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
void func_286(var uParam0, int iParam1) // Position - 0xD766
{
	if (iParam1 > 0)
...
void func_288(var uParam0, BOOL bParam1) // Position - 0xD923
{
	int i;
...
void func_289(var uParam0) // Position - 0xD966
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_290(var uParam0) // Position - 0xD97F
{
	int i;
...
void func_291(var uParam0) // Position - 0xD9B6
{
	func_292(*uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_292(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xD9CD
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_228(iParam0))
...
void func_293(int iParam0) // Position - 0xDA87
{
	var name;
	...
	if (func_203())
	{
		...
		func_297(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_296(Global_114151, true), 64);
	
		if (func_295(Global_114151) > 0)
		{
	...
	func_294(&Global_33165);
	Global_114152 = false;
	func_241(-1);
	return;
}

void func_294(var uParam0) // Position - 0xDB39
{
	if (*uParam0 == -1)
		return;
...
int func_295(int iParam0) // Position - 0xDB76
{
	int num;
...
char* func_296(int iParam0, BOOL bParam1) // Position - 0xDC27
{
	switch (iParam0)
	{
		case 0:
...
void func_297(int iParam0) // Position - 0xDE70
{
	Global_44750 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_298(int iParam0) // Position - 0xDE82
{
	func_299(iParam0, 0, func_304(iParam0));
	return;
}

void func_299(int iParam0, int iParam1, int iParam2) // Position - 0xDE97
{
	int unk;
	var unk2;
...
struct<16> func_300(var uParam0) // Position - 0xDEC6
{
	var unk;
	int num;
...
void func_301(int iParam0, var uParam1) // Position - 0xDF95
{
	Global_114162.f_24999.f_43[iParam0] = *uParam1;
	return;
}

void func_302(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xDFAD
{
	int num;
	int i;
	int num2;
...
void func_303(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE12F
{
...
int func_304(int iParam0) // Position - 0xE167
{
	int num;
...
void func_305(int iParam0, int iParam1) // Position - 0xE30A
{
	if (iParam0 == -1)
		iParam0 = func_204();
...
void func_306(int iParam0, var uParam1, var uParam2) // Position - 0xE40E
{
	BOOL flag;
...
void func_307() // Position - 0xE4F4
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114162.f_10198.f_3853))
		func_100(13, SYSTEM::FLOOR(Global_114162.f_10198.f_3853));
...
int func_308() // Position - 0xE9B2
{
	return Global_33105;
}

int func_309(int iParam0, int iParam1) // Position - 0xE9BD
{
	switch (iParam0)
	{
		case 0:
...
void func_310(int iParam0) // Position - 0xED31
{
	int offset;
	int i;
...
void func_311(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xED73
{
	func_312(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_312(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xED93
{
	int i;
...
BOOL func_314(int iParam0) // Position - 0xF07C
{
	int num;
	int i;
...
void func_315(int iParam0, int iParam1) // Position - 0xF0BC
{
