...
void main() // Position - 0x0
{
	...
	func_435(2);
	func_423(&(uLocal_180.f_1), func_434(Global_97692[8 /*19*/], Global_97692[9 /*19*/]));
	func_422(&uLocal_180, 4);
	func_421(4, 0, true);
	func_420(false);

	while (!func_419(3))
	{
		if (!Global_79810 && !func_418(14))
		{
			func_404(&uLocal_180, 10f, 18f);
			func_402(&uLocal_180);
			func_223();
			func_152();
		...
		if (func_419(34))
			if (!_IS_MISSION_REPEAT_ACTIVE(false))
				if (!IS_BIT_SET(Global_114135.f_1.f_120[4], 9))
					func_421(4, 9, true);
			else if (IS_BIT_SET(Global_114135.f_1.f_120[4], 9))
				func_421(4, 9, false);
		else if (IS_BIT_SET(Global_114135.f_1.f_120[4], 9))
			func_421(4, 9, false);
...
void func_3() // Position - 0x248
{
	...
	Global_97883.f_8 = Global_97883.f_8 + num;
	return;
}

void func_4(var uParam0) // Position - 0x28A
{
	if (IS_BIT_SET(Global_97671, *uParam0))
	{
		if (IS_BIT_SET(uParam0->f_449, 1))
		{
			...
			unk_0x8744D2E3FC95740E(&Global_97671, *uParam0);
		}
	}
...
void func_7(var uParam0, int iParam1, int iParam2) // Position - 0x390
{
	switch (iParam1)
	{
		...
		case 4:
			...
			Global_114135.f_1.f_6[*uParam0] = true;
...
void func_8(var uParam0) // Position - 0x4BD
{
	...
	unk = unk_0xF761D79754BC3043(2, 13, 1);
	unk2 = unk_0xF761D79754BC3043(2, 11, 1);
	unk3 = unk_0xE934399D6F2C3AC5(0, 32, 1);
	unk4 = unk_0xF761D79754BC3043(0, 1, 1);
	unk5 = unk_0xE934399D6F2C3AC5(2, 201, 1);
	unk6 = unk_0xE934399D6F2C3AC5(2, 202, 1);

	if (unk_0xAE231F549813BBDF(2))
	{
		unk = unk_0xF761D79754BC3043(2, 6, 1);
		unk2 = unk_0xF761D79754BC3043(2, 7, 1);
		unk3 = unk_0xF761D79754BC3043(0, 29, 1);
	}
...
void func_10(var uParam0) // Position - 0x99C
{
...
BOOL func_11(int iParam0, int iParam1) // Position - 0x9AA
{
	...
	flag = IS_BIT_SET(Global_114135.f_9089.f_99.f_219[iParam0], iParam1);
	return flag;
}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xA69
{
	unk_0x39DCBE5519BD783A(message);
	return unk_0x7EBCD400E7DE179C(0);
}

void func_14(var uParam0, int iParam1) // Position - 0xA7C
{
	int i;
	int j;

	if (Global_112772 && iParam1)
		if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(uParam0) && !unk_0xA5DAECD045AA8024())
			unk_0x428C32CC68809A35(0);

	for (i = 0; i < Global_114135.f_20414.f_145; i = i + 1)
	{
		if (unk_0x1B79E937E91F40C3(uParam0, &Global_114135.f_20414[i /*16*/]))
		{
			...
			func_16(Global_114135.f_20414.f_145 - 1);
			...
			switch (uParam0->f_464)
			{
				case 3:
					if (!Global_114135.f_1[*uParam0])
					{
						...
						Global_114135.f_1[*uParam0] = true;
					}
					else if (func_21() && !unk_0x4C705AAF75363287())
					{
						...
						{
							unk_0xAC98CA65AD9A3215("PB_H_CHOICE" /*Select an approach for this heist.*/);
				...
				case 2:
					if (!Global_114135.f_1.f_6[*uParam0])
					{
						...
						if (!IS_BIT_SET(uParam0->f_449, 10))
						{
							if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("PB_H_GUNM" /*Select a gunman to hire.*/) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("PB_H_HACK" /*Select a hacker to hire.*/) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("PB_H_DRIV" /*Select a driver to hire.*/))
							{
								...
								if (uParam0->f_417 < 5)
								{
									if (!IS_BIT_SET(uParam0->f_449, 11) && !IS_BIT_SET(uParam0->f_449, 10) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && uParam0->f_483 == 0)
									{
										switch (Global_97692[num /*19*/].f_1[uParam0->f_417])
										{
											case 1:
												unk_0xAC98CA65AD9A3215("PB_H_GUNM" /*Select a gunman to hire.*/);
												unk_0x5E01B6B1F460FE3F(0, 1, 0, -1);
												break;
										
											case 2:
												unk_0xAC98CA65AD9A3215("PB_H_HACK" /*Select a hacker to hire.*/);
												unk_0x5E01B6B1F460FE3F(0, 1, 0, -1);
												break;
										
											case 3:
												unk_0xAC98CA65AD9A3215("PB_H_DRIV" /*Select a driver to hire.*/);
												unk_0x5E01B6B1F460FE3F(0, 1, 0, -1);
												break;
										}
									}
...
{
	if (Global_114135.f_20414.f_145 > 0)
		return false;

	return true;
}

void func_22(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1156
{
	func_23(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_23(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1176
{
	int i;
...
void func_24(var uParam0, int iParam1, int iParam2) // Position - 0x1348
{
	...
	{
		if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_280[iParam1 /*2*/], ""))
		{
			func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_280[iParam1 /*2*/], iParam2);
			unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_1.f_303), iParam1);
		}
	}
...
Vector3 func_28(var uParam0, var uParam1) // Position - 0x1462
{
	...
	num7 = num5;
	num8 = unk_0x21CDF75488EFB98B(num7 / uParam0->f_1.f_8);
	num9 = uParam0->f_401.f_2 - uParam0->f_649.f_1.f_2;
	num10 = unk2.f_2 - uParam0->f_649.f_1.f_2;
	num11 = num10 - num9;
	num12 = unk_0x21CDF75488EFB98B(num11 / uParam0->f_1.f_8);
	num13 = (num8 * 3f) / 18f;
...
{
	return IS_BIT_SET(Global_114135.f_1.f_120[iParam0], iParam1);
}
...
void func_36(var uParam0, int iParam1, int iParam2) // Position - 0x1B91
{
	...
	func_24(uParam0, 2, 1);
	num = func_66(func_31(*uParam0));
	num2 = Global_97692[num /*19*/].f_1[iParam1];
...
void func_37(var uParam0, int iParam1) // Position - 0x1CC7
{
	...
	num = func_31(*uParam0);
	num2 = func_66(num);
	num3 = Global_97692[num2 /*19*/].f_1[iParam1];
	unk_0x88F483FBD433696A(uParam0->f_413, "CREATE_VIEW");
	unk_0x330108B080A2132F(iParam1);
	unk_0x330108B080A2132F(0);
	...
	if (Global_114135.f_1.f_12[num2 /*6*/][iParam1] != 0)
	{
		num5 = Global_114135.f_1.f_12[num2 /*6*/][iParam1];
...
BOOL func_38(var uParam0, int iParam1) // Position - 0x1E51
{
	...
	{
		if (Global_114135.f_1.f_12[num /*6*/][i] == iParam1)
			return true;
	}
...
{
	return IS_BIT_SET(Global_114135.f_1.f_118, iParam0);
}

BOOL func_40(int iParam0) // Position - 0x1EA9
{
	return IS_BIT_SET(Global_114135.f_1.f_116, iParam0);
}

int func_41(int iParam0) // Position - 0x1EBC
{
	return Global_97538[iParam0 /*5*/];
}

void func_42(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1ECC
{
...
var func_43(int iParam0) // Position - 0x2008
{
	return Global_97538[iParam0 /*5*/].f_1;
}
...
{
	return func_48(iParam1, Global_114135.f_1.f_73[iParam0 /*3*/].f_1, Global_114135.f_1.f_73[iParam0 /*3*/].f_2);
}
...
void func_63(var uParam0, int iParam1, int iParam2) // Position - 0x2493
{
	...
	if (!IS_BIT_SET(Global_97692[iParam1 /*19*/].f_18, iParam2))
	{
		if (!unk_0x1B79E937E91F40C3(&Global_97692[iParam1 /*19*/].f_7[iParam2 /*2*/], ""))
		{
			func_25(uParam0, uParam0->f_1.f_276, Global_97692[iParam1 /*19*/].f_7[iParam2 /*2*/], 1);
			unk_0x0B0C9A0F9AAEB7F0(&(Global_97692[iParam1 /*19*/].f_18), iParam2);
		
			for (i = 0; i < 10; i = i + 1)
			{
				if (unk_0x1B79E937E91F40C3(&Global_97692[iParam1 /*19*/].f_7[iParam2 /*2*/], &Global_97692[i /*19*/].f_7[iParam2 /*2*/]))
					unk_0x0B0C9A0F9AAEB7F0(&(Global_97692[i /*19*/].f_18), iParam2);
			}
		}
	}
...
int func_66(int iParam0) // Position - 0x25B3
{
	...
	return Global_114135.f_9089.f_99.f_205[iParam0];
}
...
void func_69(var uParam0) // Position - 0x2649
{
		...
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			if (!func_149(0))
			{
				if (func_140(8))
				{
					...
					{
						unk = { uParam0->f_401 - unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
						num = unk_0x97BC40FFA2FFCCD2(unk, unk.f_1);
						num2 = unk_0x1D5CD3EAAA7422B0(uParam0->f_404 - num);
						...
						else
						{
							...
							if (num3 - num < num2)
								num2 = unk_0x1D5CD3EAAA7422B0(num3 - num);
	...
	else
	{
		...
		if (!flag2 && uParam0->f_453 > 15 && unk_0x875A214D5EBCA509(2, iLocal_34) || unk_0x875A214D5EBCA509(2, 238) || IS_BIT_SET(uParam0->f_449, 8))
		{
...
void func_70(var uParam0, BOOL bParam1) // Position - 0x2862
{
	...
	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		...
		{
			unk = { uParam0->f_401 };
			unk = { unk + { 0f, 1f * SYSTEM::COS(180f - uParam0->f_404), 1f * SYSTEM::SIN(180f - uParam0->f_404) } };
	...
	num = unk_0x0E171121A3A25363(uParam0->f_401);

	if (num != 0)
		unk_0xBBB6D0F765409642(num);
...
void func_71(var uParam0, int iParam1, BOOL bParam2) // Position - 0x29E7
{
...
void func_80(var uParam0) // Position - 0x2C5D
{
	...
	unk = unk_0xF761D79754BC3043(0, 1, 1);

	if (!unk_0x1B79E937E91F40C3(unk, uParam0->f_466))
		func_8(uParam0);
	...
	flag = uParam0->f_454 > unk_0x1DD05E817C89C737();
	...
	if (!IS_BIT_SET(uParam0->f_449, 7))
	{
		...
		{
			unk2 = { uParam0->f_401 };
			unk2 = { unk2 + { 0.5f, 2.9f * SYSTEM::COS(180f - uParam0->f_404), 2.9f * SYSTEM::SIN(180f - uParam0->f_404) } };
			unk_0xB1EAADCB692D69CE(unk2, &(unk2.f_2), 0, 0);
			...
			unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), unk2, 1, 0, 0, 1);
			unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), uParam0->f_404);
...
void func_81(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x2E9A
{
	...
	{
		uParam0->f_14 = uParam0->f_14 + func_82((num6 - uParam0->f_14) * 0.05f * num5 * iParam7, -3f, 3f);
		uParam0->f_14.f_1 = uParam0->f_14.f_1 + func_82((num6.f_1 - uParam0->f_14.f_1) * 0.05f * num5 * iParam7, -3f, 3f);
		uParam0->f_14.f_2 = uParam0->f_14.f_2 + func_82((num6.f_2 - uParam0->f_14.f_2) * 0.05f * num5 * iParam7, -3f, 3f);
	}
...
void func_86(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3614
{
	...
	if (bParam2)
		unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_9089.f_99.f_219[iParam0], iParam1);
	else
		unk_0x8744D2E3FC95740E(&Global_114135.f_9089.f_99.f_219[iParam0], iParam1);
...
void func_88(var uParam0) // Position - 0x36DD
{
	...
	if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x9390801B06EE998F() && !unk_0xFD216000DC314A92())
	{
		if (uParam0->f_483 > 0)
		{
...
BOOL func_93(int iParam0) // Position - 0x3C41
{
	return func_94(iParam0, 20);
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x3C51
{
...
void func_101() // Position - 0x3E8B
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_102(character) && !func_418(14) || Global_113083)
			{
				if (Global_114135.f_2367.f_539.f_4321 != character && func_102(Global_114135.f_2367.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x3F94
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3FD1
{
...
int func_105(eCharacter echParam0) // Position - 0x3FF6
{
...
void func_109(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x40ED
{
...
void func_110(var uParam0) // Position - 0x4143
{
						...
						switch (uParam0->f_464)
						{
							...
							case 2:
								if (!func_11(4, *uParam0))
								{
									...
									if (uParam0->f_450 < Global_97692[num2 /*19*/])
									{
										unk_0x88F483FBD433696A(uParam0->f_413, "GET_CURRENT_SELECTION");
							...
							case 4:
								...
								for (i = 0; i < Global_97692[num2 /*19*/]; i = i + 1)
								{
									if (Global_114135.f_1.f_12[num2 /*6*/][i] == 0 || func_41(Global_114135.f_1.f_12[num2 /*6*/][i]) != Global_97692[num2 /*19*/].f_1[i])
									{
										flag = false;
										...
										for (j = 0; j < 14; j = j + 1)
										{
											if (!flag)
											{
												...
												if (num3 != 0)
												{
													if (Global_97538[num3 /*5*/] != Global_97692[num2 /*19*/].f_1[i])
														flag = false;
												
													if (!IS_BIT_SET(Global_114135.f_1.f_116, num3))
														flag = false;
												
													if (IS_BIT_SET(Global_114135.f_1.f_118, num3))
														flag = false;
										...
										Global_114135.f_1.f_12[num2 /*6*/][i] = num3;
									}
								}
						...
						switch (uParam0->f_464)
						{
							case 2:
								...
								if (uParam0->f_450 > 0)
								{
									...
									num4 = Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450];
									Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450] = 0;
									uParam0->f_465 = Global_97692[num2 /*19*/].f_1[uParam0->f_450];
									...
									if (*uParam0 != 2)
									{
										...
										for (k = 0; k < 2; k = k + 1)
										{
											if (uParam0->f_1.f_30[k] != 13)
												func_421(*uParam0, uParam0->f_1.f_30[k], false);
										}
							...
							case 4:
								if (*uParam0 != 1)
								{
									...
									uParam0->f_450 = uParam0->f_450 - 1;
									uParam0->f_417 = uParam0->f_450;
									num5 = Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450];
									Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450] = 0;
									uParam0->f_465 = Global_97692[num2 /*19*/].f_1[uParam0->f_450];
								...
								else
								{
									for (l = 0; l < 2; l = l + 1)
									{
										if (uParam0->f_1.f_30[l] != 13)
											func_421(*uParam0, uParam0->f_1.f_30[l], false);
									}
	...
	else if (uParam0->f_455 > 5)
	{
		...
		if (uParam0->f_450 >= Global_97692[num2 /*19*/] || *uParam0 == 1 && uParam0->f_450 > uParam0->f_415)
		{
			unk_0x88F483FBD433696A(uParam0->f_413, "FOCUS_VIEW");
			unk_0x330108B080A2132F(99);
			unk_0x330108B080A2132F(-1);
		...
		else
		{
			...
			{
				num6 = Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450];
				Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450] = 0;
				uParam0->f_465 = Global_97692[num2 /*19*/].f_1[uParam0->f_450];
	...
	if (uParam0->f_680 != 0)
	{
		...
		{
			num7 = unk_0x5DEF122A58D4F685(uParam0->f_680);
			num2 = func_30(*uParam0, num7);
			num = func_31(*uParam0);
			func_114(num, num2);
			...
			if (uParam0->f_1.f_30[num7] != 13)
				func_421(*uParam0, uParam0->f_1.f_30[num7], true);
		
			for (m = 0; m < uParam0->f_1.f_96; m = m + 1)
			{
				func_62(uParam0, m);
			
				if (m < Global_97692[num2 /*19*/])
				{
					unk_0x88F483FBD433696A(uParam0->f_413, "SHOW_VIEW");
					unk_0x330108B080A2132F(m);
					unk_0x557F1E2300EF1A3E(1);
					unk_0xE6B753D52F4CA222();
				}
				else
	...
	if (uParam0->f_681 != 0)
	{
		...
		{
			num8 = unk_0x5DEF122A58D4F685(uParam0->f_681);
			num = func_31(*uParam0);
			num2 = func_66(num);
			Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450] = uParam0->f_418[num8];
			num9 = Global_114135.f_1.f_12[num2 /*6*/][uParam0->f_450];
	...
	if (uParam0->f_682 != 0)
	{
		...
		{
			num10 = unk_0x5DEF122A58D4F685(uParam0->f_682);
		
			if (num10 != -1)
			{
				unk = uParam0->f_418[num10];
...
void func_111(var uParam0, int iParam1) // Position - 0x4EEB
{
	if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		if (uParam0->f_483 == 0)
		{
			...
			{
				case 10:
					if (IS_BIT_SET(Global_114135.f_1.f_119, 14))
					{
						if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_304[14 /*2*/], ""))
						{
							...
							unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 14);
				...
				case 13:
					if (IS_BIT_SET(Global_114135.f_1.f_119, 16))
					{
						if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_304[16 /*2*/], ""))
						{
							...
							unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 16);
							unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_449), 12);
							return;
						}
					}
				...
				case 12:
					if (IS_BIT_SET(Global_114135.f_1.f_119, 15))
					{
						if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_304[15 /*2*/], ""))
						{
							...
							unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 15);
							unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_449), 12);
							return;
						}
					}
				...
				case 11:
					if (IS_BIT_SET(Global_114135.f_1.f_119, 17))
					{
						if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_304[17 /*2*/], ""))
						{
							...
							unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 17);
							unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_449), 12);
							return;
						}
					}
...
void func_112(var uParam0, int iParam1) // Position - 0x50F7
{
	...
	{
		if (!IS_BIT_SET(Global_114135.f_1.f_119, iParam1))
		{
			if (!unk_0x1B79E937E91F40C3(&uParam0->f_1.f_304[iParam1 /*2*/], ""))
			{
				func_25(uParam0, uParam0->f_1.f_278, uParam0->f_1.f_304[iParam1 /*2*/], 1);
				unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_119), iParam1);
			}
		}
		else
		{
			switch (*uParam0)
			{
				case 2:
					...
					{
						case 1:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 0))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 10:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 1))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					}
					break;
				...
				case 3:
					...
					{
						case 12:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 3))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
							break;
					
						case 9:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 6))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
							break;
					
						case 1:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 0))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 7))
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
								else
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							else if (IS_BIT_SET(Global_114135.f_1.f_117, 7))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
							break;
					
						case 10:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 1))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 8))
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
								else
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							else if (IS_BIT_SET(Global_114135.f_1.f_117, 8))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
							break;
					
						case 6:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 4))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 7:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 2))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					
						case 8:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 5))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
							break;
					}
					break;
				...
				case 4:
					...
					{
						case 12:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 15))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 3))
						...
						case 4:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 17))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
							break;
					
						case 5:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 12))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
							break;
					
						case 1:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 10))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 0))
									if (IS_BIT_SET(Global_114135.f_1.f_117, 7))
						...
						case 10:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 11))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 1))
									if (IS_BIT_SET(Global_114135.f_1.f_117, 8))
										func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
									else
						...
						case 3:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 13))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
							break;
					
						case 6:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 19))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 4))
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
								else
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
						...
						case 8:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 16))
								if (IS_BIT_SET(Global_114135.f_1.f_117, 5))
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
								else
									func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
						...
						case 13:
							if (IS_BIT_SET(Global_114135.f_1.f_117, 20))
								func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
							break;
					}
					break;
		...
		unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_463), iParam1);
	}
...
void func_113(int iParam0) // Position - 0x5821
{
	...
	{
		case 0:
			num = Global_114135.f_9089.f_99.f_205[7];
		...
		case 1:
			num = Global_114135.f_9089.f_99.f_205[8];
		...
		case 3:
			num = Global_114135.f_9089.f_99.f_205[10];
		...
		case 4:
			num = Global_114135.f_9089.f_99.f_205[11];
...
void func_115(int iParam0, int iParam1) // Position - 0x5961
{
...
void func_116(int iParam0) // Position - 0x59A6
{
	...
	switch (iParam0)
	{
		case 0:
			...
			for (i = 0; i < Global_97692[num /*19*/]; i = i + 1)
			{
				switch (Global_114135.f_1.f_12[num /*6*/][i])
				{
					case 1:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 0);
						break;
				
					case 10:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 1);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 14);
						break;
				
					case 7:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 2);
						break;
				
					case 12:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 3);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 15);
						break;
				
					case 6:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 4);
						break;
				
					case 8:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 5);
						break;
				
					case 9:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 6);
						break;
				}
			
				unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_119), Global_114135.f_1.f_12[num /*6*/][i]);
			}
			break;
	
		case 2:
			num = Global_114135.f_9089.f_99.f_205[9];
			...
			for (i = 0; i < Global_97692[num /*19*/]; i = i + 1)
			{
				...
				{
					case 1:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 7);
						break;
				
					case 10:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 8);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 14);
						break;
				
					case 11:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 9);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 17);
						break;
				}
		...
		case 3:
			...
			for (i = 0; i < Global_97692[num /*19*/]; i = i + 1)
			{
				...
				{
					case 1:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 10);
						break;
				
					case 10:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 11);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 14);
						break;
				
					case 5:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 12);
						break;
				
					case 3:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 13);
						break;
				
					case 4:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 17);
						break;
				
					case 7:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 14);
						break;
				
					case 12:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 15);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 15);
						break;
				
					case 6:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 19);
						break;
				
					case 8:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 16);
						break;
				
					case 9:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 18);
						break;
				
					case 13:
						unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_1.f_117), 20);
						unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_119), 16);
						break;
				}
...
void func_117(int iParam0) // Position - 0x5D23
{
	...
	{
		case 0:
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 0);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 1);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 2);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 3);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 4);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 5);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 6);
			break;
	
		case 2:
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 7);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 8);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 9);
			break;
	
		case 3:
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 10);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 11);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 12);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 13);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 14);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 15);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 16);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 17);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 18);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 19);
			unk_0x8744D2E3FC95740E(&(Global_114135.f_1.f_117), 20);
			break;
	}
...
void func_122(var uParam0) // Position - 0x5EBA
{
	...
	if (!unk_0xFD216000DC314A92())
	{
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			...
			unk = { uParam0->f_401 };
			unk = { unk + { 0.5f, 2.9f * SYSTEM::COS(180f - uParam0->f_404), 2.9f * SYSTEM::SIN(180f - uParam0->f_404) } };
			unk_0xB1EAADCB692D69CE(unk, &(unk.f_2), 0, 0);
			unk_0x4686BC3BFDBB5348(unk_0x259BE71D8A81D4FA(), 0, 134);
			unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), unk, 1, 0, 0, 1);
			unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), uParam0->f_404);
	...
	if (num != 0)
		unk_0x74C1590CC91B3930(num);

	unk_0xDC750660004ECB83(&(Global_97609[uParam0->f_1.f_1 /*15*/].f_7));
...
{
	if (!bParam0)
		Global_112774 = unk_0x1DD05E817C89C737() + 250;
...
void func_125(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, var uParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x6128
{
	...
	*uParam0 = unk_0x69D23632E4288DBD("DEFAULT_SCRIPTED_CAMERA", 0);
	...
	if (iParam14 > 0f)
		unk_0x3AAB5D3F3D4028CC(*uParam0, iParam14);
...
void func_127(int iParam0) // Position - 0x622E
{
	int num;
	int num2;
	int num3;
...
int func_129(int iParam0) // Position - 0x630A
{
	int i;
...
int func_135(int iParam0) // Position - 0x646A
{
	int i;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x65FD
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_148() || Global_113182 || Global_33090 || func_147() || func_107(8, -1) || func_146() || func_145() || func_144() || func_143() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_148() || Global_33090 || func_147() || func_107(8, -1) || func_144() || func_146() || func_145() || func_143() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_148() || Global_113182 || Global_33090 || func_147() || func_107(8, -1) || func_144() || func_146() || func_145() || func_143() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_148() || Global_113182 || Global_33090 || func_147() || func_107(8, -1) || func_146() || func_145() || func_143() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_148() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_107(8, -1) || func_143() || func_142() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
{
	return func_151(iParam0, Global_44181);
}
	...
	if (func_419(26))
	{
		if (func_419(25))
		{
			if (unk_0xC4ADACBD3FE3F266(sLocal_40))
			{
				...
				func_73(true);
				func_124(true);
				func_213(true, true, true, 0, false, false, false);
		...
		else if (unk_0x1DD05E817C89C737() > iLocal_43 || _IS_MISSION_REPEAT_ACTIVE(false))
		{
			if (_IS_MISSION_REPEAT_ACTIVE(false))
			{
			...
			func_73(false);
			func_213(false, true, true, 0, false, false, false);
			func_193();
			func_191(&(Global_114135.f_2367.f_539), 77);
			func_161(&(Global_114135.f_2367.f_539), 77);
			func_160(&iLocal_44);
			unk_0x8744D2E3FC95740E(&iLocal_41, 3);
			func_115(26, 0);
			unk_0xD7B6A43ACC36D868(uLocal_177, 0);
		
			if (iLocal_178 != -1)
				if (unk_0xF935563454D3B338(iLocal_178))
					unk_0x8E99C7AF6C6639AB(iLocal_178);
		
			unk_0x93586F94C370857F();
			unk_0x79CA429D8B4B057A(uLocal_180.f_1.f_394 - uLocal_180.f_1.f_397, uLocal_180.f_1.f_394 + uLocal_180.f_1.f_397, 1, 0);
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x74B3
{
	...
	if (!func_40(10) && IS_BIT_SET(Global_114135.f_24999.f_8[4], 0))
		func_157(9, true);

	if (!func_40(13) && IS_BIT_SET(Global_114135.f_24999.f_8[16], 0))
		func_157(12, true);
...
void func_157(int iParam0, BOOL bParam1) // Position - 0x7708
{
	...
	if (num >= 0 && num <= 31)
	{
		if (!func_159(iParam0))
		{
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_26438.f_1), num);
...
BOOL func_159(int iParam0) // Position - 0x7834
{
	if (iParam0 != -1 && iParam0 != 13)
		return IS_BIT_SET(Global_114135.f_26438.f_1, iParam0);
...
void func_161(var uParam0, int iParam1) // Position - 0x789D
{
	switch (iParam1)
	{
		...
		case 19:
			func_162(uParam0, CHAR_FRANKLIN, 13);
			break;
	
		case 29:
			func_162(uParam0, CHAR_FRANKLIN, 14);
			break;
	
		case 30:
			func_162(uParam0, CHAR_TREVOR, 15);
			func_162(uParam0, CHAR_FRANKLIN, 29);
			break;
	
		case 32:
			func_162(uParam0, CHAR_FRANKLIN, 16);
			func_162(uParam0, CHAR_MICHAEL, 17);
			break;
	
		case 39:
			func_162(uParam0, CHAR_MICHAEL, 21);
			func_162(uParam0, CHAR_FRANKLIN, 20);
			break;
	
		case 31:
			func_162(uParam0, CHAR_MICHAEL, 18);
			break;
	
		case 20:
			func_162(uParam0, CHAR_TREVOR, 22);
			break;
	
		case 66:
			func_162(uParam0, CHAR_FRANKLIN, 23);
			break;
	
		case 68:
			func_162(uParam0, CHAR_FRANKLIN, 24);
			break;
	
		case 70:
			func_162(uParam0, CHAR_FRANKLIN, 67);
			break;
	
		case 8:
			func_162(uParam0, CHAR_FRANKLIN, 25);
			func_162(uParam0, CHAR_TREVOR, 26);
			break;
	
		case 67:
			func_162(uParam0, CHAR_FRANKLIN, 27);
			break;
	
		case 9:
			func_162(uParam0, CHAR_TREVOR, 28);
			break;
	
		case 38:
			func_162(uParam0, CHAR_TREVOR, 30);
			func_162(uParam0, CHAR_FRANKLIN, 19);
			break;
	
		case 83:
			func_162(uParam0, CHAR_TREVOR, 33);
			break;
	
		case 45:
			func_162(uParam0, CHAR_FRANKLIN, 35);
			break;
	
		case 64:
			func_162(uParam0, CHAR_MICHAEL, 36);
			func_162(uParam0, CHAR_FRANKLIN, 37);
			break;
	
		case 91:
			func_162(uParam0, CHAR_MICHAEL, 41);
			break;
	
		case 42:
			func_162(uParam0, CHAR_MICHAEL, 58);
			Global_101092[0 /*98*/] = 0;
			func_162(uParam0, CHAR_TREVOR, 59);
			Global_101092[2 /*98*/] = 0;
			break;
	
		case 41:
			func_162(uParam0, CHAR_FRANKLIN, 42);
			func_162(uParam0, CHAR_TREVOR, 42);
			break;
	
		case 15:
			func_162(uParam0, CHAR_MICHAEL, 46);
			func_162(uParam0, CHAR_FRANKLIN, 47);
			break;
	
		case 16:
			func_162(uParam0, CHAR_MICHAEL, 48);
			break;
	
		case 48:
			func_162(uParam0, CHAR_FRANKLIN, 50);
			func_162(uParam0, CHAR_TREVOR, 51);
			break;
	
		case 74:
			func_162(uParam0, CHAR_MICHAEL, 52);
			func_162(uParam0, CHAR_FRANKLIN, 66);
			break;
	
		case 76:
			func_162(uParam0, CHAR_FRANKLIN, 53);
			func_162(uParam0, CHAR_TREVOR, 54);
			func_162(uParam0, CHAR_MICHAEL, 62);
			break;
	
		case 75:
			func_162(uParam0, CHAR_MICHAEL, 61);
			func_162(uParam0, CHAR_FRANKLIN, 31);
			break;
	
		case 69:
			func_162(uParam0, CHAR_FRANKLIN, 63);
			break;
	
		case 84:
			func_162(uParam0, CHAR_MICHAEL, 68);
			func_162(uParam0, CHAR_TREVOR, 69);
			break;
	
		case 85:
			func_162(uParam0, CHAR_MICHAEL, 64);
			func_162(uParam0, CHAR_TREVOR, 65);
			break;
	
		case 93:
			func_162(uParam0, CHAR_FRANKLIN, 38);
			func_162(uParam0, CHAR_TREVOR, 39);
			break;
	
		case 11:
			func_162(uParam0, CHAR_TREVOR, 55);
			break;
	
		case 77:
			func_162(uParam0, CHAR_FRANKLIN, 56);
			func_162(uParam0, CHAR_TREVOR, 57);
			break;
...
int func_162(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x7BE6
{
	int num;
	var unk;
	var unk99;
	...
	if (!IS_BIT_SET(Global_114135.f_9089.f_99.f_219[0], 9))
	{
		num = Global_114135.f_18537[echParam1];
	...
	Global_114135.f_18537[echParam1] = iParam2;
	uParam0->f_2296[echParam1] = func_180();

	if (!func_179(iParam2, &uParam0->f_2300[echParam1 /*3*/], &uParam0->f_2310[echParam1]))
		return 0;

	if (!func_178(uParam0->f_2300[echParam1 /*3*/], 0f, 0f, 0f, false))
	{
		if (!func_178(Global_100127[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
		
			if (func_163(echParam1, iParam2, &unk, &unk99, &unk102, &unk103, &unk106))
				Global_101092[echParam1 /*98*/] = { unk };
		}
	}
...
BOOL func_163(eCharacter echParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7D03
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
	...
	{
		case 5:
			*uParam2 = { Global_101092[echParam0 /*98*/] };
		
			if (Global_101387[echParam0] != 2)
			{
				if (unk_0x26715B0ED6702C87(Global_101395[echParam0 /*3*/], -829.7478f, 192.11703f, 76.73248f, -827.13837f, 153.85951f, 59.961723f, 33.25f, 0, 1))
				{
					if (Global_101387[echParam0] == 1)
					{
						*uParam3 = { Global_101395[echParam0 /*3*/] - Global_114135.f_2367.f_539.f_2300[echParam0 /*3*/] };
						*uParam4 = Global_101405[echParam0] - Global_114135.f_2367.f_539.f_2310[echParam0];
		...
		case 9:
			return func_163(echParam0, 8, uParam2, uParam3, uParam4, uParam5, uParam6);
		...
		case 113:
			if (func_163(echParam0, 112, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { unk_0xD2AA6F822D3A55D2(-5f, 5f), unk_0xD2AA6F822D3A55D2(-5f, 5f), 0f };
				*uParam4 = unk_0xD2AA6F822D3A55D2(-180f, 180f);
				return true;
		...
		case 119:
			if (func_163(echParam0, 118, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 5f, 20f, 0f };
				*uParam6 = 5f;
				return true;
		...
		case 106:
			return func_163(echParam0, 105, uParam2, uParam3, uParam4, uParam5, uParam6);
		...
		case 100:
			return func_163(echParam0, 99, uParam2, uParam3, uParam4, uParam5, uParam6);
		...
		case 93:
			if (func_163(echParam0, 91, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 136:
			if (func_163(echParam0, 135, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { unk_0xD2AA6F822D3A55D2(-5f, 5f), unk_0xD2AA6F822D3A55D2(-5f, 5f), 0f };
				*uParam4 = unk_0xD2AA6F822D3A55D2(-180f, 180f);
				return true;
		...
		case 140:
			if (func_163(echParam0, 142, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 0f, 15f, 0f };
				*uParam6 = 10f;
				return true;
		...
		case 151:
			if (func_163(echParam0, 94, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 162:
			if (func_163(echParam0, 115, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 166:
			return func_163(echParam0, 98, uParam2, uParam3, uParam4, uParam5, uParam6);
	...
	switch (iParam1)
	{
		case 110:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 32.5629f, -387.5143f, -147.166f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 341.4322f - 133f;
			return true;
	
		case 111:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 24.4283f, -689.1462f, -1306.7816f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 214.6826f - 33f;
			return true;
	
		case 153:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 79.3324f, 254.0631f, -708.9244f } - Global_100127[iParam1 /*3*/] };
		...
		case 165:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 35.0054f, -441.1681f, -1100.8779f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 297.5568f - -144.622f;
			return true;
	
		case 159:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 36.3852f, -199.5354f, -825.3141f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 29.4869f - -62.5f;
			return true;
	
		case 160:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 36.2086f, -144.1027f, -730.8218f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 28.532f - 119f;
			return true;
	
		case 167:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 31.7307f, -523.2257f, -1144.1743f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 299.2956f - -22.32f;
			return true;
	
		case 152:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 60.9436f, 314.6989f, -1421.7998f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 335.4134f - 72f;
			return true;
	
		case 157:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 79.469f, 255.3143f, -706.187f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 117.3069f - 37.27f;
			return true;
	
		case 225:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 28.7165f, -1677.7335f, 185.4888f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 54.2538f - -83.8f;
			return true;
	
		case 218:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 28.3218f, -1405.1594f, -17.556f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 91.3098f - -70.4124f;
			return true;
	
		case 219:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 30.2611f, -1492.1511f, -219.3172f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 139.2572f - -12f;
			return true;
	
		case 220:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 25.3018f, -1811.6935f, -22.6138f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 141.0423f - -117.356f;
			return true;
	
		case 206:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 208.5337f, 773.6719f, 164.1308f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 136.3104f - -36f;
			return true;
	
		case 207:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 108.9995f, 396.924f, -263.3745f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 284.4611f - -95.588f;
			return true;
	
		case 274:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 139.5782f, 2030.4458f, -1883.836f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 340.5746f - 9f;
			return true;
	
		case 312:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 10.0296f, 6560.5566f, -200.684f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 134.5505f - 110.5931f;
			return true;
	
		case 271:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 6.4647f, -1083.7513f, -1278.0234f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 115.8919f - 26.3597f;
			return true;
	
		case 248:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 102.4417f, 164.5124f, 325.8113f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 68.4108f - 10.77f;
			return true;
	
		case 242:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 56.616f, -122.9896f, -1622.2205f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 210.8653f - 13.7207f;
			return true;
	
		case 254:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 53.0019f, -213.7796f, 172.442f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 250.3032f - -40f;
			return true;
	
		case 287:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 17.3426f, -836.0328f, -887.9977f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 270.8607f - -81f;
			return true;
	
		case 286:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 4.8359f, -1182.7039f, -1264.2178f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 298.4328f - -150f;
			return true;
	
		case 239:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 104.8218f, 289.0073f, -80.4564f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 247.6446f - -122f;
			return true;
	
		case 243:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 28.2762f, -1477.2819f, 434.9171f } - Global_100127[iParam1 /*3*/] };
		...
		case 249:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 103.1881f, 177.7729f, 288.977f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 68.9831f - 138f - 180f;
			return true;
	
		case 273:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 32.7794f, -432.4635f, -161.4589f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 340.0368f - -153f;
			return true;
	
		case 92:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 202.1143f, 828.3607f, -806.8813f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 101.1612f - -54.347f;
			return true;
	
		case 103:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 12.0174f, -1108.081f, -1724.72f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 319.8931f - 143.4931f;
			return true;
	
		case 109:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 10.2248f, -628.4899f, -1859.5045f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 229.0784f - 99f;
			return true;
	
		case 81:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 53.1469f, 90.4242f, -1393.4424f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 123.1782f - -45f;
			return true;
	
		case 95:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 101.921f, 186.1865f, 370.5876f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 159.7861f - 70f;
			return true;
	
		case 97:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 45.9871f, -188.5636f, -1391.1559f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 36.5172f - -45f;
			return true;
	
		case 134:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 46.0567f, 3076.742f, 2001.9182f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 328.101f - -33.128f;
			return true;
	
		case 88:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 60.9442f, 314.7191f, -1421.8212f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 336.5938f - -132f;
			return true;
	
		case 306:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 37.4888f, 5643.7256f, -569.3535f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 296.1685f - unk_0x97BC40FFA2FFCCD2(7.4998f, -7.4995f);
			return true;
	
		case 307:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 47.4526f, 4717.728f, -1555.5929f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 236.223f - unk_0x97BC40FFA2FFCCD2(-10.6345f, -0.7246f);
			return true;
	
		case 308:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 22.7549f, 4629.148f, -1553.861f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 332.7842f - unk_0x97BC40FFA2FFCCD2(3.4271f, 13.6787f);
			return true;
	
		case 278:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 35.9161f, -1009.7451f, 631.8275f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 98.8128f - -33.77f;
			return true;
	
		case 279:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 234.6825f, 900.8749f, -111.9033f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 6.1087f - 155.68f;
			return true;
	
		case 240:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 33.5351f, 3636.151f, 1546.3232f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 298.4009f - -4.124f;
			return true;
	
		case 241:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 30.512f, 6439.6665f, -179.4242f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 225.5593f - 108f;
			return true;
	
		case 264:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 28.2977f, -1390.5446f, 486.7419f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 178.298f - -90f;
			return true;
	
		case 266:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 10.5662f, 143.2342f, -3052.8945f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 85.3429f - 68.8227f;
			return true;
	
		case 267:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 39.9155f, 4934.08f, 2202.3752f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 314.2654f - 56.2037f;
			return true;
	
		case 269:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 28.149f, -782.0952f, 401.2502f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 179.9905f - -106.6605f;
			return true;
	
		case 246:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 3.3919f, -1534.5072f, -1195.2559f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 305.8221f - -165f;
			return true;
	
		case 263:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 12.8792f, -1241.2125f, -573.3765f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 316.9941f - -171f;
			return true;
	
		case 259:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 4.0002f, -1298.5391f, -724.429f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 230.5715f - -32.488f;
			return true;
	
		case 260:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 61.203f, 250.8387f, -1309.1135f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 10.7756f - -29.093f;
			return true;
	
		case 261:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 79.764f, 60.3233f, 917.6678f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = 148.021f - 229.6085f;
			return true;
	
		case 270:
			func_165(echParam0, uParam2, 0);
			*uParam3 = { { 350f, 8588f, 2919f } - Global_100127[iParam1 /*3*/] };
			*uParam4 = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			return true;
...
{
	if (Global_101092[echParam0 /*98*/] == 0)
	{
	...
	if (Global_101092[echParam0 /*98*/] == joaat("blimp"))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (unk_0xEA4F815FDC353FEF(Global_101092[echParam0 /*98*/]))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (unk_0x00C6FDED3EB75117(Global_101092[echParam0 /*98*/]))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (unk_0xBA16CD57E37AC32A(Global_101092[echParam0 /*98*/]))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (unk_0xAE447CBB33B40CA3(Global_101092[echParam0 /*98*/]))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (iParam2 == 1)
	{
		if (!unk_0xD3CE8D1E6564B011(Global_101092[echParam0 /*98*/]))
		{
			func_164(echParam0, uParam1, iParam2);
			uParam1->f_91 = iParam2;
			return 1;
	...
	{
		if (!unk_0x78B050AFBA6D1517(Global_101092[echParam0 /*98*/]))
		{
			func_164(echParam0, uParam1, iParam2);
			uParam1->f_91 = iParam2;
			return 1;
	...
	if (!func_166(Global_101092[echParam0 /*98*/], false, -1))
	{
		func_164(echParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	if (iParam2 != 0)
	{
		...
		if (Global_101092[echParam0 /*98*/] != *uParam1)
		{
			*uParam1 = { Global_101092[echParam0 /*98*/] };
			uParam1->f_91 = 0;
			return 0;
		}
	}
...
BOOL func_166(int iParam0, BOOL bParam1, int iParam2) // Position - 0xB8E1
{
	int i;
	var unk;
...
BOOL func_167(int iParam0) // Position - 0xBA66
{
	int num;
	var unk;
	var unk2;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0xBB49
{
	int num;
	int num2;
...
BOOL func_170() // Position - 0xBD52
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_171() // Position - 0xBD68
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

BOOL func_172() // Position - 0xBD7E
{
	return false;
}

BOOL func_173() // Position - 0xBD87
{
	return true;
}

BOOL func_174() // Position - 0xBD90
{
	return true;
}

BOOL func_175() // Position - 0xBD99
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xBDB2
{
	var unk;
...
BOOL func_177(eCharacter echParam0) // Position - 0xBE6A
{
	if (Global_101092[echParam0 /*98*/] == joaat("blimp") || Global_101092[echParam0 /*98*/] == joaat("blimp2"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("submersible") || Global_101092[echParam0 /*98*/] == joaat("submersible2"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("freight"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("packer"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("asea2"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("burrito2") || Global_101092[echParam0 /*98*/] == joaat("fbi2"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("entityxf") && !Global_114135.f_9089.f_330[8 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("cheetah") && !Global_114135.f_9089.f_330[8 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("policeb") && !Global_114135.f_9089.f_330[8 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("ztype") && !Global_114135.f_9089.f_330[9 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("polmav") && !Global_114135.f_9089.f_330[9 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("jb700") && !Global_114135.f_9089.f_330[10 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("monroe") && !Global_114135.f_9089.f_330[11 /*6*/])
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("firetruk"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("handler"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("monroe"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("phantom"))
		return true;

	if (Global_101092[echParam0 /*98*/] == joaat("gauntlet") && !Global_114135.f_9089.f_330[80 /*6*/] && !Global_114135.f_9089.f_330[81 /*6*/] && !Global_114135.f_9089.f_330[82 /*6*/])
		return true;

	return false;
}

BOOL func_178(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC0EF
{
	if (bParam6)
...
BOOL func_179(int iParam0, var uParam1, var uParam2) // Position - 0xC136
{
	switch (iParam0)
	{
		case 11:
...
int func_180() // Position - 0xCAA5
{
	var unk;

	func_190(&unk, unk_0x4BA5A16068183C5E());
	func_189(&unk, unk_0x18E502A71E28968C());
	func_188(&unk, unk_0x5295501D0862870D());
	func_183(&unk, unk_0xB12880C92EA6EE15());
	func_182(&unk, unk_0x8825A6E0A30BDCB8());
	func_181(&unk, unk_0x7598FE4545010A75());
	return unk;
}

void func_181(var uParam0, int iParam1) // Position - 0xCAEB
{
	if (iParam1 <= 0)
		return;
...
void func_182(var uParam0, int iParam1) // Position - 0xCB71
{
...
void func_183(var uParam0, int iParam1) // Position - 0xCBA4
{
	int num;
	int num2;
...
int func_184(int iParam0, int iParam1) // Position - 0xCBF5
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_185(int iParam0) // Position - 0xCC97
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_186(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCCB9
{
	if (bParam0)
		return uParam1;
...
int func_187(int iParam0) // Position - 0xCCD0
{
	return iParam0 & 15;
}

void func_188(var uParam0, int iParam1) // Position - 0xCCDD
{
...
void func_189(var uParam0, int iParam1) // Position - 0xCD17
{
...
void func_190(var uParam0, int iParam1) // Position - 0xCD52
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_191(var uParam0, int iParam1) // Position - 0xCD8E
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_179(Global_114135.f_18537[i], &unk, &num2))
			{
...
void func_192(var uParam0) // Position - 0xCF54
{
	*uParam0 = -15;
	return;
}

void func_193() // Position - 0xCF62
{
	Global_113158 = 0;
	return;
}

int func_194() // Position - 0xCF6F
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		return 0;
...
void func_195(int iParam0) // Position - 0xCFBA
{
	Global_78329.f_138 = iParam0;
	return;
}

int func_196(int iParam0) // Position - 0xCFCA
{
	int i;
	int num;
...
void func_197(int iParam0) // Position - 0xD0F1
{
	int i;
	var unk;
...
void func_198(int iParam0) // Position - 0xD1AA
{
	int i;
	var unk;
...
void func_199(eCharacter echParam0) // Position - 0xD272
{
	int i;
	int num;
	int j;
...
void func_200(int iParam0) // Position - 0xD330
{
	var unk;
	int i;
	int j;
...
void func_201(int iParam0) // Position - 0xD3DD
{
	var unk;
	int i;
	int j;
	...
	for (i = 0; i < Global_114135.f_7692.f_198; i = i + 1)
	{
		if (Global_114135.f_7692.f_137[i /*15*/] == iParam0)
		{
			func_202(Global_114135.f_7692.f_137[i /*15*/].f_6);
...
int func_202(int iParam0) // Position - 0xD499
{
	eCharacter character;

	if (Global_120[iParam0 /*10*/].f_8 != 184)
	{
		if (func_208(iParam0, Global_21066) == 1)
		{
			func_207(iParam0, Global_21066, 0);
		
			if (func_206(iParam0, Global_21066) == 0)
			{
				character = Global_21066;
				func_203(iParam0, character);
			}
...
void func_203(int iParam0, eCharacter echParam1) // Position - 0xD4EF
{
	eCharacter character;
	...
	if (Global_120[iParam0 /*10*/].f_8 != 184)
	{
		...
		{
			character = echParam1;
			func_205(iParam0, character, 0);
			func_204(iParam0, character, 0);
		}
	}
...
void func_204(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xD524
{
	...
	if (iParam0 < 162)
		Global_114135.f_28055[iParam0 /*29*/].f_24[echParam1] = iParam2;

	return;
}

void func_205(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xD569
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;

	Global_2201[iParam0 /*29*/].f_12[echParam1] = iParam2;

	if (iParam0 < 162)
		Global_114135.f_28055[iParam0 /*29*/].f_12[echParam1] = iParam2;

	return;
}

int func_206(int iParam0, eCharacter echParam1) // Position - 0xD5AE
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_207(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xD5D8
{
	Global_2201[iParam0 /*29*/].f_19[echParam1] = iParam2;

	if (iParam0 < 162)
		Global_114135.f_28055[iParam0 /*29*/].f_19[echParam1] = iParam2;

	return;
}

int func_208(int iParam0, eCharacter echParam1) // Position - 0xD609
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_209(eCharacter echParam0) // Position - 0xD633
{
	eCharacter i;
	int num;
	var unk;
...
int func_210(int iParam0, int iParam1) // Position - 0xD70B
{
	int num;
	...
	return Global_114135.f_1.f_12[num /*6*/][iParam1];
}

int func_211(int iParam0) // Position - 0xD74C
{
	switch (iParam0)
	{
		case 0:
...
int func_212(int iParam0) // Position - 0xD7A1
{
	int num;

	num = func_66(func_211(iParam0));
	return Global_97692[num /*19*/];
}

void func_213(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD7BD
{
	if (bParam0)
	{
...
BOOL func_214() // Position - 0xD90C
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_215(int iParam0, int iParam1) // Position - 0xD926
{
	BOOL flag;
...
int func_216(int iParam0, BOOL bParam1) // Position - 0xD97F
{
	int num;
	int num2;
...
int func_217() // Position - 0xD9C0
{
	return Global_1574926;
}

BOOL func_218(int iParam0) // Position - 0xD9CC
{
	int num;
...
BOOL func_219(int iParam0) // Position - 0xD9EE
{
...
BOOL func_220() // Position - 0xDA2D
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_221(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xDA3B
{
	int num;
...
void func_222(int iParam0) // Position - 0xDA6E
{
	if (iParam0 == 1)
		...
		if (!_IS_MISSION_REPEAT_ACTIVE(false))
		{
			if (!IS_BIT_SET(iLocal_41, 3))
			{
				if (func_156(77))
				{
					...
					{
						if (func_400(&iLocal_44, 0, 0, false, 0) == 1)
						{
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_41, 3);
							func_399();
							uLocal_177 = unk_0xA7B0B03284E7503C(uLocal_180.f_1.f_394 - uLocal_180.f_1.f_397, uLocal_180.f_1.f_394 + uLocal_180.f_1.f_397, 0, 1, 1, 1, 1);
							iLocal_178 = unk_0x8CC50AC10D8037C7(uLocal_180.f_1.f_394, uLocal_180.f_1.f_397 * { 1.5f, 1.5f, 1.5f }, 0f, 0, 7);
							unk_0x89C4F1335B4A6633(uLocal_180.f_1.f_394 - uLocal_180.f_1.f_397, uLocal_180.f_1.f_394 + uLocal_180.f_1.f_397);
							unk_0x79CA429D8B4B057A(uLocal_180.f_1.f_394 - uLocal_180.f_1.f_397, uLocal_180.f_1.f_394 + uLocal_180.f_1.f_397, 0, 0);
			...
			if (IS_BIT_SET(iLocal_41, 3))
			{
				if (unk_0xC4ADACBD3FE3F266("BS_2A_2B_INT"))
				{
					if (!unk_0xFD216000DC314A92())
					{
						...
						{
							uLocal_132 = Global_98160.f_28[0];
							unk_0xEE0BCDB1B5E36BCB(uLocal_132, 0, 1);
						
							if (unk_0x5B9219522937741D(uLocal_132))
								unk_0x837D67618BF89034(uLocal_132, 1, 1);
						
							unk_0xF293D66D4452C854(uLocal_132, "WALKINGSTICK_LESTER", 1, joaat("IG_LesterCrest"), 0);
						}
						...
						switch (_GET_CURRENT_PLAYER_CHARACTER())
						{
							...
							case CHAR_FRANKLIN:
								...
								unk_0xF293D66D4452C854(iLocal_129, "FRANKLIN", 0, joaat("Player_One"), 0);
								unk_0xF293D66D4452C854(iLocal_130, "TREVOR", 2, joaat("Player_Two"), 0);
								unk_0x0B0C9A0F9AAEB7F0(&iLocal_41, 4);
								break;
						...
						func_213(true, true, true, 0, false, false, false);
						func_394(77);
						unk_0xE226F16D30AF5945(95.19f, -1293.4994f, 28.2672f, 1.5f, joaat("v_club_officechair"), 0);
					...
					else
					{
						...
						{
							unk_0x2094BC4B6731BA68(124.0681f, -1294.7621f, 28.2695f, 1.5f, 0, 0, 0, 0);
							unk_0x0B0C9A0F9AAEB7F0(&iLocal_41, 6);
						}
						...
						switch (iLocal_179)
						{
							case 0:
								func_392(1, 0);
								func_392(CHAR_TREVOR, 0);
							
								if (!unk_0x1C2F771CDC87A3A5(uLocal_126, 0))
									if (func_391(uLocal_126, CHAR_MICHAEL, 0))
										iLocal_179 = 2;
								else if (unk_0xFC8BFE4B41177C22(uLocal_126))
									unk_0x8C1F7D7A31B2A38E(&uLocal_126);
							...
							case 1:
								...
								{
									func_392(CHAR_MICHAEL, 0);
									func_383(133.95317f, -1311.4037f, 28.08922f, 127.84701f, -1315.5419f, 32.11665f, 3.3f, 124.97f, -1321.87f, 28f, 37.74f, func_390(), true, false, true, false, false);
									func_322(&uLocal_127, CHAR_MICHAEL, 130.56f, -1313.66f, 28.74f, 124.66f, false, 0);
									unk_0x1DE99C193C7EC64B(uLocal_127, 1084227584);
									unk_0x55098D9E9AD58806(joaat("tailgater"));
									func_295(uLocal_127, 0f, 0f, 0f, 0f, 24, false);
									iLocal_179 = 2;
								}
								break;
						}
						...
						if (unk_0xD8FC13DA1BA1DBA2("MICHAEL", joaat("Player_Zero")))
						{
							if (!unk_0x1C2F771CDC87A3A5(unk_0x4240B5D04F91480C("MICHAEL", 0), 0))
							{
								...
								unk_0xB2BD5837A8D3CEDA(iLocal_128, 96.46f, -1291.4402f, 28.2688f, 1, 0, 0, 1);
								unk_0x5C96CEA06531AB03(iLocal_128, 299.3742f);
								_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_180.f_484), 0, iLocal_128, "MICHAEL", 1, 1);
							
								if (IS_BIT_SET(iLocal_41, 4))
								{
									uLocal_133[0] = iLocal_128;
						...
						if (unk_0xD8FC13DA1BA1DBA2("FRANKLIN", joaat("Player_One")))
						{
							if (!unk_0x1C2F771CDC87A3A5(unk_0x4240B5D04F91480C("FRANKLIN", 0), 0))
							{
								...
								unk_0xB2BD5837A8D3CEDA(iLocal_129, 97.116f, -1288.5883f, 28.2688f, 1, 0, 0, 1);
								unk_0x5C96CEA06531AB03(iLocal_129, 246.1162f);
								_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_180.f_484), 1, iLocal_129, "FRANKLIN", 1, 1);
							}
						}
						...
						if (unk_0xD8FC13DA1BA1DBA2("TREVOR", joaat("Player_Two")))
						{
							if (!unk_0x1C2F771CDC87A3A5(unk_0x4240B5D04F91480C("TREVOR", 0), 0))
							{
								...
								unk_0xB2BD5837A8D3CEDA(iLocal_130, 99.1774f, -1292.0686f, 28.2688f, 1, 0, 0, 1);
								unk_0x5C96CEA06531AB03(iLocal_130, 20.8497f);
								_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_180.f_484), 2, iLocal_130, "TREVOR", 1, 1);
							}
						}
						...
						if (unk_0xD8FC13DA1BA1DBA2("LESTER", joaat("IG_LesterCrest")))
						{
							if (!unk_0x1C2F771CDC87A3A5(unk_0x4240B5D04F91480C("LESTER", 0), 0))
							{
								...
								_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_180.f_484), 3, iLocal_131, "LESTER", 1, 1);
							}
						}
						...
						if (unk_0x2B60F53D06BC6971(0))
						{
							...
							unk_0xC94AE68759E1B3BD(95.19f, -1293.4994f, 28.2672f, 1.5f, joaat("v_club_officechair"), 0);
							func_115(24, 0);
						}
					}
				}
...
void func_224(var uParam0) // Position - 0xE231
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0, BOOL bParam1) // Position - 0xE319
{
	if (iParam0 == -1)
		return;
...
int func_227(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xE377
{
	var unk;
	eCharacter character;
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0->[uParam0->f_7]) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && uParam0->[uParam0->f_7] != unk_0x4A8C381C258A124D())
	{
		...
		func_275(character, &unk);
		unk_0x0428AFDCAA63B06E(unk, 32, 1);
		unk_0x0428AFDCAA63B06E(unk, 250, 1);
		...
		{
			if (Global_23831.f_13)
			{
				for (i = 0; i < 7; i = i + 1)
				{
					if (IS_BIT_SET(Global_92415[i /*5*/].f_1, 2))
					{
						num2 = Global_92415[i /*5*/];
						TEXT_LABEL_ASSIGN_STRING(&unk2, "MISS_SWITCH_", 64);
						TEXT_LABEL_APPEND_STRING(&unk2, &Global_92451[Global_79810.f_109[num2 /*4*/] /*34*/], 64);
						unk_0x3CAC0DB32E69B1B8(unk_0x70E57E9927B6BA58(&unk2), 1f);
					}
				}
			}
		}
		...
		if (bParam1)
		{
			if (unk_0xFC8BFE4B41177C22(unk))
			{
				...
				func_271(unk);
				unk_0x6E544F5DBF10461B(unk, 0, 0);
				unk_0xF9358C41CC69C616(unk, 0, 0);
			}
		}
		else if (unk_0xFC8BFE4B41177C22(unk))
		{
			unk20 = unk_0xED22194AB8539910(unk, &unk19);
		
			if (!unk_0xFF692AB7350A74D7(unk20))
			{
				if (!unk_0x1B79E937E91F40C3(unk20, unk_0x1AF90EB93E0012D6()))
					unk_0xEE0BCDB1B5E36BCB(unk, 0, 1);
		...
		if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			unk_0xE8B2E2E978035EF0(unk_0x259BE71D8A81D4FA(), func_419(67));
	
		if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			unk_0x5D0510F58106E4FF(unk_0x259BE71D8A81D4FA(), func_419(68));
	
		func_231(character2, &unk18);
	
		if (func_418(0) || func_418(3) || func_418(2) || func_418(4))
		{
			unk_0x0428AFDCAA63B06E(unk18, 32, 0);
			unk_0x0428AFDCAA63B06E(unk18, 250, 0);
		}
		else
		{
			unk_0x0428AFDCAA63B06E(unk18, 32, 1);
			unk_0x0428AFDCAA63B06E(unk18, 250, 1);
		}
...
char* func_229(eCharacter echParam0) // Position - 0xE898
{
	echParam0 = echParam0;
	return "";
}

BOOL func_230() // Position - 0xE8A6
{
	return Global_23829;
}

void func_231(eCharacter echParam0, var uParam1) // Position - 0xE8B1
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
		...
		case CHAR_FRANKLIN:
			if (Global_114135.f_9089.f_330[2 /*6*/])
				func_232(4, *uParam1);
			...
			if (Global_114135.f_9089.f_99.f_58[126])
				func_232(12, *uParam1);
			break;
	
		case CHAR_TREVOR:
			if (Global_114135.f_9089.f_330[20 /*6*/])
				func_232(4, *uParam1);
...
void func_232(int iParam0, int iParam1) // Position - 0xE97D
{
	int i;
	int num;
	BOOL flag;
	...
	if (Global_42877[iParam0 /*31*/].f_24 < 5)
	{
		Global_42877[iParam0 /*31*/].f_25[Global_42877[iParam0 /*31*/].f_24] = iParam1;
		Global_42877[iParam0 /*31*/].f_24 = Global_42877[iParam0 /*31*/].f_24 + 1;
	}
	else
	{
		flag = false;
		...
		for (i = 0; i < 5; i = i + 1)
		{
			num = Global_42877[iParam0 /*31*/].f_25[i];
		
			if (!unk_0xFC8BFE4B41177C22(num) || unk_0x4FAFF4BCB7633475(num))
			{
				Global_42877[iParam0 /*31*/].f_25[i] = iParam1;
				flag = true;
				i = 6;
			}
		}
...
BOOL func_233(int iParam0, int iParam1) // Position - 0xEA2F
{
	int i;

	for (i = 0; i < Global_42877[iParam0 /*31*/].f_24; i = i + 1)
	{
		if (iParam1 == Global_42877[iParam0 /*31*/].f_25[i])
			return true;
	}
...
void func_234(int iParam0) // Position - 0xEA68
{
	if (iParam0 == 10)
		return;
	...
	{
		case 0:
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[38 / 32], 38 % 32);
			func_235(38, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[41 / 32], 41 % 32);
			func_235(41, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[43 / 32], 43 % 32);
			func_235(43, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[42 / 32], 42 % 32);
			func_235(42, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[44 / 32], 44 % 32);
			func_235(44, 0);
			break;
	
		case 1:
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[51 / 32], 51 % 32);
			func_235(51, 0);
			break;
		...
		case 3:
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[53 / 32], 53 % 32);
			func_235(53, 0);
			break;
	
		case 4:
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[81 / 32], 81 % 32);
			func_235(81, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[82 / 32], 82 % 32);
			func_235(82, 0);
			break;
	
		case 5:
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[47 / 32], 47 % 32);
			func_235(47, 0);
			unk_0x0B0C9A0F9AAEB7F0(&Global_39541[50 / 32], 50 % 32);
			func_235(50, 0);
			break;
...
void func_235(int iParam0, int iParam1) // Position - 0xEBF8
{
	int num;
...
void func_236(int iParam0) // Position - 0xECE5
{
...
void func_237(int iParam0) // Position - 0xED30
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
int func_239(int iParam0) // Position - 0xF275
{
	eCharacter character;
...
BOOL func_240(int iParam0) // Position - 0xF49D
{
	int num;
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52)
	{
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			...
			{
				num = unk_0x4B423FAA24E8ABF0(func_241(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 1)));
...
var func_241(var uParam0) // Position - 0xF509
{
	return uParam0;
}

void func_242(int iParam0, var uParam1) // Position - 0xF513
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_243(iParam0) && unk_0x486FF5D06E9659F1(Global_92451[26 /*34*/].f_6) == 0)
			{
				Global_114135.f_7265[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_114135.f_7265[iParam0], 1, 1);
			}
...
BOOL func_243(int iParam0) // Position - 0xFEAB
{
	var unk;
	int num;
...
int func_244(int iParam0) // Position - 0xFEDF
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

struct<7> func_245(int iParam0) // Position - 0xFEF2
{
	var unk;
...
int func_249(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x12C48
{
	int i;
	float num;
	float num2;
...
void func_252(eCharacter echParam0, int iParam1) // Position - 0x12D0F
{
	...
	func_256(echParam0, iParam1, &unk, &num2);

	if (unk_0x76CD105BCAC6EB9F())
		value = func_253(num2, -1);
	else
...
var func_254(int iParam0, int iParam1) // Position - 0x12E2A
{
	return unk_0xD69CE161FE614531(0, iParam0, func_255(iParam1));
}
...
void func_257() // Position - 0x130CA
{
	...
	if (unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) || !func_102(_GET_CURRENT_PLAYER_CHARACTER()) || !func_264())
		return;
	...
	unk.f_39 = 9;
	unk.f_49 = 9;
	func_259(unk_0x4A8C381C258A124D(), &unk, 1, -1);
	...
	Global_114135.f_2367.f_539.f_4315 = 1;
	return;
}
...
void func_258(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x13470
{
	...
	unk_0x0F575D68F532124C(iParam0, echParam1, iParam2);
	return;
}

void func_259(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x13498
{
	eCharacter character;
	int i;
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		for (i = 0; i < 12; i = i + 1)
		{
			func_263(iParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = 0; i < 9; i = i + 1)
		{
			func_262(iParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
var func_261(int iParam0, int iParam1) // Position - 0x13656
{
	return unk_0xD69CE161FE614531(2, iParam0, func_255(iParam1));
}

void func_262(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x1366B
{
	eCharacter character;
...
void func_263(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x13BB4
{
	eCharacter character;
...
var func_265(int iParam0) // Position - 0x13E13
{
	return Global_1574538[iParam0];
}

var func_266() // Position - 0x13E23
{
...
void func_267(eCharacter echParam0) // Position - 0x13E35
{
	...
	{
		case CHAR_MICHAEL:
			unk_0xD414C47AFF81382A(255, joaat("AMBIENT_GANG_FAMILY"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(2, joaat("PLAYER"), joaat("AMBIENT_GANG_LOST"));
			unk_0xD414C47AFF81382A(255, joaat("AMBIENT_GANG_LOST"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, Global_96666, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96666);
			unk_0xD414C47AFF81382A(1, Global_96667, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96667);
			unk_0xD414C47AFF81382A(1, Global_96668, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96668);
			break;
	
		case CHAR_FRANKLIN:
			unk_0xD414C47AFF81382A(1, joaat("AMBIENT_GANG_FAMILY"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(2, joaat("PLAYER"), joaat("AMBIENT_GANG_LOST"));
			unk_0xD414C47AFF81382A(255, joaat("AMBIENT_GANG_LOST"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, Global_96666, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96666);
		...
		case CHAR_TREVOR:
			unk_0xD414C47AFF81382A(255, joaat("AMBIENT_GANG_FAMILY"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(5, joaat("PLAYER"), joaat("AMBIENT_GANG_LOST"));
			unk_0xD414C47AFF81382A(5, joaat("AMBIENT_GANG_LOST"), joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, Global_96666, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96666);
			unk_0xD414C47AFF81382A(1, Global_96667, joaat("PLAYER"));
			unk_0xD414C47AFF81382A(1, joaat("PLAYER"), Global_96667);
...
void func_268() // Position - 0x13FE9
{
	...
	{
		character = Global_114135.f_2367.f_539.f_4321;
	
		if (func_418(14))
			character = _GET_PLAYER_CHARACTER_FROM_PED(unk_0x4A8C381C258A124D());
	
		if (character == CHAR_MICHAEL)
			unk_0x594D5D0D7071B0DE(unk, "BLIP_MICHAEL" /*Michael*/);
		else if (character == CHAR_FRANKLIN)
			unk_0x594D5D0D7071B0DE(unk, "BLIP_FRANKLIN" /*Franklin*/);
		else if (character == CHAR_TREVOR)
			unk_0x594D5D0D7071B0DE(unk, "BLIP_TREV" /*Trevor*/);
		else
			unk_0x594D5D0D7071B0DE(unk, "BLIP_PLAYER" /*Player*/);
	}

	return;
}

void func_269(var uParam0) // Position - 0x1406E
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; i < 44; i = i + 1)
	{
		...
		if (num != 0)
		{
			num2 = unk_0xBCEDAE6CA2B2046E(uParam0, num);
		
			if (num2 != 0 && num2 != joaat("WEAPON_UNARMED") && num2 != joaat("OBJECT"))
				if (unk_0x1149D67DB429787A(uParam0, num2) == -1)
					if (unk_0xACBE463290141D49(uParam0, num2, &unk))
						unk_0xA83DA0A0DF32920C(uParam0, 0, num2);
		}
	}

	num3 = unk_0x9A7818E159C72516();

	for (j = 0; j < num3; j = j + 1)
	{
		if (unk_0xDF94727C5BBB298F(j, &unk2))
		{
			num2 = unk2.f_1;
...
int func_270(int iParam0) // Position - 0x14130
{
	int num;
...
void func_271(var uParam0) // Position - 0x143A4
{
	eCharacter character;

	character = _GET_PLAYER_CHARACTER_FROM_PED(uParam0);

	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		if (uParam0 == unk_0x4A8C381C258A124D() && unk_0x3C8EDE4003ABACA0(uParam0) == 200)
			unk_0x36A20106D0B42723(uParam0, SYSTEM::ROUND((float)unk_0x3C8EDE4003ABACA0(uParam0) * Global_262145.f_104));
	
		if (Global_114135.f_2367.f_539.f_290[character] <= 0f)
			Global_114135.f_2367.f_539.f_290[character] = 100f;
		else if (Global_114135.f_2367.f_539.f_290[character] <= 10f)
			Global_114135.f_2367.f_539.f_290[character] = 10f;
	
		unk_0xD25E9BDC14A0B649(uParam0, SYSTEM::ROUND(((Global_114135.f_2367.f_539.f_290[character] / 100f) * (SYSTEM::TO_FLOAT(unk_0x3C8EDE4003ABACA0(uParam0)) - 100f)) + 100f), 0, 0);
	}
...
void func_276(int iParam0, int iParam1, BOOL bParam2) // Position - 0x145D5
{
	int i;
	BOOL flag;
	...
	if (Global_42877[iParam0 /*31*/].f_24 == 0)
		return;
	...
	for (i = 0; i < Global_42877[iParam0 /*31*/].f_24; i = i + 1)
	{
		if (flag)
		{
			Global_42877[iParam0 /*31*/].f_25[i - 1] = Global_42877[iParam0 /*31*/].f_25[i];
			Global_42877[iParam0 /*31*/].f_25[i] = 0;
		}
		else if (iParam1 == Global_42877[iParam0 /*31*/].f_25[i])
		{
			Global_42877[iParam0 /*31*/].f_25[i] = 0;
			flag = true;
		}
...
void func_277(var uParam0, BOOL bParam1) // Position - 0x14691
{
	func_289(uParam0);
	func_283(uParam0, bParam1);
	func_282(uParam0);
	func_281(uParam0);
	func_280(uParam0);
	func_279(uParam0);
...
void func_278(var uParam0) // Position - 0x146C5
{
	eCharacter character;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
		if (uParam0 == unk_0x4A8C381C258A124D())
			Global_114135.f_2367.f_539.f_2328[character] = unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA());

	return;
}

void func_279(var uParam0) // Position - 0x1470C
{
	eCharacter character;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
		Global_114135.f_2367.f_539.f_2318[character /*3*/] = { unk_0xE5741C6B6539231F(uParam0) };

	return;
}

void func_280(var uParam0) // Position - 0x1474A
{
	eCharacter character;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		Global_114135.f_2367.f_539.f_2300[character /*3*/] = { unk_0xD1A6A821F5AC81DB(uParam0, 1) };
		Global_114135.f_2367.f_539.f_2310[character] = unk_0xCFC0C995455A6204(uParam0);
		Global_114135.f_2367.f_539.f_2314[character] = unk_0xAB74A6FE5E16479E(uParam0);
	
		if (Global_114135.f_2367.f_539.f_2300[character /*3*/] >= 8000f)
			Global_114135.f_2367.f_539.f_2300[character /*3*/] = 7500f;
		else if (Global_114135.f_2367.f_539.f_2300[character /*3*/] <= -8000f)
			Global_114135.f_2367.f_539.f_2300[character /*3*/] = -7500f;
	
		if (Global_114135.f_2367.f_539.f_2300[character /*3*/].f_1 >= 8000f)
			Global_114135.f_2367.f_539.f_2300[character /*3*/].f_1 = 7500f;
		else if (Global_114135.f_2367.f_539.f_2300[character /*3*/].f_1 <= -8000f)
			Global_114135.f_2367.f_539.f_2300[character /*3*/].f_1 = -7500f;
	
		if (Global_114135.f_2367.f_539.f_2300[character /*3*/].f_2 >= 2500f)
			Global_114135.f_2367.f_539.f_2300[character /*3*/].f_2 = 2000f;
	}

	return;
}

void func_281(var uParam0) // Position - 0x148D7
{
	eCharacter character;
...
void func_282(var uParam0) // Position - 0x14913
{
	eCharacter character;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
		Global_114135.f_2367.f_539.f_290[character] = ((SYSTEM::TO_FLOAT(unk_0x8D91ADE44AC79BC9(uParam0)) - 100f) / (SYSTEM::TO_FLOAT(unk_0x3C8EDE4003ABACA0(uParam0)) - 100f)) * 100f;

	return;
}

void func_283(var uParam0, BOOL bParam1) // Position - 0x14970
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		if (uParam0 == unk_0x4A8C381C258A124D())
		{
			func_284(uParam0, &Global_114135.f_2367.f_539.f_298[character /*477*/]);
...
void func_284(var uParam0, var uParam1) // Position - 0x14A63
{
	int i;
	int j;
	int k;
	...
	if (!unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (num != 0)
			{
				num2 = unk_0xBCEDAE6CA2B2046E(uParam0, func_270(i));
				num2.f_1 = 0;
				num2.f_2 = 0;
				num2.f_3 = 0;
				num2.f_4 = 0;
				...
				if (num2 != 0 && num2 != joaat("WEAPON_UNARMED"))
				{
					...
					for (k = func_287(num2, j); k != 0; k = func_287(num2, j))
					{
		...
		{
			if (unk_0xA40B513DA7201333(l, &unk5) && !func_286(unk5.f_1) && num4 < 51)
			{
...
int func_287(int iParam0, int iParam1) // Position - 0x14F84
{
	int num;
	int num2;
	int i;
...
int func_288(int iParam0, var uParam1) // Position - 0x15D05
{
	int i;
	int num;
...
void func_289(var uParam0) // Position - 0x15D40
{
	eCharacter character;
	...
	if (func_102(character) && !unk_0x4FAFF4BCB7633475(uParam0))
		Global_114135.f_2367.f_539.f_2296[character] = func_180();

	return;
}

int func_290(var uParam0, int iParam1) // Position - 0x15D7A
{
	BOOL flag;
	BOOL flag2;
	...
	else
	{
		...
		if (func_272(_GET_CURRENT_PLAYER_CHARACTER()) != iParam1 || flag)
		{
			...
			if (flag || uParam0->f_24[iParam1] != 0 || func_294(iParam1) && func_291(iParam1) && !uParam0->f_18[iParam1])
				if (!uParam0->f_23)
					if (!unk_0x4FAFF4BCB7633475(uParam0->[iParam1]) || flag)
						if (uParam0->f_34[iParam1] != 1 && uParam0->f_34[iParam1] != 3)
							flag2 = true;
				else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && unk_0x76CD105BCAC6EB9F() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) == 0 && !IS_BIT_SET(Global_99141.f_47, iParam1))
					flag2 = true;
			else if (!(IS_BIT_SET(Global_114135.f_9089.f_2[27 /*3*/], 1) && !Global_4 && !_IS_MISSION_REPEAT_ACTIVE(false)))
				if (uParam0->f_23)
					flag2 = true;
...
int func_291(int iParam0) // Position - 0x15ECF
{
	if (Global_114135.f_9089 || Global_4)
		if (!Global_79539 || Global_79539 && iParam0 != func_272(func_293()))
...
BOOL func_292(eCharacter echParam0) // Position - 0x15F1F
{
	if (func_102(echParam0))
...
eCharacter func_293() // Position - 0x15F6D
{
	return Global_114135.f_2367.f_539.f_4323;
}

int func_294(int iParam0) // Position - 0x15F82
{
	if (Global_114135.f_9089 || Global_4 || _IS_MISSION_REPEAT_ACTIVE(false))
		if (!Global_79539 || Global_79539 && iParam0 != func_272(func_293()))
			if (iParam0 == 0 && !func_419(115) || iParam0 == 1 && !func_419(116) || iParam0 == 2 && !func_419(117))
				return 0;

	return 1;
}

void func_295(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x1600E
{
	var unk;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		func_309(iParam5, &unk, fParam1, fParam4, func_315(iParam0));
		func_296(iParam5, iParam0, 0);
	}

	return;
}

void func_296(int iParam0, int iParam1, int iParam2) // Position - 0x16137
{
	int num;
	...
	if (!func_307(&Global_78329.f_555[0 /*21*/], iParam0))
		return;
	...
	if (unk_0xFC8BFE4B41177C22(iParam1))
	{
		if (unk_0xD9F5E1FEFD1329E4(iParam1, 0))
		{
			...
			if (iParam0 == 24)
				Global_114135.f_32754.f_4801 = func_180();
...
void func_297(int iParam0, eCharacter echParam1) // Position - 0x1624E
{
	var unk;
	int i;
	int j;
	...
	func_316(iParam0, &(Global_114135.f_32754.f_5510));
	return;
}

BOOL func_298(int iParam0) // Position - 0x16450
{
	if (!unk_0xFC8BFE4B41177C22(iParam0) || !unk_0xD9F5E1FEFD1329E4(iParam0, 0) || func_304(iParam0, CHAR_MICHAEL, false) || func_304(iParam0, CHAR_FRANKLIN, false) || func_304(iParam0, CHAR_TREVOR, false) || func_315(iParam0) != _CHAR_NULL || func_303(iParam0) || func_302(iParam0) || func_301(iParam0) || func_300(iParam0) || !func_299(unk_0x4B423FAA24E8ABF0(iParam0)))
	{
		func_302(iParam0);
		func_302(iParam0);
		func_304(iParam0, CHAR_MICHAEL, false);
		func_304(iParam0, CHAR_FRANKLIN, false);
		func_304(iParam0, CHAR_TREVOR, false);
		func_315(iParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_299(int iParam0) // Position - 0x1652D
{
	if (iParam0 == 0)
		return false;

	if (!func_166(iParam0, false, -1))
		return false;
...
BOOL func_300(int iParam0) // Position - 0x166EB
{
	int num;
	var unk;
	...
	if (!func_166(num, false, -1))
		return true;

	return false;
}

BOOL func_301(int iParam0) // Position - 0x16732
{
	int i;
...
BOOL func_302(int iParam0) // Position - 0x1676D
{
	int i;
...
BOOL func_303(int iParam0) // Position - 0x167E9
{
	int i;
...
BOOL func_304(int iParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x168D1
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_305(echParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_305(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x1693F
{
...
int func_306(int iParam0) // Position - 0x16A16
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_307(var uParam0, int iParam1) // Position - 0x16A32
{
	BOOL num;
	int num2;
...
int func_308(eCharacter echParam0, int iParam1) // Position - 0x18121
{
	int num;
...
void func_309(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x18163
{
	if (func_307(&Global_78329.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_314(iParam0);
			func_313(uParam1, &Global_114135.f_32754.f_69[Global_78329.f_555[0 /*21*/].f_14 /*78*/]);
...
void func_310(int iParam0, BOOL bParam1) // Position - 0x1825C
{
	if (iParam0 == -1)
		return;
...
void func_311(int iParam0, int iParam1, BOOL bParam2) // Position - 0x182B9
{
	if (iParam0 == -1)
		return;
...
BOOL func_312(int iParam0, int iParam1) // Position - 0x182F4
{
	if (iParam0 == -1)
		return false;
...
void func_313(var uParam0, var uParam1) // Position - 0x18314
{
...
void func_314(int iParam0) // Position - 0x183E0
{
	if (iParam0 == -1)
		return;
...
eCharacter func_315(int iParam0) // Position - 0x18457
{
	int i;
...
void func_316(int iParam0, var uParam1) // Position - 0x184BA
{
	int i;
		...
		*uParam1 = unk_0x4F06416A18248EA0(iParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (unk_0x5318DF85BEB6B95F(iParam0, i + 1))
				unk_0x0B0C9A0F9AAEB7F0(&(uParam1->f_77), func_317(i + 1));
		}
...
int func_317(int iParam0) // Position - 0x18765
{
	switch (iParam0)
	{
		case 1:
...
int func_318(var uParam0, var uParam1, var uParam2) // Position - 0x18815
{
	int i;
	int num;
...
BOOL func_319(int iParam0) // Position - 0x18A08
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_320(var uParam0) // Position - 0x18A28
{
	int i;
...
void func_321(int iParam0) // Position - 0x18AD7
{
...
int func_322(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x18AFE
{
	var unk;
	var unk2;
	int num;
	...
	if (func_102(echParam1))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_164(echParam1, &num, iParam7);
		...
		if (Global_114135.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == num)
		{
			...
			{
				*uParam0 = unk_0x5779387E956077A6(Global_114135.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/], fParam2, fParam5, 0, 0, 0);
				...
				func_374(uParam0, &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114135.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == num)
		{
			...
			{
				*uParam0 = unk_0x5779387E956077A6(Global_114135.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/], fParam2, fParam5, 0, 0, 0);
				unk_0x1DE99C193C7EC64B(*uParam0, 1084227584);
				unk_0x9BC299A7D57D7CAA(*uParam0, 0);
				unk_0xC13B5C4CC421EA79(*uParam0, 0);
				unk_0x5FE0938FDE9B0958(*uParam0, 1);
				...
				func_374(uParam0, &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				unk_0x4DC7FAAC148F9B2F(*uParam0, num.f_96);
		...
		else
		{
			...
			if (unk_0x6252BC0DD8A320DB(num))
			{
				...
				*uParam0 = unk_0x5779387E956077A6(num, fParam2, fParam5, 1, 1, 0);
				...
				func_374(uParam0, &(num.f_31), &(num.f_81));
				unk_0x4DC7FAAC148F9B2F(*uParam0, num.f_96);
...
void func_323(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x19921
{
	var unk;
	var unk2;
	int num;
	...
	if (func_102(echParam0) && unk_0xFC8BFE4B41177C22(*uParam1) && unk_0xD9F5E1FEFD1329E4(*uParam1, 0))
	{
		...
		if (unk_0xA9DFDFED12311CA7(*uParam1) >= 0 && func_327(*uParam1, false, &unk))
		{
			func_318(uParam1, &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114135.f_20122[echParam0 /*43*/].f_31 = func_326(*uParam1);
				...
				func_324(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num2, true, &(Global_114135.f_20122[echParam0 /*43*/].f_1));
				...
				func_324(Global_114135.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num2, false, &(Global_114135.f_20122[echParam0 /*43*/].f_2));
			}
		}
	}
...
int func_324(int iParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4) // Position - 0x1A535
{
	int i;
	int num;
	var unk;
...
BOOL func_325(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1A5A8
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_326(var uParam0) // Position - 0x1BA9A
{
	int num;
	int num2;
	int num3;
...
BOOL func_327(int iParam0, BOOL bParam1, var uParam2) // Position - 0x1BB4A
{
	int num;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_369(num, bParam1, uParam2) && !func_368(unk_0x259BE71D8A81D4FA()) && !func_341(iParam0))
		return false;
	...
	if (func_337(unk_0x259BE71D8A81D4FA()) && unk_0xBA16CD57E37AC32A(num) || unk_0x00C6FDED3EB75117(num))
		flag = true;

	if (unk_0x9E20DC08879FF3FC(iParam0) && !func_334(iParam0) && !flag && !(func_333(unk_0x4B423FAA24E8ABF0(iParam0)) && func_332(unk_0x259BE71D8A81D4FA())) && !(func_331(unk_0x4B423FAA24E8ABF0(iParam0)) && func_328(unk_0x259BE71D8A81D4FA())))
	{
...
BOOL func_328(Player plParam0) // Position - 0x1BCD5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 30;

	return false;
}

int func_329(int iParam0) // Position - 0x1BD1C
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1C515
{
	Player player;
...
BOOL func_331(int iParam0) // Position - 0x1C575
{
...
BOOL func_332(Player plParam0) // Position - 0x1C58C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_333(int iParam0) // Position - 0x1C5D3
{
...
BOOL func_334(int iParam0) // Position - 0x1C615
{
	switch (unk_0x4B423FAA24E8ABF0(iParam0))
	{
		...
		case joaat("monster4"):
		case joaat("monster5"):
			if (func_336(unk_0x259BE71D8A81D4FA()))
				return true;
			break;
...
BOOL func_335(Player plParam0) // Position - 0x1C6DD
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_336(Player plParam0) // Position - 0x1C724
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_337(Player plParam0) // Position - 0x1C76B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_338(int iParam0) // Position - 0x1C7B1
{
	BOOL flag;
	...
	if (!func_340(unk_0x259BE71D8A81D4FA()) && iParam0 != joaat("thruster") && iParam0 != joaat("avenger") && iParam0 != func_339(true) && !flag)
		return false;

	return true;
}

int func_339(BOOL bParam0) // Position - 0x1C842
{
	if (bParam0)
		return -426933872;
...
BOOL func_340(Player plParam0) // Position - 0x1C85C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_341(int iParam0) // Position - 0x1C882
{
	if (func_367(unk_0x259BE71D8A81D4FA()) || func_366(unk_0x259BE71D8A81D4FA()))
		if (func_342(iParam0))
			return true;
...
BOOL func_342(int iParam0) // Position - 0x1C8B1
{
	...
	if (func_346(iParam0, false))
		return true;

	if (func_345(unk_0x259BE71D8A81D4FA()) && !func_338(unk_0x4B423FAA24E8ABF0(iParam0)) || unk_0x2E6A27037F1DC473(iParam0, joaat("openwheel1")) || unk_0x2E6A27037F1DC473(iParam0, joaat("openwheel2")) || unk_0x2E6A27037F1DC473(iParam0, joaat("formula")) || unk_0x2E6A27037F1DC473(iParam0, joaat("formula2")))
		return false;
...
BOOL func_343(int iParam0) // Position - 0x1CA19
{
	int num;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0) && unk_0xD9F5E1FEFD1329E4(iParam0, 0))
	{
		...
		if (unk_0x9E20DC08879FF3FC(iParam0) && !func_334(iParam0) || func_344(num))
			return true;
...
BOOL func_344(int iParam0) // Position - 0x1CA96
{
	switch (iParam0)
	{
		case joaat("mule"):
...
BOOL func_345(Player plParam0) // Position - 0x1CAF2
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_368(plParam0) && Global_2657991[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_346(var uParam0, BOOL bParam1) // Position - 0x1CB2B
{
	switch (unk_0x4B423FAA24E8ABF0(uParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_348(unk_0x4B423FAA24E8ABF0(uParam0), 0))
				if (Global_2739811.f_307 == uParam0)
					return true;
				else if (func_347(uParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_347(var uParam0) // Position - 0x1CB86
{
	int i;
...
BOOL func_348(int iParam0, int iParam1) // Position - 0x1CBBF
{
	if (iParam1 == 0)
...
BOOL func_358(int iParam0) // Position - 0x1D499
{
	if (unk_0x259BE71D8A81D4FA() != _INVALID_PLAYER_INDEX())
	{
		if (func_364() || func_363(unk_0x259BE71D8A81D4FA()))
			return false;
	
		if (func_362(unk_0x259BE71D8A81D4FA(), true, false) && Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_268.f_36 > 0 || IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_268.f_34, 11))
			return false;
	
		if (unk_0x77B62CAA5DF0922A("Player_Vehicle", 3))
			if (unk_0xD130E7CDEE903624(iParam0, "Player_Vehicle"))
				if (unk_0xE2F6FE9B61232165(iParam0, "Player_Vehicle") == unk_0x3351FEF40EC734DB(unk_0x259BE71D8A81D4FA()))
					if (func_360() != -1 && func_360() < 547)
						if (!func_359(iParam0) || unk_0x4B423FAA24E8ABF0(iParam0) != Global_1586535[func_360() /*143*/].f_66)
							return true;
					else
						return true;
	}
...
BOOL func_359(var uParam0) // Position - 0x1D592
{
...
int func_360() // Position - 0x1D5AB
{
	return Global_2359296[func_361() /*5571*/].f_681.f_2;
}

int func_361() // Position - 0x1D5C3
{
	int num;
...
BOOL func_362(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D5D0
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_363(Player plParam0) // Position - 0x1D634
{
...
BOOL func_364() // Position - 0x1D665
{
	return func_365() != -1;
}

int func_365() // Position - 0x1D673
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

BOOL func_366(Player plParam0) // Position - 0x1D68B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_367(Player plParam0) // Position - 0x1D6EA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657991[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_368(Player plParam0) // Position - 0x1D74A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657991[plParam0 /*467*/].f_324.f_8 != -1)
				return func_329(Global_2657991[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_369(int iParam0, BOOL bParam1, var uParam2) // Position - 0x1D791
{
	BOOL flag;
	...
	if (func_337(unk_0x259BE71D8A81D4FA()) && unk_0xBA16CD57E37AC32A(iParam0) || unk_0x00C6FDED3EB75117(iParam0))
		flag = true;
...
BOOL func_370(int iParam0) // Position - 0x1DB88
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_371(int iParam0, eCharacter echParam1) // Position - 0x1DBBD
{
	int i;
...
void func_372(var uParam0) // Position - 0x1DC3F
{
	if (!func_373(*uParam0))
...
BOOL func_373(var uParam0) // Position - 0x1DC6A
{
	return unk_0x5318DF85BEB6B95F(uParam0, 5);
}

int func_374(var uParam0, var uParam1, var uParam2) // Position - 0x1DC79
{
	int i;
	int num;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (unk_0x94C9CD3D66808551(*uParam0, num) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_380(*uParam0, num, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_379(unk_0x4B423FAA24E8ABF0(*uParam0)) && unk_0x94C9CD3D66808551(*uParam0, 24) != func_377(*uParam0, uParam1->[38] - 1))
		unk_0x8450270DC5896D39(*uParam0, 24, func_377(*uParam0, uParam1->[38] - 1), 0);
...
BOOL func_375(var uParam0) // Position - 0x1DE52
{
	int i;
	int num;
	int num2;
...
void func_376(var uParam0) // Position - 0x1DF2E
{
	switch (unk_0x4B423FAA24E8ABF0(*uParam0))
	{
		case joaat("starling"):
...
int func_377(var uParam0, int iParam1) // Position - 0x1DF85
{
	int value;
	int value2;
	float num;
	...
	if (unk_0xFC8BFE4B41177C22(uParam0) && unk_0xD9F5E1FEFD1329E4(uParam0, 0))
	{
		...
		value = func_378(uParam0, 38) + 1;
		value2 = func_378(uParam0, 24) + 1;
...
int func_378(var uParam0, int iParam1) // Position - 0x1E06E
{
	int i;
	...
	for (i = unk_0x5B59C12A02157D00(uParam0, iParam1) - 1; i >= 0 && func_380(uParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_379(int iParam0) // Position - 0x1E0D0
{
	if (func_357(iParam0, 1))
		return true;
...
BOOL func_380(var uParam0, int iParam1, int iParam2) // Position - 0x1E0FB
{
	if (!func_381() && unk_0xAF82FE1B3E949337(uParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_381() // Position - 0x1E11F
{
	return false;
}

BOOL func_382(var uParam0, var uParam1) // Position - 0x1E128
{
	if (unk_0x76CD105BCAC6EB9F())
	{
	}
...
void func_383(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1E169
{
	func_384(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_384(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x1E193
{
	int num;
	BOOL flag;
	BOOL flag2;
		...
		if (unk_0xD9F5E1FEFD1329E4(num, 0))
		{
			...
			else
			{
				...
				if (unk6.f_2 > uParam0.f_2 && unk6.f_2 < uParam3.f_2 || unk6.f_2 > uParam3.f_2 && unk6.f_2 < uParam0.f_2)
					if (func_386(num, uParam0, uParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_304(num, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1E589
{
...
BOOL func_386(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x1E5B3
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_387(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x1E8A9
{
	float num;
	float num2;
	float num3;
...
Vector3 func_388(float fParam0, var uParam1, var uParam2) // Position - 0x1E95D
{
	float num;
	float num2;
...
void func_389(int iParam0) // Position - 0x1E99C
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
...
Vector3 func_390() // Position - 0x1EA01
{
	return 2.55f, 5.665f, 2.55f;
}

BOOL func_391(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x1EA18
{
	int i;
		...
		if (unk_0xFC8BFE4B41177C22(Global_98994[i]))
			if (Global_98994[i] == iParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_99004[i])
					if (iParam2 == 0 || unk_0x4B423FAA24E8ABF0(iParam0) == func_308(echParam1, iParam2))
						return true;
	}
...
void func_392(eCharacter echParam0, int iParam1) // Position - 0x1EAA6
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(Global_98994[i]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x4B423FAA24E8ABF0(Global_98994[i]) == func_308(echParam0, iParam1))
				{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1EB44
{
...
void func_394(int iParam0) // Position - 0x1EBDF
{
	if (Global_98585 != -1)
	{
...
void func_395() // Position - 0x1EC03
{
	eCharacter character;

	character = _GET_PLAYER_CHARACTER_FROM_PED(unk_0x4A8C381C258A124D());
	func_396(unk_0x4A8C381C258A124D(), &Global_101092[character /*98*/], &Global_101395[character /*3*/], &Global_101405[character], &Global_101387[character], &Global_4546316[character]);
	return;
}

void func_396(var uParam0, int iParam1, var uParam2, float fParam3, int iParam4, var uParam5) // Position - 0x1EC45
{
	int num;
	int num2;
	eCharacter character;
	...
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
		{
			...
			{
				num2 = unk_0x6EF03BE64E058E2F(uParam0, 0);
				*iParam4 = 2;
			}
			else
			{
				...
				if (!unk_0x1C2F771CDC87A3A5(Global_101391[character], 0))
				{
					if (unk_0xC39AE5D390581AD5(Global_101391[character], -1, 0))
					{
						vector = { unk_0xD1A6A821F5AC81DB(uParam0, 1) };
						vector2 = { unk_0xD1A6A821F5AC81DB(Global_101391[character], 1) };
					
						if (unk_0x4B423FAA24E8ABF0(Global_101391[character]) == joaat("luxor2"))
						{
							if (SYSTEM::VDIST(vector, vector2) < 10f)
							{
								*iParam4 = 2;
								num2 = Global_101391[character];
								num = 1;
							}
						}
					}
	...
	func_397(uParam0, num2, iParam1, uParam2, fParam3, iParam4, uParam5, num);
	return;
}

void func_397(var uParam0, int iParam1, int iParam2, var uParam3, float fParam4, int iParam5, var uParam6, int iParam7) // Position - 0x1ED18
{
	eCharacter character;
	int i;
	Vector3 vector;
	...
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0) && !unk_0x1C2F771CDC87A3A5(iParam1, 0))
	{
		character = _GET_PLAYER_CHARACTER_FROM_PED(uParam0);
		...
		if (unk_0xD130E7CDEE903624(iParam1, "GetawayVehicleValid"))
		{
			...
			{
				if (Global_114135.f_9089.f_99.f_58[45] || Global_114135.f_9089.f_99.f_58[12] || Global_114135.f_9089.f_99.f_58[34])
				{
					*iParam5 = 0;
					Global_101391[character] = 0;
					return;
				}
			}
		}
	
		if (unk_0xCECDBB848D53DEB2(uParam0, iParam1, 0) || iParam7)
		{
			*iParam5 = 2;
			Global_101391[character] = iParam1;
		}
		else if (unk_0x7F420695E3F776FB(uParam0, 0))
		{
			iParam1 = unk_0x6EF03BE64E058E2F(uParam0, 0);
			*iParam5 = 2;
			Global_101391[character] = iParam1;
		}
		else
		{
			for (i = 0; i < 68; i = i + 1)
			{
				if (iParam1 == Global_78329.f_139[i])
				{
					*iParam5 = 0;
					Global_101391[character] = 0;
					return;
			...
			if (!unk_0x1C2F771CDC87A3A5(Global_101391[character], 0))
			{
				if (!func_304(Global_101391[character], character, false) || unk_0xCECDBB848D53DEB2(uParam0, Global_101391[character], 0))
				{
					vector = { unk_0xD1A6A821F5AC81DB(uParam0, 1) };
					vector2 = { unk_0xD1A6A821F5AC81DB(Global_101391[character], 1) };
				
					if (func_398(uParam0, Global_101391[character], 0))
					{
						if (SYSTEM::VDIST2(vector, vector2) < 22500f)
						{
							*uParam3 = { vector2 };
							*fParam4 = unk_0xCFC0C995455A6204(Global_101391[character]);
							*iParam5 = 1;
							Global_101391[character] = iParam1;
						
							if (SYSTEM::VDIST2(vector, vector2) < 1.5f * 1.5f)
							{
							}
						}
					}
	...
	if (unk_0xFC8BFE4B41177C22(iParam1))
	{
		*iParam2 = unk_0x4B423FAA24E8ABF0(iParam1);
	
		if (unk_0x20974C28142EB370(iParam1, &unk5))
			iParam2->f_1 = unk_0x4B423FAA24E8ABF0(unk5);
	
		iParam2->f_2 = unk_0xF04E476AE02C4646(iParam1);
		iParam2->f_3 = unk_0x8D91ADE44AC79BC9(iParam1);
		iParam2->f_4 = unk_0x0507EE8EDD1D75E9(iParam1);
		...
		{
			iParam2->f_9 = 0;
			unk_0xFF4B16F297D9CB3E(iParam1, &(iParam2->f_5), &(iParam2->f_6));
		}
	
		if (!unk_0xEA4F815FDC353FEF(*iParam2))
		{
			iParam2->f_10 = 1;
			unk_0x741D9B0685E67684(iParam1, &(iParam2->f_7), &(iParam2->f_8));
		}
		else
		{
			iParam2->f_10 = 0;
		...
		TEXT_LABEL_ASSIGN_STRING(&(iParam2->f_27), unk_0xCA7159F2C5FF745A(iParam1), 16);
		iParam2->f_26 = unk_0x4F06416A18248EA0(iParam1);
		iParam2->f_88 = unk_0xE6BE8A525BA6BD44(iParam1);
		unk_0x9D35AABAEE206518(iParam1, &(iParam2->f_84), &(iParam2->f_85), &(iParam2->f_86));
		iParam2->f_87 = unk_0xDA63CE76F9AAB439(iParam1);
		unk_0x64FEACF0AD019F1F(iParam1, &(iParam2->f_93), &(iParam2->f_94), &(iParam2->f_95));
	
		if (unk_0xF1B79038130E3C08(iParam1, 2))
			unk_0x0B0C9A0F9AAEB7F0(&(iParam2->f_92), 28);
		else
			unk_0x8744D2E3FC95740E(&(iParam2->f_92), 28);
	
		if (unk_0xF1B79038130E3C08(iParam1, 3))
			unk_0x0B0C9A0F9AAEB7F0(&(iParam2->f_92), 29);
		else
			unk_0x8744D2E3FC95740E(&(iParam2->f_92), 29);
	
		if (unk_0xF1B79038130E3C08(iParam1, 0))
			unk_0x0B0C9A0F9AAEB7F0(&(iParam2->f_92), 30);
		else
			unk_0x8744D2E3FC95740E(&(iParam2->f_92), 30);
	
		if (unk_0xF1B79038130E3C08(iParam1, 1))
			unk_0x0B0C9A0F9AAEB7F0(&(iParam2->f_92), 31);
		else
			unk_0x8744D2E3FC95740E(&(iParam2->f_92), 31);
	
		iParam2->f_89 = unk_0xA089B04A208DBD0B(iParam1);
		iParam2->f_90 = unk_0x6A375D21624F9187(iParam1);
	
		for (j = 0; j < 12; j = j + 1)
		{
			iParam2->f_11[j] = unk_0x5318DF85BEB6B95F(iParam1, j + 1);
		}
		...
		if (uParam0 == unk_0x4A8C381C258A124D())
			iParam2->f_25 = unk_0xE1799BB6E4C1CDFB();
	
		func_318(&iParam1, &(iParam2->f_31), &(iParam2->f_81));
		iParam2->f_96 = unk_0xD1DBD3830272ECAA(iParam1);
		iParam2->f_97 = func_302(iParam1);
		*uParam6 = -1;
	
		switch (character)
		{
			case CHAR_MICHAEL:
				if (Global_114135.f_32754.f_69[0 /*78*/].f_66 == unk_0x4B423FAA24E8ABF0(iParam1))
					*uParam6 = 12;
				break;
		
			case CHAR_FRANKLIN:
				if (Global_114135.f_32754.f_69[1 /*78*/].f_66 == unk_0x4B423FAA24E8ABF0(iParam1))
					*uParam6 = 13;
				break;
		
			case CHAR_TREVOR:
				if (Global_114135.f_32754.f_69[2 /*78*/].f_66 == unk_0x4B423FAA24E8ABF0(iParam1))
					*uParam6 = 14;
				break;
		}
	}
...
BOOL func_398(var uParam0, int iParam1, int iParam2) // Position - 0x1F21F
{
	int num;

	if (unk_0xCECDBB848D53DEB2(uParam0, iParam1, iParam2))
	{
		num = unk_0x4B423FAA24E8ABF0(iParam1);
	
		if (unk_0xEA4F815FDC353FEF(num) || num == joaat("submersible") || num == joaat("submersible2"))
		{
		...
		if (unk_0x00C6FDED3EB75117(num) || unk_0xBA16CD57E37AC32A(num) || num == joaat("blimp"))
		{
...
void func_399() // Position - 0x1F2AB
{
	Global_101727 = 1;
	return;
}

int func_400(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1F2B8
{
	int i;
...
void func_401(var uParam0, int iParam1) // Position - 0x1F3EF
{
	int i;
...
void func_402(var uParam0) // Position - 0x1F43E
{
	if (func_11(2, *uParam0))
	{
		if (IS_BIT_SET(uParam0->f_449, 1))
		{
			if (IS_BIT_SET(uParam0->f_449, 2))
			{
				func_70(uParam0, func_403(*uParam0));
...
BOOL func_403(int iParam0) // Position - 0x1F48D
{
	switch (iParam0)
	{
		case 0:
...
void func_404(var uParam0, float fParam1, float fParam2) // Position - 0x1F4FA
{
	float num;

	if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		num = SYSTEM::VDIST2(uParam0->f_401, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1));
	
		if (IS_BIT_SET(uParam0->f_449, 1))
			func_415(uParam0);
		else if (num < fParam1 * fParam1 || IS_BIT_SET(Global_97672, *uParam0))
			if (IS_BIT_SET(uParam0->f_449, 0))
				if (func_414(uParam0))
					if (IS_BIT_SET(Global_97672, *uParam0))
						if (IS_BIT_SET(Global_97674, *uParam0))
							func_409(uParam0);
					else
						func_409(uParam0);
			else
		...
		if (num > fParam2 * fParam2 && !IS_BIT_SET(Global_97672, *uParam0))
		{
			if (IS_BIT_SET(uParam0->f_449, 0))
			{
				if (IS_BIT_SET(uParam0->f_449, 1))
...
void func_405(var uParam0) // Position - 0x1F5CB
{
	...
	unk_0x8744D2E3FC95740E(&Global_97673, *uParam0);
	unk_0x8744D2E3FC95740E(&(uParam0->f_449), 0);
	return;
}

void func_406(var uParam0) // Position - 0x1F635
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!unk_0xFD216000DC314A92())
		...
		func_407(uParam0);
		unk_0x8744D2E3FC95740E(&(uParam0->f_449), 1);
		unk_0x8744D2E3FC95740E(&Global_97672, *uParam0);
	}

	return;
}

void func_407(var uParam0) // Position - 0x1F67B
{
	int i;

	for (i = 0; i < uParam0->f_1.f_33; i = i + 1)
	{
		if (unk_0xFC8BFE4B41177C22(uParam0->f_428[i]))
			unk_0x51C8BEA2005931AB(&uParam0->f_428[i]);
	}

	return;
}

void func_408(var uParam0) // Position - 0x1F6B7
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_97671, *uParam0);
	unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_449), 0);
	return;
}

void func_409(var uParam0) // Position - 0x1F735
{
	int i;
	...
	if (!IS_BIT_SET(uParam0->f_449, 1))
	{
		...
		func_412(uParam0);
		func_410(uParam0);
		unk_0x0B0C9A0F9AAEB7F0(&(uParam0->f_449), 1);
	}

	return;
}

void func_410(var uParam0) // Position - 0x1F78F
{
	int i;
	int num;
	float num2;
	...
	for (i = 0; i < uParam0->f_1.f_33; i = i + 1)
	{
		if (func_33(*uParam0, uParam0->f_1.f_75[i]))
		{
			...
			{
				case 0:
					num = joaat("prop_ld_planning_pin_01");
					break;
			
				case 1:
					num = joaat("prop_ld_planning_pin_02");
					break;
			
				case 2:
					num = joaat("prop_ld_planning_pin_03");
					break;
			}
		
			num2 = SYSTEM::TO_FLOAT(unk_0xC5935DFB3F39785A(0, 65535) - 32767) / 4000f;
			num3 = SYSTEM::TO_FLOAT(unk_0xC5935DFB3F39785A(0, 65535) - 32767) / 4000f;
			unk = { func_411(uParam0, &uParam0->f_1.f_34[i /*2*/]) };
			uParam0->f_428[i] = unk_0x4E55EAB577C13329(num, unk, 1, 1, 0);
			unk_0xCF39804E8C88080E(uParam0->f_428[i], num2, 0f, uParam0->f_404 + num3, 2, 1);
			unk_0xEE0BCDB1B5E36BCB(uParam0->f_428[i], 1, 0);
			unk_0x935364B4448CD584(uParam0->f_428[i], 1, 0);
			unk_0x44C48AC14D3C09ED(uParam0->f_428[i], 0, 0);
			unk_0xBF861D73D95BF415(uParam0->f_428[i], 0);
			unk_0x5D7CD709B34C90F0(uParam0->f_428[i], 1);
		}
	}

	unk_0x8744D2E3FC95740E(&Global_97674, *uParam0);
	return;
}

Vector3 func_411(var uParam0, var uParam1) // Position - 0x1F8C5
{
	float num;
	float num2;
	float num3;
...
void func_412(var uParam0) // Position - 0x1F943
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < uParam0->f_1.f_117; i = i + 1)
	{
		...
		else
		{
			...
			unk_0x557F1E2300EF1A3E(flag);
			unk_0x330108B080A2132F(0);
			unk_0x74BF156C860580D4(SYSTEM::TO_FLOAT(uParam0->f_1.f_141[i /*2*/]));
			unk_0x74BF156C860580D4(SYSTEM::TO_FLOAT(uParam0->f_1.f_141[i /*2*/].f_1));
			unk_0xE6B753D52F4CA222();
		}
	}
...
void func_413(var uParam0) // Position - 0x1FA20
{
	int num;
	int num2;
	int i;
...
BOOL func_414(var uParam0) // Position - 0x1FB60
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_97673, *uParam0);
	return true;
}

void func_415(var uParam0) // Position - 0x1FBFB
{
	float num;
	float num2;
	...
	if (func_33(*uParam0, 0))
	{
		...
		unk_0x3D1B3BF5963D08DE(uParam0->f_413, uParam0->f_401 + { num2, num * SYSTEM::COS(90f - uParam0->f_404), num * SYSTEM::SIN(90f - uParam0->f_404) }, 180f, 0f, uParam0->f_404, 1f, 1f, 1f, uParam0->f_1.f_6, uParam0->f_1.f_7, 1f, 2);
	}

	return;
}

void func_416(var uParam0) // Position - 0x1FC84
{
	int i;
	int num;
	BOOL flag;
		...
		for (i = 0; i < uParam0->f_1.f_33; i = i + 1)
		{
			if (func_33(*uParam0, uParam0->f_1.f_75[i]))
			{
				if (!unk_0xFC8BFE4B41177C22(uParam0->f_428[i]))
				{
					...
					{
						case 0:
							num2 = joaat("prop_ld_planning_pin_01");
							break;
					
						case 1:
							num2 = joaat("prop_ld_planning_pin_02");
							break;
					
						case 2:
							num2 = joaat("prop_ld_planning_pin_03");
							break;
					}
				
					num3 = SYSTEM::TO_FLOAT(unk_0xC5935DFB3F39785A(0, 65535) - 32767) / 4000f;
					num4 = SYSTEM::TO_FLOAT(unk_0xC5935DFB3F39785A(0, 65535) - 32767) / 4000f;
					unk = { func_411(uParam0, &uParam0->f_1.f_34[i /*2*/]) };
					uParam0->f_428[i] = unk_0x4E55EAB577C13329(num2, unk, 1, 1, 0);
					unk_0xCF39804E8C88080E(uParam0->f_428[i], num3, 0f, uParam0->f_404 + num4, 2, 1);
					unk_0xEE0BCDB1B5E36BCB(uParam0->f_428[i], 1, 0);
					unk_0x935364B4448CD584(uParam0->f_428[i], 1, 0);
					unk_0x44C48AC14D3C09ED(uParam0->f_428[i], 0, 0);
					unk_0xBF861D73D95BF415(uParam0->f_428[i], 0);
			...
			else if (!unk_0xFC8BFE4B41177C22(uParam0->f_428[i]))
			{
				unk_0x51C8BEA2005931AB(&uParam0->f_428[i]);
			}
		}
...
void func_417(var uParam0) // Position - 0x1FEC5
{
	unk_0x88F483FBD433696A(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	unk_0x330108B080A2132F(uParam0->f_415 + 1);
	unk_0xE6B753D52F4CA222();
...
BOOL func_418(int iParam0) // Position - 0x1FEE9
{
	return Global_44181 == iParam0;
}

BOOL func_419(int iParam0) // Position - 0x1FEF7
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_420(BOOL bParam0) // Position - 0x1FF24
{
	if (bParam0)
		Global_113156 = 0;
	else
...
void func_421(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1FF3E
{
	if (bParam2)
		unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_1.f_120[iParam0], iParam1);
	else
		unk_0x8744D2E3FC95740E(&Global_114135.f_1.f_120[iParam0], iParam1);

	unk_0x0B0C9A0F9AAEB7F0(&Global_97671, iParam0);
	return;
}

void func_422(var uParam0, int iParam1) // Position - 0x1FF7C
{
	var unk;
	var unk4;

	*uParam0 = iParam1;
	unk = { Global_97609[uParam0->f_1.f_1 /*15*/].f_3 };
	unk4 = Global_97609[uParam0->f_1.f_1 /*15*/].f_6;
	uParam0->f_401 = { unk };
	uParam0->f_404 = unk4;
...
void func_423(var uParam0, var uParam1) // Position - 0x20049
{
	func_433(uParam0, 0, "HEIST_FINALE", "BOARD6", "FHFAUD", "CRWAUD", 1, 1, 3, 4, uParam1, 96.47825f, -1292.3529f, 29.768753f, 5f, 5.5f, 6f);
	func_432(uParam0, 1500, 540, 3.45f, 1.34f, 3.18f, 1.79f, 2.58f, 747, 260, 620, 442, 490, 445, 360, 438, 230, 440, 100, 435, 872, 398, 20, 40, 1150, 415);
	func_431(uParam0, 18f, 17f, 19f);
	func_430(uParam0, "", "", "", "", "FHP16", "", "FHP17", "FHP19");
	func_429(uParam0, 1, "CRW_GM", "");
	func_429(uParam0, 2, "CRW_KA", "");
	func_429(uParam0, 3, "CRW_HW", "");
	func_429(uParam0, 4, "CRW_NR", "");
	func_429(uParam0, 5, "CRW_DJ", "");
	func_429(uParam0, 6, "CRW_PH", "");
	func_429(uParam0, 7, "CRW_CF", "");
	func_429(uParam0, 8, "CRW_ET", "");
	func_429(uParam0, 9, "CRW_KD", "");
	func_429(uParam0, 10, "CRW_PM", "CRM_PM");
	func_429(uParam0, 11, "", "CRM_CH");
	func_429(uParam0, 12, "CRW_RL", "CRM_RL");
	func_429(uParam0, 13, "CRW_TM", "CRM_TM");
	func_428(uParam0, 24, "FHP18");
	func_428(uParam0, 25, "FHP18b");
	func_428(uParam0, 28, "FHP18c");
	func_428(uParam0, 29, "FHP18d");
	func_428(uParam0, 30, "FHP18e");
	func_428(uParam0, 26, "FHP18f");
	func_428(uParam0, 27, "FHP18g");
	func_428(uParam0, 31, "FHP18h");
	func_428(uParam0, 22, "FHP18i");
	func_428(uParam0, 23, "FHP18j");
	func_428(uParam0, 20, "FHP18k");
	func_427(uParam0, 0, 1, 0, 0);
	func_427(uParam0, 1, 1, 0, 0);
	func_427(uParam0, 2, 1, 0, 0);
	func_427(uParam0, 3, 1, 0, 0);
	func_427(uParam0, 4, 1, 0, 0);
	func_427(uParam0, 5, 1, 0, 0);
	func_427(uParam0, 6, 1, 0, 0);
	func_427(uParam0, 7, 1, 0, 0);
	func_427(uParam0, 8, 1, 0, 0);
	func_427(uParam0, 9, 1, 0, 0);
	func_427(uParam0, 10, 1, 0, 0);
	func_427(uParam0, 11, 1, 0, 0);
	func_427(uParam0, 12, 1, 0, 0);
	func_427(uParam0, 13, 1, 0, 0);
	func_427(uParam0, 14, 1, 0, 0);
	func_427(uParam0, 15, 1, 0, 0);
	func_427(uParam0, 16, 1, 0, 0);
	func_427(uParam0, 17, 1, 0, 0);
	func_427(uParam0, 18, 1, 0, 0);
	func_427(uParam0, 19, 1, 0, 0);
	func_427(uParam0, 20, 1, 0, 0);
	func_427(uParam0, 21, 1, 0, 0);
	func_426(uParam0, 0, 0, "H_TD_RES" /*Research repository*/);
	func_426(uParam0, 0, 0, "H_TD_FLY" /*Flyover area*/);
	func_426(uParam0, 0, 2, "H_TD_PLAN" /*Decide approach*/);
	func_426(uParam0, 0, 10, "H_TD_CREW" /*Pick crew*/);
	func_426(uParam0, 3, 5, "H_TD_STNG" /*Police stingers*/);
	func_426(uParam0, 3, 6, "H_TD_CARS" /*Modded Vehicles*/);
	func_426(uParam0, 4, 7, "H_TD_DRIL" /*Drilling machine*/);
	func_426(uParam0, 4, 8, "H_TD_TRAI" /*Get a train*/);
	func_426(uParam0, 4, 9, "H_TD_GETA" /*Getaway Vehicle*/);
	func_425(uParam0, 1, 142, 72);
	func_425(uParam0, 1, 134, 244);
	func_425(uParam0, 1, 262, 54);
	func_425(uParam0, 1, 334, 206);
	func_425(uParam0, 1, 547, 65);
	func_425(uParam0, 1, 550, 200);
	func_425(uParam0, 1, 453, 54);
	func_425(uParam0, 1, 492, 242);
	func_425(uParam0, 1, 731, 179);
	func_425(uParam0, 1, 685, 81);
	func_425(uParam0, 1, 828, 79);
	func_425(uParam0, 1, 982, 167);
	func_425(uParam0, 1, 1155, 70);
	func_425(uParam0, 1, 1293, 60);
	func_425(uParam0, 1, 1254, 191);
	func_425(uParam0, 1, 1433, 84);
	func_425(uParam0, 1, 1469, 172);
	func_425(uParam0, 1, 952, 367);
	func_425(uParam0, 1, 967, 469);
	func_425(uParam0, 1, 1246, 374);
	func_424(uParam0, 1, "FHP9", 777, 165, true);
	func_424(uParam0, 1, "FHP10", 970, 179, true);
	func_424(uParam0, 1, "FHP11", 1210, 184, true);
	func_424(uParam0, 1, "FHP12", 537, 168, false);
	func_424(uParam0, 1, "FHP13", 579, 229, true);
	func_424(uParam0, 1, "FHP14", 355, 228, true);
	func_424(uParam0, 1, "FHP15", 350, 117, true);
	return;
}

void func_424(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x20503
{
	var unk;
...
void func_425(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2057C
{
	if (uParam0->f_33 < 20)
	{
...
void func_426(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0x205C0
{
	var unk;
...
void func_427(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20610
{
	if (uParam0->f_117 < 22)
	{
...
void func_428(var uParam0, int iParam1, char* sParam2) // Position - 0x20660
{
	var unk;
...
void func_429(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0x2068B
{
	var unk;
	var unk3;
...
void func_430(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0x20724
{
	var unk;
	var unk5;
	var unk9;
...
void func_431(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x207C8
{
	uParam0->f_9 = fParam1;
...
void func_432(var uParam0, int iParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, int iParam25) // Position - 0x207E2
{
	uParam0->f_2 = iParam1;
	uParam0->f_3 = iParam2;
	uParam0->f_4 = fParam3;
...
void func_433(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x208B0
{
	uParam0->f_1 = iParam1;
...
var func_434(var uParam0, var uParam1) // Position - 0x2091C
{
	if (uParam0 > uParam1)
		return uParam0;
...
int func_435(int iParam0) // Position - 0x20932
{
	int num;
	int num2;
...
void func_436() // Position - 0x20989
{
	while (!func_437(&uLocal_180))
	{
		SYSTEM::WAIT(0);
	}
...
BOOL func_437(var uParam0) // Position - 0x20A37
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_406(uParam0);
