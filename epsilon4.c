...
void main() // Position - 0x0
{
	...
	fLocal_156 = 24.0044f;
	iLocal_157 = joaat("WEAPON_DIGISCANNER");
	uLocal_158 = unk_0xA0A2925EDC6DDA6D(iLocal_157);
	sLocal_159 = "empty";
	iLocal_337 = 1;
	iLocal_762 = -1;
	iLocal_763 = -1;
	...
	uLocal_160 = func_411();
	uLocal_161 = func_410(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_762 = unk_0x8CC50AC10D8037C7(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, 0, 7);
	iLocal_763 = unk_0x8CC50AC10D8037C7(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, 0, 7);
	iLocal_764 = unk_0x8CC50AC10D8037C7(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, 0, 7);
	...
	uLocal_358 = unk_0x5F3592B356EE3A4C(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_406();
	func_389();
	func_388();
	iLocal_770 = 0;
	...
	while (true)
	{
		...
		{
			if (func_353(unk_0x4A8C381C258A124D()) == iLocal_157)
			{
...
void func_1() // Position - 0x3FD
{
	...
	switch (iLocal_770.f_1)
	{
		case 0:
			...
			if (unk_0x1B79E937E91F40C3(str, sLocal_159))
				func_425(true);
			else
				func_7(str, true);
...
void func_2(var uParam0) // Position - 0x4E3
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	func_3(uParam0);
...
void func_3(var uParam0) // Position - 0x4FB
{
...
void func_5(var uParam0) // Position - 0x565
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_11() // Position - 0x651
{
	...
	while (func_353(unk_0x4A8C381C258A124D()) == iLocal_157)
	{
		SYSTEM::WAIT(0);
		unk_0x4EB223432F8FA0A0(2);
		...
		if (unk_0xE100DD4F82A51BDE("weapons@holster_1h"))
			if (!unk_0x13CCB1AD131C1082(unk_0x4A8C381C258A124D(), "weapons@holster_1h", "holster", 3))
				unk_0x10425721983AE158(unk_0x4A8C381C258A124D(), "weapons@holster_1h", "holster", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
...
int func_12(int iParam0, int iParam1) // Position - 0x770
{
	int num;
...
BOOL func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x7C1
{
	...
	if (Global_114135.f_7692.f_866 < 10)
	{
		num = iParam0;
		...
		Global_114135.f_7692.f_765[Global_114135.f_7692.f_866 /*10*/] = { num };
	...
	else
	{
		...
		num2 = 0;
		func_19(&num2);
		num3 = func_18(unk10, Global_114135.f_7692.f_765[num2 /*10*/]);
	
		if (num3 == 2)
		{
			func_16(Global_114135.f_7692.f_765[num2 /*10*/]);
			Global_114135.f_7692.f_765[num2 /*10*/] = { unk10 };
			func_15(&unk10);
			return true;
		}
		else if (num3 == 1)
		{
			...
			{
				if (!func_14(Global_114135.f_7692.f_765[num2 /*10*/]))
				{
					Global_114135.f_7692.f_765[num2 /*10*/] = { unk10 };
					func_15(&unk10);
					return true;
...
void func_19(var uParam0) // Position - 0xA95
{
	...
	*uParam0 = 0;
	...
	{
		if (func_18(Global_114135.f_7692.f_765[i /*10*/], Global_114135.f_7692.f_765[*uParam0 /*10*/]) == 0)
			*uParam0 = i;
	}
...
void func_25() // Position - 0xE14
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114135.f_10198.f_3853))
		func_12(13, SYSTEM::FLOOR(Global_114135.f_10198.f_3853));

	if (!unk_0xB00920C3C99A34C5())
	{
		if (!Global_79539)
		{
			if (func_26() == 2 == false && !unk_0x76CD105BCAC6EB9F())
			{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x12DD
{
	if (iParam2 == -1)
		iParam2 = func_28();
...
void func_39(var uParam0) // Position - 0x14BC
{
	int i;
	int j;
...
BOOL func_49(int iParam0, int iParam1, int iParam2) // Position - 0x1DA9
{
	int num;
	int i;
	var unk;
...
BOOL func_50(int iParam0, int iParam1, var uParam2) // Position - 0x1F66
{
	int num;
...
int func_51(int iParam0) // Position - 0x2007
{
	switch (iParam0)
	{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2042
{
	int i;
	int j;
	int k;
...
void func_53(int iParam0, int iParam1, int iParam2) // Position - 0x2853
{
	int num;
	int num2;
...
BOOL func_54(int iParam0, int iParam1, int iParam2) // Position - 0x28DD
{
	if (iParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_55(int iParam0, int iParam1, int iParam2) // Position - 0x29BB
{
	Global_79322[1 /*14*/] = { func_102(iParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_56(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x29E3
{
	var unk;
	int i;
...
BOOL func_57(int iParam0, int iParam1, int iParam2) // Position - 0x2FE7
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_58(var uParam0, int iParam1, int iParam2) // Position - 0x3080
{
	int i;
	int j;
...
BOOL func_59(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x3121
{
	int num;
...
int func_60(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3428
{
	int num;
	int num2;
	int num3;
...
BOOL func_61(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0x3FDB
{
	int num;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x42C0
{
	int num;
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4587
{
	int i;
	int num;
...
BOOL func_64(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x45BE
{
	int num;
...
BOOL func_65(int iParam0, int iParam1, var uParam2) // Position - 0x45E7
{
	*uParam2 = -99;
...
BOOL func_66(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x48B1
{
	int num;
...
int func_67(int iParam0, int iParam1, int iParam2) // Position - 0x4B3B
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_68(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4C92
{
	int num;
...
BOOL func_69(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4D2C
{
	switch (iParam0)
	{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4DFA
{
	var unk;
	int num;
	int num2;
...
int func_71(int iParam0, int iParam1) // Position - 0x4F14
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_72(int iParam0) // Position - 0x52BB
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x531C
{
	int num;
	int num2;
	int num3;
	...
	if (num2 != -1 && num2 != 0)
		if (num == joaat("MP_M_Freemode_01"))
			return func_75(unk_0x4B423FAA24E8ABF0(iParam0), num2, 14, 3);
		else if (num == joaat("MP_F_Freemode_01"))
			return func_75(unk_0x4B423FAA24E8ABF0(iParam0), num2, 14, 4);
	...
	for (i = 0; i <= num3 - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= num5 - 1; j = j + 1)
			{
				...
				{
					num4 = num4 + func_74(iParam0, iParam3);
					return num4;
				}
				else
				{
...
int func_74(var uParam0, int iParam1) // Position - 0x5418
{
	int num;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5556
{
	var unk;
	int i;
	int num;
...
int func_76(int iParam0) // Position - 0x5611
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_77(int iParam0) // Position - 0x5670
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_78(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x56F6
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_79(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5973
{
	if (iParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_80(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5D98
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_81(var uParam0, int iParam1) // Position - 0x608B
{
	int num;
	var unk;
...
int func_82(var uParam0, int iParam1) // Position - 0x60D2
{
	int num;
	var unk;
	var unk2;
...
int func_83(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x6132
{
	int num;
	int num2;
	int num3;
...
void func_85(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x6235
{
	int num;
	var unk;
	int num2;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x627D
{
	int num;
...
int func_87(int iParam0, int iParam1) // Position - 0x62AB
{
...
BOOL func_90(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x6323
{
	int value;
...
BOOL func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8F48
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_92(int iParam0) // Position - 0x9DEB
{
	if (!IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_93(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x9E33
{
	int num;
...
int func_94(int iParam0) // Position - 0x9EDE
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_95(int iParam0, int iParam1) // Position - 0x9F8E
{
	int i;
	var unk;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA8BD
{
	int num;
	var unk;
	int num2;
...
void func_97(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA9E7
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_98(int iParam0, int iParam1) // Position - 0xAA2F
{
	int i;
	var unk;
...
void func_99(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC879
{
	int num;
	var unk;
	int num2;
...
int func_100(int iParam0) // Position - 0xCA63
{
	switch (iParam0)
	{
		case 0:
...
void func_101(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCB13
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_102(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCB84
{
	func_166();
...
void func_103(int iParam0, int iParam1) // Position - 0xCBD6
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0) // Position - 0xCCC6
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xDF00
{
	int num;
	int num2;
...
BOOL func_106(int iParam0, int iParam1, var uParam2) // Position - 0xE2A1
{
	*uParam2 = 979;
...
int func_107(int iParam0, int iParam1) // Position - 0xE6A6
{
	switch (iParam1)
	{
		case 0:
...
int func_108(int iParam0, int iParam1) // Position - 0xEAA1
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_109(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xEE9C
{
	int num;
	int num2;
	int num3;
...
BOOL func_110(int iParam0) // Position - 0xEEDA
{
	return Global_44181 == iParam0;
}

int func_111(int iParam0) // Position - 0xEEE8
{
	switch (iParam0)
	{
		case -1:
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xEFBC
{
	int num;
	int unk;
	var unk2;
...
void func_113(int iParam0) // Position - 0xF242
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0xF38F
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0xF89C
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0xF910
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0xF983
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0xFA6A
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0xFDAC
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0xFFB4
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Position - 0x101F8
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x10301
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x10C93
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x117EB
{
	if (iParam0 < 136)
		func_126(iParam0);
	else
...
void func_125(int iParam0) // Position - 0x11820
{
	BOOL flag;
	int num;
	var unk;
...
void func_126(int iParam0) // Position - 0x12424
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Position - 0x13324
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Position - 0x13451
{
	BOOL flag;
	int num;
	var unk;
...
void func_129(int iParam0, int iParam1) // Position - 0x13548
{
	switch (iParam0)
	{
		case 0:
...
void func_130(int iParam0) // Position - 0x13638
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0) // Position - 0x14B06
{
	BOOL flag;
	int num;
	var unk;
...
void func_132(int iParam0) // Position - 0x14C4D
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Position - 0x15157
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Position - 0x157C0
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Position - 0x15833
{
	BOOL flag;
	int num;
	var unk;
...
void func_136(int iParam0) // Position - 0x15903
{
	BOOL flag;
	int num;
	var unk;
...
void func_137(int iParam0) // Position - 0x15DFE
{
	BOOL flag;
	int num;
	var unk;
...
void func_138(int iParam0) // Position - 0x15F8F
{
	BOOL flag;
	int num;
	var unk;
...
void func_139(int iParam0) // Position - 0x1677E
{
	BOOL flag;
	int num;
	var unk;
...
void func_140(int iParam0) // Position - 0x16887
{
	BOOL flag;
	int num;
	var unk;
...
void func_141(int iParam0) // Position - 0x177AA
{
	BOOL flag;
	int num;
	var unk;
...
void func_142(int iParam0) // Position - 0x18458
{
	if (iParam0 < 107)
		func_145(iParam0);
	else if (iParam0 < 227)
...
void func_143(int iParam0) // Position - 0x1849E
{
	BOOL flag;
	int num;
	var unk;
...
void func_144(int iParam0) // Position - 0x18F42
{
	BOOL flag;
	int num;
	var unk;
...
void func_145(int iParam0) // Position - 0x19D30
{
	BOOL flag;
	int num;
	var unk;
...
void func_146(int iParam0) // Position - 0x1A96F
{
	BOOL flag;
	int num;
	var unk;
...
void func_147(int iParam0) // Position - 0x1ABE7
{
	BOOL flag;
	int num;
	var unk;
...
void func_148(int iParam0, int iParam1) // Position - 0x1AD23
{
	switch (iParam0)
	{
		case 0:
...
void func_149(int iParam0) // Position - 0x1AE13
{
	BOOL flag;
	int num;
	var unk;
...
void func_150(int iParam0) // Position - 0x1BB71
{
	BOOL flag;
	int num;
	var unk;
...
void func_151(int iParam0) // Position - 0x1BCE0
{
	BOOL flag;
	int num;
	var unk;
...
void func_152(int iParam0) // Position - 0x1C252
{
	BOOL flag;
	int num;
	var unk;
...
void func_153(int iParam0) // Position - 0x1C77A
{
	BOOL flag;
	int num;
	var unk;
...
void func_154(int iParam0) // Position - 0x1C7ED
{
	BOOL flag;
	int num;
	var unk;
...
void func_155(int iParam0) // Position - 0x1C8BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_156(int iParam0) // Position - 0x1CD6D
{
	BOOL flag;
	int num;
	var unk;
...
void func_157(int iParam0) // Position - 0x1CFC8
{
	BOOL flag;
	int num;
	var unk;
...
void func_158(int iParam0) // Position - 0x1D288
{
	BOOL flag;
	int num;
	var unk;
...
void func_159(int iParam0) // Position - 0x1D443
{
	BOOL flag;
	int num;
	var unk;
...
void func_160(int iParam0) // Position - 0x1DF89
{
	BOOL flag;
	int num;
	var unk;
...
void func_161(int iParam0) // Position - 0x1EBBB
{
	if (iParam0 < 60)
		func_163(iParam0);
	else
...
void func_162(int iParam0) // Position - 0x1EBF0
{
	BOOL flag;
	int num;
	var unk;
...
void func_163(int iParam0) // Position - 0x1F983
{
	BOOL flag;
	int num;
	var unk;
...
void func_164(int iParam0) // Position - 0x20007
{
	BOOL flag;
	int num;
	var unk;
...
void func_165(int iParam0) // Position - 0x200ED
{
	BOOL flag;
	int num;
	var unk;
...
void func_166() // Position - 0x201E4
{
...
BOOL func_167(int iParam0, int iParam1, int iParam2) // Position - 0x2025C
{
	int num;
	int num2;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x204B5
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x204F2
{
...
int func_170(eCharacter echParam0) // Position - 0x20517
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_171(eCharacter echParam0) // Position - 0x20526
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_172(var uParam0, int iParam1) // Position - 0x20532
{
...
void func_174() // Position - 0x205C9
{
	eCharacter character;
...
struct<2> func_175(int iParam0) // Position - 0x206C6
{
	var unk;
	var unk3;
...
struct<2> func_176(int iParam0) // Position - 0x206FD
{
	var unk;
...
void func_177(int iParam0, int iParam1) // Position - 0x20B49
{
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20B93
{
...
void func_179(int iParam0, int iParam1, int iParam2) // Position - 0x20C30
{
	var unk;
	var unk33;
...
void func_180(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x20C6F
{
...
void func_181(int iParam0, var uParam1) // Position - 0x20CB3
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0) // Position - 0x21EF9
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0) // Position - 0x2223F
{
	Global_44732 = unk_0x1DD05E817C89C737() + iParam0;
	return;
}

void func_185() // Position - 0x22251
{
	if (Global_98975)
	{
		func_174();
...
char* func_186(eCharacter echParam0) // Position - 0x22283
{
	echParam0 = echParam0;
	return "";
}

void func_187() // Position - 0x22292
{
	var unk;
...
BOOL func_188() // Position - 0x222DF
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_189() // Position - 0x222F5
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_190(int iParam0, int iParam1) // Position - 0x2230B
{
...
void func_191() // Position - 0x2231F
{
	Global_79794 != 6;
...
void func_192(int iParam0) // Position - 0x22357
{
	if (*iParam0 == -1)
		return;
...
void func_193(int iParam0, BOOL bParam1) // Position - 0x22394
{
	var unk;
	int num;
	BOOL flag;
...
int func_194(int iParam0) // Position - 0x22511
{
	switch (iParam0)
	{
		case 0:
...
void func_195(int iParam0) // Position - 0x22898
{
...
int func_196() // Position - 0x228CE
{
	return Global_114135.f_10020.f_21 + Global_114135.f_18578.f_380;
}

void func_197(int iParam0, BOOL bParam1) // Position - 0x228EA
{
	int num;
	int num2;
	int num3;
...
void func_198(int iParam0) // Position - 0x22C0E
{
...
void func_199(int iParam0) // Position - 0x22C41
{
	switch (iParam0)
	{
		case 30:
...
void func_200(int iParam0, BOOL bParam1) // Position - 0x22C76
{
	if (iParam0 == -1)
		return;
...
void func_201(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22CD3
{
	if (iParam0 == -1)
		return;
...
BOOL func_202(int iParam0, int iParam1) // Position - 0x22D0E
{
	if (iParam0 == -1)
		return false;
...
void func_203(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x22D2E
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_204(int iParam0, int iParam1) // Position - 0x22D86
{
	switch (iParam0)
	{
		case 12:
...
void func_205(int iParam0, BOOL bParam1) // Position - 0x22E6F
{
	if (bParam1)
...
BOOL func_206(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x22E98
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_207() // Position - 0x237E7
{
...
int func_208() // Position - 0x23817
{
	return Global_33088;
}

int func_209(var uParam0, int iParam1) // Position - 0x23822
{
	int i;
...
int func_210(int iParam0) // Position - 0x26FBD
{
	switch (iParam0)
	{
		case 46:
...
void func_211(int iParam0, BOOL bParam1) // Position - 0x270AC
{
	switch (iParam0)
	{
		case 46:
...
void func_212(int iParam0, BOOL bParam1) // Position - 0x270FD
{
	int num;
...
void func_213(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x27163
{
	func_214(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_214(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x27184
{
	int i;
...
void func_215() // Position - 0x27357
{
	int i;
...
BOOL func_216(int iParam0) // Position - 0x2746E
{
	int num;
	int i;
...
void func_217(char* sParam0) // Position - 0x274AE
{
...
char* func_218(int iParam0) // Position - 0x274D2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_219(int iParam0) // Position - 0x276A5
{
...
BOOL func_220(const char* sParam0) // Position - 0x276CF
{
...
int func_221() // Position - 0x2772F
{
	return func_222(unk_0x1AF90EB93E0012D6(), 0);
}

int func_222(var uParam0, int iParam1) // Position - 0x27740
{
	int num;
	var unk;
	var unk33;
...
void func_223(BOOL bParam0) // Position - 0x27789
{
	if (bParam0)
	{
		func_230();
...
void func_224(int iParam0) // Position - 0x277EC
{
	if (func_228())
		return;
...
BOOL func_225() // Position - 0x27876
{
...
void func_226(BOOL bParam0, BOOL bParam1) // Position - 0x2789D
{
	if (bParam0)
	{
		if (func_229(0))
...
BOOL func_227() // Position - 0x27911
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_228() // Position - 0x2791F
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_229(int iParam0) // Position - 0x2792E
{
	if (iParam0 == 1)
...
void func_230() // Position - 0x27985
{
...
void func_231() // Position - 0x279AE
{
	unk_0x8E4825CCACA34B58(iLocal_623.f_2);
	unk_0x8E4825CCACA34B58(iLocal_623.f_3);
	unk_0x8E4825CCACA34B58(iLocal_623.f_4);
	unk_0x8E4825CCACA34B58(iLocal_623.f_5);
	iLocal_623.f_6 = 0;
	iLocal_623.f_7 = 0;
	return;
}

void func_232(int iParam0) // Position - 0x279E6
{
	BOOL flag;
	int i;
...
void func_233() // Position - 0x27A57
{
	switch (iLocal_770.f_1)
	{
		case 0:
			...
			unk_0x4EB223432F8FA0A0(2);
			unk_0x4F07124B9C56ED6F(unk_0x4A8C381C258A124D(), iLocal_157);
			iLocal_770.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (unk_0x1C2F771CDC87A3A5(uLocal_604[0 /*8*/], 0))
			{
				func_243(6);
				iLocal_770.f_9 = 2;
				iLocal_770.f_1 = 3;
			}
			else if (unk_0x1C2F771CDC87A3A5(uLocal_604[1 /*8*/], 0))
			{
				func_243(6);
				iLocal_770.f_9 = 3;
				iLocal_770.f_1 = 3;
			}
			else if (unk_0x9B3D4335E0EDB0BE(uLocal_604[0 /*8*/], unk_0x4A8C381C258A124D(), 1) && unk_0x1AC621DBDFE4ECA0(uLocal_604[0 /*8*/], 0, 2))
			{
				func_243(6);
				iLocal_770.f_9 = 4;
				iLocal_770.f_1 = 3;
			}
			else if (unk_0x9B3D4335E0EDB0BE(uLocal_604[1 /*8*/], unk_0x4A8C381C258A124D(), 1) && unk_0x1AC621DBDFE4ECA0(uLocal_604[1 /*8*/], 0, 2))
			{
				func_243(6);
				iLocal_770.f_9 = 5;
				iLocal_770.f_1 = 3;
			...
			{
				if (func_234(unk_0x4A8C381C258A124D(), uLocal_604[0 /*8*/], 1) >= 50f)
				{
...
float func_234(var uParam0, var uParam1, int iParam2) // Position - 0x27C7A
{
	var unk;
	var unk4;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0x27CD8
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_236(var uParam0) // Position - 0x27CF9
{
...
BOOL func_237(int iParam0, int iParam1, int iParam2) // Position - 0x27D1A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
	{
		...
		if (func_238(iParam0, iParam2, false, false))
			return true;
	}
...
BOOL func_238(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27D52
{
	float num;
	float num2;
...
BOOL func_239(int iParam0, int iParam1) // Position - 0x27E5E
{
	var unk;
	var unk2;

	if (unk_0xF67924A428A734EC(iParam0, joaat("WEAPON_GRENADE"), iParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(iParam0, joaat("WEAPON_SMOKEGRENADE"), iParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(iParam0, joaat("WEAPON_BZGAS"), iParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(iParam0, joaat("WEAPON_STICKYBOMB"), iParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(iParam0, joaat("WEAPON_MOLOTOV"), iParam1, &unk2, &unk, 0))
		if (func_240(iParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_240(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x27EF3
{
	var unk;
	var unk4;
	float num;

	unk = { func_242(uParam1 - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	if (iParam5 == 0)
		...
		unk4 = { func_242(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };

	num = func_241(unk4, unk);
...
float func_241(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x27F81
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_242(float fParam0, var uParam1, var uParam2) // Position - 0x27FA2
{
	float num;
	float num2;
...
void func_243(int iParam0) // Position - 0x27FE1
{
	iLocal_770.f_8 = iParam0;
	return;
}

void func_244() // Position - 0x27FF0
{
	var unk;
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (!func_294(iLocal_360))
		{
			iLocal_360 = unk_0x5779387E956077A6(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1, 0);
			unk_0xD133EF7430EDCD09(iLocal_360, 157, 157);
			unk_0xBB361D7264AC4FD8(iLocal_360, 5, 157);
			unk_0x1DE99C193C7EC64B(iLocal_360, 1084227584);
		}
		...
		if (func_354(unk_0x4A8C381C258A124D()))
		{
			...
			while (unk_0x1DD05E817C89C737() - unk < 500)
			{
			...
			if (iLocal_351 == 0)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
					unk_0xF293D66D4452C854(uLocal_604[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
					unk_0xF293D66D4452C854(uLocal_604[0 /*8*/], "Marnie", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
					unk_0xF293D66D4452C854(unk_0x4A8C381C258A124D(), "Michael", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_623))
				{
					iLocal_639 = func_276(unk_0x4A8C381C258A124D(), joaat("WEAPON_DIGISCANNER"), 1, false, 0, 0, 0, 0, 0);
					unk_0xF293D66D4452C854(iLocal_639, "Artefact_Detector", 0, 0, 0);
				}
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					unk_0xF293D66D4452C854(uLocal_361[iLocal_351 /*43*/].f_1, "EPS_TV", 0, 0, 0);
			}
			else if (iLocal_351 == 1)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					unk_0xF293D66D4452C854(uLocal_361[iLocal_351 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
			}
			else
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					unk_0xF293D66D4452C854(uLocal_361[iLocal_351 /*43*/].f_1, "Old_Boot", 0, 0, 0);
			}
			...
			while (unk_0x1DD05E817C89C737() - unk < 1)
			{
				unk_0x4EB223432F8FA0A0(2);
				SYSTEM::WAIT(0);
				unk_0xECF30459397D5190("SF_Epsilon4", 0);
			...
			if (iLocal_351 >= 2)
				if (unk_0xFD216000DC314A92())
					if (unk_0x15EF8F22A719BE5E() > 17000)
						if (!unk_0x787F8EE1F6FBDC6D())
							unk_0xAC48F8E2BF2BEBF7(1847.4722f, 4756.157f, 36.6968f, func_260(271.4718f), 145f, 0);
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2872A
{
	var unk;
	...
	func_246(false, true, false, 0, false, false, false);
...
void func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x287D4
{
	if (bParam0)
	{
...
BOOL func_247() // Position - 0x28923
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_248(int iParam0, int iParam1) // Position - 0x2893D
{
	BOOL flag;
...
int func_249(int iParam0, BOOL bParam1) // Position - 0x28996
{
	int num;
	int num2;
...
BOOL func_250(int iParam0) // Position - 0x289D7
{
	int num;
...
BOOL func_251(int iParam0) // Position - 0x289F9
{
...
BOOL func_252() // Position - 0x28A38
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_253(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x28A46
{
	int num;
...
void func_254(int iParam0) // Position - 0x28A79
{
	if (iParam0 == 1)
...
void func_255() // Position - 0x28A9C
{
	unk_0x88F483FBD433696A(uLocal_163, "SET_COLOUR");
	...
	unk_0x88F483FBD433696A(uLocal_163, "SET_DISTANCE");
	unk_0x74BF156C860580D4(10f);
	unk_0xE6B753D52F4CA222();
	unk_0x61055542D9D877AE(uLocal_164);
	unk_0x6D16B99FEB0AFFF1(uLocal_163, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	return;
}

BOOL func_256() // Position - 0x28B28
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Michael", 0))
		{
			...
			else
			{
				...
				if (func_353(unk_0x4A8C381C258A124D()) != iLocal_157)
					unk_0xB41DEC3AAC1AA107(unk_0x4A8C381C258A124D(), iLocal_157, -1, 1, 1);
...
void func_257() // Position - 0x28BA6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Jimmy_Boston", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[1]) && func_294(iLocal_360))
				{
					unk_0xB5396F1FB088FE38(&uLocal_780);
					unk_0x6CB88242CC3DA778(0, iLocal_360, 0);
					unk_0x93C0674FC00824D0(uLocal_780);
					unk_0x4BD42B0527065BB6(uLocal_81.f_28[1], uLocal_780);
					unk_0xD0557B139A542F12(&uLocal_780);
					_DEBUG_PRINT("Did Jimmy pass exit");
				}
			}
			else
			{
				unk_0x63C8DCBEC1CF8225(uLocal_81.f_28[1], 1764.089f, 4665.8794f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				_DEBUG_PRINT("Did Jimmy regular exit");
			}
		
			unk_0x717804C8C8DA67BF(uLocal_604[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
...
void func_258() // Position - 0x28C62
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Marnie", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]) && func_294(iLocal_360))
				{
					unk_0xB5396F1FB088FE38(&uLocal_780);
					unk_0x6CB88242CC3DA778(0, iLocal_360, -1);
					unk_0xCF6CC9EA0D2EFE23(0, iLocal_360, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					unk_0x7C8E9DE09D4AD3FF(0, iLocal_360, 30f, 262275);
					unk_0x93C0674FC00824D0(uLocal_780);
					unk_0x4BD42B0527065BB6(uLocal_81.f_28[0], uLocal_780);
					unk_0xD0557B139A542F12(&uLocal_780);
			...
			{
				unk_0xA966E518B752B92A(uLocal_81.f_28[0], unk_0x0D1381B6E0F3987D(uLocal_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
				_DEBUG_PRINT("Did Marnie regular exit");
			}
		
			unk_0x717804C8C8DA67BF(uLocal_604[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
		}
	}
...
void func_259() // Position - 0x28D57
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_639))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Artefact_Detector", 0))
		{
			if (iLocal_351 < 2)
			{
				...
				unk_0x4693060C5049F4E3(iLocal_639, unk_0x4A8C381C258A124D());
				func_5(&iLocal_639);
			
				if (!unk_0xFC8BFE4B41177C22(iLocal_623))
				{
					_DEBUG_PRINT("*** Recreating gDetector.hObj after cutscene...");
					iLocal_623 = unk_0x484426882F80CACE(unk_0x4A8C381C258A124D(), 1);
				}
			}
			else
			{
...
Vector3 func_260(float fParam0) // Position - 0x28DC7
{
	return -SYSTEM::SIN(fParam0), SYSTEM::COS(fParam0), 0f;
}

BOOL func_261() // Position - 0x28DDD
{
	if (unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
	{
		func_243(6);
...
void func_262(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x28EF7
{
	var unk;
...
void func_263(int iParam0, BOOL bParam1) // Position - 0x290B5
{
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x290F1
{
	return unk_0xD1A6A821F5AC81DB(unk_0x56E414973C2A8C0E(uParam0), 0);
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x29104
{
	func_174();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_266(BOOL bParam0) // Position - 0x2911D
{
	var unk;
	...
	func_246(true, true, false, 0, false, false, false);
	return;
}

void func_267(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x2915C
{
	func_268(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x29186
{
	var unk;
	BOOL flag;
	BOOL flag2;
		...
		if (unk_0xD9F5E1FEFD1329E4(unk, 0))
		{
			...
			else
			{
				...
				if (unk7.f_2 > uParam0.f_2 && unk7.f_2 < uParam3.f_2 || unk7.f_2 > uParam3.f_2 && unk7.f_2 < uParam0.f_2)
					if (func_272(unk, uParam0, uParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_270(unk, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2957C
{
...
BOOL func_270(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x295A6
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; func_271(echParam1, i, &unk, &num); i = i + 1)
	{
...
BOOL func_271(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29614
{
...
BOOL func_272(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x296EC
{
	float num;
	var unk3;
	var unk6;
...
BOOL func_273(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x299E2
{
	float num;
	float num2;
	float num3;
...
void func_274(var uParam0) // Position - 0x29A96
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
Vector3 func_275() // Position - 0x29AFB
{
	return 2.55f, 5.665f, 2.55f;
}

int func_276(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x29B12
{
	int num;
	int num2;
	int num3;
	...
	while (func_280(num3, num6) != 0)
	{
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
			if (unk_0x5EDED4B3E1A48E68(uParam0, num3, func_280(num3, num6)))
				if (func_279(func_280(num3, num6)))
					unk4 = unk_0xB39F6B1C186F538E(func_280(num3, num6));
	...
	while (func_280(num3, num7) != 0)
	{
		if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
		{
			if (unk_0x5EDED4B3E1A48E68(uParam0, num3, func_280(num3, num7)))
			{
				unk_0x93A0B91D4456D7E9(num2, func_280(num3, num7));
				func_277(num2, func_280(num3, num7));
			}
		}
...
void func_277(var uParam0, int iParam1) // Position - 0x29C86
{
	int num;

	num = func_278(iParam1);
...
int func_278(int iParam0) // Position - 0x29CA4
{
	switch (iParam0)
	{
...
BOOL func_279(int iParam0) // Position - 0x29E3B
{
...
int func_280(int iParam0, int iParam1) // Position - 0x2A04B
{
	int num;
	int num2;
	int i;
...
BOOL func_281(int iParam0) // Position - 0x2ADCC
{
	switch (iParam0)
	{
...
int func_282(int iParam0, var uParam1) // Position - 0x2AE6D
{
	int i;
	int num;
...
BOOL func_283(int iParam0, int iParam1, int iParam2) // Position - 0x2AEA8
{
	int num;
	...
	if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
	{
		...
		{
			if (!func_290(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), iParam1, 1, 1056964608, 0, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
...
BOOL func_284() // Position - 0x2AF7C
{
	BOOL flag;
...
void func_285() // Position - 0x2AF9F
{
	Global_21291 = 0;
	func_286();
	return;
...
void func_286() // Position - 0x2AFAF
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2B006
{
...
void func_288() // Position - 0x2B028
{
	unk_0x66EFB3D6110055C4(0, 21, 1);
...
BOOL func_289(var uParam0, int iParam1) // Position - 0x2B079
{
	if (func_354(uParam0))
...
BOOL func_290(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2B0AC
{
...
void func_291(var uParam0) // Position - 0x2B103
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_292(BOOL bParam0, BOOL bParam1) // Position - 0x2B12F
{
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x2B280
{
	if (func_354(*uParam0))
	{
		uParam0->f_1 = 3;
...
BOOL func_294(int iParam0) // Position - 0x2B2E9
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
...
void func_295() // Position - 0x2B313
{
	unk_0x88F483FBD433696A(uLocal_163, "SET_COLOUR");
...
void func_296(int iParam0) // Position - 0x2B39D
{
	if (iParam0 == 1)
	{
		if (func_297())
		{
			if (unk_0x1B79E937E91F40C3(iLocal_623.f_14, "NO_RECENT_ANIM") || !unk_0x13CCB1AD131C1082(iLocal_623, "rcm_epsilonism4", iLocal_623.f_14, 3) || unk_0x82E64DE58A6B84A8(iLocal_623, "rcm_epsilonism4", iLocal_623.f_14) >= 0.98f)
			{
				if (fLocal_638 > 80f)
					iLocal_623.f_14 = "detector_level3_prop";
				else if (fLocal_638 > 50f)
					iLocal_623.f_14 = "detector_level2_prop";
				else
					iLocal_623.f_14 = "detector_level1_prop";
			
				unk_0x5ED9595F4AC7D134(iLocal_623, iLocal_623.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
			}
		}
	}
	else if (func_297())
	{
		if (!unk_0x1B79E937E91F40C3(iLocal_623.f_14, "NO_RECENT_ANIM"))
		{
			if (unk_0x13CCB1AD131C1082(iLocal_623, "rcm_epsilonism4", iLocal_623.f_14, 1))
			{
				if (unk_0x82E64DE58A6B84A8(iLocal_623, "rcm_epsilonism4", iLocal_623.f_14) <= 0.05f)
				{
					unk_0x1D949F0AD44C7F05(iLocal_623, iLocal_623.f_14, "rcm_epsilonism4", -4f);
					iLocal_623.f_14 = "NO_RECENT_ANIM";
				}
			}
		}
	}
...
BOOL func_297() // Position - 0x2B4B1
{
	if (unk_0xFC8BFE4B41177C22(iLocal_623))
		return true;
...
void func_298(char* sParam0, int iParam1) // Position - 0x2B4C8
{
	sParam0 = sParam0;
	iParam1 = iParam1;
	return;
...
void func_299(int iParam0, int iParam1, int iParam2) // Position - 0x2B4D8
{
...
void func_300(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B50C
{
	var unk;
	int i;
...
void func_301(int iParam0, var uParam1, int iParam2) // Position - 0x2B5C7
{
	int i;
	var unk;
	var unk2;
	...
	for (i = 0; i < 12; i = i + 1)
	{
		...
		{
			if (func_59(num, func_100(i), func_83(iParam0, unk2.f_13[i], unk2[i], func_100(i)), &unk))
			{
				unk67 = { func_102(num, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
				num2 = 1;
			}
		
			if (func_66(num, func_100(i), func_83(iParam0, unk2.f_13[i], unk2[i], func_100(i)), &unk))
			{
				unk67 = { func_102(num, 1, uParam1->f_62, -1) };
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		{
			if (func_59(num, 14, func_73(iParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_102(num, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
			...
			if (func_66(num, 14, func_73(iParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_102(num, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = unk67.f_3;
				uParam1->[1] = unk67.f_4;
	...
	if (num3 || num2)
	{
		num4 = func_83(iParam0, uParam1->f_13[1], uParam1->[1], 1);
		num5 = func_83(iParam0, uParam1->f_13[2], uParam1->[2], 2);
		num6 = func_67(num, num5, num4);
	
		if (num6 != -99)
		{
			unk67 = { func_102(num, 0, num6, -1) };
...
void func_302(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B83C
{
	eCharacter character;
	int i;
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		for (i = 0; i < 12; i = i + 1)
		{
			func_306(iParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = 0; i < 9; i = i + 1)
		{
			func_305(iParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
BOOL func_303(int iParam0, int iParam1) // Position - 0x2B9D6
{
	var unk;
	BOOL num;

	unk = func_304(iParam0, iParam1);
...
var func_304(int iParam0, int iParam1) // Position - 0x2B9FA
{
	return unk_0xD69CE161FE614531(2, iParam0, func_88(iParam1));
}

void func_305(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x2BA0F
{
	eCharacter character;
...
void func_306(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x2BF58
{
	eCharacter character;
...
void func_307(char* sParam0) // Position - 0x2C19A
{
	func_246(true, true, false, 0, false, false, false);
...
void func_308(BOOL bParam0, BOOL bParam1) // Position - 0x2C1B5
{
	if (bParam0)
		func_309(false, 1, 1);
...
void func_309(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2C1E8
{
	BOOL flag;
...
void func_310() // Position - 0x2C247
{
	int i;
	var unk;
	var unk2;
	...
	if (iLocal_770.f_3 == 1)
	{
		...
		if (iLocal_351 == 0)
		{
			if (!func_342())
			{
				unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), uLocal_145, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), fLocal_148);
			}
			...
			{
				unk_0x5D7CD709B34C90F0(uLocal_81.f_28[1], 0);
				unk_0xB2BD5837A8D3CEDA(uLocal_604[1 /*8*/], 1829.75f, 4693.5f, 38.51f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_604[1 /*8*/], 27.46f);
				unk2 = { unk_0xD1A6A821F5AC81DB(uLocal_604[1 /*8*/], 1) };
				unk_0xB1EAADCB692D69CE(1829.75f, 4693.5f, 38.51f, &unk, 0, 0);
				unk_0xB2BD5837A8D3CEDA(uLocal_604[1 /*8*/], unk2, unk2.f_1, unk, 1, 0, 0, 1);
				_DEBUG_PRINT("Setting Jimmy position (0)");
			}
		
			if (func_354(uLocal_604[0 /*8*/]))
			{
				unk_0xB2BD5837A8D3CEDA(uLocal_604[0 /*8*/], 1827.32f, 4692.59f, 38.53f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_604[0 /*8*/], 171.22f);
				_DEBUG_PRINT("Setting Marnie position (0)");
			}
		}
		else if (iLocal_351 == 1)
		{
			unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), 1754.6337f, 4675.7886f, 42.9068f, 1, 0, 0, 1);
			unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), 293.2275f);
		
			if (func_354(uLocal_604[1 /*8*/]))
			{
				unk_0xB2BD5837A8D3CEDA(uLocal_604[1 /*8*/], 1758.5857f, 4670.0854f, 42.6276f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_604[1 /*8*/], 262.4368f);
				_DEBUG_PRINT("Setting Jimmy position (1)");
			}
		
			if (func_354(uLocal_604[0 /*8*/]))
			{
				unk_0xB2BD5837A8D3CEDA(uLocal_604[0 /*8*/], 1759.9169f, 4683.584f, 42.7266f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_604[0 /*8*/], 148.3211f);
				_DEBUG_PRINT("Setting Marnie position (1)");
			}
		}
		else if (iLocal_351 == 2)
		{
			unk_0xB2BD5837A8D3CEDA(unk_0x4A8C381C258A124D(), 1758.4542f, 4829.4307f, 39.729f, 1, 0, 0, 1);
			unk_0x5C96CEA06531AB03(unk_0x4A8C381C258A124D(), 168.2012f);
		
			if (func_354(uLocal_604[0 /*8*/]))
			{
				unk_0xB2BD5837A8D3CEDA(uLocal_604[0 /*8*/], 1755.0052f, 4827.329f, 40.0736f, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(uLocal_604[0 /*8*/], 169.6486f);
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		iLocal_751 = 0;
		iLocal_752 = 0;
		uLocal_753 = unk_0x1DD05E817C89C737();
		uLocal_755 = unk_0x1DD05E817C89C737();
		iLocal_756 = 0;
		...
		if (iLocal_351 == 0)
		{
			...
			if (func_354(uLocal_604[1 /*8*/]))
			{
				unk_0x4F07124B9C56ED6F(uLocal_604[1 /*8*/], iLocal_157);
				unk_0xA966E518B752B92A(uLocal_604[1 /*8*/], 1826.2458f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
		...
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_166, 0, unk_0x4A8C381C258A124D(), "MICHAEL", 0, 1);
		...
		if (iLocal_351 == 0)
			iLocal_359 = uLocal_604[1 /*8*/];
		else
			iLocal_359 = uLocal_604[0 /*8*/];
		...
		iLocal_745 = 0;
		unk_0x428C32CC68809A35(1);
		uLocal_356 = unk_0x1DD05E817C89C737();
		iLocal_745 = unk_0x1DD05E817C89C737() + 1000;
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		else if (!func_335(&uLocal_692, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
		{
			func_243(6);
			iLocal_770.f_9 = 8;
			iLocal_770.f_1 = 3;
		...
		else
		{
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_361[iLocal_351 /*43*/].f_1))
			{
				if (iLocal_351 == 0)
				{
					if (func_234(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_1, 1) < 100f)
					{
						if (!unk_0x0DDDD9D153BCF51F())
						{
					...
					else if (func_234(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_1, 1) > 120f)
					{
						if (unk_0x0DDDD9D153BCF51F())
						{
				...
				else if (func_234(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_1, 1) < 100f)
				{
					if (!unk_0x0DDDD9D153BCF51F())
					{
			...
			if (iLocal_351 == 0)
			{
				if (iLocal_744 == 0)
				{
					if (iLocal_745 < unk_0x1DD05E817C89C737())
					{
						if (!func_355())
						{
							func_330("EPS4_T0");
							iLocal_745 = unk_0x1DD05E817C89C737() + 7500;
							iLocal_744 = iLocal_744 + 1;
							uLocal_757 = unk_0x1DD05E817C89C737();
						}
						else
						{
							iLocal_744 = 2;
				...
				{
					if (unk_0x875A214D5EBCA509(0, 25) || iLocal_745 < unk_0x1DD05E817C89C737())
					{
						unk_0x428C32CC68809A35(1);
						iLocal_745 = unk_0x1DD05E817C89C737() + 1000;
						iLocal_744 = iLocal_744 + 1;
			...
			func_296(iLocal_623.f_1);
		
			if (iLocal_337 == 1)
			{
				func_329(&iLocal_162);
			
				if (!func_335(&uLocal_640, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)))
				{
					iLocal_337 = 0;
					unk_0x0F15249D24BC5ADA(0);
					unk_0x406CBCEA35499884();
				...
				{
					if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_36, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_36, sLocal_159))
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_359))
								unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 10000, 0, 2);
				...
				{
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500)
					{
						if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_37, sLocal_159) || !unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_37, sLocal_159))
								if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iLocal_359))
									unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 5000, 0, 2);
				...
				else if (iLocal_340 == 0)
				{
					...
					{
						iLocal_340 = 1;
						iLocal_354 = unk_0x1DD05E817C89C737();
						iLocal_355 = 0;
					}
				}
				else if (bLocal_336 == false && !func_313(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 9f, 1))
				{
					if (func_313(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 20f, 1))
					{
						if (!bLocal_341)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					...
					{
						if (func_312(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 1) || iLocal_351 == 2)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - iLocal_354 > 15000)
							{
								if (bLocal_334)
								{
									if (iLocal_350 == 0)
									{
										...
										{
											if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_354(iLocal_359))
													unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 3000, 0, 2);
									...
									{
										if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_354 = unk_0x1DD05E817C89C737();
								...
								{
									if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_41, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_354(iLocal_359))
											unk_0xE67051907958B5EB(iLocal_359, unk_0x4A8C381C258A124D(), 3000, 0, 2);
							...
							else if (bLocal_334 != iLocal_623.f_1)
							{
								bLocal_334 = iLocal_623.f_1;
								...
								if (bLocal_334)
								{
									if (iLocal_355 < unk_0x1DD05E817C89C737())
									{
										if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
											unk_0x0F15249D24BC5ADA(1);
									
										iLocal_354 = unk_0x1DD05E817C89C737() - 7500;
										iLocal_355 = unk_0x1DD05E817C89C737();
									}
								}
								else
								{
					...
					{
						iLocal_354 = unk_0x1DD05E817C89C737() - 5000;
					}
				}
				...
				if (iLocal_351 == 0)
				{
					if (iLocal_751 < 5)
					{
						if (unk_0x1DD05E817C89C737() - uLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
							{
								if (func_234(uLocal_604[0 /*8*/], unk_0x4A8C381C258A124D(), 1) < 4f)
								{
				...
				else if (iLocal_351 == 1)
				{
					if (iLocal_751 < 4)
					{
						if (unk_0x1DD05E817C89C737() - uLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
							{
								if (func_234(uLocal_604[1 /*8*/], unk_0x4A8C381C258A124D(), 1) < 4f)
								{
				...
				if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1))
				{
					if (iLocal_357 == -1)
					{
						iLocal_357 = unk_0x1DD05E817C89C737();
					}
					else if (unk_0x1DD05E817C89C737() - iLocal_357 >= 1500)
					{
						if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							func_285();
					
						uLocal_535 = unk_0x1DD05E817C89C737();
						func_243(3);
						iLocal_770.f_1 = 3;
					}
				}
				...
				else if (!func_313(unk_0x4A8C381C258A124D(), uLocal_361[iLocal_351 /*43*/].f_2, 9f + 2f, 1))
				{
					bLocal_335 = false;
				}
			}
			...
			{
				if (!unk_0xC450B06E5AAA0985(iLocal_162))
					iLocal_162 = func_311(uLocal_142, 5, 0);
				...
				{
					if (iLocal_351 < 2)
						if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0))
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541())
								if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_38, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_38, 7, 0, 0, 0))
									iLocal_342 = 1;
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541())
						if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_38, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_38, 7, 0, 0, 0))
							iLocal_342 = 1;
				}
				else if (iLocal_343 == 0)
				{
					if (iLocal_351 < 2)
						if (unk_0xFAA48325A90263BE(unk_0x4A8C381C258A124D(), iLocal_359, 30f, 30f, 30f, 0, 1, 0))
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500 && !unk_0xFBA523E6F8ACE541())
								if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
									iLocal_343 = 1;
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uLocal_356 >= 7500 && !unk_0xFBA523E6F8ACE541())
						if (unk_0x1B79E937E91F40C3(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
							iLocal_343 = 1;
				}
			}
	...
	if (iLocal_770.f_1 == 3)
	{
		...
		if (unk_0x1DD05E817C89C737() - uLocal_535 > 750)
		{
			func_231();
...
int func_311(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x2D5D3
{
	int num;
...
BOOL func_312(var uParam0, int iParam1, float fParam2, int iParam3) // Position - 0x2D601
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam3), unk_0xD1A6A821F5AC81DB(iParam1, iParam3)) <= fParam2 * fParam2;
}

BOOL func_313(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2D623
{
	return SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, iParam5), vParam1) <= fParam4 * fParam4;
}

void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x2D641
{
	iParam2 = iParam2;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2D65A
{
...
BOOL func_316(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2D6A8
{
	Global_22426 = 0;
...
void func_317() // Position - 0x2D976
{
	if (!func_318())
		return;
...
BOOL func_318() // Position - 0x2D9AD
{
...
BOOL func_319(int iParam0) // Position - 0x2DA10
{
	return func_320(iParam0, 20);
}

BOOL func_320(int iParam0, int iParam1) // Position - 0x2DA20
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2DA38
{
	return -1;
}

void func_322() // Position - 0x2DA41
{
	int i;
...
void func_323() // Position - 0x2DA72
{
...
BOOL func_324() // Position - 0x2DB07
{
	int num;
	int num2;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2DBA0
{
	if (func_110(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_326() // Position - 0x2DC42
{
	int i;
...
BOOL func_327(int iParam0, int iParam1) // Position - 0x2DC99
{
	switch (iParam0)
	{
		case 5:
...
void func_328(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DCD1
{
...
void func_329(var uParam0) // Position - 0x2DD27
{
...
void func_330(char* sParam0) // Position - 0x2DD47
{
...
void func_331(var uParam0) // Position - 0x2DD5D
{
	float num;
	float num2;
	float num3;
	...
	num = SYSTEM::VDIST(uParam0->f_2, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1));
	num2 = { unk_0x90D0E0397D3F7690(unk_0x4A8C381C258A124D()) };

	if (num > iLocal_623.f_11)
	{
		value = 0f;
	
		if (iLocal_623.f_8 > 0f)
			value = value + (SYSTEM::SIN((num - iLocal_623.f_11) * (360f / iLocal_623.f_8)) * iLocal_623.f_10);
	
		if (iLocal_623.f_9 > 0f)
			value = value + (SYSTEM::SIN((num - iLocal_623.f_11) * (360f / iLocal_623.f_9)) * iLocal_623.f_10 * -0.7f);
	
		num3 = (num2 * SYSTEM::COS(value)) - (num2.f_1 * SYSTEM::SIN(value));
		num3.f_1 = (num2.f_1 * SYSTEM::COS(value)) + (num2 * SYSTEM::SIN(value));
	}
	else
	{
		num3 = { num2 };
	...
	num4 = { uParam0->f_2 - unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
	unk7 = { uParam0->f_2 - unk_0x0D1381B6E0F3987D(unk_0x4A8C381C258A124D(), 0f, -5f, 0f) };
	flag = (num4 * num3) + (num4.f_1 * num3.f_1) > 0f;
	num5 = 1f - (unk_0x20A3B1C2EC4167BB(num3, num3.f_1, unk7, unk7.f_1) / 180f);

	if (num >= 10f)
		iLocal_623.f_12 = 0.92f;
	else
		iLocal_623.f_12 = 0.95f;

	flag2 = num5 > iLocal_623.f_12 && flag;
	iLocal_623.f_1 = flag2;
	...
	else if (iLocal_352 < unk_0x1DD05E817C89C737())
	{
		if (num <= 6.5f && flag2)
		{
			unk_0x8E4825CCACA34B58(iLocal_623.f_3);
			unk_0xBD618A73193F9982(iLocal_623.f_4, "CONTINUAL_BEEP", unk_0x4A8C381C258A124D(), "EPSILONISM_04_SOUNDSET", 0, 0);
			iLocal_623.f_6 = 1;
		}
		else
		{
			...
			num7 = 125 + SYSTEM::ROUND((num6 / 40f) * (1250f - 125f));
		
			if (num7 > 1250)
				num7 = 1250;
		
			iLocal_352 = unk_0x1DD05E817C89C737() + num7;
			num7 = num7 / 3;
		
			if (num7 < 100)
				num7 = 100;
		
			iLocal_353 = unk_0x1DD05E817C89C737() + num7;
			unk_0xBD618A73193F9982(iLocal_623.f_3, "IDLE_BEEP", unk_0x4A8C381C258A124D(), "EPSILONISM_04_SOUNDSET", 0, 0);
	...
	if (iLocal_353 > 0 && unk_0x1DD05E817C89C737() > iLocal_353)
	{
		unk_0x8E4825CCACA34B58(iLocal_623.f_3);
		iLocal_353 = 0;
	}
	...
	if (unk_0x196704C916969409())
	{
		if (iLocal_623.f_7 == 0)
		{
			unk_0xBD618A73193F9982(iLocal_623.f_5, "SCAN", unk_0x4A8C381C258A124D(), "EPSILONISM_04_SOUNDSET", 0, 0);
			iLocal_623.f_7 = 1;
		}
		else if (flag2)
		{
			unk_0x3F002AA9562BF0BE(iLocal_623.f_5, "IsOnTarget", 1f);
		}
		else
		{
			unk_0x3F002AA9562BF0BE(iLocal_623.f_5, "IsOnTarget", 0f);
		}
	
		uLocal_757 = unk_0x1DD05E817C89C737();
	}
	else if (iLocal_623.f_7 == 1)
	{
		unk_0x8E4825CCACA34B58(iLocal_623.f_5);
		iLocal_623.f_7 = 0;
	}
	...
	{
		num8 = (num - 6.5f) / (uParam0->f_23 - 6.5f);
		...
		unk_0x88F483FBD433696A(uLocal_163, "SET_DISTANCE");
		unk_0x74BF156C860580D4(fLocal_638);
		unk_0xE6B753D52F4CA222();
		unk_0x61055542D9D877AE(uLocal_164);
		unk_0x6D16B99FEB0AFFF1(uLocal_163, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
...
void func_332(var uParam0) // Position - 0x2E27D
{
	int i;
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				for (i = unk_0xC5935DFB3F39785A(0, iLocal_603); uParam0->f_3 == -1; i = (i + 1) % iLocal_603)
				{
					if (uLocal_536[i /*6*/].f_5 == 0)
					{
						if (uLocal_536[i /*6*/].f_4 == 0)
						{
							if (!unk_0x65FFA94B82A71741(*uParam0, uLocal_536[i /*6*/], 3f, 3f, 3f, 0, 1, 0))
							{
				...
				unk_0xA966E518B752B92A(*uParam0, uLocal_536[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				unk_0xB5396F1FB088FE38(&uLocal_165);
				...
				if (uLocal_536[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == uLocal_604[1 /*8*/])
					{
						...
						unk_0x10425721983AE158(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 1090519040, -4f, -1, 0, 0, 0, 0, 0);
					...
					else
					{
						...
						unk_0x10425721983AE158(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 1090519040, -4f, -1, 0, 0, 0, 0, 0);
				...
				{
					unk_0x2280392018BC0DD3(0, uLocal_536[uParam0->f_3 /*6*/].f_3, 0);
					unk_0x10425721983AE158(0, "rcm_epsilonism4", "peeing", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				}
				...
				unk_0x93C0674FC00824D0(uLocal_165);
				unk_0x4BD42B0527065BB6(*uParam0, uLocal_165);
				unk_0xD0557B139A542F12(&uLocal_165);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
		...
		case 4:
			...
			{
				if (!unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_351 > 0)
				{
					if (!unk_0x133460AD0F183CC9(*uParam0))
					{
						unk_0x974022927CB47E68(*uParam0);
					...
					uLocal_754 = unk_0x1DD05E817C89C737();
			...
			else if (uParam0->f_2 == 1)
			{
				...
				if (unk_0x6CDEFB59235A1FD9(*uParam0))
				{
					if (!bLocal_348)
					{
						if (unk_0x1DD05E817C89C737() - uLocal_754 > 6000)
						{
							unk_0xB5396F1FB088FE38(&uLocal_165);
				...
				if (unk_0x6F21822F60DC0945(unk_0x4A8C381C258A124D()) || unk_0x2C807E70DCB4BB36(unk_0x4A8C381C258A124D()))
					if (unk_0x1DD05E817C89C737() - uLocal_755 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541() && !bLocal_335)
						if (*uParam0 == uLocal_604[1 /*8*/])
				...
				if (unk_0x1DD05E817C89C737() - uLocal_757 > 15000)
				{
					if (iLocal_756 < 4 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541() && !bLocal_335 && !func_355())
					{
						if (*uParam0 == uLocal_604[1 /*8*/])
						{
...
var func_333() // Position - 0x2E9D3
{
	return unk_0xD59511AF30BE1934(unk_0xB6B621402486C3E4());
}

void func_334(int iParam0) // Position - 0x2E9E3
{
	if (func_354(iParam0) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
		if (iLocal_621 == 0)
		{
		...
		else if (func_354(iLocal_622))
		{
			if (unk_0x0B3FC0E7676E79BF(iLocal_622) || unk_0x5B3431FA66D59A4C(iLocal_622))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xFBA523E6F8ACE541())
				{
					if (iLocal_622 == uLocal_604[1 /*8*/])
					{
...
BOOL func_335(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x2EAB9
{
	BOOL flag;
	int num;
	int num2;
...
void func_336(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2EB75
{
	unk_0xBD618A73193F9982(iLocal_623.f_2, "DEVICE", unk_0x4A8C381C258A124D(), "EPSILONISM_04_SOUNDSET", 0, 0);

	if (iLocal_623.f_13 == 0)
	{
		iLocal_623.f_8 = uParam0;
		iLocal_623.f_9 = uParam1;
		iLocal_623.f_10 = uParam2;
		iLocal_623.f_11 = uParam3;
		iLocal_623.f_12 = uParam4;
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2EBD6
{
...
void func_338(var uParam0, int iParam1) // Position - 0x2EC71
{
	if (func_354(*uParam0))
	{
		if (uParam0->f_1 == 2)
		...
		unk_0x19626F992DC71FB9(*uParam0);
		unk_0xB2BD5837A8D3CEDA(*uParam0, uLocal_536[iParam1 /*6*/], 1, 0, 0, 1);
		unk_0x5C96CEA06531AB03(*uParam0, uLocal_536[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
void func_339(var uParam0, int iParam1) // Position - 0x2ECF8
{
	if (func_354(*uParam0))
	{
		uParam0->f_1 = 1;
...
void func_340(var uParam0, BOOL bParam1) // Position - 0x2ED3B
{
...
void func_341(int iParam0, int iParam1, int iParam2) // Position - 0x2ED9F
{
...
BOOL func_342() // Position - 0x2EE63
{
	return IS_BIT_SET(Global_101688.f_20, 13);
}

BOOL func_343() // Position - 0x2EE74
{
...
BOOL func_344() // Position - 0x2EE9A
{
...
int func_345() // Position - 0x2EED1
{
	int i;

	for (i = 0; i < iLocal_534; i = i + 1)
	{
		unk_0xEC9DAA34BBB4658C(uLocal_361[i /*43*/]);
	}

	unk_0xEC9DAA34BBB4658C(uLocal_158);
	unk_0xEC9DAA34BBB4658C(joaat("bison"));

	for (i = 0; i < iLocal_534; i = i + 1)
	{
		if (!unk_0x6252BC0DD8A320DB(uLocal_361[i /*43*/]))
			return 0;
	}

	if (!unk_0x6252BC0DD8A320DB(uLocal_158) || !unk_0x6252BC0DD8A320DB(joaat("bison")))
		return 0;

	return 1;
}

int func_346() // Position - 0x2EF4D
{
...
void func_347() // Position - 0x2EF6B
{
	if (unk_0xB3FA103AA6383C28())
	{
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (func_283(1, 1093140480, 0))
		{
			...
			if (func_354(uLocal_81.f_28[0]))
				unk_0xF293D66D4452C854(uLocal_81.f_28[0], "Marnie", 0, 0, 0);
		
			if (func_354(uLocal_81.f_28[1]))
			{
				unk_0x5D7CD709B34C90F0(uLocal_81.f_28[1], 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x484426882F80CACE(uLocal_81.f_28[1], 1)))
				{
					iLocal_639 = func_276(uLocal_81.f_28[1], joaat("WEAPON_DIGISCANNER"), 1, false, 0, 0, 0, 0, 0);
					unk_0xF293D66D4452C854(iLocal_639, "Artefact_Detector", 0, 0, 0);
				}
			
				unk_0xF293D66D4452C854(uLocal_81.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
		{
			...
			{
				_DEBUG_PRINT("*** Forcing Michael's move state");
				func_350(unk_0x4A8C381C258A124D(), 1827.1611f, 4698.6445f, 38.094f, 184.1384f, false, 1);
				unk_0xB41DEC3AAC1AA107(unk_0x4A8C381C258A124D(), iLocal_157, -1, 1, 1);
			}
		}
...
void func_348() // Position - 0x2F2E0
{
	var unk;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Jimmy_Boston", 0))
		{
			unk_0xB1EAADCB692D69CE(1829.8f, 4693.48f, 38.5f, &unk, 0, 0);
			unk_0xB2BD5837A8D3CEDA(uLocal_604[1 /*8*/], 1829.8f, 4693.48f, unk, 1, 0, 0, 1);
		}
	}
...
void func_349() // Position - 0x2F333
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (unk_0xD8FC13DA1BA1DBA2("Marnie", 0))
		{
			...
			unk_0x63C8DCBEC1CF8225(uLocal_604[0 /*8*/], uLocal_536[uLocal_604[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			unk_0x717804C8C8DA67BF(uLocal_604[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
...
BOOL func_350(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, int iParam6) // Position - 0x2F3E4
{
	BOOL flag;
	float num;
...
void func_351() // Position - 0x2F440
{
	int num;
...
void func_352() // Position - 0x2F460
{
	func_406();
	...
	if (iLocal_770.f_1 == 0)
	{
		iLocal_352 = unk_0x1DD05E817C89C737();
	
		if (!_IS_MISSION_REPEAT_ACTIVE(false) && unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, 0, 1, 0))
		{
	...
	if (iLocal_770.f_1 == 1)
	{
		if (unk_0x1DD05E817C89C737() - iLocal_352 > 1250)
		{
		...
		if (!_IS_MISSION_REPEAT_ACTIVE(false) && unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, 0, 1, 0))
		{
			if (func_234(unk_0x4A8C381C258A124D(), uLocal_81.f_28[0], 1) >= 3f)
			{
				if (!unk_0xE37AC296E66C33AF())
				{
					if (!bLocal_331)
					{
						...
						{
							unk_0x190BA0A3BB48F7FD(uLocal_81.f_28[0], 0f, 0f, 0.2f, 1, 30000, 2000, 2000, 0);
							unk_0x4F5BF7798505A667(fLocal_765);
							unk_0x39723B4B969CC059(fLocal_766);
							unk_0x6CD2A2994586D388(fLocal_767);
							unk_0x4302C09C88CF5356(fLocal_768);
							unk_0x640D5D2C8DE912A2(fLocal_769);
							unk_0xD5864F7F5BC214FF(1);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
							{
								unk_0xB5396F1FB088FE38(&uLocal_165);
								unk_0xE67051907958B5EB(0, uLocal_81.f_28[0], 15000, 0, 2);
								unk_0xA966E518B752B92A(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								unk_0x0E95B96CFEFE7B61(0, uLocal_81.f_28[0], 0);
								unk_0x93C0674FC00824D0(uLocal_165);
								unk_0x4BD42B0527065BB6(unk_0x4A8C381C258A124D(), uLocal_165);
								unk_0xD0557B139A542F12(&uLocal_165);
			...
			if (!bLocal_332)
			{
				...
				{
					unk_0xE67051907958B5EB(uLocal_81.f_28[0], unk_0x4A8C381C258A124D(), -1, 48, 2);
					unk_0x10425721983AE158(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					unk_0xDD291722ADDCBD60();
			...
			{
				if (unk_0x13CCB1AD131C1082(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (unk_0x82E64DE58A6B84A8(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!bLocal_333)
						{
					...
					if (unk_0x82E64DE58A6B84A8(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
					...
					if (func_234(unk_0x4A8C381C258A124D(), uLocal_81.f_28[0], 1) <= 1.5f)
					{
						unk_0x4686BC3BFDBB5348(unk_0x259BE71D8A81D4FA(), 0, 0);
						unk_0x974022927CB47E68(unk_0x4A8C381C258A124D());
					}
...
int func_353(var uParam0) // Position - 0x2F800
{
	int unk;
...
BOOL func_354(int iParam0) // Position - 0x2F814
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(iParam0))
		if (!unk_0x4FAFF4BCB7633475(iParam0))
			return true;
...
BOOL func_355() // Position - 0x2F834
{
...
void func_356(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2F84D
{
	float num;
	int value;
	int num2;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !unk_0x15CCE8886267624F())
			{
				...
				unk = { func_358(Global_79795, Global_79797, iParam10) };
				num4 == -0.014f;
...
float func_357(var uParam0) // Position - 0x2FB32
{
	unk_0x282D5DA1EE14950F(uParam0);
	return unk_0x43026780D77E3DC0(1);
}

struct<2> func_358(int iParam0, int iParam1, int iParam2) // Position - 0x2FB45
{
	var unk;
	int num;
...
char* func_359(int iParam0) // Position - 0x2FC1B
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_360(int iParam0) // Position - 0x2FD83
{
	var unk;
	var unk3;
...
struct<2> func_361(int iParam0) // Position - 0x2FDB7
{
	var unk;
	var unk3;
...
struct<2> func_362(int iParam0) // Position - 0x2FDEB
{
	var unk;
	var unk3;
...
struct<2> func_363(int iParam0) // Position - 0x2FE1F
{
	var unk;
	var unk3;
...
struct<2> func_364(int iParam0) // Position - 0x2FE53
{
	var unk;
	var unk3;
...
struct<2> func_365(int iParam0) // Position - 0x2FE91
{
	var unk;
	var unk3;
...
struct<2> func_366(int iParam0) // Position - 0x2FEC5
{
	var unk;
...
BOOL func_367(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2FF32
{
	if (!func_369(0) || Global_79810 || Global_79798 == 1 || !unk_0x9390801B06EE998F())
		return false;
	...
	switch (Global_79794)
	{
		...
		case 5:
			if (unk_0xFD216000DC314A92() || func_229(0) || func_368(true))
			{
			}
			else
			{
...
BOOL func_368(BOOL bParam0) // Position - 0x3004D
{
	if (bParam0)
...
BOOL func_369(int iParam0) // Position - 0x30076
{
	if (Global_44181 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x30098
{
	return func_371(iParam0, Global_44181);
}

BOOL func_371(int iParam0, int iParam1) // Position - 0x300A9
{
	if (iParam1 == 15)
		return 1;
...
void func_372(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3028A
{
	int num;
...
void func_373() // Position - 0x30408
{
	var unk;
	var unk17;
	var unk33;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x30485
{
	return Global_2201[character /*29*/].f_3;
}

int func_375(eCharacter echParam0, int iParam1) // Position - 0x30498
{
...
int func_376(eCharacter echParam0, int iParam1) // Position - 0x304C2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_377(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x304EC
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_378(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x30531
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_379() // Position - 0x30576
{
...
void func_380(var uParam0, int iParam1, BOOL bParam2) // Position - 0x30676
{
	int i;
...
void func_381(int iParam0) // Position - 0x3076C
{
...
void func_382(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5) // Position - 0x30781
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
int func_384(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x30840
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
	...
	{
		*uParam0 = unk_0xB1DBFEB95C0EFB88(5, iParam6, uParam1, fParam4, 1, 1);
...
void func_385(var uParam0) // Position - 0x308D6
{
	var unk;

	unk = { uParam0->f_2 };
	func_386("Rock created at: ", uParam0->f_2);
	uParam0->f_1 = unk_0x43AFC452F25F3A2F(*uParam0, unk, 1, 1, 0, 0);
...
void func_386(char* sParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3095B
{
	sParam0 = sParam0;
	uParam1 = { uParam1 };
	return;
...
void func_387() // Position - 0x3096F
{
	iLocal_623.f_2 = unk_0xCA369FBC0DE29517();
	iLocal_623.f_3 = unk_0xCA369FBC0DE29517();
	iLocal_623.f_4 = unk_0xCA369FBC0DE29517();
	iLocal_623.f_5 = unk_0xCA369FBC0DE29517();
	iLocal_623.f_12 = 0.92f;
	iLocal_623.f_13 = 0;
	iLocal_623.f_14 = "NO_RECENT_ANIM";
	uLocal_163 = unk_0x8DE4F68A9728925E("digiscanner");

	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_163))
	{
		SYSTEM::WAIT(0);
	}
	...
	unk_0xF1C26EB47E689774(uLocal_158);

	if (unk_0xC13AFEAFC3F7AD96("digiscanner"))
		uLocal_164 = unk_0x08732C0099FA1813("digiscanner");

	return;
}

void func_388() // Position - 0x30A06
{
	iLocal_770.f_4 = 0;
	iLocal_770.f_5 = 0;
	iLocal_770.f_6 = 0;
...
void func_389() // Position - 0x30A2C
{
...
void func_390(var uParam0, var uParam1, float fParam2) // Position - 0x30F06
{
	int num;
	int num2;
	int num3;
...
void func_391(var uParam0) // Position - 0x31013
{
	int i;
	float num;
...
void func_392(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x310B3
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_393(var uParam0) // Position - 0x310E4
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
int func_394(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0x3110B
{
	int num;
...
void func_395(float fParam0, float fParam1, float fParam2) // Position - 0x31157
{
	int num;
...
void func_396(float fParam0, float fParam1, float fParam2) // Position - 0x3118D
{
	int num;
...
void func_397(char* sParam0) // Position - 0x311C3
{
	int num;
...
void func_398(char* sParam0, char* sParam1) // Position - 0x311E3
{
	int num;
...
void func_399(char* sParam0, char* sParam1) // Position - 0x3120E
{
	int num;
...
void func_400(char* sParam0, char* sParam1) // Position - 0x31239
{
	int num;
...
void func_401(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x31264
{
	int num;
...
void func_402(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x312A2
{
	int num;
...
void func_403(float fParam0, float fParam1, float fParam2) // Position - 0x312D1
{
	int num;
...
void func_404(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x312F5
{
	int num;
...
void func_405(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x31333
{
	int num;
...
void func_406() // Position - 0x313D0
{
	func_408(0);
	func_288();
	func_407();
...
void func_407() // Position - 0x313E5
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_290(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
void func_408(int iParam0) // Position - 0x3143D
{
	if (func_228())
		return;
...
void _DEBUG_PRINT(char* sParam0) // Position - 0x31470
{
	sParam0 = sParam0;
	return;
}

var func_410(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3147C
{
	var unk;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[1]))
			{
				if (func_413(&uParam0->f_28[1], CHAR_JIMMY_BOSTON, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					...
					func_350(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, true, 1);
				}
				else
				{
					flag = false;
...
BOOL func_413(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x3170B
{
	if (func_414(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_414(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x31767
{
	int num;

	if (!func_171(echParam1))
	{
		num = func_445(echParam1);
...
int func_415(var uParam0, eCharacter echParam1) // Position - 0x317F5
{
	int num;
...
BOOL func_416(var uParam0) // Position - 0x3183B
{
	if (func_417(uParam0))
	{
...
BOOL func_417(var uParam0) // Position - 0x31865
{
...
BOOL func_418(var uParam0) // Position - 0x3188A
{
	int i;
...
void func_419(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x318BB
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x318F7
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x3191F
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_422() // Position - 0x31943
{
	func_351();
	...
	unk_0xB7F6A8F981EF6068(uLocal_358);

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
		if (unk_0x133460AD0F183CC9(uLocal_604[0 /*8*/]))
			unk_0x5C4B3034CCDA5270(uLocal_604[0 /*8*/]);
		else if (unk_0x133460AD0F183CC9(uLocal_604[1 /*8*/]))
			unk_0x5C4B3034CCDA5270(uLocal_604[1 /*8*/]);

	func_423(&uLocal_604[0 /*8*/], 1, 1, 1);
	func_423(&uLocal_604[1 /*8*/], 1, 1, 1);
	unk_0xF8211BE23F0D0552("digiscanner");
	unk_0xD7B6A43ACC36D868(uLocal_160, 0);
	unk_0xD7B6A43ACC36D868(uLocal_161, 0);
	unk_0x8E99C7AF6C6639AB(iLocal_762);
	unk_0x8E99C7AF6C6639AB(iLocal_763);
	unk_0x8E99C7AF6C6639AB(iLocal_764);
...
void func_423(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x31A57
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
BOOL func_424() // Position - 0x31AA7
{
	int num;
...
void func_425(BOOL bParam0) // Position - 0x31B48
{
	int num;
	...
	if (!func_440())
	{
		...
		{
			func_179(num, 1, 0);
			func_426(unk_0x1AF90EB93E0012D6(), num);
		}
		else
		{
			if (Global_113222[num /*10*/].f_9 == -1)
...
void func_426(char* sParam0, int iParam1) // Position - 0x31C18
{
	if (Global_101688 != 12)
...
BOOL func_427(char* sParam0, int iParam1, int iParam2) // Position - 0x31C40
{
	var unk;
	var unk2;
	int num;
	...
	if (func_433())
	{
		...
		{
			num = func_428(unk_0x1AF90EB93E0012D6());
...
int func_428(char* sParam0) // Position - 0x31DCF
{
...
int func_429() // Position - 0x31E29
{
	int num;
	int num2;

	num = func_430(&(Global_101688.f_3), false);
	num2 = 0;
...
int func_430(char* sParam0, BOOL bParam1) // Position - 0x31E4D
{
	var unk;
	int num;

	unk = unk_0x70E57E9927B6BA58(sParam0);
	num = func_431(unk, true);
	num == -1 && !bParam1;
	return num;
}

int func_431(var uParam0, BOOL bParam1) // Position - 0x31E77
{
	int i;
...
BOOL func_432() // Position - 0x31EAD
{
...
BOOL func_433() // Position - 0x31EFD
{
	...
	if (Global_101688.f_11 == 5)
		if (func_428(&(Global_101688.f_3)) > -1)
			return true;

	return false;
}

void func_434(int iParam0) // Position - 0x31F69
{
...
void func_435(int iParam0) // Position - 0x31F7D
{
	if (iParam0 == 1)
	{
		unk_0x5C6622EF2CEA902F();
...
void func_436(int iParam0) // Position - 0x31FB7
{
	if (iParam0 == 1)
	{
...
void func_437() // Position - 0x31FF1
{
	Global_23831.f_5 = 1;
	return;
}

void func_438() // Position - 0x31FFF
{
	Global_23831.f_5 = 0;
	return;
}

void func_439() // Position - 0x3200D
{
	Global_95839 = 0;
	Global_95840 = 0;
	return;
...
BOOL func_440() // Position - 0x3201F
{
...
void func_441() // Position - 0x3205D
{
	Global_101723 = 1;
...
void func_442(char* sParam0) // Position - 0x32150
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_443(var uParam0) // Position - 0x32162
{
...
void func_444(var uParam0) // Position - 0x32182
{
	int i;
...
int func_445(eCharacter echParam0) // Position - 0x321BC
{
