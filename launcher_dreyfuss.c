	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_299(&(Global_113249[num /*10*/].f_9));
			}
		}
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x482E
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55AF
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55EA
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x585E
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DE9
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A90
{
	int i;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F5F
{
...
struct<2> func_119(int iParam0) // Position - 0x8F87
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93D4
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6AC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA9F2
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAA97
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB32
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAB90
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xABE9
{
...
int func_129(Ped pedParam0) // Position - 0xAC6C
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC9D
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACB2
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD65
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD80
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xADCC
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE15
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE35
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE56
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF26
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF79
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB06F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB0DA
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB119
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB268
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB282
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB2DB
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB33E
{
...
BOOL func_150() // Position - 0xB37D
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB38B
{
	int num;
...
void func_153(int iParam0) // Position - 0xB3E5
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB408
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4AC
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB53B
{
...
void func_161(Vehicle veParam0) // Position - 0xB592
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB5BE
{
...
void func_164(int iParam0) // Position - 0xB760
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB793
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB81D
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB891
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB89F
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB8F6
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB905
{
...
BOOL func_171(int iParam0) // Position - 0xB946
{
	int num;
...
void func_172(int iParam0) // Position - 0xB98B
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9BD
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBAF4
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB43
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB54
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD35
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBD57
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBD68
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDB1
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_182(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xBE76
{
...
float func_183(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xBEA9
{
...
BOOL func_184(int iParam0) // Position - 0xBEE3
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113209 || Global_33108 || func_191() || func_190(8, -1) || func_101() || func_189() || func_188() || func_187() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_33108 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113209 || Global_33108 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113209 || Global_33108 || func_191() || func_190(8, -1) || func_101() || func_189() || func_187() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_33108 || func_191() || func_190(8, -1) || func_189() || func_188() || func_187() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || func_189() || Global_113209 || Global_33108 || func_191() || Global_45410 || func_190(8, -1) || func_188() || func_186() || func_187() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_113209 || Global_33108 || func_191() || func_190(8, -1) || func_188() || func_186() || func_101() || func_189() || func_187())
							return false;
						break;
				}
			}
...
BOOL func_185() // Position - 0xC603
{
	return Global_101752.f_1;
}

BOOL func_186() // Position - 0xC611
{
	if (Global_98610 != -1)
...
BOOL func_189() // Position - 0xC678
{
	return Global_101765.f_400 > 0;
}

BOOL func_190(int iParam0, int iParam1) // Position - 0xC689
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xC6C1
{
	return Global_1575086;
}

BOOL func_192() // Position - 0xC6CD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_193(var uParam0, int iParam1) // Position - 0xC6E9
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_194() // Position - 0xCECC
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_195(var uParam0) // Position - 0xCEE7
{
	float num;
...
void func_196(int iParam0, var uParam1) // Position - 0xCF75
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_197(BOOL bParam0) // Position - 0xCFD9
{
...
BOOL func_198(Vehicle veParam0) // Position - 0xD070
{
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD09A
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD122
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD15D
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1B3
{
...
void func_203(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD24E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD33F
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD37B
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD3B4
{
	BOOL flag;
	int i;
...
BOOL func_207() // Position - 0xD452
{
	return Global_98997;
}

void func_208(var uParam0) // Position - 0xD45E
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD475
{
	BOOL flag;
	int num;
	int i;
...
void func_210(int iParam0) // Position - 0xD55D
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD585
{
	var unk;
...
void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD7F5
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_213(int iParam0) // Position - 0xDB4D
{
...
BOOL func_214(var uParam0) // Position - 0xDB6D
{
...
BOOL func_215(var uParam0) // Position - 0xDB85
{
...
void func_216(var uParam0) // Position - 0xDBAA
{
	int i;
	int taskSequenceId;
...
void func_217(Object* pobParam0) // Position - 0xDEAE
{
...
void func_218(var uParam0) // Position - 0xDED9
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF59
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE117
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE147
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE403
{
...
BOOL func_223(Ped pedParam0, int iParam1) // Position - 0xE437
{
	float xSize;
...
BOOL func_224(Ped pedParam0, int iParam1) // Position - 0xE4AD
{
	return func_225(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4C5
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE586
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE6B2
{
...
BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE7C1
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE852
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE873
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE8B2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Ped pedParam0, Ped pedParam1) // Position - 0xE8CD
{
	int i;
...
BOOL func_234(Ped pedParam0) // Position - 0xE90C
{
...
BOOL func_235(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE934
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEA2F
{
	float entityCoords;
	float num;
...
BOOL func_237(Ped pedParam0, float fParam1) // Position - 0xEB3B
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEBD0
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC5E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xECA6
{
...
void func_241(Vehicle veParam0) // Position - 0xECF0
{
	int taskSequenceId;
...
BOOL func_242(int iParam0) // Position - 0xED8D
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xEE22
{
...
BOOL func_246(int iParam0) // Position - 0xEEA1
{
...
BOOL func_248(int iParam0) // Position - 0xEF13
{
...
BOOL func_250(var uParam0) // Position - 0xEF6A
{
	if (!func_251(uParam0))
		return false;
...
BOOL func_251(var uParam0) // Position - 0xEF89
{
	int num;
	int i;
	BOOL flag;
...
void func_252(BOOL bParam0) // Position - 0xF1A4
{
...
void func_253(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF1F6
{
	if (iParam0 != 198)
	{
		if (Global_79564)
...
void func_254(int iParam0, int iParam1) // Position - 0xF24E
{
	switch (iParam0)
	{
		case 12:
...
void func_255(int iParam0, BOOL bParam1) // Position - 0xF337
{
	if (bParam1)
...
BOOL func_256(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF360
{
	BOOL flag;
	int num;
	int num2;
...
int func_258() // Position - 0xFCF5
{
	return Global_33106;
}

int func_259(var uParam0, int iParam1) // Position - 0xFD00
{
	int i;
