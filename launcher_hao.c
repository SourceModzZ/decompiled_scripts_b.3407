...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_268(&unk64, &num, unk61, 1f))
	{
		func_267();
	...
	uLocal_92 = unk_0xA7B0B03284E7503C(-103.0011f, -1281.6357f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1, 1);
	...
	while (true)
	{
		...
		{
			if (!func_211(-72.323f, -1258.643f, 28.648f, unk_0xD1A6A821F5AC81DB(num.f_35[0], 1), 1056964608))
			{
		...
		func_207(num);
		func_200(&iLocal_91, &(num.f_9), unk61);
		func_195(&num, unk61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
...
var func_15(int iParam0) // Position - 0xC2D
{
	var unk;
...
void func_21(var uParam0) // Position - 0xD24
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD54
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A2D
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28D8
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2960
{
...
BOOL func_29(var uParam0) // Position - 0x29A0
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x29CE
{
...
int func_31(var uParam0) // Position - 0x2AAA
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2AEC
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B4F
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BDD
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E87
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34A6
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35D5
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x371C
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3759
{
...
int func_47(eCharacter echParam0) // Position - 0x377E
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x378D
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3956
{
...
var func_54(int iParam0, int iParam1) // Position - 0x39CF
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39E4
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F2D
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4293
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x4386
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x48A7
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x5628
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5663
{
	int num;
...
void func_67(int iParam0) // Position - 0x58D7
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5913
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E62
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5EA6
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6625
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x666C
{
...
BOOL func_73(int iParam0) // Position - 0x66C7
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66D7
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6737
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AEE
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6AF9
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B09
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BAB
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7325
{
...
int func_81() // Position - 0x7620
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x762F
{
...
int func_83() // Position - 0x7659
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7671
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7686
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x769D
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76F5
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x779F
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7834
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7878
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x79FC
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A0A
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84D5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8557
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85AF
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85B8
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x883F
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x884F
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x886C
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x887C
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BBF
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8BD0
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C16
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C9C
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CCF
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D20
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DC2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DE4
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DFB
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E08
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E42
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E7D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EB9
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8ED2
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F35
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8F4B
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F61
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FA3
{
...
struct<2> func_119(int iParam0) // Position - 0x8FCB
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9418
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6F0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA36
{
	int num;
...
void func_125(int iParam0) // Position - 0xAB76
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xABD4
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC2D
{
...
int func_129(int iParam0) // Position - 0xACB0
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACE1
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACF6
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADA9
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADC4
{
	int i;
...
int func_135(int iParam0) // Position - 0xAE10
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAE59
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE79
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE9A
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF6A
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFBD
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0B3
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB11E
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB15D
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2AC
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB2C6
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB31F
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB360
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB382
{
...
BOOL func_150() // Position - 0xB3C1
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3CF
{
	int num;
...
void func_153(int iParam0) // Position - 0xB429
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB44C
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4F0
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB57F
{
...
void func_161(var uParam0) // Position - 0xB5D6
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB602
{
...
void func_164(int iParam0) // Position - 0xB7A4
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7D7
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB861
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8D5
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8E3
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB93A
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB949
{
...
BOOL func_171(int iParam0) // Position - 0xB98A
{
	int num;
...
void func_172(int iParam0) // Position - 0xB9CF
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA01
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB38
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB87
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB98
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD79
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBD9B
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBDAC
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDF5
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE19
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC5FD
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC618
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6A6
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC70A
{
	var unk;
...
BOOL func_186(int iParam0) // Position - 0xC7A1
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_194() || Global_113182 || Global_33090 || func_193() || func_192(8, -1) || func_101() || func_191() || func_190() || func_189() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_194() || Global_33090 || func_193() || func_192(8, -1) || func_190() || func_101() || func_191() || func_189() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_194() || Global_113182 || Global_33090 || func_193() || func_192(8, -1) || func_190() || func_101() || func_191() || func_189() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_194() || Global_113182 || Global_33090 || func_193() || func_192(8, -1) || func_101() || func_191() || func_189() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_194() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_192(8, -1) || func_189() || func_188() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_187() // Position - 0xCEBE
{
	return Global_101727.f_1;
}

BOOL func_188() // Position - 0xCECC
{
	if (Global_98585 != -1)
...
BOOL func_191() // Position - 0xCF33
{
	return Global_101740.f_400 > 0;
}

BOOL func_192(int iParam0, int iParam1) // Position - 0xCF44
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCF7C
{
	return Global_1575084;
}

BOOL func_194() // Position - 0xCF88
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCFA4
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_199(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD02C
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD067
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0BD
{
...
float func_199(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD158
{
	var unk;
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD192
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_199(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_203(uParam0, 1);
			}
			else
			{
				...
				if (func_199(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_205(uParam0);
			}
		}
	}
...
void func_201(int iParam0, BOOL bParam1) // Position - 0xD283
{
	if (iParam0 == -1)
		return;
...
int func_202(int iParam0) // Position - 0xD2BF
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_203(var uParam0, int iParam1) // Position - 0xD2F8
{
	BOOL flag;
	int i;
...
BOOL func_204() // Position - 0xD396
{
	return Global_98972;
}

void func_205(var uParam0) // Position - 0xD3A2
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD3B9
{
	BOOL flag;
	int num;
	int i;
...
void func_207(int iParam0) // Position - 0xD4A1
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
void func_208(var uParam0) // Position - 0xD4C9
{
	int i;
	var unk;
...
void func_209(var uParam0) // Position - 0xD7CD
{
	var unk;
...
void func_210(var uParam0) // Position - 0xD86A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_211(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xD895
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_212(var uParam0) // Position - 0xD8CE
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD8F8
{
	var unk;
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_79785 == 1)
		return true;
...
void func_214(int iParam0, var uParam1, int iParam2) // Position - 0xDB68
{
	var unk;
	var unk2;
...
BOOL func_215(int iParam0) // Position - 0xDEC0
{
...
BOOL func_216(var uParam0) // Position - 0xDEE0
{
...
BOOL func_217(var uParam0) // Position - 0xDEF8
{
...
void func_218(var uParam0) // Position - 0xDF1D
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF9D
{
	int i;
	int num;
	var unk;
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE15B
{
	var unk;
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE18B
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE447
{
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE47B
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE4F1
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE509
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE5CA
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE6F6
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE805
{
	var unk;
	var unk4;
	float num;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE896
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE8B7
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE8F6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(var uParam0, var uParam1) // Position - 0xE911
{
	int i;
...
int func_234(var uParam0) // Position - 0xE950
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE978
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEA73
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEB7F
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEC14
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xECA2
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_240(int iParam0) // Position - 0xECEA
{
...
BOOL func_241(int iParam0) // Position - 0xED34
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_242(int iParam0) // Position - 0xEDC9
{
...
BOOL func_245(int iParam0) // Position - 0xEE48
{
	if (func_246() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_246() // Position - 0xEE7C
{
...
BOOL func_247(int iParam0) // Position - 0xEEBA
{
...
BOOL func_248(var uParam0) // Position - 0xEEE2
{
	if (!func_249(uParam0))
		return false;
...
BOOL func_249(var uParam0) // Position - 0xEF01
{
	int num;
	int i;
	var unk5;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_256(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
		...
		case 3:
			...
			{
				unk6 = unk_0x365DC1E8054AF31A(uParam0->f_35[0], "chassis_dummy");
				unk7 = { unk_0x75DF72FC74EED046(uParam0->f_35[0], unk6) };
				unk5 = unk_0x2EC137C692A52458(unk7, unk_0x88124E0D60FB8D11(uParam0->f_35[0], 2), 2);
				unk_0xBF3497E24DEAD835(unk5, 1);
				unk_0xA7C372501A8A3B23(unk5, 0);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], unk5, str, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_250(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF36B
{
	func_210(uParam0);
...
void func_251(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF392
{
	func_252(uParam0);
...
void func_252(var uParam0) // Position - 0xF3D5
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_253(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF471
{
	if (func_254(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_254(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF4CD
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_287(echParam1);
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xF55B
{
	int num;
...
BOOL func_256(var uParam0) // Position - 0xF5A1
{
	int i;
...
BOOL func_257(int iParam0) // Position - 0xF5D2
{
	int i;
...
BOOL func_258(int iParam0) // Position - 0xF63A
{
	var unk;
	eCharacter character;
...
BOOL func_259(int iParam0) // Position - 0xF68B
{
	var unk;
...
BOOL func_260(int iParam0) // Position - 0xF744
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF805
{
	int i;
	var unk;
	int num;
...
BOOL func_262(int iParam0, char* sParam1) // Position - 0xF88A
{
...
BOOL func_263(int iParam0) // Position - 0xF96C
{
...
BOOL func_264(int iParam0) // Position - 0xF997
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF9C2
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xF9ED
{
	if (func_242(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFA3C
{
	int i;
...
BOOL func_269(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFAA1
{
	int num;
	char* str;
...
BOOL func_270(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFB19
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFB94
{
	if (bParam1)
	{
	...
	unk_0xD7B6A43ACC36D868(uLocal_92, 0);
...
void func_272(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFBE8
{
...
void func_273(var uParam0, BOOL bParam1) // Position - 0xFC08
{
	func_274(&(uParam0->f_41), bParam1);
	return;
}

void func_274(var uParam0, BOOL bParam1) // Position - 0xFC1A
{
	int i;
...
void func_275(var uParam0, BOOL bParam1) // Position - 0xFC58
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_276(var uParam0, BOOL bParam1) // Position - 0xFC93
{
	func_277(&(uParam0->f_35), bParam1);
	return;
}

void func_277(var uParam0, BOOL bParam1) // Position - 0xFCA5
{
	int i;
...
void func_278(var uParam0) // Position - 0xFCE2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_279(var uParam0, int iParam1) // Position - 0xFD1A
{
	func_280(&(uParam0->f_28), iParam1);
	return;
}

void func_280(var uParam0, int iParam1) // Position - 0xFD2C
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_281(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_281(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFD6D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_282(var uParam0) // Position - 0xFDBD
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_283(int iParam0) // Position - 0xFDFE
{
	if (*iParam0 == -1)
		return;
...
void func_284(char* sParam0) // Position - 0xFE3B
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_285(var uParam0) // Position - 0xFE4D
{
	*uParam0 = -1;
...
int func_287(eCharacter echParam0) // Position - 0xFE9A
{
	if (!func_36(echParam0))
