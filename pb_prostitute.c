...
void func_32(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xFEE
{
...
char* func_92() // Position - 0x322D
{
	return "clipset@veh@low@ps@female@base";
}

int func_93(Vehicle veParam0) // Position - 0x3239
{
	int i;
	int modType;
	Hash hashKey;
...
BOOL func_94(Hash hParam0) // Position - 0x3733
{
	switch (hParam0)
	{
		case joaat("police"):
...
int func_95(Hash hParam0, BOOL bParam1) // Position - 0x37DB
{
...
void func_96(int iParam0) // Position - 0x39BE
{
	iLocal_293 = iParam0;
	return;
}

void func_97() // Position - 0x39CB
{
	if (func_571())
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(pedLocal_94))
...
void func_98(var uParam0) // Position - 0x3A38
{
...
void func_99(var uParam0) // Position - 0x3D27
{
	if (!func_571())
...
void func_100(int iParam0) // Position - 0x3DA4
{
	return;
}

char* func_101(BOOL bParam0) // Position - 0x3DAC
{
	if (!func_510(iLocal_47, 32768))
		if (bParam0)
			return func_45(6);
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x3F8B
{
...
void func_106(BOOL bParam0) // Position - 0x3FB3
{
	if (!PED::IS_PED_INJURED(pedLocal_94))
...
void func_107(Ped pedParam0, BOOL bParam1) // Position - 0x3FDD
{
	int taskSequenceId;
...
char* func_108(BOOL bParam0) // Position - 0x41AE
{
	if (!func_510(iLocal_47, 32768))
		if (bParam0)
			return func_45(4);
...
void func_109(Ped pedParam0, int iParam1) // Position - 0x41F4
{
...
char* func_110(BOOL bParam0) // Position - 0x4226
{
	if (!func_510(iLocal_47, 32768))
		if (bParam0)
			return func_45(2);
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x4311
{
...
void func_114(char* sParam0) // Position - 0x43DD
{
...
void func_115(int* piParam0) // Position - 0x43F3
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
void func_116(Ped pedParam0) // Position - 0x4409
{
	int num;
...
void func_117(int iParam0) // Position - 0x4444
{
	int num;
	var unk;
...
void func_118(Ped pedParam0) // Position - 0x448C
{
	int num;
...
char* func_119(int iParam0) // Position - 0x44BA
{
	char* str;
...
void func_120(var uParam0, int iParam1) // Position - 0x4549
{
...
float func_121(int* piParam0) // Position - 0x4566
{
	if (func_10(piParam0))
		if (func_9(piParam0))
			return piParam0->f_2;
...
void func_122(var uParam0) // Position - 0x459F
{
	BOOL flag;
	Vehicle vehiclePedIsIn;
...
void func_123(BOOL bParam0) // Position - 0x462D
{
	var entityRotation;
...
void func_124(var uParam0) // Position - 0x46B1
{
...
BOOL func_127(Ped pedParam0) // Position - 0x49FD
{
	int num;
...
void func_133(char* sParam0) // Position - 0x4AD1
{
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sParam0))
...
void func_139(int iParam0, int iParam1, int iParam2) // Position - 0x5103
{
	int num;
	int num2;
...
void func_140(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x51F1
{
	Hash statName;
...
Hash func_141(int iParam0, int iParam1) // Position - 0x521F
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_142(iParam1));
}

int func_142(int iParam0) // Position - 0x5234
{
	int num;
	int num2;
...
int func_143() // Position - 0x5268
{
	return Global_1574926;
}

int func_144(int iParam0, int iParam1) // Position - 0x5274
{
	Hash statHash;
	int outValue;
...
void func_145(Ped pedParam0) // Position - 0x52A3
{
	int num;
	int num2;
	int i;
...
void func_146(int iParam0, int iParam1, int iParam2) // Position - 0x5342
{
	if (iParam0 > -1)
...
int func_147(Ped pedParam0, int iParam1) // Position - 0x5365
{
	return PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_82(iParam1));
}

void func_148(int iParam0, int iParam1, int iParam2) // Position - 0x5379
{
	if (iParam0 > -1)
...
int func_149(Ped pedParam0, int iParam1) // Position - 0x539C
{
	return PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_86(iParam1));
}

char* func_150(int iParam0) // Position - 0x53B0
{
	return func_151(iParam0);
}

char* func_151(int iParam0) // Position - 0x53BE
{
	char* str;
...
void func_153(int iParam0) // Position - 0x5478
{
	if (iParam0 > -1)
		if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
...
void func_154(int iParam0, int iParam1, int iParam2) // Position - 0x550A
{
	BOOL flag;
...
int func_156() // Position - 0x5AAE
{
	return Global_33105;
}

BOOL func_157(int iParam0, int iParam1) // Position - 0x5AB9
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5B0A
{
	if (iParam2 == -1)
		iParam2 = func_143();
...
void func_160(BOOL bParam0, BOOL bParam1) // Position - 0x5B69
{
	int num;
...
void func_161(Ped pedParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9) // Position - 0x5BE2
{
	if (func_571())
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0x5C12
{
	int num;
...
void func_163(Ped pedParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x5C9B
{
	if (func_571())
...
void func_164(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5CC1
{
	var unk;
...
void func_165(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0x5D27
{
	if (!func_571())
...
void func_166(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x5D47
{
...
int func_167(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x5D7A
{
	int sceneID;
...
void func_168(BOOL bParam0, BOOL bParam1) // Position - 0x5DD5
{
	int num;
...
void func_169(BOOL bParam0, BOOL bParam1) // Position - 0x5E4E
{
	int num;
...
var func_170(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5ECE
{
	if (bParam0)
		return uParam1;
...
int func_173(eCharacter echParam0, int iParam1) // Position - 0x5F46
{
	var outValue;
	Hash statHash;
...
Hash func_174(eCharacter echParam0, int iParam1) // Position - 0x5F64
{
	var unk;
	var unk2;
...
void func_175(eCharacter echParam0, int iParam1, var uParam2, var uParam3) // Position - 0x5F7A
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_177(BOOL bParam0, BOOL bParam1) // Position - 0x621B
{
	int num;
...
void func_178(BOOL bParam0, BOOL bParam1) // Position - 0x6294
{
	int num;
...
void func_179(BOOL bParam0, BOOL bParam1) // Position - 0x6314
{
	int num;
...
void func_180(BOOL bParam0, BOOL bParam1) // Position - 0x638D
{
	int num;
...
float func_181(int iParam0) // Position - 0x640D
{
...
void func_182(int iParam0) // Position - 0x6435
{
	if (!func_222(iParam0))
		return;
...
void func_183(BOOL bParam0, BOOL bParam1) // Position - 0x644A
{
	int num;
...
void func_184(BOOL bParam0, BOOL bParam1) // Position - 0x64C3
{
	int num;
...
void func_185(Ped pedParam0, int iParam1) // Position - 0x6544
{
...
void func_186(var uParam0) // Position - 0x658B
{
	float num;
	float num2;
...
void func_187(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x66F6
{
	uParam0->f_1 = { fParam4 };
...
float func_188(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x6748
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

Vector3 func_189(int iParam0) // Position - 0x6762
{
...
Vector3 func_190() // Position - 0x6851
{
	Vector3 worldPositionOfEntityBone;
	var offsetFromEntityGivenWorldCoords;
	var minimum;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x68CB
{
...
void func_192(int iParam0, BOOL bParam1) // Position - 0x68F5
{
	if (bParam1)
...
void func_193(var uParam0) // Position - 0x6917
{
...
void func_194(var uParam0) // Position - 0x69E2
{
	if (*uParam0 < 3)
		*uParam0 = *uParam0 + 1;
	else if (*uParam0 == 3)
...
void func_196(var uParam0) // Position - 0x6A87
{
	var unk;
	float num;
	float num2;
...
float func_197(float fParam0, float fParam1, float fParam2) // Position - 0x6C21
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_198(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x6C48
{
...
void func_200(int iParam0) // Position - 0x7071
{
...
BOOL func_203(Ped pedParam0) // Position - 0x70F8
{
...
char* func_205(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x717A
{
	char* str;
	Vehicle vehiclePedIsIn;
...
void func_208(int iParam0) // Position - 0x730F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_209(Player plParam0) // Position - 0x7396
{
...
BOOL func_210(Player plParam0) // Position - 0x73C6
{
	Player player;
...
BOOL func_212(float fParam0) // Position - 0x747F
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x74AB
{
	Player player;
...
void func_214(BOOL bParam0, BOOL bParam1) // Position - 0x750B
{
	if (!func_571())
		return;
...
void func_215(int iParam0, int iParam1) // Position - 0x7546
{
	int num;
...
void func_216(int iParam0) // Position - 0x756D
{
	if (func_221())
		return;
...
void func_217(int iParam0) // Position - 0x75A0
{
	if (func_221())
		return;
...
void func_218(BOOL bParam0, BOOL bParam1) // Position - 0x762A
{
	if (bParam0)
	{
		if (func_220(0))
...
BOOL func_219() // Position - 0x769E
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_220(int iParam0) // Position - 0x76AC
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
...
BOOL func_221() // Position - 0x7703
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_222(int iParam0) // Position - 0x7712
{
...
float func_224() // Position - 0x7782
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
Vector3 func_225() // Position - 0x77C7
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
float func_227() // Position - 0x7888
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
BOOL func_228(int* piParam0, float fParam1) // Position - 0x78CD
{
	if (func_10(piParam0))
...
void func_229(var uParam0) // Position - 0x78EF
{
	int i;
...
void func_230(int iParam0, var uParam1) // Position - 0x792E
{
	struct<13> eventData;
...
void func_231(var uParam0, var uParam1) // Position - 0x794C
{
...
void func_232(var uParam0) // Position - 0x79AA
{
	int entityHealth;
...
void func_233(var uParam0) // Position - 0x79F9
{
	int entityHealth;
...
void func_234(var uParam0) // Position - 0x7A4C
{
	Vehicle vehiclePedIsIn;
	Vector3 entityCoords;
...
int func_236(int iParam0) // Position - 0x813A
{
	if (MISC::IS_AUSSIE_VERSION())
		if (iParam0 == 0)
			return 70;
...
void func_237(int iParam0) // Position - 0x81A5
{
	var unk;

	if (!func_571())
		func_251(_GET_CURRENT_PLAYER_CHARACTER(), 1, iParam0);
	else if (!_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
		MONEY::NETWORK_SPENT_PROSTITUTES(iParam0, false, false);
	else
		_NETSHOPPING_PROCESS_TRANSACTION(joaat("SERVICE_SPEND_PROSTITUTES"), iParam0, &unk, false, false, false);

	return;
}

void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x81E7
{
	int num;
	...
	switch (hParam0)
	{
		...
		case 571787049:
			if (iParam1 > 0 || Global_262145.f_27955)
				func_239(uParam2, joaat("NET_SHOP_TTYPE_SERVICE"), joaat("NET_SHOP_ACTION_SPEND"), joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), hParam0, iParam1, num, 7);
			break;
		...
		case joaat("SERVICE_EARN_SPIN_THE_WHEEL_CASH"):
			func_239(uParam2, joaat("NET_SHOP_TTYPE_SERVICE"), 1445302971, joaat("CATEGORY_SERVICE_WITH_THRESHOLD"), hParam0, iParam1, num, 7);
			break;
	}
...
int func_239(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8B66
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	*uParam0 = 15;
	...
	if (flag || flag2 || NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(&transactionId, hParam3, hParam4, hParam2, iParam5, iParam6))
	{
		...
		{
			*uParam0 = func_246(transactionId, iParam1, hParam4, hParam2, hParam3, iParam5, false, iParam6, iParam7, 1, true);
	...
	else
	{
		...
		if (iParam7 & 4 != 0)
			func_240(-1, hParam4, iParam6, iParam5, -1);
	}

	return 0;
}

void func_240(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x8D13
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_241(int iParam0) // Position - 0x8D4B
{
	BOOL flag;
...
void func_242(var uParam0) // Position - 0x8D9F
{
	uParam0->f_65 = 0;
...
void func_243(var uParam0) // Position - 0x8EAA
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_244(int iParam0) // Position - 0x8EF2
{
...
void func_245(int iParam0, Hash hParam1) // Position - 0x8F1D
{
...
int func_246(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x8F31
{
	int i;
...
void func_248() // Position - 0x9102
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
	return;
}

int func_249(Player plParam0) // Position - 0x9112
{
	var address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x912D
{
	if (MISC::IS_PC_VERSION())
...
int func_251(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x9144
{
	...
	return func_252(func_284(echParam0), 0, iParam1, iParam2, false);
}

int func_252(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x9178
{
	float num;
	int num2;
	int num3;
...
void func_253(BOOL bParam0) // Position - 0x9777
{
	int i;
	int j;
...
void func_254(int iParam0) // Position - 0x99F9
{
	int value;
...
void func_255(int iParam0) // Position - 0x9A53
{
	int num;
	BOOL flag;
	var txdName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x9C1F
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x9D5F
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x9D7B
{
	Hash statHash;
	int outValue;
...
Hash func_260(int iParam0) // Position - 0x9D99
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_261(int iParam0) // Position - 0x9DBB
{
	switch (iParam0)
	{
		case 38:
...
int func_262(int iParam0) // Position - 0x9DD8
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_263(int iParam0) // Position - 0x9EDD
{
	switch (iParam0)
	{
		case 18:
...
void func_264(int iParam0) // Position - 0x9F6C
{
	func_282(93, iParam0);
	func_282(29, iParam0);
	func_282(30, iParam0);
...
BOOL func_265(int iParam0) // Position - 0x9F8C
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xA197
{
	if (iParam1 == -1)
		iParam1 = func_143();
...
int func_267(BOOL bParam0) // Position - 0xA1B3
{
	var outValue;
	int value;
	int outValue2;
...
int func_268(int iParam0, int iParam1) // Position - 0xA26A
{
	if (iParam0 >= 78)
		return 0;
...
int func_269(int iParam0, int iParam1) // Position - 0xA285
{
...
BOOL func_270(var uParam0, int iParam1) // Position - 0xA322
{
	int i;
	var unk;
...
int func_271(var uParam0, int iParam1) // Position - 0xA3D3
{
	int i;
...
BOOL func_272(var uParam0, int iParam1) // Position - 0xA44E
{
	return uParam0->[iParam1] == 78;
}

void func_273(var uParam0) // Position - 0xA45F
{
	int i;
...
void func_274(var uParam0, int iParam1) // Position - 0xA493
{
	uParam0->[iParam1] = 78;
	return;
}

void func_275(var uParam0, int iParam1) // Position - 0xA4A3
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_276(var uParam0) // Position - 0xA4C0
{
	return uParam0->f_80;
}

BOOL func_277(var uParam0, int iParam1) // Position - 0xA4CC
{
	return func_278(uParam0, iParam1) != -1;
}

int func_278(var uParam0, int iParam1) // Position - 0xA4DE
{
	int i;
...
BOOL func_279(var uParam0) // Position - 0xA50B
{
	return uParam0->f_79 == 1;
}

BOOL func_280(int iParam0) // Position - 0xA519
{
	switch (iParam0)
	{
		case 60:
...
void func_281(Hash hParam0, int iParam1) // Position - 0xA569
{
	int outValue;
...
void func_282(int iParam0, int iParam1) // Position - 0xA58C
{
	int outValue;
...
int func_284(eCharacter echParam0) // Position - 0xA65E
{
	return Global_2201[echParam0 /*29*/].f_17;
}

int func_285() // Position - 0xA66F
{
	if (func_571())
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0xA694
{
	int outValue;
...
int func_287(Player plParam0) // Position - 0xA6EC
{
	int num;
...
int func_288(Player plParam0) // Position - 0xA6FE
{
	if (plParam0 > -1)
...
BOOL func_289(Player plParam0) // Position - 0xA741
{
	if (!func_210(plParam0))
		return false;
...
void func_290(BOOL bParam0) // Position - 0xA760
{
...
void func_291() // Position - 0xA77D
{
	Global_23848.f_5 = 0;
	return;
}

void func_292(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA78B
{
	int i;
	int num;
...
void func_293() // Position - 0xA8DD
{
	...
	{
		iLocal_296 = uLocal_287[iLocal_68];
		func_294();
...
int func_298(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0xA9C4
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_299(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAAA4
{
	float x;
	float y;
	float x2;
...
void func_300(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xAD50
{
...
float func_301(float fParam0) // Position - 0xAD87
{
	fParam0 = fParam0 * func_302();
	return fParam0;
}

float func_302() // Position - 0xAD9A
{
	return 1.7777778f / func_303();
}

float func_303() // Position - 0xADAC
{
	return Global_23987.f_9117;
}

void func_304(BOOL bParam0) // Position - 0xADBA
{
	float num;
	float num2;
	float num3;
...
void func_306(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xAE8B
{
...
void func_307(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0xAF60
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_338(Global_23987.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 || !Global_23987.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_333("CommonMenu", "Gradient_Nav", Global_23984 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0)
										{
											...
											func_317(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, num46, flag5, flag4);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_331(num24 - num49, num25 + num48, 0);
													num22 = num22 + 1;
												}
											}
										}
...
void func_308(int iParam0) // Position - 0xE120
{
	Global_1675263.f_1163 = iParam0;
	return;
}

float func_309(int iParam0) // Position - 0xE131
{
	switch (iParam0)
	{
		case 35:
...
void func_310(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0xE1A0
{
...
void func_311(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xE1C3
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0xE1E5
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_313(BOOL bParam0) // Position - 0xE1F6
{
	int r;
	int g;
	int b;
...
float func_314(BOOL bParam0) // Position - 0xE23C
{
	return func_315(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_315(float fParam0) // Position - 0xE24E
{
	fParam0 = fParam0 * func_316();
	return fParam0;
}

float func_316() // Position - 0xE261
{
	return func_303() / 1.7777778f;
}

void func_317(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xE273
{
	int r;
	int g;
	int b;
...
void func_318(float fParam0, float fParam1) // Position - 0xE421
{
	HUD::SET_TEXT_WRAP(func_301(fParam0), func_301(fParam1));
	return;
}

void func_319(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xE439
{
	switch (iParam0)
	{
		case 0:
...
void func_320(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0xE6C3
{
	int num;
	int i;
	int j;
...
void func_321(char* sParam0) // Position - 0xEBC8
{
...
void func_322(char* sParam0) // Position - 0xEBDA
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_323(Player plParam0, int iParam1) // Position - 0xEBE8
{
	BOOL flag;
...
int func_324(int iParam0, BOOL bParam1) // Position - 0xEC41
{
	int num;
	int num2;
...
void func_327(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0xED0A
{
...
void func_328(float fParam0) // Position - 0xEE2B
{
	int r;
	int g;
	int b;
...
void func_329(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xEE8A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_330(char* sParam0, int iParam1, int iParam2) // Position - 0xEEB1
{
...
void func_331(float fParam0, float fParam1, int iParam2) // Position - 0xEEF3
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_301(fParam0), fParam1, iParam2);
	return;
}

void func_332() // Position - 0xEF09
{
	int r;
	int g;
	int b;
...
void func_333(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0xEF93
{
...
char* func_334(int iParam0, BOOL bParam1) // Position - 0xEFC1
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_335(char* sParam0) // Position - 0xF4EB
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xF4F5
{
	var gamerHandle;
...
char* func_337(int iParam0) // Position - 0xF50C
{
	var txdName;
	var netHandle;
...
void func_338(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0xF581
{
	int num;
	float num2;
	float num3;
...
float func_339(char* sParam0) // Position - 0xF79D
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_340(char* sParam0) // Position - 0xF7B9
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_341(int iParam0, BOOL bParam1) // Position - 0xF7F6
{
	int num;
...
void func_342(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0xF842
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_343(int iParam0, int iParam1) // Position - 0xF8CA
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_344(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0xF8E5
{
	var textureDict;
	var textureName;
	int num;
...
float func_345(int iParam0) // Position - 0xFA11
{
	switch (iParam0)
	{
		case 33:
...
BOOL func_346(BOOL bParam0, BOOL bParam1) // Position - 0xFAE5
{
	if (Global_2672942.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_30(8, -1) && func_347() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79825 || Global_23987.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101765.f_1490)
		return false;

	return true;
}

int func_347() // Position - 0xFB82
{
	return Global_1575014;
}

BOOL func_348(var uParam0, BOOL bParam1, int iParam2) // Position - 0xFB8E
{
	var unk;
	Hash hashKey;
	int i;
...
BOOL func_350(int iParam0) // Position - 0xFCA5
{
	return func_351(func_367(), iParam0);
}

BOOL func_351(int iParam0, int iParam1) // Position - 0xFCB7
{
	int num;
	int num2;
...
int func_352(int iParam0) // Position - 0xFDC3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_353(int iParam0) // Position - 0xFDD6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_354(int iParam0) // Position - 0xFDE9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_355(int iParam0) // Position - 0xFDFC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_356(int iParam0) // Position - 0xFE0E
{
	return iParam0 & 15;
}

int func_357(int iParam0) // Position - 0xFE1B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

void func_358(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xFE3D
{
	int num;
	int i;
	int num2;
...
void func_359(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xFFBF
{
...
void func_360(var uParam0, int iParam1) // Position - 0xFFF7
{
	if (iParam1 <= 0)
		return;
...
void func_361(var uParam0, int iParam1) // Position - 0x1007E
{
	int num;
	int num2;
...
void func_362(var uParam0, int iParam1) // Position - 0x100CF
{
...
void func_363(var uParam0, int iParam1) // Position - 0x10102
{
...
void func_364(var uParam0, int iParam1) // Position - 0x1013C
{
...
void func_365(var uParam0, int iParam1) // Position - 0x10177
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
int func_366(int iParam0, int iParam1) // Position - 0x101B3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1029B
{
...
void func_369() // Position - 0x102B2
{
	int num;
	int num2;
	int num3;
	...
	if (func_285() >= num)
	{
		func_338(iLocal_69, "PROS_DOLLAR" /*$~1~*/, 1, 1, 0, false, 0);
		func_372(num, false);
		uLocal_287[iLocal_69] = 0;
		iLocal_69 = iLocal_69 + 1;
	}

	if (func_285() >= num2 && func_371(veLocal_97))
	{
		func_338(iLocal_69, "PROS_DOLLAR" /*$~1~*/, 1, true, 0, false, 0);
		func_372(num2, false);
		uLocal_287[iLocal_69] = 1;
		iLocal_69 = iLocal_69 + 1;
	}

	if (func_285() >= num3 && func_371(veLocal_97))
	{
		func_338(iLocal_69, "PROS_DOLLAR" /*$~1~*/, 1, true, 0, false, 0);
		func_372(num3, false);
		uLocal_287[iLocal_69] = 2;
		iLocal_69 = iLocal_69 + 1;
	}

	func_338(iLocal_69, "PROS_QUIT" /*Decline Service*/, 0, true, 0, false, 0);
	iLocal_68 = 0;
	func_292(iLocal_68, true, 1);
	func_370();
	iLocal_87 = MISC::GET_GAME_TIMER();
...
void func_370() // Position - 0x103D4
{
	Global_23848.f_5 = 1;
	return;
}

BOOL func_371(Vehicle veParam0) // Position - 0x103E2
{
	Hash entityModel;
...
void func_372(int iParam0, BOOL bParam1) // Position - 0x104D0
{
	float num;
	float num2;
	var unk;
...
float func_373() // Position - 0x1060B
{
	int i;
	int num;
	float num2;
...
float func_374() // Position - 0x106BE
{
	float num;
	var unk;
	var unk2;
...
void func_375(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x10B05
{
...
void func_376(char* sParam0) // Position - 0x10BBA
{
	int i;
...
void func_377(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x10C05
{
...
void func_378(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x10C44
{
...
void func_379(BOOL bParam0, BOOL bParam1) // Position - 0x10CEE
{
	int i;
	int j;
	float aspectRatio;
...
float func_380(BOOL bParam0) // Position - 0x111D0
{
	float aspectRatio;
...
void func_381(BOOL bParam0) // Position - 0x111FB
{
	if (!bParam0)
...
BOOL func_382(char* sParam0, int iParam1) // Position - 0x11219
{
...
BOOL func_383(Player plParam0) // Position - 0x11263
{
	Player player;
...
BOOL func_384(Ped pedParam0, BOOL bParam1) // Position - 0x11286
{
...
char* func_385(BOOL bParam0) // Position - 0x11418
{
	if (!func_510(iLocal_47, 32768))
		if (bParam0)
			return func_45(0);
...
void func_386(var uParam0) // Position - 0x1145E
{
	*uParam0 = -15;
	return;
}

BOOL func_387(int iParam0) // Position - 0x1146C
{
	int num;
	int num2;
	int num3;
...
void func_388() // Position - 0x11548
{
	if (PED::IS_PED_INJURED(pedLocal_94))
		return;
...
BOOL func_389() // Position - 0x11593
{
...
BOOL func_390(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x115B9
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_391(int* piParam0) // Position - 0x116C7
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_392() // Position - 0x11769
{
	if (!func_571())
		return;
...
void func_393() // Position - 0x1178D
{
	Vehicle vehiclePedIsIn;
...
void func_394(BOOL bParam0, int iParam1) // Position - 0x117D6
{
	int num;
...
void func_395(int* piParam0) // Position - 0x1189C
{
	if (piParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
...
BOOL func_396() // Position - 0x118C8
{
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_397() // Position - 0x1193D
{
	if (iLocal_70 == 0)
	{
...
BOOL func_398(int iParam0) // Position - 0x119C5
{
	Vector3 vector;
	Vector3 entityCoords;
	int hit;
...
void func_399(int iParam0) // Position - 0x11B10
{
	switch (iParam0)
	{
		case 0:
...
void func_400() // Position - 0x11BB0
{
...
void func_401() // Position - 0x11BEB
{
	Vector3 vector;
	Vector3 vector2;
...
void func_402(var uParam0, var uParam1) // Position - 0x11C81
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
void func_403(Ped pedParam0) // Position - 0x11DBB
{
	int taskSequenceId;
...
Vector3 func_404() // Position - 0x11E1A
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
Vector3 func_407() // Position - 0x11EE7
{
	switch (_GET_CURRENT_PLAYER_CHARACTER())
	{
		case CHAR_MICHAEL:
...
void func_408() // Position - 0x11F4C
{
	func_349();
	func_423();
...
void func_409() // Position - 0x12102
{
	iLocal_49 = 0;
	uLocal_306[0] = 0;
	uLocal_306[1] = 0;
...
void func_410() // Position - 0x12129
{
	if (PED::IS_PED_INJURED(pedLocal_94))
		return;
...
BOOL func_411() // Position - 0x12156
{
...
void func_412() // Position - 0x12177
{
	if (func_571())
	{
...
void func_413() // Position - 0x121A8
{
	Vector3 entityCoords;
...
BOOL func_414() // Position - 0x12273
{
	Vehicle vehiclePedIsIn;
...
BOOL func_415() // Position - 0x122BF
{
	Entity outPed;
	Vector3 entityCoords;
	var unk3;
...
BOOL func_416() // Position - 0x12413
{
...
BOOL func_417(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x12452
{
...
BOOL func_418(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x125BA
{
...
BOOL func_419(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x126CD
{
...
BOOL func_420(Vehicle veParam0, Vector3* pvParam1) // Position - 0x127B3
{
	var unk;
...
BOOL func_421() // Position - 0x1287A
{
	return Global_76658;
}

BOOL func_422() // Position - 0x12886
{
...
void func_423() // Position - 0x128B2
{
...
void func_424(int iParam0, BOOL bParam1) // Position - 0x128F8
{
	if (bParam1)
...
void func_425(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1292F
{
	int address;
...
int func_426(int iParam0) // Position - 0x1299F
{
	switch (iParam0)
	{
		case 0:
...
void func_427(int iParam0, int iParam1, BOOL bParam2) // Position - 0x12D56
{
	int address;
...
BOOL func_428(int iParam0, int iParam1, BOOL bParam2) // Position - 0x12DC6
{
	if (iParam0 == -1)
		return false;
...
void func_429(var uParam0) // Position - 0x12E26
{
	if (func_510(iLocal_47, 2))
	{
		if (!func_63())
...
void func_430() // Position - 0x12E5D
{
...
BOOL func_431(float fParam0) // Position - 0x13213
{
	if (!func_10(&uLocal_111))
		func_40(&uLocal_111);
...
float func_432(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x13234
{
	Vector3 entityCoords;
...
BOOL func_433(Vehicle veParam0) // Position - 0x13292
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_434(Vehicle veParam0) // Position - 0x132BD
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_435(Vehicle veParam0) // Position - 0x132E8
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_436(Vehicle veParam0) // Position - 0x13313
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_437(Vehicle veParam0) // Position - 0x1333E
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_438(Vehicle veParam0) // Position - 0x13369
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_439(Vehicle veParam0) // Position - 0x13394
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_440(Vehicle veParam0) // Position - 0x133BF
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_441(Vehicle veParam0) // Position - 0x133EA
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_442(Vehicle veParam0) // Position - 0x1341B
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_443(Vehicle veParam0) // Position - 0x13446
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_444(Vehicle veParam0) // Position - 0x13471
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_445(Vehicle veParam0) // Position - 0x134A2
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_446(Vehicle veParam0) // Position - 0x134D3
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
BOOL func_447(Vehicle veParam0) // Position - 0x1350A
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(veParam0))
...
void func_448(var uParam0) // Position - 0x1358F
{
...
void func_449() // Position - 0x1370A
{
	var unk;
...
BOOL func_450(int iParam0, BOOL bParam1) // Position - 0x13806
{
	int num;
...
int func_451(int iParam0) // Position - 0x138BE
{
	int i;
...
void func_452() // Position - 0x138F9
{
	if (Global_33257)
	{
		if (HUD::IS_PAUSE_MENU_ACTIVE())
...
BOOL _CONTEXT_IS_HELP_TEXT_BEING_DISPLAYED(int iParam0, int iParam1) // Position - 0x1395B
{
	int num;
	BOOL flag;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x13A10
{
	int i;
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x13B3B
{
	int num;
...
BOOL func_456() // Position - 0x13B92
{
	int randomIntInRange;
	int taskSequenceId;
...
BOOL func_457(BOOL bParam0) // Position - 0x13D49
{
	if (ENTITY::IS_ENTITY_DEAD(pedLocal_94, false))
		return false;
...
void func_458() // Position - 0x13E74
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x13EC5
{
	Vehicle vehiclePedIsIn;
...
void func_460() // Position - 0x13F4A
{
	if (func_457(false))
	{
		func_449();
...
void func_461(var uParam0) // Position - 0x13FAC
{
	if (func_457(false))
	{
		func_449();
...
void func_462(var uParam0) // Position - 0x14016
{
	float num;
	var maximum;
	var minimum;
...
void func_463(var uParam0, var uParam1) // Position - 0x14164
{
	int i;
...
void func_464(var uParam0, const char* sParam1) // Position - 0x1419A
{
	func_465(uParam0, 1, -1, sParam1, 0);
	return;
}

void func_465(var uParam0, int iParam1, int iParam2, const char* sParam3, int iParam4) // Position - 0x141AD
{
	int i;
...
void func_466(var uParam0, BOOL bParam1) // Position - 0x1428E
{
	int i;
...
void func_467(var uParam0) // Position - 0x142D1
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_468(var uParam0) // Position - 0x142EA
{
	int i;
...
void func_469(var uParam0) // Position - 0x14321
{
	func_470(*uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_470(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x14338
{
...
int func_471(int iParam0) // Position - 0x143F2
{
	int i;
...
int func_472(var uParam0, char* sParam1) // Position - 0x1441B
{
	int i;
	int num;
...
int func_473(var uParam0) // Position - 0x14480
{
	int i;
...
void func_474(var uParam0) // Position - 0x144AF
{
	var string1;
...
void func_475() // Position - 0x145D1
{
	if (!func_543(64))
	{
		func_476(false, 31, 5);
...
void func_476(BOOL bParam0, int iParam1, int iParam2) // Position - 0x145F1
{
...
BOOL func_477() // Position - 0x146CC
{
	if (func_478())
		return false;
...
BOOL func_478() // Position - 0x146EC
{
	return Global_2696947;
}

BOOL func_479() // Position - 0x146F8
{
	return Global_2697899;
}

BOOL func_480(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x14704
{
	if (bParam1)
...
BOOL func_481(Player plParam0) // Position - 0x14736
{
	return func_482(plParam0);
}

BOOL func_482(Player plParam0) // Position - 0x14744
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

void func_483(BOOL bParam0) // Position - 0x1475B
{
...
BOOL func_484() // Position - 0x1478A
{
	return Global_2672942.f_2590[0 /*80*/].f_1 != 0;
}

void _DISPLAY_HELP_TEXT_NO_SOUND(const char* text, int iParam1) // Position - 0x147A0
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(text);
...
const char* func_486(const char* sParam0) // Position - 0x147B7
{
	return sParam0;
}

void func_487() // Position - 0x147C1
{
	if (iLocal_72 != -1)
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x147D5
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x14870
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_490(int* piParam0, float fParam1) // Position - 0x14883
{
...
void func_491(int* piParam0) // Position - 0x148A1
{
	if (!func_10(piParam0))
		func_40(piParam0);
...
void func_492(BOOL bParam0) // Position - 0x148B9
{
	BOOL flag;
...
BOOL func_494() // Position - 0x1494F
{
...
BOOL func_495() // Position - 0x1497C
{
	return Global_2684721.f_737;
}

BOOL func_496() // Position - 0x1498B
{
	return IS_BIT_SET(Global_2684721.f_2, 11);
}

BOOL func_497() // Position - 0x1499C
{
	return IS_BIT_SET(Global_2684721, 5);
}

BOOL func_498() // Position - 0x149AA
{
	return IS_BIT_SET(Global_2684721, 2);
}

BOOL func_499() // Position - 0x149B8
{
	return IS_BIT_SET(Global_2684721, 20);
}

BOOL func_500() // Position - 0x149C7
{
	return Global_2684721.f_700;
}

void func_501(var uParam0, int iParam1) // Position - 0x149D6
{
	func_502(uParam0, iParam1);
	return;
}

void func_502(var uParam0, int iParam1) // Position - 0x149E6
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_503() // Position - 0x149F7
{
	if (Global_33259)
		return false;
...
BOOL func_504() // Position - 0x14A30
{
	Hash entityModel;
...
BOOL func_505(var uParam0) // Position - 0x14B05
{
...
BOOL func_506(Vehicle veParam0, BOOL bParam1) // Position - 0x14B27
{
	if (Global_79564)
...
BOOL func_507() // Position - 0x14B66
{
...
BOOL IS_CUSTOMER_A_PLAYER() // Position - 0x14B8C
{
...
void func_509() // Position - 0x14BE0
{
	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_94, false))
	{
...
BOOL func_510(int iParam0, int iParam1) // Position - 0x14C43
{
	return iParam0 && iParam1 != false;
}

void func_511(char* sParam0) // Position - 0x14C52
{
	return;
}

BOOL func_512() // Position - 0x14C5A
{
	if (PED::IS_PED_INJURED(pedLocal_94))
		return false;
...
BOOL func_513() // Position - 0x14C90
{
	switch (iLocal_298)
	{
		case 0:
...
BOOL func_514(var uParam0) // Position - 0x14DF4
{
	return func_515(uParam0);
}

BOOL func_515(var uParam0) // Position - 0x14E02
{
	int i;
...
BOOL func_516(var uParam0) // Position - 0x14E60
{
	return func_517(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

BOOL func_517(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x14E77
{
	if (IS_BIT_SET(iParam0, 30))
	{
...
BOOL func_518() // Position - 0x14F62
{
	if (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
...
float func_519(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x14FC2
{
	Vector3 entityCoords;
...
void func_521() // Position - 0x15075
{
	if (ENTITY::IS_ENTITY_DEAD(pedLocal_94, false))
		return;
...
void func_522(Ped pedParam0) // Position - 0x150B4
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		return;
...
void func_523() // Position - 0x15168
{
	if (Global_33257)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_97, false))
...
void func_524() // Position - 0x15261
{
	if (func_571())
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(pedLocal_94))
...
void func_525(var uParam0) // Position - 0x15290
{
	if (!(iLocal_293 == 12))
	{
...
void func_526() // Position - 0x1536E
{
	if (PED::IS_PED_INJURED(pedLocal_94))
		return;
...
BOOL func_527() // Position - 0x15397
{
	Vehicle vehiclePedIsIn;
...
BOOL func_528() // Position - 0x153EB
{
	if (!func_571())
	{
		return true;
...
BOOL func_529() // Position - 0x15491
{
	Vector3 entityCoords;
...
BOOL func_530() // Position - 0x15575
{
...
BOOL func_531() // Position - 0x15718
{
...
BOOL func_532(int iParam0) // Position - 0x15732
{
	if (Global_44199 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x15754
{
	return func_534(iParam0, Global_44199);
}

BOOL func_534(int iParam0, int iParam1) // Position - 0x15765
{
	if (iParam1 == 15)
		return 1;
...
void func_535() // Position - 0x15946
{
	int i;
	eEventType eventAtIndex;
	struct<3> eventData;
...
void func_536() // Position - 0x1599A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_537(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x159DA
{
	return func_538(0, iParam0, true, bParam1, bParam2);
}

BOOL func_538(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x159EE
{
	int num;
	int num2;
...
int func_539(int iParam0) // Position - 0x15AB4
{
	switch (iParam0)
	{
		case 0:
...
int func_540(int iParam0) // Position - 0x15AEE
{
	switch (iParam0)
	{
		case 0:
...
int func_541(int iParam0, BOOL bParam1) // Position - 0x15B34
{
	Player player;
...
int func_542(int iParam0) // Position - 0x15BD1
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_543(int iParam0) // Position - 0x15C11
{
	return func_510(iLocal_50, iParam0);
}

void func_544(var uParam0) // Position - 0x15C21
{
	int i;
...
void func_545(int* piParam0) // Position - 0x15CA3
{
	func_546(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_546(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0x15CB9
{
...
void func_547(int iParam0) // Position - 0x15D8A
{
	if (func_510(iLocal_50, iParam0))
...
void func_548() // Position - 0x15DA5
{
	func_2(false);
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x15E09
{
	int i;
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x15F1F
{
...
BOOL func_551() // Position - 0x15F36
{
	return Global_2684721.f_695;
}

BOOL func_552(BOOL bParam0) // Position - 0x15F45
{
	bParam0;
	return Global_1575058;
}

void func_553() // Position - 0x15F56
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_554() // Position - 0x15F62
{
	func_200(1);
	return;
}

void func_555(var uParam0) // Position - 0x15F6F
{
	func_560();
...
void func_556() // Position - 0x1613E
{
	return;
}

void func_557() // Position - 0x16146
{
	if (IS_BIT_SET(Global_1668458, 4))
...
void func_558() // Position - 0x16160
{
	if (Global_2672942.f_1023.f_10)
...
BOOL func_559() // Position - 0x1617E
{
	return IS_BIT_SET(Global_1958268, 3);
}

void func_560() // Position - 0x1618C
{
	return;
}

void func_561(BOOL bParam0) // Position - 0x16194
{
	if (!PED::IS_PED_INJURED(pedLocal_94))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(pedLocal_94, false))
...
void func_562() // Position - 0x16206
{
	if (!func_571())
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_97, false) && !ENTITY::IS_ENTITY_DEAD(veLocal_97, false))
	{
		if (func_571())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veLocal_97))
			{
				if (Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 <= 0 && !IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
				{
...
void func_563() // Position - 0x16540
{
	var unk;
	var unk18;
...
int func_564() // Position - 0x165C5
{
	return iLocal_44;
}

int func_565() // Position - 0x165CF
{
	return iLocal_43;
}

int func_566() // Position - 0x165D9
{
	return 0;
}

BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x165E2
{
	int num;
	int i;
	var gamerHandle;
...
BOOL func_568() // Position - 0x16716
{
...
void func_569() // Position - 0x1673C
{
	if (func_510(iLocal_47, 128))
	{
		func_424(39, false);
...
void func_570(int iParam0) // Position - 0x16781
{
	if (func_571())
		if (func_222(iParam0))
...
BOOL func_571() // Position - 0x1679F
{
	return func_543(1);
}

BOOL func_572(int iParam0) // Position - 0x167AC
{
	return Global_44199 == iParam0;
}

BOOL func_573(Player plParam0, BOOL bParam1) // Position - 0x167BA
{
	Ped playerPed;
	int i;
	Player player;
...
BOOL func_574(Player plParam0, BOOL bParam1) // Position - 0x16830
{
	if (bParam1)
		if (func_481(plParam0))
			return true;
