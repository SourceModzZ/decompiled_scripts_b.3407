		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_171)
		{
			...
			switch (iLocal_48)
			{
				case 0:
					...
					{
						if (Global_114162.f_24999.f_5 >= iLocal_190 && !func_201())
							iLocal_48 = 2;
				...
				case 2:
					...
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42895[9 /*31*/], 0, false, true);
					OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42895[10 /*31*/], 0, false, true);
					break;
...
BOOL func_25(Player plParam0, int iParam1) // Position - 0xC9C
{
	BOOL flag;
...
BOOL func_28(Player plParam0) // Position - 0xD42
{
	Player player;
...
int func_31(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDB1
{
	int num;
...
void func_35(int* piParam0) // Position - 0x139F
{
	func_36(piParam0, 0f);
	return;
}

void func_36(int* piParam0, float fParam1) // Position - 0x13AE
{
...
void func_38(int* piParam0) // Position - 0x1431
{
	if (*piParam0 != 0)
	{
...
void func_43(const char* sParam0) // Position - 0x174B
{
...
float func_45(int* piParam0) // Position - 0x1780
{
	if (func_50(piParam0))
		if (func_46(piParam0))
			return piParam0->f_2;
...
BOOL func_46(int* piParam0) // Position - 0x17BC
{
...
void func_49(int* piParam0) // Position - 0x1871
{
	if (!func_50(piParam0))
		func_35(piParam0);
...
BOOL func_50(int* piParam0) // Position - 0x1889
{
...
void func_61(int* piParam0) // Position - 0x1BF9
{
	if (!func_50(piParam0))
		func_49(piParam0);
	else
...
void func_64() // Position - 0x1C4B
{
	if (!bLocal_174)
	{
		...
		Global_114162.f_24999.f_5 = 1000;
		AUDIO::UNLOCK_MISSION_NEWS_STORY(64);
		Global_114162.f_20568.f_472 = 54;
...
void func_65(int iParam0) // Position - 0x1D7F
{
	...
	if (func_93())
	{
		...
		func_70(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_69(Global_114151, true), 64);
	
		if (func_68(Global_114151) > 0)
		{
...
{
	if (Global_114151 == func_94() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114152)
		return true;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x2B68
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2BB4
{
...
BOOL func_105(Player plParam0) // Position - 0x3005
{
	return func_106(plParam0, 20);
}

BOOL func_106(Player plParam0, int iParam1) // Position - 0x3015
{
...
void func_117() // Position - 0x3397
{
	...
	switch (iLocal_188)
	{
		case 0:
			...
			if (!bLocal_170 && Global_114162.f_24999.f_5 != 1000)
				func_136();
...
int func_118(BOOL bParam0) // Position - 0x4359
{
	if (func_123())
	{
		...
		if (func_122(Global_114151))
			func_119(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_122(Global_114151))
...
{
	switch (func_124(&Global_33165, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
{
	return func_127(iParam0, Global_44199);
}
...
Blip func_133(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0x49B5
{
	Blip blip;
...
Blip func_134(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x49FF
{
	Blip blip;
...
float func_135(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4AA3
{
...
Object func_137(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x4AC9
{
	BOOL showWorldModel;
	Object weaponObject;
	Hash weaponhash;
...
void func_138(Object obParam0, Hash hParam1) // Position - 0x4C3D
{
	Hash componentHash;
...
Hash func_139(Hash hParam0) // Position - 0x4C5B
{
	switch (hParam0)
	{
...
BOOL func_140(Hash hParam0) // Position - 0x4DF2
{
...
Hash func_141(Hash hParam0, int iParam1) // Position - 0x5002
{
	Hash num;
	int dlcWeaponIndex;
	int i;
...
int func_143(Hash hParam0, Any* panParam1) // Position - 0x5E24
{
	int i;
	int numDlcWeapons;
...
void func_158() // Position - 0x6181
{
	...
	if (fLocal_181 >= 0f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42895[10 /*31*/], fLocal_181, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42895[10 /*31*/], 4, false, true);
	}
	...
	if (fLocal_180 <= 0f)
	{
		OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42895[9 /*31*/], fLocal_180, false, true);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42895[9 /*31*/], 4, false, true);
	}
...
void func_160() // Position - 0x6299
{
	switch (iLocal_187)
	{
		case 0:
			...
			{
				if (Global_114162.f_24999.f_5 < 2)
				{
					if (Global_114162.f_24999.f_5 == 0)
						sLocal_407 = "ACULT_HI";
					else
				...
				else if (Global_114162.f_24999.f_5 >= 2)
				{
		...
		case 2:
			if (!PED::IS_PED_INJURED(uLocal_191[0]))
				if (PED::IS_PED_MALE(uLocal_191[0]))
					func_188(uLocal_191[0], "WHIMPER", "WAVELOAD_PAIN_MALE", 3, false);
				else
					func_188(uLocal_191[0], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3, false);
		
			if (!PED::IS_PED_INJURED(uLocal_191[1]))
				if (PED::IS_PED_MALE(uLocal_191[1]))
					func_188(uLocal_191[1], "WHIMPER", "WAVELOAD_PAIN_MALE", 3, false);
				else
					func_188(uLocal_191[1], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3, false);
		...
		case 4:
			...
			Global_114162.f_24999.f_5 = Global_114162.f_24999.f_5 + 2;
			bLocal_172 = true;
			break;
	}
...
void func_161(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6ADB
{
	...
	if (func_187(echParam0) == 3)
		return;

	if (func_187(echParam0) == 4)
		return;

	func_162(func_187(echParam0), 1, iParam1, iParam2, false);
...
int func_162(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x6BAD
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_185(99, 1);
					func_184(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 1:
					func_184(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 2:
					func_184(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_184(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 1:
							func_184(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 2:
							func_184(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_184(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 1:
							func_184(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 2:
							func_184(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_184(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 1:
							func_184(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 2:
							func_184(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_184(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 1:
							func_184(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 2:
							func_184(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_184(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 1:
									func_184(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 2:
									func_184(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_184(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 1:
									func_184(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 2:
									func_184(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_184(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 1:
									func_184(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 2:
									func_184(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_184(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 1:
									func_184(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 2:
									func_184(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_184(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 1:
					func_184(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 2:
					func_184(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_165(int iParam0) // Position - 0x7488
{
	...
	if (iParam0 == 12)
	{
		func_174(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_174(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_174(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_174(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_174(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_174(8277, 0, -1, true);
		return;
	}

	if (func_173(iParam0))
	{
		func_174(func_172(iParam0), 0, -1, true);
		return;
	}

	if (func_171(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_170(iParam0));
		_MPPLY_STAT_SET_INT(func_170(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114162.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_167() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114162.f_20568.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_167() /*5571*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x7654
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x7794
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x77B0
{
	Hash statHash;
	int outValue;
...
Hash func_170(int iParam0) // Position - 0x77CE
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_171(int iParam0) // Position - 0x77F0
{
	switch (iParam0)
	{
		case 38:
...
int func_172(int iParam0) // Position - 0x780D
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_173(int iParam0) // Position - 0x7912
{
	switch (iParam0)
	{
		case 18:
...
void func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x79A1
{
	Hash statName;

	if (iParam0 != 17239)
	{
		statName = func_175(iParam0, iParam2);
...
Hash func_175(int iParam0, int iParam1) // Position - 0x79CF
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_176(iParam1));
}

int func_176(int iParam0) // Position - 0x79E4
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7A18
{
	if (iParam2 == -1)
		iParam2 = func_27();
...
void func_178(int iParam0) // Position - 0x7A36
{
	func_185(93, iParam0);
	func_185(29, iParam0);
	func_185(30, iParam0);
...
BOOL func_179(int iParam0) // Position - 0x7A56
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_173(iParam0))
	{
		...
		num7 = func_180(func_172(iParam0), -1);
	...
	if (func_171(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_170(iParam0));
...
int func_180(int iParam0, int iParam1) // Position - 0x7C61
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x7C90
{
	if (iParam1 == -1)
		iParam1 = func_27();
...
int func_182(BOOL bParam0) // Position - 0x7CAC
{
	var outValue;
	int value;
	int outValue2;
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x7D63
{
...
void func_184(Hash hParam0, int iParam1) // Position - 0x7DB4
{
	int outValue;
...
void func_185(int iParam0, int iParam1) // Position - 0x7DD7
{
	int outValue;
...
int func_187(eCharacter echParam0) // Position - 0x7EA9
{
	return Global_2201[echParam0 /*29*/].f_17;
}

void func_188(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x7EBA
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x7ED4
{
	char* str;
...
void func_192(int iParam0) // Position - 0x80FD
{
	Global_23453 = iParam0;
	return;
}

BOOL func_193() // Position - 0x810A
{
	if (Global_23453 == 1)
		return true;
	...
	switch (iLocal_187)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("A_M_O_ACult_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_anim_cash_pile_02")) && STREAMING::HAS_ANIM_DICT_LOADED("random@altruist_cult") && AUDIO::PREPARE_MUSIC_EVENT("AC_DELIVERED") && WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_ASSAULTRIFLE")))
			{
				...
				else if (Global_114162.f_24999.f_5 == 1)
				{
				...
				else if (Global_114162.f_24999.f_5 >= 3)
				{
					sLocal_407 = "ACULT_CAPT";
					sLocal_401 = "cult_p7_guard_01";
					sLocal_402 = "cult_p7_guard_02";
		...
		case 1:
			...
			if (Global_114162.f_24999.f_5 >= 3)
			{
				iLocal_194[1] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_O_ACult_02"), -1041.7574f, 4908.4897f, 207.2777f, 305.3168f, true, true);
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_409, 2, iLocal_194[1], "ACULTMember2", 0, 1);
			}
		...
		case 4:
			...
			{
				AUDIO::TRIGGER_MUSIC_EVENT("AC_DONE");
				Global_114162.f_24999.f_5 = Global_114162.f_24999.f_5 + 1;
				bLocal_172 = true;
			}
			break;
...
void func_195() // Position - 0x8AF5
{
	if (func_197())
	{
		if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
		{
			if (PED::DOES_GROUP_EXIST(func_196()))
			{
				PED::GET_GROUP_SIZE(func_196(), &uLocal_184, &iLocal_185);
			
				if (iLocal_185 == 1)
				{
					uLocal_191[0] = PED::GET_PED_AS_GROUP_MEMBER(func_196(), 0);
				...
				{
					uLocal_191[0] = PED::GET_PED_AS_GROUP_MEMBER(func_196(), 0);
					uLocal_191[1] = PED::GET_PED_AS_GROUP_MEMBER(func_196(), 1);
...
int func_196() // Position - 0x8C00
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

BOOL func_197() // Position - 0x8C10
{
	return Global_33344;
}

void func_198() // Position - 0x8C1B
{
	if (func_201())
	{
		if (iLocal_398 == 0)
	...
	if (func_200())
	{
		if (bLocal_177)
		{
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_42895[9 /*31*/].f_2, 6f, Global_42895[9 /*31*/].f_5, false))
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_42895[9 /*31*/].f_5, Global_42895[9 /*31*/].f_2, false, 0f, false);
		
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_42895[10 /*31*/].f_2, 6f, Global_42895[10 /*31*/].f_5, false))
				OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_42895[10 /*31*/].f_5, Global_42895[10 /*31*/].f_2, false, 0f, false);
...
void func_202() // Position - 0x8FCD
{
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("AMBIENT_GANG_CULT"), joaat("PLAYER"));

	if (Global_114162.f_24999.f_5 >= iLocal_190 && Global_114162.f_24999.f_5 != 1000)
	{
		if (bLocal_170)
		{
			func_1(true);
		...
		else
		{
			...
			bLocal_177 = false;
			func_97();
			Global_114162.f_24999.f_5 = iLocal_190 - 1;
			SCRIPT::TERMINATE_THIS_THREAD();
		}
	}
	else
...
void func_203(int* piParam0) // Position - 0x90F9
{
