...
void main() // Position - 0x0
{
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
		func_306(-1339.7863f, -1277.5099f, 3.8874f, 261.2839f, 1, 0);

	if (_IS_MISSION_REPEAT_ACTIVE(false))
	{
		Global_114162.f_2367.f_539.f_2395[0] = -99;
		Global_114162.f_2367.f_539.f_2395[1] = -99;
		Global_114162.f_2367.f_539.f_2395[2] = -99;
		func_268();
	}
...
void func_23() // Position - 0x129C
{
	switch (iLocal_79)
	{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - iLocal_202 > 2000)
			{
				...
				if (func_44(&uLocal_380, &uLocal_376, &uLocal_211))
				{
					...
					if (Global_114162.f_2367.f_539.f_2395[0] == 38 && Global_114162.f_2367.f_539.f_2395[1] == 33 && Global_114162.f_2367.f_539.f_2395[2] == 54)
						func_42(821);
		...
		case 3:
			Global_114162.f_2367.f_539.f_2395[0] = 38;
			Global_114162.f_2367.f_539.f_2395[1] = 33;
			Global_114162.f_2367.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_79 = 2;
			break;
	}
...
BOOL func_29() // Position - 0x1726
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_30(Player plParam0, int iParam1) // Position - 0x1740
{
	BOOL flag;
...
int func_31(int iParam0, BOOL bParam1) // Position - 0x1799
{
	int num;
	int num2;
...
int func_32() // Position - 0x17DA
{
	return Global_1574926;
}

BOOL func_33(Player plParam0) // Position - 0x17E6
{
	Player player;
...
BOOL func_34(Player plParam0) // Position - 0x1808
{
...
int func_36(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1855
{
	int num;
...
void func_38(int iParam0) // Position - 0x18AF
{
	if (iParam0 == 1)
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x18E8
{
	int num;
	int num2;
	int num3;
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_79811.f_1 == 1 && func_41(Global_79811))
		{
		}
		else
		{
...
BOOL func_41(int iParam0) // Position - 0x19B8
{
	switch (iParam0)
	{
		case 71:
...
void func_42(int iParam0) // Position - 0x19F6
{
	BOOL flag;
	int i;
...
void func_43(BOOL bParam0, int iParam1) // Position - 0x1A67
{
	int i;
...
BOOL func_44(var uParam0, char* sParam1, var uParam2) // Position - 0x1B01
{
	switch (*uParam0)
	{
		case 0:
...
void func_45(int iParam0, int iParam1) // Position - 0x1C76
{
...
BOOL func_46(int iParam0) // Position - 0x1CB3
{
	if (iParam0 == 1)
...
void func_48(BOOL bParam0) // Position - 0x1D2D
{
...
void func_49(char* sParam0, char* sParam1) // Position - 0x1D41
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_22499 = 1;
...
int func_52(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1DDE
{
	int num;
	int address;
...
void func_53(eCharacter echParam0) // Position - 0x1F2F
{
	int i;
	int num;
	int j;
...
int func_54(int iParam0) // Position - 0x1FED
{
	switch (iParam0)
	{
		case 0:
...
int func_56() // Position - 0x217D
{
	return Global_79827;
}

BOOL func_57(Ped pedParam0, int iParam1) // Position - 0x2189
{
	return false;
}

Ped func_58(eCharacter echParam0) // Position - 0x21E2
{
	...
	return Global_99166[func_59(echParam0)];
}

int func_59(eCharacter echParam0) // Position - 0x2213
{
...
struct<4> func_60(BOOL bParam0) // Position - 0x224E
{
	var unk;
...
BOOL func_61(var uParam0, eCharacter echParam1, eCharacter echParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x22B4
{
...
BOOL func_62(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x231C
{
	Global_22443 = 0;
...
BOOL func_65(Player plParam0) // Position - 0x2684
{
	return func_66(plParam0, 20);
}

BOOL func_66(Player plParam0, int iParam1) // Position - 0x2694
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x26AC
{
	return -1;
}

void func_68() // Position - 0x26B5
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2814
{
	if (func_13(14))
	{
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x290D
{
	switch (iParam0)
	{
		case 5:
...
void func_75(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x299C
{
...
eCharacter func_77() // Position - 0x2AFA
{
	eCharacter num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2B33
{
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x2BCE
{
...
void func_80(BOOL bParam0) // Position - 0x2C13
{
	if (bParam0)
...
BOOL func_82(int iParam0) // Position - 0x2CAF
{
...
BOOL func_84(int iParam0) // Position - 0x2D23
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_85(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, char* sParam6) // Position - 0x2D50
{
...
Blip func_86(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x2D7F
{
	Blip blip;
...
BOOL func_87(const char* sParam0, int iParam1, const char* sParam2) // Position - 0x2DAD
{
...
BOOL func_88(int iParam0) // Position - 0x2DCB
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2DDB
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x2E3B
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x2E6A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x2E7F
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x2EB3
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x326A
{
	return Global_33105;
}

BOOL func_95(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x3275
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_96(int iParam0, BOOL bParam1) // Position - 0x3293
{
	func_101();
...
void func_97(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x333E
{
	if (func_267(pedParam0))
...
BOOL func_98(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3364
{
...
BOOL func_99(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x33C0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_100(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, BOOL bParam7) // Position - 0x3428
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_101() // Position - 0x34A3
{
	func_102(&uLocal_211);
	return;
}

void func_102(var uParam0) // Position - 0x34B1
{
	int num;
	char* str;
...
void func_104(BOOL bParam0) // Position - 0x3652
{
	func_105(iLocal_78);
...
void func_105(int iParam0) // Position - 0x3685
{
	switch (iParam0)
	{
		case 0:
...
void func_106(int iParam0, BOOL bParam1) // Position - 0x369D
{
	int i;
...
BOOL func_107(int iParam0) // Position - 0x36E7
{
	return func_89(iParam0, 5, true);
}

void func_108(char* sParam0, var uParam1) // Position - 0x36F7
{
	if (!*uParam1)
	{
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x3714
{
	iParam2 = iParam2;
...
void func_111(Vehicle* pveParam0) // Position - 0x3852
{
...
BOOL func_112(int iParam0) // Position - 0x388A
{
	return func_89(iParam0, 0, true);
}

void func_113(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x389A
{
...
void func_114(int iParam0) // Position - 0x395E
{
	if (iParam0 == 1)
...
BOOL func_115() // Position - 0x3987
{
	return IS_BIT_SET(Global_101713.f_20, 13);
}

void func_116(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x3998
{
	int num;
	...
	if (num == 1)
	{
		...
		*uParam0 = func_219(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_218(fParam1, 0f, 0f, 0f, false))
		{
...
BOOL func_117(var uParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3B2C
{
	int plateIndex;
	var plateText;
	Hash model;
	...
	if (func_14(echParam1))
	{
		...
		model.f_31 = 49;
		model.f_81 = 2;
		func_206(echParam1, &model, iParam7);
		...
		if (Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				if (func_205(&plateText, &plateIndex))
				{
				...
				func_195(uParam0, &(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_195(uParam0, &(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_118(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4951
{
	var unk;
	Entity trailer;
	...
	if (func_14(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_122(uParam1, &(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114162.f_20122[echParam0 /*43*/].f_31 = func_121(*uParam1);
				...
				func_119(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114162.f_20122[echParam0 /*43*/].f_1));
				...
				func_119(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114162.f_20122[echParam0 /*43*/].f_2));
			}
		}
	}
...
int func_119(int iParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4) // Position - 0x5565
{
	int i;
	int num;
	var unk;
...
BOOL func_120(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x55D8
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_121(Vehicle veParam0) // Position - 0x6ACA
{
	int num;
	int num2;
	int num3;
...
int func_122(var uParam0, var uParam1, var uParam2) // Position - 0x6B7A
{
	int i;
	int modType;
...
BOOL func_123(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x6D6D
{
	Hash entityModel;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_131(veParam0) && !flag && !(func_130(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_129(PLAYER::PLAYER_ID())) && !(func_128(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_125(PLAYER::PLAYER_ID())))
	{
...
BOOL func_124(Vehicle veParam0) // Position - 0x6EF8
{
	int i;
...
BOOL func_125(Player plParam0) // Position - 0x6F33
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 32;

	return false;
}

int func_126(int iParam0) // Position - 0x6F7A
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x74AF
{
	Player player;
...
BOOL func_128(Hash hParam0) // Position - 0x750F
{
...
BOOL func_129(Player plParam0) // Position - 0x7526
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_130(Hash hParam0) // Position - 0x756D
{
...
BOOL func_131(Vehicle veParam0) // Position - 0x75AF
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_132(Player plParam0) // Position - 0x7677
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_133(Player plParam0) // Position - 0x76BE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_134(Player plParam0) // Position - 0x7705
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_135(Hash hParam0) // Position - 0x774B
{
	BOOL flag;
...
Hash func_136(BOOL bParam0) // Position - 0x77DC
{
	if (bParam0)
...
BOOL func_137(Player plParam0) // Position - 0x77F6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_138(Vehicle veParam0) // Position - 0x781C
{
...
BOOL func_139(Vehicle veParam0) // Position - 0x784B
{
...
BOOL func_140(Vehicle veParam0) // Position - 0x79B3
{
	Hash entityModel;
...
BOOL func_141(Hash hParam0) // Position - 0x7A30
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_142(Player plParam0) // Position - 0x7A8C
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_165(plParam0) && Global_2657994[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_143(Vehicle veParam0, BOOL bParam1) // Position - 0x7AC5
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
int func_144(Vehicle veParam0) // Position - 0x7B20
{
	int i;
...
BOOL func_145(Hash hParam0, int iParam1) // Position - 0x7B59
{
	if (iParam1 == 0)
...
BOOL func_155(Vehicle veParam0) // Position - 0x8440
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_159(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > 0 || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
	
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", INT))
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_157() != -1 && func_157() < 547)
						if (!func_156(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1586542[func_157() /*143*/].f_66)
							return true;
					else
						return true;
	}
...
BOOL func_156(Vehicle veParam0) // Position - 0x8539
{
...
int func_157() // Position - 0x8552
{
	return Global_2359296[func_158() /*5571*/].f_681.f_2;
}

int func_158() // Position - 0x856A
{
	int num;
...
BOOL func_159(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8577
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_160(Player plParam0) // Position - 0x85DB
{
...
BOOL func_161() // Position - 0x860C
{
	return func_162() != -1;
}

int func_162() // Position - 0x861A
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

BOOL func_163(Player plParam0) // Position - 0x8632
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_164(Player plParam0) // Position - 0x8691
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_165(Player plParam0) // Position - 0x86F1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_166(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x8738
{
	BOOL flag;
...
BOOL func_167(Hash hParam0) // Position - 0x8B29
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_168(Vehicle veParam0, eCharacter echParam1) // Position - 0x8B5E
{
	...
	func_169(veParam0, &(Global_114162.f_32754.f_5510));
	return;
}

void func_169(Vehicle veParam0, var uParam1) // Position - 0x8D60
{
	int i;
...
int func_170(int iParam0) // Position - 0x900B
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_171(int iParam0) // Position - 0x90BB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_172(var uParam0) // Position - 0x90DB
{
	int i;
...
BOOL func_174(Hash hParam0) // Position - 0x9268
{
	if (hParam0 == 0)
		return false;

	if (!func_175(hParam0, false, -1))
		return false;
...
BOOL func_175(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x9426
{
	int i;
	Hash outData;
...
BOOL func_176(Hash hParam0) // Position - 0x95AB
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x9677
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_178(Hash hParam0, int iParam1) // Position - 0x968E
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x98BB
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x98D1
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_181() // Position - 0x98E7
{
	return false;
}

BOOL func_182() // Position - 0x98F0
{
	return true;
}

BOOL func_183() // Position - 0x98F9
{
	return true;
}

BOOL func_184() // Position - 0x9902
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x991B
{
	int profileSetting;
...
BOOL func_186(Vehicle veParam0) // Position - 0x99D3
{
	Hash entityModel;
...
BOOL func_187(Vehicle veParam0) // Position - 0x9A1A
{
	int i;
...
BOOL func_188(Vehicle veParam0) // Position - 0x9A96
{
	int i;
...
eCharacter func_189(Vehicle veParam0) // Position - 0x9B7E
{
	int i;
...
BOOL func_190(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x9BE1
{
	int i;
	var garageName;
	int num;
...
BOOL func_191(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x9C4F
{
...
void func_192(Vehicle veParam0, eCharacter echParam1) // Position - 0x9D27
{
	int i;
...
void func_193(var uParam0) // Position - 0x9DA9
{
	if (!func_194(*uParam0))
...
BOOL func_194(Vehicle veParam0) // Position - 0x9DD4
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_195(var uParam0, var uParam1, var uParam2) // Position - 0x9DE3
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_203(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_200(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_198(*uParam0, uParam1->[38] - 1))
...
BOOL func_196(Vehicle veParam0) // Position - 0x9FE1
{
	int i;
	int modType;
	Hash hashKey;
...
void func_197(var uParam0) // Position - 0xA0BD
{
...
int func_198(Vehicle veParam0, int iParam1) // Position - 0xA128
{
	int value;
	int value2;
	float num;
...
int func_199(Vehicle veParam0, int iParam1) // Position - 0xA211
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_203(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_200(Hash hParam0) // Position - 0xA273
{
...
BOOL func_201(Vehicle veParam0) // Position - 0xA29E
{
	Hash entityModel;
...
BOOL func_202(Hash hParam0) // Position - 0xA2E4
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_203(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xA38E
{
	if (!func_204() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_204() // Position - 0xA3B2
{
	return true;
}

BOOL func_205(var uParam0, var uParam1) // Position - 0xA3BF
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_206(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xA400
{
	int num;
...
void func_207(eCharacter echParam0, int iParam1) // Position - 0xA65C
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99019[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99019[i]) == func_208(echParam0, iParam1))
				{
...
Hash func_208(eCharacter echParam0, int iParam1) // Position - 0xA6FA
{
	int num;
...
void func_209(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xA73C
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_217(&Global_78354.f_555[0 /*21*/], i))
...
void func_210(int iParam0) // Position - 0xA78C
{
	BOOL flag;
	...
	if (func_217(&Global_78354.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_216(iParam0, 0) && Global_79263.f_66 == 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] != 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] > 3 && !func_214(0, Global_78354.f_555[0 /*21*/].f_12) || !func_214(1, Global_78354.f_555[0 /*21*/].f_12))
			{
				func_213(&Global_114162.f_32754.f_69[Global_78354.f_555[0 /*21*/].f_14 /*78*/], &Global_79263);
...
void func_211(int iParam0, BOOL bParam1) // Position - 0xA8FB
{
	if (iParam0 == -1)
		return;
...
void func_212(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA958
{
	if (iParam0 == -1)
		return;
...
void func_213(var uParam0, var uParam1) // Position - 0xA993
{
...
BOOL func_214(int iParam0, int iParam1) // Position - 0xAA5F
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_215(&Global_114162.f_32754.f_5038[num /*157*/]))
		return false;

	return func_175(Global_114162.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_215(var uParam0) // Position - 0xAAD2
{
	return *uParam0;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0xAADD
{
	if (iParam0 == -1)
		return false;
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xAAFD
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_218(Global_114162.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_218(Global_114162.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_218(Global_114162.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_218(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC1ED
{
	if (bParam6)
...
Vehicle func_219(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xC234
{
	return func_220(&(Global_107707.f_2890), uParam0, fParam3, false);
}

Vehicle func_220(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xC24E
{
	Vehicle vehicle;
	...
	if (func_244(uParam0))
	{
		...
		if (func_243(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehicle))
			{
				...
				func_224(vehicle, &(uParam0->f_12), false, true);
				flag = true;
				...
				else if (!func_222(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					num = func_221(vehicle);
...
int func_221(Vehicle veParam0) // Position - 0xC500
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_222(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xC5C3
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_223(veParam0, Global_78354.f_139[38], false))
			{
				func_210(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_223(veParam0, Global_78354.f_139[43], true))
			{
				func_210(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_223(veParam0, sizeAndVehs[i], true) && func_100(ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_218(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(veParam0, true), ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), true) < 10f)
					{
...
BOOL func_223(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xC7CB
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_224(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC82C
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_233(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_232())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_231(veParam0, uParam1->f_69);
				else
					func_231(veParam0, uParam1->f_69);
		...
		if (func_226() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_136(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_225(veParam0, 5f))
...
BOOL func_225(Vehicle veParam0, float fParam1) // Position - 0xCF31
{
	float entityCoords;
	var groundZ;
...
BOOL func_226() // Position - 0xCFA2
{
	...
	if (func_229(7))
		if (func_228(Global_2672942.f_4.f_16) || func_227(Global_2672942.f_4.f_16))
			return false;

	return true;
}

BOOL func_227(int iParam0) // Position - 0xD031
{
	int num;
...
BOOL func_228(int iParam0) // Position - 0xD055
{
	int num;
...
BOOL func_229(int iParam0) // Position - 0xD073
{
	return func_230(&(Global_2672942.f_194), iParam0);
}

BOOL func_230(var uParam0, int iParam1) // Position - 0xD087
{
	int num;
	int num2;
	int num3;
...
void func_231(Vehicle veParam0, int iParam1) // Position - 0xD0AA
{
	int vehicleMod;
...
BOOL func_232() // Position - 0xD122
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_233(Vehicle veParam0) // Position - 0xD133
{
	int _int;
...
int func_234(var uParam0) // Position - 0xD17B
{
...
BOOL func_235(int iParam0) // Position - 0xD19B
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_236(Vehicle veParam0) // Position - 0xD1EE
{
	...
	if (func_238(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_237(veParam0) != -1)
				return true;

	return false;
}

int func_237(Vehicle veParam0) // Position - 0xD275
{
...
int func_238(Player plParam0) // Position - 0xD2A4
{
	if (func_241(plParam0) == 233)
		return func_239(plParam0);

	return -1;
}

int func_239(Player plParam0) // Position - 0xD2C1
{
...
BOOL func_240(Player plParam0, BOOL bParam1) // Position - 0xD2E4
{
	if (func_33(plParam0))
...
int func_241(Player plParam0) // Position - 0xD328
{
	if (func_33(plParam0))
		if (func_240(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xD354
{
...
BOOL func_243(var uParam0) // Position - 0xD3A1
{
	if (func_244(uParam0))
	{
...
BOOL func_244(var uParam0) // Position - 0xD3D6
{
...
BOOL func_245() // Position - 0xD436
{
	return func_243(&(Global_107707.f_2890));
}

void func_246() // Position - 0xD449
{
	func_247(&(Global_107707.f_2890));
	return;
}

void func_247(var uParam0) // Position - 0xD45C
{
	if (func_244(uParam0))
...
BOOL func_248(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD47A
{
	...
	if (iParam2 == 0 && func_250(Global_107707.f_2890.f_12.f_66))
		return false;
...
BOOL func_250(Hash hParam0) // Position - 0xD57D
{
	switch (hParam0)
	{
		case joaat("police"):
...
BOOL func_251() // Position - 0xD625
{
	return func_244(&(Global_107707.f_2890));
}

void func_252(int iParam0) // Position - 0xD638
{
	Global_97543 = 0;
...
void func_253(int iParam0) // Position - 0xD6C6
{
	MISC::SET_BIT(&Global_97543, iParam0);
	return;
}

void func_254() // Position - 0xD6D8
{
...
BOOL func_255() // Position - 0xD795
{
	...
	if (!func_256(bLocal_188, num) && !bLocal_188)
		return false;

	return true;
}

BOOL func_256(BOOL bParam0, int iParam1) // Position - 0xD7D1
{
	int num;
...
int func_257(int iParam0, int iParam1) // Position - 0xD81D
{
	int num;

	num = func_258(iParam0) - iParam1;
	return num;
}

int func_258(int iParam0) // Position - 0xD832
{
	return Global_61500[iParam0];
}

BOOL func_259(int iParam0) // Position - 0xD841
{
	return func_89(iParam0, 1, true);
}

void func_260(int iParam0) // Position - 0xD851
{
	HUD::CLEAR_PRINTS();
	func_261();
...
void func_263() // Position - 0xD908
{
	if (func_265())
	{
		...
		{
			case CHAR_MICHAEL:
				if (Global_114162.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114162.f_2367.f_539.f_2395[1] == -99)
					func_264(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114162.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
		
			case CHAR_FRANKLIN:
				if (Global_114162.f_2367.f_539.f_2395[1] == -99)
					func_264(uLocal_206[1], uLocal_206[0], uLocal_206[2]);
				else if (Global_114162.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114162.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				break;
			...
			case CHAR_TREVOR:
				if (Global_114162.f_2367.f_539.f_2395[2] == -99)
					func_264(uLocal_206[2], uLocal_206[1], uLocal_206[0]);
				else if (Global_114162.f_2367.f_539.f_2395[0] == -99)
					func_264(uLocal_206[0], uLocal_206[1], uLocal_206[2]);
				else if (Global_114162.f_2367.f_539.f_2395[1] == -99)
...
void func_264(const char* sParam0, const char* sParam1, const char* sParam2) // Position - 0xDABE
{
...
BOOL func_265() // Position - 0xDAFA
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

int func_266() // Position - 0xDB0F
{
	int num;
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_114162.f_2367.f_539.f_2395[i] != -99)
			num = num + 1;
	}
...
BOOL func_267(Ped pedParam0) // Position - 0xDB4B
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
...
void func_268() // Position - 0xDB6B
{
	...
	if (func_258(num) < 1500)
		func_269(_GET_CURRENT_PLAYER_CHARACTER(), 96, 1500, false, false);

	return;
}

void func_269(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDBBB
{
	int outValue;
	Hash statHash;

	if (func_304(echParam0) == 3)
		return;

	if (func_304(echParam0) == 4)
		return;

	func_270(func_304(echParam0), 1, iParam1, iParam2, false);
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xDC8D
{
	float num;
	int num2;
	int num3;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_302(99, 1);
					func_301(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 1:
					func_301(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 2:
					func_301(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_301(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 1:
							func_301(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 2:
							func_301(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_301(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 1:
							func_301(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 2:
							func_301(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_301(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 1:
							func_301(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 2:
							func_301(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_301(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 1:
							func_301(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 2:
							func_301(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_301(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 1:
									func_301(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 2:
									func_301(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_301(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 1:
									func_301(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 2:
									func_301(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_301(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 1:
									func_301(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 2:
									func_301(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_301(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 1:
									func_301(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 2:
									func_301(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_301(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 1:
					func_301(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 2:
					func_301(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_271(BOOL bParam0) // Position - 0xE28C
{
	int i;
	int j;
...
void func_272(int iParam0) // Position - 0xE50E
{
	int value;
...
void func_273(int iParam0) // Position - 0xE568
{
	int num;
	BOOL flag;
	var txdName;
	...
	if (iParam0 == 12)
	{
		func_281(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_281(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_281(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_281(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_281(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_281(8277, 0, -1, true);
		return;
	}

	if (func_280(iParam0))
	{
		func_281(func_279(iParam0), 0, -1, true);
		return;
	}

	if (func_278(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_277(iParam0));
		_MPPLY_STAT_SET_INT(func_277(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114162.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_158() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114162.f_20568.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_158() /*5571*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xE733
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0xE865
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0xE881
{
	Hash statHash;
	int outValue;
...
Hash func_277(int iParam0) // Position - 0xE89F
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_278(int iParam0) // Position - 0xE8C1
{
	switch (iParam0)
	{
		case 38:
...
int func_279(int iParam0) // Position - 0xE8DE
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_280(int iParam0) // Position - 0xE9E3
{
	switch (iParam0)
	{
		case 18:
...
void func_281(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEA72
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xEAA0
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
void func_283(int iParam0) // Position - 0xEABE
{
	func_302(93, iParam0);
	func_302(29, iParam0);
	func_302(30, iParam0);
...
BOOL func_284(int iParam0) // Position - 0xEADE
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_280(iParam0))
	{
		...
		num7 = func_90(func_279(iParam0), -1);
	...
	if (func_278(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_277(iParam0));
	...
	return IS_BIT_SET(Global_2359296[func_158() /*5571*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xECE9
{
	if (iParam1 == -1)
		iParam1 = func_32();
...
int func_286(BOOL bParam0) // Position - 0xED05
{
	var outValue;
	int value;
	int outValue2;
...
int func_287(int iParam0, int iParam1) // Position - 0xEDBC
{
	if (iParam0 >= 78)
		return 0;
...
int func_288(int iParam0, int iParam1) // Position - 0xEDD7
{
	if (func_13(14) && !func_299(iParam0))
		return 0;
	...
	if (func_298(&Global_4546323))
	{
		if (func_296(&Global_4546323, iParam0))
			return 0;
	
		if (func_289(&Global_4546323, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_289(var uParam0, int iParam1) // Position - 0xEE74
{
	int i;
	var unk;
	...
	if (func_13(14) && !func_299(iParam1))
		return false;
...
int func_290(var uParam0, int iParam1) // Position - 0xEF25
{
	int i;
...
BOOL func_291(var uParam0, int iParam1) // Position - 0xEFA0
{
	return uParam0->[iParam1] == 78;
}

void func_292(var uParam0) // Position - 0xEFB1
{
	int i;
	...
	func_294(uParam0, Global_4546322 - 0.5f);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0xEFE5
{
	uParam0->[iParam1] = 78;
	return;
}

void func_294(var uParam0, int iParam1) // Position - 0xEFF5
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_295(var uParam0) // Position - 0xF012
{
	return uParam0->f_80;
}

BOOL func_296(var uParam0, int iParam1) // Position - 0xF01E
{
	return func_297(uParam0, iParam1) != -1;
}

int func_297(var uParam0, int iParam1) // Position - 0xF030
{
	int i;
...
BOOL func_298(var uParam0) // Position - 0xF05D
{
	return uParam0->f_79 == 1;
}

BOOL func_299(int iParam0) // Position - 0xF06B
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_300(int iParam0, int iParam1) // Position - 0xF0BB
{
...
void func_301(Hash hParam0, int iParam1) // Position - 0xF10C
{
	int outValue;
...
void func_302(int iParam0, int iParam1) // Position - 0xF12F
{
	int outValue;
...
int func_304(eCharacter echParam0) // Position - 0xF201
{
	return Global_2201[echParam0 /*29*/].f_17;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xF212
{
...
void func_306(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0xF23A
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xF2CF
{
...
void func_308() // Position - 0xF2F3
{
	func_309(joaat("Player_Zero"), 14, 31, true);
	func_309(joaat("Player_Zero"), 14, 32, true);
	func_309(joaat("Player_Zero"), 14, 33, true);
	func_309(joaat("Player_Zero"), 14, 34, true);
	func_309(joaat("Player_Zero"), 14, 35, true);
	func_309(joaat("Player_Zero"), 14, 36, true);
	func_309(joaat("Player_Zero"), 14, 37, true);
	func_309(joaat("Player_Zero"), 14, 38, true);
	func_309(joaat("Player_Zero"), 14, 39, true);
	func_309(joaat("Player_Zero"), 14, 40, true);
	func_309(joaat("Player_Zero"), 14, 41, true);
	func_309(joaat("Player_Zero"), 14, 42, true);
	func_309(joaat("Player_Zero"), 14, 43, true);
	func_309(joaat("Player_Zero"), 14, 44, true);
	func_309(joaat("Player_Zero"), 9, 9, true);
	func_309(joaat("Player_Zero"), 9, 10, true);
	func_309(joaat("Player_Zero"), 9, 11, true);
	func_309(joaat("Player_Zero"), 9, 12, true);
	func_309(joaat("Player_Zero"), 9, 13, true);
	func_309(joaat("Player_Zero"), 9, 14, true);
	func_309(joaat("Player_One"), 14, 26, true);
	func_309(joaat("Player_One"), 14, 27, true);
	func_309(joaat("Player_One"), 14, 28, true);
	func_309(joaat("Player_One"), 14, 29, true);
	func_309(joaat("Player_One"), 14, 30, true);
	func_309(joaat("Player_One"), 14, 31, true);
	func_309(joaat("Player_One"), 14, 32, true);
	func_309(joaat("Player_One"), 14, 33, true);
	func_309(joaat("Player_One"), 14, 34, true);
	func_309(joaat("Player_One"), 14, 35, true);
	func_309(joaat("Player_One"), 14, 36, true);
	func_309(joaat("Player_One"), 14, 37, true);
	func_309(joaat("Player_One"), 14, 38, true);
	func_309(joaat("Player_One"), 14, 39, true);
	func_309(joaat("Player_One"), 9, 5, true);
	func_309(joaat("Player_One"), 9, 6, true);
	func_309(joaat("Player_One"), 9, 7, true);
	func_309(joaat("Player_One"), 9, 8, true);
	func_309(joaat("Player_One"), 9, 9, true);
	func_309(joaat("Player_One"), 9, 10, true);
	func_309(joaat("Player_Two"), 14, 49, true);
	func_309(joaat("Player_Two"), 14, 50, true);
	func_309(joaat("Player_Two"), 14, 51, true);
	func_309(joaat("Player_Two"), 14, 52, true);
	func_309(joaat("Player_Two"), 14, 53, true);
	func_309(joaat("Player_Two"), 14, 54, true);
	func_309(joaat("Player_Two"), 14, 55, true);
	func_309(joaat("Player_Two"), 14, 56, true);
	func_309(joaat("Player_Two"), 14, 57, true);
	func_309(joaat("Player_Two"), 14, 58, true);
	func_309(joaat("Player_Two"), 14, 59, true);
	func_309(joaat("Player_Two"), 14, 60, true);
	func_309(joaat("Player_Two"), 9, 9, true);
	func_309(joaat("Player_Two"), 9, 10, true);
	func_309(joaat("Player_Two"), 9, 11, true);
	func_309(joaat("Player_Two"), 9, 12, true);
	func_309(joaat("Player_Two"), 9, 13, true);
	func_309(joaat("Player_Two"), 9, 14, true);
	func_309(joaat("Player_Two"), 9, 15, true);
	func_309(joaat("Player_Two"), 9, 16, true);
	return;
}

int func_309(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF643
{
	Global_79347[1 /*14*/] = { func_311(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_79347[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79347[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_310(iParam1, Global_79347[1 /*14*/].f_5, Global_79347[1 /*14*/].f_2, 0, Global_79347[1 /*14*/].f_1, 1, 0);
		else
			func_310(iParam1, Global_79347[1 /*14*/].f_5, Global_79347[1 /*14*/].f_2, 0, Global_79347[1 /*14*/].f_1, 0, 1);
...
BOOL func_310(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF6D9
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_311(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1057D
{
	func_376();
...
void func_312(int iParam0, int iParam1) // Position - 0x105CF
{
	switch (iParam0)
	{
		case 0:
...
void func_313(int iParam0) // Position - 0x106BF
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			func_321(num6, iParam0, 155, -1);
			return;
	}

	func_314(&Global_79347[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_314(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x11936
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_318(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_318(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_310(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_310(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_310(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_90(func_317(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_90(func_316(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_315(iParam1, iParam0->f_2, &num2))
			{
...
BOOL func_315(int iParam0, int iParam1, var uParam2) // Position - 0x11CD8
{
	*uParam2 = 979;
...
int func_316(int iParam0, int iParam1) // Position - 0x120DD
{
	switch (iParam1)
	{
		case 0:
...
int func_317(int iParam0, int iParam1) // Position - 0x124D8
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_318(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x128D3
{
	int num;
	int num2;
	int num3;
	...
	if (func_319(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_319(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x12911
{
...
int func_320(int iParam0) // Position - 0x15536
{
	switch (iParam0)
	{
		case -1:
...
void func_321(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1560A
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_314(&Global_79347[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_314(&Global_79347[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_314(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_314(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_322(iParam0));
...
int func_322(int iParam0) // Position - 0x15891
{
	switch (iParam0)
	{
		case 0:
...
void func_323(int iParam0) // Position - 0x15941
{
	BOOL flag;
	int num;
	var unk;
...
void func_324(int iParam0) // Position - 0x15A98
{
	BOOL flag;
	int num;
	var unk;
...
void func_325(int iParam0) // Position - 0x15FA6
{
	BOOL flag;
	int num;
	var unk;
...
void func_326(int iParam0) // Position - 0x1601B
{
	BOOL flag;
	int num;
	var unk;
...
void func_327(int iParam0) // Position - 0x1608F
{
	BOOL flag;
	int num;
	var unk;
...
void func_328(int iParam0) // Position - 0x16176
{
	BOOL flag;
	int num;
	var unk;
...
void func_329(int iParam0) // Position - 0x164D9
{
	BOOL flag;
	int num;
	var unk;
...
void func_330(int iParam0) // Position - 0x166EA
{
	BOOL flag;
	int num;
	var unk;
...
void func_331(int iParam0) // Position - 0x1691A
{
	BOOL flag;
	int num;
	var unk;
...
void func_332(int iParam0) // Position - 0x16A2A
{
	BOOL flag;
	int num;
	var unk;
...
void func_333(int iParam0) // Position - 0x173C9
{
	BOOL flag;
	int num;
	var unk;
...
void func_334(int iParam0) // Position - 0x17F3C
{
	if (iParam0 < 136)
		func_336(iParam0);
	else
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_321(3, iParam0, 242, -1);

	return;
}

void func_335(int iParam0) // Position - 0x17F71
{
	BOOL flag;
	int num;
	var unk;
...
void func_336(int iParam0) // Position - 0x18BDD
{
	BOOL flag;
	int num;
	var unk;
...
void func_337(int iParam0) // Position - 0x19AEB
{
	BOOL flag;
	int num;
	var unk;
...
void func_338(int iParam0) // Position - 0x19C18
{
	BOOL flag;
	int num;
	var unk;
...
void func_339(int iParam0, int iParam1) // Position - 0x19D16
{
	switch (iParam0)
	{
		case 0:
...
void func_340(int iParam0) // Position - 0x19E06
{
	BOOL flag;
	int num;
	var unk;
...
void func_341(int iParam0) // Position - 0x1B2F7
{
	BOOL flag;
	int num;
	var unk;
...
void func_342(int iParam0) // Position - 0x1B448
{
	BOOL flag;
	int num;
	var unk;
...
void func_343(int iParam0) // Position - 0x1B953
{
	BOOL flag;
	int num;
	var unk;
...
void func_344(int iParam0) // Position - 0x1BFC1
{
	BOOL flag;
	int num;
	var unk;
...
void func_345(int iParam0) // Position - 0x1C036
{
	BOOL flag;
	int num;
	var unk;
...
void func_346(int iParam0) // Position - 0x1C106
{
	BOOL flag;
	int num;
	var unk;
...
void func_347(int iParam0) // Position - 0x1C636
{
	BOOL flag;
	int num;
	var unk;
...
void func_348(int iParam0) // Position - 0x1C7CD
{
	BOOL flag;
	int num;
	var unk;
...
void func_349(int iParam0) // Position - 0x1CFCB
{
	BOOL flag;
	int num;
	var unk;
...
void func_350(int iParam0) // Position - 0x1D0DB
{
	BOOL flag;
	int num;
	var unk;
...
void func_351(int iParam0) // Position - 0x1E006
{
	BOOL flag;
	int num;
	var unk;
...
void func_352(int iParam0) // Position - 0x1ECC3
{
	if (iParam0 < 107)
		func_355(iParam0);
	else if (iParam0 < 227)
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_321(3, iParam0, 318, -1);

	return;
}

void func_353(int iParam0) // Position - 0x1ED09
{
	BOOL flag;
	int num;
	var unk;
...
void func_354(int iParam0) // Position - 0x1F7AE
{
	BOOL flag;
	int num;
	var unk;
...
void func_355(int iParam0) // Position - 0x2059F
{
	BOOL flag;
	int num;
	var unk;
...
void func_356(int iParam0) // Position - 0x211E8
{
	BOOL flag;
	int num;
	var unk;
...
void func_357(int iParam0) // Position - 0x21461
{
	BOOL flag;
	int num;
	var unk;
...
void func_358(int iParam0, int iParam1) // Position - 0x215A7
{
	switch (iParam0)
	{
		case 0:
...
void func_359(int iParam0) // Position - 0x21697
{
	BOOL flag;
	int num;
	var unk;
...
void func_360(int iParam0) // Position - 0x22421
{
	BOOL flag;
	int num;
	var unk;
...
void func_361(int iParam0) // Position - 0x2259B
{
	BOOL flag;
	int num;
	var unk;
...
void func_362(int iParam0) // Position - 0x22B12
{
	BOOL flag;
	int num;
	var unk;
...
void func_363(int iParam0) // Position - 0x2303C
{
	BOOL flag;
	int num;
	var unk;
...
void func_364(int iParam0) // Position - 0x230B0
{
	BOOL flag;
	int num;
	var unk;
...
void func_365(int iParam0) // Position - 0x23180
{
	BOOL flag;
	int num;
	var unk;
...
void func_366(int iParam0) // Position - 0x23658
{
	BOOL flag;
	int num;
	var unk;
...
void func_367(int iParam0) // Position - 0x238C1
{
	BOOL flag;
	int num;
	var unk;
...
void func_368(int iParam0) // Position - 0x23B97
{
	BOOL flag;
	int num;
	var unk;
...
void func_369(int iParam0) // Position - 0x23D60
{
	BOOL flag;
	int num;
	var unk;
...
void func_370(int iParam0) // Position - 0x248B7
{
	BOOL flag;
	int num;
	var unk;
...
void func_371(int iParam0) // Position - 0x25501
{
	if (iParam0 < 60)
		func_373(iParam0);
	else
	...
	if (Global_79347[0 /*14*/].f_2 == -1)
		func_321(3, iParam0, 181, -1);

	return;
}

void func_372(int iParam0) // Position - 0x25536
{
	BOOL flag;
	int num;
	var unk;
...
void func_373(int iParam0) // Position - 0x262D6
{
	BOOL flag;
	int num;
	var unk;
...
void func_374(int iParam0) // Position - 0x26962
{
	BOOL flag;
	int num;
	var unk;
...
void func_375(int iParam0) // Position - 0x26A49
{
	BOOL flag;
	int num;
	var unk;
...
void func_376() // Position - 0x26B47
{
...
void func_377() // Position - 0x26BC0
{
	func_386();
	func_385();
	func_378();
...
void func_378() // Position - 0x26BD4
{
	var unk;
...
void func_379(var uParam0, int iParam1) // Position - 0x26C41
{
	int i;
	...
	{
		func_383(&uLocal_80, uParam0->[i /*3*/]);
	}

	func_382(&uLocal_80);
	func_380(&uLocal_132, &uLocal_80, 50f);
	return;
}

void func_380(var uParam0, var uParam1, float fParam2) // Position - 0x26C85
{
	int num;
	int num2;
	int num3;
	...
	while (num2 < uParam1->f_46)
	{
		...
		if (func_381(uParam1, uParam1->[num2 /*3*/] + num6))
			num6 = { -num6 };
...
BOOL func_381(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x26D92
{
	BOOL flag;
	int num;
	int num2;
...
void func_382(var uParam0) // Position - 0x26E4E
{
	int i;
	float num;
...
void func_383(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x26EEE
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_384(var uParam0) // Position - 0x26F1F
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_385() // Position - 0x26F46
{
...
void func_386() // Position - 0x26F66
{
	return;
}

void func_387() // Position - 0x26F6E
{
	func_398(true);
	func_397();
	func_388(false);
...
void func_388(BOOL bParam0) // Position - 0x26F88
{
	bParam0;
	func_396(true, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
...
void func_389() // Position - 0x26FF3
{
	return;
}

void func_390() // Position - 0x26FFB
{
	Global_21308 = 0;
	func_391();
	return;
...
void func_391() // Position - 0x2700B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
void func_392() // Position - 0x2702C
{
	return;
}

void func_393() // Position - 0x27034
{
	return;
}

void func_394() // Position - 0x2703C
{
	return;
}

void func_395() // Position - 0x27044
{
	return;
}

void func_396(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2704C
{
...
void func_397() // Position - 0x270AB
{
	Global_97543 = 0;
	return;
}

void func_398(BOOL bParam0) // Position - 0x270B8
{
...
void func_399() // Position - 0x270FF
{
	int num;
...
BOOL func_400() // Position - 0x27170
{
	if (Global_101713 == 13 || Global_101713 == 10 || Global_101713 == 11 || Global_101713 == 12)
		return false;
...
void func_401() // Position - 0x271AE
{
	Global_114162.f_2367.f_539.f_2395[0] = -99;
	Global_114162.f_2367.f_539.f_2395[1] = -99;
	Global_114162.f_2367.f_539.f_2395[2] = -99;
