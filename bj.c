...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82))
		func_568(&unk15, &unk1091, &entity2, &train, &vehicle, &sizeAndVehs, &playersLastVehicle, &unk915, &entity, &ped, &num8, soundId, &num21, blip, blip2, num4, &num7, hasPedGotWeapon);

	if (num19 < 0)
		return;

	if (IS_BIT_SET(Global_114162.f_18971.f_1, num19))
		num10 = 0.1f;
	...
	if (ENTITY::DOES_ENTITY_EXIST(entity2))
	{
		...
		if (func_539(&unk15) != 0 && ENTITY::GET_ENTITY_MODEL(entity2) == func_539(&unk15))
		{
			vehicle = entity2;
			entity2 = 0;
		}
	...
	while (true)
	{
		...
		func_519(&unk100);
		func_515(&unk110, num);
		func_511(&unk110, num, num4, flag4);
		...
		switch (num)
		{
			case 0:
				...
				func_504();
				func_503(true);
				func_499("AM_H_BASEJ" /*Parachuting now available at ~BLIP_BASE_JUMP~*/, 1);
				HUD::CLEAR_PRINTS();
				HUD::CLEAR_HELP(true);
				...
				{
					func_495(-74.9632f, -827.4467f, 324.9521f, 25f, true);
				...
				if (num4 == 6 || num4 == 12 || num4 == 5)
				{
					...
					func_485(&unk106, &unk15, num4, num4 == 6);
					flag12 = true;
				}
			...
			case 1:
				if (CAM::IS_SCREEN_FADED_OUT() || num4 == 5 || num4 == 6 || num4 == 12 && !flag4)
				{
					if (!flag4)
					{
						...
						{
							num9 = { func_484(num4) };
							num9 = { func_483(SYSTEM::COS(num9.f_2), SYSTEM::SIN(num9.f_2), MISC::TAN(num9)) };
						
							if (func_482(num4))
								STREAMING::NEW_LOAD_SCENE_START(func_481(num4), num9, 4000f, 0);
						}
					
						func_475(&unk15, num4, &unk, &hash, &hash2, &unk1091, &num22);
					}
					else if (func_473(func_474(num4)))
					{
						vector3 = { { 1.2f, 1.2f, 1.2f } * { 0f, -SYSTEM::COS(-97.4239f + func_472(&unk15)), SYSTEM::SIN(-97.4239f + func_472(&unk15)) } };
						offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(entity2, 1.12046f, -0.317773f, 1.3385f) };
						vector3 = { func_471(vector3, 8.909f) };
					...
					if (flag4 || num4 == 4 || num4 == 8 || num4 == 3)
					{
						...
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_481(num4), false, false, false, true);
						ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_472(&unk15));
				...
				else if (!CAM::IS_SCREEN_FADING_OUT() && !func_470(&unk888) || func_469(&unk888) > 0.05f)
				{
			...
			case 2:
				if (func_467(&unk, &unk867, &unk1091, num4, num22, num4 != 5 && num4 != 6 && num4 != 12))
				{
					func_466(&unk867);
					func_443(&unk15, &unk915, &num14, &entity2, &train, &vehicle, &unk1080, &unk1081, &entity, &ped, hash, hash2, &unk876, num4, &sceneID);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), true, false);
				
					if (!flag4 && !flag12)
						func_485(&unk106, &unk15, num4, false);
			...
			case 3:
				if (!func_470(&unk867) && !flag4)
				{
					func_442(0, false, true);
					func_494(&unk867);
				}
				else if (func_470(&unk867) && func_469(&unk867) > 0.2f || flag4)
				{
					if (func_473(func_474(num4)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3))
					{
					}
					else if (flag4)
					{
					...
					else
					{
						...
						{
							SYSTEM::WAIT(1000);
							CAM::SET_CAM_ACTIVE_WITH_INTERP(func_441(&unk106, 1), func_441(&unk106, 0), 10000, 1, 1);
						...
						if (!_IS_NULL_VECTOR(func_440(num4)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_440(num4), true, false, false, true);
							ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_438(func_440(num4), func_481(num4)));
							PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
							...
							if (func_435(num4) > 0)
								TASK::TASK_STAND_STILL(0, func_435(num4));
						
							TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_481(num4), 1f, -1, func_472(&unk15), 1056964608);
			...
			case 4:
				...
				{
					func_425(false, true, true, false, false, false, false);
				
					if (func_473(func_474(num4)))
					{
						func_424(&unk106, &unk15, &unk1097, &offsetFromEntityInWorldCoords, &vector3, entity2, &unk1113, &unk1116);
				...
				else
				{
					if (!flag14)
					{
						...
						else if (func_469(&unk909) > 4f || func_473(func_474(num4)) && func_469(&unk909) > 0.5f)
						{
							_CONVERSATION_ADD_LINE(&unk915, "OJBJAUD", func_423(&unk15), 8, 0, 0, 0);
							flag14 = true;
						}
					}
					...
					{
						if (func_386(&unk15, num4, &vehicle, &unk106, &unk100, &unk870, &unk873, &unk885, &unk903, num22, &flag5, &flag16, flag8))
						{
							HUD::CLEAR_HELP(true);
							flag8 = false;
			...
			case 5:
				...
				{
					if (flag4 && flag13)
						CLOCK::SET_CLOCK_TIME(func_381(num6), func_380(num6), func_379(num6));
				...
				{
					blip = HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(train, func_377(&unk15)));
				...
				{
					blip = HUD::ADD_BLIP_FOR_COORD(func_376(&unk15, 0));
					HUD::SET_BLIP_COLOUR(blip, 5);
				...
				if (num14 > 1)
				{
					blip2 = HUD::ADD_BLIP_FOR_COORD(func_376(&unk15, 1));
				...
				if (ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false))
				{
					...
					if (func_374(_STOPWATCH_IS_INITIALIZED_0(&unk15)))
						VEHICLE::DELETE_MISSION_TRAIN(&train);
					else
						ENTITY::SET_ENTITY_COORDS(train, func_376(&unk15, 0), true, false, false, true);
				}
			
				if (IS_BIT_SET(Global_114162.f_18971.f_1, func_373(&unk15) - 125))
				{
				...
				if (func_372(func_474(num4)))
				{
					func_371(true, true, true);
					TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					func_378(&unk876);
					num = 6;
					func_370(88, 1);
				...
				if (!func_385(&unk15))
				{
					...
					{
						if (func_368(&unk15) && !flag16 && !flag4)
						{
							CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(true, 0, 3, 0);
						}
						else if (num4 == 4 && !func_367())
						{
							CAM::SET_CAM_COORD(func_441(&unk106, 0), -76.7226f, -829.9866f, 326.0427f);
							CAM::SET_CAM_ROT(func_441(&unk106, 0), 0.8541f, 0f, -17.012f, 2);
							CAM::SET_CAM_FOV(func_441(&unk106, 0), 53.883f);
							CAM::SET_CAM_ACTIVE(func_441(&unk106, 0), true);
						}
						else
						{
							if (CAM::IS_SCRIPT_GLOBAL_SHAKING())
			...
			case 6:
				...
				if (flag7 || flag6 || func_366(&unk15, num4, &flag9))
				{
					HUD::CLEAR_HELP(true);
					HUD::CLEAR_PRINTS();
					num = 10;
				...
				else
				{
					...
					func_365(&unk876);
					func_355(&unk15, train, entity, &num8, &checkpoint, &checkpoint2, &num13, &num15, &num16, num14, &num17, &blip, &blip2, &num12, &num5, &unk1117, &unk1118, &unk1119, &unk1120, false, true, num10);
					func_354(&unk1092);
				
					if (func_470(&unk867))
						if (func_469(&unk867) > 10f)
							func_350(&unk879, &num21);
					else
						func_349(&unk867, 0f);
					...
					{
						if (HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_470(&unk912))
						{
							func_378(&unk912);
						}
						else if (func_469(&unk912) > 0.25f)
						{
							unk1093 = { func_348(num4) };
			...
			case 7:
				...
				else
				{
					...
					if (func_473(func_474(num4)) && !ENTITY::IS_ENTITY_DEAD(entity2, false))
						func_343(entity2, func_481(num4));
					...
					if (func_339(&unk15, &unk106, &unk100, &unk873, &unk1097, &unk1106, offsetFromEntityInWorldCoords, vector3) || flag8)
					{
						func_466(&unk867);
						HUD::CLEAR_HELP(true);
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							{
								ENTITY::SET_ENTITY_COORDS(entity2, func_481(num4), true, false, false, true);
								ENTITY::SET_ENTITY_HEADING(entity2, func_472(&unk15));
								...
								func_337(entity2, &unk106, &unk870);
								STREAMING::NEW_LOAD_SCENE_STOP();
							}
						}
			...
			case 8:
				...
				if (ENTITY::DOES_ENTITY_EXIST(entity2))
				{
					if (func_336(&unk106, &unk870, offsetFromEntityInWorldCoords, vector3, unk1097, &unk1113, &unk1116))
					{
			...
			case 9:
				...
				else if (func_335(&unk100, 3, 1000) && !Global_23848.f_135)
				{
					...
					{
						func_355(&unk15, train, ped, &num8, &checkpoint, &checkpoint2, &num13, &num15, &num16, num14, &num17, &blip, &blip2, &num12, &num5, &unk1117, &unk1118, &unk1119, &unk1120, false, true, num10);
						SYSTEM::WAIT(0);
					}
				
					func_289(&unk15, &unk1091, &unk110, &address, &ped, &num8, &playersLastVehicle, &train, &unk1080, &vehicle, &sizeAndVehs, &checkpoint, &checkpoint2, blip, blip2, &num13, &num15, &num16, &num21, &num17, num4, &num2, &num5, &unk882, &unk900, &unk1106, &unk1117, &unk1118, &unk1119, &unk1120, &flag5, &flag6, &flag7, &flag8, &flag10, &num23, &num7);
					flag4 = true;
					num = 0;
				}
				else
				{
					func_286(&unk897, &num8);
				
					if (flag8)
					{
						vector = { func_376(&unk15, num14 - 1) };
						func_284(PLAYER::PLAYER_PED_ID(), vector);
						flag8 = false;
					}
					...
					if (func_374(_STOPWATCH_IS_INITIALIZED_0(&unk15)))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(train) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_376(&unk15, 0), false) <= 200f)
						{
							train = VEHICLE::CREATE_MISSION_TRAIN(6, func_376(&unk15, 0), true, 0, 0);
						
							if (!ENTITY::IS_ENTITY_DEAD(train, false))
								VEHICLE::SET_TRAIN_CRUISE_SPEED(train, 7.5f);
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false) && !_IS_NULL_VECTOR(func_376(&unk15, 0)))
					{
						PED::IS_PED_INJURED(ped);
					
						if (func_283(PLAYER::PLAYER_PED_ID(), train, false) <= 325f)
						{
							if (num4 == 5)
					...
					num2 = func_355(&unk15, train, ped, &num8, &checkpoint, &checkpoint2, &num13, &num15, &num16, num14, &num17, &blip, &blip2, &num12, &num5, &unk1117, &unk1118, &unk1119, &unk1120, true, true, num10);
					...
					func_277(&unk110, &unk15, num4, num14);
				}
				break;
			...
			case 10:
				...
				if (!flag6 && !flag7 && !flag9)
				{
					...
					if (_STOPWATCH_IS_INITIALIZED_0(&unk15) == 0)
						func_276(func_376(&unk15, num14 - 1), unk900);
				
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), train, vector2, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_376(&unk15, num13), vector2, false, true, 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()))
						{
							flag21 = false;
							...
							if (flag21)
							{
								if (func_335(&unk100, 3, 1000) && !Global_23848.f_135)
								{
									ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
									PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, SPC_LEAVE_CAMERA_CONTROL_ON);
									CAM::DO_SCREEN_FADE_OUT(800);
				...
				if (flag6 || flag7 || flag9 || func_470(&unk882) && func_469(&unk882) > 0.25f)
				{
					if (func_470(&unk882) && func_469(&unk882) > 0.25f)
						func_272(func_376(&unk15, num13), train, ped, &num2, &num17, &num11);
				
					func_466(&unk882);
				
					if (flag6 || num2 == 1)
					{
						for (i = func_271(); !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(i); i = func_271())
						{
							SYSTEM::WAIT(0);
						...
						if (!func_270(&unk110, 7))
						{
							num20 = 125;
							MISC::SET_BIT(&(Global_114162.f_18971.f_1), func_373(&unk15) - num20);
							func_269(func_373(&unk15), true);
							flag = true;
							flag2 = true;
							flag3 = true;
							...
							for (k = 0; k < 13; k = k + 1)
							{
								if (!IS_BIT_SET(Global_114162.f_18971.f_1, k))
								{
									if (func_473(func_474(k)))
										flag3 = false;
									else
										flag2 = false;
			...
			case 11:
				...
				if (!flag6 && !flag7)
				{
					if (func_213() && !func_270(&unk110, 26))
					{
						func_202(num4);
				...
				else if (!CAM::IS_SCREEN_FADING_OUT() && !func_77() || func_469(&unk894) >= 2f)
				{
					...
					if (func_470(&unk873))
					{
						if (num3 == 1 || func_469(&unk873) >= 60f || !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID()) || !isPedInAnyVehicle && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
						{
							if (!flag20)
							{
								func_76(&(unk110.f_26));
...
void func_1(int* piParam0) // Position - 0x2BB1
{
...
void func_2(BOOL bParam0, var uParam1, var uParam2, Vehicle* pveParam3, Vehicle* pveParam4, Vehicle* pveParam5, var uParam6, Vehicle veParam7, var uParam8, Ped* ppedParam9, var uParam10, var uParam11, int iParam12, var uParam13, Blip blParam14, Blip blParam15, int iParam16, var uParam17, BOOL bParam18) // Position - 0x2BCD
{
	if (bParam0)
		func_568(uParam1, uParam2, pveParam3, pveParam4, pveParam5, uParam6, &veParam7, uParam8, ppedParam9, uParam10, uParam11, iParam12, uParam13, blParam14, blParam15, iParam16, uParam17, bParam18);
	else
		func_568(uParam1, uParam2, pveParam3, pveParam4, pveParam5, uParam6, &veParam7, uParam8, ppedParam9, uParam10, uParam11, iParam12, uParam13, blParam14, blParam15, iParam16, uParam17, bParam18);
...
BOOL func_3(var uParam0, var uParam1, char* sParam2, char* sParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0x2C2D
{
	switch (*uParam1)
	{
		...
		case 1:
			...
			if (!func_470(&(uParam1->f_1)))
				func_494(&(uParam1->f_1));
		
			if (func_15(iParam5, 2))
				if (!func_470(&(uParam1->f_4)))
					func_494(&(uParam1->f_4));
		...
		case 2:
			...
			if (!func_15(iParam5, 16) && func_469(&(uParam1->f_1)) >= uParam1->f_135 || CAM::IS_SCREEN_FADED_OUT())
			{
			...
			if (func_15(iParam5, 2))
			{
				if (func_469(&(uParam1->f_4)) >= iParam8)
				{
					uParam1->f_138 = 0;
					AUDIO::PLAY_SOUND_FRONTEND(-1, "NO", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
...
void func_4(int* piParam0) // Position - 0x3010
{
	if (*piParam0 != 0)
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(piParam0);
...
void func_9(const char* sParam0) // Position - 0x332A
{
...
int func_11(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x335F
{
	...
	if (func_469(&(uParam0->f_2)) * 1000f > SYSTEM::TO_FLOAT(uParam0->f_1))
	{
		func_466(&(uParam0->f_2));
		return 0;
	}
	...
	if ((float)SYSTEM::TIMERA() > 1500f * 0.2f)
	{
		...
		else if ((float)SYSTEM::TIMERB() > 1500f * 0.075f || CAM::IS_SCREEN_FADED_OUT())
		{
			...
			else if (iLocal_42 == 0)
			{
				...
				func_19(0, 2, true);
				func_425(true, true, true, false, false, false, false);
				func_26(true);
...
void func_35(int* piParam0) // Position - 0x3CA4
{
	if (!func_470(piParam0))
		func_494(piParam0);
	else
		func_378(piParam0);
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3CC5
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3D02
{
...
Hash func_38(eCharacter echParam0) // Position - 0x3D27
{
...
{
	if (func_470(&(uParam0->f_1)))
		func_466(&(uParam0->f_1));

	if (func_470(&(uParam0->f_4)))
		func_466(&(uParam0->f_4));
...
void func_42(int* piParam0, float fParam1) // Position - 0x3DB4
{
...
BOOL func_47(var uParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x3F22
{
	BOOL flag;
...
void func_50(var uParam0, int iParam1, BOOL bParam2) // Position - 0x466C
{
	int alpha;
	float num;
	float num2;
...
void func_52(const char* sParam0, const char* sParam1, float fParam2, float fParam3, BOOL bParam4, int iParam5) // Position - 0x536C
{
...
void func_53(const char* sParam0, float fParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x5399
{
...
void func_56(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x55D6
{
	float num;
	float value;
	float aspectRatio;
...
char* func_58(int iParam0, BOOL bParam1) // Position - 0x5679
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23987.f_7680[iParam0 /*16*/]))
	{
		...
		{
			return func_59(&Global_23987.f_7680[iParam0 /*16*/]);
		}
	}
...
char* func_59(const char* sParam0) // Position - 0x5BA1
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5BAB
{
	var gamerHandle;
...
char* func_61(int iParam0) // Position - 0x5BC2
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23987.f_6623[iParam0 /*16*/]))
	{
		...
		{
			return func_59(&Global_23987.f_6623[iParam0 /*16*/]);
		}
	}
...
void func_63(int iParam0, int iParam1, float fParam2, float fParam3, const char* sParam4, int iParam5) // Position - 0x5EC5
{
	eHudColour hudColor;
...
float func_69(const char* sParam0, const char* sParam1) // Position - 0x63FC
{
...
float func_70(const char* sParam0) // Position - 0x6417
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true) / 2f;
}
...
void func_72(const char* sParam0) // Position - 0x6454
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}
...
void func_78(var uParam0, var uParam1, Vehicle* pveParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, Vehicle veParam6, var uParam7, Ped* ppedParam8, var uParam9, var uParam10, int iParam11, var uParam12, Blip blParam13, Blip blParam14, int iParam15, var uParam16, BOOL bParam17) // Position - 0x64FA
{
	func_568(uParam0, uParam1, pveParam2, pveParam3, pveParam4, uParam5, &veParam6, uParam7, ppedParam8, uParam9, uParam10, iParam11, uParam12, blParam13, blParam14, iParam15, uParam16, bParam17);
	return;
}
...
int func_79(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, var uParam7, float fParam8, var uParam9) // Position - 0x652A
{
	...
	if (!func_270(uParam1, 6))
		if (func_181(&(uParam1->f_26), false, 0))
			func_221(uParam1, 6, true);
		else
			return 2;

	if (func_270(uParam1, 27) && PLAYER::IS_PLAYER_ONLINE())
	{
		if (!func_270(uParam1, 26))
			func_214(uParam1, false, INPUT_FRONTEND_ENDSCREEN_ACCEPT, "BJ_CONTINUE", INPUT_FRONTEND_ENDSCREEN_EXPAND, "BJ_RETRY", 365, 0, 365, 0);
	...
	if (SYSTEM::TIMERA() > 1000)
	{
		...
		if (*uParam9)
		{
			if (PLAYER::IS_PLAYER_ONLINE())
			{
				if (!func_270(uParam1, 28) && func_80(&uLocal_143))
				{
			...
			if (func_335(uParam3, 7, 1000))
			{
				*uParam9 = 0;
				func_214(uParam1, false, INPUT_FRONTEND_ENDSCREEN_ACCEPT, "BJ_CONTINUE", INPUT_FRONTEND_ENDSCREEN_EXPAND, "BJ_RETRY", INPUT_FRONTEND_LEADERBOARD, "HUD_INPUT68" /*Online Leaderboard*/, 365, 0);
			}
		}
		else if (func_335(uParam3, 5, 1000))
		{
			func_76(&(uParam1->f_26));
			return 1;
		}
		else if (func_335(uParam3, 4, 1000))
		{
			return 0;
		}
		else if (!*uParam9 && func_335(uParam3, 8, 1000) && !PLAYER::IS_PLAYER_ONLINE() || func_270(uParam1, 26))
		{
			*uParam9 = 1;
...
BOOL func_81(int* piParam0, BOOL bParam1) // Position - 0x67ED
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x6E73
{
...
BOOL func_102(var uParam0, eControlAction ecaParam1) // Position - 0x83FD
{
	var unk;
	int num;
	var unk2;
...
void func_104(int iParam0, int iParam1, int iParam2) // Position - 0x8571
{
...
int func_110(Hash hParam0) // Position - 0x8AE9
{
	Hash value;
	float num;
	int num2;
...
struct<4> func_113(Hash hParam0) // Position - 0x8C14
{
	var unk;
...
int func_116(int iParam0, Any* panParam1) // Position - 0x9C29
{
	int i;
	int numDlcWeapons;
...
int func_117(Hash hParam0) // Position - 0x9C64
{
	if (hParam0 == 600)
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, const char* sParam4, const char* sParam5) // Position - 0x9DD7
{
...
BOOL func_119(Any* panParam0, Any* panParam1) // Position - 0x9E29
{
...
void func_127(int iParam0, int iParam1, int iParam2, const char* sParam3) // Position - 0xA69A
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0xAA6D
{
...
BOOL func_134(var uParam0, int iParam1, Any* panParam2, var uParam3) // Position - 0xAD3C
{
	var unk;
	int i;
...
void func_135(Any* panParam0, char* sParam1) // Position - 0xADF5
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(panParam0, 35, sParam1);
	return;
}

BOOL func_136(Any* panParam0, Any* panParam1) // Position - 0xAE07
{
	int i;
...
BOOL IS_XBOX_PLATFORM() // Position - 0xAE46
{
...
void func_139(Any* panParam0) // Position - 0xAECC
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
BOOL func_141(var uParam0, Any* panParam1, char* sParam2) // Position - 0xAF82
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_145(var uParam0, const char* sParam1, char* sParam2, Any anParam3, var uParam4) // Position - 0xB3E7
{
	int displaynamesFromHandles;
	var unk;
...
BOOL func_148(var uParam0, var uParam1, Any* panParam2, int iParam3, int iParam4) // Position - 0xC437
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_158(var uParam0, var uParam1, Any* panParam2, int iParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xC7EB
{
	int any;
	float num;
...
void func_165(int iParam0) // Position - 0xE307
{
...
void func_166(int iParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE327
{
	char* componentType;
	var clanDesc;
	var unk35;
...
void func_167(int iParam0, char* sParam1, var uParam2, int iParam3) // Position - 0xE5FE
{
	int i;
...
void func_168(int iParam0, char* sParam1, const char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xE640
{
...
void func_170(int iParam0, int iParam1) // Position - 0xE6F2
{
...
BOOL func_173(Player plParam0) // Position - 0xE72F
{
...
int func_174(Player plParam0) // Position - 0xE78F
{
...
BOOL func_198(var uParam0, var uParam1, Any* panParam2, Any* panParam3) // Position - 0xF660
{
	switch (*uParam0)
	{
		case 0:
...
void func_203(var uParam0, int iParam1, const char* sParam2, char* sParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xFBF3
{
	var unk;
	var unk9;
	int i;
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_209(*Global_4718592.f_194133) || func_206(*Global_4718592.f_194133))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
				...
				else if (func_205(*Global_4718592.f_194133))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[1 /*6*/], "SCLB_C_DEATH" /*DEATHS*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[2 /*6*/], "SCLB_C_RANK" /*POSITION*/, 24);
...
Hash func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x1529E
{
	var unk;
...
BOOL func_213() // Position - 0x15446
{
	return NETWORK::NETWORK_IS_SIGNED_ONLINE();
}

void func_214(var uParam0, BOOL bParam1, eControlAction ecaParam2, char* sParam3, eControlAction ecaParam4, char* sParam5, eControlAction ecaParam6, char* sParam7, eControlAction ecaParam8, int iParam9) // Position - 0x15452
{
	if (*uParam0 == 0)
		*uParam0 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("instructional_buttons");
...
var func_215(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15596
{
	if (bParam0)
		return uParam1;
...
void func_216() // Position - 0x155AD
{
	func_217(PLAYER::PLAYER_PED_ID(), "GENERIC_CURSE_MED", 24);
	return;
}

void func_217(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x155C3
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x155DA
{
	char* str;
...
void func_220(int iParam0, int iParam1) // Position - 0x1581A
{
...
void func_221(var uParam0, int iParam1, BOOL bParam2) // Position - 0x15832
{
	if (bParam2)
...
int func_222(var uParam0, int iParam1, var uParam2, var uParam3, float fParam4) // Position - 0x15858
{
	int num;
...
void func_223(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x158C6
{
	int outValue;
	Hash statHash;

	if (func_263(echParam0) == 3)
		return;

	if (func_263(echParam0) == 4)
		return;

	func_224(func_263(echParam0), 1, iParam1, iParam2, false);
...
int func_224(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x15998
{
	float num;
	int num2;
	int num3;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_370(99, 1);
					func_261(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 1:
					func_261(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 2:
					func_261(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_261(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 1:
							func_261(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 2:
							func_261(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_261(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 1:
							func_261(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 2:
							func_261(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_261(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 1:
							func_261(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 2:
							func_261(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_261(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 1:
							func_261(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 2:
							func_261(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_261(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 1:
									func_261(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 2:
									func_261(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_261(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 1:
									func_261(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 2:
									func_261(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_261(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 1:
									func_261(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 2:
									func_261(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_261(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 1:
									func_261(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 2:
									func_261(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_261(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 1:
					func_261(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 2:
					func_261(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_225(BOOL bParam0) // Position - 0x15F97
{
	int i;
	int j;
...
void func_226(int iParam0) // Position - 0x16219
{
	int value;
...
void func_227(int iParam0) // Position - 0x16273
{
	int num;
	BOOL flag;
	var txdName;
	...
	if (iParam0 == 12)
	{
		func_236(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_236(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_236(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_236(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_236(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_236(8277, 0, -1, true);
		return;
	}

	if (func_235(iParam0))
	{
		func_236(func_234(iParam0), 0, -1, true);
		return;
	}

	if (func_233(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_232(iParam0));
		_MPPLY_STAT_SET_INT(func_232(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114162.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_229() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114162.f_20568.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_229() /*5571*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x1643E
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x1657D
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x16599
{
	Hash statHash;
	int outValue;
...
Hash func_232(int iParam0) // Position - 0x165B7
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_233(int iParam0) // Position - 0x165D9
{
	switch (iParam0)
	{
		case 38:
...
int func_234(int iParam0) // Position - 0x165F6
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_235(int iParam0) // Position - 0x166FB
{
	switch (iParam0)
	{
		case 18:
...
void func_236(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1678A
{
	Hash statName;

	if (iParam0 != 17239)
	{
		statName = func_237(iParam0, iParam2);
...
Hash func_237(int iParam0, int iParam1) // Position - 0x167B8
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_238(iParam1));
}

int func_238(int iParam0) // Position - 0x167CD
{
	int num;
	int num2;
...
int func_239() // Position - 0x16801
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1680D
{
	if (iParam2 == -1)
		iParam2 = func_239();
...
void func_241(int iParam0) // Position - 0x1682B
{
	func_370(93, iParam0);
	func_370(29, iParam0);
	func_370(30, iParam0);
...
BOOL func_242(int iParam0) // Position - 0x1684B
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_235(iParam0))
	{
		...
		num7 = func_243(func_234(iParam0), -1);
	...
	if (func_233(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_232(iParam0));
...
int func_243(int iParam0, int iParam1) // Position - 0x16A56
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x16A85
{
	if (iParam1 == -1)
		iParam1 = func_239();
...
int func_245(BOOL bParam0) // Position - 0x16AA1
{
	var outValue;
	int value;
	int outValue2;
...
int func_246(int iParam0, int iParam1) // Position - 0x16B58
{
	if (iParam0 >= 78)
		return 0;
...
int func_247(int iParam0, int iParam1) // Position - 0x16B73
{
	if (func_259(14) && !func_258(iParam0))
		return 0;
	...
	if (func_257(&Global_4546323))
	{
		if (func_255(&Global_4546323, iParam0))
			return 0;
	
		if (func_248(&Global_4546323, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_248(var uParam0, int iParam1) // Position - 0x16C10
{
	int i;
	var unk;
	...
	if (func_259(14) && !func_258(iParam1))
		return false;
...
int func_249(var uParam0, int iParam1) // Position - 0x16CC1
{
	int i;
...
BOOL func_250(var uParam0, int iParam1) // Position - 0x16D3C
{
	return uParam0->[iParam1] == 78;
}

void func_251(var uParam0) // Position - 0x16D4D
{
	int i;
	...
	func_253(uParam0, Global_4546322 - 0.5f);
	return;
}

void func_252(var uParam0, int iParam1) // Position - 0x16D81
{
	uParam0->[iParam1] = 78;
	return;
}

void func_253(var uParam0, int iParam1) // Position - 0x16D91
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_254(var uParam0) // Position - 0x16DAE
{
	return uParam0->f_80;
}

BOOL func_255(var uParam0, int iParam1) // Position - 0x16DBA
{
	return func_256(uParam0, iParam1) != -1;
}

int func_256(var uParam0, int iParam1) // Position - 0x16DCC
{
	int i;
...
BOOL func_257(var uParam0) // Position - 0x16DF9
{
	return uParam0->f_79 == 1;
}

BOOL func_258(int iParam0) // Position - 0x16E07
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_259(int iParam0) // Position - 0x16E57
{
	return Global_44199 == iParam0;
}

BOOL func_260(int iParam0, int iParam1) // Position - 0x16E65
{
...
void func_261(Hash hParam0, int iParam1) // Position - 0x16EB6
{
	int outValue;
...
void func_262() // Position - 0x16ED9
{
	int outValue;
...
int func_263(eCharacter echParam0) // Position - 0x16F4E
{
	return Global_2201[echParam0 /*29*/].f_17;
}

void func_264(int iParam0, int iParam1, int iParam2) // Position - 0x16F5F
{
	BOOL flag;
...
void func_265() // Position - 0x17045
{
	int num;
	float num2;
	float num3;
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114162.f_10198.f_3853))
		func_260(13, SYSTEM::FLOOR(Global_114162.f_10198.f_3853));

	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_79564)
		{
			if (func_266() == 2 == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_266() // Position - 0x17503
{
	return Global_33105;
}

void func_267(int iParam0, BOOL bParam1) // Position - 0x1750E
{
...
BOOL func_268(int iParam0) // Position - 0x17553
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_269(int iParam0, BOOL bParam1) // Position - 0x17580
{
	int num;
...
BOOL func_270(var uParam0, int iParam1) // Position - 0x17606
{
	return IS_BIT_SET(uParam0->f_607, iParam1);
}

int func_271() // Position - 0x17616
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MP_BIG_MESSAGE_FREEMODE");
}

void func_272(var uParam0, var uParam1, var uParam2, Vehicle veParam3, Ped pedParam4, var uParam5, var uParam6, var uParam7) // Position - 0x17626
{
	Ped ped;
	Vehicle trailer;
	BOOL isPedInjured;
	...
	if (flag6)
	{
		...
		*uParam7 = num2;
		...
		{
			*uParam6 = func_275(SYSTEM::CEIL((100f * (15f - num2)) / 15f) + 4, 0, 100);
			*uParam5 = 1;
		}
		else
		{
	...
	if (flag)
	{
		if (func_273(veParam3, pedParam4))
		{
			*uParam7 = 0f;
			*uParam6 = 100;
			*uParam5 = 1;
...
BOOL func_273(Vehicle veParam0, Ped pedParam1) // Position - 0x177BD
{
	Vehicle trailer;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_374(ENTITY::GET_ENTITY_MODEL(veParam0)))
		{
			i = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(trailer))
		{
			if (!ENTITY::IS_ENTITY_DEAD(trailer, false))
			{
				...
				else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), trailer))
				{
					...
					offsetFromEntityGivenWorldCoords = func_274(MISC::ABSF(offsetFromEntityGivenWorldCoords) - 1.305f, 0f);
				
					if (offsetFromEntityGivenWorldCoords.f_1 >= 0f)
						offsetFromEntityGivenWorldCoords.f_1 = func_274(offsetFromEntityGivenWorldCoords.f_1 - 5.98f, 0f);
					else
						offsetFromEntityGivenWorldCoords.f_1 = func_274(-offsetFromEntityGivenWorldCoords.f_1 - 6.21f, 0f);
...
float func_274(float fParam0, float fParam1) // Position - 0x17970
{
	if (fParam0 > fParam1)
		return fParam0;
...
int func_275(int iParam0, int iParam1, int iParam2) // Position - 0x17987
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_276(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x179AC
{
	float num;
	int alpha;
...
void func_277(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x17A63
{
	Hash hash;

	hash = _STOPWATCH_IS_INITIALIZED_0(uParam1);

	if (func_473(func_474(iParam2)))
	{
	...
	if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("BJ_FALLHLP") && Global_23848.f_135)
	{
		HUD::CLEAR_HELP(true);
		func_221(uParam0, 1, false);
	}

	if (!func_270(uParam0, 1) && !Global_23848.f_135)
	{
...
void func_278(var uParam0) // Position - 0x17BC5
{
	...
	unk9.f_2 = 0f;
	num3 = MISC::ABSF(func_282(unk9, forwardVector));
	...
	speed = func_49(func_279(entityVelocity.f_1, num2, 0.5f), entityVelocity.f_1, num);
	entityVelocity.f_1 = func_279(entityVelocity.f_1, num2, 0.5f);
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, false) && entityVelocity.f_1 > 2f && entityVelocity.f_1 < VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(*uParam0))
		TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam0, -1, false), speed, 0);

	return;
}

float func_279(float fParam0, float fParam1, float fParam2) // Position - 0x17D39
{
	float num;

	num = (1f - SYSTEM::COS(func_280(fParam2 * 3.1415927f))) * 0.5f;
	return (fParam0 * (1f - num)) + (fParam1 * num);
}

float func_280(float fParam0) // Position - 0x17D68
{
	return fParam0 * 57.29578f;
}

BOOL func_281(Vehicle veParam0) // Position - 0x17D78
{
	var entityCoords;
	var position;
	var rightVector;
	...
	unk7.f_2 = 0f;
	forwardVector.f_2 = 0f;
	num = func_282(unk7, forwardVector);
...
float func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x17DE2
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

float func_283(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0x17E03
{
...
Vector3 func_284(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x17E61
{
	var groundZ;
...
BOOL func_285(Ped pedParam0) // Position - 0x17EA7
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_286(int* piParam0, var uParam1) // Position - 0x17EC5
{
	var sizeAndPeds;
	int taskSequenceId;
	float num;
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		{
			if (func_288(uParam1->[i], &sizeAndPeds) == -1)
			{
				func_287(&uParam1->[i]);
			}
			else
	...
	if (pedNearbyPeds > 0)
	{
		for (i = 0; i < pedNearbyPeds; i = i + 1)
		{
			...
			{
				if (func_288(sizeAndPeds[i], uParam1) == -1)
				{
...
void func_287(var uParam0) // Position - 0x18109
{
...
int func_288(Entity eParam0, var uParam1) // Position - 0x1813A
{
	int i;
...
void func_289(var uParam0, var uParam1, int* piParam2, var uParam3, Ped* ppedParam4, var uParam5, var uParam6, Vehicle* pveParam7, Vehicle* pveParam8, Vehicle* pveParam9, var uParam10, var uParam11, var uParam12, Blip blParam13, Blip blParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20, var uParam21, var uParam22, int* piParam23, int* piParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36) // Position - 0x18180
{
	...
	*uParam30 = 0;
	...
	if (func_470(piParam24))
		func_466(piParam24);

	if (func_470(piParam23))
		func_466(piParam23);

	if (ENTITY::DOES_ENTITY_EXIST(*pveParam7))
	{
		if (func_374(_STOPWATCH_IS_INITIALIZED_0(uParam0)))
		{
	...
	{
		if (!func_333(*pveParam9) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*pveParam9, -1, false)))
		{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsUsing))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam6) && vehiclePedIsUsing == *uParam6)
			{
				...
				func_293(*uParam6, func_332(iParam20), func_331(iParam20), 24, false);
				ENTITY::SET_ENTITY_VELOCITY(vehiclePedIsUsing, 0f, 0f, 0f);
				ENTITY::SET_ENTITY_COORDS(vehiclePedIsUsing, func_332(iParam20), true, false, false, true);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vehiclePedIsUsing, 1084227584);
				ENTITY::SET_ENTITY_HEADING(vehiclePedIsUsing, func_331(iParam20));
			}
			else
			{
...
void func_290() // Position - 0x1845B
{
	Global_33250 = 1;
	return;
}

void func_291() // Position - 0x18467
{
	int i;
...
void func_292(int* piParam0) // Position - 0x184D7
{
	piParam0->f_607 = 0;
	return;
}

void func_293(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x184E5
{
	var unk;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		unk.f_9 = 49;
		unk.f_59 = 2;
		func_325(veParam0, &unk);
	
		if (func_324(uParam1, 0f, 0f, 0f, false))
		{
		...
		func_317(iParam5, &unk, uParam1, fParam4, func_323(veParam0));
		func_294(iParam5, veParam0, 0);
	}

	return;
}

void func_294(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x1860E
{
	Vehicle vehicle;
...
void func_295(Vehicle veParam0, eCharacter echParam1) // Position - 0x18725
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_325(veParam0, &(Global_114162.f_32754.f_5510));
	return;
}

BOOL func_296(Vehicle veParam0) // Position - 0x18927
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_311(veParam0, 0, false) || func_311(veParam0, 1, false) || func_311(veParam0, 2, false) || func_323(veParam0) != 145 || func_310(veParam0) || func_309(veParam0) || func_308(veParam0) || func_307(veParam0) || !func_297(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_309(veParam0);
		func_309(veParam0);
...
BOOL func_297(Hash hParam0) // Position - 0x18A04
{
	if (hParam0 == 0)
		return false;

	if (!func_298(hParam0, false, -1))
		return false;
...
BOOL func_298(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x18BC2
{
	int i;
	Hash outData;
	...
	if (hParam0 == joaat("blimp"))
		if (!func_305() && !func_304() && !func_303() && !func_302() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED())
			return false;
...
BOOL func_299(Hash hParam0) // Position - 0x18D47
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x18E13
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_301(Hash hParam0, int iParam1) // Position - 0x18E2A
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_302() // Position - 0x19057
{
	return false;
}

BOOL func_303() // Position - 0x19060
{
	return true;
}

BOOL func_304() // Position - 0x19069
{
	return true;
}

BOOL func_305() // Position - 0x19072
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1908B
{
	int profileSetting;
...
BOOL func_307(Vehicle veParam0) // Position - 0x19143
{
	Hash entityModel;
...
BOOL func_308(Vehicle veParam0) // Position - 0x1918A
{
	int i;
...
BOOL func_309(Vehicle veParam0) // Position - 0x191C5
{
	int i;
...
BOOL func_310(Vehicle veParam0) // Position - 0x19241
{
	int i;
...
BOOL func_311(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x19329
{
	int i;
	var garageName;
	int num;
...
BOOL func_312(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x19397
{
...
Vehicle func_313(int iParam0) // Position - 0x1946F
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_314(var uParam0, int iParam1) // Position - 0x1948B
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_324(Global_114162.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_324(Global_114162.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_324(Global_114162.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
int func_315(eCharacter echParam0, int iParam1) // Position - 0x1AB79
{
	int num;
...
void func_316(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x1ABBB
{
	int num;
...
void func_317(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x1AE17
{
	if (func_314(&Global_78354.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_322(iParam0);
			func_321(uParam1, &Global_114162.f_32754.f_69[Global_78354.f_555[0 /*21*/].f_14 /*78*/]);
			...
			Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] = iParam6 + 1;
...
void func_318(int iParam0, BOOL bParam1) // Position - 0x1AF10
{
	if (iParam0 == -1)
		return;
	...
	if (bParam1)
	{
		...
		{
			func_319(iParam0, 1, false);
			func_319(iParam0, 2, false);
			func_319(iParam0, 3, false);
			func_319(iParam0, 4, false);
			func_319(iParam0, 0, true);
			Global_78354[iParam0] = 1;
		}
	}
	else
	{
		func_319(iParam0, 0, false);
	}

	return;
}

void func_319(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1AF6D
{
	if (iParam0 == -1)
		return;
...
BOOL func_320(int iParam0, int iParam1) // Position - 0x1AFA8
{
	if (iParam0 == -1)
		return false;
...
void func_321(var uParam0, var uParam1) // Position - 0x1AFC8
{
...
void func_322(int iParam0) // Position - 0x1B094
{
	if (iParam0 == -1)
		return;
	...
	if (func_314(&Global_78354.f_555[0 /*21*/], iParam0))
	{
		...
		if (IS_BIT_SET(Global_78354.f_555[0 /*21*/].f_9, 13))
			func_318(iParam0, false);
	}

	return;
}

int func_323(Vehicle veParam0) // Position - 0x1B10B
{
	int i;
...
BOOL func_324(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x1B16E
{
	if (bParam6)
...
void func_325(Vehicle veParam0, var uParam1) // Position - 0x1B1B5
{
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		if (uParam1->f_65 == -1 && !func_328(uParam1->f_66))
			uParam1->f_65 = 0;
		...
		func_327(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_326(i + 1));
		}
...
int func_326(int iParam0) // Position - 0x1B460
{
	switch (iParam0)
	{
		case 1:
...
int func_327(var uParam0, var uParam1, var uParam2) // Position - 0x1B510
{
	int i;
	int modType;
...
BOOL func_328(int iParam0) // Position - 0x1B703
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_329(var uParam0) // Position - 0x1B723
{
	int i;
...
void func_330(int iParam0) // Position - 0x1B7D3
{
...
float func_331(int iParam0) // Position - 0x1B7FA
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_332(int iParam0) // Position - 0x1B8C4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_333(Vehicle veParam0) // Position - 0x1BA14
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
...
void func_334(int* piParam0) // Position - 0x1BA57
{
	if (*piParam0 != 0)
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(piParam0);
...
BOOL func_335(var uParam0, int iParam1, int iParam2) // Position - 0x1BB2A
{
...
BOOL func_336(var uParam0, int* piParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x1BB82
{
	var unk;
	...
	{
		case 0:
			if (func_469(piParam1) >= 0f)
			{
				uParam8.f_2 = func_49(uParam8.f_2, -8.909f, 8.909f);
				uParam11->f_2 = uParam11->f_2 + uParam8.f_2;
				unk = { func_471(uParam5, uParam8.f_2) };
				CAM::SET_CAM_PARAMS(func_441(uParam0, 0), uParam2 + unk, *uParam11, *uParam12, 300, 1, 1, 2);
				CAM::SET_CAM_ACTIVE_WITH_INTERP(func_441(uParam0, 1), func_441(uParam0, 0), SYSTEM::FLOOR(1000f * (1.1f - 0f)), 2, 1);
				uParam0->f_3 = 1;
			}
			break;
...
void func_337(Vehicle veParam0, var uParam1, int* piParam2) // Position - 0x1BC96
{
	float camRot;
	Cam cam;
	Cam cam2;
	...
	cam = func_441(uParam1, 0);
	cam2 = func_441(uParam1, 1);
	CAM::SET_CAM_NEAR_CLIP(cam2, func_338());
...
float func_338() // Position - 0x1BD15
{
	if (MISC::IS_PC_VERSION())
		return 0.5f;
...
BOOL func_339(var uParam0, var uParam1, var uParam2, int* piParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x1BD31
{
	Cam cam;
	float num;
	var unk3;
	...
	*uParam4 = *uParam4 + (*uParam5 * MISC::GET_FRAME_TIME());
	...
	unk3 = { func_471(uParam9, uParam4->f_2) };
	CAM::SET_CAM_COORD(cam, uParam6 + unk3);
	CAM::SET_CAM_ROT(cam, -33f + *uParam4, 0f, -88.515f + func_472(uParam0) + uParam4->f_2, 2);
	CAM::SET_CAM_NEAR_CLIP(cam, func_338());

	if (!CAM::IS_SCREEN_FADED_IN() || !func_470(piParam3))
	{
		func_378(piParam3);
	}
	else
	{
		if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
			func_341("BJ_VLOOKHLP");
	
		if (func_470(piParam3) && func_469(piParam3) > 0.5f)
		{
			if (func_340(uParam2, 1))
			{
				func_466(piParam3);
				CAM::DETACH_CAM(cam);
				return true;
...
BOOL func_340(var uParam0, int iParam1) // Position - 0x1BF6F
{
	return IS_BIT_SET(uParam0->f_2, iParam1) && !IS_BIT_SET(uParam0->f_3, iParam1);
}

void func_341(char* sParam0) // Position - 0x1BF8B
{
...
Vector3 func_342(var uParam0) // Position - 0x1BFA1
{
	return *uParam0, uParam0->f_1, 0f;
}

void func_343(Vehicle veParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1BFB1
{
	float num;
	float num2;
	float num3;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x1C03F
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1C052
{
...
void func_346(var uParam0, BOOL bParam1) // Position - 0x1C069
{
	if (bParam1)
	{
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x1C0B1
{
	iParam2 = iParam2;
...
struct<4> func_348(int iParam0) // Position - 0x1C0CA
{
	var unk;
...
void func_349(int* piParam0, float fParam1) // Position - 0x1C130
{
	if (!func_470(piParam0))
...
void func_350(int* piParam0, var uParam1) // Position - 0x1C14A
{
	if (func_470(piParam0))
	{
		if (func_352(piParam0, 7.5f * (float)*uParam1))
		{
			*uParam1 = *uParam1 + 1;
	...
	{
		func_349(piParam0, 0f);
	}

	return;
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1C196
{
...
BOOL func_352(int* piParam0, float fParam1) // Position - 0x1C1B8
{
	if (func_353(piParam0, fParam1))
	{
		func_466(piParam0);
		return true;
	}
...
BOOL func_353(int* piParam0, float fParam1) // Position - 0x1C1D6
{
	if (func_470(piParam0))
		if (func_469(piParam0) > fParam1)
			return true;

	return false;
}

void func_354(Hash* phParam0) // Position - 0x1C1F8
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
int func_355(var uParam0, Vehicle veParam1, Ped pedParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, var uParam10, Blip* pblParam11, Blip* pblParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, BOOL bParam19, BOOL bParam20, float fParam21) // Position - 0x1C29E
{
	var forwardVector;
	var rightVector;
	var upVector;
	...
	vector = { func_376(uParam0, *uParam6) };
	...
	if (flag)
	{
		...
		{
			offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam1, func_377(uParam0)) };
		...
		{
			offsetFromEntityInWorldCoords = { func_376(uParam0, 0) };
			vector = { offsetFromEntityInWorldCoords };
		}
		else
		{
		...
		{
			GRAPHICS::DRAW_MARKER(6, offsetFromEntityInWorldCoords, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_364(offsetFromEntityInWorldCoords, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, offsetFromEntityInWorldCoords, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_364(offsetFromEntityInWorldCoords, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, offsetFromEntityInWorldCoords, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_364(offsetFromEntityInWorldCoords, 170, 200), false, false, 2, false, 0, 0, false);
		}
	...
	else
	{
		...
		num = { position - vector };
		vector2 = { func_376(uParam0, *uParam6 + 1) };
		GRAPHICS::DRAW_MARKER(6, vector, func_483(num), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_364(vector, 25, 200), false, false, 2, false, 0, 0, false);
		...
		if (*uParam7 != *uParam6)
		{
			...
			*uParam4 = GRAPHICS::CREATE_CHECKPOINT(17, vector, vector2, 9f, r, g, b, func_364(offsetFromEntityInWorldCoords, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))), 0);
		
			if (*uParam6 < iParam9 - 2)
				*uParam5 = GRAPHICS::CREATE_CHECKPOINT(17, vector2, func_376(uParam0, *uParam6 + 2), 9f * 0.5f, r, g, b, func_364(offsetFromEntityInWorldCoords, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))), 0);
		...
		{
			GRAPHICS::DRAW_MARKER(6, vector2, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 4f, 0.5f * 4f, 0.5f * 4f, 240, 200, 80, func_364(vector2, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vector2, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 9f, 0.5f * 9f, 0.5f * 9f, 240, 200, 80, func_364(vector2, 170, 200), false, false, 2, false, 0, 0, false);
			GRAPHICS::DRAW_MARKER(6, vector2, 0f, 0f, 1f, 0f, 0f, 0f, 0.5f * 14f, 0.5f * 14f, 0.5f * 14f, 240, 200, 80, func_364(vector2, 170, 200), false, false, 2, false, 0, 0, false);
		}
		else
		{
			GRAPHICS::DRAW_MARKER(6, vector2, func_483(position - vector2), 0f, 0f, 0f, 0.5f * 14f, 0.5f * 14f, 0.5f * 14f, 240, 200, 80, func_364(vector2, 25, 200), false, false, 2, false, 0, 0, false);
		}
	
		if (*uParam4 != 0)
			GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, r, g, b, func_364(vector, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))));
	
		if (*uParam5 != 0)
			GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, r, g, b, func_364(vector2, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))));
	}
	...
	if (PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == 0 || PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == 1 || PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == 2 && !PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_VEH_CIN_CAM))
	{
		if (!GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(vector, &screenX, &screenY))
		{
			if (bLocal_581)
			{
				func_362(vector, uParam15, uParam16, uParam17);
			
				if (func_470(&uLocal_583))
					func_466(&uLocal_583);
			}
			else if (func_470(&uLocal_583))
			{
				if (func_360(&uLocal_583) > 0.5f)
				{
					func_466(&uLocal_583);
					bLocal_581 = true;
				}
	...
	if (func_359(uParam14, uParam18, &veParam1))
	{
		if (HUD::DOES_BLIP_EXIST(*pblParam11))
		...
		if (num.f_2 < 5f && num.f_2 > -2f && num2 < 15f || func_273(veParam1, pedParam2))
		{
			*uParam10 = func_275(SYSTEM::CEIL((100f * (15f - num2)) / 15f) + 4, 0, 100);
			return 1;
		}
		else
		{
	...
	else if (!flag)
	{
		...
		if (value < 22f * 22f)
		{
			if (value < 10f * 10f)
				flag2 = true;
			else if (func_282(forwardVector, -num / F2V(SYSTEM::SQRT(value))) < 0.08f)
				flag2 = true;
		
			if (flag2)
			{
				*uParam8 = *uParam8 + 1;
				func_357(uParam13, true);
		...
		else
		{
			...
			entityForwardVector = { func_483(entityForwardVector) };
			unk15 = { -num, -num.f_1, 0f };
			unk15 = { func_483(unk15) };
			num3 = (position.f_2 - 32f) + (32f * func_356(entityForwardVector, unk15));
			num2 = SYSTEM::SQRT((num * num) + (num.f_1 * num.f_1));
		...
		if (flag2)
		{
			*uParam6 = *uParam6 + 1;
			...
			if (*uParam6 < iParam9 - 1)
			{
				if (!HUD::DOES_BLIP_EXIST(*pblParam12))
				{
					*pblParam12 = HUD::ADD_BLIP_FOR_COORD(func_376(uParam0, *uParam6 + 1));
			...
			TASK::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), func_376(uParam0, *uParam6), -1, 0, 2);
		}
	}
...
float func_356(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1CB9A
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

void func_357(var uParam0, BOOL bParam1) // Position - 0x1CBB1
{
...
BOOL func_358() // Position - 0x1CBF4
{
...
BOOL func_359(var uParam0, var uParam1, var uParam2) // Position - 0x1CC4C
{
	Ped ped;
	int pedParachuteLandingType;
...
float func_360(int* piParam0) // Position - 0x1CD05
{
	if (func_470(piParam0))
		if (func_361(piParam0))
			return piParam0->f_2;
		else
...
BOOL func_361(int* piParam0) // Position - 0x1CD3E
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_362(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1CD4B
{
	var screenX;
	var screenY;
	float screenX2;
	...
	height = 0.05f;
	width = 0.05f;
	func_363(vParam0, &screenX2, &screenY2);
...
void func_363(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1CEBB
{
	float screenX;
	float screenY;
	float num;

	if (!func_324(vParam0, 0f, 0f, 0f, false))
...
int func_364(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x1CFA2
{
	float num;
	int num2;
...
void func_365(int* piParam0) // Position - 0x1D00E
{
	if (func_470(piParam0) && func_469(piParam0) > 7.5f)
		func_466(piParam0);

	return;
}

BOOL func_366(var uParam0, int iParam1, var uParam2) // Position - 0x1D036
{
	Vehicle vehiclePedIsIn;
	Vector3 entityCoords;
	var unk3;
	...
	{
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_481(iParam1)) > 3600f)
		{
			*uParam2 = 1;
			return true;
		}
...
BOOL func_367() // Position - 0x1D1B3
{
...
BOOL func_368(var uParam0) // Position - 0x1D1CC
{
	return uParam0->f_84;
}

void func_369(var uParam0, BOOL bParam1) // Position - 0x1D1D8
{
	int taskSequenceId;
	Ped pedInVehicleSeat;
	var entityCoords;
...
void func_370(int iParam0, int iParam1) // Position - 0x1D2C7
{
	int outValue;
...
void func_371(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D324
{
	if (bParam0)
		PLAYER::SET_PLAYER_CONTROL(PLAYER::GET_PLAYER_INDEX(), true, 0);

	CUTSCENE::SET_PAD_CAN_SHAKE_DURING_CUTSCENE(true);
	func_425(false, true, bParam2, false, false, false, false);
...
BOOL func_372(Hash hParam0) // Position - 0x1D362
{
	switch (hParam0)
	{
		case joaat("bmx"):
...
int func_373(var uParam0) // Position - 0x1D3E2
{
	return *uParam0;
}

BOOL func_374(Hash hParam0) // Position - 0x1D3ED
{
	switch (hParam0)
	{
		case joaat("freight"):
...
Hash _STOPWATCH_IS_INITIALIZED_0(var uParam0) // Position - 0x1D40D
{
	return uParam0->f_1;
}

Vector3 func_376(var uParam0, int iParam1) // Position - 0x1D419
{
...
Vector3 func_377(var uParam0) // Position - 0x1D443
{
	return uParam0->f_6;
}

void func_378(int* piParam0) // Position - 0x1D451
{
	func_42(piParam0, 0f);
	return;
}

int func_379(int iParam0) // Position - 0x1D460
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_380(int iParam0) // Position - 0x1D473
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_381(int iParam0) // Position - 0x1D486
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_382() // Position - 0x1D499
{
	int i;
...
void func_383() // Position - 0x1D4C2
{
	var unk;
	...
	func_384(&(Global_2097157.f_73));
	func_384(&(Global_2097157.f_142));
	func_384(&(Global_2097157.f_211));
	func_384(&(Global_2097157.f_280));
...
void func_384(Any* panParam0) // Position - 0x1D564
{
	int i;
...
BOOL func_385(var uParam0) // Position - 0x1D59F
{
	return uParam0->f_83;
}

BOOL func_386(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int* piParam6, int* piParam7, int* piParam8, int iParam9, var uParam10, var uParam11, BOOL bParam12) // Position - 0x1D5AB
{
	if (CAM::IS_CAM_INTERPOLATING(func_441(uParam3, 1)))
		func_378(piParam5);

	if (!*uParam10)
	{
		if (func_470(piParam7) && func_469(piParam7) >= func_407(uParam0))
		{
			func_369(uParam2, false);
			func_466(piParam7);
			*uParam10 = 1;
		}
	}
	...
	if (func_470(piParam5) && func_469(piParam5) > 0.2f)
	{
		func_466(piParam5);
		func_466(piParam6);
		return true;
	...
	if (!func_470(piParam6))
	{
		func_494(piParam6);
	}
	else if (bParam12 && CAM::IS_SCREEN_FADED_IN() || func_469(piParam6) > 0.5f && func_340(uParam4, 2))
	{
		*uParam11 = 1;
		func_466(piParam5);
		func_466(piParam6);
	...
	if (func_470(piParam8))
	{
		if (func_474(iParam1) != 0)
		{
			func_466(piParam8);
		}
		else if (func_469(piParam8) > func_434(iParam1, iParam9))
		{
			switch (iParam9)
			{
				case 0:
...
void func_387() // Position - 0x1D76C
{
	var unk;
	int num;

	num = Global_114162.f_18971;
	func_388(unk, 0, 0, 0, 0, num);
	return;
}

void func_388(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1D78B
{
	float num;
	int value;
	int alpha;
	...
	if (Global_79819 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_391(Global_79820, Global_79822, iParam10) };
				y == -0.014f;
...
void func_389() // Position - 0x1DA70
{
	Global_79819 != 6;
...
float func_390(const char* sParam0) // Position - 0x1DAA8
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_391(int iParam0, int iParam1, int iParam2) // Position - 0x1DABB
{
	var unk;
	int num;
	...
	{
		case 1:
			unk = { func_401(iParam0) };
			break;
	
		case 7:
			unk = { func_399(iParam0) };
			break;
		...
		case 3:
			...
			{
				case 0:
					unk = { func_398(iParam2) };
					break;
			
				case 8:
					unk = { func_397(iParam2) };
					break;
			
				case 7:
					unk = { func_396(iParam2) };
					break;
			
				case 10:
					unk = { func_395(iParam2) };
					break;
			
				case 5:
					unk = { func_394(iParam2) };
					break;
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_392(num), 8);
					break;
			}
			break;
...
char* func_392(int iParam0) // Position - 0x1DB91
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_393(int iParam0) // Position - 0x1DCE4
{
	var unk;
	var unk3;
...
struct<2> func_394(int iParam0) // Position - 0x1DD17
{
	var unk;
	var unk3;
...
struct<2> func_395(int iParam0) // Position - 0x1DD4A
{
	var unk;
	var unk3;
...
struct<2> func_396(int iParam0) // Position - 0x1DD7D
{
	var unk;
	var unk3;
...
struct<2> func_397(int iParam0) // Position - 0x1DDB0
{
	var unk;
	var unk3;
...
struct<2> func_398(int iParam0) // Position - 0x1DDED
{
	var unk;
	var unk3;
...
struct<2> func_399(int iParam0) // Position - 0x1DE20
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_400(iParam0) };
...
struct<2> func_400(int iParam0) // Position - 0x1DE57
{
	var unk;
...
struct<2> func_401(int iParam0) // Position - 0x1E2A3
{
	var unk;
...
BOOL func_402(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1E30C
{
	if (!func_404(0) || Global_79835 || Global_79823 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
	...
	switch (Global_79819)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_32(0) || func_403(true))
			{
			}
			else
			{
...
BOOL func_403(BOOL bParam0) // Position - 0x1E424
{
	if (bParam0)
...
BOOL func_404(int iParam0) // Position - 0x1E44D
{
	if (Global_44199 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1E46F
{
	return func_406(iParam0, Global_44199);
}

BOOL func_406(int iParam0, int iParam1) // Position - 0x1E480
{
	if (iParam1 == 15)
		return 1;
...
float func_407(var uParam0) // Position - 0x1E661
{
	return uParam0->f_80;
}

int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1E66D
{
	func_422(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	...
	Global_23439 = 0;
	Global_2883585 = 0;
	return func_409(sParam2, iParam3, false);
}

int func_409(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1E6BB
{
	Global_22443 = 0;
...
void func_410() // Position - 0x1E989
{
	if (!func_411())
		return;
...
BOOL func_411() // Position - 0x1E9C0
{
...
BOOL func_412(Player plParam0) // Position - 0x1EA23
{
	return func_413(plParam0, 20);
}

BOOL func_413(Player plParam0, int iParam1) // Position - 0x1EA33
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1EA4B
{
	return -1;
}

void func_415() // Position - 0x1EA54
{
	int i;
...
void func_416() // Position - 0x1EA85
{
...
BOOL func_417() // Position - 0x1EB1A
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1EBB3
{
	if (func_259(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_419() // Position - 0x1EC55
{
	int i;
...
BOOL func_420(int iParam0, int iParam1) // Position - 0x1ECAC
{
	switch (iParam0)
	{
		case 5:
...
void func_421() // Position - 0x1ECE4
{
...
void func_422(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1ED3B
{
...
char* func_423(var uParam0) // Position - 0x1ED91
{
	return uParam0->f_4;
}

void func_424(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, Vehicle veParam5, var uParam6, var uParam7) // Position - 0x1ED9D
{
	Cam cam;
	var unk;
	Vector3 vector;
	...
	cam = func_441(uParam0, 0);

	if (ENTITY::DOES_ENTITY_EXIST(veParam5) && !ENTITY::IS_ENTITY_DEAD(veParam5, false))
	{
		*uParam2 = { 10.2986f, 0f, 8.909f };
		*uParam4 = { { 1.2f, 1.2f, 1.2f } * { 0f, -SYSTEM::COS(-97.4239f + func_472(uParam1)), SYSTEM::SIN(-97.4239f + func_472(uParam1)) } };
		*uParam3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam5, 1.12046f, -0.317773f, 1.3385f) };
		unk = { func_471(*uParam4, uParam2->f_2) };
		vector2 = { *uParam3 + unk };
		*uParam6 = { -33f + *uParam2, 0f, -88.515f + func_472(uParam1) };
		*uParam7 = 26f;
		vector = { *uParam6 };
...
void func_425(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1EEA8
{
	if (bParam0)
	{
		...
		func_432(true, bParam3, bParam2, false);
		Global_64332 = 1;
		Global_76661 = 1;
		Global_79562 = 1;
	}
	else
	{
		...
		func_432(false, bParam3, bParam2, false);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_430(PLAYER::PLAYER_ID()) && !func_427(PLAYER::PLAYER_ID(), 0) && !func_426() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_430(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5)
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
...
BOOL func_426() // Position - 0x1EFF7
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_427(Player plParam0, int iParam1) // Position - 0x1F011
{
	BOOL flag;
...
int func_428(int iParam0, BOOL bParam1) // Position - 0x1F06A
{
	int num;
	int num2;
...
BOOL func_429(Player plParam0) // Position - 0x1F0AB
{
	Player player;
...
BOOL func_430(Player plParam0) // Position - 0x1F0CD
{
	if (func_427(plParam0, 0))
		return true;
...
BOOL func_431() // Position - 0x1F10C
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_432(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1F11A
{
	int num;
...
void func_433(int iParam0) // Position - 0x1F14D
{
	if (iParam0 == 1)
...
float func_434(int iParam0, int iParam1) // Position - 0x1F170
{
	switch (iParam0)
	{
		case 3:
...
int func_435(int iParam0) // Position - 0x1F20A
{
	switch (iParam0)
	{
		case 5:
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1F23E
{
	func_437();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_437() // Position - 0x1F257
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(character) && !func_259(14) || Global_113110)
			{
...
float func_438(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1F354
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1F36E
{
...
Vector3 func_440(int iParam0) // Position - 0x1F398
{
	switch (iParam0)
	{
		case 5:
...
Cam func_441(var uParam0, int iParam1) // Position - 0x1F3F2
{
	if (iParam1 >= 2)
		return 0;
...
void func_442(eSetPlayerControlFlags espcfParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1F40A
{
	...
	func_27(0);
	func_425(true, true, bParam2, false, false, false, false);
	HUD::DISPLAY_RADAR(false);
	HUD::DISPLAY_HUD(false);
	func_566(23, true);
	return;
...
void func_443(var uParam0, var uParam1, var uParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, Vehicle* pveParam6, Vehicle* pveParam7, var uParam8, Ped* ppedParam9, Hash hParam10, Hash hParam11, int* piParam12, int iParam13, var uParam14) // Position - 0x1F463
{
	Hash modelHash;
	Vehicle playersLastVehicle;
	float entityCoords;
	...
	if (_IS_NULL_VECTOR(func_465(uParam0)))
	{
	}
	else
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(func_465(uParam0), func_464(uParam0), false, true);
	}

	for (i = 0; i < 12; i = i + 1)
	{
		if (!_IS_NULL_VECTOR(func_376(uParam0, i)))
			*uParam2 = i + 1;
		else
			i = 999999;
	}
	...
	if (modelHash != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(*pveParam3, false) || ENTITY::DOES_ENTITY_EXIST(*pveParam3))
		{
			...
			ENTITY::SET_ENTITY_COORDS(*pveParam3, func_481(iParam13), true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(*pveParam3, func_472(uParam0));
		}
		else
		{
			*pveParam3 = VEHICLE::CREATE_VEHICLE(modelHash, func_481(iParam13), func_472(uParam0), true, true, false);
		}
	
		if (func_473(modelHash))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(*uParam8) || ENTITY::IS_ENTITY_DEAD(*uParam8, false))
			{
				*uParam8 = PED::CREATE_PED_INSIDE_VEHICLE(*pveParam3, PED_TYPE_MISSION, hParam10, -1, true, true);
				...
				func_463(*uParam8, iParam13);
				ENTITY::SET_ENTITY_INVINCIBLE(*uParam8, true, 0);
			}
		
			CAM::SHAKE_SCRIPT_GLOBAL("SKY_DIVING_SHAKE", 0.15f);
			func_461(uParam1, *uParam8, func_462(iParam13));
			func_458(uParam1, PLAYER::PLAYER_PED_ID(), func_460());
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if (func_457(PLAYER::PLAYER_PED_ID(), *pveParam3) == 1)
				{
					ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), *pveParam3, 2);
				}
	...
	else
	{
		...
		if (func_385(uParam0))
		{
			...
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_481(iParam13), true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_472(uParam0));
	...
	if (func_539(uParam0) != 0)
		func_453(uParam0, uParam5, iParam13);

	if (func_452(uParam0) != 0)
		func_449(uParam0, pveParam7);

	modelHash = _STOPWATCH_IS_INITIALIZED_0(uParam0);

	if (func_374(modelHash))
	{
	...
	{
		MISC::CLEAR_AREA(func_376(uParam0, 0), 100f, true, false, false, false);
		...
		{
			*pveParam4 = VEHICLE::CREATE_VEHICLE(modelHash, func_376(uParam0, 0), func_448(uParam0), true, true, false);
		
			if (func_447(_STOPWATCH_IS_INITIALIZED_0(uParam0)))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*pveParam4, 11);
			}
			else if (func_446(_STOPWATCH_IS_INITIALIZED_0(uParam0)))
			{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(*pveParam4, false))
		{
			...
			ENTITY::SET_ENTITY_COORDS(*pveParam4, func_376(uParam0, 0), true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(*pveParam4, func_448(uParam0));
		}
		...
		if (func_447(_STOPWATCH_IS_INITIALIZED_0(uParam0)))
		{
			...
			{
				*pveParam6 = VEHICLE::CREATE_VEHICLE(joaat("trflat"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*pveParam4, 0f, -10f, 0f), func_448(uParam0), true, true, false);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1FF19
{
...
void func_445(Ped pedParam0, int iParam1) // Position - 0x1FFB4
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		return;
...
BOOL func_446(Hash hParam0) // Position - 0x20089
{
	switch (hParam0)
	{
		case joaat("seashark"):
...
BOOL func_447(Hash hParam0) // Position - 0x200D3
{
	switch (hParam0)
	{
		case joaat("hauler"):
...
float func_448(var uParam0) // Position - 0x20111
{
	return uParam0->f_77;
}

void func_449(var uParam0, Vehicle* pveParam1) // Position - 0x2011D
{
	if (!ENTITY::DOES_ENTITY_EXIST(*pveParam1))
	{
		*pveParam1 = VEHICLE::CREATE_VEHICLE(func_452(uParam0), func_451(uParam0), func_450(uParam0), true, true, false);
	}
...
float func_450(var uParam0) // Position - 0x20186
{
	return uParam0->f_79;
}

Vector3 func_451(var uParam0) // Position - 0x20192
{
	return uParam0->f_9;
}

Hash func_452(var uParam0) // Position - 0x201A0
{
	return uParam0->f_3;
}

void func_453(var uParam0, var uParam1, int iParam2) // Position - 0x201AC
{
	Hash modelHash;
	Ped pedInVehicleSeat;
	Vehicle vehicle;
	...
	{
		if (!func_333(*uParam1) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, false)))
			pedInVehicleSeat = VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, false);
	
		vehicle = *uParam1;
	}

	modelHash = func_456(iParam2);

	if (modelHash != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(vehicle))
		{
			vehicle = VEHICLE::CREATE_VEHICLE(func_539(uParam0), func_455(uParam0), func_454(uParam0), true, true, false);
		}
		else
		{
			ENTITY::SET_ENTITY_COORDS(vehicle, func_455(uParam0), true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(vehicle, func_454(uParam0));
		}
		...
		func_463(pedInVehicleSeat, iParam2);
	}
	else
	{
		if (!ENTITY::DOES_ENTITY_EXIST(vehicle))
...
float func_454(var uParam0) // Position - 0x20319
{
	return uParam0->f_78;
}

Vector3 func_455(var uParam0) // Position - 0x20325
{
	return uParam0->f_70;
}

Hash func_456(int iParam0) // Position - 0x20333
{
	switch (iParam0)
	{
		case 0:
...
int func_457(Ped pedParam0, Vehicle veParam1) // Position - 0x203B3
{
...
void func_458(var uParam0, Ped pedParam1, char* sParam2) // Position - 0x20425
{
	int num;
...
char* func_460() // Position - 0x20482
{
	eCharacter character;
...
void func_461(var uParam0, Ped pedParam1, char* sParam2) // Position - 0x204C5
{
	int num;
...
char* func_462(int iParam0) // Position - 0x204F8
{
	return "EXT1HELIPILOT";
}

void func_463(Ped pedParam0, int iParam1) // Position - 0x20504
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		return;
...
Vector3 func_464(var uParam0) // Position - 0x205AE
{
	return uParam0->f_67;
}

Vector3 func_465(var uParam0) // Position - 0x205BC
{
	return uParam0->f_64;
}

void func_466(int* piParam0) // Position - 0x205CA
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
BOOL func_467(var uParam0, int* piParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x205E0
{
	var animDict;

	if (!func_473(func_474(iParam3)))
		STREAMING::REQUEST_ADDITIONAL_COLLISION_AT_COORD(func_481(iParam3));

	if (func_470(piParam1))
		if (func_469(piParam1) >= 5f)
			return true;
	else
		func_349(piParam1, 0f);
...
BOOL func_468(var uParam0) // Position - 0x20717
{
	int i;
...
float func_469(int* piParam0) // Position - 0x2075E
{
	if (func_470(piParam0))
		if (func_361(piParam0))
			return piParam0->f_2;
...
BOOL func_470(int* piParam0) // Position - 0x2079A
{
	return IS_BIT_SET(*piParam0, 1);
}

Vector3 func_471(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x207A7
{
	float num;
	float num2;
	float num3;
...
float func_472(var uParam0) // Position - 0x207EB
{
	return uParam0->f_76;
}

BOOL func_473(Hash hParam0) // Position - 0x207F7
{
	switch (hParam0)
	{
...
Hash func_474(int iParam0) // Position - 0x20841
{
	switch (iParam0)
	{
		case 0:
...
void func_475(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x20897
{
	int num;
	Hash hash;
	...
	if (CAM::IS_SCREEN_FADED_OUT())
		MISC::CLEAR_AREA(func_481(iParam1), 5000f, true, false, false, false);
	...
	if (num != 0)
	{
		if (func_473(num))
		{
			...
			*uParam3 = func_456(iParam1);
			func_478(uParam2, *uParam3);
		}
	
		func_478(uParam2, num);
	}

	if (func_539(uParam0) != 0)
	{
		func_478(uParam2, func_539(uParam0));
	
		if (func_456(iParam1) != 0)
			func_478(uParam2, func_456(iParam1));
		else
			func_478(uParam2, joaat("S_M_Y_Pilot_01"));
	}
	...
	if (hash != 0)
	{
		*uParam4 = func_477(iParam1);
		func_478(uParam2, *uParam4);
		func_478(uParam2, hash);
		func_478(uParam2, joaat("trflat"));
	}

	if (func_374(hash))
	{
		func_478(uParam2, joaat("freight"));
		func_478(uParam2, joaat("freightcar"));
		func_478(uParam2, joaat("freightgrain"));
		func_478(uParam2, joaat("freightcont1"));
		func_478(uParam2, joaat("freightcont2"));
		func_478(uParam2, joaat("tankercar"));
		func_478(uParam2, joaat("metrotrain"));
	}

	if (func_452(uParam0) != 0)
		func_478(uParam2, func_452(uParam0));
	...
	*uParam5 = func_171();
	...
	if (func_474(iParam1) == 0)
		STREAMING::REQUEST_ADDITIONAL_COLLISION_AT_COORD(func_481(iParam1));

	return;
}

void func_476(var uParam0) // Position - 0x20B33
{
	int i;
...
int func_477(int iParam0) // Position - 0x20B63
{
	switch (iParam0)
	{
		case 0:
...
int func_478(var uParam0, Hash hParam1) // Position - 0x20B9D
{
	int i;
	int num;
...
int func_479(var uParam0) // Position - 0x20BFA
{
	int i;
...
void func_480(int iParam0, BOOL bParam1) // Position - 0x20C26
{
...
Vector3 func_481(int iParam0) // Position - 0x20C4D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_482(int iParam0) // Position - 0x20D97
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_481(iParam0), 15f, 15f, 15f, false, true, 0))
			return true;
	
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_481(iParam0), false, false, false, true);
...
Vector3 func_483(float fParam0, float fParam1, float fParam2) // Position - 0x20E07
{
	float num;
	float num2;
...
Vector3 func_484(int iParam0) // Position - 0x20E46
{
	switch (iParam0)
	{
		case 0:
...
void func_485(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x20F70
{
	Vector3 vector;
	Vector3 vector2;
	float fieldOfView;
	...
	vector = { func_493(uParam1) };
	vector2 = { func_492(uParam1) };
	fieldOfView = func_491(uParam1);

	if (!CAM::DOES_CAM_EXIST(func_441(uParam0, 0)))
	{
		func_490(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vector, vector2, 1115815936, false, 2), true);
	}
	else
	{
		CAM::SET_CAM_COORD(func_441(uParam0, 0), vector);
		CAM::SET_CAM_ROT(func_441(uParam0, 0), vector2, 2);
	}

	CAM::SET_CAM_FOV(func_441(uParam0, 0), fieldOfView);
	CAM::SET_CAM_ACTIVE(func_441(uParam0, 0), true);

	if (bParam3)
	{
		vector3 = { vector };
		vector3.f_2 = vector3.f_2 + 8f;
		CAM::SET_CAM_PARAMS(func_441(uParam0, 0), vector3, vector2, fieldOfView, func_489(iParam2), 1, 1, 2);
	}
	...
	if (!CAM::DOES_CAM_EXIST(func_441(uParam0, 1)))
	{
		func_490(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), vector, vector2, 1115815936, false, 2), true);
	}
	else
	{
		CAM::SET_CAM_COORD(func_441(uParam0, 1), vector);
		CAM::SET_CAM_ROT(func_441(uParam0, 1), vector2, 2);
	}

	CAM::SET_CAM_FOV(func_441(uParam0, 1), fieldOfView);

	if (!CAM::IS_SCREEN_FADED_OUT())
		CAM::SET_CAM_ACTIVE_WITH_INTERP(func_441(uParam0, 1), func_441(uParam0, 0), func_489(iParam2), 1, 1);
...
float func_486(var uParam0) // Position - 0x210F6
{
	return uParam0->f_82;
}

Vector3 func_487(var uParam0) // Position - 0x21102
{
	return uParam0->f_58;
}

Vector3 func_488(var uParam0) // Position - 0x21110
{
	return uParam0->f_55;
}

int func_489(int iParam0) // Position - 0x2111E
{
	switch (iParam0)
	{
		case 5:
...
void func_490(var uParam0, int iParam1, Cam caParam2, BOOL bParam3) // Position - 0x2114B
{
	if (iParam1 >= 2)
		return;
...
float func_491(var uParam0) // Position - 0x21178
{
	return uParam0->f_81;
}

Vector3 func_492(var uParam0) // Position - 0x21184
{
	return uParam0->f_52;
}

Vector3 func_493(var uParam0) // Position - 0x21192
{
	return uParam0->f_49;
}

void func_494(int* piParam0) // Position - 0x211A0
{
	if (!func_470(piParam0))
		func_378(piParam0);
...
void func_495(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x211B8
{
	int i;
...
void func_496(int iParam0) // Position - 0x21208
{
	BOOL flag;
	...
	if (func_314(&Global_78354.f_555[0 /*21*/], iParam0))
	{
		...
		if (IS_BIT_SET(Global_78354.f_555[0 /*21*/].f_9, 13))
		{
			if (iParam0 == 24 && func_320(iParam0, 0) && Global_79263.f_66 == 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] != 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] > 3 && !func_497(0, Global_78354.f_555[0 /*21*/].f_12) || !func_497(1, Global_78354.f_555[0 /*21*/].f_12))
			{
				func_321(&Global_114162.f_32754.f_69[Global_78354.f_555[0 /*21*/].f_14 /*78*/], &Global_79263);
...
BOOL func_497(int iParam0, int iParam1) // Position - 0x21377
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_498(&Global_114162.f_32754.f_5038[num /*157*/]))
		return false;

	return func_298(Global_114162.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_498(var uParam0) // Position - 0x213EA
{
	return *uParam0;
}

void func_499(char* sParam0, int iParam1) // Position - 0x213F5
{
	int i;
	int j;

	if (Global_112799 && iParam1)
	...
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &Global_114162.f_20414[i /*16*/]))
		{
			for (j = i; j <= Global_114162.f_20414.f_145 - 2; j = j + 1)
			{
				func_502(j, j + 1);
			}
		
			func_501(Global_114162.f_20414.f_145 - 1);
...
void func_500() // Position - 0x214A2
{
	int i;
...
void func_501(int iParam0) // Position - 0x215B9
{
	TEXT_LABEL_ASSIGN_STRING(&Global_114162.f_20414[iParam0 /*16*/], "", 16);
	TEXT_LABEL_ASSIGN_STRING(&(Global_114162.f_20414[iParam0 /*16*/].f_4), "", 16);
	Global_114162.f_20414[iParam0 /*16*/].f_8 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_9 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_11 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_10 = -1;
	Global_114162.f_20414[iParam0 /*16*/].f_12 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_13 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_14 = 0;
	Global_114162.f_20414[iParam0 /*16*/].f_15 = 0;
	return;
}

void func_502(int iParam0, int iParam1) // Position - 0x21653
{
	Global_114162.f_20414[iParam0 /*16*/] = { Global_114162.f_20414[iParam1 /*16*/] };
	Global_114162.f_20414[iParam0 /*16*/].f_4 = { Global_114162.f_20414[iParam1 /*16*/].f_4 };
	Global_114162.f_20414[iParam0 /*16*/].f_8 = Global_114162.f_20414[iParam1 /*16*/].f_8;
	Global_114162.f_20414[iParam0 /*16*/].f_10 = Global_114162.f_20414[iParam1 /*16*/].f_10;
	Global_114162.f_20414[iParam0 /*16*/].f_9 = Global_114162.f_20414[iParam1 /*16*/].f_9;
	Global_114162.f_20414[iParam0 /*16*/].f_11 = Global_114162.f_20414[iParam1 /*16*/].f_11;
	Global_114162.f_20414[iParam0 /*16*/].f_12 = Global_114162.f_20414[iParam1 /*16*/].f_12;
	Global_114162.f_20414[iParam0 /*16*/].f_13 = Global_114162.f_20414[iParam1 /*16*/].f_13;
	Global_114162.f_20414[iParam0 /*16*/].f_14 = Global_114162.f_20414[iParam1 /*16*/].f_14;
	Global_114162.f_20414[iParam0 /*16*/].f_15 = Global_114162.f_20414[iParam1 /*16*/].f_15;
	return;
}

void func_503(BOOL bParam0) // Position - 0x21763
{
	if (bParam0)
	{
...
void func_504() // Position - 0x217A5
{
	func_505(&uLocal_143, 0);
	return;
}

void func_505(var uParam0, int iParam1) // Position - 0x217B4
{
	if (uParam0->f_4 != 0)
		func_153(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44));
...
void func_506() // Position - 0x2185F
{
	int i;
	int j;
	var unk;
	...
	Global_2097536.f_2779 = 0;
	func_507(&(Global_2097536.f_2780));
	_STOPWATCH_DESTROY(&(Global_2097536.f_2823));
	Global_2097536.f_2825 = -1;
...
void func_507(int iParam0) // Position - 0x219CA
{
	int i;
...
void func_508(var uParam0) // Position - 0x21A20
{
	int i;
	var unk;
...
void func_509(var uParam0) // Position - 0x21AA8
{
	int i;
	var unk;
...
void func_510() // Position - 0x21B72
{
	Global_23848.f_5 = 1;
	return;
}

void func_511(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x21B80
{
	int pedParachuteState;

	if (iParam1 < 11)
	{
		if (!func_270(uParam0, 19))
			if (iParam1 == 4 && !bParam3 && CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())
				func_513(func_514(iParam2, 19), "", &(uParam0->f_607), 19);
	
		if (!func_270(uParam0, 20))
		{
			if (iParam1 > 4)
				func_513(func_514(iParam2, 20), func_514(iParam2, 19), &(uParam0->f_607), 20);
		}
		else if (!func_270(uParam0, 21))
		{
			if (iParam1 == 9)
				func_513(func_514(iParam2, 21), func_514(iParam2, 20), &(uParam0->f_607), 21);
			else if (iParam1 == 8)
				func_513(func_514(iParam2, 21), func_514(iParam2, 20), &(uParam0->f_607), 21);
		}
		else if (!func_270(uParam0, 22))
		{
			if (iParam1 == 9)
			{
				...
				if (pedParachuteState == 1 || pedParachuteState == 2)
					func_513(func_514(iParam2, 22), func_514(iParam2, 21), &(uParam0->f_607), 22);
			}
		}
		else if (iParam1 == 10 && !func_270(uParam0, 23))
		{
			func_512(func_514(iParam2, 22), &(uParam0->f_607), 23);
		}
		else if (!func_270(uParam0, 23) && !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
...
void func_512(char* sParam0, int* piParam1, int iParam2) // Position - 0x21CFE
{
...
BOOL func_513(char* sParam0, char* sParam1, int* piParam2, int iParam3) // Position - 0x21D1E
{
...
char* func_514(int iParam0, int iParam1) // Position - 0x21D6C
{
	char* str;
	...
	switch (iParam1)
	{
		...
		case 20:
			if (func_473(func_474(iParam0)))
				str = "BASEJUMPS_PREP_FOR_JUMP_HELI";
			else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_372(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))))
...
void func_515(var uParam0, int iParam1) // Position - 0x21DFC
{
	if (iParam1 < 11)
		if (!func_270(uParam0, 15))
			if (iParam1 >= 4 && CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())
				if (func_517(func_518(11), &(uParam0->f_607), 11))
					func_516(func_518(15), &(uParam0->f_607), 15);
		else if (!func_270(uParam0, 16))
			if (iParam1 == 9)
				if (func_517(func_518(12), &(uParam0->f_607), 12))
					func_516(func_518(16), &(uParam0->f_607), 16);
			else if (iParam1 == 8)
				if (func_517(func_518(12), &(uParam0->f_607), 12))
					func_516(func_518(16), &(uParam0->f_607), 16);
		else if (iParam1 == 10 && !func_270(uParam0, 17))
			if (func_517(func_518(13), &(uParam0->f_607), 13))
				func_516(func_518(17), &(uParam0->f_607), 17);

	return;
}

int func_516(char* sParam0, int* piParam1, int iParam2) // Position - 0x21F02
{
	if (!IS_BIT_SET(*piParam1, iParam2))
	{
...
BOOL func_517(char* sParam0, int* piParam1, int iParam2) // Position - 0x21F40
{
	if (!IS_BIT_SET(*piParam1, iParam2))
	{
		if (AUDIO::PREPARE_MUSIC_EVENT(sParam0))
...
char* func_518(int iParam0) // Position - 0x21F6F
{
	switch (iParam0)
	{
		case 15:
...
void func_519(var uParam0) // Position - 0x21FCD
{
	float num;
	var unk3;
	var unk4;
...
void func_521(var uParam0, int iParam1, BOOL bParam2) // Position - 0x22114
{
	if (bParam2)
...
void func_522(var uParam0) // Position - 0x22138
{
...
void func_523(var uParam0, float fParam1, var uParam2) // Position - 0x2214D
{
	func_525(uParam0, fParam1);
	func_524(uParam0, uParam2);
	return;
}

void func_524(var uParam0, var uParam1) // Position - 0x22165
{
	uParam0->f_1 = uParam1;
	return;
}

void func_525(var uParam0, float fParam1) // Position - 0x22173
{
	*uParam0 = fParam1;
	return;
}

void func_526(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x22180
{
	float controlNormal;
...
void func_527() // Position - 0x2226D
{
...
int func_528() // Position - 0x2231A
{
	var unk;

	func_538(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_537(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_536(&unk, CLOCK::GET_CLOCK_HOURS());
	func_531(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_530(&unk, CLOCK::GET_CLOCK_MONTH());
	func_529(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_529(var uParam0, int iParam1) // Position - 0x22360
{
	if (iParam1 <= 0)
		return;
...
void func_530(var uParam0, int iParam1) // Position - 0x223E6
{
...
void func_531(var uParam0, int iParam1) // Position - 0x22419
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_532(num, num2))
		return;
...
int func_532(int iParam0, int iParam1) // Position - 0x2246A
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_533(int iParam0) // Position - 0x2250C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_534(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2252E
{
	if (bParam0)
		return uParam1;
...
int func_535(int iParam0) // Position - 0x22545
{
	return iParam0 & 15;
}

void func_536(var uParam0, int iParam1) // Position - 0x22552
{
...
void func_537(var uParam0, int iParam1) // Position - 0x2258C
{
...
void func_538(var uParam0, int iParam1) // Position - 0x225C7
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
Hash func_539(var uParam0) // Position - 0x22603
{
	return uParam0->f_2;
}

void func_540(var uParam0, int iParam1) // Position - 0x2260F
{
	eCharacter character;
	...
	{
		case 0:
			func_565(uParam0, 125);
			func_564(uParam0, joaat("squalo"));
			func_563(uParam0, 41.0737f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			func_558(uParam0, 0);
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, -1039.7124f, -1731.1447f, 1f);
			func_554(uParam0, 317.8872f);
			func_553(uParam0, 0f, -2f, 0f);
			func_552(uParam0, "BJ_01P");
			func_550(uParam0, func_551(0));
			func_549(uParam0, func_484(0));
			func_548(uParam0, 53.4142f);
			func_547(uParam0, -1151.4016f, -1864.3694f, 214.9385f);
			func_546(uParam0, -55.1298f, -0.0328f, -19.7985f);
			func_545(uParam0, 39.6124f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
			break;
	
		case 1:
			func_565(uParam0, 126);
			func_564(uParam0, 0);
			func_563(uParam0, 10.5f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, 978.232f, -397.611f, 416.607f);
			func_555(uParam0, 1, 873.389f, -183.851f, 302.972f);
			func_555(uParam0, 2, 1082.347f, -86.822f, 174.287f);
			func_555(uParam0, 3, 1151.098f, 124.6955f, 81.4805f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
			func_552(uParam0, "BJ_02P");
			func_550(uParam0, func_551(1));
			func_549(uParam0, func_484(1));
			func_548(uParam0, 52.5984f);
			func_547(uParam0, 886.5799f, -442.7917f, 535.8002f);
			func_546(uParam0, -41.778f, 0.0092f, -13.8287f);
			func_545(uParam0, 41.3305f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 2:
			func_565(uParam0, 127);
			func_564(uParam0, 0);
			func_563(uParam0, 289.2623f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, 2028.516f, 1759.102f, 424.7939f);
			func_555(uParam0, 1, 2230.78f, 1600.25f, 318.384f);
			func_555(uParam0, 2, 2410.55f, 1739.71f, 253.494f);
			func_555(uParam0, 3, 2273.7869f, 1885.168f, 152.702f);
			func_555(uParam0, 4, 2111.9119f, 1887.4564f, 92.5308f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
			func_552(uParam0, "BJ_03P");
			func_550(uParam0, func_551(2));
			func_549(uParam0, func_484(2));
			func_548(uParam0, 31.9702f);
			func_547(uParam0, 2038.8071f, 1971.5627f, 591.7618f);
			func_546(uParam0, -79.6953f, 0.0213f, 159.6313f);
			func_545(uParam0, 50.8804f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 3:
			func_565(uParam0, 128);
			func_564(uParam0, 0);
			func_563(uParam0, 60.1427f);
			func_562(uParam0, joaat("frogger"));
			func_561(uParam0, 402.6013f, 5736.4507f, 696.3928f);
			func_560(uParam0, 119.8889f);
			func_559(uParam0, 5f);
			func_558(uParam0, 0);
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, 320.69f, 5808.49f, 550.56f);
			func_555(uParam0, 1, 220.59f, 5943.149f, 415.514f);
			func_555(uParam0, 2, 30.63f, 6117.63f, 227.9f);
			func_555(uParam0, 3, -80.95f, 6440.43f, 100.48f);
			func_555(uParam0, 4, -273.773f, 6633.584f, 6.533f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_04M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_04F");
			else
				func_552(uParam0, "BJ_04T");
		
			func_550(uParam0, func_551(3));
			func_549(uParam0, func_484(3));
			func_548(uParam0, 44.3626f);
			func_547(uParam0, 409.9299f, 5701.4766f, 696.7185f);
			func_546(uParam0, -5.0705f, 0f, 20.8267f);
			func_545(uParam0, 43.8549f);
			func_544(uParam0, 0);
			func_543(uParam0, 1);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 4:
			func_565(uParam0, 129);
			func_564(uParam0, 0);
			func_563(uParam0, 1.8891f);
			func_562(uParam0, joaat("skylift"));
			func_561(uParam0, -75.3f, -823.9f, 329.2f);
			func_560(uParam0, 150f);
			func_559(uParam0, 4f);
			func_558(uParam0, 0);
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, -77.2067f, -444.208f, 37f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_05M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_05F");
			else
				func_552(uParam0, "BJ_05T");
		
			func_550(uParam0, func_551(4));
			func_549(uParam0, func_484(4));
			func_548(uParam0, 26.7726f);
			func_547(uParam0, -111.8981f, -862.3896f, 334.5773f);
			func_546(uParam0, -5.4775f, 0.0397f, -29.0222f);
			func_545(uParam0, 30.0131f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 5:
			func_565(uParam0, 130);
			func_564(uParam0, joaat("hauler"));
			func_563(uParam0, 358.9586f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, -96.9738f, -662.5833f, 34.7843f);
			func_554(uParam0, -18.6f);
			func_553(uParam0, 0f, -6f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_06M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_06F");
			else
				func_552(uParam0, "BJ_06T");
		
			func_550(uParam0, func_551(5));
			func_549(uParam0, func_484(5));
			func_548(uParam0, 55.7667f);
			func_547(uParam0, -117.2447f, -977.6218f, 297.0984f);
			func_546(uParam0, -7.6574f, 0f, 0.8528f);
			func_545(uParam0, 60f);
			func_544(uParam0, 0);
			func_543(uParam0, 1);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 6:
			func_565(uParam0, 131);
			func_564(uParam0, 0);
			func_563(uParam0, 164.6178f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			func_558(uParam0, joaat("blazer"));
			func_557(uParam0, -1310.9476f, 4330.1265f, 7.2444f);
			func_556(uParam0, 87.84f);
			func_555(uParam0, 0, -1246.49f, 4482.091f, 100.349f);
			func_555(uParam0, 1, -1309.67f, 4400.428f, 50.542f);
			func_555(uParam0, 2, -1304.67f, 4348.428f, 5.75f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_07M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_07F");
			else
				func_552(uParam0, "BJ_07T");
		
			func_550(uParam0, func_551(6));
			func_549(uParam0, func_484(6));
			func_548(uParam0, 47.1789f);
			func_547(uParam0, -1242.7314f, 4536.298f, 186.6862f);
			func_546(uParam0, -13.6409f, 0f, 172.0553f);
			func_545(uParam0, 47.1789f);
			func_544(uParam0, 0);
			func_543(uParam0, 1);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 7:
			func_565(uParam0, 132);
			func_564(uParam0, joaat("freight"));
			func_563(uParam0, 112.6f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, -487.5452f, 4252.1924f, 87.712f);
			func_554(uParam0, 10.8894f);
			func_553(uParam0, 0f, -20f, 4f);
			func_552(uParam0, "BJ_08P");
			func_550(uParam0, func_551(7));
			func_549(uParam0, func_484(7));
			func_548(uParam0, 24.3623f);
			func_547(uParam0, -337.5233f, 4110.1597f, 315.6679f);
			func_546(uParam0, -29.1422f, 0.0324f, 47.5813f);
			func_545(uParam0, 37.0424f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 8:
			func_565(uParam0, 133);
			func_564(uParam0, 0);
			func_563(uParam0, 104.207f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, -1154.4427f, 204.1726f, 64.4915f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_09M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_09F");
			else
				func_552(uParam0, "BJ_09T");
		
			func_550(uParam0, func_551(8));
			func_549(uParam0, func_484(8));
			func_548(uParam0, 50f);
			func_547(uParam0, -805.2963f, 332.5761f, 234.6604f);
			func_546(uParam0, -19.7458f, 0f, 116.6405f);
			func_545(uParam0, 55.2882f);
			func_544(uParam0, 0);
			func_543(uParam0, 1);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 9:
			func_565(uParam0, 134);
			func_564(uParam0, 0);
			func_563(uParam0, 329.4791f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			func_558(uParam0, joaat("blazer"));
			func_557(uParam0, -818.3042f, 4405.6753f, 20.1095f);
			func_556(uParam0, -89.36f);
			func_555(uParam0, 0, -1200f, 3616f, 964f);
			func_555(uParam0, 1, -1240f, 3307f, 854f);
			func_555(uParam0, 2, -1552f, 3456f, 655f);
			func_555(uParam0, 3, -1616f, 3808f, 505f);
			func_555(uParam0, 4, -1157.684f, 4128.348f, 288.607f);
			func_555(uParam0, 5, -1063.995f, 4246.1367f, 163.291f);
			func_555(uParam0, 6, -938.541f, 4360.14f, 82.372f);
			func_555(uParam0, 7, -828.1418f, 4413.5615f, 20.062f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
			func_552(uParam0, "BJ_10P");
			func_550(uParam0, func_551(9));
			func_549(uParam0, func_484(9));
			func_548(uParam0, 31.7648f);
			func_547(uParam0, -1286.9763f, 3660.1375f, 1082.208f);
			func_546(uParam0, -47.0453f, 0.0328f, -13.4198f);
			func_545(uParam0, 39.6786f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 10:
			...
			func_557(uParam0, 0f, 0f, 0f);
			func_556(uParam0, 0f);
			func_555(uParam0, 0, 1239.342f, 4008.389f, 1135.372f);
			func_555(uParam0, 1, 1374.479f, 4156.592f, 1019.694f);
			func_555(uParam0, 2, 1391.31f, 4362.621f, 909.212f);
			func_555(uParam0, 3, 1240.832f, 4598.044f, 758.002f);
			func_555(uParam0, 4, 1382.169f, 4377.629f, 600.013f);
			func_555(uParam0, 5, 1624.116f, 4207.519f, 471.225f);
			func_555(uParam0, 6, 1910.345f, 4175.518f, 362.862f);
			func_555(uParam0, 7, 2236.975f, 4282.967f, 218.116f);
			func_555(uParam0, 8, 2330.282f, 4534.43f, 90f);
			func_555(uParam0, 9, 2473.3438f, 4715.347f, 33.524f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
			func_552(uParam0, "BJ_11P");
			func_550(uParam0, func_551(10));
			func_549(uParam0, func_484(10));
			func_548(uParam0, 27.2187f);
			func_547(uParam0, 1012.6727f, 3960.4355f, 1367.7009f);
			func_546(uParam0, -54.7868f, 0f, -90.128f);
			func_545(uParam0, 35.5634f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 11:
			func_565(uParam0, 136);
			func_564(uParam0, 0);
			func_563(uParam0, 24.92f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			func_558(uParam0, joaat("sanchez"));
			func_557(uParam0, 1280.9326f, -50.6157f, 61.8195f);
			func_556(uParam0, 130.39f);
			func_555(uParam0, 0, 1829.46f, -260.665f, 1141.852f);
			func_555(uParam0, 1, 1816.46f, -10.665f, 1033.084f);
			func_555(uParam0, 2, 1688.46f, 218.335f, 924.307f);
			func_555(uParam0, 3, 1503.46f, 382.335f, 815.529f);
			func_555(uParam0, 4, 1554.46f, 598.335f, 706.751f);
			func_555(uParam0, 5, 1813.46f, 724.335f, 597.973f);
			func_555(uParam0, 6, 1975.46f, 519.335f, 486.196f);
			func_555(uParam0, 7, 1946.46f, 125.335f, 364.417f);
			func_555(uParam0, 8, 1663.46f, -15.665f, 241.64f);
			func_555(uParam0, 9, 1396.64f, -62.665f, 118f);
			func_555(uParam0, 10, 1278.5f, -41.05f, 61.7f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
			func_552(uParam0, "BJ_12P");
			func_550(uParam0, func_551(11));
			func_549(uParam0, func_484(11));
			func_548(uParam0, 18.9374f);
			func_547(uParam0, 1628.1558f, -431.2605f, 1332.7611f);
			func_546(uParam0, -54.5827f, 0f, -2.0463f);
			func_545(uParam0, 56.4495f);
			func_544(uParam0, 0);
			func_543(uParam0, 0);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
		...
		case 12:
			func_565(uParam0, 137);
			func_564(uParam0, 0);
			func_563(uParam0, 359.2885f);
			func_562(uParam0, 0);
			func_561(uParam0, 0f, 0f, 0f);
			func_560(uParam0, 0f);
			func_559(uParam0, 0f);
			func_558(uParam0, joaat("sanchez"));
			func_557(uParam0, -885.2659f, 4433.5923f, 20.381f);
			func_556(uParam0, 104.35f);
			func_555(uParam0, 0, -771.9196f, 4400.4526f, 60.5786f);
			func_555(uParam0, 1, -892.6581f, 4427.487f, 19.8561f);
			func_554(uParam0, 0f);
			func_553(uParam0, 0f, 0f, 0f);
		
			if (character == CHAR_MICHAEL)
				func_552(uParam0, "BJ_13M");
			else if (character == CHAR_FRANKLIN)
				func_552(uParam0, "BJ_13F");
			else
				func_552(uParam0, "BJ_13T");
		
			func_550(uParam0, func_551(12));
			func_549(uParam0, func_484(12));
			func_548(uParam0, 48.3921f);
			func_547(uParam0, -765.6544f, 4332.836f, 149.0282f);
			func_546(uParam0, -18.0357f, 0f, 6.0212f);
			func_545(uParam0, 48.3921f);
			func_544(uParam0, 0);
			func_543(uParam0, 1);
			func_542(uParam0, 0f, 0f, 0f);
			func_541(uParam0, 0f, 0f, 0f);
...
void func_541(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x237E9
{
	uParam0->f_67 = { fParam1 };
	return;
}

void func_542(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x237FB
{
	uParam0->f_64 = { fParam1 };
	return;
}

void func_543(var uParam0, int iParam1) // Position - 0x2380D
{
	uParam0->f_84 = iParam1;
	return;
}

void func_544(var uParam0, int iParam1) // Position - 0x2381B
{
	uParam0->f_83 = iParam1;
	return;
}

void func_545(var uParam0, float fParam1) // Position - 0x23829
{
	uParam0->f_82 = fParam1;
	return;
}

void func_546(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23837
{
	uParam0->f_58 = { fParam1 };
	return;
}

void func_547(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23849
{
	uParam0->f_55 = { fParam1 };
	return;
}

void func_548(var uParam0, float fParam1) // Position - 0x2385B
{
	uParam0->f_81 = fParam1;
	return;
}

void func_549(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x23869
{
	uParam0->f_52 = { uParam1 };
	return;
}

void func_550(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2387B
{
	uParam0->f_49 = { uParam1 };
	return;
}

Vector3 func_551(int iParam0) // Position - 0x2388D
{
	switch (iParam0)
	{
		case 0:
...
void func_552(var uParam0, char* sParam1) // Position - 0x239D7
{
	uParam0->f_4 = sParam1;
	return;
}

void func_553(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x239E5
{
	uParam0->f_6 = { fParam1 };
	return;
}

void func_554(var uParam0, float fParam1) // Position - 0x239F7
{
	uParam0->f_77 = fParam1;
	return;
}

void func_555(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4) // Position - 0x23A05
{
	if (iParam1 < 0 || iParam1 >= 12)
		return;
...
void func_556(var uParam0, float fParam1) // Position - 0x23A30
{
	uParam0->f_79 = fParam1;
	return;
}

void func_557(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23A3E
{
	uParam0->f_9 = { fParam1 };
	return;
}

void func_558(var uParam0, int iParam1) // Position - 0x23A50
{
	uParam0->f_3 = iParam1;
	return;
}

void func_559(var uParam0, float fParam1) // Position - 0x23A5E
{
	uParam0->f_80 = fParam1;
	return;
}

void func_560(var uParam0, float fParam1) // Position - 0x23A6C
{
	uParam0->f_78 = fParam1;
	return;
}

void func_561(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x23A7A
{
	uParam0->f_70 = { fParam1 };
	return;
}

void func_562(var uParam0, int iParam1) // Position - 0x23A8C
{
	uParam0->f_2 = iParam1;
	return;
}

void func_563(var uParam0, float fParam1) // Position - 0x23A9A
{
	uParam0->f_76 = fParam1;
	return;
}

void func_564(var uParam0, int iParam1) // Position - 0x23AA8
{
	uParam0->f_1 = iParam1;
	return;
}

void func_565(var uParam0, int iParam1) // Position - 0x23AB6
{
	*uParam0 = iParam1;
	return;
}

void func_566(int iParam0, BOOL bParam1) // Position - 0x23AC3
{
	if (bParam1)
...
void func_567(int iParam0) // Position - 0x23AE5
{
	func_389();
...
void func_568(var uParam0, var uParam1, Vehicle* pveParam2, Vehicle* pveParam3, Vehicle* pveParam4, var uParam5, var uParam6, var uParam7, Ped* ppedParam8, var uParam9, var uParam10, int iParam11, var uParam12, Blip blParam13, Blip blParam14, int iParam15, var uParam16, BOOL bParam17) // Position - 0x23B01
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	{
		VEHICLE::SET_PLAYERS_LAST_VEHICLE(*uParam6);
		func_293(*uParam6, func_332(iParam15), func_331(iParam15), 24, false);
	}
	...
	*uParam12 = 1;
	...
	func_569();
	SCRIPT::SET_NO_LOADING_SCREEN(false);
	Global_114162.f_18971 = -1;
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_569() // Position - 0x23EC9
{
	Global_23848.f_5 = 0;
	return;
}

void func_570(var uParam0) // Position - 0x23ED7
{
	func_571(uParam0, 0);
	func_571(uParam0, 1);
	func_571(uParam0, 2);
...
void func_571(var uParam0, int iParam1) // Position - 0x23EF4
{
...
void func_572(int iParam0, BOOL bParam1) // Position - 0x23F11
{
...
void func_573(var uParam0) // Position - 0x23F45
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
	return;
}

void func_574(var uParam0) // Position - 0x23F53
{
	func_573(*uParam0);
	return;
}
