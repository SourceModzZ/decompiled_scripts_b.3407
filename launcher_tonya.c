...
void main() // Position - 0x0
{
	...
	unk_0x2094BC4B6731BA68(uLocal_90, 5f, 1, 0, 0, 0);
...
void func_3(int iParam0, var uParam1) // Position - 0x3A3
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xC25
{
	var unk;
...
void func_21(var uParam0) // Position - 0xD1C
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD4C
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A25
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28D0
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2958
{
...
BOOL func_29(var uParam0) // Position - 0x2998
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x29C6
{
...
int func_31(var uParam0) // Position - 0x2AA2
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2AE4
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B47
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BD5
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E7F
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x349E
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35CD
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x3714
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3751
{
...
int func_47(eCharacter echParam0) // Position - 0x3776
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3785
{
...
var func_50(int iParam0, int iParam1) // Position - 0x394E
{
...
var func_54(int iParam0, int iParam1) // Position - 0x39C7
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39DC
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F25
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x428B
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x437E
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x489F
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x5620
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x565B
{
	int num;
...
void func_67(int iParam0) // Position - 0x58CF
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x590B
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E5A
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E9E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x661D
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6664
{
...
BOOL func_73(int iParam0) // Position - 0x66BF
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66CF
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x672F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AE6
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6AF1
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B01
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BA3
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x731D
{
...
int func_81() // Position - 0x7618
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7627
{
...
int func_83() // Position - 0x7651
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7669
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x767E
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7695
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76ED
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7797
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x782C
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7870
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x79F4
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A02
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84CA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x854C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85A4
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85AD
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8834
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x8844
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8861
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8871
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BB4
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8BC5
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C91
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CC4
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D15
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DB7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DD9
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DF0
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8DFD
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E37
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E72
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EAE
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8EC7
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F2A
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8F40
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F56
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F98
{
...
struct<2> func_119(int iParam0) // Position - 0x8FC0
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x940D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6E5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA2B
{
	int num;
...
void func_124(int iParam0) // Position - 0xAAD0
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAB6B
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xABC9
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC22
{
...
int func_129(int iParam0) // Position - 0xACA5
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACD6
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACEB
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD9E
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADB9
{
	int i;
...
int func_135(int iParam0) // Position - 0xAE05
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAE4E
{
...
BOOL func_138(int iParam0) // Position - 0xAE8F
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF5F
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFB2
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0A8
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB113
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB152
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2A1
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB2BB
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB314
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB355
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB377
{
...
BOOL func_150() // Position - 0xB3B6
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3C4
{
	int num;
...
void func_153(int iParam0) // Position - 0xB41E
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB441
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB574
{
...
void func_161(var uParam0) // Position - 0xB5CB
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB5F7
{
...
void func_164(int iParam0) // Position - 0xB799
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7CC
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB856
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8CA
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8D8
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB92F
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB93E
{
...
BOOL func_171(int iParam0) // Position - 0xB97F
{
	int num;
...
void func_172(int iParam0) // Position - 0xB9C4
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9F6
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB2D
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB7C
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB8D
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD6E
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBD90
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBDA1
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDEA
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE0E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC5F2
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC60D
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC69B
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC6FF
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC796
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC7C0
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCEDD
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCEEB
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCF52
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF63
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCF9B
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCFA7
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_196(var uParam0) // Position - 0xCFC3
{
	float num;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		num = SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_90);
		...
		if (num < 20f * 20f && bLocal_96)
		{
			switch (iLocal_97)
			{
				case 0:
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						...
						if (*uParam0 == 58)
						{
							...
							{
								unk_0xD0557B139A542F12(&uLocal_94);
								unk_0xB5396F1FB088FE38(&uLocal_94);
								...
								unk_0x93C0674FC00824D0(uLocal_94);
								unk_0x4BD42B0527065BB6(uParam0->f_28[0], uLocal_94);
								unk_0xD0557B139A542F12(&uLocal_94);
							}
						}
						else if (*uParam0 == 59)
				...
				case 2:
					if (func_203(&uLocal_263))
					{
						if (func_197(&uLocal_263) > unk_0xD2AA6F822D3A55D2(9f, 15f))
						{
...
float func_197(var uParam0) // Position - 0xDD74
{
	if (func_203(uParam0))
		if (func_199(uParam0))
			return uParam0->f_2;
		else
			return func_198(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1;

	return uParam0->f_1;
}

float func_198(BOOL bParam0) // Position - 0xDDB0
{
	float num;
	float num2;
	int value;
...
BOOL func_199(var uParam0) // Position - 0xDE08
{
	return IS_BIT_SET(*uParam0, 2);
}

void func_200(var uParam0) // Position - 0xDE15
{
	func_201(uParam0, 0f);
	return;
}

void func_201(var uParam0, float fParam1) // Position - 0xDE24
{
	uParam0->f_1 = func_198(IS_BIT_SET(*uParam0, 4)) - fParam1;
...
void func_202(var uParam0) // Position - 0xDE4F
{
	if (!func_203(uParam0))
		func_200(uParam0);
...
BOOL func_203(var uParam0) // Position - 0xDE67
{
	return IS_BIT_SET(*uParam0, 1);
}

int func_204(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xDE74
{
...
int func_205(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xDEC8
{
	Global_22426 = 0;
...
BOOL func_208(int iParam0) // Position - 0xE230
{
	return func_209(iParam0, 20);
}

BOOL func_209(int iParam0, int iParam1) // Position - 0xE240
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

void func_210() // Position - 0xE258
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xE3B8
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_215(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4B2
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE508
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE556
{
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE5F1
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_222(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_221(uParam0, 1);
			}
			else
			{
				...
				if (func_222(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_224(uParam0);
			}
		}
	}
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xE6E2
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xE71E
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xE757
{
	BOOL flag;
	int i;
...
float func_222(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xE7F5
{
	var unk;
...
BOOL func_223() // Position - 0xE82F
{
	return Global_98972;
}

void func_224(var uParam0) // Position - 0xE83B
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_225(uParam0);
...
void func_225(var uParam0) // Position - 0xE852
{
	BOOL flag;
	int num;
	int i;
...
void func_226(int iParam0) // Position - 0xE93A
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE962
{
	var unk;
	...
	if (func_264(*panParam0) || func_262(*panParam0) || Global_79785 == 1)
		return true;
...
void func_228(int iParam0, var uParam1, int iParam2) // Position - 0xEBD2
{
	var unk;
	var unk2;
...
BOOL func_229(int iParam0) // Position - 0xEF2A
{
...
BOOL func_230(var uParam0) // Position - 0xEF4A
{
...
BOOL func_231(var uParam0) // Position - 0xEF62
{
...
void func_232(var uParam0) // Position - 0xEF87
{
	int i;
	var unk;
...
void func_233(var uParam0) // Position - 0xF28B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_234(var uParam0) // Position - 0xF2B6
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF336
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_236(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_236(var uParam0, var uParam1) // Position - 0xF4F4
{
	var unk;
...
BOOL func_237(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF524
{
	int i;
	int num;
...
BOOL func_238(int iParam0) // Position - 0xF7E0
{
...
BOOL func_239(var uParam0, int iParam1) // Position - 0xF814
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_250(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_240(var uParam0, int iParam1) // Position - 0xF88A
{
	return func_241(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_241(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF8A2
{
	BOOL flag;
	var unk;
	int num;

	num = func_249(uParam0, uParam1);
	...
	if (!func_245(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_242(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_242(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF963
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_243(var uParam0, int iParam1) // Position - 0xFA8F
{
	int num;
...
BOOL func_245(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFB9E
{
	var unk;
	var unk4;
	float num;

	unk = { func_247(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_247(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_246(unk4, unk);
...
float func_246(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xFC2F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_247(float fParam0, var uParam1, var uParam2) // Position - 0xFC50
{
	float num;
	float num2;
...
void func_248(var uParam0) // Position - 0xFC8F
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_249(var uParam0, var uParam1) // Position - 0xFCAA
{
	int i;
...
int func_250(var uParam0) // Position - 0xFCE9
{
...
BOOL func_251(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFD11
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_255(uParam0, bParam1, num, num2))
				return true;
		
			if (func_252(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_252(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFE0C
{
	float num;
	float num2;
...
BOOL func_253(var uParam0, float fParam1) // Position - 0xFF18
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_254(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_254(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFFAD
{
	var unk;
	var unk4;
	float num;

	unk = { func_247(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_255(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x1003D
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_256(int iParam0) // Position - 0x10085
{
...
void func_257(var uParam0) // Position - 0x100CF
{
	var unk;
...
BOOL func_258(int iParam0) // Position - 0x1016C
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_259(int iParam0) // Position - 0x10201
{
...
BOOL func_260() // Position - 0x10240
{
	if (unk_0x761778199FE1211C())
...
BOOL func_261() // Position - 0x1025D
{
	if (Global_98585 != -1)
...
BOOL func_262(int iParam0) // Position - 0x10280
{
	if (func_263() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_263() // Position - 0x102B4
{
...
BOOL func_264(int iParam0) // Position - 0x102F2
{
...
BOOL func_265(var uParam0) // Position - 0x1031A
{
	if (!func_266(uParam0))
		return false;

	uLocal_93 = unk_0xA7B0B03284E7503C(uLocal_90 - { 10f, 10f, 10f }, uLocal_90 + { 10f, 10f, 10f }, 0, 1, 1, 1, 1);
	bLocal_95 = true;
	func_296("Created initial scene");
	return true;
}

BOOL func_266(var uParam0) // Position - 0x1036F
{
	BOOL flag;
	var unk;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
			{
				unk_0xD0557B139A542F12(&unk);
				unk_0xB5396F1FB088FE38(&unk);
				...
				unk_0x93C0674FC00824D0(unk);
				unk_0x4BD42B0527065BB6(uParam0->f_28[0], unk);
				unk_0xD0557B139A542F12(&unk);
				unk_0xE67051907958B5EB(uParam0->f_28[0], unk_0x4A8C381C258A124D(), -1, 0, 4);
			}
...
BOOL func_267(int iParam0) // Position - 0x10625
{
	int i;
...
BOOL func_268(int iParam0) // Position - 0x1068D
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x106DE
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0x10797
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x10858
{
	int i;
	var unk;
	int num;
...
BOOL func_272(int iParam0, char* sParam1) // Position - 0x108DD
{
...
BOOL func_273(int iParam0) // Position - 0x109BF
{
...
BOOL func_274(int iParam0) // Position - 0x109EA
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10A15
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x10A40
{
	if (func_259(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10A75
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10ADA
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10B52
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x10BCD
{
	func_293();
...
void func_281(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10CA1
{
...
void func_282(var uParam0, BOOL bParam1) // Position - 0x10CC1
{
	func_283(&(uParam0->f_41), bParam1);
	return;
}

void func_283(var uParam0, BOOL bParam1) // Position - 0x10CD3
{
	int i;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x10D11
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x10D4C
{
	func_286(&(uParam0->f_35), bParam1);
	return;
}

void func_286(var uParam0, BOOL bParam1) // Position - 0x10D5E
{
	int i;
...
void func_287(var uParam0) // Position - 0x10D9B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_288(var uParam0) // Position - 0x10DD3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_289(var uParam0, int iParam1) // Position - 0x10E6F
{
	func_290(&(uParam0->f_28), iParam1);
	return;
}

void func_290(var uParam0, int iParam1) // Position - 0x10E81
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_291(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_291(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10EC2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_292(var uParam0) // Position - 0x10F12
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_293() // Position - 0x10F53
{
	Global_21291 = 0;
	func_294();
	return;
...
void func_294() // Position - 0x10F63
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
void func_295(int iParam0) // Position - 0x10F84
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x10FC1
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x10FD3
{
	*uParam0 = -1;
