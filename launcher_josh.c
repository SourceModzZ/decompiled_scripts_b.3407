	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_318(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B19
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29C4
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A4C
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4994
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5715
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5750
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x59C4
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F4F
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BF6
{
	int i;
...
int func_97() // Position - 0x895E
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x896E
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x898B
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x899B
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8CDE
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8CEF
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8D35
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8DBB
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8DEE
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8E3F
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8EE1
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8F03
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8F1A
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8F27
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8F61
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F9C
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8FD8
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8FF1
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x9054
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x906A
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x9080
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x90C2
{
...
struct<2> func_119(int iParam0) // Position - 0x90EA
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9537
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA80F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAB55
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xABFA
{
	var name;
...
void func_125(int iParam0) // Position - 0xAC95
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xACF3
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAD4C
{
...
int func_129(Ped pedParam0) // Position - 0xADCF
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAE00
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAE15
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAEC8
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAEE3
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAF2F
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAF78
{
...
BOOL func_137(int iParam0) // Position - 0xAF98
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xB068
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB0BB
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB1B1
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB21C
{
	Player playerIndex;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB25B
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB3AA
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_145(Player plParam0, int iParam1) // Position - 0xB3C4
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB41D
{
	int num;
	int num2;
...
BOOL func_147(Player plParam0) // Position - 0xB45E
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB480
{
...
BOOL func_149() // Position - 0xB4BF
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB4CD
{
	int num;
...
void func_152(int iParam0) // Position - 0xB527
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB54A
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5EE
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB67D
{
...
void func_160(Vehicle veParam0) // Position - 0xB6D4
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB700
{
...
void func_163(int iParam0) // Position - 0xB8A2
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB8D5
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB95F
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB9D3
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_167(int iParam0) // Position - 0xB9E1
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xBA38
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_169(int iParam0) // Position - 0xBA47
{
...
BOOL func_170(int iParam0) // Position - 0xBA88
{
	int num;
...
void func_171(int iParam0) // Position - 0xBACD
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBAFF
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBC36
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC85
{
	return func_175(iParam0, Global_44199);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBC96
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBE77
{
	if (Global_44199 == 15)
		return false;
...
int func_177() // Position - 0xBE99
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBEAA
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBEF3
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBF17
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC388
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC3B4
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC3CB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0) // Position - 0xC45A
{
	if (*uParam0 == 30)
	{
...
float func_185(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xC4D9
{
...
BOOL func_186(var uParam0) // Position - 0xC537
{
	if (*uParam0 == 29)
	{
...
BOOL func_187(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC5CA
{
...
int func_188(var uParam0) // Position - 0xC5FD
{
	if (*uParam0 == 28)
	{
...
int func_189(var uParam0, int iParam1) // Position - 0xC694
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_190() // Position - 0xCE77
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_191(var uParam0) // Position - 0xCE92
{
	float num;
...
void func_192(int iParam0, var uParam1) // Position - 0xCF20
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_193(BOOL bParam0) // Position - 0xCF84
{
...
BOOL func_194(Vehicle veParam0) // Position - 0xD01B
{
...
BOOL func_195(int iParam0) // Position - 0xD045
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113209 || Global_33108 || func_202() || func_201(8, -1) || func_101() || func_200() || func_199() || func_198() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_203() || Global_33108 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113209 || Global_33108 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113209 || Global_33108 || func_202() || func_201(8, -1) || func_101() || func_200() || func_198() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_203() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_201(8, -1) || func_198() || func_197() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_203() || Global_33108 || func_202() || func_201(8, -1) || func_200() || func_199() || func_198() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_203() || func_200() || Global_113209 || Global_33108 || func_202() || Global_45410 || func_201(8, -1) || func_199() || func_197() || func_198() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_203() || Global_113209 || Global_33108 || func_202() || func_201(8, -1) || func_199() || func_197() || func_101() || func_200() || func_198())
							return false;
						break;
				}
			}
...
BOOL func_196() // Position - 0xD762
{
	return Global_101752.f_1;
}

BOOL func_197() // Position - 0xD770
{
	if (Global_98610 != -1)
...
BOOL func_200() // Position - 0xD7D7
{
	return Global_101765.f_400 > 0;
}

BOOL func_201(int iParam0, int iParam1) // Position - 0xD7E8
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_202() // Position - 0xD820
{
	return Global_1575086;
}

BOOL func_203() // Position - 0xD82C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD914
{
...
BOOL func_206(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD962
{
	Global_22443 = 0;
...
BOOL func_209(Player plParam0) // Position - 0xDCCA
{
	return func_210(plParam0, 20);
}

BOOL func_210(Player plParam0, int iParam1) // Position - 0xDCDA
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_211() // Position - 0xDCF2
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDE52
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_216(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF4C
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDFA2
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
int func_218(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDFC3
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE04B
{
...
void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE086
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE177
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE1B3
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE1EC
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE28A
{
	return Global_98997;
}

void func_225(var uParam0) // Position - 0xE296
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE2AD
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE395
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
void func_228(var uParam0) // Position - 0xE3BD
{
	int i;
...
float func_229(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xE43D
{
	Vector3 entityCoords;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE477
{
	var unk;
	...
	if (func_266(*panParam0) || func_264(*panParam0) || Global_79810 == 1)
		return true;
...
void func_231(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE6E7
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_232(int iParam0) // Position - 0xEA3F
{
...
BOOL func_233(var uParam0) // Position - 0xEA5F
{
...
BOOL func_234(var uParam0) // Position - 0xEA77
{
...
void func_235(var uParam0) // Position - 0xEA9C
{
	int i;
	int taskSequenceId;
...
void func_236(Object* pobParam0) // Position - 0xEDA0
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEDCB
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_238(Ped pedParam0, Vehicle veParam1) // Position - 0xEF89
{
...
BOOL func_239(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEFB9
{
	int i;
	int num;
...
BOOL func_240(int iParam0) // Position - 0xF275
{
...
BOOL func_241(Ped pedParam0, int iParam1) // Position - 0xF2A9
{
	float xSize;
...
BOOL func_242(Ped pedParam0, int iParam1) // Position - 0xF31F
{
	return func_243(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF337
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_244(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF3F8
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_245(Ped pedParam0, int iParam1) // Position - 0xF524
{
...
BOOL func_247(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF633
{
	var unk;
...
float func_248(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF6C4
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_249(float fParam0, var uParam1, var uParam2) // Position - 0xF6E5
{
	float num;
	float num2;
...
void func_250(var uParam0) // Position - 0xF724
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_251(Ped pedParam0, Ped pedParam1) // Position - 0xF73F
{
	int i;
...
BOOL func_252(Ped pedParam0) // Position - 0xF77E
{
...
BOOL func_253(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF7A6
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_254(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF8A1
{
	float entityCoords;
	float num;
...
BOOL func_255(Ped pedParam0, float fParam1) // Position - 0xF9AD
{
	var outProjectile;
	var outCoords;
...
BOOL func_256(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFA42
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_257(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFAD0
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_258(int iParam0) // Position - 0xFB18
{
...
void func_259(Vehicle veParam0) // Position - 0xFB62
{
	int taskSequenceId;
...
BOOL func_260(int iParam0) // Position - 0xFBFF
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_261(int iParam0) // Position - 0xFC94
{
...
BOOL func_264(int iParam0) // Position - 0xFD13
{
	if (func_265() && Global_101713.f_11 == 6 && iParam0 == func_178(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_265() // Position - 0xFD47
{
...
BOOL func_266(int iParam0) // Position - 0xFD85
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFDAD
{
...
BOOL func_268(var uParam0) // Position - 0xFE48
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_269(var uParam0) // Position - 0xFEBD
{
	int num;
	int i;
...
void func_270(Vehicle* pveParam0, BOOL bParam1) // Position - 0x102B2
{
	var unk;
	float num;
...
void func_271(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10326
{
	func_272(pveParam0);
...
void func_272(Vehicle* pveParam0) // Position - 0x10369
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_273(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x10405
{
	func_274(ppedParam0);
...
void func_274(Ped* ppedParam0) // Position - 0x10426
{
...
BOOL func_275(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10467
{
...
BOOL func_276(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x104C3
{
	Hash model;
...
int func_277(var uParam0, eCharacter echParam1) // Position - 0x10551
{
	int num;
...
BOOL func_278(BOOL bParam0, BOOL bParam1) // Position - 0x10597
{
	int num;
...
BOOL func_279(BOOL bParam0, BOOL bParam1) // Position - 0x10605
{
	int num;
...
BOOL func_280(var uParam0) // Position - 0x106AB
{
	if (func_234(uParam0))
	{
...
BOOL func_281(var uParam0) // Position - 0x106D5
{
	int i;
...
void func_282(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x10706
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_283(var uParam0) // Position - 0x10742
{
	int num;
	int i;
	BOOL flag;
...
void func_284(Vehicle* pveParam0) // Position - 0x1092A
{
...
BOOL func_285(var uParam0) // Position - 0x10970
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_286(var uParam0) // Position - 0x10B93
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_287(BOOL bParam0, BOOL bParam1) // Position - 0x10D00
{
	int num;
...
BOOL func_288(int iParam0) // Position - 0x10D6E
{
	var unk;
	eCharacter character;
...
BOOL func_289(int iParam0) // Position - 0x10DBF
{
	const char* string2;
...
BOOL func_290(int iParam0) // Position - 0x10E78
{
	var unk;
...
BOOL func_291(int iParam0) // Position - 0x10F39
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_292(int iParam0, char* sParam1) // Position - 0x10FBE
{
...
BOOL func_293(int iParam0) // Position - 0x110A0
{
...
BOOL func_294(int iParam0) // Position - 0x110CB
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_295(int iParam0) // Position - 0x110F6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_296(int iParam0) // Position - 0x11121
{
	if (func_261(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_297() // Position - 0x11156
{
...
BOOL func_298(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x11170
{
	int i;
...
BOOL func_299(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x111D5
{
	int num;
	char* str;
...
BOOL func_300(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1124D
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_301(var uParam0, BOOL bParam1) // Position - 0x112C8
{
	char* str;
...
void func_302(char* sParam0) // Position - 0x11376
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_305(sParam0))
			func_303();
...
void func_303() // Position - 0x11395
{
	Global_21308 = 0;
	func_304();
	return;
...
void func_304() // Position - 0x113A5
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
BOOL func_305(char* sParam0) // Position - 0x113C6
{
	var string1;
...
struct<6> func_306() // Position - 0x113E6
{
	var unk;
...
int func_307(var uParam0) // Position - 0x1140A
{
	if (func_234(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_308(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11440
{
...
void func_309(var uParam0, BOOL bParam1) // Position - 0x11460
{
	func_310(&(uParam0->f_41), bParam1);
	return;
}

void func_310(var uParam0, BOOL bParam1) // Position - 0x11472
{
	int i;
...
void func_311(Object* pobParam0, BOOL bParam1) // Position - 0x114B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_312(var uParam0, BOOL bParam1) // Position - 0x114EB
{
	func_313(&(uParam0->f_35), bParam1);
	return;
}

void func_313(var uParam0, BOOL bParam1) // Position - 0x114FD
{
	int i;
...
void func_314(Vehicle* pveParam0) // Position - 0x1153A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_315(var uParam0, int iParam1) // Position - 0x11572
{
	func_316(&(uParam0->f_28), iParam1);
	return;
}

void func_316(var uParam0, int iParam1) // Position - 0x11584
{
	int i;
...
void func_317(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x115C5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_318(int iParam0) // Position - 0x11615
{
	if (*iParam0 == -1)
		return;
...
void func_319(char* sParam0) // Position - 0x11652
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_320(var uParam0) // Position - 0x11664
{
	*uParam0 = -1;
...
void func_321() // Position - 0x11697
{
...
Hash func_322(eCharacter echParam0) // Position - 0x116B1
{
	if (!func_36(echParam0))
