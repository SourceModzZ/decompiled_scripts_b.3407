...
void main() // Position - 0x0
{
	...
	iLocal_91 = joaat("dune");
	uLocal_92 = unk_0xA0A2925EDC6DDA6D(joaat("WEAPON_SNIPERRIFLE"));
	uLocal_93 = unk_0xB39F6B1C186F538E(joaat("COMPONENT_AT_SCOPE_LARGE"));
	uLocal_94 = unk_0xB39F6B1C186F538E(joaat("COMPONENT_AT_AR_SUPP_02"));
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	unk_0x2094BC4B6731BA68(vector, 3f, 1, 0, 0, 0);
	...
	while (true)
	{
		...
		if (num == 25)
			if (SYSTEM::VDIST2(vector, vector2) < 10f * 10f)
				unk_0x4190C67D524CD0DC(unk_0x4A8C381C258A124D(), 1f);
			else
				unk_0x4190C67D524CD0DC(unk_0x4A8C381C258A124D(), 3f);
	
		if (func_181(&num, 0) && unk_0x1D5CD3EAAA7422B0(vector.f_2 - vector2.f_2) < 2.5f)
		{
			if (!func_2(&num))
				func_272(&num, true);
...
void func_3(int iParam0, var uParam1) // Position - 0x3AF
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xC31
{
	var unk;
...
void func_21(var uParam0) // Position - 0xD28
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD58
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A31
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28DC
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2964
{
...
BOOL func_29(var uParam0) // Position - 0x29A4
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x29D2
{
...
int func_31(var uParam0) // Position - 0x2AAE
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2AF0
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B53
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BE1
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E8B
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34AA
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35D9
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x3720
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x375D
{
...
int func_47(eCharacter echParam0) // Position - 0x3782
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3791
{
...
var func_50(int iParam0, int iParam1) // Position - 0x395A
{
...
var func_54(int iParam0, int iParam1) // Position - 0x39D3
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39E8
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F31
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4298
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x438B
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x48AC
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x562D
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5668
{
	int num;
...
void func_67(int iParam0) // Position - 0x58DC
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5918
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E67
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5EAB
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x662A
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6671
{
...
BOOL func_73(int iParam0) // Position - 0x66CC
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66DC
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x673C
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AF3
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6AFE
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B0E
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BB0
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x732A
{
...
int func_81() // Position - 0x7625
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7634
{
...
int func_83() // Position - 0x765E
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7676
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x768B
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x76A2
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x76FA
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77A4
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7839
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x787D
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A01
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A0F
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84DA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x855C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85B4
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85BD
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8844
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x8854
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8871
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8881
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BC4
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8BD5
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C1B
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CA1
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CD4
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D25
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DC7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DE9
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E00
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E0D
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E47
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E82
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EBE
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8ED7
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F3A
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8F50
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F66
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FA8
{
...
struct<2> func_119(int iParam0) // Position - 0x8FD0
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x941D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6F5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA3B
{
	int num;
...
void func_124(int iParam0) // Position - 0xAAE0
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAB7B
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xABD9
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC32
{
...
int func_129(int iParam0) // Position - 0xACB5
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACE6
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACFB
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADAE
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADC9
{
	int i;
...
int func_135(int iParam0) // Position - 0xAE15
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAE5E
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAE7E
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAE9F
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF6F
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFC2
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0B8
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB123
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB162
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2B1
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB2CB
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB324
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB365
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB387
{
...
BOOL func_150() // Position - 0xB3C6
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3D4
{
	int num;
...
void func_153(int iParam0) // Position - 0xB42E
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB451
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4F5
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB584
{
...
void func_161(var uParam0) // Position - 0xB5DB
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB607
{
...
void func_164(int iParam0) // Position - 0xB7A9
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB7DC
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB866
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8DA
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB8E8
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB93F
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB94E
{
...
BOOL func_171(int iParam0) // Position - 0xB98F
{
	int num;
...
void func_172(int iParam0) // Position - 0xB9D4
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA06
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB3D
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB8C
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBB9D
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBD7E
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBDA0
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBDB1
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDFA
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE1E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC602
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC61D
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6AB
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC70F
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC7A6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC7D0
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCEED
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCEFB
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCF62
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF73
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCFAB
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCFB7
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCFD3
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_200(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD05B
{
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD096
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0EC
{
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD187
{
	var unk;
...
void func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1C1
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_200(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_204(uParam0, 1);
			}
			else
			{
				...
				if (func_200(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_206(uParam0);
			}
		}
	}
...
void func_202(int iParam0, BOOL bParam1) // Position - 0xD2B2
{
	if (iParam0 == -1)
		return;
...
int func_203(int iParam0) // Position - 0xD2EE
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_204(var uParam0, int iParam1) // Position - 0xD327
{
	BOOL flag;
	int i;
...
BOOL func_205() // Position - 0xD3C5
{
	return Global_98972;
}

void func_206(var uParam0) // Position - 0xD3D1
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_207(uParam0);
...
void func_207(var uParam0) // Position - 0xD3E8
{
	BOOL flag;
	int num;
	int i;
...
void func_208(int iParam0) // Position - 0xD4D0
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD4F8
{
	var unk;
	...
	if (func_246(*panParam0) || func_244(*panParam0) || Global_79785 == 1)
		return true;
...
void func_210(int iParam0, var uParam1, int iParam2) // Position - 0xD768
{
	var unk;
	var unk2;
...
BOOL func_211(int iParam0) // Position - 0xDAC0
{
...
BOOL func_212(var uParam0) // Position - 0xDAE0
{
...
BOOL func_213(var uParam0) // Position - 0xDAF8
{
...
void func_214(var uParam0) // Position - 0xDB1D
{
	int i;
	var unk;
...
void func_215(var uParam0) // Position - 0xDE21
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_216(var uParam0) // Position - 0xDE4C
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDECC
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_218(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_218(var uParam0, var uParam1) // Position - 0xE08A
{
	var unk;
...
BOOL func_219(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0BA
{
	int i;
	int num;
...
BOOL func_220(int iParam0) // Position - 0xE376
{
...
BOOL func_221(var uParam0, int iParam1) // Position - 0xE3AA
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_232(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_222(var uParam0, int iParam1) // Position - 0xE420
{
	return func_223(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE438
{
	BOOL flag;
	var unk;
	int num;

	num = func_231(uParam0, uParam1);
	...
	if (!func_227(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_224(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_224(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE4F9
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_225(var uParam0, int iParam1) // Position - 0xE625
{
	int num;
...
BOOL func_227(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE734
{
	var unk;
	var unk4;
	float num;

	unk = { func_229(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_229(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_228(unk4, unk);
...
float func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE7C5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_229(float fParam0, var uParam1, var uParam2) // Position - 0xE7E6
{
	float num;
	float num2;
...
void func_230(var uParam0) // Position - 0xE825
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(var uParam0, var uParam1) // Position - 0xE840
{
	int i;
...
int func_232(var uParam0) // Position - 0xE87F
{
...
BOOL func_233(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8A7
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_237(uParam0, bParam1, num, num2))
				return true;
		
			if (func_234(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_234(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9A2
{
	float num;
	float num2;
...
BOOL func_235(var uParam0, float fParam1) // Position - 0xEAAE
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_236(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB43
{
	var unk;
	var unk4;
	float num;

	unk = { func_229(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_237(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBD1
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_238(int iParam0) // Position - 0xEC19
{
...
void func_239(var uParam0) // Position - 0xEC63
{
	var unk;
...
BOOL func_240(int iParam0) // Position - 0xED00
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_241(int iParam0) // Position - 0xED95
{
...
BOOL func_244(int iParam0) // Position - 0xEE14
{
	if (func_245() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_245() // Position - 0xEE48
{
...
BOOL func_246(int iParam0) // Position - 0xEE86
{
...
BOOL func_247(var uParam0) // Position - 0xEEAE
{
	switch (*uParam0)
	{
		case 25:
...
BOOL func_248(var uParam0) // Position - 0xEEF5
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_255(&num) || !unk_0xE100DD4F82A51BDE("rcmhunting2"))
				return false;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uLocal_98))
			{
				uLocal_98 = unk_0x8A3572575D91006C(joaat("WEAPON_SNIPERRIFLE"), 0, uLocal_95, 0, 1065353216, 0, 0, 1);
				unk_0x93A0B91D4456D7E9(uLocal_98, joaat("COMPONENT_AT_SCOPE_LARGE"));
				unk_0x93A0B91D4456D7E9(uLocal_98, joaat("COMPONENT_AT_AR_SUPP_02"));
			}
		...
		case 3:
			...
			if (unk_0xE10356B235A70E70(uLocal_95, 1f, uLocal_92, 0))
				unk_0xCF39804E8C88080E(uLocal_98, 0f, -90f, -162.64f, 2, 1);
...
void func_249(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xF12A
{
	func_250(uParam0, iLocal_91, fParam1, fParam4);
...
void func_250(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF190
{
	func_251(uParam0);
...
void func_251(var uParam0) // Position - 0xF1D3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_252(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF26F
{
	if (func_253(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_253(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF2CB
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_288(echParam1);
...
int func_254(var uParam0, eCharacter echParam1) // Position - 0xF359
{
	int num;
...
BOOL func_255(var uParam0) // Position - 0xF39F
{
	int i;
...
BOOL func_256(var uParam0) // Position - 0xF3D0
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_255(&num) || !func_257(&(uParam0->f_48)) || !unk_0xE100DD4F82A51BDE("special_ped@cletus@base"))
				return false;
...
BOOL func_257(var uParam0) // Position - 0xF686
{
	if (func_213(uParam0))
	{
...
void func_258(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF6B0
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_259(int iParam0) // Position - 0xF6EC
{
	var unk;
	eCharacter character;
...
BOOL func_260(int iParam0) // Position - 0xF73D
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF7F6
{
	var unk;
...
BOOL func_262(int iParam0) // Position - 0xF8B7
{
	int i;
	var unk;
	int num;
...
BOOL func_263(int iParam0, char* sParam1) // Position - 0xF93C
{
...
BOOL func_264(int iParam0) // Position - 0xFA1E
{
...
BOOL func_265(int iParam0) // Position - 0xFA49
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xFA74
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_267(int iParam0) // Position - 0xFA9F
{
	if (func_241(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_269(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFAEE
{
	int i;
...
BOOL func_270(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFB53
{
	int num;
	char* str;
...
BOOL func_271(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFBCB
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xFC46
{
	if (bParam1)
	{
...
void func_273(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFC93
{
...
void func_274(var uParam0, BOOL bParam1) // Position - 0xFCB3
{
	func_275(&(uParam0->f_41), bParam1);
	return;
}

void func_275(var uParam0, BOOL bParam1) // Position - 0xFCC5
{
	int i;
...
void func_276(var uParam0, BOOL bParam1) // Position - 0xFD03
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_277(var uParam0, BOOL bParam1) // Position - 0xFD3E
{
	func_278(&(uParam0->f_35), bParam1);
	return;
}

void func_278(var uParam0, BOOL bParam1) // Position - 0xFD50
{
	int i;
...
void func_279(var uParam0) // Position - 0xFD8D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_280(var uParam0, int iParam1) // Position - 0xFDC5
{
	func_281(&(uParam0->f_28), iParam1);
	return;
}

void func_281(var uParam0, int iParam1) // Position - 0xFDD7
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_282(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_282(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFE18
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_283(var uParam0) // Position - 0xFE68
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_284(int iParam0) // Position - 0xFEA9
{
	if (*iParam0 == -1)
		return;
...
void func_285(char* sParam0) // Position - 0xFEE6
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_286(var uParam0) // Position - 0xFEF8
{
	*uParam0 = -1;
...
int func_288(eCharacter echParam0) // Position - 0xFF45
{
	if (!func_36(echParam0))
