...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x173751E886F8E9AB() || iLocal_98 || func_111() && unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_46, 500f, 500f, 500f, 0, 1, 0))
		{
			if (!func_111())
				if (func_110())
					func_142();
...
void func_1() // Position - 0x18C
{
	if (bLocal_86 && !bLocal_85)
	{
		...
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_101[iLocal_123]))
			{
				if (unk_0xC450B06E5AAA0985(uLocal_114[iLocal_123]))
					unk_0xFE54B8568B2ABD12(&uLocal_114[iLocal_123]);
			
				unk_0xF09E30AF1B8FB379(&iLocal_101[iLocal_123]);
			}
		}
	...
	if (SYSTEM::VDIST(_GET_PLAYER_COORDS(unk_0x259BE71D8A81D4FA()), uLocal_46) > 150f)
		func_142();

	return;
}

Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x23D
{
...
var func_6(BOOL bParam0, var uParam1, var uParam2) // Position - 0x36C
{
	if (bParam0)
		return uParam1;
...
int func_22() // Position - 0x80A
{
	...
	func_20(&unk, unk_0x4BA5A16068183C5E());
	func_19(&unk, unk_0x18E502A71E28968C());
	func_18(&unk, unk_0x5295501D0862870D());
	func_16(&unk, unk_0xB12880C92EA6EE15());
	func_17(&unk, unk_0x8825A6E0A30BDCB8());
	func_15(&unk, unk_0x7598FE4545010A75());
	return unk;
}

void func_23(int iParam0) // Position - 0x850
{
	Global_114135.f_24999.f_7 = iParam0;
	return;
}
...
void func_24() // Position - 0x863
{
	...
	{
		case 0:
			if (unk_0xB0E14182FAD64944(uLocal_111))
			{
				if (unk_0xC450B06E5AAA0985(uLocal_112))
				{
					if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_71, uLocal_74, fLocal_77, 0, 1, 0))
					{
						func_67();
			...
			if (bLocal_99)
			{
				if (unk_0x1DD05E817C89C737() - uLocal_128 > 6000)
				{
					if (!bLocal_100)
					{
		...
		case 1:
			if (unk_0x4FAFF4BCB7633475(iLocal_101[0]) && unk_0x4FAFF4BCB7633475(iLocal_101[1]) && unk_0x4FAFF4BCB7633475(iLocal_101[2]) && unk_0x4FAFF4BCB7633475(iLocal_101[3]) && unk_0x4FAFF4BCB7633475(iLocal_101[4]))
				func_25();
			else if (!unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), uLocal_46, 100f, 100f, 100f, 0, 1, 0))
				func_25();
			break;
	}
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xA4D
{
...
void func_32() // Position - 0xC6C
{
	...
	if (!unk_0xB00920C3C99A34C5())
	{
		if (!Global_79539)
		{
			if (func_33() == 2 == false && !unk_0x76CD105BCAC6EB9F())
			{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1186
{
	if (iParam2 == -1)
		iParam2 = func_36();
...
BOOL func_38(int iParam0) // Position - 0x1524
{
	switch (iParam0)
	{
		case 29:
...
void func_41(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x15B6
{
	int i;
...
void func_44() // Position - 0x18E6
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_46(character) && !func_45(14) || Global_113083)
			{
...
BOOL func_46(eCharacter echParam0) // Position - 0x19F1
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x19FD
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1A3A
{
...
int func_49(eCharacter echParam0) // Position - 0x1A5F
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_50(int iParam0) // Position - 0x1A6E
{
	int num;
	int i;
...
int func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1B97
{
...
BOOL func_55() // Position - 0x1D71
{
	return true;
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1D7A
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1D9C
{
...
int func_58(BOOL bParam0) // Position - 0x1DB3
{
	if (func_61())
	{
		Global_114125 = true;
		...
		if (func_38(Global_114124))
			func_59(0);
	
		unk_0xB51A8DA1DD0D2E4E(1, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_38(Global_114124))
...
BOOL func_61() // Position - 0x1F20
{
	switch (func_62(&Global_33147, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x20DC
{
	return func_65(iParam0, Global_44181);
}

BOOL func_65(int iParam0, int iParam1) // Position - 0x20ED
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_66(int iParam0) // Position - 0x22CE
{
	if (Global_44181 == 15)
		return false;
...
void func_67() // Position - 0x22F0
{
	if (unk_0xC450B06E5AAA0985(uLocal_112))
	{
		unk_0xFE54B8568B2ABD12(&uLocal_112);
	
		if (unk_0xB0E14182FAD64944(uLocal_111))
			if (!unk_0xC450B06E5AAA0985(iLocal_113))
				iLocal_113 = func_68(uLocal_111);
	}

	return;
}

int func_68(var uParam0) // Position - 0x2322
{
	int num;
...
var func_69(BOOL bParam0, var uParam1, var uParam2) // Position - 0x235A
{
	if (bParam0)
		return uParam1;
...
{
	if (unk_0x1D56B24774D5E23C(uLocal_111))
	{
		if (unk_0xC450B06E5AAA0985(uLocal_112))
			unk_0xFE54B8568B2ABD12(&uLocal_112);
...
void func_71() // Position - 0x239F
{
	...
	for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
	{
		...
		{
			if (func_95() && iLocal_125 != 2 || iLocal_125 == 1 && unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
			{
				func_93();
				SYSTEM::WAIT(0);
			...
			switch (iLocal_125)
			{
				case 0:
					...
					{
						if (unk_0xFAA48325A90263BE(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D(), 15f, 15f, 40f, 0, 1, 0) && unk_0xC1204DBD7B8A643E(unk_0x259BE71D8A81D4FA(), iLocal_101[iLocal_123]) || unk_0x7E54CB377175F94E(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D()))
						{
							if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_71, uLocal_74, fLocal_77, 0, 1, 0) || unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), 2205.9185f, 5633.4546f, 55.7472f, 15f, 15f, 40f, 0, 1, 0))
							{
								...
								{
									unk_0x895CE77855F9AFD2(iLocal_101[iLocal_123]);
									unk_0xB5396F1FB088FE38(&uLocal_122);
									...
									unk_0x93C0674FC00824D0(uLocal_122);
									unk_0x4BD42B0527065BB6(iLocal_101[i], uLocal_122);
									unk_0xD0557B139A542F12(&uLocal_122);
									unk_0x96A0632EBDD87FA3(iLocal_101[i], 1, -1, 0);
								}
				...
				case 1:
					for (j = 0; j < iLocal_101; j = j + 1)
					{
						if (!iLocal_88[j])
						{
							...
							unk_0x646DE293036A3499(0, unk_0x4A8C381C258A124D(), -1, 0);
							unk_0x93C0674FC00824D0(uLocal_122);
							unk_0x4BD42B0527065BB6(iLocal_101[j], uLocal_122);
							unk_0xD0557B139A542F12(&uLocal_122);
							unk_0x96A0632EBDD87FA3(iLocal_101[j], 1, -1, 0);
							iLocal_88[j] = 1;
						}
					}
					...
					if (!unk_0x4FAFF4BCB7633475(iLocal_101[iLocal_123]))
					{
						if (!unk_0x3644984C9D7B57EF(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D(), 50f))
						{
							unk_0xE67051907958B5EB(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D(), -1, 0, 2);
							unk_0x44FB298D6382876D(iLocal_101[iLocal_123], 1);
						}
					}
					...
					{
						if (unk_0x1DD05E817C89C737() - uLocal_128 > 12000)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							{
								_CONVERSATION_INITIALIZE_ACTOR(&uLocal_129, 3, iLocal_101[iLocal_123], "SalvadorGang", 0, 1);
					...
					if (iLocal_88[iLocal_123])
					{
						if (unk_0x1DD05E817C89C737() - uLocal_128 > 18000 || iLocal_127 - iLocal_126 > 5000 || unk_0x1B32E388988DD296(iLocal_101[iLocal_123], 0))
						{
							if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), uLocal_71, uLocal_74, fLocal_77, 0, 1, 0) || unk_0xFAA48325A90263BE(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_93();
								SYSTEM::WAIT(0);
							...
							{
								if (!unk_0x1B32E388988DD296(iLocal_101[iLocal_123], 0))
								{
									unk_0x974022927CB47E68(iLocal_101[iLocal_123]);
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[0]))
									{
										unk_0xB5396F1FB088FE38(&uLocal_122);
										unk_0xA966E518B752B92A(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2214.833f, 5635.6274f, 55.0029f, 8000);
										unk_0xA966E518B752B92A(0, 2222.2588f, 5613.22f, 53.5576f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2221.9507f, 5593.6255f, 52.9483f, 10000);
										unk_0xC58DD79B4CA8487F(uLocal_122, 1);
										unk_0x93C0674FC00824D0(uLocal_122);
										unk_0x4BD42B0527065BB6(iLocal_101[0], uLocal_122);
										unk_0xD0557B139A542F12(&uLocal_122);
										unk_0x96A0632EBDD87FA3(iLocal_101[0], 0, -1, 0);
									}
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[1]))
									{
										unk_0xB5396F1FB088FE38(&uLocal_122);
										unk_0xA966E518B752B92A(0, 2210.5842f, 5580.6836f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2205.466f, 5583.631f, 52.8682f, 8000);
										unk_0xA966E518B752B92A(0, 2203.0386f, 5567.4077f, 52.7996f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2199.4983f, 5560.702f, 52.8606f, 10000);
										unk_0xC58DD79B4CA8487F(uLocal_122, 1);
										unk_0x93C0674FC00824D0(uLocal_122);
										unk_0x4BD42B0527065BB6(iLocal_101[1], uLocal_122);
										unk_0xD0557B139A542F12(&uLocal_122);
										unk_0x96A0632EBDD87FA3(iLocal_101[1], 0, -1, 0);
									}
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[2]))
									{
										unk_0xB5396F1FB088FE38(&uLocal_122);
										unk_0xA966E518B752B92A(0, 2199.6792f, 5590.673f, 52.7784f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2210.6458f, 5593.5757f, 52.8312f, 8000);
										unk_0xA966E518B752B92A(0, 2232.7615f, 5593.5635f, 53.0542f, 1f, -1, 1048576000, 0, 1193033728);
										unk_0xCD76801E1106CABE(0, 2237.9163f, 5599.5894f, 53.2311f, 12000);
										unk_0xC58DD79B4CA8487F(uLocal_122, 1);
										unk_0x93C0674FC00824D0(uLocal_122);
										unk_0x4BD42B0527065BB6(iLocal_101[2], uLocal_122);
										unk_0xD0557B139A542F12(&uLocal_122);
										unk_0x96A0632EBDD87FA3(iLocal_101[2], 0, -1, 0);
									}
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[3]) && !unk_0x4FAFF4BCB7633475(iLocal_101[4]))
									{
										unk_0xB5396F1FB088FE38(&uLocal_122);
										unk_0xAB3658A740EED98E(0, iLocal_101[4], -1, 2f, 1f, 1073741824, 0);
										unk_0x0E95B96CFEFE7B61(0, iLocal_101[4], 0);
										unk_0x21B9EFA4B4AA3A5B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0x93C0674FC00824D0(uLocal_122);
										unk_0x4BD42B0527065BB6(iLocal_101[3], uLocal_122);
										unk_0xD0557B139A542F12(&uLocal_122);
										unk_0x96A0632EBDD87FA3(iLocal_101[3], 0, -1, 0);
									}
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[4]))
									{
										unk_0xB5396F1FB088FE38(&uLocal_122);
										unk_0xAB3658A740EED98E(0, iLocal_101[3], -1, 2f, 1f, 1073741824, 0);
										unk_0x0E95B96CFEFE7B61(0, iLocal_101[3], 0);
										unk_0x21B9EFA4B4AA3A5B(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0x93C0674FC00824D0(uLocal_122);
										unk_0x4BD42B0527065BB6(iLocal_101[4], uLocal_122);
										unk_0xD0557B139A542F12(&uLocal_122);
										unk_0x96A0632EBDD87FA3(iLocal_101[4], 0, -1, 0);
									}
								
									if (!unk_0x4FAFF4BCB7633475(iLocal_101[5]))
									{
										unk_0xAEFEF83576CF9532(iLocal_101[5], 0f, 3f, 1);
										unk_0x96A0632EBDD87FA3(iLocal_101[5], 0, -1, 0);
									}
								}
				...
				case 2:
					...
					for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
					{
						if (!unk_0x4FAFF4BCB7633475(iLocal_101[iLocal_123]))
						{
							...
							{
								unk_0x895CE77855F9AFD2(iLocal_101[iLocal_123]);
								unk_0x62A5310368A20EFA(iLocal_101[iLocal_123], unk_0x4A8C381C258A124D(), 0, 16);
								unk_0x44FB298D6382876D(iLocal_101[iLocal_123], 1);
...
int func_72(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2BF3
{
	int num;

	num = func_73(uParam0, !bParam1, false);
...
int func_73(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C3D
{
	int num;
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2CE1
{
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x30A7
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x30BF
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x324E
{
	if (func_45(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x32F0
{
	func_44();
...
void func_90(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x33EF
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3445
{
...
{
	return Global_114135.f_24999.f_7;
}
...
BOOL func_95() // Position - 0x3522
{
	int i;

	for (i = 0; i < iLocal_108; i = i + 1)
	{
		if (unk_0xD9F5E1FEFD1329E4(iLocal_108[i], 0))
			if (unk_0x9B3D4335E0EDB0BE(iLocal_108[i], unk_0x4A8C381C258A124D(), 1))
				return true;
	}

	for (i = 0; i < iLocal_101; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(iLocal_101[i]))
		{
			if (unk_0x7E54CB377175F94E(iLocal_101[i], unk_0x4A8C381C258A124D()))
				if (unk_0xE5D813FA6F741B01(unk_0x259BE71D8A81D4FA(), iLocal_101[i]) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iLocal_101[i]))
					return true;
		
			if (unk_0x398315D0C90DE6F6(unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1), 5f, 1) || unk_0x9B3D4335E0EDB0BE(iLocal_101[i], unk_0x4A8C381C258A124D(), 1) || unk_0x685171EED42BC4DF(unk_0x4A8C381C258A124D(), iLocal_101[i]) || unk_0x7A082DC02E5E00C1(unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) - { 15f, 15f, 15f }, unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) + { 15f, 15f, 15f }, joaat("WEAPON_SMOKEGRENADE"), 1) || unk_0x7A082DC02E5E00C1(unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) - { 15f, 15f, 15f }, unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) + { 15f, 15f, 15f }, joaat("WEAPON_GRENADE"), 1) || unk_0x7A082DC02E5E00C1(unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) - { 15f, 15f, 15f }, unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) + { 15f, 15f, 15f }, joaat("WEAPON_GRENADELAUNCHER"), 1) || unk_0x7A082DC02E5E00C1(unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) - { 15f, 15f, 15f }, unk_0xD1A6A821F5AC81DB(iLocal_101[i], 1) + { 15f, 15f, 15f }, joaat("WEAPON_STICKYBOMB"), 1))
				return true;
		}
	}

	if (unk_0x9D27D35452DED6B5(-1, uLocal_71, uLocal_74, fLocal_77))
		return true;
	...
	if (unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), 2202.4976f, 5603.4243f, 52.7476f, 20f, 20f, 20f, 0, 1, 0))
...
void func_96() // Position - 0x3795
{
	...
	{
		unk_0xA7B0B03284E7503C(uLocal_46 - { 20f, 50f, 50f }, uLocal_46 + { 20f, 50f, 50f }, 0, 1, 1, 1, 1);
		unk_0xCCA6D8A84EE8C88A(joaat("bobcatxl"), 1);
		unk_0x425BBE19F25A57AB(0f);
		unk_0xCC1C92F7E1A3CE9D(3, 0);
		iLocal_108[0] = unk_0x5779387E956077A6(joaat("bobcatxl"), 2209.1704f, 5572.8975f, 52.7565f, 255.5161f, 1, 1, 0);
		unk_0xEE0BCDB1B5E36BCB(iLocal_108[0], 1, 0);
		unk_0x1DE99C193C7EC64B(iLocal_108[0], 1084227584);
		unk_0xD772F6AA66750D2B(iLocal_108[0], 1, 1);
		iLocal_108[1] = unk_0x5779387E956077A6(joaat("bobcatxl"), 2195.473f, 5607.5063f, 52.5648f, 168.4012f, 1, 1, 0);
		unk_0xEE0BCDB1B5E36BCB(iLocal_108[1], 1, 0);
		unk_0xD772F6AA66750D2B(iLocal_108[1], 1, 0);
		num = 0;
		unk_0x0B0C9A0F9AAEB7F0(&num, 1);
		uLocal_111 = unk_0x6FCBED6282FF5DA5(joaat("PICKUP_MONEY_CASE"), uLocal_49, -1.368082f, 0.230633f, 176.87486f, num, unk_0xC5935DFB3F39785A(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		unk_0x06CD913C241C765E("DrugCult", &uLocal_121);
		unk_0xD414C47AFF81382A(3, uLocal_121, joaat("COP"));
		unk_0xD414C47AFF81382A(3, joaat("COP"), uLocal_121);
		unk_0xD414C47AFF81382A(5, uLocal_121, joaat("PLAYER"));
	
		for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
		{
			iLocal_101[iLocal_123] = unk_0xB1DBFEB95C0EFB88(26, joaat("G_M_Y_SalvaGoon_01"), uLocal_52[iLocal_123 /*3*/], uLocal_78[iLocal_123], 1, 1);
			unk_0xAAA71DD7E9059338(iLocal_101[iLocal_123], 1);
			unk_0xD0764B65C2DFEDCA(iLocal_101[iLocal_123], 2);
			unk_0xBE8796DB2B90A437(iLocal_101[iLocal_123], 50, 1);
			unk_0x1090EAA386FB31A8(iLocal_101[iLocal_123], 0);
			unk_0xC652B7E19CE29859(iLocal_101[iLocal_123], 13);
			unk_0x3CEA1FD137ACE2D9(iLocal_101[iLocal_123], uLocal_121);
			iLocal_124 = unk_0xC5935DFB3F39785A(0, 3);
		
			if (iLocal_124 == 0)
				unk_0xB41DEC3AAC1AA107(iLocal_101[iLocal_123], joaat("WEAPON_SAWNOFFSHOTGUN"), -1, 1, 1);
			else if (iLocal_124 == 1)
				unk_0xB41DEC3AAC1AA107(iLocal_101[iLocal_123], joaat("WEAPON_MICROSMG"), -1, 1, 1);
			else
				unk_0xB41DEC3AAC1AA107(iLocal_101[iLocal_123], joaat("WEAPON_ASSAULTRIFLE"), -1, 1, 1);
		
			unk_0x0428AFDCAA63B06E(iLocal_101[iLocal_123], 42, 1);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_129, 3, iLocal_101[iLocal_123], "SalvadorGang", 0, 1);
		}
		...
		if (!unk_0x4FAFF4BCB7633475(iLocal_101[0]))
		{
			...
			unk_0xA966E518B752B92A(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0xCD76801E1106CABE(0, 2214.833f, 5635.6274f, 55.0029f, 8000);
			unk_0xA966E518B752B92A(0, 2215.9932f, 5613.299f, 53.6157f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0xCD76801E1106CABE(0, 2221.9507f, 5593.6255f, 52.9483f, 10000);
			unk_0xC58DD79B4CA8487F(uLocal_122, 1);
			unk_0x93C0674FC00824D0(uLocal_122);
			unk_0x4BD42B0527065BB6(iLocal_101[0], uLocal_122);
		...
		unk_0xEB418CA245FFE897(iLocal_101[0], "piDrugCult[0]");
		...
		unk_0xEB418CA245FFE897(iLocal_101[1], "piDrugCult[1]");
	
		if (!unk_0x4FAFF4BCB7633475(iLocal_101[2]))
		{
			unk_0xB5396F1FB088FE38(&uLocal_122);
			unk_0xA966E518B752B92A(0, 2201.0137f, 5589.357f, 52.9573f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0xCD76801E1106CABE(0, 2210.6458f, 5593.5757f, 52.8312f, 8000);
			unk_0xA966E518B752B92A(0, 2229.6667f, 5598.368f, 53.2195f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0xCD76801E1106CABE(0, 2237.9163f, 5599.5894f, 53.2311f, 12000);
			unk_0xC58DD79B4CA8487F(uLocal_122, 1);
			unk_0x93C0674FC00824D0(uLocal_122);
			unk_0x4BD42B0527065BB6(iLocal_101[2], uLocal_122);
		...
		unk_0xEB418CA245FFE897(iLocal_101[2], "piDrugCult[2]");
		...
		unk_0xEB418CA245FFE897(iLocal_101[3], "piDrugCult[3]");
		...
		unk_0xEB418CA245FFE897(iLocal_101[4], "piDrugCult[4]");
		unk_0xAEFEF83576CF9532(iLocal_101[5], 0f, 3f, 1);
		unk_0xEB418CA245FFE897(iLocal_101[5], "piDrugCult[5]");
		uLocal_112 = func_97(uLocal_49, 0);
		unk_0x4C905FB262965D5D(uLocal_112, 140);
...
var func_97(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x3DCD
{
	var unk;
...
BOOL func_111() // Position - 0x5AFF
{
	if (Global_114124 == func_53() && unk_0x9FA91AA1AC724CD0() && Global_114125)
		return true;
...
BOOL func_115(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5BAB
{
	BOOL flag;
	Vector3 vector;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (!func_136(Global_114135.f_24999.f_43[iParam3]))
			return false;
		...
		if (func_46(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_124(num))
					if (func_117(i))
						if (!func_116(vector2, 0f, 0f, 0f, false))
...
BOOL func_116(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x5F45
{
	if (bParam6)
...
BOOL func_117(eCharacter echParam0) // Position - 0x5F8C
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x5FAD
{
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x6270
{
	int num;
	int num2;
...
BOOL func_124(int iParam0) // Position - 0x637C
{
	int num;
	int num2;
	int num3;
...
BOOL func_125(int iParam0, int iParam1) // Position - 0x6458
{
...
BOOL func_126(int iParam0) // Position - 0x6478
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_134() || Global_113182 || Global_33090 || func_133() || func_88(8, -1) || func_132() || func_131() || func_130() || func_129() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_134() || Global_33090 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_134() || Global_113182 || Global_33090 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_134() || Global_113182 || Global_33090 || func_133() || func_88(8, -1) || func_132() || func_131() || func_129() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_134() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_88(8, -1) || func_129() || func_128() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_127() // Position - 0x6B95
{
	return Global_101727.f_1;
}

BOOL func_128() // Position - 0x6BA3
{
	if (Global_98585 != -1)
...
BOOL func_133() // Position - 0x6C2C
{
	return Global_1575084;
}

BOOL func_134() // Position - 0x6C38
{
...
BOOL func_137(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x6C8E
{
	BOOL num;
	eCharacter character;
...
int func_138(eCharacter echParam0) // Position - 0x6D72
{
...
BOOL func_139(int iParam0) // Position - 0x6D96
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x6E32
{
	var unk;
...
void func_143(int iParam0) // Position - 0x6F86
{
	...
	if (func_111())
	{
		...
		func_146(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_145(Global_114124, true), 64);
	
		if (func_52(Global_114124) > 0)
		{
