	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A3C
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28E7
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x296F
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48B6
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5637
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5672
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58E6
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E71
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B18
{
	int i;
...
int func_97() // Position - 0x8881
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8891
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88AE
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88BE
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C01
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8C12
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C58
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CDE
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D11
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D62
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8E04
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E26
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E3D
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E4A
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E84
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EBF
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EFB
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F14
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F77
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F8D
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8FA3
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FE5
{
...
struct<2> func_119(int iParam0) // Position - 0x900D
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x945A
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA732
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA78
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB1D
{
	var name;
...
void func_125(int iParam0) // Position - 0xABB8
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAC16
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC6F
{
...
int func_129(Ped pedParam0) // Position - 0xACF2
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD23
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD38
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADEB
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE06
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE52
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE9B
{
...
BOOL func_137(int iParam0) // Position - 0xAEBB
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAF8B
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFDE
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB0D4
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB13F
{
	Player playerIndex;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB17E
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB2CD
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_145(Player plParam0, int iParam1) // Position - 0xB2E7
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB340
{
	int num;
	int num2;
...
BOOL func_147(Player plParam0) // Position - 0xB381
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB3A3
{
...
BOOL func_149() // Position - 0xB3E2
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3F0
{
	int num;
...
void func_152(int iParam0) // Position - 0xB44A
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB46D
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB511
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5A0
{
...
void func_160(Vehicle veParam0) // Position - 0xB5F7
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB623
{
...
void func_163(int iParam0) // Position - 0xB7C5
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB7F8
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB882
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB8F6
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_167(int iParam0) // Position - 0xB904
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB95B
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_169(int iParam0) // Position - 0xB96A
{
...
BOOL func_170(int iParam0) // Position - 0xB9AB
{
	int num;
...
void func_171(int iParam0) // Position - 0xB9F0
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA22
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB59
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBA8
{
	return func_175(iParam0, Global_44199);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBBB9
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD9A
{
	if (Global_44199 == 15)
		return false;
...
int func_177() // Position - 0xBDBC
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBDCD
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE16
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE3A
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC2AA
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2D6
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2ED
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC37C
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_185() // Position - 0xCB5F
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_186(var uParam0) // Position - 0xCB7A
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCC08
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC6C
{
...
BOOL func_189(Vehicle veParam0) // Position - 0xCD03
{
...
BOOL func_190(int iParam0) // Position - 0xCD2D
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD44A
{
	return Global_101752.f_1;
}

BOOL func_192() // Position - 0xD458
{
	if (Global_98610 != -1)
...
BOOL func_195() // Position - 0xD4BF
{
	return Global_101765.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD4D0
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD508
{
	return Global_1575086;
}

BOOL func_198() // Position - 0xD514
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_199(var uParam0) // Position - 0xD530
{
	if (iLocal_95 == -1)
...
void func_200(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0xD581
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD59B
{
	char* str;
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD790
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD818
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD853
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD8A9
{
...
float func_206(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD944
{
...
BOOL func_207(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD97E
{
	var unk;
...
BOOL func_208(char* sParam0) // Position - 0xDA40
{
	var string1;
...
struct<6> func_209() // Position - 0xDA60
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDA84
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_211(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDAA5
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_212(int iParam0, BOOL bParam1) // Position - 0xDB96
{
	if (iParam0 == -1)
		return;
...
int func_213(int iParam0) // Position - 0xDBD2
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_214(var uParam0, int iParam1) // Position - 0xDC0B
{
	BOOL flag;
	int i;
...
BOOL func_215() // Position - 0xDCA9
{
	return Global_98997;
}

void func_216(var uParam0) // Position - 0xDCB5
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_217(uParam0);
...
void func_217(var uParam0) // Position - 0xDCCC
{
	BOOL flag;
	int num;
	int i;
...
void func_218(int iParam0) // Position - 0xDDB4
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDDDC
{
	var unk;
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_79810 == 1)
		return true;
...
void func_220(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE04C
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_221(int iParam0) // Position - 0xE3A4
{
...
BOOL func_222(var uParam0) // Position - 0xE3C4
{
...
BOOL func_223(var uParam0) // Position - 0xE3DC
{
...
void func_224(var uParam0) // Position - 0xE401
{
	int i;
	int taskSequenceId;
...
void func_225(Object* pobParam0) // Position - 0xE705
{
...
void func_226(var uParam0) // Position - 0xE730
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE7B0
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_228(Ped pedParam0, Vehicle veParam1) // Position - 0xE96E
{
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE99E
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Position - 0xEC5A
{
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEC8E
{
	float xSize;
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xED04
{
	return func_233(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xED1C
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEDDD
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_235(Ped pedParam0, int iParam1) // Position - 0xEF09
{
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF018
{
	var unk;
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF0A9
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xF0CA
{
	float num;
	float num2;
...
void func_240(var uParam0) // Position - 0xF109
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(Ped pedParam0, Ped pedParam1) // Position - 0xF124
{
	int i;
...
BOOL func_242(Ped pedParam0) // Position - 0xF163
{
...
BOOL func_243(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF18B
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_244(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF286
{
	float entityCoords;
	float num;
...
BOOL func_245(Ped pedParam0, float fParam1) // Position - 0xF392
{
	var outProjectile;
	var outCoords;
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF427
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_247(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF4B5
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_248(int iParam0) // Position - 0xF4FD
{
...
void func_249(Vehicle veParam0) // Position - 0xF547
{
	int taskSequenceId;
...
BOOL func_250(int iParam0) // Position - 0xF5E4
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_251(int iParam0) // Position - 0xF679
{
...
BOOL func_254(int iParam0) // Position - 0xF6F8
{
	if (func_255() && Global_101713.f_11 == 6 && iParam0 == func_178(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_255() // Position - 0xF72C
{
...
BOOL func_256(int iParam0) // Position - 0xF76A
{
...
BOOL func_257(var uParam0) // Position - 0xF792
{
	switch (*uParam0)
	{
		case 21:
...
BOOL func_259(var uParam0) // Position - 0xF846
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFC06
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFC62
{
	Hash model;
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0xFCF0
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xFD36
{
	if (func_223(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0xFD60
{
	int i;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xFD91
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Position - 0xFDCD
{
	int num;
	int i;
	BOOL flag;
...
void func_268(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10114
{
	func_269(pveParam0);
...
void func_269(Vehicle* pveParam0) // Position - 0x10157
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_270(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x101F3
{
	func_271(ppedParam0);
...
void func_271(Ped* ppedParam0) // Position - 0x10214
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_272(var uParam0) // Position - 0x10255
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_273(int iParam0) // Position - 0x103B0
{
	var unk;
	eCharacter character;
...
BOOL func_274(int iParam0) // Position - 0x10401
{
	const char* string2;
...
BOOL func_275(int iParam0) // Position - 0x104BA
{
	var unk;
...
BOOL func_276(int iParam0) // Position - 0x1057B
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_277(int iParam0, char* sParam1) // Position - 0x10600
{
...
BOOL func_278(int iParam0) // Position - 0x106E2
{
...
BOOL func_279(int iParam0) // Position - 0x1070D
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10738
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10763
{
	if (func_251(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_282() // Position - 0x10798
{
...
BOOL func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x107B2
{
	int i;
...
BOOL func_284(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10817
{
	int num;
	char* str;
...
BOOL func_285(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1088F
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x1090A
{
	char* str;
...
void func_287(char* sParam0) // Position - 0x109AE
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_208(sParam0))
			func_288();
...
void func_288() // Position - 0x109CD
{
	Global_21308 = 0;
	func_289();
	return;
...
void func_289() // Position - 0x109DD
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
int func_290(var uParam0) // Position - 0x109FE
{
	if (func_223(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_291(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10A34
{
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x10A54
{
	func_293(&(uParam0->f_41), bParam1);
	return;
}

void func_293(var uParam0, BOOL bParam1) // Position - 0x10A66
{
	int i;
...
void func_294(Object* pobParam0, BOOL bParam1) // Position - 0x10AA4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_295(var uParam0, BOOL bParam1) // Position - 0x10ADF
{
	func_296(&(uParam0->f_35), bParam1);
	return;
}

void func_296(var uParam0, BOOL bParam1) // Position - 0x10AF1
{
	int i;
...
void func_297(Vehicle* pveParam0) // Position - 0x10B2E
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_298(var uParam0, int iParam1) // Position - 0x10B66
{
	func_299(&(uParam0->f_28), iParam1);
	return;
}

void func_299(var uParam0, int iParam1) // Position - 0x10B78
{
	int i;
...
void func_300(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10BB9
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_301(int iParam0) // Position - 0x10C09
{
	if (*iParam0 == -1)
		return;
...
void func_302(char* sParam0) // Position - 0x10C46
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_303(var uParam0) // Position - 0x10C58
{
	*uParam0 = -1;
...
void func_304() // Position - 0x10C8B
{
...
Hash func_305(eCharacter echParam0) // Position - 0x10CA5
{
	if (!func_36(echParam0))
