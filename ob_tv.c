					...
					switch (iLocal_27)
					{
						case 0:
							...
							else
							{
								...
								Global_33148[iLocal_41 /*11*/].f_2 = 0;
								Global_33148[iLocal_41 /*11*/].f_6 = 1;
								Global_33148[iLocal_41 /*11*/] = unk_0xC5935DFB3F39785A(0, 2);
								Global_33148[iLocal_41 /*11*/].f_1 = 0;
								Global_33148[iLocal_41 /*11*/].f_4 = 0;
								Global_33148[iLocal_41 /*11*/].f_7 = 0;
								Global_33148[iLocal_41 /*11*/].f_8 = 0;
								Global_33148[iLocal_41 /*11*/].f_10 = 0;
								fLocal_28 = -4f;
								func_56(&uLocal_24);
								func_54();
								func_53();
						...
						case 1:
							if (unk_0x3EE1A6D743332852(unk_0x259BE71D8A81D4FA(), 0))
								...
								if (func_45() || Global_33148[iLocal_41 /*11*/].f_5)
									iLocal_27 = 2;
							else
						...
						case 2:
							...
							if (!func_65(iLocal_41))
							{
								if (Global_33148[iLocal_41 /*11*/] == 3 || Global_33148[iLocal_41 /*11*/] == 2 || Global_33148[iLocal_41 /*11*/] == -1)
									Global_33148[iLocal_41 /*11*/] = unk_0xC5935DFB3F39785A(0, 2);
							
								unk_0xECDF98280946398E(Global_33148[iLocal_41 /*11*/]);
								unk_0xBAF43CF1A42D5B1A(fLocal_28);
							}
							else
							{
								iLocal_42 = Global_33148[iLocal_41 /*11*/];
								iLocal_43 = Global_33148[iLocal_41 /*11*/].f_1;
								unk_0x7C7F282055FB517C(iLocal_42, func_42(iLocal_43), Global_33148[iLocal_41 /*11*/].f_9);
								unk_0xECDF98280946398E(iLocal_42);
							
								if (Global_33148[iLocal_41 /*11*/].f_7)
								{
									Global_33148[iLocal_41 /*11*/].f_5 = 0;
									Global_33148[iLocal_41 /*11*/].f_7 = 0;
								}
							}
						
							Global_33148[iLocal_41 /*11*/].f_2 = 1;
							func_41(133, 1);
							func_41(131, 1);
							func_41(132, 1);
							iLocal_27 = 3;
						...
						case 3:
							if (Global_33148[iLocal_41 /*11*/].f_4)
								iLocal_27 = 6;
						
							if (Global_33148[iLocal_41 /*11*/].f_7 && func_65(iLocal_41))
							{
								Global_33148[iLocal_41 /*11*/].f_7 = 0;
								iLocal_27 = 6;
							}
...
{
	if (iLocal_41 != -1)
		Global_33148[iLocal_41 /*11*/] = unk_0x6609A7E82612E0DF();
...
int func_8(int iParam0, BOOL bParam1) // Position - 0x8D1
{
	int num;
	int num2;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x10D2
{
	int i;
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x1476
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x15C5
{
	unk_0x39DCBE5519BD783A(message);
	return unk_0x7EBCD400E7DE179C(0);
}

void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x15D8
{
	int num;
...
BOOL func_45() // Position - 0x162F
{
	...
	if (Global_33148[iLocal_41 /*11*/].f_8)
	{
		_CONTEXT_REMOVE_HELP_TEXT(&iLocal_40);
		return false;
	}
	...
	if (func_27(iLocal_40, true))
	{
		_CONTEXT_REMOVE_HELP_TEXT(&iLocal_40);
		func_56(&uLocal_24);
		Global_33148[iLocal_41 /*11*/].f_7 = 1;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1D4D
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x1DD1
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
void func_55() // Position - 0x1ED9
{
	...
	iLocal_35 = 0;
	iLocal_35 = unk_0x43AFC452F25F3A2F(joaat("v_ilev_mm_screen2"), uLocal_29, 1, 1, 0, 0);
	unk_0x5C96CEA06531AB03(iLocal_35, uLocal_32);
	unk_0x5D7CD709B34C90F0(iLocal_35, 1);
	unk_0x4285E11B28063EE0(iLocal_35, 0, 0);
	iLocal_37 = 0;
	iLocal_37 = unk_0x43AFC452F25F3A2F(joaat("v_ilev_mm_screen2_vl"), uLocal_29, 1, 1, 0, 0);
...
{
	uLocal_36 = unk_0x43AFC452F25F3A2F(joaat("prop_tt_screenstatic"), uLocal_29, 1, 1, 0, 0);
...
void func_63() // Position - 0x231D
{
	...
	if (Global_33148[iLocal_41 /*11*/].f_10 == 0)
	{
		if (iLocal_84 == 1)
		{
			if (unk_0xFC8BFE4B41177C22(uLocal_38))
				unk_0x935364B4448CD584(uLocal_38, 0, 0);
		
			if (unk_0xFC8BFE4B41177C22(iLocal_35))
				unk_0x935364B4448CD584(iLocal_35, 0, 0);
		
			if (unk_0xFC8BFE4B41177C22(iLocal_37))
				unk_0x935364B4448CD584(iLocal_37, 0, 0);
		
			if (unk_0xFC8BFE4B41177C22(uLocal_36))
				unk_0x935364B4448CD584(uLocal_36, 0, 0);
	...
	{
		if (unk_0xFC8BFE4B41177C22(uLocal_38))
			unk_0x935364B4448CD584(uLocal_38, 1, 0);
	
		if (unk_0xFC8BFE4B41177C22(iLocal_35))
			unk_0x935364B4448CD584(iLocal_35, 1, 0);
	
		if (unk_0xFC8BFE4B41177C22(iLocal_37))
			unk_0x935364B4448CD584(iLocal_37, 1, 0);
	
		if (unk_0xFC8BFE4B41177C22(uLocal_36))
			unk_0x935364B4448CD584(uLocal_36, 1, 0);
...
void func_69() // Position - 0x244D
{
	...
	{
		func_1();
		Global_33148[iLocal_41 /*11*/].f_6 = 0;
		Global_33148[iLocal_41 /*11*/].f_7 = 0;
		Global_33148[iLocal_41 /*11*/].f_8 = 0;
		Global_33148[iLocal_41 /*11*/].f_4 = 0;
		Global_33148[iLocal_41 /*11*/].f_5 = 0;
		Global_33148[iLocal_41 /*11*/].f_2 = 0;
		Global_33148[iLocal_41 /*11*/] = -1;
		Global_33148[iLocal_41 /*11*/].f_1 = 0;
		Global_33148[iLocal_41 /*11*/].f_10 = 0;
	}
