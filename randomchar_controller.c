...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_130())
		{
			...
			for (i = 0; i < 63; i = i + 1)
			{
				if (i % 60 == iLocal_47 || Global_113249[i /*10*/].f_2)
					func_83(i);
			}
...
void func_1() // Position - 0x121
{
	...
	for (j = 0; j < 63; j = j + 1)
	{
		...
		if (Global_113249[num /*10*/].f_8 != -1)
		{
			func_3(uLocal_72[Global_113249[num /*10*/].f_8], false, false);
			func_2(&(Global_113249[num /*10*/].f_8));
		}
	
		Global_113249[num /*10*/].f_7 = 0;
	}
					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (HUD::DOES_BLIP_EXIST(Global_33485[num /*23*/].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_33485[num /*23*/].f_19, true);
									HUD::SET_BLIP_FLASH_TIMER(Global_33485[num /*23*/].f_19, 10000);
...
{
	if (!func_45(39))
		if (IS_BIT_SET(Global_114162.f_18578[27 /*6*/], 3))
...
void func_54() // Position - 0x2DF1
{
	if (_IS_EXCLUSIVE_CONTENT_UNLOCKED())
	{
		if (!func_43(114))
		{
			if (IS_BIT_SET(Global_114162.f_18578[46 /*6*/], 3))
			{
		...
		{
			if (IS_BIT_SET(Global_114162.f_18578[51 /*6*/], 3))
			{
...
void func_61(int iParam0) // Position - 0x32C6
{
	...
	for (i = 0; i < Global_114162.f_7692.f_198; i = i + 1)
	{
		if (Global_114162.f_7692.f_137[i /*15*/] == iParam0)
		{
			func_62(Global_114162.f_7692.f_137[i /*15*/].f_6);
...
int func_62(int iParam0) // Position - 0x3382
{
	...
	{
		if (func_68(iParam0, Global_21083) == 1)
		{
			func_67(iParam0, Global_21083, 0);
		
			if (func_66(iParam0, Global_21083) == 0)
			{
				num = Global_21083;
				func_63(iParam0, num);
			}
...
void func_76() // Position - 0x3997
{
	...
	{
		if (!IS_BIT_SET(Global_114162.f_18578.f_390[iLocal_50], iLocal_49))
		{
			func_18(num, &unk);
		
			if (num == 58)
				MISC::SET_BIT(&Global_114162.f_18578.f_390[iLocal_50], iLocal_49);
			else if (HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(unk.f_6))
				MISC::SET_BIT(&Global_114162.f_18578.f_390[iLocal_50], iLocal_49);
			else if (Global_113249[num /*10*/].f_8 != -1)
				if (uLocal_51[Global_113249[num /*10*/].f_8])
					if (IS_BIT_SET(Global_33485[uLocal_72[Global_113249[num /*10*/].f_8] /*23*/].f_11, 6))
						func_81(uLocal_72[Global_113249[num /*10*/].f_8]);
		}
		else if (Global_113249[num /*10*/].f_8 != -1)
		{
			if (uLocal_51[Global_113249[num /*10*/].f_8])
				if (!IS_BIT_SET(Global_33485[uLocal_72[Global_113249[num /*10*/].f_8] /*23*/].f_11, 6))
					func_77(uLocal_72[Global_113249[num /*10*/].f_8]);
		}
	}
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	func_18(iParam0, &unk);
	Global_113249[iParam0 /*10*/].f_2 = 0;

	if (!IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 1))
		if (!unk.f_23)
			MISC::SET_BIT(&Global_114162.f_18578[iParam0 /*6*/], 1);

	if (IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 0) && !IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 3))
	{
		if (!Global_114162.f_18578[iParam0 /*6*/].f_1)
		{
			unk33 = func_42();
			...
			Global_114162.f_18578[iParam0 /*6*/].f_2 = unk33;
			Global_114162.f_18578[iParam0 /*6*/].f_1 = 1;
		}
		...
		if (IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					if (!func_23(Global_114162.f_18578[iParam0 /*6*/].f_2))
					{
						func_122(Global_114162.f_18578[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num, &num2, &num3);
					
						if (num3 > 0 || num2 > 0 || num > 10)
						{
							unk53 = { func_21(iParam0) };
							Global_114162.f_18578[iParam0 /*6*/].f_2 = func_42();
							func_34(&(Global_114162.f_18578[iParam0 /*6*/].f_2), 0, 0, unk.f_15, 0, 0, 0);
						}
				...
				if (flag)
				{
					MISC::SET_BIT(&Global_114162.f_18578[iParam0 /*6*/], 2);
					Global_113249[iParam0 /*10*/].f_4 = 0;
					...
					{
						Global_113249[iParam0 /*10*/].f_3 = 1;
					}
				}
			}
		}
	...
	if (IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 3))
	{
		flag2 = true;
		...
		if (!flag2)
			MISC::CLEAR_BIT(&Global_114162.f_18578[iParam0 /*6*/], 2);
	}
	...
	{
		Global_113249[iParam0 /*10*/].f_2 = 1;
		Global_113249[iParam0 /*10*/].f_1 = 0;
		Global_113249[iParam0 /*10*/].f_3 = 1;
	}
	else if (Global_113249[iParam0 /*10*/].f_3)
	{
		...
		{
			if (iParam0 == 10 && Global_114162.f_7265[109] != 1)
				func_107(109, 1);
	...
	if (flag3 && !IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 3) && IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 0) && IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 1) && IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 2))
	{
	...
	if (Global_113249[iParam0 /*10*/].f_7 != num5)
	{
		if (func_105(&(Global_113249[iParam0 /*10*/].f_8)))
		{
			...
			{
				num6 = uLocal_72[Global_113249[iParam0 /*10*/].f_8];
			
				if (num5 == 0)
				{
					func_3(num6, false, false);
					func_104(num6, false);
					func_2(&(Global_113249[iParam0 /*10*/].f_8));
				}
				else if (num5 == 2)
				{
					if (func_103(iParam0))
			...
			Global_113249[iParam0 /*10*/].f_7 = num5;
		}
	}

	if (!IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 4))
	{
		if (MISC::GET_HASH_KEY(&(unk.f_10)) == MISC::GET_HASH_KEY(""))
		{
			MISC::SET_BIT(&Global_114162.f_18578[iParam0 /*6*/], 4);
		}
		else if (num5 == 2)
		{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!func_45(35))
		{
			if (IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_114162.f_18578[iParam0 /*6*/], 3))
			{
				if (!func_94(unk.f_26, _GET_CURRENT_PLAYER_CHARACTER()) && !func_103(iParam0) && !func_82(iParam0) && !func_86(iParam0) && !func_85(iParam0) && !Global_113249[iParam0 /*10*/].f_3)
				{
...
{
	if (iParam0 == 2)
		if (IS_BIT_SET(Global_114162.f_18578[3 /*6*/], 3) && Global_113249[3 /*10*/].f_3 == true)
			return true;
	else if (iParam0 == 3)
		if (IS_BIT_SET(Global_114162.f_18578[2 /*6*/], 3) && Global_113249[2 /*10*/].f_3 == true)
			return true;
...
BOOL func_86(int iParam0) // Position - 0x457E
{
	if (iParam0 == 2 || iParam0 == 3)
		if (IS_BIT_SET(Global_114162.f_18578[2 /*6*/], 0) && IS_BIT_SET(Global_114162.f_18578[3 /*6*/], 0))
...
BOOL func_88(int iParam0) // Position - 0x461A
{
	...
	flag = IS_BIT_SET(Global_33485[num /*23*/].f_11, 0);
	flag2 = IS_BIT_SET(Global_33485[num /*23*/].f_11, 15);
...
BOOL func_91(int iParam0) // Position - 0x472C
{
	...
	if (Global_114162.f_2356[num2 /*2*/] >= 1)
		return true;
...
void func_96(int iParam0, int iParam1) // Position - 0x4930
{
	...
	{
		if (IS_BIT_SET(Global_114162.f_18578[2 /*6*/], 3) || IS_BIT_SET(Global_114162.f_18578[3 /*6*/], 3) || IS_BIT_SET(Global_114162.f_18578[4 /*6*/], 3))
		{
...
void func_98(int iParam0, int iParam1) // Position - 0x4CEE
{
	...
	MISC::SET_BITS_IN_RANGE(&(Global_33485[num /*23*/].f_11), 21, 26, iParam1);
...
void func_100(int iParam0, float fParam1) // Position - 0x4DBA
{
	...
	Global_33482 = 1;
	Global_33485[num /*23*/].f_10 = fParam1;
	Global_39535 = 1;
	MISC::SET_BIT(&(Global_33485[num /*23*/].f_11), 18);
	return;
}
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		MISC::SET_BIT(&(Global_33485[num /*23*/].f_11), 28);
	else
		MISC::CLEAR_BIT(&(Global_33485[num /*23*/].f_11), 28);
...
void func_114(int iParam0, var uParam1) // Position - 0x597C
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92476[26 /*34*/].f_6) == 0)
			{
				Global_114162.f_7265[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114162.f_7265[iParam0], true, true);
			}
...
{
	return func_133(iParam0, Global_44199);
}
...
void func_136() // Position - 0x978A
{
	...
	for (i = 0; i < 63; i = i + 1)
	{
		Global_113249[i /*10*/].f_5 = 0;
		Global_113249[i /*10*/].f_6 = 0;
		Global_113249[i /*10*/].f_4 = 0;
		Global_113249[i /*10*/].f_7 = 0;
		Global_113249[i /*10*/].f_8 = -1;
		Global_113249[i /*10*/].f_9 = -1;
	}
