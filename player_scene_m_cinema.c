...
BOOL func_2() // Position - 0x10C
{
	...
	if (SYSTEM::VDIST(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_103) > 100f)
		return true;

	return false;
}

int func_3(var uParam0, int iParam1) // Position - 0x153
{
	char* str;
	int i;
	...
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		switch (iLocal_81[iParam1])
		{
			case 0:
				...
				if (unk_0x9B5C1660CCDF7189(uParam0, joaat("SCRIPT_TASK_WANDER_STANDARD")) != 1)
				{
					unk_0x761F56E633460973(uParam0, 1193033728, 0);
					unk_0x44FB298D6382876D(iLocal_71[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xD6F9DEE4765092A9(&uLocal_86[iParam1 /*4*/]))
				{
				...
				str = "WORLD_HUMAN_PROSTITUTE_LOW_CLASS";
			
				if (!unk_0x1FF4AE189014B73E(uParam0))
				{
					unk_0x21B9EFA4B4AA3A5B(uParam0, str, 0, 1);
					unk_0x44FB298D6382876D(iLocal_71[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(uParam0, 1), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) > 50f * 50f)
				{
					iLocal_81[iParam1] = 0;
					return 1;
				}
...
BOOL func_4(var uParam0) // Position - 0x33E
{
	int i;
...
int func_7(int iParam0, int iParam1) // Position - 0x431
{
	...
	if (!unk_0x3555462DB47B7AB1())
	{
		...
		else if (iParam1 == func_8(Global_101409) && iParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
...
void func_11() // Position - 0x574
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_12(character) && !func_16(14) || Global_113083)
			{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x67D
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6BA
{
...
int func_15(eCharacter echParam0) // Position - 0x6DF
{
...
void func_21() // Position - 0x769
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_76; i = i + 1)
		{
			...
			if (!unk_0xD6F9DEE4765092A9(&uLocal_86[i /*4*/]))
			{
				unk_0x97A5024CE91641F1(&uLocal_86[i /*4*/]);
			
				if (!unk_0xA6E4F7A73ABC4A76(&uLocal_86[i /*4*/]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_71; i = i + 1)
	{
		if (iLocal_76[i] != 0)
		{
			iLocal_71[i] = unk_0xB1DBFEB95C0EFB88(4, iLocal_76[i], uLocal_103 + uLocal_107[i /*3*/], 0, 1, 1);
			unk_0x5C96CEA06531AB03(iLocal_71[i], fLocal_106 + uLocal_120[i]);
			...
			unk_0x9FF00EA9A61211D2(iLocal_71[i], 0);
		}
	}
...
void func_22() // Position - 0x896
{
	...
	switch (iLocal_69)
	{
		case 97:
			...
			uLocal_107[3 /*3*/] = { { 45.5004f, unk_0xD2AA6F822D3A55D2(-205.8167f, -210.4254f), unk_0xD2AA6F822D3A55D2(-1416.5402f, -1428.5013f) } - uLocal_103 };
...
char* func_33(int iParam0) // Position - 0x904F
{
	switch (iParam0)
	{
