...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x8F5
{
...
BOOL func_3(Hash hParam0) // Position - 0x916
{
...
BOOL func_10(int iParam0, char* sParam1) // Position - 0xAB1
{
...
BOOL func_11(Player plParam0) // Position - 0xB19
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_12(Global_2657994[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

int func_12(int iParam0) // Position - 0xB60
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1095
{
	Player player;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x10F5
{
	return -1;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x10FE
{
	if (Global_1575058 == 0)
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			return true;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1182
{
	switch (func_18())
	{
		case 0:
...
int func_18() // Position - 0x11D9
{
	return Global_33105;
}

BOOL func_19() // Position - 0x11E4
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x11F3
{
...
BOOL func_21() // Position - 0x120A
{
	return Global_2696433;
}

BOOL func_22() // Position - 0x1216
{
	return Global_2684721.f_695;
}

BOOL func_23() // Position - 0x1225
{
	return Global_76658;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1231
{
...
BOOL func_27() // Position - 0x12BD
{
	return Global_2684721.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x12CC
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_193 != 0;
}

void func_29() // Position - 0x12E3
{
	Global_2684721.f_758 = 1;
	return;
}

BOOL func_30() // Position - 0x12F3
{
	return Global_2684721.f_737;
}

BOOL func_31() // Position - 0x1302
{
	return IS_BIT_SET(Global_2684721.f_2, 11);
}

void func_32(int iParam0, int iParam1) // Position - 0x1313
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x14F3
{
...
void func_34(BOOL bParam0, int iParam1, int iParam2) // Position - 0x1542
{
	var unk;
...
int _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x15DE
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x166D
{
	return Global_2201[character /*29*/].f_3;
}

int func_37(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x1680
{
	int num;
	int num2;
...
void func_38(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x1B63
{
...
BOOL func_40(Player plParam0) // Position - 0x1C61
{
	return func_41(plParam0, 20);
}

BOOL func_41(Player plParam0, int iParam1) // Position - 0x1C71
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

var func_42(Player plParam0) // Position - 0x1C89
{
	return Global_1845270[plParam0 /*892*/].f_206.f_6;
}

void func_43(int iParam0) // Position - 0x1C9E
{
	int i;
	int num;
	int value;
...
void func_44(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x2225
{
...
void func_45(const char* sParam0) // Position - 0x22D8
{
...
void func_47(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x230D
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
BOOL func_48() // Position - 0x2370
{
	return Global_1575086;
}

void func_49(int iParam0) // Position - 0x237C
{
	var unk;
	var unk2;
...
void func_50(int iParam0) // Position - 0x239B
{
	int clockSeconds;
	int clockMinutes;
	int clockHours;
...
BOOL func_52(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x24F8
{
	int num;
	int num2;
	int num3;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x274B
{
	if (func_380(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27ED
{
	func_56();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_56() // Position - 0x2806
{
	eCharacter character;
...
BOOL func_57(eCharacter echParam0) // Position - 0x2903
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x290F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x294C
{
...
Hash func_60(eCharacter echParam0) // Position - 0x2971
{
	return Global_2201[echParam0 /*29*/];
}

void func_61() // Position - 0x2980
{
...
int _THEFEED_SHOW_MESSAGE(char* sParam0, BOOL bParam1) // Position - 0x29C4
{
	int num;
	int num2;
...
void func_63(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x29FC
{
	int num;
...
int func_64(int iParam0) // Position - 0x2B04
{
	int i;
...
void func_65(int iParam0) // Position - 0x2B66
{
	int i;
...
BOOL func_66(Player plParam0, int iParam1) // Position - 0x2B9F
{
	BOOL flag;
...
int func_67(int iParam0, BOOL bParam1) // Position - 0x2BF8
{
	int num;
	int num2;
...
int func_68() // Position - 0x2C39
{
	return Global_1574926;
}

BOOL func_69(Player plParam0) // Position - 0x2C45
{
	Player player;
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x2C67
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

BOOL func_71() // Position - 0x2C78
{
	return func_72(PLAYER::PLAYER_ID());
}

BOOL func_72(Player plParam0) // Position - 0x2C88
{
	return func_73(plParam0, 1);
}

BOOL func_73(Player plParam0, int iParam1) // Position - 0x2C97
{
	if (func_69(plParam0))
		if (func_69(Global_1887694[plParam0 /*611*/].f_10))
...
BOOL func_74(Player plParam0) // Position - 0x2CE6
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_75(Player plParam0) // Position - 0x2D4E
{
	Player player;
...
BOOL func_77(Player plParam0) // Position - 0x2D9D
{
	int num;
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		if (plParam0 != PLAYER::PLAYER_ID())
		{
			...
			if (func_105(true))
				if (func_104(plParam0, 9))
					num = 1;
			else if (func_41(plParam0, 15))
				num = 1;
		
			if (num && func_78(plParam0, 0, false))
				return true;
		}
	}
...
int func_78(Player plParam0, Player plParam1, BOOL bParam2) // Position - 0x2DFA
{
	var unk;
	...
	if (bParam2)
	{
		if (func_99(plParam0, plParam1, true))
			return 0;
	
		if (func_40(plParam0))
			return 0;
	
		if (func_97(plParam0, true))
			return 0;
	}
	else if (func_304(plParam0, true))
	{
		return 0;
	}
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2F2E
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x2F3E
{
	var gamerHandle;
...
BOOL func_81(Player plParam0) // Position - 0x2F55
{
	if (func_89(plParam0))
		return true;
...
BOOL func_82(Player plParam0) // Position - 0x2F78
{
	if (func_83(plParam0, 339, -1))
		return true;

	return false;
}

BOOL func_83(Player plParam0, int iParam1, int iParam2) // Position - 0x2F92
{
	Player player;

	if (func_87(plParam0) == iParam1)
	{
		if (iParam2 == -1)
		{
			return true;
		...
		{
			player = func_86(plParam0);
		
			if (player != _INVALID_PLAYER_INDEX())
				return func_84(player) == iParam2;
		}
	}
...
int func_84(Player plParam0) // Position - 0x2FD0
{
...
BOOL func_85(Player plParam0, BOOL bParam1) // Position - 0x2FF3
{
	if (func_69(plParam0))
...
Player func_86(Player plParam0) // Position - 0x3037
{
	return Global_1887694[plParam0 /*611*/].f_10.f_35;
}

int func_87(Player plParam0) // Position - 0x304C
{
	if (func_88(plParam0, false))
		return Global_1887694[plParam0 /*611*/].f_10.f_32;

	return -1;
}

BOOL func_88(Player plParam0, BOOL bParam1) // Position - 0x306F
{
	if (func_69(plParam0))
...
BOOL func_89(Player plParam0) // Position - 0x30B3
{
	if (func_90(plParam0) == 339)
		return true;

	return false;
}

int func_90(Player plParam0) // Position - 0x30CC
{
	if (func_69(plParam0))
		if (func_85(plParam0, false))
...
BOOL func_91(Player plParam0) // Position - 0x30F8
{
	return func_92(func_93(plParam0));
}

BOOL func_92(int iParam0) // Position - 0x310A
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_93(Player plParam0) // Position - 0x311F
{
	return Global_1907308[plParam0 /*310*/].f_270;
}

BOOL func_94(Player plParam0) // Position - 0x3133
{
	if (func_66(plParam0, 0))
		return true;
...
BOOL func_95() // Position - 0x3172
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0) // Position - 0x3180
{
	Player player;
...
BOOL func_97(Player plParam0, BOOL bParam1) // Position - 0x31A3
{
	return func_98(plParam0, bParam1, 1);
}

int func_98(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x31B4
{
	Player player;
	...
	if (!bParam1)
		if (func_73(plParam0, iParam2))
			return 0;

	player = Global_1887694[plParam0 /*611*/].f_10;

	if (func_69(player) && Global_1887694[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_99(Player plParam0, Player plParam1, BOOL bParam2) // Position - 0x3210
{
	if (func_69(plParam1))
	{
		if (!bParam2)
			if (func_100(plParam0, plParam1))
				return false;
...
BOOL func_100(Player plParam0, Player plParam1) // Position - 0x325A
{
...
BOOL func_101(Player plParam0) // Position - 0x329F
{
	return func_41(plParam0, 30);
}

BOOL func_102(Player plParam0) // Position - 0x32AF
{
...
int func_103(Player plParam0) // Position - 0x32E3
{
	return Global_1887694[plParam0 /*611*/].f_10.f_23;
}

BOOL func_104(Player plParam0, int iParam1) // Position - 0x32F8
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_5, iParam1);
}

BOOL func_105(BOOL bParam0) // Position - 0x3310
{
	return func_97(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_106() // Position - 0x3322
{
	int i;
	var string2;
	var string1;
...
struct<16> func_107(int iParam0) // Position - 0x337C
{
	return Global_2685663.f_3078.f_18[iParam0 /*16*/];
}

int func_108(int iParam0) // Position - 0x3394
{
	switch (iParam0)
	{
		case 0:
...
void func_109(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15) // Position - 0x33EA
{
	hParam0 = -642704387;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x3419
{
	int address;
	int i;
	Player player;
...
BOOL func_111(Player plParam0) // Position - 0x347E
{
	if (!func_69(plParam0))
		return false;
...
void func_112(int iParam0) // Position - 0x34A5
{
	int num;
	int offset;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x360B
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x3621
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_119(const char* sParam0, int iParam1, BOOL bParam2) // Position - 0x3637
{
	if (bParam2)
	{
...
void func_120(const char* sParam0, BOOL bParam1) // Position - 0x3707
{
	var unk;
...
void func_121(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, int iParam17) // Position - 0x37D2
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_123(_GET_BOSS_OF_LOCAL_PLAYER());
	num3 = func_122(_GET_BOSS_OF_LOCAL_PLAYER());
	num4 = iParam17;
	unk_0xAA434D7D0A89A95C(flag, num, num2, num3, iParam0, &uParam1, num4);
	return;
}

int func_122(Player plParam0) // Position - 0x383C
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_123(Player plParam0) // Position - 0x3861
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x3886
{
	return Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_125(BOOL bParam0) // Position - 0x389B
{
	return func_304(PLAYER::PLAYER_ID(), bParam0);
}

void func_126(const char* sParam0, BOOL bParam1) // Position - 0x38AD
{
	var unk;
...
void func_127(int iParam0, const char* sParam1) // Position - 0x3949
{
	Global_1982838[iParam0] = MISC::GET_HASH_KEY(sParam1);
	return;
}

void func_128(int iParam0, int iParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x395F
{
	Hash statName;
	Hash statName2;
	var value;
...
Hash func_129(int iParam0, int iParam1) // Position - 0x39F2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(3, iParam0, func_130(iParam1));
}

int func_130(int iParam0) // Position - 0x3A07
{
	int num;
	int num2;
...
const char* func_131(Player plParam0, BOOL bParam1) // Position - 0x3A3B
{
	if (!bParam1)
		if (func_97(plParam0, true))
			return func_132();
...
const char* func_132() // Position - 0x3A62
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

struct<16> func_133(int iParam0, int iParam1, int iParam2) // Position - 0x3A72
{
	Hash statHash;
	Hash statHash2;
	var unk;
...
BOOL func_134(int iParam0) // Position - 0x3AAF
{
	int num;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x3AC6
{
	Hash statHash;
	int outValue;
...
Hash func_136(int iParam0, int iParam1) // Position - 0x3AF5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_130(iParam1));
}

BOOL func_137(BOOL bParam0) // Position - 0x3B0A
{
	if (bParam0)
		return func_139();
...
Hash func_142(int iParam0, int iParam1) // Position - 0x3B9C
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_130(iParam1));
}

void func_143() // Position - 0x3BB1
{
	int i;
...
void func_144(var uParam0, int iParam1) // Position - 0x3BFC
{
	func_145(uParam0, iParam1);
	return;
}

void func_145(var uParam0, int iParam1) // Position - 0x3C0C
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_146(int iParam0) // Position - 0x3C1D
{
	return Global_2672942.f_2590[0 /*80*/].f_1 == iParam0;
}

void func_147(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3C34
{
	var userID;
	int cloudTimeAsInt;
	int num;
...
void func_148(int iParam0, BOOL bParam1) // Position - 0x3F2A
{
	BOOL flag;
	int num;
...
void func_149(var uParam0) // Position - 0x3FBA
{
...
BOOL func_150(var uParam0) // Position - 0x409F
{
	var unk;
	BOOL flag;
...
BOOL func_151(var uParam0, var uParam1, var uParam2) // Position - 0x410F
{
	int num;
...
int func_152(int iParam0, int iParam1, int iParam2) // Position - 0x4137
{
	switch (iParam0)
	{
		case 17:
...
BOOL func_153(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4250
{
	int num;
	int i;
...
void func_154(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x42A2
{
	int i;
	int j;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5497
{
	int i;
...
void func_158(int iParam0, int iParam1) // Position - 0x573D
{
	int num;
	BOOL address;
	int offset;
...
void func_159(int iParam0, int iParam1) // Position - 0x578E
{
	int num;
	int offset;
...
int func_160(int iParam0) // Position - 0x5849
{
	return func_161(iParam0) / 8;
}

int func_161(int iParam0) // Position - 0x585A
{
	switch (iParam0)
	{
		case 2:
...
void func_162(int iParam0, int iParam1) // Position - 0x59CD
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_163(int iParam0) // Position - 0x5A20
{
	var unk;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x5A40
{
	switch (iParam0)
	{
		case 0:
...
Hash func_165(int iParam0) // Position - 0x5C00
{
	switch (iParam0)
	{
		case 0:
...
Hash func_166() // Position - 0x5C6C
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_167() // Position - 0x5C7C
{
	if (Global_1668413 == 0)
		func_168();
...
int func_169(int iParam0, int iParam1) // Position - 0x5CC3
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_170(int iParam0) // Position - 0x5CDF
{
	return func_161(iParam0) % 8;
}

int func_171(int iParam0) // Position - 0x5CF0
{
	int num;
...
BOOL func_172(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5D46
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_173(int iParam0, int iParam1) // Position - 0x5DE3
{
	BOOL flag;
	BOOL flag2;

	flag = func_174(iParam0, iParam1);
	flag2 = func_192(iParam0, iParam1);
	return flag2 >= flag;
}

int func_174(int iParam0, int iParam1) // Position - 0x5E04
{
	int i;
...
int func_175(int iParam0, int iParam1) // Position - 0x6EAD
{
	if (func_176(iParam0))
	{
		switch (iParam1)
...
BOOL func_176(int iParam0) // Position - 0x6F20
{
	int num;
...
int func_177(int iParam0) // Position - 0x6F48
{
	switch (iParam0)
	{
		case 25:
...
int func_178(int iParam0, int iParam1, int iParam2) // Position - 0x7048
{
	int num;
	int i;
	int num2;
...
int func_179(int iParam0) // Position - 0x70B4
{
	if (func_176(iParam0))
		return 13;
...
void func_180(int iParam0) // Position - 0x70CF
{
	int num;
	int num2;
	int offset;
...
int func_181(int iParam0) // Position - 0x710D
{
	return iParam0 % 32;
}

int func_182(int iParam0) // Position - 0x711A
{
	return iParam0 / 32;
}

int func_183(int iParam0) // Position - 0x7127
{
	switch (iParam0)
	{
		case 16:
...
void func_184(var uParam0) // Position - 0x810C
{
	int num;
	int num2;
	int num3;
...
int func_185(int iParam0) // Position - 0x8148
{
	switch (iParam0)
	{
		case 2:
...
void func_186(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x8C71
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_187(int iParam0, var uParam1, int iParam2) // Position - 0x8CDA
{
	var unk;
...
char* func_188(int iParam0) // Position - 0x8FC9
{
	var unk;
...
char* func_189(var uParam0) // Position - 0x8FE4
{
	return uParam0;
}

char* func_190(int iParam0) // Position - 0x8FEE
{
	switch (iParam0)
	{
		case 0:
...
Hash func_191(BOOL bParam0) // Position - 0x9042
{
	if (bParam0)
...
BOOL func_192(int iParam0, int iParam1) // Position - 0x9065
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 77:
					flag = func_135(12459, -1);
					break;
			
				case 78:
					flag2 = func_135(12444, -1);
				...
				case 79:
					...
					{
						flag = flag + func_207(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_207(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 11:
			switch (iParam1)
			{
				...
				case 103:
					flag = func_135(12044, -1);
					flag = flag + func_135(12042, -1);
					break;
		...
		case 16:
			switch (iParam1)
			{
				...
				case 172:
					...
					if (_STAT_GET_PACKED_BOOL(&func_189, -1))
						flag = flag + 1;
		...
		case 30:
			...
			{
				case 325:
					if (func_135(1209, -1) > false)
						flag = true;
					break;
			
				case 326:
					if (func_135(11921, -1) > false)
						flag = true;
					break;
			
				case 327:
					flag = func_202(40, -1) + func_202(41, -1);
					break;
			
				case 328:
					flag = func_135(11920, -1);
					break;
		...
		case 12:
			switch (iParam1)
			{
				...
				case 118:
					flag = func_135(11928, -1);
					break;
			
				case 119:
					flag = func_135(11927, -1);
					break;
		...
		case 32:
			switch (iParam1)
			{
				...
				case 352:
					flag = func_204(func_135(11964, -1));
					break;
		...
		case 20:
			...
			{
				case 215:
					if (func_135(9631, -1) == true && _STAT_GET_PACKED_BOOL(31737, -1))
						flag = true;
					break;
				...
				case 225:
					flag = func_135(9622, -1);
					break;
			
				case 226:
					flag = func_135(11932, -1);
					break;
		...
		case 22:
			switch (iParam1)
			{
				...
				case 248:
					flag = func_135(11933, -1);
					break;
			
				case 249:
					flag = func_204(func_135(9586, -1));
					break;
		...
		case 23:
			...
			{
				case 254:
					flag2 = func_135(8726, -1);
				
					if (func_204(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
		...
		case 21:
			switch (iParam1)
			{
				...
				case 234:
					...
					if (_STAT_GET_PACKED_BOOL(&func_190, -1))
						flag = flag + 1;
		...
		case 26:
			switch (iParam1)
			{
				...
				case 294:
					if (func_135(7864, -1) > false || func_135(7865, -1) > false)
						flag = true;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 138:
					if (func_135(7231, -1) > false)
						flag = true;
					break;
			
				case 139:
					flag = func_135(12010, -1);
					break;
				...
				case 144:
					if (_STAT_GET_PACKED_BOOL(41989, -1))
						...
						flag = func_135(7212, -1);
					break;
			
				case 145:
					flag = func_135(7231, -1);
					break;
				...
				case 147:
					flag = func_135(7230, -1);
					break;
			
				case 148:
					flag = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_135(12025, -1) / 60));
					break;
			
				case 149:
					flag = func_135(7234, -1);
					break;
			}
			break;
		...
		case 15:
			switch (iParam1)
			{
				...
				case 154:
					flag = func_135(6116, -1);
					break;
			
				case 155:
					if (func_135(6118, -1) > false)
						flag = true;
					break;
				...
				case 161:
					...
					if (_STAT_GET_PACKED_BOOL(&func_191, -1))
						flag = flag + 1;
				...
				case 162:
					flag = func_135(6119, -1);
					flag = flag + func_135(6120, -1);
					break;
			}
			break;
		...
		case 17:
			...
			{
				case 176:
					if (func_135(5303, -1) > false)
						flag = true;
					break;
			
				case 177:
					if (func_135(5332, -1) > false)
						flag = true;
					break;
				...
				case 180:
					if (func_135(11941, -1) > false)
						flag = true;
					break;
			
				case 181:
					flag = func_135(11940, -1);
					break;
			
				case 182:
					flag = func_135(5332, -1);
					break;
				...
				case 187:
					flag = func_135(11941, -1);
					break;
			
				case 188:
					flag = func_135(5333, -1);
					break;
			}
			break;
		...
		case 18:
			switch (iParam1)
			{
				...
				case 196:
					if (func_135(3913, -1) > false || func_135(3903, -1) > false)
						flag = flag + 1;
				
					if (func_135(3946, -1) > false || func_135(3932, -1) > false)
						flag = flag + 1;
				
					if (func_135(3948, -1) > false || func_135(3936, -1) > false)
						flag = flag + 1;
				
					if (func_135(3950, -1) > false || func_135(3940, -1) > false)
						flag = flag + 1;
				
					if (func_135(3952, -1) > false || func_135(3944, -1) > false)
						flag = flag + 1;
					break;
			
				case 197:
					flag = func_135(10411, -1);
					break;
			
				case 198:
					flag = flag + func_135(3954, -1);
					flag = flag + func_135(3955, -1);
					flag = flag + func_135(3956, -1);
					flag = flag + func_135(3957, -1);
					flag = flag + func_135(3958, -1);
					break;
			
				case 199:
					flag = func_135(11943, -1);
					break;
			
				case 200:
					flag = func_135(11969, -1);
					break;
			
				case 201:
					flag = func_135(11942, -1);
					break;
			}
			break;
		...
		case 19:
			switch (iParam1)
			{
				...
				case 206:
					if (func_135(3639, -1) > false)
						flag = true;
					break;
			
				case 207:
					if (func_135(3667, -1) > false)
						flag = true;
					break;
				...
				case 213:
					flag = flag + func_135(11970, -1);
					break;
			
				case 214:
					flag = func_135(3671, -1);
					break;
			}
			break;
		...
		case 29:
			...
			{
				case 317:
					if (func_135(1210, -1) > false || _STAT_GET_PACKED_BOOL(42023, -1))
						flag = true;
					break;
				...
				case 319:
					flag = func_135(819, -1);
					flag = flag + func_135(12029, -1);
					flag = flag + func_135(12030, -1);
					break;
				...
				case 321:
					flag = flag + func_204(func_135(11929, -1));
					flag = flag + func_204(func_135(11966, -1));
					flag = flag + func_204(func_135(11967, -1));
					flag = flag + func_204(func_135(11968, -1));
					break;
...
BOOL func_193(int iParam0, int iParam1) // Position - 0xE737
{
	Hash statHash;
	BOOL outValue;
...
Hash func_194(int iParam0, int iParam1) // Position - 0xE75B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_130(iParam1));
}

BOOL func_195() // Position - 0xE771
{
	int num;
	BOOL flag;
...
void func_196(int iParam0, BOOL bParam1, int iParam2) // Position - 0xE7B8
{
	if (iParam2 == -1)
		iParam2 = func_68();
...
int func_199(int iParam0) // Position - 0xE94F
{
	iParam0 = iParam0 / 32;
...
Hash func_200(int iParam0) // Position - 0xE9C2
{
	switch (iParam0)
	{
		case 34:
...
var func_201(BOOL bParam0, var uParam1, var uParam2) // Position - 0xF003
{
	if (bParam0)
		return uParam1;
...
BOOL func_202(int iParam0, int iParam1) // Position - 0xF01A
{
	Hash statHash;
	int outValue;
...
Hash func_203(int iParam0, int iParam1) // Position - 0xF03E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_130(iParam1));
}

BOOL func_204(BOOL bParam0) // Position - 0xF054
{
	int num;
	BOOL flag;
...
void func_205(var uParam0, int iParam1) // Position - 0xF094
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_206() // Position - 0xF0A9
{
	int num;
	int num2;
...
int func_207(BOOL bParam0) // Position - 0xF2EE
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xF300
{
	if (iParam1 == -1)
		iParam1 = func_68();
...
BOOL func_209(int iParam0, var uParam1) // Position - 0xF31C
{
	int i;
...
int func_210(int iParam0, int iParam1, int iParam2) // Position - 0xF394
{
	switch (iParam1)
	{
		case 0:
...
int func_211(int iParam0) // Position - 0x113F5
{
	int num;
	int num2;
	int num3;
...
BOOL func_212(int iParam0, BOOL bParam1) // Position - 0x1143B
{
	if (iParam0 == -1)
		return false;
...
int func_213(int iParam0) // Position - 0x11457
{
	switch (iParam0)
	{
		case 51280:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x12434
{
	if (iParam2 == -1)
		iParam2 = func_68();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x12452
{
	if (iParam1 == -1)
		iParam1 = func_68();
...
void func_218(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x124A6
{
	int num;
...
void func_219() // Position - 0x12624
{
	var txdName;
	var subject;
...
int func_220(eCharacter echParam0, int iParam1) // Position - 0x1269F
{
...
int func_221(eCharacter echParam0, int iParam1) // Position - 0x126C9
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_222(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x126F3
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_223(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x12738
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x1277D
{
...
void func_225() // Position - 0x12799
{
	BOOL flag;
...
void func_226() // Position - 0x1282F
{
	Global_1048576.f_10 = 0;
	return;
}

void func_227() // Position - 0x1283E
{
	var unk;
	var unk2;
	var unk3;
...
void func_228() // Position - 0x12B75
{
	MISC::SET_BIT(&(Global_2684721.f_2), 12);
	return;
}

void func_229() // Position - 0x12B89
{
	Global_1057440 = -1;
	return;
}

BOOL func_230() // Position - 0x12B96
{
	switch (func_231())
	{
		case 21:
...
int func_231() // Position - 0x12C49
{
	return Global_1057440;
}

void func_232(BOOL bParam0) // Position - 0x12C55
{
	BOOL flag;
...
void func_233(int iParam0) // Position - 0x12CE8
{
	Global_2684721.f_894 = iParam0;
	return;
}

void func_234(int iParam0) // Position - 0x12CF9
{
	if (iParam0 == -1)
...
void func_235() // Position - 0x12D23
{
	Global_2684721.f_9 = -1;
	return;
}

BOOL func_236() // Position - 0x12D32
{
	return Global_2684721.f_739;
}

void func_237() // Position - 0x12D41
{
	Global_2684721.f_42 = func_238();
	return;
}

int func_238() // Position - 0x12D53
{
	if (Global_2692748)
		return 32;
...
void func_239() // Position - 0x12D6E
{
	Global_2684721.f_737 = 0;
	return;
}

void func_240() // Position - 0x12D7E
{
	Global_2684721.f_719 = 0;
	return;
}

void func_241() // Position - 0x12D8E
{
	MISC::CLEAR_BIT(&(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18), 15);
	return;
}

void func_242() // Position - 0x12DAB
{
...
void func_243() // Position - 0x12DC1
{
	MISC::SET_BIT(&(Global_2684721.f_3), 2);
	return;
}

void func_244() // Position - 0x12DD4
{
	MISC::CLEAR_BIT(&Global_2684721, 7);
	return;
}

void func_245() // Position - 0x12DE5
{
	MISC::CLEAR_BIT(&Global_2684721, 6);
	return;
}

void func_246() // Position - 0x12DF6
{
	Global_2684721 = 0;
...
void func_247(BOOL bParam0) // Position - 0x12E11
{
	int i;
	var unk;
	int j;
...
void func_248() // Position - 0x12F0D
{
	Global_2680842.f_32 = 0;
	return;
}

void func_249() // Position - 0x12F1C
{
	var unk;
	int i;
...
BOOL func_255() // Position - 0x13019
{
	return IS_BIT_SET(Global_2684721, 1);
}

BOOL func_256() // Position - 0x13027
{
	return IS_BIT_SET(Global_2684721, 2);
}

BOOL func_257() // Position - 0x13035
{
	return IS_BIT_SET(Global_2684721, 20);
}

BOOL func_258() // Position - 0x13044
{
	return IS_BIT_SET(Global_2685663.f_1.f_2810, 3);
}

void func_259() // Position - 0x13057
{
...
void func_260() // Position - 0x13078
{
	var unk;
...
void func_261() // Position - 0x130CC
{
	var unk;
...
void func_262(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x13120
{
	Hash statName;
...
void func_263(int iParam0) // Position - 0x1314E
{
...
void func_264() // Position - 0x13178
{
	int i;
...
BOOL func_265() // Position - 0x131D9
{
	return Global_2684721.f_742;
}

void func_266(int iParam0) // Position - 0x131E8
{
	int num;
	int offset;
...
BOOL func_267(int iParam0) // Position - 0x13211
{
	int num;
	int num2;
...
void func_268(int iParam0, int iParam1, BOOL bParam2) // Position - 0x13237
{
	if (func_275())
	{
		if (iParam1 == 1)
...
BOOL func_269(Player plParam0) // Position - 0x13301
{
...
BOOL func_270(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13326
{
	if (bParam1)
...
BOOL func_271(Player plParam0) // Position - 0x13358
{
	return func_272(plParam0);
}

BOOL func_272(Player plParam0) // Position - 0x13366
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

BOOL func_273() // Position - 0x1337D
{
	return Global_2684721.f_846;
}

void func_274(BOOL bParam0) // Position - 0x1338C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_275())
...
BOOL func_275() // Position - 0x13485
{
	return Global_1574582;
}

void func_276() // Position - 0x13491
{
	int i;
	Player player;
...
void func_277(Player plParam0) // Position - 0x134D3
{
	Ped playerPed;
...
void func_278(BOOL bParam0, Player plParam1) // Position - 0x13535
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(playerPed) && !ENTITY::IS_ENTITY_DEAD(playerPed, false))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, false))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && ENTITY::IS_ENTITY_A_VEHICLE(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
				{
					...
					if (func_99(plParam1, _GET_BOSS_OF_LOCAL_PLAYER(), true))
					{
						...
						{
							num = func_279(_GET_BOSS_OF_LOCAL_PLAYER(), plParam1);
			...
			else if (!bParam0)
			{
				if (func_99(plParam1, _GET_BOSS_OF_LOCAL_PLAYER(), true))
				{
					...
					{
						num2 = func_279(_GET_BOSS_OF_LOCAL_PLAYER(), plParam1);
...
int func_279(Player plParam0, Player plParam1) // Position - 0x136D6
{
	int i;

	if (func_361(plParam0))
	{
		if (func_99(plParam1, plParam0, false) || func_281(plParam1, plParam0))
		{
			for (i = 0; i < 7; i = i + 1)
			{
				if (func_280(plParam0, i) == plParam1)
					return i;
			}
		}
	}
...
Player func_280(Player plParam0, int iParam1) // Position - 0x1372C
{
	if (func_361(plParam0))
...
BOOL func_281(Player plParam0, Player plParam1) // Position - 0x13768
{
	if (plParam1 != _INVALID_PLAYER_INDEX())
...
void func_282(int iParam0) // Position - 0x137A1
{
	if (!func_295())
		return;
...
int func_283(Player plParam0) // Position - 0x137E9
{
...
int func_284(Player plParam0) // Position - 0x1380A
{
	return Global_1887694[plParam0 /*611*/].f_10.f_1;
}

void func_285() // Position - 0x1381F
{
...
void func_286(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x13850
{
	Global_2685663.f_3078.f_2 = { uParam0 };
	return;
}

void func_287(var uParam0, var uParam1) // Position - 0x13869
{
...
void func_288(BOOL bParam0) // Position - 0x13899
{
	func_289(204, bParam0, -1, true);
	return;
}

void func_289(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x138AB
{
	Hash statName;
...
void func_290(BOOL bParam0) // Position - 0x138CE
{
	if (bParam0)
	{
		if (func_292(4))
...
void func_291(BOOL bParam0) // Position - 0x13936
{
	func_289(432, bParam0, -1, true);
	return;
}

BOOL func_292(int iParam0) // Position - 0x13949
{
	return IS_BIT_SET(Global_2739945.f_5266.f_50, iParam0);
}

struct<16> func_293(int iParam0) // Position - 0x1395D
{
	var unk;
...
const char* func_294(int iParam0) // Position - 0x139A0
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_295() // Position - 0x139C4
{
...
var func_296(int iParam0) // Position - 0x139E2
{
	return Global_1574538[iParam0];
}

var func_297() // Position - 0x139F2
{
	return func_296(func_68() + 1);
}

BOOL func_298(Player plParam0) // Position - 0x13A04
{
	return func_299(plParam0) > 0;
}

int func_299(Player plParam0) // Position - 0x13A14
{
	int num;
	int num2;
...
var func_300() // Position - 0x13A69
{
	return Global_262145.f_15362;
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x13A78
{
	Hash statHash;
	int outValue;
...
int func_302() // Position - 0x13A96
{
	return Global_262145.f_12825;
}

int func_303() // Position - 0x13AA5
{
	int i;
	int num;
	Player player;
...
BOOL func_304(Player plParam0, BOOL bParam1) // Position - 0x13AE2
{
	if (!func_69(plParam0))
		return false;
	...
	return func_69(Global_1887694[plParam0 /*611*/].f_10);
}

void func_305() // Position - 0x13B1A
{
	var unk;
...
void func_306(Object obParam0) // Position - 0x13C6B
{
	var animDict;
	var animDict2;
	var animDict3;
...
BOOL func_307(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x141B7
{
...
BOOL func_308(Ped pedParam0) // Position - 0x141EA
{
...
BOOL func_309(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1420A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_310() // Position - 0x14285
{
...
BOOL func_311() // Position - 0x142A7
{
...
BOOL func_312() // Position - 0x142DA
{
...
BOOL func_313() // Position - 0x1430D
{
...
BOOL func_314(int iParam0, BOOL bParam1) // Position - 0x1435C
{
	int num;
...
int func_315(int iParam0) // Position - 0x14414
{
	int i;
...
void func_316(BOOL bParam0) // Position - 0x1444F
{
...
BOOL func_317() // Position - 0x1448F
{
	return Global_1944438.f_748;
}

void func_318(BOOL bParam0) // Position - 0x1449E
{
...
BOOL func_319(Player plParam0) // Position - 0x14613
{
	return func_320(func_90(plParam0));
}

BOOL func_320(int iParam0) // Position - 0x14625
{
	switch (iParam0)
	{
		case 178:
...
void func_321(char* sParam0) // Position - 0x14645
{
...
BOOL func_322() // Position - 0x1465B
{
	if (Global_1944297)
		return false;
...
BOOL func_323() // Position - 0x14672
{
	if (func_324())
		return 1;
...
BOOL func_324() // Position - 0x1468C
{
	return Global_1575039 == 10;
}

int func_325(Player plParam0) // Position - 0x1469B
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
int func_326(Player plParam0) // Position - 0x146BE
{
	if (func_340(plParam0))
		return func_327(Global_2657994[plParam0 /*467*/].f_324.f_8);

	return 0;
}

int func_327(int iParam0) // Position - 0x146E5
{
	switch (iParam0)
	{
		case 60:
...
void func_328(BOOL bParam0) // Position - 0x1477A
{
...
BOOL func_329(Player plParam0) // Position - 0x148E9
{
	return func_330(func_90(plParam0));
}

BOOL func_330(int iParam0) // Position - 0x148FB
{
	switch (iParam0)
	{
		case 190:
...
BOOL func_331() // Position - 0x14921
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_147))
	{
...
BOOL func_332(Player plParam0) // Position - 0x1495F
{
...
BOOL func_333(Player plParam0) // Position - 0x14982
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_12(Global_2657994[plParam0 /*467*/].f_324.f_8) == 25;

	return false;
}

void func_334(BOOL bParam0) // Position - 0x149E2
{
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x14B3D
{
	int i;
...
BOOL func_336() // Position - 0x14C68
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x14D0C
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x14D1F
{
	int num;
...
BOOL func_339(Player plParam0) // Position - 0x14D76
{
...
BOOL func_340(Player plParam0) // Position - 0x14DAF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_12(Global_2657994[plParam0 /*467*/].f_324.f_8) == 1;

	return false;
}

BOOL func_341(int iParam0, int iParam1) // Position - 0x14DF5
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_342(int iParam0) // Position - 0x14ED2
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_343() // Position - 0x14F01
{
	return Global_78340;
}

BOOL func_344() // Position - 0x14F0D
{
...
int func_345(int iParam0) // Position - 0x1503B
{
	int i;
...
int func_346(int iParam0) // Position - 0x15066
{
	if (iParam0 != -1)
...
BOOL func_347() // Position - 0x15085
{
	return IS_BIT_SET(Global_1944438.f_11, 1);
}

BOOL func_348() // Position - 0x15095
{
...
BOOL func_349(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x150D2
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), fParam1) <= fParam4 * fParam4;
}

int func_350(Player plParam0) // Position - 0x150F0
{
	Player player;
...
int func_351(Player plParam0) // Position - 0x1510F
{
...
BOOL func_352() // Position - 0x1512C
{
	return func_361(PLAYER::PLAYER_ID());
}

BOOL func_353() // Position - 0x1513C
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/] == 148;
}

BOOL func_354() // Position - 0x15152
{
	return Global_76659;
}

BOOL func_355() // Position - 0x1515E
{
	return Global_1929789;
}

BOOL func_356() // Position - 0x1516A
{
...
BOOL func_357() // Position - 0x15198
{
...
BOOL func_358(int iParam0) // Position - 0x151B2
{
	if (iParam0 == 1)
...
BOOL func_359(float fParam0, float fParam1, float fParam2) // Position - 0x15209
{
	float num;
	float num2;
...
BOOL func_360() // Position - 0x1527E
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_147))
		if (func_375(PLAYER::PLAYER_ID()))
			return 1;
...
BOOL func_361(Player plParam0) // Position - 0x1529F
{
	if (func_69(plParam0))
		if (func_69(Global_1887694[plParam0 /*611*/].f_10))
...
BOOL func_362() // Position - 0x152D4
{
...
BOOL func_363() // Position - 0x152F7
{
...
BOOL func_364(Player plParam0) // Position - 0x1531A
{
	if (func_341(Global_1845270[plParam0 /*892*/].f_268.f_36, -1))
		return 1;
...
BOOL func_365() // Position - 0x1533D
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_147))
...
void func_366(int iParam0) // Position - 0x15370
{
	if (func_371())
		return;
...
void func_367(int iParam0) // Position - 0x153A3
{
	if (func_371())
		return;
...
BOOL func_368() // Position - 0x1542D
{
...
void func_369(BOOL bParam0, BOOL bParam1) // Position - 0x15454
{
	if (bParam0)
	{
		if (func_358(0))
...
BOOL func_370() // Position - 0x154C8
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_371() // Position - 0x154D6
{
	return IS_BIT_SET(Global_1958240, 19);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x154E5
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x154F2
{
	if (millis == -1)
		return true;
...
BOOL func_374(Player plParam0) // Position - 0x15550
{
	int num;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		{
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
			{
				num = func_12(Global_2657994[plParam0 /*467*/].f_324.f_8);
				return num == 2 || num == 25;
			}
		}
	}
...
BOOL func_375(Player plParam0) // Position - 0x155A5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x155EB
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x15630
{
	return uParam0->f_1;
}

BOOL func_378(Player plParam0) // Position - 0x1563C
{
	return func_379(func_90(plParam0));
}

BOOL func_379(int iParam0) // Position - 0x1564E
{
	switch (iParam0)
	{
		case 167:
...
BOOL func_380(int iParam0) // Position - 0x15674
{
	return Global_44199 == iParam0;
}

void func_381() // Position - 0x15682
{
	if (iLocal_136 != -1)
		_CONTEXT_REMOVE_HELP_TEXT(&iLocal_136);
