...
void main() // Position - 0x0
{
	...
	if (Global_21065 == false)
	{
		...
		if (MISC::IS_XBOX360_VERSION() || IS_XBOX_PLATFORM() || MISC::IS_PC_VERSION())
		{
			...
			func_157(Global_21064, "SET_SOFT_KEYS_COLOUR", 1f, SYSTEM::TO_FLOAT(iLocal_106), SYSTEM::TO_FLOAT(iLocal_107), SYSTEM::TO_FLOAT(iLocal_108), -1082130432);
			HUD::GET_HUD_COLOUR(HUD_COLOUR_RED, &iLocal_106, &iLocal_107, &iLocal_108, &uLocal_109);
			func_157(Global_21064, "SET_SOFT_KEYS_COLOUR", 3f, SYSTEM::TO_FLOAT(iLocal_106), SYSTEM::TO_FLOAT(iLocal_107), SYSTEM::TO_FLOAT(iLocal_108), -1082130432);
		}
		else
		{
	...
	if (Global_79564)
	{
		...
		func_157(Global_21064, "SET_THEME", SYSTEM::TO_FLOAT(Global_4546299), -1082130432, -1082130432, -1082130432, -1082130432);
		func_152();
		...
		if (Global_4546300 == 0)
		{
			...
			if (NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&gamerHandle) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0) && Global_4546303 == 0)
			{
				...
				{
					func_157(Global_21064, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432, -1082130432);
				}
			}
			else
			{
		...
		{
			func_157(Global_21064, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(Global_4546300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		func_157(Global_21064, "SET_THEME", SYSTEM::TO_FLOAT(Global_114162.f_14055[Global_21083 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
	
		if (Global_9757 == 0)
			func_157(Global_21064, "SET_BACKGROUND_IMAGE", SYSTEM::TO_FLOAT(Global_114162.f_14055[Global_21083 /*20*/].f_9), -1082130432, -1082130432, -1082130432, -1082130432);
		else
	...
	{
		if (func_128(14))
			func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(6), -1082130432, -1082130432, -1082130432);
		else
			func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21087), -1082130432, -1082130432, -1082130432);
	...
	while (true)
	{
			...
			if (!Global_21302)
			{
				if (Global_21083.f_1 >= 6)
				{
					...
					if (Global_21083.f_1 == 6)
					{
						...
						func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21063), -1082130432, -1082130432, -1082130432);
					}
				}
			}
		}
		...
		if (Global_79564)
		{
			...
			{
				func_118(10, 23, 5, 1, &func_119);
				func_118(21, 24, 3, 0, &func_115);
			}
		}
		...
		else if (SCRIPT::HAS_SCRIPT_LOADED(&(Global_8926[Global_21086 /*15*/].f_5)))
		{
			if (Global_21086 == 0)
			{
				if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8926[Global_21086 /*15*/].f_9) == 0)
					Global_21081 = SYSTEM::START_NEW_SCRIPT(&(Global_8926[Global_21086 /*15*/].f_5), CONTACTS_APP);
			}
			else
			{
				num4 = 0;
				...
				if (Global_21086 == 2 || num4 == 1)
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8926[Global_21086 /*15*/].f_9) == 0)
						Global_21081 = SYSTEM::START_NEW_SCRIPT(&(Global_8926[Global_21086 /*15*/].f_5), APP_INTERNET);
				else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8926[Global_21086 /*15*/].f_9) == 0)
					Global_21081 = SYSTEM::START_NEW_SCRIPT(&(Global_8926[Global_21086 /*15*/].f_5), CELLPHONE);
			}
...
int func_2(Ped pedParam0, Vehicle veParam1) // Position - 0x1F68
{
...
BOOL func_3(Ped pedParam0) // Position - 0x2041
{
	if (pedParam0 == 0)
		return false;
...
int func_4(Ped pedParam0) // Position - 0x2062
{
	int i;
...
void func_5(BOOL bParam0, BOOL bParam1) // Position - 0x20AB
{
	if (bParam0)
	{
		if (func_6(0))
...
BOOL func_6(int iParam0) // Position - 0x211F
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
			if (IS_BIT_SET(Global_8919, 14))
...
BOOL func_7() // Position - 0x2176
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_8() // Position - 0x2184
{
	return Global_2747169.f_1;
}

void func_9() // Position - 0x2192
{
	float num;
	var unk;
	float num2;
...
BOOL func_12(int iParam0) // Position - 0x25EA
{
	if (Global_44199 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x260C
{
	return func_14(iParam0, Global_44199);
}

BOOL func_14(int iParam0, int iParam1) // Position - 0x261D
{
	if (iParam1 == 15)
		return 1;
...
float func_15(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0x27FE
{
	var position;
	float num;
	float num2;
...
Vector3 func_16(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x290D
{
	return uParam0 + ((uParam3 - uParam0) * { fParam6, fParam6, fParam6 });
}

float func_17(float fParam0, float fParam1, float fParam2) // Position - 0x2927
{
	if (fParam0 > fParam2)
		return fParam2;
			...
			if (Global_79564 == false)
			{
				if (Global_21303)
				{
					if (Global_21302 == false)
					{
						...
						func_129(2);
						func_19();
						func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21088), -1082130432, -1082130432, -1082130432);
...
int func_22(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2BF6
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
void func_23(char* sParam0) // Position - 0x2D5C
{
...
void func_25(int iParam0) // Position - 0x31A1
{
	int num;
	int offset;
...
void func_26() // Position - 0x31CA
{
	func_157(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21072, true);
	func_27();
	return;
}

void func_27() // Position - 0x3207
{
	if (func_28())
...
void func_29() // Position - 0x3271
{
	func_157(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21072, true);
	func_30();
	return;
}

void func_30() // Position - 0x32AE
{
	if (func_28())
		if (Global_21306 == false)
			MOBILE::CELL_SET_INPUT(2);
...
void func_31() // Position - 0x32D1
{
	func_157(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(2), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21072, true);
	func_32();
	return;
}

void func_32() // Position - 0x330E
{
	if (func_28())
		if (Global_21306 == false)
...
void func_33() // Position - 0x3331
{
	func_157(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(4), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21072, true);
	func_34();
	return;
}

void func_34() // Position - 0x336E
{
	if (func_28())
		if (Global_21306 == false)
			MOBILE::CELL_SET_INPUT(3);
...
void func_36() // Position - 0x3682
{
	...
	func_131();
	func_129(1);
	func_157(Global_21064, "DISPLAY_VIEW", 4f, SYSTEM::TO_FLOAT(Global_21063), -1082130432, -1082130432, -1082130432);
	func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21063), -1082130432, -1082130432, -1082130432);
	return;
}

void func_37() // Position - 0x3727
{
	int i;
	...
	func_157(Global_21064, "DISPLAY_VIEW", 4f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
	func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
	return;
}

void func_38(char* sParam0) // Position - 0x37B7
{
...
void func_40(BOOL bParam0) // Position - 0x37DC
{
	int i;
...
void func_41(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x38FF
{
...
void func_42(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x396F
{
		...
		if (Global_79564)
		{
			...
			else
			{
				...
				if (num == 0)
				{
					...
					{
						func_44();
						unk_0xCFB0E9C3456319EA(Global_2672942.f_4.f_11, "PhoneApp", 0, Global_8926[Global_21086 /*15*/].f_9);
...
void func_54(var uParam0) // Position - 0x4CE6
{
	if (func_71(false))
	{
		*uParam0 = 1;
...
BOOL func_55(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4DB4
{
	if (bParam1)
		if (func_56(plParam0))
			return true;
...
BOOL func_56(Player plParam0) // Position - 0x4DE6
{
	return func_57(plParam0);
}

BOOL func_57(Player plParam0) // Position - 0x4DF4
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

BOOL func_58() // Position - 0x4E0B
{
...
BOOL func_59() // Position - 0x4E43
{
	return func_60(*Global_4718592.f_134976);
}

BOOL func_60(var uParam0) // Position - 0x4E59
{
	int i;
...
BOOL func_61(Player plParam0) // Position - 0x4E88
{
	return func_62(&(Global_2657994[plParam0 /*467*/].f_446), 0);
}

BOOL func_62(var uParam0, int iParam1) // Position - 0x4EA1
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_63() // Position - 0x4EAF
{
	return Global_1835546;
}

int func_64(Player plParam0) // Position - 0x4EBB
{
	if (func_67(plParam0))
		return 1;
...
BOOL func_65(Player plParam0) // Position - 0x4EDE
{
	return func_66(plParam0, 20);
}

BOOL func_66(Player plParam0, int iParam1) // Position - 0x4EEE
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_67(Player plParam0) // Position - 0x4F06
{
	Player player;
...
int func_68(Player plParam0) // Position - 0x4F29
{
	if (func_70(plParam0))
		return 1;
...
BOOL func_69(Player plParam0) // Position - 0x4F4C
{
	Player player;
...
BOOL func_70(Player plParam0) // Position - 0x4F6A
{
	Player player;
...
BOOL func_71(BOOL bParam0) // Position - 0x4F8D
{
	return func_72(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_72(Player plParam0, BOOL bParam1) // Position - 0x4F9F
{
	if (!func_74(plParam0))
		return false;
...
BOOL func_73(Player plParam0) // Position - 0x4FD7
{
	if (func_74(plParam0))
...
BOOL func_74(Player plParam0) // Position - 0x500C
{
	Player player;
...
char* func_75() // Position - 0x502E
{
	return "BLOCK_APP_WEB" /*The Internet app is currently unavailable. Please try again later.*/;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x503A
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_77(BOOL bParam0) // Position - 0x504D
{
	if (bParam0)
		return func_80();
...
BOOL func_78(int iParam0) // Position - 0x5069
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_79() // Position - 0x507E
{
	return Global_1907308[PLAYER::PLAYER_ID() /*310*/].f_270;
}

BOOL func_80() // Position - 0x5094
{
	return func_83(526, -1) || unk_0xB233964AC562A357() && func_82() != 0 && !func_81(0);
}

BOOL func_81(int iParam0) // Position - 0x50C4
{
	int num;
...
int func_82() // Position - 0x50DB
{
	return unk_0xA0A0D77ECEDD4136();
}

BOOL func_83(int iParam0, int iParam1) // Position - 0x50E7
{
	Hash statHash;
	BOOL outValue;
...
Hash func_84(int iParam0, int iParam1) // Position - 0x510B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_85(iParam1));
}

int func_85(int iParam0) // Position - 0x5120
{
	int num;
	int num2;
...
int func_86() // Position - 0x5154
{
	return Global_1574926;
}

void func_87() // Position - 0x5160
{
	if (Global_21049 == 0)
	{
	...
	switch (Global_21083.f_1)
	{
		...
		case 9:
			if (Global_21082 == 1)
			{
				...
				{
					func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_120[Global_8234 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2201[Global_8234 /*29*/].f_3), &(Global_2201[Global_8234 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2201[Global_8234 /*29*/].f_3), 0);
				}
			...
			else if (Global_22442 == 4 || Global_22442 == 3)
			{
				...
				else
				{
					...
					if (func_96(Global_8234, Global_21083) == 0)
					{
						...
						func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_120[Global_8234 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_157(Global_21064, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2201[Global_8234 /*29*/].f_3), &(Global_2201[Global_8234 /*29*/].f_7), &unk, &(Global_2201[Global_8234 /*29*/].f_3), 0);
					}
				}
...
int func_96(int iParam0, eCharacter echParam1) // Position - 0x5EF9
{
...
void func_98() // Position - 0x5F72
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_21064))
	{
		if (!Global_22450)
		{
			...
			{
				func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_120[Global_8234 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_219" /*CONNECTED*/, "CELL_195" /*Unknown*/, 0);
			}
			else
			{
				func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2201[Global_8234 /*29*/].f_3), &(Global_2201[Global_8234 /*29*/].f_7), "CELL_219" /*CONNECTED*/, &(Global_2201[Global_8234 /*29*/].f_3), 0);
			}
		}
...
BOOL func_101(eControlType ectParam0, eControlAction ecaParam1, int iParam2) // Position - 0x6166
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x61F5
{
...
void func_104(int iParam0) // Position - 0x621D
{
	if (func_106())
		return;
...
BOOL func_106() // Position - 0x62CE
{
	return IS_BIT_SET(Global_1958240, 19);
}

void func_107() // Position - 0x62DD
{
	if (Global_21083.f_1 == 9 || Global_21083.f_1 == 10)
	{
		Global_22495 = 0;
...
BOOL func_115() // Position - 0x67FD
{
	return func_116() && !NETWORK::NETWORK_IS_ACTIVITY_SESSION();
}

BOOL func_116() // Position - 0x6813
{
	return _STAT_GET_PACKED_BOOL(9539, -1);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x6823
{
	if (iParam1 == -1)
		iParam1 = func_86();
...
void func_118(int iParam0, int iParam1, int iParam2, int iParam3, function funcParam4) // Position - 0x683F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8926[iParam0 /*15*/].f_9) > 0)
	{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x6A41
{
...
void func_127(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, const char* sParam8, const char* sParam9, char* sParam10, const char* sParam11) // Position - 0x6A6C
{
...
BOOL func_128(int iParam0) // Position - 0x6B1F
{
	return Global_44199 == iParam0;
}

void func_129(int iParam0) // Position - 0x6B2D
{
	int i;
	int num;
	int value;
				...
				if (iParam0 == Global_8926[num /*15*/].f_11)
				{
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9520[i] == false)
						{
							...
							if (Global_2696428)
								if (num == 14)
									func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23505), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9520[i] == false)
						{
							...
							if (num == 1)
							{
								...
								func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23510), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79564)
								{
									...
									func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21083)
									...
									func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8926[num /*15*/].f_10 == 57 && num == 25)
							{
								...
								func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_127(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
...
void func_131() // Position - 0x7142
{
	...
	else
	{
		...
		if (func_115())
			func_42(24, "CELL_HACKER_ROB", 3, "appHackerDen", 62, 1, 1, 0, 0);
		else
...
int func_132(int iParam0, eCharacter echParam1) // Position - 0x772B
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
BOOL func_133(int iParam0) // Position - 0x7755
{
	int num;
...
BOOL func_134(int* piParam0) // Position - 0x77EA
{
	if (func_135())
	{
		*piParam0 = 11;
...
BOOL func_135() // Position - 0x7808
{
	return Global_33383;
}

int func_136() // Position - 0x7813
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x785B
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_138() // Position - 0x7871
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	...
	func_157(Global_21064, "SET_PROVIDER_ICON", SYSTEM::TO_FLOAT(iLocal_87), SYSTEM::TO_FLOAT(iLocal_88), -1082130432, -1082130432, -1082130432);
	return;
}

BOOL func_139() // Position - 0x7941
{
...
int func_140(int iParam0) // Position - 0x7A41
{
	return Global_114162.f_7692.f_765[iParam0 /*10*/].f_7;
}

int func_141(int iParam0) // Position - 0x7A59
{
	return Global_114162.f_7692.f_651[iParam0 /*14*/].f_7;
}

BOOL func_142(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7A71
{
	if (iParam3 != -1)
	{
		...
		if (SYSTEM::VDIST2(vParam0, Global_44200[iParam3 /*5*/]) <= Global_44200[iParam3 /*5*/].f_3 * Global_44200[iParam3 /*5*/].f_3)
			return true;
...
int func_143(int iParam0) // Position - 0x7ADC
{
	return Global_114162.f_7692[iParam0 /*15*/].f_7;
}

BOOL func_144(eCharacter echParam0) // Position - 0x7AF1
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x7AFD
{
	func_146();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_146() // Position - 0x7B16
{
	eCharacter character;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x7C13
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x7C50
{
	if (func_144(character))
...
Hash func_149(eCharacter echParam0) // Position - 0x7C75
{
	return Global_2201[echParam0 /*29*/];
}

int func_150() // Position - 0x7C84
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
	return Global_114162.f_14055[Global_21083 /*20*/].f_8;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x7C9E
{
	var gamerHandle;
...
int func_153(int iParam0, int iParam1) // Position - 0x7F2C
{
	Hash statHash;
	int outValue;
...
Hash func_154(int iParam0, int iParam1) // Position - 0x7F5B
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_85(iParam1));
}

void func_155() // Position - 0x7F70
{
	if (func_128(14))
	{
		if (Global_2696428)
		{
			if (Global_21083.f_1 == 6)
			{
				if (Global_21063 == 7)
				{
					func_157(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(7), -1082130432, -1082130432, -1082130432);
				}
				else
				{
					Global_21063 = 6;
	...
	if (iLocal_90 != Global_8922)
	{
		...
		func_127(Global_21064, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_89), SYSTEM::TO_FLOAT(iLocal_90), -1f, -1f, -1f, &uLocal_92, 0, 0, 0, 0);
...
void func_157(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8259
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
BOOL IS_XBOX_PLATFORM() // Position - 0x82BC
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_159() // Position - 0x82D2
{
...
void func_160(Any* panParam0) // Position - 0x8345
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x842D
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_163() // Position - 0x843D
{
	Global_21308 = 0;
	func_10();
	return;
...
void func_164(int iParam0, char* sParam1) // Position - 0x844D
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	return;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x865F
{
	if (func_128(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
