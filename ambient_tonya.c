...
void func_5(int iParam0) // Position - 0x304
{
	...
	TEXT_LABEL_COPY(&Global_64341, { func_10(iParam0) }, 4);
	Global_64329 = 0;
	Global_64328 = 0;
...
{
	Global_64345 = 0;
	Global_64349 = func_16(joaat("SP0_SHOTS"));
	Global_64348 = func_16(joaat("SP0_HITS"));
	Global_64351 = func_16(joaat("SP1_SHOTS"));
	Global_64350 = func_16(joaat("SP1_HITS"));
	Global_64353 = func_16(joaat("SP2_SHOTS"));
	Global_64352 = func_16(joaat("SP2_HITS"));
	return;
}
...
void func_24(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xBED
{
	if (Global_101713 != 10 && Global_101713 != 9)
	{
		...
		func_26(&Global_104723, sParam0, 0, "Start", iParam1, pedParam2);
		func_25();
		Global_95866 = 0;
	}
...
void func_59() // Position - 0x4010
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_37(character) && !func_60(14) || Global_113110)
			{
...
void func_61(Ped pedParam0, BOOL bParam1) // Position - 0x411B
{
	...
	if (func_37(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_62(pedParam0, &Global_114162.f_2367.f_539.f_298[character /*477*/]);
...
Hash func_65(Hash hParam0, int iParam1) // Position - 0x472F
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_66(Hash hParam0, Any* panParam1) // Position - 0x54B0
{
	int i;
	int numDlcWeapons;
...
Hash func_67(int iParam0) // Position - 0x54EB
{
	int num;
...
void func_68(Ped pedParam0) // Position - 0x575F
{
	eCharacter character;
...
BOOL func_70(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CEA
{
...
int func_79(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6991
{
	int i;
...
Vector3 func_80(int iParam0, BOOL bParam1) // Position - 0x6A33
{
	switch (iParam0)
	{
		...
		case 45:
			return func_97(Global_103877);
	
		case 46:
			if (Global_1845100 != _INVALID_PLAYER_INDEX())
				if (func_95(Global_1845100))
					return func_88(2, 2);
				else if (func_87(Global_1845100))
					return func_88(45, 3);
				else
...
int func_98() // Position - 0x86F8
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8708
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8725
{
	return func_75(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8735
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8A78
{
	return Global_101765.f_399 > 0;
}

var func_103() // Position - 0x8A89
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8ACF
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8B55
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8B88
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x8BD9
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x8C7B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C9D
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x8CB4
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x8CC1
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8CFB
{
...
void func_113(var uParam0, int iParam1) // Position - 0x8D36
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8D72
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_115(int iParam0) // Position - 0x8D96
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DF9
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E0F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E25
{
...
struct<2> func_119(int iParam0) // Position - 0x8E66
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x92B2
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA4F6
{
	switch (iParam0)
	{
		case 0:
...
void func_123(int iParam0) // Position - 0xA83C
{
	char* scriptName;
...
void func_124(int iParam0) // Position - 0xA88E
{
	var name;
...
void func_125(int iParam0) // Position - 0xA929
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xA987
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xA9E0
{
...
int func_129(Ped pedParam0) // Position - 0xAA63
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAA94
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAAA9
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAB5C
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAB77
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xABC3
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAC0C
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAC2C
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAC4D
{
	switch (iParam0)
	{
		case 5:
...
void func_140(char* sParam0) // Position - 0xAD1D
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

BOOL func_141(int iParam0) // Position - 0xAD2F
{
	if (iParam0 == -1)
		iParam0 = func_151();
...
BOOL func_142(int iParam0) // Position - 0xADC4
{
...
BOOL func_145(int iParam0) // Position - 0xAE43
{
	if (func_147() && Global_101713.f_11 == 6 && iParam0 == func_146(&(Global_101713.f_3), 0))
		return true;

	return false;
}

int func_146(const char* sParam0, int iParam1) // Position - 0xAE77
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xAEFE
{
	return func_149(iParam0, Global_44199);
}

BOOL func_149(int iParam0, int iParam1) // Position - 0xAF0F
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_150(int iParam0) // Position - 0xB0F0
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
...
int func_151() // Position - 0xB118
{
	return func_146(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

BOOL func_152(int iParam0) // Position - 0xB129
{
	int num;
	...
	num = func_154(&(Global_113249[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_153(int iParam0) // Position - 0xB16E
{
	Global_113249[iParam0 /*10*/].f_4 = 1;
	Global_113249[iParam0 /*10*/].f_5 = 0;
	Global_113249[iParam0 /*10*/].f_6 = 0;
	Global_113249[iParam0 /*10*/] = 0;
	return;
}

int func_154(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB1A0
{
	int i;
...
void func_155(var uParam0, int iParam1) // Position - 0xB2D7
{
	int i;
...
BOOL func_156(int iParam0) // Position - 0xB326
{
	if (Global_44199 == 15)
		return false;
...
BOOL func_157(int iParam0) // Position - 0xB348
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_165() || Global_113209 || Global_33108 || func_164() || func_163(8, -1) || func_102() || func_162() || func_161() || func_160() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_165() || Global_33108 || func_164() || func_163(8, -1) || func_161() || func_102() || func_162() || func_160() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_165() || Global_113209 || Global_33108 || func_164() || func_163(8, -1) || func_161() || func_102() || func_162() || func_160() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_165() || Global_113209 || Global_33108 || func_164() || func_163(8, -1) || func_102() || func_162() || func_160() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_165() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_163(8, -1) || func_160() || func_159() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_165() || Global_33108 || func_164() || func_163(8, -1) || func_162() || func_161() || func_160() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_165() || func_162() || Global_113209 || Global_33108 || func_164() || Global_45410 || func_163(8, -1) || func_161() || func_159() || func_160() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_165() || Global_113209 || Global_33108 || func_164() || func_163(8, -1) || func_161() || func_159() || func_102() || func_162() || func_160())
							return false;
						break;
				}
			}
...
BOOL func_158() // Position - 0xBA65
{
	return Global_101752.f_1;
}

BOOL func_159() // Position - 0xBA73
{
	if (Global_98610 != -1)
...
BOOL func_162() // Position - 0xBADA
{
	return Global_101765.f_400 > 0;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0xBAEB
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_164() // Position - 0xBB23
{
	return Global_1575086;
}

BOOL func_165() // Position - 0xBB2F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_167(int iParam0) // Position - 0xBB63
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xBCB3
{
...
BOOL func_170(int iParam0) // Position - 0xBCD5
{
	if (Global_120[iParam0 /*10*/].f_8 != 184)
...
int func_171(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0xBD13
{
...
int func_172(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xBD72
{
	Global_22443 = 0;
...
BOOL func_175(Player plParam0) // Position - 0xC0DD
{
	return func_176(plParam0, 20);
}

BOOL func_176(Player plParam0, int iParam1) // Position - 0xC0ED
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_177() // Position - 0xC105
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC28B
{
	if (func_60(14))
	{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC3DB
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC431
{
...
BOOL func_189(int iParam0) // Position - 0xC59D
{
...
BOOL func_190(int iParam0) // Position - 0xC5CA
{
	int i;
...
void func_192(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xC648
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xC841
{
	return Global_2201[character /*29*/].f_3;
}

int func_195(eCharacter echParam0, int iParam1) // Position - 0xC854
{
...
int func_196(eCharacter echParam0, int iParam1) // Position - 0xC87E
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_197(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC8A8
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_198(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC8ED
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xC932
{
	func_59();
	return Global_114162.f_2367.f_539.f_4321;
}

BOOL func_200(int iParam0) // Position - 0xC94B
{
...
BOOL func_201(int iParam0, int iParam1) // Position - 0xC976
{
	BOOL flag;
...
int func_202(int iParam0) // Position - 0xC9C0
{
	int num;
	int offset;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xCA17
{
...
int func_205(int iParam0) // Position - 0xCA67
{
	int num;
	int offset;
