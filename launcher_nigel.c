	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_328(&(Global_113249[num /*10*/].f_9));
			}
		}
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x495B
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x56DC
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5717
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x598B
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F16
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BBD
{
	int i;
...
int func_97() // Position - 0x8925
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8935
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8952
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8962
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8CA5
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8CB6
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8CFC
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D82
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8DB5
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8E06
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8EA8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8ECA
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8EE1
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EEE
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8F28
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F63
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F9F
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8FB8
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x901B
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x9031
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x9047
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9089
{
...
struct<2> func_119(int iParam0) // Position - 0x90B1
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x94FE
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA7D6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAB1C
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xABC1
{
	var name;
...
void func_125(int iParam0) // Position - 0xAC5C
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xACBA
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAD13
{
...
int func_129(Ped pedParam0) // Position - 0xAD96
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xADC7
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADDC
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE8F
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAEAA
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAEF6
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAF3F
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAF5F
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAF80
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xB050
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB0A3
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB199
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB204
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB243
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB392
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB3AC
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB405
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB446
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB468
{
...
BOOL func_150() // Position - 0xB4A7
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_151() // Position - 0xB4B5
{
...
void func_152(int iParam0) // Position - 0xB4DC
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB4FF
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5A3
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB632
{
...
void func_160(Vehicle veParam0) // Position - 0xB689
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB6B5
{
...
void func_163(int iParam0) // Position - 0xB857
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB88A
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB914
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB988
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_167(int iParam0) // Position - 0xB996
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB9ED
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_169(int iParam0) // Position - 0xB9FC
{
...
BOOL func_170(int iParam0) // Position - 0xBA3D
{
	int num;
	...
	num = func_172(&(Global_113249[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_171(int iParam0) // Position - 0xBA82
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBAB4
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBBEB
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC3A
{
	return func_175(iParam0, Global_44199);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBC4B
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBE2C
{
	if (Global_44199 == 15)
		return false;
...
int func_177() // Position - 0xBE4E
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBE5F
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBEA8
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBECC
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC33B
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC367
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC37E
{
	switch (iParam0)
	{
		case 0:
...
int func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC40D
{
	int num;
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC440
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCC23
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCC3E
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCCCC
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCD30
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xCDC7
{
...
BOOL func_191(int iParam0) // Position - 0xCDF1
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_199() || Global_113209 || Global_33108 || func_198() || func_197(8, -1) || func_101() || func_196() || func_195() || func_194() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_199() || Global_33108 || func_198() || func_197(8, -1) || func_195() || func_101() || func_196() || func_194() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_199() || Global_113209 || Global_33108 || func_198() || func_197(8, -1) || func_195() || func_101() || func_196() || func_194() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_199() || Global_113209 || Global_33108 || func_198() || func_197(8, -1) || func_101() || func_196() || func_194() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_199() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_197(8, -1) || func_194() || func_193() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_199() || Global_33108 || func_198() || func_197(8, -1) || func_196() || func_195() || func_194() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_199() || func_196() || Global_113209 || Global_33108 || func_198() || Global_45410 || func_197(8, -1) || func_195() || func_193() || func_194() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_199() || Global_113209 || Global_33108 || func_198() || func_197(8, -1) || func_195() || func_193() || func_101() || func_196() || func_194())
							return false;
						break;
				}
			}
...
BOOL func_192() // Position - 0xD50E
{
	return Global_101752.f_1;
}

BOOL func_193() // Position - 0xD51C
{
	if (Global_98610 != -1)
...
BOOL func_196() // Position - 0xD583
{
	return Global_101765.f_400 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD594
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD5CC
{
	return Global_1575086;
}

BOOL func_199() // Position - 0xD5D8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_200(var uParam0) // Position - 0xD5F4
{
	int i;
...
int func_201(var uParam0, var uParam1) // Position - 0xD6B8
{
...
BOOL func_202(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xD6F5
{
	BOOL flag;
	int num;
	int num2;
...
void func_203(var uParam0, var uParam1, var uParam2) // Position - 0xD7B1
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD91C
{
	char* str;
...
int func_205(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDB11
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB99
{
...
void func_207(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBD4
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC2A
{
...
float func_209(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDCC5
{
...
int func_210(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xDCFF
{
	var unk;
...
void func_211(int iParam0) // Position - 0xDE4A
{
	Global_23453 = iParam0;
	return;
}

BOOL func_212(char* sParam0) // Position - 0xDE57
{
	var string1;
...
struct<6> func_213() // Position - 0xDE77
{
	var unk;
...
void func_214(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDE9B
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_215(int iParam0) // Position - 0xE1F3
{
...
BOOL func_216(var uParam0) // Position - 0xE213
{
...
BOOL func_217(var uParam0) // Position - 0xE22B
{
...
Hash func_218() // Position - 0xE250
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_219() // Position - 0xE25D
{
	return "Al_DiNapoli";
}

void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE269
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE35A
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE396
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE3CF
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE46D
{
	return Global_98997;
}

void func_225(var uParam0) // Position - 0xE479
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE490
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE578
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE5A0
{
	var unk;
	...
	if (func_261(*panParam0) || func_259(*panParam0) || Global_79810 == 1)
		return true;
...
void func_229(var uParam0) // Position - 0xE810
{
	int i;
	int taskSequenceId;
...
void func_230(Object* pobParam0) // Position - 0xEB14
{
...
void func_231(var uParam0) // Position - 0xEB3F
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEBBF
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_233(Ped pedParam0, Vehicle veParam1) // Position - 0xED7D
{
...
BOOL func_234(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEDAD
{
	int i;
	int num;
...
BOOL func_235(int iParam0) // Position - 0xF069
{
...
BOOL func_236(Ped pedParam0, int iParam1) // Position - 0xF09D
{
	float xSize;
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF113
{
	return func_238(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF12B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_239(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF1EC
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_240(Ped pedParam0, int iParam1) // Position - 0xF318
{
...
BOOL func_242(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF427
{
	var unk;
...
float func_243(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF4B8
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_244(float fParam0, var uParam1, var uParam2) // Position - 0xF4D9
{
	float num;
	float num2;
...
void func_245(var uParam0) // Position - 0xF518
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_246(Ped pedParam0, Ped pedParam1) // Position - 0xF533
{
	int i;
...
BOOL func_247(Ped pedParam0) // Position - 0xF572
{
...
BOOL func_248(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF59A
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_249(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF695
{
	float entityCoords;
	float num;
...
BOOL func_250(Ped pedParam0, float fParam1) // Position - 0xF7A1
{
	var outProjectile;
	var outCoords;
...
BOOL func_251(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF836
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_252(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF8C4
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_253(int iParam0) // Position - 0xF90C
{
...
void func_254(Ped pedParam0) // Position - 0xF956
{
	int taskSequenceId;
...
BOOL func_255(int iParam0) // Position - 0xF9F3
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_256(int iParam0) // Position - 0xFA88
{
...
BOOL func_259(int iParam0) // Position - 0xFB07
{
	if (func_260() && Global_101713.f_11 == 6 && iParam0 == func_178(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_260() // Position - 0xFB3B
{
...
BOOL func_261(int iParam0) // Position - 0xFB79
{
...
BOOL func_262(var uParam0, var uParam1) // Position - 0xFBA1
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_263(var uParam0) // Position - 0xFC5D
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_264(var uParam0, var uParam1) // Position - 0xFE44
{
...
void func_265(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFF19
{
	func_266(pveParam0);
...
void func_266(Vehicle* pveParam0) // Position - 0xFF5C
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_267(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFFF8
{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10055
{
	Hash model;
...
int func_269(var uParam0, eCharacter echParam1) // Position - 0x100E3
{
	int num;
...
BOOL func_270(var uParam0) // Position - 0x10129
{
	if (func_217(uParam0))
	{
...
BOOL func_271(var uParam0) // Position - 0x10153
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x10184
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_273(var uParam0) // Position - 0x101C0
{
	int num;
	int i;
	BOOL flag;
...
void func_274(int iParam0, BOOL bParam1) // Position - 0x103DB
{
	switch (iParam0)
	{
		case 37:
...
void func_275(BOOL bParam0) // Position - 0x107F5
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
void func_279(var uParam0) // Position - 0x10ED3
{
	int i;
	float num;
...
void func_280(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x10F73
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_281(var uParam0) // Position - 0x10FA4
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
BOOL func_282(var uParam0) // Position - 0x10FCB
{
	int num;
	int i;
	char* animDict;
...
BOOL func_283(var uParam0) // Position - 0x112F9
{
	int num;
	int i;
	char* animDict;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
				...
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_41[0], true, 0);
...
void func_284(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1185D
{
	func_230(pobParam0);
...
void func_285(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x11884
{
	func_286(ppedParam0);
...
void func_286(Ped* ppedParam0) // Position - 0x118A5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_287(var uParam0) // Position - 0x118E6
{
	int num;
	int i;
	Interior interiorAtCoordsWithType;
...
void func_288(int iParam0, BOOL bParam1) // Position - 0x11E34
{
	char* string2;
	Interior interior;
...
BOOL func_289(int iParam0) // Position - 0x11EFB
{
	int num;
...
struct<2> func_290(int iParam0) // Position - 0x11F2C
{
	int num;
...
void func_291(int iParam0, BOOL bParam1) // Position - 0x11F59
{
	int offset;
...
char* func_292(int iParam0, var uParam1) // Position - 0x11F9C
{
	Vector3 vector;
...
struct<5> func_293(int iParam0) // Position - 0x11FC1
{
	var unk;
	var unk6;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_294(&Global_4718592.f_231553[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_231553[1 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_231553[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_231553[2 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_231553[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_231553[3 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_231553[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_231553[4 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_231553[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
var func_294(var uParam0) // Position - 0x14C23
{
	return uParam0;
}

struct<6> func_295(int iParam0, BOOL bParam1) // Position - 0x14C2D
{
	var unk;
...
BOOL func_296(var uParam0) // Position - 0x157E3
{
	int num;
	int i;
	int num2;
...
BOOL func_297(int iParam0) // Position - 0x15A84
{
	var unk;
	eCharacter character;
...
BOOL func_298(int iParam0) // Position - 0x15AD5
{
	const char* string2;
...
BOOL func_299(int iParam0) // Position - 0x15B8E
{
	var unk;
...
BOOL func_300(int iParam0) // Position - 0x15C4F
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_301(int iParam0, char* sParam1) // Position - 0x15CD4
{
...
BOOL func_302(int iParam0) // Position - 0x15DB6
{
...
BOOL func_303(int iParam0) // Position - 0x15DE1
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_304(int iParam0) // Position - 0x15E0C
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x15E37
{
	if (func_256(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_306() // Position - 0x15E6C
{
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x15E86
{
	int i;
...
BOOL func_308(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x15EEB
{
	int num;
	char* str;
...
BOOL func_309(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x15F63
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_310(var uParam0, var uParam1, BOOL bParam2) // Position - 0x15FDE
{
	char* str;
...
void func_311(char* sParam0) // Position - 0x160C8
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_212(sParam0))
			func_312();
...
void func_312() // Position - 0x160E7
{
	Global_21308 = 0;
	func_313();
	return;
...
void func_313() // Position - 0x160F7
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
int func_314(var uParam0) // Position - 0x16118
{
	if (func_217(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_315(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1614E
{
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x1616E
{
	func_317(&(uParam0->f_41), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x16180
{
	int i;
...
void func_318(Object* pobParam0, BOOL bParam1) // Position - 0x161BE
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_319(var uParam0, BOOL bParam1) // Position - 0x161F9
{
	func_320(&(uParam0->f_35), bParam1);
	return;
}

void func_320(var uParam0, BOOL bParam1) // Position - 0x1620B
{
	int i;
...
void func_321(Vehicle* pveParam0) // Position - 0x16248
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_322(var uParam0, int iParam1) // Position - 0x16280
{
	func_323(&(uParam0->f_28), iParam1);
	return;
}

void func_323(var uParam0, int iParam1) // Position - 0x16292
{
	int i;
...
void func_324(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x162D3
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_325(var uParam0) // Position - 0x16323
{
...
BOOL func_326(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x16374
{
...
void func_327(var uParam0) // Position - 0x163A7
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[0]))
...
void func_328(int iParam0) // Position - 0x16436
{
	if (*iParam0 == -1)
		return;
...
void func_329(char* sParam0) // Position - 0x16473
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_330(var uParam0) // Position - 0x16485
{
	*uParam0 = -1;
...
void func_331() // Position - 0x164B8
{
...
Hash func_332(eCharacter echParam0) // Position - 0x164D2
{
	if (!func_36(echParam0))
