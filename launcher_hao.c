	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A2D
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28D8
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2960
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48A7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5628
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5663
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58D7
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E62
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B09
{
	int i;
...
int func_97() // Position - 0x8874
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8884
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88A1
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88B1
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BF4
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8C05
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C4B
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CD1
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D04
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D55
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DF7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E19
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E30
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E3D
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E77
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EB2
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EEE
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F07
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F6A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F80
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F96
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FD8
{
...
struct<2> func_119(int iParam0) // Position - 0x9000
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x944D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA725
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA6B
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB10
{
	var name;
...
void func_125(int iParam0) // Position - 0xABAB
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAC09
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC62
{
...
int func_129(Ped pedParam0) // Position - 0xACE5
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD16
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD2B
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADDE
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADF9
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE45
{
	int i;
...
BOOL func_136(Vehicle veParam0) // Position - 0xAE8E
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAEAE
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAECF
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF9F
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFF2
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0E8
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB153
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB192
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2E1
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2FB
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB354
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB395
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB3B7
{
...
BOOL func_150() // Position - 0xB3F6
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB404
{
	int num;
...
void func_153(int iParam0) // Position - 0xB45E
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB481
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB525
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5B4
{
...
void func_161(Vehicle veParam0) // Position - 0xB60B
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB637
{
...
void func_164(int iParam0) // Position - 0xB7D9
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB80C
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB896
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB90A
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB918
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB96F
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB97E
{
...
BOOL func_171(int iParam0) // Position - 0xB9BF
{
	int num;
...
void func_172(int iParam0) // Position - 0xBA04
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA36
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB6D
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBBC
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBBCD
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBDAE
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBDD0
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDE1
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE2A
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE4E
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC635
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC650
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6DE
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC742
{
...
BOOL func_186(int iParam0) // Position - 0xC7D9
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_113209 || Global_33108 || func_193() || func_192(8, -1) || func_101() || func_191() || func_190() || func_189() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194() || Global_33108 || func_193() || func_192(8, -1) || func_190() || func_101() || func_191() || func_189() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_113209 || Global_33108 || func_193() || func_192(8, -1) || func_190() || func_101() || func_191() || func_189() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_113209 || Global_33108 || func_193() || func_192(8, -1) || func_101() || func_191() || func_189() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_194() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_192(8, -1) || func_189() || func_188() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_194() || Global_33108 || func_193() || func_192(8, -1) || func_191() || func_190() || func_189() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194() || func_191() || Global_113209 || Global_33108 || func_193() || Global_45410 || func_192(8, -1) || func_190() || func_188() || func_189() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_194() || Global_113209 || Global_33108 || func_193() || func_192(8, -1) || func_190() || func_188() || func_101() || func_191() || func_189())
							return false;
						break;
				}
			}
...
BOOL func_187() // Position - 0xCEF6
{
	return Global_101752.f_1;
}

BOOL func_188() // Position - 0xCF04
{
	if (Global_98610 != -1)
...
BOOL func_191() // Position - 0xCF6B
{
	return Global_101765.f_400 > 0;
}

BOOL func_192(int iParam0, int iParam1) // Position - 0xCF7C
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_193() // Position - 0xCFB4
{
	return Global_1575086;
}

BOOL func_194() // Position - 0xCFC0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_195(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCFDC
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD064
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD09F
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0F5
{
...
float func_199(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD190
{
...
void func_200(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1CA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_201(int iParam0, BOOL bParam1) // Position - 0xD2BB
{
	if (iParam0 == -1)
		return;
...
int func_202(int iParam0) // Position - 0xD2F7
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_203(var uParam0, int iParam1) // Position - 0xD330
{
	BOOL flag;
	int i;
...
BOOL func_204() // Position - 0xD3CE
{
	return Global_98997;
}

void func_205(var uParam0) // Position - 0xD3DA
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD3F1
{
	BOOL flag;
	int num;
	int i;
...
void func_207(int iParam0) // Position - 0xD4D9
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
void func_208(var uParam0) // Position - 0xD501
{
	int i;
	int taskSequenceId;
...
void func_209(Vehicle veParam0) // Position - 0xD805
{
	int taskSequenceId;
...
void func_210(Object* pobParam0) // Position - 0xD8A2
{
...
BOOL func_211(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xD8CD
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_212(Vehicle veParam0) // Position - 0xD906
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD930
{
	var unk;
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_79810 == 1)
		return true;
...
void func_214(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDBA0
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_215(int iParam0) // Position - 0xDEF8
{
...
BOOL func_216(var uParam0) // Position - 0xDF18
{
...
BOOL func_217(var uParam0) // Position - 0xDF30
{
...
void func_218(var uParam0) // Position - 0xDF55
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDFD5
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE193
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE1C3
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE47F
{
...
BOOL func_223(Vehicle veParam0, int iParam1) // Position - 0xE4B3
{
	float xSize;
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE529
{
	return func_225(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE541
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE602
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE72E
{
	...
	if (iParam1 == 0)
		...
		return PED::GET_PED_BONE_COORDS(pedParam0, &func_119, 0f, 0f, 0f);

	return ENTITY::GET_ENTITY_COORDS(pedParam0, true);
}

int func_228() // Position - 0xE7F3
{
	int i;
...
BOOL func_229(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE83D
{
	var unk;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE8CE
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE8EF
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE92E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Vehicle veParam0, Ped pedParam1) // Position - 0xE949
{
	int i;
...
BOOL func_234(Vehicle veParam0) // Position - 0xE988
{
...
BOOL func_235(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE9B0
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_236(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEAAB
{
	float entityCoords;
	float num;
...
BOOL func_237(Vehicle veParam0, float fParam1) // Position - 0xEBB7
{
	var outProjectile;
	var outCoords;
...
BOOL func_238(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEC4C
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_239(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xECDA
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xED22
{
...
BOOL func_241(int iParam0) // Position - 0xED6C
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_242(int iParam0) // Position - 0xEE01
{
...
BOOL func_245(int iParam0) // Position - 0xEE80
{
	if (func_246() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_246() // Position - 0xEEB4
{
...
BOOL func_247(int iParam0) // Position - 0xEEF2
{
...
BOOL func_248(var uParam0) // Position - 0xEF1A
{
	if (!func_249(uParam0))
		return false;
...
BOOL func_249(var uParam0) // Position - 0xEF39
{
	int num;
	int i;
	int sceneID;
...
void func_250(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3A3
{
	func_210(pobParam0);
...
void func_251(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF3CA
{
	func_252(pveParam0);
...
void func_252(Vehicle* pveParam0) // Position - 0xF40D
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_253(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF4A9
{
...
BOOL func_254(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF505
{
	Hash model;
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xF593
{
	int num;
...
BOOL func_256(var uParam0) // Position - 0xF5D9
{
	int i;
...
BOOL func_257(int iParam0) // Position - 0xF60A
{
	int i;
...
BOOL func_258(int iParam0) // Position - 0xF672
{
	var unk;
	eCharacter character;
...
BOOL func_259(int iParam0) // Position - 0xF6C3
{
	const char* string2;
...
BOOL func_260(int iParam0) // Position - 0xF77C
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0xF83D
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_262(int iParam0, char* sParam1) // Position - 0xF8C2
{
...
BOOL func_263(int iParam0) // Position - 0xF9A4
{
...
BOOL func_264(int iParam0) // Position - 0xF9CF
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xF9FA
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xFA25
{
	if (func_242(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFA74
{
	int i;
...
BOOL func_269(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFAD9
{
	int num;
	char* str;
...
BOOL func_270(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFB51
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFBCC
{
	if (bParam1)
	{
...
void func_272(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFC20
{
...
void func_273(var uParam0, BOOL bParam1) // Position - 0xFC40
{
	func_274(&(uParam0->f_41), bParam1);
	return;
}

void func_274(var uParam0, BOOL bParam1) // Position - 0xFC52
{
	int i;
...
void func_275(Object* pobParam0, BOOL bParam1) // Position - 0xFC90
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_276(var uParam0, BOOL bParam1) // Position - 0xFCCB
{
	func_277(&(uParam0->f_35), bParam1);
	return;
}

void func_277(var uParam0, BOOL bParam1) // Position - 0xFCDD
{
	int i;
...
void func_278(Vehicle* pveParam0) // Position - 0xFD1A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_279(var uParam0, int iParam1) // Position - 0xFD52
{
	func_280(&(uParam0->f_28), iParam1);
	return;
}

void func_280(var uParam0, int iParam1) // Position - 0xFD64
{
	int i;
...
void func_281(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFDA5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_282(Ped* ppedParam0) // Position - 0xFDF5
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_283(int iParam0) // Position - 0xFE36
{
	if (*iParam0 == -1)
		return;
...
void func_284(char* sParam0) // Position - 0xFE73
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_285(var uParam0) // Position - 0xFE85
{
	*uParam0 = -1;
...
Hash func_287(eCharacter echParam0) // Position - 0xFED2
{
	if (!func_36(echParam0))
