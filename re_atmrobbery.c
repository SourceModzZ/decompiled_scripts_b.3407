				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_98, fLocal_133, fLocal_133, fLocal_133, false, true, 0) && !func_107())
				{
					...
					if (!func_136())
					{
						if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
						{
							...
							{
								if (!IS_BIT_SET(Global_8919, 11) || func_102())
								{
									if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
										{
											...
											{
												while (!func_88(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_134, 1, 1056964608, false, true, false) || _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(obLocal_99))
												{
...
void func_7(int iParam0) // Position - 0x3303
{
	...
	else if (IS_BIT_SET(Global_114162.f_20568.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_9() /*5571*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114162.f_20568.f_471), iParam0);
...
char* func_8(int iParam0) // Position - 0x34CC
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x3607
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x3623
{
	Hash statHash;
	int outValue;
...
Hash func_12(int iParam0) // Position - 0x3641
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_13(int iParam0) // Position - 0x3663
{
	switch (iParam0)
	{
		case 38:
...
int func_14(int iParam0) // Position - 0x3680
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_15(int iParam0) // Position - 0x3785
{
	switch (iParam0)
	{
		case 18:
...
void func_16(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3814
{
	Hash statName;
...
Hash func_17(int iParam0, int iParam1) // Position - 0x3842
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_18(iParam1));
}

int func_18(int iParam0) // Position - 0x3857
{
	int num;
	int num2;
...
int func_19() // Position - 0x388B
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x3897
{
	if (iParam2 == -1)
		iParam2 = func_19();
...
void func_21(int iParam0) // Position - 0x38B5
{
	func_41(93, iParam0);
	func_41(29, iParam0);
	func_41(30, iParam0);
...
BOOL func_22(int iParam0) // Position - 0x38D5
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_23(int iParam0, int iParam1) // Position - 0x3AE0
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x3B0F
{
	if (iParam1 == -1)
		iParam1 = func_19();
...
int func_25(BOOL bParam0) // Position - 0x3B2B
{
	var outValue;
	int value;
	int outValue2;
...
int func_26(int iParam0, int iParam1) // Position - 0x3BE2
{
	if (iParam0 >= 78)
		return 0;
...
int func_27(int iParam0, int iParam1) // Position - 0x3BFD
{
...
BOOL func_28(var uParam0, int iParam1) // Position - 0x3C9A
{
	int i;
	var unk;
...
int func_29(var uParam0, int iParam1) // Position - 0x3D4B
{
	int i;
...
BOOL func_30(var uParam0, int iParam1) // Position - 0x3DC6
{
	return uParam0->[iParam1] == 78;
}

void func_31(var uParam0) // Position - 0x3DD7
{
	int i;
...
void func_32(var uParam0, int iParam1) // Position - 0x3E0B
{
	uParam0->[iParam1] = 78;
	return;
}

void func_33(var uParam0, int iParam1) // Position - 0x3E1B
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_34(var uParam0) // Position - 0x3E38
{
	return uParam0->f_80;
}

BOOL func_35(var uParam0, int iParam1) // Position - 0x3E44
{
	return func_36(uParam0, iParam1) != -1;
}

int func_36(var uParam0, int iParam1) // Position - 0x3E56
{
	int i;
...
BOOL func_37(var uParam0) // Position - 0x3E83
{
	return uParam0->f_79 == 1;
}

BOOL func_38(int iParam0) // Position - 0x3E91
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_39(int iParam0) // Position - 0x3EE1
{
	return Global_44199 == iParam0;
}

BOOL func_40(int iParam0, int iParam1) // Position - 0x3EEF
{
...
void func_41(int iParam0, int iParam1) // Position - 0x3F40
{
	int outValue;
...
int func_43(eCharacter echParam0) // Position - 0x4014
{
	return Global_2201[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4025
{
	func_45();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_45() // Position - 0x403E
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(character) && !func_39(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_46(Global_114162.f_2367.f_539.f_4321))
...
BOOL func_46(eCharacter echParam0) // Position - 0x413B
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x4147
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x4184
{
...
Hash func_49(eCharacter echParam0) // Position - 0x41A9
{
	return Global_2201[echParam0 /*29*/];
}

void func_50() // Position - 0x41B8
{
	Cam cam;
...
void func_52(Vehicle* pveParam0) // Position - 0x420F
{
...
BOOL func_53(Ped pedParam0, float fParam1, float fParam2) // Position - 0x4247
{
	float num;
	float num2;
...
BOOL func_55(int iParam0) // Position - 0x4319
{
...
void func_57(Hash hParam0, int iParam1) // Position - 0x4395
{
	int outValue;
...
int func_58(var uParam0, char* sParam1, char* sParam2, var uParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8) // Position - 0x43B8
{
	var unk;
	var unk12;
...
int func_59(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x4411
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x4902
{
	if (func_39(14))
	{
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x49FB
{
	switch (iParam0)
	{
		case 5:
...
void func_68(int iParam0, var uParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) // Position - 0x4A8A
{
...
void func_69(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4B12
{
...
BOOL func_70(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x4B68
{
	if (bParam6)
...
Vector3 func_71(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4BAF
{
	Vehicle playersLastVehicle;
...
Vector3 func_72(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4, var uParam5, var uParam6) // Position - 0x51B0
{
	float num;
	float value;
	float num2;
...
BOOL func_73(Vehicle veParam0) // Position - 0x51FD
{
...
BOOL func_74(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0x5227
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_75(Ped pedParam0, var uParam1, var uParam2, char* sParam3, char* sParam4) // Position - 0x52A2
{
	int num;
	int num2;
	int num3;
...
float func_76(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x545A
{
	float num;
	float num2;
	float num3;
...
float func_77(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x54BF
{
	var entityCoords;
	var entityCoords2;
...
void func_78(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x54EB
{
	BOOL flag;
	float dx;
...
BOOL func_79(Vehicle veParam0, float fParam1, float fParam2) // Position - 0x55EC
{
	float entityHeading;
	float num;
	float num2;
...
void func_80(int iParam0) // Position - 0x5673
{
	if (func_85())
		return;
...
void func_81(int iParam0) // Position - 0x56A6
{
	if (func_85())
		return;
...
void func_82(BOOL bParam0, BOOL bParam1) // Position - 0x5730
{
	if (bParam0)
	{
		if (func_84(0))
...
BOOL func_83() // Position - 0x57A4
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_84(int iParam0) // Position - 0x57B2
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
...
BOOL func_85() // Position - 0x5809
{
	return IS_BIT_SET(Global_1958240, 19);
}

void func_86() // Position - 0x5818
{
	Global_21308 = 0;
	func_87();
	return;
...
BOOL func_88(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5849
{
...
void func_89(Vehicle veParam0) // Position - 0x58A0
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_90(BOOL bParam0, BOOL bParam1) // Position - 0x58CC
{
...
void func_91(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5A1D
{
	if (bParam0)
	{
...
BOOL func_92() // Position - 0x5B6C
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_93(Player plParam0, int iParam1) // Position - 0x5B86
{
	BOOL flag;
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x5BDF
{
	int num;
	int num2;
...
BOOL func_95(Player plParam0) // Position - 0x5C20
{
	Player player;
...
BOOL func_96(Player plParam0) // Position - 0x5C42
{
...
BOOL func_97() // Position - 0x5C81
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_98(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5C8F
{
	int num;
...
void func_99(int iParam0) // Position - 0x5CC2
{
	if (iParam0 == 1)
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x5CF5
{
...
BOOL func_103(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D38
{
...
BOOL func_104(int iParam0) // Position - 0x5E1D
{
	return _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(func_106(iParam0));
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x5E2F
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

char* func_106(int iParam0) // Position - 0x5E42
{
	char* str;
...
void func_109(int iParam0) // Position - 0x6469
{
	switch (iParam0)
	{
		case 0:
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x6544
{
...
void func_111(var uParam0) // Position - 0x655B
{
	*uParam0 = -99;
	return;
}

Blip func_112(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x6569
{
	iParam2 = iParam2;
	return func_113(pedParam0, bParam1, 145);
}

Blip func_113(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x657F
{
	Blip blip;
...
Blip func_114(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x65C9
{
	Blip blip;
...
var func_115(BOOL bParam0, var uParam1, var uParam2) // Position - 0x666D
{
	if (bParam0)
		return uParam1;
...
Blip func_117(Pickup pkParam0) // Position - 0x698D
{
	return func_118(pkParam0);
}

Blip func_118(Pickup pkParam0) // Position - 0x699B
{
	Blip blip;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x69D3
{
...
void func_122(Blip blParam0, Ped pedParam1, float fParam2, int iParam3, BOOL bParam4) // Position - 0x6C2F
{
	int num;
...
void func_123(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x6D88
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x6D9F
{
	char* str;
...
float func_125(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x6F94
{
	Vector3 entityCoords;
...
void func_126(Blip blParam0, var uParam1) // Position - 0x6FF2
{
	if (HUD::DOES_BLIP_EXIST(blParam0))
	{
...
BOOL func_127(int iParam0) // Position - 0x7050
{
	return IS_BIT_SET(Global_114158, iParam0);
}

void func_128() // Position - 0x705F
{
	switch (iLocal_107)
	{
		case 1:
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7256
{
...
BOOL func_130(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x72A4
{
	Global_22443 = 0;
...
BOOL func_133(Player plParam0) // Position - 0x760C
{
	return func_134(plParam0, 20);
}

BOOL func_134(Player plParam0, int iParam1) // Position - 0x761C
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x7634
{
	return -1;
}

BOOL func_136() // Position - 0x763D
{
	BOOL flag;
	Vector3 vector;
	Vector3 vector2;
...
BOOL func_137(Ped pedParam0) // Position - 0x778E
{
...
BOOL func_140(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x78BB
{
	float num;
...
BOOL func_141(Ped pedParam0, int iParam1) // Position - 0x7976
{
	float xSize;
...
BOOL func_142(Ped pedParam0, int iParam1) // Position - 0x79EC
{
	return func_143(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_143(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x7A04
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_144(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0x7AC5
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_145(Ped pedParam0, int iParam1) // Position - 0x7BF1
{
...
BOOL func_147(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x7D00
{
	var unk;
...
float func_148(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x7D91
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_149(float fParam0, var uParam1, var uParam2) // Position - 0x7DB2
{
	float num;
	float num2;
...
void func_150(var uParam0) // Position - 0x7DF1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_151(Ped pedParam0, Ped pedParam1) // Position - 0x7E0C
{
	int i;
...
BOOL func_152(Ped pedParam0) // Position - 0x7E4B
{
...
BOOL func_153(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x7E73
{
...
BOOL func_154(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7EBA
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_155(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7FB5
{
	float entityCoords;
	float num;
...
BOOL func_156(Ped pedParam0, float fParam1) // Position - 0x80C3
{
	var outProjectile;
	var outCoords;
...
BOOL func_157(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x8158
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_158(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x81E6
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_160(var uParam0, Ped pedParam1, char* sParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x8265
{
	func_161(uParam0, pedParam1, sParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_161(var uParam0, Ped pedParam1, char* sParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x827F
{
	func_162(uParam0, pedParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_162(var uParam0, Ped pedParam1, float fParam2, float fParam3, float fParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x829C
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
...
void func_163(var uParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4, char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x82D4
{
	char* string2;
	BOOL flag;
...
void func_164(var uParam0) // Position - 0x8641
{
...
BOOL func_165(var uParam0) // Position - 0x86AA
{
	int num;
...
int func_166(BOOL bParam0) // Position - 0x86D5
{
	switch (Global_44199)
	{
		case 0:
...
BOOL func_167(char* sParam0) // Position - 0x877F
{
...
BOOL func_168(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8818
{
	Vehicle vehiclePedIsIn;
	int seatIndex;
	...
	if (func_175() || func_174(*Global_4718592.f_194133) || func_173())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
BOOL func_169(Player plParam0) // Position - 0x8A71
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x8AD7
{
	Player player;
...
BOOL func_171(Vehicle veParam0, int iParam1) // Position - 0x8B37
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x8B99
{
	Vehicle vehiclePedIsIn;
...
BOOL func_173() // Position - 0x8C1E
{
	return Global_2684721.f_19;
}

BOOL func_174(int iParam0) // Position - 0x8C2C
{
	return iParam0 == 51;
}

BOOL func_175() // Position - 0x8C39
{
	return Global_2684721.f_18;
}

BOOL func_176() // Position - 0x8C47
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

void func_177(var uParam0, Ped pedParam1, Vector3 vParam2, var uParam3, var uParam4, int iParam5) // Position - 0x8C5C
{
...
BOOL func_178() // Position - 0x8D6C
{
	return func_179(PLAYER::PLAYER_ID());
}

BOOL func_179(Player plParam0) // Position - 0x8D7C
{
...
BOOL func_180(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8D9B
{
	if (uParam0->f_1)
		if (MISC::GET_GAME_TIMER() >= uParam0->f_8 + uParam0->f_9)
			uParam0->f_1 = 0;
...
BOOL func_181(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9107
{
...
BOOL func_182(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9159
{
	if (!func_168(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_183(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x91A2
{
	if (!func_168(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9201
{
	if (!func_168(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_185(Ped pedParam0) // Position - 0x9257
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (ENTITY::IS_ENTITY_A_VEHICLE(pedParam0))
...
void func_186() // Position - 0x92B2
{
	MISC::SET_BIT(&Global_8920, 4);
	return;
}

void func_187(var uParam0, char* sParam1, BOOL bParam2) // Position - 0x92C2
{
	const char* str;
...
float func_188(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x939C
{
	Vector3 entityCoords;
...
BOOL func_189(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x93D6
{
...
void func_190(char* sParam0) // Position - 0x9409
{
	func_191(sParam0);
	return;
}

void func_191(char* sParam0) // Position - 0x9417
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_192(var uParam0, int iParam1) // Position - 0x942A
{
...
int func_194(BOOL bParam0) // Position - 0x95FE
{
	if (func_196())
	{
		Global_114152 = true;
		...
		if (func_195(Global_114151))
			func_109(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_195(Global_114151))
...
BOOL func_195(int iParam0) // Position - 0x9651
{
	switch (iParam0)
	{
		case 29:
...
BOOL func_196() // Position - 0x9680
{
	switch (func_197(&Global_33165, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_197(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x96B6
{
	int i;
...
void func_198(var uParam0, int iParam1) // Position - 0x97ED
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x983C
{
	return func_200(iParam0, Global_44199);
}

BOOL func_200(int iParam0, int iParam1) // Position - 0x984D
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_201(int iParam0) // Position - 0x9A2E
{
	if (Global_44199 == 15)
		return false;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xA2E6
{
...
BOOL func_207(var uParam0) // Position - 0xA426
{
	int i;
...
BOOL func_208(var uParam0) // Position - 0xA482
{
	return func_209(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

BOOL func_209(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xA499
{
...
int func_210(int iParam0) // Position - 0xA584
{
	int i;
...
void func_211(var uParam0, char* sParam1) // Position - 0xA5AD
{
	func_212(uParam0, 1, -1, sParam1, 0);
	return;
}

void func_212(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xA5C0
{
	int i;
...
void func_213(var uParam0, Hash hParam1) // Position - 0xA69F
{
	func_212(uParam0, 0, hParam1, "NULL", 0);
	return;
}

void func_214(var uParam0, int iParam1) // Position - 0xA6B3
{
	if (iParam1 > 0)
...
BOOL func_215() // Position - 0xA6CA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_227())
			return false;
	}
...
int func_216(float fParam0, BOOL bParam1) // Position - 0xA750
{
	var unk;
	int num;
	int num2;
...
void func_217(int iParam0, var uParam1) // Position - 0xA801
{
	switch (iParam0)
	{
		case 0:
...
int func_219(int iParam0) // Position - 0xBA47
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_220(int iParam0) // Position - 0xBD8D
{
	var unk;
	var unk3;
...
struct<2> func_221(int iParam0) // Position - 0xBDC4
{
	var unk;
...
BOOL func_224() // Position - 0xC28A
{
	return Global_113880 > 0;
}

BOOL func_225() // Position - 0xC298
{
	if (Global_98610 != -1)
		return true;
...
BOOL _GET_RANDOM_BOOL() // Position - 0xCE46
{
...
BOOL func_231() // Position - 0xCEC6
{
	if (Global_114151 == func_232() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114152)
		return true;

	return false;
}

int func_232() // Position - 0xCEF1
{
	var unk;
	int num;
...
int func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xCF0E
{
...
void func_234(var uParam0) // Position - 0xD0E8
{
	int i;
...
void func_235(int* piParam0) // Position - 0xD166
{
	func_236(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_236(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0xD17C
{
...
void func_237(Blip blParam0, var uParam1) // Position - 0xD24D
{
	int value;
	int num;
...
void func_238() // Position - 0xD2EC
{
	return;
}

void func_239() // Position - 0xD2F4
{
	return;
}

void func_240(int iParam0) // Position - 0xD2FC
{
	if (iParam0 == -1)
		iParam0 = func_232();
...
void func_242(int iParam0) // Position - 0xD36F
{
	Global_114151 = iParam0;
	return;
}

BOOL func_243(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD37D
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (!func_278(Global_114162.f_24999.f_43[iParam3]))
			return false;
...
BOOL func_244(eCharacter echParam0) // Position - 0xD717
{
	int num;
...
BOOL func_245(int iParam0) // Position - 0xD738
{
	return func_246(iParam0, 1);
}

int func_246(int iParam0, int iParam1) // Position - 0xD747
{
	var unk;
	var unk2;
	int num;
...
void func_247(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xD79A
{
	func_248(func_259(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_248(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xD7B8
{
	int num;
	int num2;
	int num3;
	...
	while (num5 < 0)
	{
		...
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_249(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_249(float fParam0, float fParam1, float fParam2) // Position - 0xD9B9
{
	float num;
...
int func_250(int iParam0, int iParam1) // Position - 0xD9FB
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_251(int iParam0) // Position - 0xDA9D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_252(int iParam0) // Position - 0xDAB0
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_253(int iParam0) // Position - 0xDAC3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_254(int iParam0) // Position - 0xDAD6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_255(int iParam0) // Position - 0xDAE8
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_256(BOOL bParam0, var uParam1, var uParam2) // Position - 0xDB0A
{
	if (bParam0)
		return uParam1;
...
int func_257(int iParam0) // Position - 0xDB21
{
	return iParam0 & 15;
}

BOOL func_258(int iParam0, int iParam1) // Position - 0xDB2E
{
	int num;
	int num2;
...
void func_260(var uParam0, int iParam1) // Position - 0xDC80
{
	if (iParam1 <= 0)
		return;
...
void func_261(var uParam0, int iParam1) // Position - 0xDD06
{
...
void func_262(var uParam0, int iParam1) // Position - 0xDD39
{
	int num;
	int num2;
...
void func_263(var uParam0, int iParam1) // Position - 0xDD8A
{
...
void func_264(var uParam0, int iParam1) // Position - 0xDDC4
{
...
void func_265(var uParam0, int iParam1) // Position - 0xDDFF
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_266(int iParam0) // Position - 0xDE3B
{
	int num;
	int num2;
	int num3;
...
BOOL func_267(int iParam0, int iParam1) // Position - 0xDF17
{
...
BOOL func_268(int iParam0) // Position - 0xDF37
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_113209 || Global_33108 || func_275() || func_66(8, -1) || func_274() || func_273() || func_272() || func_271() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_276() || Global_33108 || func_275() || func_66(8, -1) || func_272() || func_274() || func_273() || func_271() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_113209 || Global_33108 || func_275() || func_66(8, -1) || func_272() || func_274() || func_273() || func_271() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_113209 || Global_33108 || func_275() || func_66(8, -1) || func_274() || func_273() || func_271() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_276() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_66(8, -1) || func_271() || func_270() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_276() || Global_33108 || func_275() || func_66(8, -1) || func_273() || func_272() || func_271() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_276() || func_273() || Global_113209 || Global_33108 || func_275() || Global_45410 || func_66(8, -1) || func_272() || func_270() || func_271() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_276() || Global_113209 || Global_33108 || func_275() || func_66(8, -1) || func_272() || func_270() || func_274() || func_273() || func_271())
							return false;
						break;
				}
			}
...
BOOL func_269() // Position - 0xE654
{
	return Global_101752.f_1;
}

BOOL func_270() // Position - 0xE662
{
	if (Global_98610 != -1)
...
BOOL func_273() // Position - 0xE6C9
{
	return Global_101765.f_400 > 0;
}

BOOL func_274() // Position - 0xE6DA
{
	return Global_101765.f_399 > 0;
}

BOOL func_275() // Position - 0xE6EB
{
	return Global_1575086;
}

BOOL func_276() // Position - 0xE6F7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_278(int iParam0) // Position - 0xE73B
{
	return func_258(func_259(), iParam0);
}

BOOL func_279(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xE74D
{
	BOOL num;
	eCharacter character;
...
int func_280(eCharacter echParam0) // Position - 0xE831
{
...
BOOL func_281(int iParam0) // Position - 0xE855
{
	int num;
	BOOL flag;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xE8F1
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xE919
{
	int profileSetting;
...
void func_286(int iParam0) // Position - 0xEAAD
{
	var name;
	...
	if (func_231())
	{
		...
		func_290(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_289(Global_114151, true), 64);
	
		if (func_288(Global_114151) > 0)
		{
	...
	func_287(&Global_33165);
	Global_114152 = false;
	func_242(-1);
	return;
}

void func_287(var uParam0) // Position - 0xEB5F
{
	if (*uParam0 == -1)
		return;
...
int func_288(int iParam0) // Position - 0xEB9C
{
	int num;
...
char* func_289(int iParam0, BOOL bParam1) // Position - 0xEC4D
{
	switch (iParam0)
	{
		case 0:
...
void func_290(int iParam0) // Position - 0xEE96
{
	Global_44750 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_291(int iParam0) // Position - 0xEEA8
{
	func_292(iParam0, 0, func_297(iParam0));
	return;
}

void func_292(int iParam0, int iParam1, int iParam2) // Position - 0xEEBD
{
	int unk;
	var unk2;
...
struct<16> func_293(var uParam0) // Position - 0xEEEC
{
	var unk;
	int num;
...
void func_294(int iParam0, var uParam1) // Position - 0xEFBC
{
	Global_114162.f_24999.f_43[iParam0] = *uParam1;
	return;
}

void func_295(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xEFD4
{
	int num;
	int i;
	int num2;
...
void func_296(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF156
{
...
int func_297(int iParam0) // Position - 0xF18E
{
	int num;
...
void func_298(var uParam0, BOOL bParam1) // Position - 0xF331
{
	int i;
...
void func_299(var uParam0) // Position - 0xF36C
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
...
void func_300(var uParam0) // Position - 0xF385
{
	int i;
...
void func_301(var uParam0) // Position - 0xF3BB
{
	func_302(*uParam0, &(uParam0->f_2), uParam0->f_1);
	return;
}

void func_302(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xF3D2
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_210(iParam0))
...
void func_303(BOOL bParam0) // Position - 0xF48C
{
	Global_114154 = { uLocal_93 };
...
void func_304() // Position - 0xF4C1
{
	func_305();
	return;
}

int func_305() // Position - 0xF4CE
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		return 0;
...
int func_306() // Position - 0xF519
{
	return 1;
}

void func_307(int iParam0, int iParam1) // Position - 0xF522
{
	if (iParam0 == -1)
		iParam0 = func_232();
...
void func_308(int iParam0, var uParam1, var uParam2) // Position - 0xF626
{
	BOOL flag;
...
void func_309() // Position - 0xF70C
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114162.f_10198.f_3853))
		func_40(13, SYSTEM::FLOOR(Global_114162.f_10198.f_3853));
...
int func_310() // Position - 0xFBCA
{
	return Global_33105;
}

int func_311(int iParam0, int iParam1) // Position - 0xFBD5
{
	switch (iParam0)
	{
		case 0:
...
void func_312(int iParam0) // Position - 0xFF49
{
	int offset;
	int i;
...
void func_313(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xFF8B
{
	func_314(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_314(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xFFAC
{
	int i;
...
void func_315() // Position - 0x10180
{
	int i;
...
BOOL func_316(int iParam0) // Position - 0x10297
{
	int num;
	int i;
...
void func_317(int iParam0, int iParam1) // Position - 0x102D7
{
	MISC::SET_BIT(&Global_114162.f_24999.f_8[iParam0], iParam1);
	return;
}

void func_318(int iParam0) // Position - 0x102F2
{
