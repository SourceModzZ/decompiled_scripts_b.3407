...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_130())
		{
			...
			for (i = 0; i < 63; i = i + 1)
			{
				if (i % 60 == iLocal_47 || Global_113222[i /*10*/].f_2)
					func_83(i);
			}
...
void func_1() // Position - 0x121
{
	...
	for (j = 0; j < 63; j = j + 1)
	{
		...
		if (Global_113222[num /*10*/].f_8 != -1)
		{
			func_3(uLocal_72[Global_113222[num /*10*/].f_8], false, false);
			func_2(&(Global_113222[num /*10*/].f_8));
		}
	
		Global_113222[num /*10*/].f_7 = 0;
	}
					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (unk_0xC450B06E5AAA0985(Global_33467[num /*23*/].f_19))
								{
									unk_0x861AC9C2D48CEA7F(Global_33467[num /*23*/].f_19, 1);
									unk_0x8D777E1B885E428C(Global_33467[num /*23*/].f_19, 10000);
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(var uParam0) // Position - 0x87C
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x8B9
{
...
int func_15(eCharacter echParam0) // Position - 0x8DE
{
...
int func_42() // Position - 0x2A04
{
	...
	func_38(&unk, unk_0x8825A6E0A30BDCB8());
	func_36(&unk, unk_0x7598FE4545010A75());
	return unk;
}
...
{
	if (!func_45(39))
		if (IS_BIT_SET(Global_114135.f_18578[27 /*6*/], 3))
...
void func_54() // Position - 0x2DF1
{
	if (_IS_EXCLUSIVE_CONTENT_UNLOCKED())
	{
		if (!func_43(114))
		{
			if (IS_BIT_SET(Global_114135.f_18578[46 /*6*/], 3))
			{
		...
		{
			if (IS_BIT_SET(Global_114135.f_18578[51 /*6*/], 3))
			{
...
void func_61(int iParam0) // Position - 0x32C6
{
	...
	for (i = 0; i < Global_114135.f_7692.f_198; i = i + 1)
	{
		if (Global_114135.f_7692.f_137[i /*15*/] == iParam0)
		{
			func_62(Global_114135.f_7692.f_137[i /*15*/].f_6);
...
int func_62(int iParam0) // Position - 0x3382
{
	...
	{
		if (func_68(iParam0, Global_21066) == 1)
		{
			func_67(iParam0, Global_21066, 0);
		
			if (func_66(iParam0, Global_21066) == 0)
			{
				num = Global_21066;
				func_63(iParam0, num);
			}
...
void func_76() // Position - 0x3997
{
	...
	{
		if (!IS_BIT_SET(Global_114135.f_18578.f_390[iLocal_50], iLocal_49))
		{
			func_18(num, &unk);
		
			if (num == 58)
				unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_18578.f_390[iLocal_50], iLocal_49);
			else if (unk_0x9A761B33F5EF75C5(unk.f_6))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_18578.f_390[iLocal_50], iLocal_49);
			else if (Global_113222[num /*10*/].f_8 != -1)
				if (uLocal_51[Global_113222[num /*10*/].f_8])
					if (IS_BIT_SET(Global_33467[uLocal_72[Global_113222[num /*10*/].f_8] /*23*/].f_11, 6))
						func_81(uLocal_72[Global_113222[num /*10*/].f_8]);
		}
		else if (Global_113222[num /*10*/].f_8 != -1)
		{
			if (uLocal_51[Global_113222[num /*10*/].f_8])
				if (!IS_BIT_SET(Global_33467[uLocal_72[Global_113222[num /*10*/].f_8] /*23*/].f_11, 6))
					func_77(uLocal_72[Global_113222[num /*10*/].f_8]);
		}
	}
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	func_18(iParam0, &unk);
	Global_113222[iParam0 /*10*/].f_2 = 0;

	if (!IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 1))
		if (!unk.f_23)
			unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_18578[iParam0 /*6*/], 1);

	if (IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 0) && !IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 3))
	{
		if (!Global_114135.f_18578[iParam0 /*6*/].f_1)
		{
			unk33 = func_42();
			...
			if (iParam0 == 57)
			{
				num = unk_0xC5935DFB3F39785A(3, 11);
				num = num * 30;
				func_34(&unk33, 0, 0, num, 0, 0, 0);
			}
		
			Global_114135.f_18578[iParam0 /*6*/].f_2 = unk33;
			Global_114135.f_18578[iParam0 /*6*/].f_1 = 1;
		}
		...
		if (IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					if (!func_23(Global_114135.f_18578[iParam0 /*6*/].f_2))
					{
						func_122(Global_114135.f_18578[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num2, &num3, &num4);
					
						if (num4 > 0 || num3 > 0 || num2 > 10)
						{
							unk53 = { func_21(iParam0) };
							Global_114135.f_18578[iParam0 /*6*/].f_2 = func_42();
							func_34(&(Global_114135.f_18578[iParam0 /*6*/].f_2), 0, 0, unk.f_15, 0, 0, 0);
						}
				...
				if (flag)
				{
					unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_18578[iParam0 /*6*/], 2);
					Global_113222[iParam0 /*10*/].f_4 = 0;
					...
					{
						Global_113222[iParam0 /*10*/].f_3 = 1;
					}
				}
			}
		}
	...
	if (IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 3))
	{
		flag2 = true;
		...
		if (!flag2)
			unk_0x8744D2E3FC95740E(&Global_114135.f_18578[iParam0 /*6*/], 2);
	}
	...
	{
		Global_113222[iParam0 /*10*/].f_2 = 1;
		Global_113222[iParam0 /*10*/].f_1 = 0;
		Global_113222[iParam0 /*10*/].f_3 = 1;
	}
	else if (Global_113222[iParam0 /*10*/].f_3)
	{
		...
		if (!func_120() && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), unk.f_6, 0) > num5)
		{
			Global_113222[iParam0 /*10*/].f_3 = 0;
		}
		else
		{
			if (iParam0 == 10 && Global_114135.f_7265[109] != 1)
				func_107(109, 1);
	...
	if (flag3 && !IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 3) && IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 0) && IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 1) && IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 2))
	{
	...
	if (Global_113222[iParam0 /*10*/].f_7 != num6)
	{
		if (func_105(&(Global_113222[iParam0 /*10*/].f_8)))
		{
			...
			{
				num7 = uLocal_72[Global_113222[iParam0 /*10*/].f_8];
			
				if (num6 == 0)
				{
					func_3(num7, false, false);
					func_104(num7, false);
					func_2(&(Global_113222[iParam0 /*10*/].f_8));
				}
				else if (num6 == 2)
				{
					if (func_103(iParam0))
					{
						func_102(num7, true);
						func_101(num7, func_52(iParam0));
						func_100(num7, func_50(iParam0));
					}
					else
					{
						func_102(num7, false);
						func_99(num7, unk.f_9);
						func_101(num7, unk.f_6);
					}
				
					func_96(num7, iParam0);
					func_95(num7);
				
					if (func_94(unk.f_26, 1))
						func_93(num7, true, 1, false);
				
					if (func_94(unk.f_26, 0))
						func_93(num7, true, 0, false);
				
					if (func_94(unk.f_26, CHAR_TREVOR))
						func_93(num7, true, 2, false);
					...
					func_3(num7, true, false);
				}
			}
		
			Global_113222[iParam0 /*10*/].f_7 = num6;
		}
	}

	if (!IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 4))
	{
		if (unk_0x70E57E9927B6BA58(&(unk.f_10)) == unk_0x70E57E9927B6BA58(""))
		{
			unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_18578[iParam0 /*6*/], 4);
		}
		else if (num6 == 2)
		{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!func_45(35))
		{
			if (IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 3))
			{
				if (!func_94(unk.f_26, _GET_CURRENT_PLAYER_CHARACTER()) && !func_103(iParam0) && !func_82(iParam0) && !func_86(iParam0) && !func_85(iParam0) && !Global_113222[iParam0 /*10*/].f_3)
				{
					if (SYSTEM::VDIST2(unk.f_6, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) < 81f)
					{
						str = "";
...
{
	if (iParam0 == 2)
		if (IS_BIT_SET(Global_114135.f_18578[3 /*6*/], 3) && Global_113222[3 /*10*/].f_3 == true)
			return true;
	else if (iParam0 == 3)
		if (IS_BIT_SET(Global_114135.f_18578[2 /*6*/], 3) && Global_113222[2 /*10*/].f_3 == true)
			return true;
...
BOOL func_86(int iParam0) // Position - 0x457E
{
	if (iParam0 == 2 || iParam0 == 3)
		if (IS_BIT_SET(Global_114135.f_18578[2 /*6*/], 0) && IS_BIT_SET(Global_114135.f_18578[3 /*6*/], 0))
...
BOOL func_88(int iParam0) // Position - 0x461A
{
	...
	flag = IS_BIT_SET(Global_33467[num /*23*/].f_11, 0);
	flag2 = IS_BIT_SET(Global_33467[num /*23*/].f_11, 15);
...
BOOL func_91(int iParam0) // Position - 0x472C
{
	...
	if (Global_114135.f_2356[num2 /*2*/] >= 1)
		return true;
...
void func_96(int iParam0, int iParam1) // Position - 0x4930
{
	...
	{
		if (IS_BIT_SET(Global_114135.f_18578[2 /*6*/], 3) || IS_BIT_SET(Global_114135.f_18578[3 /*6*/], 3) || IS_BIT_SET(Global_114135.f_18578[4 /*6*/], 3))
		{
...
void func_98(int iParam0, int iParam1) // Position - 0x4CEE
{
	...
	unk_0xA11116C8E2E46ED4(&(Global_33467[num /*23*/].f_11), 21, 26, iParam1);
...
void func_100(int iParam0, float fParam1) // Position - 0x4DBA
{
	...
	Global_33464 = 1;
	Global_33467[num /*23*/].f_10 = fParam1;
	Global_39517 = 1;
	unk_0x0B0C9A0F9AAEB7F0(&(Global_33467[num /*23*/].f_11), 18);
	return;
}
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&(Global_33467[num /*23*/].f_11), 28);
	else
		unk_0x8744D2E3FC95740E(&(Global_33467[num /*23*/].f_11), 28);
...
BOOL func_112(int iParam0) // Position - 0x5906
{
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52)
	{
		if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		{
			...
			{
				num = unk_0x4B423FAA24E8ABF0(func_113(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 1)));
...
void func_114(int iParam0, var uParam1) // Position - 0x597C
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && unk_0x486FF5D06E9659F1(Global_92451[26 /*34*/].f_6) == 0)
			{
				Global_114135.f_7265[iParam0] = 1;
				unk_0xEBB2809684978887(uParam1->f_5, Global_114135.f_7265[iParam0], 1, 1);
			}
...
{
	return func_133(iParam0, Global_44181);
}
...
void func_136() // Position - 0x978A
{
	...
	for (i = 0; i < 63; i = i + 1)
	{
		Global_113222[i /*10*/].f_5 = 0;
		Global_113222[i /*10*/].f_6 = 0;
		Global_113222[i /*10*/].f_4 = 0;
		Global_113222[i /*10*/].f_7 = 0;
		Global_113222[i /*10*/].f_8 = -1;
		Global_113222[i /*10*/].f_9 = -1;
	}
