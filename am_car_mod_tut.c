...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		switch (func_290(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_289() == 2)
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(player))
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
				!IS_BIT_SET(Global_1845270[plLocal_138 /*892*/].f_144, 4);
		}
...
void func_8() // Position - 0x34D
{
	if (iLocal_236 != -1)
	{
		func_154(iLocal_236, false);
		func_153(iLocal_236, false);
		iLocal_236 = -1;
	}
...
void func_12(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x4F8
{
	Hash statName;
...
BOOL func_16(int iParam0, int iParam1) // Position - 0x57B
{
	Hash statHash;
	int outValue;
...
int func_18() // Position - 0x961
{
	return Global_33105;
}

void func_19(int iParam0, int iParam1, BOOL bParam2) // Position - 0x96C
{
	int address;
...
void func_20(int iParam0) // Position - 0x9DC
{
...
BOOL func_21(int iParam0) // Position - 0xA03
{
	return func_23(iParam0, 5, true);
}

int func_22(int iParam0) // Position - 0xA13
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_23(int iParam0, int iParam1, BOOL bParam2) // Position - 0xD56
{
	if (iParam0 == -1)
		return false;
...
void func_26(BOOL bParam0) // Position - 0xDF4
{
	BOOL flag;
...
void func_31(BOOL bParam0) // Position - 0x1159
{
	int i;
	int num;
	int num2;
	...
	num = func_146(PLAYER::PLAYER_ID(), bParam0);
	num2 = func_143(num, bParam0);
	...
	if (!func_121(true))
	{
		func_114(func_115(59, false, false), false);
		func_42(func_115(135, false, false), true);
		func_40(func_115(22, false, false), func_115(73, false, false));
	}
	else
	{
		func_40(false, false);
...
void func_32(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1334
{
	Hash statName;
...
Hash func_33(int iParam0, int iParam1) // Position - 0x1357
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_14(iParam1));
}

BOOL func_34() // Position - 0x136C
{
	return Global_1575074;
}

BOOL func_35() // Position - 0x1378
{
	return Global_1575076;
}

void func_36(BOOL bParam0) // Position - 0x1384
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
void func_37(BOOL bParam0) // Position - 0x13D6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_38(int iParam0, int iParam1) // Position - 0x1416
{
	Hash statHash;
	BOOL outValue;
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x145B
{
	BOOL flag;
...
void func_41(int iParam0, BOOL bParam1) // Position - 0x1583
{
	if (bParam1)
...
void func_42(BOOL bParam0, BOOL bParam1) // Position - 0x15A9
{
	BOOL flag;
	...
	if (Global_262145.f_61 == 1 && func_115(135, false, false))
		bParam0 = true;
...
int func_43(int iParam0) // Position - 0x162F
{
	int num;

	if (Global_1939321[iParam0 /*8*/] == -1)
	{
		num = func_16(func_113(iParam0), -1);
...
void func_44(int iParam0, int iParam1) // Position - 0x1672
{
	Global_1939321[iParam0 /*8*/] = iParam1;
	func_45(func_113(iParam0), iParam1, -1);
	return;
}

void func_45(int iParam0, int iParam1, int iParam2) // Position - 0x1691
{
	BOOL flag;
	int num;
	...
	if (!func_111(num, iParam1 == func_16(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_110(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_108(iParam0, &num))
			flag = false;
	}
...
void func_46(var uParam0) // Position - 0x1725
{
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		{
			func_57(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2739945.f_7118.f_1 && func_110(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_47(var uParam0) // Position - 0x1809
{
	var unk;
	BOOL flag;
	...
	unk = 10;
	flag = false;
	func_52(*uParam0, uParam0->f_2, &unk, &flag);

	if (uParam0->f_6 <= uParam0->f_2.f_1)
		return false;

	if (!flag)
		if (func_51(&unk, uParam0->f_2.f_1, uParam0->f_6, &(uParam0->f_2.f_3)))
			if (func_48(*uParam0, uParam0->f_2, uParam0->f_2.f_3))
				return false;
		else
			return false;
...
BOOL func_48(var uParam0, var uParam1, var uParam2) // Position - 0x1879
{
	int num;

	num = func_50(uParam0, uParam1, uParam2);
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x18A1
{
	if (iParam1 == -1)
		iParam1 = func_15();
...
int func_50(int iParam0, int iParam1, int iParam2) // Position - 0x18BD
{
	switch (iParam0)
	{
		case 17:
...
BOOL func_51(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x19D6
{
	int num;
	int i;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1A28
{
	int i;
	int j;
...
void func_53(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x2C1D
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2E38
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
void func_57(int iParam0, int iParam1) // Position - 0x2EDA
{
	int num;
	BOOL address;
	int offset;
...
void func_58(int iParam0, int iParam1) // Position - 0x2F2B
{
	int num;
	int offset;
...
int func_59(int iParam0) // Position - 0x2FE6
{
	return func_60(iParam0) / 8;
}

int func_60(int iParam0) // Position - 0x2FF7
{
	switch (iParam0)
	{
		case 2:
...
void func_61(int iParam0, int iParam1) // Position - 0x316A
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_62(int iParam0) // Position - 0x31BD
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "PROGRESS_HUB_PACK_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_63(iParam0), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_63(int iParam0) // Position - 0x31DC
{
	switch (iParam0)
	{
		case 0:
...
Hash func_64(int iParam0) // Position - 0x3394
{
	switch (iParam0)
	{
		case 0:
...
Hash func_65() // Position - 0x3400
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_66() // Position - 0x3410
{
	if (Global_1668413 == 0)
		func_67();
...
int func_68(int iParam0, int iParam1) // Position - 0x3457
{
	if (iParam1 == 4)
		iParam1 = 3;
...
int func_69(int iParam0) // Position - 0x3473
{
	return func_60(iParam0) % 8;
}

int func_70(int iParam0) // Position - 0x3484
{
	int num;
...
BOOL func_71(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x34DA
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x3577
{
	BOOL flag;
	BOOL flag2;

	flag = func_73(iParam0, iParam1);
	flag2 = func_91(iParam0, iParam1);
	return flag2 >= flag;
}

int func_73(int iParam0, int iParam1) // Position - 0x3598
{
	int i;
...
int func_74(int iParam0, int iParam1) // Position - 0x4642
{
	if (func_75(iParam0))
	{
		switch (iParam1)
...
BOOL func_75(int iParam0) // Position - 0x46B5
{
	int num;
...
int func_76(int iParam0) // Position - 0x46DD
{
	switch (iParam0)
	{
		case 25:
...
int func_77(int iParam0, int iParam1, int iParam2) // Position - 0x47DD
{
	int num;
	int i;
	int num2;
...
int func_78(int iParam0) // Position - 0x4849
{
	if (func_75(iParam0))
		return 13;
...
void func_79(int iParam0) // Position - 0x4864
{
	int num;
	int num2;
	int offset;
...
int func_80(int iParam0) // Position - 0x48A2
{
	return iParam0 % 32;
}

int func_81(int iParam0) // Position - 0x48AF
{
	return iParam0 / 32;
}

int func_82(int iParam0) // Position - 0x48BC
{
	switch (iParam0)
	{
		case 16:
...
void func_83(var uParam0) // Position - 0x589F
{
	int num;
	int num2;
	int num3;
...
int func_84(int iParam0) // Position - 0x58DB
{
	switch (iParam0)
	{
		case 2:
...
void func_85(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6404
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_86(int iParam0, var uParam1, int iParam2) // Position - 0x646D
{
	var unk;
...
char* func_87(int iParam0) // Position - 0x675B
{
	var unk;
...
char* func_88(var uParam0) // Position - 0x6775
{
	return uParam0;
}

char* func_89(int iParam0) // Position - 0x677F
{
	switch (iParam0)
	{
		case 0:
...
Hash func_90(BOOL bParam0) // Position - 0x67D3
{
	if (bParam0)
...
BOOL func_91(int iParam0, int iParam1) // Position - 0x67F6
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 77:
					flag = func_16(12459, -1);
					break;
			
				case 78:
					flag2 = func_16(12444, -1);
				...
				case 79:
					...
					{
						flag = flag + func_106(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_106(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 11:
			switch (iParam1)
			{
				...
				case 103:
					flag = func_16(12044, -1);
					flag = flag + func_16(12042, -1);
					break;
		...
		case 16:
			...
			{
				case 163:
					if (func_16(5448, -1) > false)
						flag = true;
					break;
			
				case 164:
					if (func_16(5453, -1) > true)
						flag = true;
					break;
				...
				case 167:
					if (func_16(5465, -1) > false)
						flag = true;
					break;
			
				case 168:
					if (func_16(5457, -1) >= true || func_16(5455, -1) >= true)
						flag = true;
					break;
			
				case 169:
					flag2 = func_16(5395, -1);
		...
		case 30:
			...
			{
				case 325:
					if (func_16(1209, -1) > false)
						flag = true;
					break;
			
				case 326:
					if (func_16(11921, -1) > false)
						flag = true;
					break;
			
				case 327:
					flag = func_101(40, -1) + func_101(41, -1);
					break;
			
				case 328:
					flag = func_16(11920, -1);
					break;
		...
		case 12:
			switch (iParam1)
			{
				...
				case 117:
					...
					if (func_16(11811, -1) >= 10)
						flag = flag + 1;
				
					if (func_16(11813, -1) >= 10)
						flag = flag + 1;
				...
				case 118:
					flag = func_16(11928, -1);
					break;
			
				case 119:
					flag = func_16(11927, -1);
					break;
		...
		case 13:
			switch (iParam1)
			{
				...
				case 125:
					if (func_16(9910, -1) > false)
						flag = true;
					break;
			
				case 126:
					if (IS_BIT_SET(func_16(9905, -1), 0))
						flag = true;
					break;
				...
				case 130:
					if (IS_BIT_SET(func_16(9905, -1), 2))
						flag = true;
					break;
			
				case 131:
					flag = func_16(11930, -1);
					break;
		...
		case 20:
			...
			{
				case 215:
					if (func_16(9631, -1) == true && _STAT_GET_PACKED_BOOL(31737, -1))
						flag = true;
					break;
		...
		case 22:
			switch (iParam1)
			{
				...
				case 243:
					if (IS_BIT_SET(func_16(9526, -1), 0) || IS_BIT_SET(func_16(9511, -1), 1))
						flag = true;
					break;
			
				case 244:
					if (IS_BIT_SET(func_16(9511, -1), 1))
						flag = true;
					break;
			
				case 245:
					if (func_16(9586, -1) > false)
						flag = true;
					break;
				...
				case 248:
					flag = func_16(11933, -1);
					break;
			
				case 249:
					flag = func_103(func_16(9586, -1));
					break;
				...
				case 252:
					if (func_16(9544, -1) > false)
						flag = flag + 1;
				
					if (func_16(9545, -1) > false)
						flag = flag + 1;
				
					if (func_16(9546, -1) > false)
						flag = flag + 1;
				
					if (func_16(9547, -1) > false)
						flag = flag + 1;
				
					if (func_16(9548, -1) > false)
						flag = flag + 1;
				
					if (func_16(9549, -1) > false)
						flag = flag + 1;
					break;
			
				case 253:
					flag = func_16(11926, -1);
					break;
			}
			break;
		...
		case 23:
			...
			{
				case 254:
					flag2 = func_16(8726, -1);
				
					if (func_103(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
				...
				case 257:
					if (IS_BIT_SET(func_16(8726, -1), 10))
						flag = true;
					break;
		...
		case 26:
			switch (iParam1)
			{
				...
				case 294:
					if (func_16(7864, -1) > false || func_16(7865, -1) > false)
						flag = true;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 138:
					if (func_16(7231, -1) > false)
						flag = true;
					break;
			
				case 139:
					flag = func_16(12010, -1);
					break;
		...
		case 17:
			...
			{
				case 176:
					if (func_16(5303, -1) > false)
						flag = true;
					break;
			
				case 177:
					if (func_16(5332, -1) > false)
						flag = true;
					break;
				...
				case 180:
					if (func_16(11941, -1) > false)
						flag = true;
					break;
			
				case 181:
					flag = func_16(11940, -1);
					break;
		...
		case 18:
			switch (iParam1)
			{
				...
				case 196:
					if (func_16(3913, -1) > false || func_16(3903, -1) > false)
						flag = flag + 1;
				
					if (func_16(3946, -1) > false || func_16(3932, -1) > false)
						flag = flag + 1;
				
					if (func_16(3948, -1) > false || func_16(3936, -1) > false)
						flag = flag + 1;
				
					if (func_16(3950, -1) > false || func_16(3940, -1) > false)
						flag = flag + 1;
				
					if (func_16(3952, -1) > false || func_16(3944, -1) > false)
						flag = flag + 1;
					break;
			
				case 197:
					flag = func_16(10411, -1);
					break;
			
				case 198:
					flag = flag + func_16(3954, -1);
					flag = flag + func_16(3955, -1);
					flag = flag + func_16(3956, -1);
					flag = flag + func_16(3957, -1);
					flag = flag + func_16(3958, -1);
					break;
			
				case 199:
					flag = func_16(11943, -1);
					break;
			
				case 200:
					flag = func_16(11969, -1);
					break;
			
				case 201:
					flag = func_16(11942, -1);
					break;
			}
			break;
		...
		case 19:
			switch (iParam1)
			{
				...
				case 206:
					if (func_16(3639, -1) > false)
						flag = true;
					break;
			
				case 207:
					if (func_16(3667, -1) > false)
						flag = true;
					break;
		...
		case 29:
			...
			{
				case 317:
					if (func_16(1210, -1) > false || _STAT_GET_PACKED_BOOL(42023, -1))
						flag = true;
					break;
				...
				case 319:
					flag = func_16(819, -1);
					flag = flag + func_16(12029, -1);
					flag = flag + func_16(12030, -1);
					break;
				...
				case 321:
					flag = flag + func_103(func_16(11929, -1));
					flag = flag + func_103(func_16(11966, -1));
					flag = flag + func_103(func_16(11967, -1));
					flag = flag + func_103(func_16(11968, -1));
					break;
...
BOOL func_92(int iParam0, int iParam1) // Position - 0xBE9C
{
	Hash statHash;
	BOOL outValue;
...
Hash func_93(int iParam0, int iParam1) // Position - 0xBEC0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_14(iParam1));
}

BOOL func_94() // Position - 0xBED6
{
	int num;
	BOOL flag;
...
void func_95(int iParam0, BOOL bParam1, int iParam2) // Position - 0xBF1D
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
BOOL func_96() // Position - 0xBF45
{
	BOOL flag;
	BOOL flag2;

	flag = _STAT_GET_PACKED_INT(41244, -1);
	flag2 = func_16(11960, -1);
	...
	func_12(11960, Global_2739945.f_6934.f_3, -1, true);
	return flag;
}

BOOL func_97() // Position - 0xBFBE
{
	BOOL address;
	int i;
	Hash weaponHash;
	...
	for (i = 0; i < 103; i = i + 1)
	{
		...
		else if (IS_BIT_SET(func_16(num, -1), i % 32))
		{
	...
	return func_103(address);
}

int func_98(int iParam0) // Position - 0xC0B5
{
	iParam0 = iParam0 / 32;
...
Hash func_99(int iParam0) // Position - 0xC128
{
	switch (iParam0)
	{
		case 34:
...
var func_100(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC769
{
	if (bParam0)
		return uParam1;
...
BOOL func_101(int iParam0, int iParam1) // Position - 0xC780
{
	Hash statHash;
	int outValue;
...
Hash func_102(int iParam0, int iParam1) // Position - 0xC7A4
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_14(iParam1));
}

BOOL func_103(BOOL bParam0) // Position - 0xC7BA
{
	int num;
	BOOL flag;
...
void func_104(var uParam0, int iParam1) // Position - 0xC7FA
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_105() // Position - 0xC80F
{
	int num;
	int num2;
...
int func_106(BOOL bParam0) // Position - 0xCA54
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xCA66
{
	if (iParam1 == -1)
		iParam1 = func_15();
...
BOOL func_108(int iParam0, var uParam1) // Position - 0xCA82
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_109(iParam0, *uParam1, i);
...
int func_109(int iParam0, int iParam1, int iParam2) // Position - 0xCAFA
{
	switch (iParam1)
	{
		case 0:
...
int func_110(int iParam0) // Position - 0xDA40
{
	int num;
	int num2;
	int num3;
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0xDA86
{
	if (iParam0 == -1)
		return false;
...
int func_112(int iParam0) // Position - 0xDAA2
{
	switch (iParam0)
	{
		case 12460:
...
int func_113(int iParam0) // Position - 0xDEB8
{
	switch (iParam0)
	{
		case 0:
...
void func_114(BOOL bParam0, BOOL bParam1) // Position - 0xDED6
{
	BOOL flag;
...
BOOL func_115(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF87
{
	int num;
	int num2;

	if (func_121(false) && iParam0 == 60)
		return true;
	...
	if (Global_262145.f_8337 == 1)
	{
		...
		if (func_117(PLAYER::PLAYER_ID(), 85))
...
BOOL func_117(Player plParam0, int iParam1) // Position - 0xE165
{
	if (!func_39())
		return false;
	...
	return func_118(&(Global_1845270[plParam0 /*892*/].f_826), func_119(iParam1));
}

BOOL func_118(var uParam0, int iParam1) // Position - 0xE1A5
{
	int num;
	int num2;
	int num3;
...
int func_119(int iParam0) // Position - 0xE1C8
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_120() // Position - 0xE3B4
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144, 3);
}

BOOL func_121(BOOL bParam0) // Position - 0xE3CB
{
	if (bParam0)
		return func_124();

	return func_122(func_123());
}

BOOL func_122(int iParam0) // Position - 0xE3E7
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_123() // Position - 0xE3FC
{
	return Global_1907308[PLAYER::PLAYER_ID() /*310*/].f_270;
}

BOOL func_124() // Position - 0xE412
{
	return func_38(526, -1) || unk_0xB233964AC562A357() && func_126() != 0 && !func_125(0);
}

BOOL func_125(int iParam0) // Position - 0xE442
{
	int num;
...
int func_126() // Position - 0xE459
{
	return unk_0xA0A0D77ECEDD4136();
}

void func_127(int iParam0, BOOL bParam1) // Position - 0xE465
{
	int offset;
	int num;
...
void func_129(BOOL bParam0) // Position - 0xE530
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_140, 25))
		{
			func_130(PLAYER::PLAYER_ID(), 12);
...
void func_130(Player plParam0, int iParam1) // Position - 0xE597
{
	func_131(&(Global_1845270[plParam0 /*892*/].f_826), func_119(iParam1));
	return;
}

int func_131(var uParam0, int iParam1) // Position - 0xE5B6
{
	int num;
	int num2;
	int offset;
...
BOOL func_132(Player plParam0) // Position - 0xE5EE
{
	if (func_35())
		return true;
...
BOOL func_136(int iParam0) // Position - 0xE6BE
{
	if (func_137())
		return true;
...
BOOL func_137() // Position - 0xE6D9
{
	return func_138() != -1;
}

int func_138() // Position - 0xE6E7
{
	return Global_2684721.f_767;
}

BOOL func_139(int iParam0) // Position - 0xE6F6
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 130:
			num2 = iParam0;
			num2 = num2 % 32;
			num = func_16(func_140(iParam0), -1);
...
int func_140(int iParam0) // Position - 0xE924
{
	int num;
...
int func_141(int iParam0) // Position - 0xE9F1
{
	if (func_35())
		return 1;
...
BOOL func_142(int iParam0) // Position - 0xECB9
{
	if (Global_1574612)
		return true;
...
int func_143(int iParam0, BOOL bParam1) // Position - 0xECEA
{
	bParam1;
	return func_144(iParam0, 0);
}

int func_144(int iParam0, int iParam1) // Position - 0xECFE
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_145(num) == iParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_145(num) < iParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
// Unhandled jump detected. Output should be considered invalid
int func_145(int iParam0) // Position - 0xEDB9
{
	int num;
	int num2;
...
int func_146(Player plParam0, BOOL bParam1) // Position - 0xF2F4
{
	bParam1;
	return func_147(plParam0);
}

int func_147(Player plParam0) // Position - 0xF307
{
	if (Global_1574633.f_9 == 0)
		if (plParam0 > -1)
			if (plParam0 == PLAYER::PLAYER_ID())
				return func_16(640, -1);
			else if (func_148(plParam0))
...
BOOL func_148(Player plParam0) // Position - 0xF35E
{
...
BOOL func_149(Player plParam0) // Position - 0xF37D
{
	Player player;
...
void func_151(BOOL bParam0) // Position - 0xF3CF
{
	if (bParam0)
		MISC::SET_BIT(&(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144), 18);
	else
		MISC::CLEAR_BIT(&(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144), 18);

	return;
}

void func_152(int iParam0, BOOL bParam1) // Position - 0xF405
{
	if (bParam1)
...
void func_153(int iParam0, BOOL bParam1) // Position - 0xF462
{
	bParam1;
	HUD::DOES_BLIP_EXIST(Global_101765.f_271[iParam0]);
	return;
}

void func_154(int iParam0, BOOL bParam1) // Position - 0xF481
{
	switch (iParam0)
	{
		case 39:
...
void func_155(int iParam0, BOOL bParam1) // Position - 0xF4F9
{
	if (bParam1)
	{
		...
		case 0:
			if (!IS_BIT_SET(uLocal_139[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!IS_BIT_SET(iLocal_237, 5))
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (!IS_BIT_SET(iLocal_237, 2))
								{
									...
									MISC::CLEAR_BIT(&iLocal_237, 3);
									func_284("FM_CTUT_CAR" /*Get a vehicle.*/, false);
							...
							else
							{
								...
								if (!func_244(vehiclePedIsIn, false, &unk) || !func_243(vehiclePedIsIn) || func_242(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
								{
									if (func_241())
										func_240(false);
									...
									if (!IS_BIT_SET(iLocal_237, 7))
									{
										func_284("FM_CTUT_ANO" /*Get a vehicle.*/, false);
										...
										if (func_235())
										{
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))
											{
												if (iLocal_245 > 0)
												{
													...
													else if (!func_244(vehiclePedIsIn, false, &unk))
													{
														MISC::SET_BIT(&iLocal_237, 8);
								...
								else
								{
									...
									if (!func_230() || func_230() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
									{
										if (!IS_BIT_SET(iLocal_237, 3))
										{
											...
											if (iLocal_236 == -1)
											{
												iLocal_236 = func_208(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4, -1);
											
												if (iLocal_236 != -1)
												{
													func_154(iLocal_236, true);
													func_153(iLocal_236, true);
												}
											}
										}
									}
									else if (func_230() && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
									{
										if (!IS_BIT_SET(iLocal_237, 3))
											MISC::SET_BIT(&iLocal_237, 3);
									}
						...
						else
						{
							if (!IS_BIT_SET(iLocal_237, 10))
							{
								...
								{
									func_284("FM_IHELP_LCP" /*Lose the Cops.*/, false);
							...
							if (func_241())
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!func_244(vehiclePedIsIn, false, &unk2) || !func_243(vehiclePedIsIn) || func_242(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)))
											func_240(false);
									}
									else
									{
					...
					if (IS_BIT_SET(iLocal_237, 3) || func_230() && IS_BIT_SET(iLocal_237, 10))
					{
						if (func_230())
						{
							...
							if (func_204("FM_IHELP_LCP" /*Lose the Cops.*/))
								func_24();
							...
							if (!IS_BIT_SET(iLocal_237, 9))
							{
								if (func_202())
								{
									...
									MISC::SET_BIT(&(Global_2739945.f_1861), 25);
								
									if (func_204("FM_CTUT_MOD" /*Go to Los Santos Customs.*/))
										func_24();
								}
							}
							...
							if (func_201())
							{
								if (!IS_BIT_SET(Global_2739945.f_1861, 25))
									MISC::SET_BIT(&(Global_2739945.f_1861), 25);
								...
								if (func_204("FM_CTUT_RSP" /*Get your vehicle resprayed.*/) || func_204("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/) || func_204("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/))
									func_24();
							}
							else if (IS_BIT_SET(iLocal_237, 9))
							{
								if (func_197(PLAYER::PLAYER_ID()) || !func_195() && func_194())
								{
									num = func_187(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false);
								
									if (num > 0)
										if (!func_204("FM_CTUT_REP" /*Get your vehicle repaired.*/))
											func_284("FM_CTUT_REP" /*Get your vehicle repaired.*/, false);
									else if (!func_185())
										if (!func_204("FM_CTUT_RSP" /*Get your vehicle resprayed.*/))
											func_284("FM_CTUT_RSP" /*Get your vehicle resprayed.*/, false);
									else if (!func_183())
										if (!func_204("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/))
											func_284("FM_IHELP_PTRK" /*Purchase a Tracker for your vehicle.*/, false);
									else if (!func_180())
										if (!func_204("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/))
											func_284("FM_IHELP_PINS" /*Purchase Insurance for your vehicle.*/, false);
								}
							}
						}
						else if (IS_BIT_SET(iLocal_237, 9))
					...
					if (!IS_BIT_SET(iLocal_237, 5))
					{
						if (func_164(PLAYER::PLAYER_ID(), true, false) || func_163() || func_162() > 0 || !func_160() && !func_230())
						{
							MISC::SET_BIT(&iLocal_237, 5);
							func_24();
						}
					}
					else if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_230())
					{
						if (CAM::IS_SCREEN_FADED_IN())
						{
							if (!func_164(PLAYER::PLAYER_ID(), true, false) && !func_163() && func_162() == 0 && func_160() || func_230())
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xFE4D
{
	return uParam0->f_1;
}

BOOL func_160() // Position - 0xFE59
{
	if (func_161() == 0)
		return true;
...
int func_161() // Position - 0xFE6E
{
	return Global_1574633.f_18;
}

int func_162() // Position - 0xFE7C
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_194;
}

BOOL func_163() // Position - 0xFE91
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 0);
}

BOOL func_164(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xFEAA
{
	if (bParam1)
...
BOOL func_165(Player plParam0) // Position - 0xFEDC
{
	return func_166(plParam0);
}

BOOL func_166(Player plParam0) // Position - 0xFEEA
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0xFF01
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_177(PLAYER::PLAYER_ID(), 0) && !func_176() && !func_175(PLAYER::PLAYER_ID()))
			...
			if (bParam1)
			{
				...
				if (!func_171(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
					if (!flag20)
			...
			else
			{
				if (!func_171(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_168(*Global_4718592.f_194133))
...
BOOL func_168(int iParam0) // Position - 0x103B6
{
	return iParam0 == 17;
}

void func_169() // Position - 0x103C3
{
	var unk;
...
void func_170() // Position - 0x10410
{
...
BOOL func_171(Ped pedParam0) // Position - 0x1044E
{
...
void func_172(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x1047F
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x1054F
{
	Hash statName;
...
void func_174() // Position - 0x1056B
{
	eViewModeContext i;
...
BOOL func_175(Player plParam0) // Position - 0x105C3
{
	if (func_177(plParam0, 0))
		return true;
...
BOOL func_176() // Position - 0x10602
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_177(Player plParam0, int iParam1) // Position - 0x10610
{
	BOOL flag;
...
int func_178(int iParam0, BOOL bParam1) // Position - 0x10669
{
	int num;
	int num2;
...
BOOL func_179() // Position - 0x106AA
{
...
BOOL func_180() // Position - 0x106DB
{
	if (Global_101765.f_1496)
		return true;
...
int _GET_ACTIVE_PV_SLOT() // Position - 0x1070F
{
	if (Global_2359296[func_182() /*5571*/].f_681.f_2 >= 547)
	{
		Global_2359296[func_182() /*5571*/].f_681.f_2 = -1;
		return -1;
	}

	return Global_2359296[func_182() /*5571*/].f_681.f_2;
}

int func_182() // Position - 0x10752
{
	int num;
...
BOOL func_183() // Position - 0x1075F
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_184(vehiclePedIsIn, true) || Global_101765.f_1495)
			return true;
	}
...
int func_184(Vehicle veParam0, BOOL bParam1) // Position - 0x1079A
{
	if (Global_79564)
...
BOOL func_185() // Position - 0x107EE
{
	Vehicle vehiclePedIsIn;
...
BOOL func_186(Vehicle veParam0) // Position - 0x1081B
{
	return DECORATOR::DECOR_EXIST_ON(veParam0, "Sprayed_Vehicle_Decorator");
}

int func_187(Vehicle veParam0, BOOL bParam1) // Position - 0x1082D
{
	int value;
	int num;
	int i;
	...
	if (func_192(PLAYER::PLAYER_ID()) && !bParam1)
		return 0;

	if (func_190(PLAYER::PLAYER_ID()) && !bParam1)
		return 0;
...
BOOL func_188(Vehicle veParam0) // Position - 0x10BDB
{
...
BOOL func_189(Hash hParam0, int iParam1) // Position - 0x10C2C
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_190(Player plParam0) // Position - 0x1100B
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1103C
{
	return -1;
}

BOOL func_192(Player plParam0) // Position - 0x11045
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_193(int iParam0) // Position - 0x1108C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_194() // Position - 0x115C1
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

BOOL func_195() // Position - 0x115D6
{
	if (func_196(39) || func_196(40) || func_196(41) || func_196(42) || func_196(43) || func_196(44))
		return true;

	return false;
}

BOOL func_196(int iParam0) // Position - 0x11628
{
	return func_23(iParam0, 20, true);
}

BOOL func_197(Player plParam0) // Position - 0x11639
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_144, 19);
}

void func_198(BOOL bParam0) // Position - 0x1165B
{
	if (bParam0)
		MISC::SET_BIT(&(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144), 20);
	else
		MISC::CLEAR_BIT(&(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144), 20);

	return;
}

BOOL func_199(Player plParam0) // Position - 0x11691
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_144, 20);
}

BOOL func_200(Player plParam0) // Position - 0x116B3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_144, 21);
}

BOOL func_201() // Position - 0x116D5
{
	if (!func_183())
		return false;
...
BOOL func_202() // Position - 0x11702
{
	if (func_203(39) || func_203(40) || func_203(41) || func_203(42) || func_203(43) || func_203(44))
		return true;

	return false;
}

BOOL func_203(int iParam0) // Position - 0x11754
{
	return func_23(iParam0, 6, true);
}

BOOL func_204(char* sParam0) // Position - 0x11764
{
...
BOOL func_205(char* sParam0) // Position - 0x117B5
{
	if (!func_30())
		return false;

	if (Global_1574765 == 11)
		return func_206(sParam0);
...
BOOL func_206(char* sParam0) // Position - 0x117F9
{
	if (!func_30())
		return false;
...
BOOL func_207() // Position - 0x1182B
{
	return Global_1575086;
}

int func_208(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x11837
{
	int i;
	...
	for (i = 0; i <= 61; i = i + 1)
	{
		if (iParam3 == 6 || iParam3 == func_22(i))
		{
			...
			if (func_228(num3))
			{
				distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_209(i, false), true);
...
Vector3 func_209(int iParam0, BOOL bParam1) // Position - 0x118B8
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_225(Global_103877);
	
		case 46:
			if (Global_1845100 != _INVALID_PLAYER_INDEX())
				if (func_224(Global_1845100))
					return func_217(2, 2);
				else if (func_216(Global_1845100))
					return func_217(45, 3);
				else
...
Vector3 func_210() // Position - 0x12032
{
...
int func_211() // Position - 0x1232D
{
	return Global_2652571.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1233C
{
...
int func_213() // Position - 0x12366
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_214(float fParam0, float fParam1, float fParam2) // Position - 0x1237E
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_215(), 0f, fParam0);
}

Vector3 func_215() // Position - 0x12393
{
	return -880f, -2770f, -50f;
}

BOOL func_216(Player plParam0) // Position - 0x123AA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Vector3 func_217(int iParam0, int iParam1) // Position - 0x12402
{
	var unk;
	var unk7;
	...
	if (Global_1845100 != _INVALID_PLAYER_INDEX())
		if (iParam1 == 3)
			if (func_218(iParam0, 1, &unk, 0, false))
				unk7 = { unk };
		else if (iParam1 == 2)
			if (IS_BIT_SET(Global_1845270[Global_1845100 /*892*/].f_268.f_294, 4))
				...
				if (func_218(iParam0, 2, &unk, 0, false))
					unk7 = { unk };

	return unk7;
}

BOOL func_218(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x124AC
{
	var unk;
	Vector3 vector;
	var unk12;
	...
	if (!func_223(iParam3, &unk))
		return false;

	if (!func_223(iParam1, &vector))
		return false;

	if (!bParam4)
		unk12 = { func_221(iParam0) };
	else
		unk12 = { func_220(iParam0) };

	vector2 = { unk12 - unk };
	vector2 = { func_219(vector2, -unk.f_3.f_2) };
	vector2 = { func_219(vector2, vector.f_3.f_2) };
	*uParam2 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vector, 0f, vector2) };
	uParam2->f_3 = { unk12.f_3 };
	return true;
}

Vector3 func_219(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x12541
{
	float num;
	float num2;
	float num3;
...
struct<6> func_220(int iParam0) // Position - 0x12585
{
	var unk;
...
struct<6> func_221(int iParam0) // Position - 0x12709
{
	return func_222(iParam0);
}

struct<6> func_222(int iParam0) // Position - 0x12717
{
	var unk;
...
BOOL func_223(int iParam0, var uParam1) // Position - 0x131DE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_224(Player plParam0) // Position - 0x13260
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Vector3 func_225(int iParam0) // Position - 0x132B8
{
	switch (iParam0)
	{
		case 1:
...
int func_226() // Position - 0x13574
{
	return func_227(PLAYER::PLAYER_ID());
}

int func_227(Player plParam0) // Position - 0x13584
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_228(int iParam0) // Position - 0x135A1
{
	BOOL flag;
...
BOOL func_229(Player plParam0) // Position - 0x1364E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;

	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_144, 18);
}

BOOL func_230() // Position - 0x13670
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x136C2
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x136D5
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x136E2
{
	if (millis == -1)
		return true;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x13740
{
...
BOOL func_235() // Position - 0x13757
{
	if (!_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_239(8, -1) || func_239(15, -1) || func_238() || func_239(3, -1) || HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() || func_164(PLAYER::PLAYER_ID(), true, false) || func_163() || func_194() || func_237() || func_236() || HUD::IS_PAUSE_MENU_ACTIVE())
		return false;

	return true;
}

BOOL func_236() // Position - 0x1380B
{
	return Global_2672942.f_2914.f_582;
}

BOOL func_237() // Position - 0x1381D
{
	return Global_101765.f_400 > 0;
}

BOOL func_238() // Position - 0x1382E
{
	return Global_2625240;
}

BOOL func_239(int iParam0, int iParam1) // Position - 0x1383A
{
	switch (iParam0)
	{
		case 5:
...
void func_240(BOOL bParam0) // Position - 0x13872
{
	if (bParam0)
		MISC::SET_BIT(&(Global_2739945.f_1864), 4);
	else
		MISC::CLEAR_BIT(&(Global_2739945.f_1864), 4);

	return;
}

BOOL func_241() // Position - 0x1389A
{
	return IS_BIT_SET(Global_2739945.f_1864, 4);
}

BOOL func_242(Hash hParam0) // Position - 0x138AB
{
	switch (hParam0)
	{
		case joaat("adder"):
...
BOOL func_243(Vehicle veParam0) // Position - 0x147FA
{
...
BOOL func_244(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x14824
{
	Hash entityModel;
	BOOL flag;
	...
	*uParam2 = 0;
	...
	if (!func_282(entityModel, bParam1, uParam2) && !func_281(PLAYER::PLAYER_ID()) && !func_257(veParam0))
		return false;

	if (func_281(PLAYER::PLAYER_ID()))
		if (func_254(entityModel))
			return true;
		else
			return false;
	...
	if (func_253(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(entityModel) || VEHICLE::IS_THIS_MODEL_A_PLANE(entityModel))
		flag = true;

	if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_250(veParam0) && !flag && !(func_249(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_248(PLAYER::PLAYER_ID())) && !(func_247(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_246(PLAYER::PLAYER_ID())))
	{
		switch (ENTITY::GET_ENTITY_MODEL(veParam0))
		{
			case joaat("cerberus"):
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_245(veParam0) && ENTITY::GET_ENTITY_MODEL(veParam0) != joaat("sentinel2") && ENTITY::GET_ENTITY_MODEL(veParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return false;
		}
...
BOOL func_245(Vehicle veParam0) // Position - 0x149AF
{
	int i;
...
BOOL func_246(Player plParam0) // Position - 0x149EA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 32;

	return false;
}

BOOL func_247(Hash hParam0) // Position - 0x14A31
{
...
BOOL func_248(Player plParam0) // Position - 0x14A48
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_249(Hash hParam0) // Position - 0x14A8F
{
...
BOOL func_250(Vehicle veParam0) // Position - 0x14AD1
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("halftrack"):
...
BOOL func_251(Player plParam0) // Position - 0x14B99
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_252(Player plParam0) // Position - 0x14BE0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_253(Player plParam0) // Position - 0x14C27
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_254(Hash hParam0) // Position - 0x14C6D
{
	BOOL flag;
	...
	if (!func_256(PLAYER::PLAYER_ID()) && hParam0 != joaat("thruster") && hParam0 != joaat("avenger") && hParam0 != func_255(true) && !flag)
		return false;

	return true;
}

Hash func_255(BOOL bParam0) // Position - 0x14CFE
{
	if (bParam0)
...
BOOL func_256(Player plParam0) // Position - 0x14D18
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_257(Vehicle veParam0) // Position - 0x14D3E
{
...
BOOL func_258(Vehicle veParam0) // Position - 0x14D6D
{
	...
	if (func_262(veParam0, false))
		return true;

	if (func_261(PLAYER::PLAYER_ID()) && !func_254(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel1")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel2")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula2")))
		return false;
...
BOOL func_259(Vehicle veParam0) // Position - 0x14ED5
{
	Hash entityModel;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_250(veParam0) || func_260(entityModel))
			return true;
...
BOOL func_260(Hash hParam0) // Position - 0x14F52
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_261(Player plParam0) // Position - 0x14FAE
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_281(plParam0) && Global_2657994[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_262(Vehicle veParam0, BOOL bParam1) // Position - 0x14FE7
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_264(ENTITY::GET_ENTITY_MODEL(veParam0), 0))
				if (Global_2739945.f_307 == veParam0)
					return true;
				else if (func_263(veParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_263(Vehicle veParam0) // Position - 0x15042
{
	int i;
...
BOOL func_264(Hash hParam0, int iParam1) // Position - 0x1507B
{
	if (iParam1 == 0)
		if (func_189(hParam0, 0))
			return true;
...
BOOL func_265() // Position - 0x154FA
{
	return DLC::IS_DLC_PRESENT(joaat("mpsum2"));
}

BOOL func_266() // Position - 0x1550B
{
	return DLC::IS_DLC_PRESENT(joaat("mpsum"));
}

BOOL func_267() // Position - 0x1551C
{
	return DLC::IS_DLC_PRESENT(joaat("mpchristmas2018"));
}

BOOL func_268() // Position - 0x1552D
{
	return DLC::IS_DLC_PRESENT(joaat("mpgunrunning"));
}

BOOL func_269() // Position - 0x1553E
{
	return DLC::IS_DLC_PRESENT(joaat("mpimportexport"));
}

BOOL func_270() // Position - 0x1554F
{
	return DLC::IS_DLC_PRESENT(joaat("mpjanuary2016"));
}

BOOL func_271() // Position - 0x15560
{
	return DLC::IS_DLC_PRESENT(joaat("mplowrider2"));
}

BOOL func_272() // Position - 0x15571
{
	return DLC::IS_DLC_PRESENT(joaat("mplowrider"));
}

BOOL func_273(Vehicle veParam0) // Position - 0x15582
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		if (func_278() || func_277(PLAYER::PLAYER_ID()))
			return false;
	
		if (func_276(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > 0 || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
...
BOOL func_274(Vehicle veParam0) // Position - 0x1567B
{
...
int func_275() // Position - 0x15694
{
	return Global_2359296[func_182() /*5571*/].f_681.f_2;
}

BOOL func_276(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x156AC
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_277(Player plParam0) // Position - 0x15710
{
...
BOOL func_278() // Position - 0x15741
{
	return func_213() != -1;
}

BOOL func_279(Player plParam0) // Position - 0x1574F
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_280(Player plParam0) // Position - 0x157AE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_281(Player plParam0) // Position - 0x1580E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_193(Global_2657994[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_282(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x15855
{
	BOOL flag;
	...
	if (func_253(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(hParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(hParam0))
		flag = true;
...
BOOL func_283(Hash hParam0) // Position - 0x15C46
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_284(char* sParam0, BOOL bParam1) // Position - 0x15C7B
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		return;
...
void func_285() // Position - 0x15CE6
{
	MISC::SET_BIT(&(Global_1574765.f_59), 1);
	return;
}

void func_286(BOOL bParam0) // Position - 0x15CF9
{
	if (bParam0)
	{
...
void func_287() // Position - 0x15D1F
{
...
BOOL func_288(BOOL bParam0) // Position - 0x15D44
{
	int num;
...
int func_289() // Position - 0x15D9E
{
	return iLocal_60;
}

int func_290(int iParam0) // Position - 0x15DA8
{
	return uLocal_139[iParam0 /*3*/];
}

void func_291() // Position - 0x15DB6
{
	func_24();
	func_152(10, false);
	...
	if (!func_288(false))
		if (func_199(PLAYER::PLAYER_ID()) || bLocal_244)
...
void func_292() // Position - 0x15E1C
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_293() // Position - 0x15E28
{
	if (!func_300(1, -1))
		func_298(1, -1);

	if (func_207() && func_18() == 0)
	{
	}
	else
	{
...
BOOL func_294() // Position - 0x15E92
{
...
var func_295(int iParam0) // Position - 0x15EB0
{
	return Global_1574538[iParam0];
}

var func_296() // Position - 0x15EC0
{
	return func_295(func_15() + 1);
}

BOOL func_297(int iParam0) // Position - 0x15ED2
{
	return Global_1929468.f_16[iParam0 /*44*/].f_3;
}

void func_298(int iParam0, int iParam1) // Position - 0x15EE6
{
	int profileSetting;
	int profileSetting2;
	...
	switch (iParam0)
	{
		case 0:
			...
			profileSetting2 = func_299(iParam1);
...
int func_299(int iParam0) // Position - 0x15FC7
{
	int num;
...
BOOL func_300(int iParam0, int iParam1) // Position - 0x1602A
{
	int profileSetting;
	int profileSetting2;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x160D7
{
	switch (func_18())
	{
		case 0:
...
Hash func_303() // Position - 0x1610A
{
...
BOOL func_304() // Position - 0x1612E
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1613D
{
...
BOOL func_306() // Position - 0x16154
{
	return Global_2696433;
}

BOOL func_307() // Position - 0x16160
{
	return Global_2684721.f_695;
}

void func_308() // Position - 0x1616F
{
	SYSTEM::WAIT(0);
	return;
}

void func_309(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1617C
{
...
void func_310() // Position - 0x161C9
{
...
void func_311(int iParam0, int iParam1) // Position - 0x161FC
{
	int profileSetting;
	int profileSetting2;
...
BOOL func_312() // Position - 0x1628D
{
	var unk;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x162EB
{
	int i;
...
BOOL func_314(BOOL bParam0) // Position - 0x16401
{
	bParam0;
	return Global_1575058;
}

void func_315(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x16412
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_292();
...
int func_316(int iParam0) // Position - 0x16431
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_317(func_318(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_317(int iParam0) // Position - 0x16BEF
{
	switch (iParam0)
	{
		case 150:
...
int func_318(int iParam0, BOOL bParam1) // Position - 0x16F29
{
	switch (iParam0)
	{
		case 229:
