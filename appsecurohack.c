...
BOOL func_5(int iParam0, var uParam1, int iParam2) // Position - 0x161
{
...
void func_7() // Position - 0x1E7
{
	...
	unk_0x330108B080A2132F(Global_4546311);
	unk_0x330108B080A2132F(Global_4546310);
	func_9("");
	func_9(&Global_4546312);
	unk_0xE6B753D52F4CA222();
	unk_0x88F483FBD433696A(Global_21047, "DISPLAY_VIEW");
	unk_0x330108B080A2132F(27);
	unk_0xE6B753D52F4CA222();

	if (!IS_BIT_SET(Global_4718592.f_21, 30))
		func_8(Global_21047, "SET_SOFT_KEYS", 3f, 0f, 27f, -1f, -1f, 0, 0, 0, 0, 0);

	return;
}

void func_8(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x262
{
