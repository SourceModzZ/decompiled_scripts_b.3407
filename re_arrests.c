...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x2843
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x2983
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x299F
{
	Hash statHash;
	int outValue;
...
Hash func_24(int iParam0) // Position - 0x29BD
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_25(int iParam0) // Position - 0x29DF
{
	switch (iParam0)
	{
		case 38:
...
int func_26(int iParam0) // Position - 0x29FC
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_27(int iParam0) // Position - 0x2B01
{
	switch (iParam0)
	{
		case 18:
...
void func_28(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2B90
{
	Hash statName;
...
Hash func_29(int iParam0, int iParam1) // Position - 0x2BBE
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_30(iParam1));
}

int func_30(int iParam0) // Position - 0x2BD3
{
	int num;
	int num2;
...
int func_31() // Position - 0x2C07
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2C13
{
	if (iParam2 == -1)
		iParam2 = func_31();
...
void func_33(int iParam0) // Position - 0x2C31
{
	func_54(93, iParam0);
	func_54(29, iParam0);
	func_54(30, iParam0);
...
BOOL func_34(int iParam0) // Position - 0x2C51
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_35(int iParam0, int iParam1) // Position - 0x2E5C
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x2E8B
{
	if (iParam1 == -1)
		iParam1 = func_31();
...
int func_37(BOOL bParam0) // Position - 0x2EA7
{
	var outValue;
	int value;
	int outValue2;
...
int func_38(int iParam0, int iParam1) // Position - 0x2F5E
{
	if (iParam0 >= 78)
		return 0;
...
int func_39(int iParam0, int iParam1) // Position - 0x2F79
{
...
BOOL func_40(var uParam0, int iParam1) // Position - 0x3016
{
	int i;
	var unk;
...
int func_41(var uParam0, int iParam1) // Position - 0x30C7
{
	int i;
...
BOOL func_42(var uParam0, int iParam1) // Position - 0x3142
{
	return uParam0->[iParam1] == 78;
}

void func_43(var uParam0) // Position - 0x3153
{
	int i;
...
void func_44(var uParam0, int iParam1) // Position - 0x3187
{
	uParam0->[iParam1] = 78;
	return;
}

void func_45(var uParam0, int iParam1) // Position - 0x3197
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_46(var uParam0) // Position - 0x31B4
{
	return uParam0->f_80;
}

BOOL func_47(var uParam0, int iParam1) // Position - 0x31C0
{
	return func_48(uParam0, iParam1) != -1;
}

int func_48(var uParam0, int iParam1) // Position - 0x31D2
{
	int i;
...
BOOL func_49(var uParam0) // Position - 0x31FF
{
	return uParam0->f_79 == 1;
}

BOOL func_50(int iParam0) // Position - 0x320D
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_51(int iParam0) // Position - 0x325D
{
	return Global_44199 == iParam0;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x326B
{
...
void func_53(Hash hParam0, int iParam1) // Position - 0x32BC
{
	int outValue;
...
void func_54(int iParam0, int iParam1) // Position - 0x32DF
{
	int outValue;
...
int func_56(eCharacter echParam0) // Position - 0x33B1
{
	return Global_2201[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x33C2
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_58() // Position - 0x33DB
{
...
BOOL func_59(eCharacter echParam0) // Position - 0x34D8
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x34E4
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3521
{
...
Hash func_62(eCharacter echParam0) // Position - 0x3546
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_63() // Position - 0x3555
{
	float xSize;
...
void func_69(var uParam0, int iParam1) // Position - 0x3D2E
{
...
void func_70(int iParam0) // Position - 0x3D4B
{
	if (!PED::IS_PED_INJURED(pedLocal_52))
	{
		ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(pedLocal_52);
...
int func_79(Ped pedParam0, Vehicle veParam1) // Position - 0x42B8
{
	var entityCoords;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4445
{
...
BOOL func_82(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x4493
{
	Global_22443 = 0;
...
BOOL func_85(Player plParam0) // Position - 0x47FB
{
	return func_86(plParam0, 20);
}

BOOL func_86(Player plParam0, int iParam1) // Position - 0x480B
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x4823
{
	return -1;
}

void func_88() // Position - 0x482C
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x49B3
{
	if (func_51(14))
	{
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x4AAD
{
	switch (iParam0)
	{
		case 5:
...
void func_95(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4AE5
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x4B3B
{
...
BOOL func_98(int iParam0) // Position - 0x4B9E
{
	var groundZ;
	var normal;
...
float func_99(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x4BCE
{
	return (fParam0 * fParam3) + (fParam0.f_1 * fParam3.f_1) + (fParam0.f_2 * fParam3.f_2);
}

BOOL func_100() // Position - 0x4BEF
{
	return false;
}

BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x4BF8
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_103(int iParam0) // Position - 0x4CFB
{
	BOOL num;
	int num2;
	Vector3 vector;
...
int func_104(BOOL bParam0) // Position - 0x4DA5
{
	if (func_109())
	{
		Global_114152 = true;
...
void func_105(int iParam0) // Position - 0x4DF8
{
	switch (iParam0)
	{
		case 0:
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x4ED3
{
...
char* func_107(int iParam0) // Position - 0x4EEA
{
	char* str;
...
BOOL func_108(int iParam0) // Position - 0x4F2E
{
	switch (iParam0)
	{
		case 29:
...
int func_110(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x4F93
{
	int i;
...
void func_111(var uParam0, int iParam1) // Position - 0x50CA
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x5119
{
	return func_113(iParam0, Global_44199);
}

BOOL func_113(int iParam0, int iParam1) // Position - 0x512A
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_114(int iParam0) // Position - 0x530B
{
	if (Global_44199 == 15)
		return false;
...
Blip func_116(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x544B
{
	Blip blip;
...
Blip func_117(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5495
{
	Blip blip;
...
var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5539
{
	if (bParam0)
		return uParam1;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x5AAD
{
...
int func_123(float fParam0, BOOL bParam1) // Position - 0x5BAA
{
	var unk;
	int num;
	int num2;
...
void func_124(int iParam0, var uParam1) // Position - 0x5C5B
{
	switch (iParam0)
	{
		case 0:
...
int func_126(int iParam0) // Position - 0x6F33
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_127(int iParam0) // Position - 0x7279
{
	var unk;
	var unk3;
...
struct<2> func_128(int iParam0) // Position - 0x72B1
{
	var unk;
...
BOOL func_132() // Position - 0x7793
{
	return Global_113880 > 0;
}

BOOL func_133() // Position - 0x77A1
{
	if (Global_98610 != -1)
		return true;
...
void func_136(int iParam0) // Position - 0x785F
{
	if (iParam0 == -1)
		iParam0 = func_139();
...
void func_138(int iParam0) // Position - 0x78D2
{
	Global_114151 = iParam0;
	return;
}

int func_139() // Position - 0x78E0
{
	var unk;
	int num;
...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x78FD
{
...
BOOL func_141(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7AD7
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
...
BOOL func_142(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x7E71
{
	if (bParam6)
...
BOOL func_143(eCharacter echParam0) // Position - 0x7EB8
{
	int num;
...
BOOL func_144(int iParam0) // Position - 0x7ED9
{
	return func_145(iParam0, 1);
}

int func_145(int iParam0, int iParam1) // Position - 0x7EE8
{
	var unk;
	var unk2;
	int num;
...
void func_146(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7F3B
{
	func_147(func_158(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_147(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7F59
{
	int num;
	int num2;
	int num3;
...
float func_148(float fParam0, float fParam1, float fParam2) // Position - 0x815D
{
	float num;
...
int func_149(int iParam0, int iParam1) // Position - 0x819F
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_150(int iParam0) // Position - 0x8241
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_151(int iParam0) // Position - 0x8254
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_152(int iParam0) // Position - 0x8267
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_153(int iParam0) // Position - 0x827A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_154(int iParam0) // Position - 0x828C
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_155(BOOL bParam0, var uParam1, var uParam2) // Position - 0x82AE
{
	if (bParam0)
		return uParam1;
...
int func_156(int iParam0) // Position - 0x82C5
{
	return iParam0 & 15;
}

BOOL func_157(int iParam0, int iParam1) // Position - 0x82D2
{
	int num;
	int num2;
...
void func_159(var uParam0, int iParam1) // Position - 0x8424
{
	if (iParam1 <= 0)
		return;
...
void func_160(var uParam0, int iParam1) // Position - 0x84AA
{
...
void func_161(var uParam0, int iParam1) // Position - 0x84DD
{
	int num;
	int num2;
...
void func_162(var uParam0, int iParam1) // Position - 0x852E
{
...
void func_163(var uParam0, int iParam1) // Position - 0x8568
{
...
void func_164(var uParam0, int iParam1) // Position - 0x85A3
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_165(int iParam0) // Position - 0x85DF
{
	int num;
	int num2;
	int num3;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x86BB
{
...
BOOL func_167(int iParam0) // Position - 0x86DB
{
	eCharacter character;
...
BOOL func_168() // Position - 0x8DF8
{
	return Global_101752.f_1;
}

BOOL func_169() // Position - 0x8E06
{
	if (Global_98610 != -1)
...
BOOL func_172() // Position - 0x8E6D
{
	return Global_101765.f_400 > 0;
}

BOOL func_173() // Position - 0x8E7E
{
	return Global_101765.f_399 > 0;
}

BOOL func_174() // Position - 0x8E8F
{
	return Global_1575086;
}

BOOL func_175() // Position - 0x8E9B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_177(int iParam0) // Position - 0x8EDF
{
	return func_157(func_158(), iParam0);
}

BOOL func_178(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x8EF1
{
	BOOL num;
	eCharacter character;
...
int func_179(eCharacter echParam0) // Position - 0x8FD5
{
...
BOOL func_180(int iParam0) // Position - 0x8FF9
{
	int num;
	BOOL flag;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9095
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x90BD
{
	int profileSetting;
...
void func_185(int iParam0) // Position - 0x9304
{
	var name;
...
void func_186(var uParam0) // Position - 0x93B6
{
	if (*uParam0 == -1)
		return;
...
int func_187(int iParam0) // Position - 0x93F3
{
	int num;
...
char* func_188(int iParam0, BOOL bParam1) // Position - 0x94A4
{
	switch (iParam0)
	{
		case 0:
...
void func_189(int iParam0) // Position - 0x96ED
{
	Global_44750 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_190(int iParam0) // Position - 0x96FF
{
	func_191(iParam0, 0, func_196(iParam0));
	return;
}

void func_191(int iParam0, int iParam1, int iParam2) // Position - 0x9714
{
	int unk;
	var unk2;
...
struct<16> func_192(var uParam0) // Position - 0x9743
{
	var unk;
	int num;
...
void func_193(int iParam0, var uParam1) // Position - 0x9814
{
	Global_114162.f_24999.f_43[iParam0] = *uParam1;
	return;
}

void func_194(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x982C
{
	int num;
	int i;
	int num2;
...
void func_195(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x99AE
{
...
int func_196(int iParam0) // Position - 0x99E6
{
	int num;
...
void func_199() // Position - 0x9BD3
{
	func_200();
	return;
}

int func_200() // Position - 0x9BE0
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		return 0;
...
void func_201(int iParam0, int iParam1) // Position - 0x9C2B
{
	if (iParam0 == -1)
		iParam0 = func_139();
...
void func_202(int iParam0, var uParam1, var uParam2) // Position - 0x9D2F
{
	BOOL flag;
...
int func_204() // Position - 0xA2D3
{
	return Global_33105;
}

int func_205(int iParam0, int iParam1) // Position - 0xA2DE
{
	switch (iParam0)
	{
		case 0:
...
void func_206(int iParam0) // Position - 0xA652
{
	int offset;
	int i;
...
void func_207(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xA694
{
	func_208(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_208(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA6B6
{
	int i;
...
BOOL func_210(int iParam0) // Position - 0xA9A1
{
	int num;
	int i;
...
void func_211(int iParam0, int iParam1) // Position - 0xA9E1
{
	MISC::SET_BIT(&Global_114162.f_24999.f_8[iParam0], iParam1);
	return;
}

int func_212() // Position - 0xA9FC
{
	return 1;
}

void func_213(int iParam0) // Position - 0xAA05
{
	Global_114148 = iParam0;
	return;
}

void func_214() // Position - 0xAA13
{
