	...
	while (true)
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (!func_28() || func_25(PLAYER::PLAYER_ID(), 0))
				if (!Global_1836283 && !func_24(3) && !func_21(PLAYER::PLAYER_ID(), 0) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && !func_19(PLAYER::PLAYER_ID()) && !func_17(func_18(PLAYER::PLAYER_ID())) && !func_15(PLAYER::PLAYER_ID(), 146) && !func_10(PLAYER::PLAYER_ID()))
					if (func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 4, 100, false))
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
							if (PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()))
								if (!func_8(&(iLocal_139.f_1)))
									func_5(&(iLocal_139.f_1));
								else if (func_2(&(iLocal_139.f_1)) > 20f)
								...
								PLAYER::REPORT_POLICE_SPOTTED_PLAYER(PLAYER::PLAYER_ID());
						else if (func_8(&(iLocal_139.f_1)))
							func_1(&(iLocal_139.f_1));
		}
		else
		{
			func_43();
...
float func_2(int* piParam0) // Position - 0x25C
{
	if (func_8(piParam0))
		if (func_4(piParam0))
			return piParam0->f_2;
...
BOOL func_4(int* piParam0) // Position - 0x2F0
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_5(int* piParam0) // Position - 0x2FD
{
	if (!func_8(piParam0))
		func_6(piParam0);
...
void func_6(int* piParam0) // Position - 0x315
{
	func_7(piParam0, 0f);
	return;
}

void func_7(int* piParam0, float fParam1) // Position - 0x324
{
...
BOOL func_8(int* piParam0) // Position - 0x34F
{
	return IS_BIT_SET(*piParam0, 1);
}

BOOL func_9(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x35C
{
	var unk;
	var unk47;
	var unk93;
...
BOOL func_10(Player plParam0) // Position - 0x10B0
{
	return func_11(func_12(plParam0));
}

BOOL func_11(int iParam0) // Position - 0x10C2
{
	switch (iParam0)
	{
		case 167:
...
int func_12(Player plParam0) // Position - 0x10E8
{
	if (func_14(plParam0))
...
BOOL func_13(Player plParam0, BOOL bParam1) // Position - 0x1114
{
	if (func_14(plParam0))
...
BOOL func_14(Player plParam0) // Position - 0x1158
{
	Player player;
...
BOOL func_15(Player plParam0, int iParam1) // Position - 0x117A
{
...
BOOL func_16(Player plParam0) // Position - 0x119A
{
	Player player;
...
BOOL func_17(int iParam0) // Position - 0x11BD
{
	switch (iParam0)
	{
		case 136:
...
int func_18(Player plParam0) // Position - 0x11FB
{
	Player player;
...
BOOL func_19(Player plParam0) // Position - 0x121A
{
...
BOOL func_21(Player plParam0, int iParam1) // Position - 0x1267
{
	BOOL flag;
...
BOOL func_25(Player plParam0, int iParam1) // Position - 0x131C
{
	Player player;
...
BOOL func_26(Player plParam0) // Position - 0x1355
{
	if (!func_14(plParam0))
		return false;
...
BOOL func_28() // Position - 0x137F
{
	...
	if (Global_1845270[PLAYER::PLAYER_ID() /*892*/] == -1)
		return false;

	return true;
}

BOOL func_29() // Position - 0x13B7
{
	BOOL num;
...
BOOL func_30() // Position - 0x13DF
{
	switch (iLocal_139)
	{
		case 0:
			if (Global_1836283 || func_24(3))
				iLocal_139.f_4 = PED::ADD_SCENARIO_BLOCKING_AREA(1413.7028f, 2341.5168f, -232.3945f, 2016.2095f, 2998.893f, 161.0299f, false, true, true, true, 1);
		
			func_31(&uLocal_106[NETWORK::PARTICIPANT_ID_TO_INT()], 1);
			iLocal_139 = 1;
			break;
		...
		case 2:
			if (Global_1836283 || func_24(3))
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_139.f_4, false);
...
void func_32(var uParam0, int iParam1) // Position - 0x14AE
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_33() // Position - 0x14BF
{
	switch (iLocal_104)
	{
		case 0:
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x153C
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x15C0
{
	switch (func_27())
	{
		case 0:
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1626
{
...
void func_45(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x167D
{
	func_51(func_52(uParam0), uParam0);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_104, 2, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_106, 33, 0);
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x1728
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1786
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x17CB
{
	int i;
...
BOOL func_50(BOOL bParam0) // Position - 0x18E1
{
	bParam0;
	return Global_1575058;
}

void func_51(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x18F2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_44();
...
int func_52(int iParam0) // Position - 0x1911
{
	switch (iParam0)
	{
		case 3:
...
int func_53(int iParam0) // Position - 0x20CF
{
	switch (iParam0)
	{
		case 150:
...
int func_54(int iParam0, BOOL bParam1) // Position - 0x2409
{
	switch (iParam0)
	{
		case 229:
