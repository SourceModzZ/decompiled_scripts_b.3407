	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A25
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28D0
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2958
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x489F
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5620
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x565B
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58CF
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E5A
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B01
{
	int i;
...
int func_97() // Position - 0x8869
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8879
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8896
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88A6
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BE9
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8BFA
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C40
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CC6
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CF9
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D4A
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DEC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E0E
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E25
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E32
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E6C
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EA7
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EE3
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8EFC
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F5F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F75
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F8B
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FCD
{
...
struct<2> func_119(int iParam0) // Position - 0x8FF5
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9442
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA71A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA60
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB05
{
	var name;
...
void func_125(int iParam0) // Position - 0xABA0
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xABFE
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC57
{
...
int func_129(Ped pedParam0) // Position - 0xACDA
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD0B
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD20
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADD3
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADEE
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE3A
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE83
{
...
BOOL func_138(int iParam0) // Position - 0xAEC4
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAF94
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFE7
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0DD
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB148
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB187
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2D6
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2F0
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB349
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB38A
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB3AC
{
...
BOOL func_150() // Position - 0xB3EB
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3F9
{
	int num;
...
void func_153(int iParam0) // Position - 0xB453
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB476
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5A9
{
...
void func_161(Vehicle veParam0) // Position - 0xB600
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB62C
{
...
void func_164(int iParam0) // Position - 0xB7CE
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB801
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB88B
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB8FF
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB90D
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB964
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB973
{
...
BOOL func_171(int iParam0) // Position - 0xB9B4
{
	int num;
...
void func_172(int iParam0) // Position - 0xB9F9
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA2B
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB62
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBB1
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBBC2
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBDA3
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBDC5
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDD6
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE1F
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE43
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC627
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC642
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6D0
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC734
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC7CB
{
...
BOOL func_187(int iParam0) // Position - 0xC7F5
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_195() || Global_113209 || Global_33108 || func_194() || func_193(8, -1) || func_101() || func_192() || func_191() || func_190() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_195() || Global_33108 || func_194() || func_193(8, -1) || func_191() || func_101() || func_192() || func_190() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_195() || Global_113209 || Global_33108 || func_194() || func_193(8, -1) || func_191() || func_101() || func_192() || func_190() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_195() || Global_113209 || Global_33108 || func_194() || func_193(8, -1) || func_101() || func_192() || func_190() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_195() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_193(8, -1) || func_190() || func_189() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_195() || Global_33108 || func_194() || func_193(8, -1) || func_192() || func_191() || func_190() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_195() || func_192() || Global_113209 || Global_33108 || func_194() || Global_45410 || func_193(8, -1) || func_191() || func_189() || func_190() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_195() || Global_113209 || Global_33108 || func_194() || func_193(8, -1) || func_191() || func_189() || func_101() || func_192() || func_190())
							return false;
						break;
				}
			}
...
BOOL func_188() // Position - 0xCF12
{
	return Global_101752.f_1;
}

BOOL func_189() // Position - 0xCF20
{
	if (Global_98610 != -1)
...
BOOL func_192() // Position - 0xCF87
{
	return Global_101765.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCF98
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCFD0
{
	return Global_1575086;
}

BOOL func_195() // Position - 0xCFDC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_196(var uParam0) // Position - 0xCFF8
{
	float num;
...
float func_197(int* piParam0) // Position - 0xDDA9
{
...
float func_198(BOOL bParam0) // Position - 0xDDE5
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_199(int* piParam0) // Position - 0xDE3D
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_200(int* piParam0) // Position - 0xDE4A
{
	func_201(piParam0, 0f);
	return;
}

void func_201(int* piParam0, float fParam1) // Position - 0xDE59
{
...
void func_202(int* piParam0) // Position - 0xDE84
{
	if (!func_203(piParam0))
		func_200(piParam0);
...
BOOL func_203(int* piParam0) // Position - 0xDE9C
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_204(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xDEA9
{
...
int func_205(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xDEFD
{
	Global_22443 = 0;
...
BOOL func_208(Player plParam0) // Position - 0xE265
{
	return func_209(plParam0, 20);
}

BOOL func_209(Player plParam0, int iParam1) // Position - 0xE275
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_210() // Position - 0xE28D
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xE3ED
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_215(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4E7
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE53D
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xE58B
{
...
void func_218(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE626
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xE717
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xE753
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xE78C
{
	BOOL flag;
	int i;
...
float func_222(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE82A
{
...
BOOL func_223() // Position - 0xE864
{
	return Global_98997;
}

void func_224(var uParam0) // Position - 0xE870
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_225(uParam0);
...
void func_225(var uParam0) // Position - 0xE887
{
	BOOL flag;
	int num;
	int i;
...
void func_226(int iParam0) // Position - 0xE96F
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE997
{
	var unk;
	...
	if (func_264(*panParam0) || func_262(*panParam0) || Global_79810 == 1)
		return true;
...
void func_228(Ped pedParam0, var uParam1, int iParam2) // Position - 0xEC07
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_229(int iParam0) // Position - 0xEF5F
{
...
BOOL func_230(var uParam0) // Position - 0xEF7F
{
...
BOOL func_231(var uParam0) // Position - 0xEF97
{
...
void func_232(var uParam0) // Position - 0xEFBC
{
	int i;
	int taskSequenceId;
...
void func_233(Object* pobParam0) // Position - 0xF2C0
{
...
void func_234(var uParam0) // Position - 0xF2EB
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF36B
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_236(Ped pedParam0, Vehicle veParam1) // Position - 0xF529
{
...
BOOL func_237(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF559
{
	int i;
	int num;
...
BOOL func_238(int iParam0) // Position - 0xF815
{
...
BOOL func_239(Ped pedParam0, int iParam1) // Position - 0xF849
{
	float xSize;
...
BOOL func_240(Ped pedParam0, int iParam1) // Position - 0xF8BF
{
	return func_241(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_241(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF8D7
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_242(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF998
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_243(Ped pedParam0, int iParam1) // Position - 0xFAC4
{
...
BOOL func_245(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xFBD3
{
	var unk;
...
float func_246(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xFC64
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_247(float fParam0, var uParam1, var uParam2) // Position - 0xFC85
{
	float num;
	float num2;
...
void func_248(var uParam0) // Position - 0xFCC4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_249(Ped pedParam0, Ped pedParam1) // Position - 0xFCDF
{
	int i;
...
BOOL func_250(Ped pedParam0) // Position - 0xFD1E
{
...
BOOL func_251(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFD46
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_252(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFE41
{
	float entityCoords;
	float num;
...
BOOL func_253(Ped pedParam0, float fParam1) // Position - 0xFF4D
{
	var outProjectile;
	var outCoords;
...
BOOL func_254(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFFE2
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_255(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x10073
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_256(int iParam0) // Position - 0x100BB
{
...
void func_257(Vehicle veParam0) // Position - 0x10105
{
	int taskSequenceId;
...
BOOL func_258(int iParam0) // Position - 0x101A2
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_259(int iParam0) // Position - 0x10237
{
...
BOOL func_260() // Position - 0x10276
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_261() // Position - 0x10293
{
	if (Global_98610 != -1)
...
BOOL func_262(int iParam0) // Position - 0x102B6
{
	if (func_263() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_263() // Position - 0x102EA
{
...
BOOL func_264(int iParam0) // Position - 0x10328
{
...
BOOL func_265(var uParam0) // Position - 0x10350
{
	if (!func_266(uParam0))
		return false;
...
BOOL func_266(var uParam0) // Position - 0x103A5
{
	BOOL flag;
	int taskSequenceId;
...
BOOL func_267(int iParam0) // Position - 0x1065B
{
	int i;
...
BOOL func_268(int iParam0) // Position - 0x106C3
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x10714
{
	const char* string2;
...
BOOL func_270(int iParam0) // Position - 0x107CD
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x1088E
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_272(int iParam0, char* sParam1) // Position - 0x10913
{
...
BOOL func_273(int iParam0) // Position - 0x109F5
{
...
BOOL func_274(int iParam0) // Position - 0x10A20
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10A4B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x10A76
{
	if (func_259(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10AAB
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10B10
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10B88
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x10C03
{
	func_293();
...
void func_281(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10CD7
{
...
void func_282(var uParam0, BOOL bParam1) // Position - 0x10CF7
{
	func_283(&(uParam0->f_41), bParam1);
	return;
}

void func_283(var uParam0, BOOL bParam1) // Position - 0x10D09
{
	int i;
...
void func_284(Object* pobParam0, BOOL bParam1) // Position - 0x10D47
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x10D82
{
	func_286(&(uParam0->f_35), bParam1);
	return;
}

void func_286(var uParam0, BOOL bParam1) // Position - 0x10D94
{
	int i;
...
void func_287(Vehicle* pveParam0) // Position - 0x10DD1
{
...
void func_288(Vehicle* pveParam0) // Position - 0x10E09
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_289(var uParam0, int iParam1) // Position - 0x10EA5
{
	func_290(&(uParam0->f_28), iParam1);
	return;
}

void func_290(var uParam0, int iParam1) // Position - 0x10EB7
{
	int i;
...
void func_291(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10EF8
{
...
void func_292(Ped* ppedParam0) // Position - 0x10F48
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_293() // Position - 0x10F89
{
	Global_21308 = 0;
	func_294();
	return;
...
void func_294() // Position - 0x10F99
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
void func_295(int iParam0) // Position - 0x10FBA
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x10FF7
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x11009
{
	*uParam0 = -1;
