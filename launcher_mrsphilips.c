	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_271(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19BA
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2865
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28ED
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4830
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55B1
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55EC
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5860
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DEB
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A92
{
	int i;
...
int func_97() // Position - 0x87FB
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x880B
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8828
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8838
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B7B
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8B8C
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BD2
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8C58
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C8B
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8CDC
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D7E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DA0
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8DB7
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8DC4
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DFE
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E39
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E75
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E8E
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8EF1
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F07
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F1D
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F5E
{
...
struct<2> func_119(int iParam0) // Position - 0x8F86
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x93D2
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA618
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA95E
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAA03
{
	var name;
...
void func_125(int iParam0) // Position - 0xAA9E
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAAFC
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB55
{
...
int func_129(Ped pedParam0) // Position - 0xABD8
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC09
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC1E
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xACD1
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xACEC
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAD38
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAD81
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xADA1
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xADC2
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAE92
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAEE5
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAFDB
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB046
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB085
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB1D4
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB1EE
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB247
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB288
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB2AA
{
...
BOOL func_150() // Position - 0xB2E9
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB2F7
{
	int num;
...
void func_153(int iParam0) // Position - 0xB351
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB374
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB418
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4A7
{
...
void func_161(Vehicle veParam0) // Position - 0xB4FE
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB52A
{
...
void func_164(int iParam0) // Position - 0xB6CC
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB6FF
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB789
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB7FD
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB80B
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB862
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB871
{
...
BOOL func_171(int iParam0) // Position - 0xB8B2
{
	int num;
...
void func_172(int iParam0) // Position - 0xB8F7
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB929
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA60
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAAF
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBAC0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBCA1
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBCC3
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBCD4
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD1D
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD41
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC524
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC53F
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC5CD
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC631
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC6C8
{
...
BOOL func_187(int iParam0) // Position - 0xC6F2
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCE0F
{
	return Global_101752.f_1;
}

BOOL func_189() // Position - 0xCE1D
{
	if (Global_98610 != -1)
...
BOOL func_192() // Position - 0xCE84
{
	return Global_101765.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCE95
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCECD
{
	return Global_1575086;
}

BOOL func_195() // Position - 0xCED9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCEF5
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xCFE6
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xD022
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xD05B
{
	BOOL flag;
	int i;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD0F9
{
...
BOOL func_201() // Position - 0xD133
{
	return Global_98997;
}

void func_202(var uParam0) // Position - 0xD13F
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD156
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD23E
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD266
{
	var unk;
...
void func_206(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD4D6
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_207(int iParam0) // Position - 0xD82E
{
...
BOOL func_208(var uParam0) // Position - 0xD84E
{
...
BOOL func_209(var uParam0) // Position - 0xD866
{
...
void func_210(var uParam0) // Position - 0xD88B
{
	int i;
	int taskSequenceId;
...
void func_211(Object* pobParam0) // Position - 0xDB8F
{
...
void func_212(var uParam0) // Position - 0xDBBA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC3A
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_214(Ped pedParam0, Vehicle veParam1) // Position - 0xDDF8
{
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDE28
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE0E4
{
...
BOOL func_217(Ped pedParam0, int iParam1) // Position - 0xE118
{
	float xSize;
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE18E
{
	return func_219(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_219(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE1A6
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_220(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE267
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_221(Ped pedParam0, int iParam1) // Position - 0xE393
{
...
BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE4A2
{
	var unk;
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE533
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE554
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE593
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(Ped pedParam0, Ped pedParam1) // Position - 0xE5AE
{
	int i;
...
BOOL func_228(Ped pedParam0) // Position - 0xE5ED
{
...
BOOL func_229(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE615
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE710
{
	float entityCoords;
	float num;
...
BOOL func_231(Ped pedParam0, float fParam1) // Position - 0xE81C
{
	var outProjectile;
	var outCoords;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8B1
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_233(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE93F
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_234(int iParam0) // Position - 0xE987
{
...
void func_235(Vehicle veParam0) // Position - 0xE9D1
{
	int taskSequenceId;
...
BOOL func_236(int iParam0) // Position - 0xEA6E
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEB03
{
...
BOOL func_240(int iParam0) // Position - 0xEB82
{
...
BOOL func_242(int iParam0) // Position - 0xEBF4
{
...
void func_243(var uParam0) // Position - 0xEC1C
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_244(var uParam0) // Position - 0xEC49
{
	uParam0->f_16 = 5;
...
BOOL func_245(int iParam0) // Position - 0xEC9E
{
	var unk;
	eCharacter character;
...
BOOL func_246(int iParam0) // Position - 0xECEF
{
	const char* string2;
...
BOOL func_247(int iParam0) // Position - 0xEDA8
{
	var unk;
...
BOOL func_248(int iParam0) // Position - 0xEE69
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_249(int iParam0, char* sParam1) // Position - 0xEEEE
{
...
BOOL func_250(int iParam0) // Position - 0xEFCE
{
...
BOOL func_251(int iParam0) // Position - 0xEFF9
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_252(int iParam0) // Position - 0xF024
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_253(int iParam0) // Position - 0xF04F
{
	if (func_237(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF09E
{
	int i;
...
BOOL func_256(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF103
{
	int num;
	char* str;
...
BOOL func_257(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF17B
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_258(var uParam0, BOOL bParam1) // Position - 0xF1F6
{
	if (bParam1)
	{
...
void func_259(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF24A
{
...
void func_260(var uParam0, BOOL bParam1) // Position - 0xF26A
{
	func_261(&(uParam0->f_41), bParam1);
	return;
}

void func_261(var uParam0, BOOL bParam1) // Position - 0xF27C
{
	int i;
...
void func_262(Object* pobParam0, BOOL bParam1) // Position - 0xF2BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_263(var uParam0, BOOL bParam1) // Position - 0xF2F5
{
	func_264(&(uParam0->f_35), bParam1);
	return;
}

void func_264(var uParam0, BOOL bParam1) // Position - 0xF307
{
	int i;
...
void func_265(Vehicle* pveParam0) // Position - 0xF344
{
...
void func_266(Vehicle* pveParam0) // Position - 0xF37C
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_267(var uParam0, int iParam1) // Position - 0xF418
{
	func_268(&(uParam0->f_28), iParam1);
	return;
}

void func_268(var uParam0, int iParam1) // Position - 0xF42A
{
	int i;
...
void func_269(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF46B
{
...
void func_270(Ped* ppedParam0) // Position - 0xF4BB
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_271(int iParam0) // Position - 0xF4FC
{
	if (*iParam0 == -1)
		return;
...
void func_272(char* sParam0) // Position - 0xF539
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_273(var uParam0) // Position - 0xF54B
{
	*uParam0 = -1;
