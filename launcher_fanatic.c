...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_283(&unk64, &num, unk61, 1f))
	{
		func_282();
	...
	while (true)
	{
		...
		func_218(num);
		func_211(&iLocal_92, &(num.f_9), unk61);
			...
			if (num == 22)
			{
				if (unk_0xB3FA103AA6383C28())
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[1]))
					{
						...
						unk_0x2F19C4305F0B8DA7("MaryAnnes_Friend", num.f_28[1], 0);
		...
		if (num == 21)
			func_207(&num, unk61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_202(&num, unk61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_207(&num, unk61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_199(&num);
...
void func_3(int iParam0, var uParam1) // Position - 0x3BA
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xC3C
{
	var unk;
...
void func_21(var uParam0) // Position - 0xD33
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xD63
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1A3C
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28E7
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x296F
{
...
BOOL func_29(var uParam0) // Position - 0x29AF
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x29DD
{
...
int func_31(var uParam0) // Position - 0x2AB9
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2AFB
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2B5E
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2BEC
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E96
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34B5
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35E4
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x372B
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3768
{
...
int func_47(eCharacter echParam0) // Position - 0x378D
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x379C
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3965
{
...
var func_54(int iParam0, int iParam1) // Position - 0x39DE
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39F3
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F3C
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x42A2
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x4395
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x48B6
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x5637
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5672
{
	int num;
...
void func_67(int iParam0) // Position - 0x58E6
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5922
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E71
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5EB5
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6634
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x667B
{
...
BOOL func_73(int iParam0) // Position - 0x66D6
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66E6
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6746
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AFD
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6B08
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B18
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BBA
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7334
{
...
int func_81() // Position - 0x762F
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x763E
{
...
int func_83() // Position - 0x7668
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7680
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7695
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x76AC
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7704
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77AE
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7843
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7887
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A0B
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A19
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x84E2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8564
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85BC
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85C5
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x884C
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x885C
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8879
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8889
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BCC
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8BDD
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C23
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CA9
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CDC
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D2D
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DCF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DF1
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E08
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E15
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E4F
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E8A
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EC6
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8EDF
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8F42
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8F58
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8F6E
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FB0
{
...
struct<2> func_119(int iParam0) // Position - 0x8FD8
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9425
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6FD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA43
{
	int num;
...
void func_124(int iParam0) // Position - 0xAAE8
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAB83
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xABE1
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC3A
{
...
int func_129(int iParam0) // Position - 0xACBD
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACEE
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD03
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADB6
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADD1
{
	int i;
...
int func_135(int iParam0) // Position - 0xAE1D
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAE66
{
...
BOOL func_137(int iParam0) // Position - 0xAE86
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAF56
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAFA9
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB09F
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB10A
{
	var unk;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB149
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB298
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_145(int iParam0, int iParam1) // Position - 0xB2B2
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB30B
{
	int num;
	int num2;
...
BOOL func_147(int iParam0) // Position - 0xB34C
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB36E
{
...
BOOL func_149() // Position - 0xB3AD
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB3BB
{
	int num;
...
void func_152(int iParam0) // Position - 0xB415
{
	if (iParam0 == 1)
...
BOOL func_153(var uParam0) // Position - 0xB438
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4DC
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB56B
{
...
void func_160(var uParam0) // Position - 0xB5C2
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB5EE
{
...
void func_163(int iParam0) // Position - 0xB790
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB7C3
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB84D
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB8C1
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_167(int iParam0) // Position - 0xB8CF
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB926
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_169(int iParam0) // Position - 0xB935
{
...
BOOL func_170(int iParam0) // Position - 0xB976
{
	int num;
...
void func_171(int iParam0) // Position - 0xB9BB
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9ED
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB24
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB73
{
	return func_175(iParam0, Global_44181);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBB84
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD65
{
	if (Global_44181 == 15)
		return false;
...
int func_177() // Position - 0xBD87
{
	return func_178(unk_0x1AF90EB93E0012D6(), 0);
}

int func_178(var uParam0, int iParam1) // Position - 0xBD98
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDE1
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE05
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC277
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2A3
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2BA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC349
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_185() // Position - 0xCB2C
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_186(var uParam0) // Position - 0xCB47
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCBD5
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC39
{
	var unk;
...
BOOL func_189(var uParam0) // Position - 0xCCD0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_190(int iParam0) // Position - 0xCCFA
{
	eCharacter character;
...
BOOL func_191() // Position - 0xD417
{
	return Global_101727.f_1;
}

BOOL func_192() // Position - 0xD425
{
	if (Global_98585 != -1)
...
BOOL func_195() // Position - 0xD48C
{
	return Global_101740.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD49D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD4D5
{
	return Global_1575084;
}

BOOL func_198() // Position - 0xD4E1
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_199(var uParam0) // Position - 0xD4FD
{
	if (iLocal_95 == -1)
		iLocal_95 = unk_0x1DD05E817C89C737();

	if (unk_0x1DD05E817C89C737() - iLocal_95 >= 900)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				func_200(uParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6, 0);
				iLocal_95 = unk_0x1DD05E817C89C737();
			}
		}
	}
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xD54E
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam3), iParam4);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD568
{
	char* str;
...
int func_202(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD75D
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_206(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD7E5
{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD820
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD876
{
...
float func_206(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD911
{
	var unk;
...
BOOL func_207(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD94B
{
	var unk;
	...
	if (func_190(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_206(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_208(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
				if (func_206(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_154();
		}
	}
...
BOOL func_208(char* sParam0) // Position - 0xDA0D
{
	var unk;
...
struct<6> func_209() // Position - 0xDA2D
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDA51
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
void func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDA72
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_206(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_214(uParam0, 1);
			}
			else
			{
				...
				if (func_206(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_216(uParam0);
			}
		}
	}
...
void func_212(int iParam0, BOOL bParam1) // Position - 0xDB63
{
	if (iParam0 == -1)
		return;
...
int func_213(int iParam0) // Position - 0xDB9F
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_214(var uParam0, int iParam1) // Position - 0xDBD8
{
	BOOL flag;
	int i;
...
BOOL func_215() // Position - 0xDC76
{
	return Global_98972;
}

void func_216(var uParam0) // Position - 0xDC82
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_217(uParam0);
...
void func_217(var uParam0) // Position - 0xDC99
{
	BOOL flag;
	int num;
	int i;
...
void func_218(int iParam0) // Position - 0xDD81
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDDA9
{
	var unk;
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_79785 == 1)
		return true;
...
void func_220(int iParam0, var uParam1, int iParam2) // Position - 0xE019
{
	var unk;
	var unk2;
...
BOOL func_221(int iParam0) // Position - 0xE371
{
...
BOOL func_222(var uParam0) // Position - 0xE391
{
...
BOOL func_223(var uParam0) // Position - 0xE3A9
{
...
void func_224(var uParam0) // Position - 0xE3CE
{
	int i;
	var unk;
...
void func_225(var uParam0) // Position - 0xE6D2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_226(var uParam0) // Position - 0xE6FD
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE77D
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_228(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_228(var uParam0, var uParam1) // Position - 0xE93B
{
	var unk;
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE96B
{
	int i;
	int num;
...
BOOL func_230(int iParam0) // Position - 0xEC27
{
...
BOOL func_231(var uParam0, int iParam1) // Position - 0xEC5B
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_242(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_232(var uParam0, int iParam1) // Position - 0xECD1
{
	return func_233(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_233(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xECE9
{
	BOOL flag;
	var unk;
	int num;

	num = func_241(uParam0, uParam1);
	...
	if (!func_237(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_234(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xEDAA
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_235(var uParam0, int iParam1) // Position - 0xEED6
{
	int num;
...
BOOL func_237(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xEFE5
{
	var unk;
	var unk4;
	float num;

	unk = { func_239(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_239(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_238(unk4, unk);
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF076
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xF097
{
	float num;
	float num2;
...
void func_240(var uParam0) // Position - 0xF0D6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(var uParam0, var uParam1) // Position - 0xF0F1
{
	int i;
...
int func_242(var uParam0) // Position - 0xF130
{
...
BOOL func_243(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF158
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_247(uParam0, bParam1, num, num2))
				return true;
		
			if (func_244(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_244(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF253
{
	float num;
	float num2;
...
BOOL func_245(var uParam0, float fParam1) // Position - 0xF35F
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_246(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_246(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF3F4
{
	var unk;
	var unk4;
	float num;

	unk = { func_239(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_247(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF482
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_248(int iParam0) // Position - 0xF4CA
{
...
void func_249(var uParam0) // Position - 0xF514
{
	var unk;
...
BOOL func_250(int iParam0) // Position - 0xF5B1
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_251(int iParam0) // Position - 0xF646
{
...
BOOL func_254(int iParam0) // Position - 0xF6C5
{
	if (func_255() && Global_101688.f_11 == 6 && iParam0 == func_178(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_255() // Position - 0xF6F9
{
...
BOOL func_256(int iParam0) // Position - 0xF737
{
...
BOOL func_257(var uParam0) // Position - 0xF75F
{
	switch (*uParam0)
	{
		case 21:
...
BOOL func_259(var uParam0) // Position - 0xF813
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				unk6 = { -916.6389f, 6137.046f, 4.7157f };
				uParam0->f_41[0] = unk_0x4E55EAB577C13329(num[1], unk6, 1, 1, 0);
			...
			{
				unk6 = { -917.7f, 6138.89f, 4.72f };
				unk_0xB1EAADCB692D69CE(unk6, &(unk6.f_2), 0, 0);
				uParam0->f_41[1] = unk_0x4E55EAB577C13329(num[2], unk6, 1, 1, 0);
			...
			{
				unk6 = { -915.6122f, 6137.662f, 4.6129f };
				uParam0->f_41[2] = unk_0x4E55EAB577C13329(num[3], unk6, 1, 1, 0);
			...
			{
				unk6 = { -915.4199f, 6137.8555f, 4.6221f };
				uParam0->f_41[3] = unk_0x4E55EAB577C13329(num[4], unk6, 1, 1, 0);
				unk_0x62C438C53BB57AFD(uParam0->f_41[3], -915.4199f, 6137.8555f, 4.6221f, 0, 0, 1);
...
BOOL func_260(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFBD3
{
	if (func_261(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_261(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFC2F
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_305(echParam1);
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0xFCBD
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xFD03
{
	if (func_223(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0xFD2D
{
	int i;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xFD5E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Position - 0xFD9A
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_270(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
...
void func_268(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x100E1
{
	func_269(uParam0);
...
void func_269(var uParam0) // Position - 0x10124
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_270(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x101C0
{
	func_271(uParam0);
...
void func_271(var uParam0) // Position - 0x101E1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_272(var uParam0) // Position - 0x10222
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_273(int iParam0) // Position - 0x1037D
{
	var unk;
	eCharacter character;
...
BOOL func_274(int iParam0) // Position - 0x103CE
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x10487
{
	var unk;
...
BOOL func_276(int iParam0) // Position - 0x10548
{
	int i;
	var unk;
	int num;
...
BOOL func_277(int iParam0, char* sParam1) // Position - 0x105CD
{
...
BOOL func_278(int iParam0) // Position - 0x106AF
{
...
BOOL func_279(int iParam0) // Position - 0x106DA
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10705
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10730
{
	if (func_251(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_282() // Position - 0x10765
{
...
BOOL func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1077F
{
	int i;
...
BOOL func_284(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x107E4
{
	int num;
	char* str;
...
BOOL func_285(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1085C
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x108D7
{
	char* str;
	...
	if (unk_0xC450B06E5AAA0985(uLocal_96))
		unk_0xFE54B8568B2ABD12(&uLocal_96);
...
void func_287(char* sParam0) // Position - 0x1097B
{
...
void func_288() // Position - 0x1099A
{
	Global_21291 = 0;
	func_289();
	return;
...
void func_289() // Position - 0x109AA
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
int func_290(var uParam0) // Position - 0x109CB
{
	if (func_223(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_291(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10A01
{
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x10A21
{
	func_293(&(uParam0->f_41), bParam1);
	return;
}

void func_293(var uParam0, BOOL bParam1) // Position - 0x10A33
{
	int i;
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x10A71
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_295(var uParam0, BOOL bParam1) // Position - 0x10AAC
{
	func_296(&(uParam0->f_35), bParam1);
	return;
}

void func_296(var uParam0, BOOL bParam1) // Position - 0x10ABE
{
	int i;
...
void func_297(var uParam0) // Position - 0x10AFB
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_298(var uParam0, int iParam1) // Position - 0x10B33
{
	func_299(&(uParam0->f_28), iParam1);
	return;
}

void func_299(var uParam0, int iParam1) // Position - 0x10B45
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_300(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_300(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10B86
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_301(int iParam0) // Position - 0x10BD6
{
	if (*iParam0 == -1)
		return;
...
void func_302(char* sParam0) // Position - 0x10C13
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_303(var uParam0) // Position - 0x10C25
{
	*uParam0 = -1;
...
void func_304() // Position - 0x10C58
{
...
int func_305(eCharacter echParam0) // Position - 0x10C72
{
	if (!func_36(echParam0))
