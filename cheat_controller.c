...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x76CD105BCAC6EB9F() && _NETWORK_IS_PLAYER_VALID(unk_0x259BE71D8A81D4FA(), true, true) && !Global_1836471 && Global_33087 == 0)
			func_113();
...
int _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x127
{
	int num;
...
void func_5(int iParam0) // Position - 0x339
{
	...
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_33338, iParam0);
		Global_33341 = 1;
		func_6();
	}
...
void func_9() // Position - 0x3F6
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_10(character) && !func_15(14) || Global_113083)
			{
...
{
	if (IS_BIT_SET(Global_33336, iParam0))
		return true;
...
void func_31(int iParam0, BOOL bParam1) // Position - 0xBD2
{
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_33337, iParam0);
		func_5(iParam0);
	}
	else
	{
		unk_0x8744D2E3FC95740E(&Global_33337, iParam0);
	}
...
{
	if (IS_BIT_SET(Global_33337, iParam0))
		return true;
...
BOOL func_83(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x27EB
{
	int i;
	var unk;
	int num;
...
int func_85(eCharacter echParam0, int iParam1) // Position - 0x2931
{
	int num;
...
{
	if (IS_BIT_SET(Global_33339, iParam0))
	{
		if (iParam1 != 0)
		{
			if (iParam1 == Global_33340)
			{
				unk_0x8744D2E3FC95740E(&Global_33339, iParam0);
				bLocal_91 = true;
				return true;
			}
			else
