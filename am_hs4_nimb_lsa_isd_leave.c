...
void func_4(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x153
{
	...
	if (func_31() == 0 && func_30() == false && bParam1 && !func_29(PLAYER::PLAYER_ID()) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_27())
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_21(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_18(*Global_4718592.f_194133))
...
BOOL func_21(Ped pedParam0) // Position - 0xB95
{
...
void func_22(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xBC6
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xC96
{
	Hash statName;
...
void func_37(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEAD
{
	if (bParam0)
	{
...
int func_39(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1016
{
	int num;
...
void func_49(BOOL bParam0) // Position - 0x127B
{
	int i;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1494
{
...
void func_65(Vehicle veParam0) // Position - 0x164D
{
...
BOOL func_66(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x16E9
{
	int i;
	int num;
	Ped ped;
...
Ped func_68(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x17D6
{
	Ped pedInVehicleSeat;
...
BOOL func_72(var uParam0) // Position - 0x1A40
{
	...
	ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_22, true, 0);
...
void func_76(var uParam0) // Position - 0x1B02
{
	...
	{
		_STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_18), Global_262145.f_30269, false);
		return;
	}
...
void func_77(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1BA9
{
	func_79();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_81(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D99
{
	Hash entityModel;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_144(veParam0, uParam1, bParam2, bParam3);
			...
			if (func_143(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (uParam1->f_9[44] == 2)
			...
			if (func_142(ENTITY::GET_ENTITY_MODEL(veParam0)))
			{
				if (IS_BIT_SET(uParam1->f_103, 0) || func_141(ENTITY::GET_ENTITY_MODEL(veParam0)))
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, false, true);
					func_140(veParam0);
				}
			...
			if (func_138(uParam1->f_66, &num) && uParam1->f_80 != num)
				uParam1->f_80 = num;
			...
			if (func_137(veParam0))
				func_131(veParam0, func_134(uParam1->f_74, uParam1->f_75, uParam1->f_76));
			...
			if (IS_BIT_SET(uParam1->f_95, 0))
				func_101(veParam0, &(uParam1->f_81));
		
			if (!func_91(4) && !bParam4 && !NETWORK::NETWORK_IS_ACTIVITY_SESSION())
				func_88(veParam0);
		
			if (func_87(entityModel))
			{
			...
			if (func_85(ENTITY::GET_ENTITY_MODEL(veParam0)))
			{
				switch (uParam1->f_9[5])
				{
					case 1:
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x22FB
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_83(Vehicle veParam0) // Position - 0x230B
{
	Hash entityModel;
...
BOOL func_84(Hash hParam0) // Position - 0x2351
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_85(Hash hParam0) // Position - 0x23FB
{
	return func_143(hParam0) && !func_86(hParam0);
}

BOOL func_86(Hash hParam0) // Position - 0x2415
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_87(Hash hParam0) // Position - 0x244A
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_88(Vehicle veParam0) // Position - 0x2551
{
	Hash entityModel;
...
void func_89(var uParam0, var uParam1, var uParam2) // Position - 0x25DC
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x261D
{
	int address;
	int i;
	Player player;
...
BOOL func_91(int iParam0) // Position - 0x2682
{
	int i;
...
BOOL func_92(int iParam0) // Position - 0x26BD
{
	return func_93(iParam0, 6, true);
}

BOOL func_93(int iParam0, int iParam1, BOOL bParam2) // Position - 0x26CD
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_98() == 0)
			return IS_BIT_SET(func_94(func_97(iParam0), -1), iParam1);
	else
...
int func_94(int iParam0, int iParam1) // Position - 0x272D
{
	Hash statHash;
	int outValue;
...
Hash func_95(int iParam0, int iParam1) // Position - 0x275C
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_96(iParam1));
}

int func_96(int iParam0) // Position - 0x2771
{
	int num;
	int num2;
...
int func_97(int iParam0) // Position - 0x27A5
{
	switch (iParam0)
	{
		case 0:
...
int func_98() // Position - 0x2B5C
{
	return Global_33105;
}

int func_99(int iParam0) // Position - 0x2B67
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x2EAA
{
	return Global_101765.f_400 > 0;
}

int func_101(Vehicle veParam0, Any* panParam1) // Position - 0x2EBB
{
	int vehicleCrewEmblemRequestState;
	Player playerFromGamerHandle;

	if (!func_111(veParam0, panParam1))
		return 1;
	...
	if (vehicleCrewEmblemRequestState == 0)
	{
		if (!func_109(veParam0))
		{
			...
			if (func_104(&veParam0, playerFromGamerHandle))
			{
			}
			else
			{
...
BOOL func_102(Vehicle veParam0) // Position - 0x2F38
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_103(Vehicle veParam0) // Position - 0x2FC5
{
	int _int;
...
BOOL func_104(var uParam0, Player plParam1) // Position - 0x3021
{
	func_108();
	...
	func_106(*uParam0, &Global_1944325, &(Global_1944325.f_1), &(Global_1944325.f_4), &(Global_1944325.f_7), &(Global_1944325.f_10));
...
BOOL func_105(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x32CC
{
...
int func_106(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x32F5
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_107(Global_1944351, 0f, 0f, 0f, false) && !func_107(Global_1944354, 0f, 0f, 0f, false) && !func_107(Global_1944357, 0f, 0f, 0f, false) && !(Global_1944360 == 0f))
	{
...
BOOL func_107(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x90C1
{
	if (bParam6)
...
BOOL func_109(Vehicle veParam0) // Position - 0x9181
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		if (GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0) || func_110(veParam0))
			return true;

	return false;
}

BOOL func_110(Vehicle veParam0) // Position - 0x91B9
{
	int _int;
...
BOOL func_111(Vehicle veParam0, Any* panParam1) // Position - 0x9201
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
	...
	if (playerFromGamerHandle == PLAYER::PLAYER_ID())
		if (func_123(15, false))
			flag = true;
		else if (func_119(true))
			flag = true;
	else
		flag = true;
...
int func_113(Vehicle veParam0) // Position - 0x96A9
{
...
int func_114(Player plParam0) // Position - 0x96D5
{
	if (func_117(plParam0) == 233)
		return func_115(plParam0);

	return -1;
}

int func_115(Player plParam0) // Position - 0x96F2
{
...
BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x9715
{
	if (func_11(plParam0))
...
int func_117(Player plParam0) // Position - 0x9759
{
	if (func_11(plParam0))
		if (func_116(plParam0, false))
...
BOOL func_119(BOOL bParam0) // Position - 0x9792
{
	return func_120(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_120(Player plParam0, BOOL bParam1) // Position - 0x97A4
{
	return func_121(plParam0, bParam1, 1);
}

BOOL func_121(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x97B5
{
	Player player;
	...
	if (!bParam1)
		if (func_122(plParam0, iParam2))
			return 0;

	player = Global_1887694[plParam0 /*611*/].f_10;

	if (func_11(player) && Global_1887694[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_122(Player plParam0, int iParam1) // Position - 0x9811
{
	if (func_11(plParam0))
		if (func_11(Global_1887694[plParam0 /*611*/].f_10))
...
BOOL func_123(int iParam0, BOOL bParam1) // Position - 0x9860
{
	int num;
	int num2;
	...
	num2 = iParam0;
	return IS_BIT_SET(num, func_124(num2));
}

int func_124(int iParam0) // Position - 0x98BE
{
	return iParam0 % 32;
}

int func_125(int iParam0) // Position - 0x98CB
{
	int num;

	num = func_94(func_126(iParam0), -1);
	return num;
}

int func_126(int iParam0) // Position - 0x98E2
{
	int num;
	int num2;
...
int func_127(int iParam0) // Position - 0x990F
{
	return iParam0 / 32;
}

BOOL func_128(Player plParam0) // Position - 0x991C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_129(plParam0) && Global_2657994[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_129(Player plParam0) // Position - 0x9951
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_130(Global_2657994[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_130(int iParam0) // Position - 0x9998
{
	switch (iParam0)
	{
		case 0:
...
void func_131(Vehicle veParam0, int iParam1) // Position - 0x9ECD
{
	int num;
	int num2;
...
BOOL func_132(int iParam0, var uParam1) // Position - 0x9EEE
{
	*uParam1 = -1;
...
int func_133(int iParam0) // Position - 0xA1B0
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xA24E
{
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA478
{
	var gamerHandle;
...
BOOL func_137(Vehicle veParam0) // Position - 0xA48D
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_138(int iParam0, var uParam1) // Position - 0xA4AE
{
	*uParam1 = -1f;
...
void func_139(Vehicle veParam0) // Position - 0xA7AF
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_140(Vehicle veParam0) // Position - 0xA7E1
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_141(Hash hParam0) // Position - 0xA815
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_142(Hash hParam0) // Position - 0xA832
{
...
BOOL func_143(Hash hParam0) // Position - 0xAD83
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_144(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAE12
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		{
			if (func_166(uParam1->f_5) || func_166(uParam1->f_6))
			{
			}
			else
			{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_165(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_164())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_162(veParam0, uParam1->f_69);
				else
					func_162(veParam0, uParam1->f_69);
		...
		if (bParam3)
			func_153(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_147() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_146(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_145(veParam0, 5f))
...
BOOL func_145(Vehicle veParam0, float fParam1) // Position - 0xB515
{
	float entityCoords;
	var groundZ;
...
Hash func_146(BOOL bParam0) // Position - 0xB586
{
	if (bParam0)
...
BOOL func_147() // Position - 0xB5A0
{
	...
	if (func_151(7))
		if (func_149(Global_2672942.f_4.f_16) || func_148(Global_2672942.f_4.f_16))
			return false;

	return true;
}

BOOL func_148(int iParam0) // Position - 0xB62F
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB653
{
	int num;
	...
	if (num != -1)
		return func_150(iParam0, 9);

	return false;
}

BOOL func_150(int iParam0, int iParam1) // Position - 0xB671
{
	return IS_BIT_SET(Global_1887694[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_151(int iParam0) // Position - 0xB689
{
	return func_152(&(Global_2672942.f_194), iParam0);
}

BOOL func_152(var uParam0, int iParam1) // Position - 0xB69D
{
	int num;
	int num2;
	int num3;
...
int func_153(var uParam0, var uParam1, var uParam2) // Position - 0xB6C0
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_160(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_158(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_156(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_156(*uParam0, uParam1->[38] - 1), false);
...
BOOL func_154(Vehicle veParam0) // Position - 0xB8BE
{
	int i;
	int modType;
	Hash hashKey;
...
void func_155(var uParam0) // Position - 0xB998
{
...
int func_156(Vehicle veParam0, int iParam1) // Position - 0xBA03
{
	int value;
	int value2;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		value = func_157(veParam0, 38) + 1;
		value2 = func_157(veParam0, 24) + 1;
...
int func_157(Vehicle veParam0, int iParam1) // Position - 0xBAEC
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_160(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_158(Hash hParam0) // Position - 0xBB4E
{
...
BOOL func_159(Hash hParam0, int iParam1) // Position - 0xBB79
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_160(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBF58
{
	if (!func_161() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_161() // Position - 0xBF7C
{
	return true;
}

void func_162(Vehicle veParam0, int iParam1) // Position - 0xBF89
{
	int vehicleMod;
...
BOOL func_163(int iParam0) // Position - 0xC003
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_164() // Position - 0xC023
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_165(Vehicle veParam0) // Position - 0xC034
{
	int _int;
...
int func_166(var uParam0) // Position - 0xC079
{
	if (!func_161() && func_167(uParam0))
		return 1;

	return 0;
}

BOOL func_167(int iParam0) // Position - 0xC099
{
	switch (iParam0)
	{
		case 161:
...
int func_168(int iParam0) // Position - 0xC0EC
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_169(Vehicle veParam0) // Position - 0xC19C
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC223
{
...
void func_171(var uParam0) // Position - 0xC270
{
...
void func_172(var uParam0) // Position - 0xC2BE
{
	if (func_289(PLAYER::PLAYER_ID(), false, false))
		return;
	...
	if (!uParam0->f_15)
		if (!STREAMING::NEW_LOAD_SCENE_START(uParam0->f_9, func_173(uParam0->f_12), 4000f, 0))
			return;
		else
			uParam0->f_15 = 1;

	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || !STREAMING::IS_NEW_LOAD_SCENE_LOADED())
		if (!_STOPWATCH_HAS_TIME_PASSED(&(uParam0->f_18), Global_262145.f_30269, false))
			return;
	else
		STREAMING::NEW_LOAD_SCENE_STOP();
...
Vector3 func_173(float fParam0, var uParam1, var uParam2) // Position - 0xC378
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_174(var uParam0) // Position - 0xC3A5
{
	Player player;
	...
	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(func_288()))
		return false;
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(func_288(), false, false, true, true);
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(func_288(), false, false, false, false);
	
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23))
			return false;
	
		func_175(uParam0->f_23, &Global_1880027[player /*55*/], false, -1);
	}

	ENTITY::SET_ENTITY_VISIBLE(uParam0->f_23, uParam0->f_8, false);
	ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_23, true, 0);
...
void func_175(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC47D
{
	var unk;
	int characterType;
	BOOL flag;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		characterType = func_282(pedParam0);
		flag = func_279(pedParam0, false);
		flag2 = func_271(pedParam0);
		flag3 = func_194(pedParam0, iParam3);
		...
		for (i = 0; i < 127; i = i + 1)
		{
			if (IS_BIT_SET(uParam1->[i / 32], i % 32))
				if (func_184(&unk, i, characterType, pedParam0, -1))
					if (func_177(pedParam0, &unk, i, unk.f_4, unk.f_8, flag, flag2, bParam2, flag3))
		...
		for (j = 0; j < numTattooShopDlcItems; j = j + 1)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(characterType, j, &outComponent))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(outComponent))
				{
					...
					{
						if (func_177(pedParam0, &(outComponent.f_7), num, outComponent.f_2, outComponent.f_6, flag, flag2, bParam2, flag3))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(pedParam0, outComponent.f_2, outComponent.f_3);
							func_176(pedParam0, outComponent.f_2, outComponent.f_3);
						}
					}
				}
			}
...
void func_176(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC5E6
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_177(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD8BD
{
	Hash entityModel;
	int num;
	...
	if (hParam4 == 0)
	{
		num = func_183(entityModel, sParam1, hParam4);
		hParam4 = MISC::GET_HASH_KEY(func_182(num));
	}
...
BOOL func_178(int iParam0, int iParam1) // Position - 0xE0E3
{
	int num;
	int num2;
	...
	num = func_179(iParam0, iParam1);
	num2 = func_124(iParam0);
...
int func_179(int iParam0, int iParam1) // Position - 0xE122
{
	int num;
	int num2;
	...
	if (num == 17239)
		if (func_98() == 2 && func_180() == 2)
			return 0;
		else
			return 0;

	num2 = func_94(num, iParam1);
	return num2;
}

int func_180() // Position - 0xE168
{
	return Global_33106;
}

int func_181(int iParam0) // Position - 0xE173
{
	int num;
	int num2;
	...
	if (func_98() == 0 || func_180() == 0 || func_98() == 999 && func_180() == 999)
	{
		switch (num2)
		{
			case 0:
...
char* func_182(int iParam0) // Position - 0xE514
{
	switch (iParam0)
	{
		case 0:
...
int func_183(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xEB55
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_184(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xFB87
{
	Hash entityModel;
	int num;

	func_193(sParam0, -1, 0, "", "", "", "", iParam2, -1, 0);
	...
	switch (iParam2)
	{
		case 0:
			...
			{
				case 0:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_01", "singleplayer_overlays", "MK_000", "", iParam2, 300, 3);
					break;
			
				case 1:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_02", "singleplayer_overlays", "MK_001", "", iParam2, 450, 0);
					break;
			
				case 2:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_03", "singleplayer_overlays", "MK_002", "", iParam2, 250, 4);
					break;
			
				case 3:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_04", "singleplayer_overlays", "MK_003", "", iParam2, 175, 0);
					break;
			
				case 4:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_06", "singleplayer_overlays", "MK_005", "", iParam2, 380, 0);
					break;
			
				case 5:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_07", "singleplayer_overlays", "MK_006", "", iParam2, 180, 0);
					break;
			
				case 6:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_08", "singleplayer_overlays", "MK_007", "", iParam2, 240, 0);
					break;
			
				case 7:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_10", "singleplayer_overlays", "MK_009", "", iParam2, 195, 0);
					break;
			
				case 8:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_11", "singleplayer_overlays", "MK_010", "", iParam2, 280, 6);
					break;
				...
				case 9:
					if (func_192() || func_191())
					{
						...
						func_193(sParam0, iParam1, pedParam3, "TAT_MIC_12", "singleplayer_overlays", "MK_011", "", iParam2, num, 2);
					}
					break;
			
				case 10:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_13", "singleplayer_overlays", "MK_012", "", iParam2, 320, 3);
					break;
			
				case 11:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_14", "singleplayer_overlays", "MK_013", "", iParam2, 500, 2);
					break;
			
				case 12:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_16", "singleplayer_overlays", "MK_015", "", iParam2, 220, 0);
					break;
			
				case 13:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_17", "singleplayer_overlays", "MK_016", "", iParam2, 320, 4);
					break;
			
				case 14:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_18", "singleplayer_overlays", "MK_017", "", iParam2, 140, 2);
					break;
			
				case 15:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_20", "singleplayer_overlays", "MK_019", "", iParam2, 350, 0);
					break;
			
				case 16:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_21", "singleplayer_overlays", "MK_020", "", iParam2, 350, 0);
					break;
			
				case 17:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_05", "singleplayer_overlays", "MK_004", "", iParam2, 120, 1);
					break;
			
				case 18:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_09", "singleplayer_overlays", "MK_008", "", iParam2, 99, 1);
					break;
			
				case 19:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_15", "singleplayer_overlays", "MK_014", "", iParam2, 400, 1);
					break;
			
				case 20:
					func_193(sParam0, iParam1, pedParam3, "TAT_MIC_19", "singleplayer_overlays", "MK_018", "", iParam2, 420, 1);
					break;
			
				default:
					func_185(sParam0, iParam2, iParam1, 21);
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 0:
					if (func_192() || func_191())
					{
						...
						func_193(sParam0, iParam1, pedParam3, "TAT_FRA_01", "singleplayer_overlays", "fr_000", "", iParam2, num, 0);
					}
					break;
			
				case 1:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_02", "singleplayer_overlays", "fr_001", "", iParam2, 230, 0);
					break;
			
				case 2:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_03", "singleplayer_overlays", "fr_002", "", iParam2, 310, 0);
					break;
			
				case 3:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_04", "singleplayer_overlays", "fr_003", "", iParam2, 260, 0);
					break;
			
				case 4:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_07", "singleplayer_overlays", "fr_006", "", iParam2, 240, 2);
					break;
			
				case 5:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_08", "singleplayer_overlays", "fr_007", "", iParam2, 190, 3);
					break;
			
				case 6:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_09", "singleplayer_overlays", "fr_008", "", iParam2, 200, 2);
					break;
			
				case 7:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_10", "singleplayer_overlays", "fr_009", "", iParam2, 225, 0);
					break;
			
				case 8:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_12", "singleplayer_overlays", "fr_011", "", iParam2, 195, 0);
					break;
			
				case 9:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_13", "singleplayer_overlays", "fr_012", "", iParam2, 275, 2);
					break;
			
				case 10:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_14", "singleplayer_overlays", "fr_013", "", iParam2, 80, 0);
					break;
			
				case 11:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_15", "singleplayer_overlays", "fr_014", "", iParam2, 95, 0);
					break;
			
				case 12:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_16", "singleplayer_overlays", "fr_015", "", iParam2, 300, 3);
					break;
			
				case 13:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_17", "singleplayer_overlays", "fr_016", "", iParam2, 450, 3);
					break;
			
				case 14:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_18", "singleplayer_overlays", "fr_017", "", iParam2, 345, 3);
					break;
			
				case 15:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_19", "singleplayer_overlays", "fr_018", "", iParam2, 550, 0);
					break;
			
				case 16:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_20", "singleplayer_overlays", "fr_019", "", iParam2, 200, 0);
					break;
			
				case 17:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_21", "singleplayer_overlays", "fr_020", "", iParam2, 180, 0);
					break;
			
				case 18:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_22", "singleplayer_overlays", "fr_021", "", iParam2, 140, 0);
					break;
			
				case 19:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_24", "singleplayer_overlays", "fr_023", "", iParam2, 245, 0);
					break;
				...
				case 21:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_26", "singleplayer_overlays", "fr_025", "", iParam2, 370, 0);
					break;
			
				case 22:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_27", "singleplayer_overlays", "fr_026", "", iParam2, 350, 0);
					break;
			
				case 23:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_28", "singleplayer_overlays", "fr_027", "", iParam2, 310, 0);
					break;
			
				case 24:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_29", "singleplayer_overlays", "fr_028", "", iParam2, 210, 0);
					break;
			
				case 25:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_30", "singleplayer_overlays", "fr_029", "", iParam2, 245, 0);
					break;
			
				case 26:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_31", "singleplayer_overlays", "fr_030", "", iParam2, 85, 0);
					break;
			
				case 27:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_32", "singleplayer_overlays", "fr_031", "", iParam2, 210, 0);
					break;
			
				case 28:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_33", "singleplayer_overlays", "fr_032", "", iParam2, 225, 0);
					break;
			
				case 29:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_34", "singleplayer_overlays", "fr_033", "", iParam2, 145, 0);
					break;
			
				case 30:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_35", "singleplayer_overlays", "fr_034", "", iParam2, 230, 0);
					break;
			
				case 31:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_36", "singleplayer_overlays", "fr_035", "", iParam2, 195, 0);
					break;
			
				case 32:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_37", "singleplayer_overlays", "fr_036", "", iParam2, 255, 0);
					break;
			
				case 33:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_38", "singleplayer_overlays", "fr_037", "", iParam2, 300, 0);
					break;
			
				case 34:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_40", "singleplayer_overlays", "fr_039", "", iParam2, 300, 0);
					break;
			
				case 35:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_05", "singleplayer_overlays", "fr_004", "", iParam2, 255, 1);
					break;
			
				case 36:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_06", "singleplayer_overlays", "fr_005", "", iParam2, 175, 1);
					break;
			
				case 37:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_11", "singleplayer_overlays", "fr_010", "", iParam2, 520, 1);
					break;
			
				case 38:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_23", "singleplayer_overlays", "fr_022", "", iParam2, 125, 1);
					break;
			
				case 39:
					func_193(sParam0, iParam1, pedParam3, "TAT_FRA_39", "singleplayer_overlays", "fr_038", "", iParam2, 365, 1);
					break;
			
				default:
					func_185(sParam0, iParam2, iParam1, 40);
					break;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_01", "singleplayer_overlays", "tp_000", "", iParam2, 120, 0);
					break;
			
				case 1:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_02", "singleplayer_overlays", "tp_001", "", iParam2, 150, 3);
					break;
			
				case 2:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_03", "singleplayer_overlays", "tp_002", "", iParam2, 100, 0);
					break;
			
				case 3:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_04", "singleplayer_overlays", "tp_003", "", iParam2, 140, 0);
					break;
			
				case 4:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_05", "singleplayer_overlays", "tp_004", "", iParam2, 250, 0);
					break;
				...
				case 5:
					if (func_192() || func_191())
					{
						...
						func_193(sParam0, iParam1, pedParam3, "TAT_TRV_06", "singleplayer_overlays", "tp_005", "", iParam2, num, 3);
					}
					break;
			
				case 6:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_07", "singleplayer_overlays", "tp_006", "", iParam2, 120, 0);
					break;
			
				case 7:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_08", "singleplayer_overlays", "tp_007", "", iParam2, 250, 0);
					break;
			
				case 8:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_09", "singleplayer_overlays", "tp_008", "", iParam2, 50, 3);
					break;
			
				case 9:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_10", "singleplayer_overlays", "tp_009", "", iParam2, 135, 2);
					break;
			
				case 10:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_11", "singleplayer_overlays", "tp_010", "", iParam2, 245, 0);
					break;
			
				case 11:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_12", "singleplayer_overlays", "tp_011", "", iParam2, 280, 0);
					break;
			
				case 12:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_13", "singleplayer_overlays", "tp_012", "", iParam2, 65, 0);
					break;
			
				case 13:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_14", "singleplayer_overlays", "tp_013", "", iParam2, 150, 6);
					break;
			
				case 14:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_15", "singleplayer_overlays", "tp_014", "", iParam2, 200, 0);
					break;
			
				case 15:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_16", "singleplayer_overlays", "tp_015", "", iParam2, 145, 0);
					break;
			
				case 16:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_17", "singleplayer_overlays", "tp_016", "", iParam2, 290, 0);
					break;
			
				case 17:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_18", "singleplayer_overlays", "tp_017", "", iParam2, 350, 3);
					break;
			
				case 18:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_19", "singleplayer_overlays", "tp_018", "", iParam2, 70, 0);
					break;
			
				case 19:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_20", "singleplayer_overlays", "tp_019", "", iParam2, 180, 6);
					break;
			
				case 20:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_21", "singleplayer_overlays", "tp_020", "", iParam2, 230, 0);
					break;
			
				case 21:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_22", "singleplayer_overlays", "tp_021", "", iParam2, 200, 0);
					break;
			
				case 22:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_24", "singleplayer_overlays", "tp_023", "", iParam2, 240, 0);
					break;
			
				case 23:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_25", "singleplayer_overlays", "tp_024", "", iParam2, 195, 0);
					break;
			
				case 24:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_26", "singleplayer_overlays", "tp_025", "", iParam2, 225, 2);
					break;
			
				case 25:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_28", "singleplayer_overlays", "tp_027", "", iParam2, 175, 0);
					break;
			
				case 26:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_29", "singleplayer_overlays", "tp_028", "", iParam2, 65, 0);
					break;
			
				case 27:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_30", "singleplayer_overlays", "tp_029", "", iParam2, 50, 0);
					break;
			
				case 28:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_31", "singleplayer_overlays", "tp_030", "", iParam2, 70, 0);
					break;
			
				case 29:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_34", "singleplayer_overlays", "tp_033", "", iParam2, 70, 0);
					break;
			
				case 30:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_23", "singleplayer_overlays", "tp_022", "", iParam2, 500, 1);
					break;
			
				case 31:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_27", "singleplayer_overlays", "tp_026", "", iParam2, 300, 1);
					break;
			
				case 32:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_32", "singleplayer_overlays", "tp_031", "", iParam2, 190, 1);
					break;
			
				case 33:
					func_193(sParam0, iParam1, pedParam3, "TAT_TRV_33", "singleplayer_overlays", "tp_032", "", iParam2, 129, 1);
					break;
			
				default:
					func_185(sParam0, iParam2, iParam1, 34);
					break;
			}
			break;
		...
		case 4:
			...
			{
				case 0:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(20000) * Global_262145.f_2825), 0);
					break;
			
				case 1:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1400) * Global_262145.f_2826), 2);
					break;
			
				case 2:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(9750) * Global_262145.f_2827), 3);
					break;
			
				case 3:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2150) * Global_262145.f_2828), 0);
					break;
			
				case 4:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2829), 0);
					break;
			
				case 54:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12400) * Global_262145.f_2830), 1);
					break;
			
				case 5:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2831), 0);
					break;
			
				case 6:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2832), 2);
					break;
			
				case 55:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1350) * Global_262145.f_2833), 1);
					break;
			
				case 7:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1450) * Global_262145.f_2834), 0);
					break;
			
				case 8:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2700) * Global_262145.f_2835), 7);
					break;
			
				case 9:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1200) * Global_262145.f_2836), 0);
					break;
			
				case 10:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1500) * Global_262145.f_2837), 0);
					break;
			
				case 11:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2650) * Global_262145.f_2838), 0);
					break;
			
				case 56:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2839), 1);
					break;
			
				case 12:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2840), 2);
					break;
			
				case 57:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2841), 1);
					break;
			
				case 58:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2842), 1);
					break;
			
				case 59:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7400) * Global_262145.f_2843), 1);
					break;
			
				case 60:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2844), 1);
					break;
			
				case 17:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2849), 2);
					break;
			
				case 18:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2850), 2);
					break;
			
				case 19:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3600) * Global_262145.f_2851), 2);
					break;
			
				case 20:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2852), 3);
					break;
			
				case 21:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12500) * Global_262145.f_2853), 3);
					break;
			
				case 22:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2854), 3);
					break;
			
				case 23:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2855), 3);
					break;
			
				case 24:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2856), 3);
					break;
			
				case 25:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2857), 2);
					break;
			
				case 26:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2858), 3);
					break;
			
				case 27:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4800) * Global_262145.f_2859), 3);
					break;
			
				case 28:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2860), 3);
					break;
			
				case 61:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12350) * Global_262145.f_2861), 1);
					break;
			
				case 62:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2862), 1);
					break;
			
				case 63:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4500) * Global_262145.f_2863), 1);
					break;
			
				case 64:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2864), 1);
					break;
			
				case 65:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12300) * Global_262145.f_2865), 1);
					break;
			
				case 29:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2866), 0);
					break;
			
				case 30:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2867), 0);
					break;
			
				case 31:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2868), 0);
					break;
			
				case 66:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2869), 1);
					break;
			
				case 32:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2870), 2);
					break;
			
				case 33:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2871), 3);
					break;
			
				case 34:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7250) * Global_262145.f_2872), 2);
					break;
			
				case 35:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(11900) * Global_262145.f_2873), 0);
					break;
			
				case 36:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2750) * Global_262145.f_2874), 0);
					break;
			
				case 37:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1750) * Global_262145.f_2875), 0);
					break;
			
				case 38:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2876), 3);
					break;
			
				case 39:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(&func_24) * Global_262145.f_2877), 2);
					break;
			
				case 40:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1000) * Global_262145.f_2878), 0);
					break;
			
				case 67:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2879), 1);
					break;
			
				case 41:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2880), 2);
					break;
			
				case 68:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2881), 1);
					break;
			
				case 42:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5050) * Global_262145.f_2882), 0);
					break;
			
				case 43:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2450) * Global_262145.f_2883), 2);
					break;
			
				case 44:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2884), 0);
					break;
			
				case 45:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2885), 0);
					break;
			
				case 46:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2886), 0);
					break;
			
				case 47:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1150) * Global_262145.f_2887), 3);
					break;
			
				case 48:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2888), 3);
					break;
			
				case 49:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7600) * Global_262145.f_2889), 3);
					break;
			
				case 50:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2600) * Global_262145.f_2890), 2);
					break;
			
				case 51:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2891), 3);
					break;
			
				case 52:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7450) * Global_262145.f_2892), 3);
					break;
			
				case 53:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2893), 0);
					break;
			
				case 69:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2894), 1);
					break;
			
				case 70:
					func_193(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2895), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				...
				{
					case 73:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_001", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 74:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_002", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 75:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_003", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 76:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_004", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 77:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_005", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 78:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_006", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 79:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_009", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 80:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_013", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 81:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_014", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 82:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_015", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 83:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_016", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 84:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_019", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 85:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_020", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 86:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_036", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 90:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_017", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 91:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_018", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 124:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_046", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 125:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_045", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 87:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
				
					case 93:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 94:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_002", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 95:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_003", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 96:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_004", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 97:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_005", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 98:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_006", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 99:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_007", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 100:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_008", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 101:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_009", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 102:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_010", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 103:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_011", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 104:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_012", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 105:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_013", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 106:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_014", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 107:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_015", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 108:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 109:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 110:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 111:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 112:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 113:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 114:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGInd_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 115:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "not_in_use", "hairOverlay", iParam2, 100, 0);
						break;
					...
					case 123:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "mpBeach_overlays", "FM_Hair_Fuzz", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 13:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2845), 0);
						break;
				
					case 14:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_193(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2848), 0);
						break;
				
					case 71:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				
					case 72:
						func_193(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				...
				{
					case 73:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_027_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 74:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_028_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 75:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_034_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 76:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_036_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 77:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_048", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 78:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_052", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 79:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_053", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 80:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_054", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 81:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_055", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 82:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_056", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 83:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_058", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 84:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_067", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 85:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_068", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 92:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_051", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 87:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
				
					case 93:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 94:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_002", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 95:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_003", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 96:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_004", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 97:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_005", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 98:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_006", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 99:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_007", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 100:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_008", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 101:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_009", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 102:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_010", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 103:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_011", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 104:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_012", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 105:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_013", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 106:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_014", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 107:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_015", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 108:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 109:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 110:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 111:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 112:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 113:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 114:
						func_193(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGInd_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
					...
					case 14:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_193(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			break;
	...
	if (iParam2 == 3 || iParam2 == 4 && iParam1 >= 129)
		func_185(sParam0, iParam2, iParam1, 129);
...
void func_185(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12BAD
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_186() // Position - 0x12C3F
{
	if (_IS_EXCLUSIVE_CONTENT_UNLOCKED() && func_189() || func_188())
		return true;
...
BOOL func_187() // Position - 0x12C71
{
	return true;
}

int func_188() // Position - 0x12C7A
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x12E69
{
	int profileSetting;
...
int func_191() // Position - 0x12F21
{
	return 1;
}

int func_192() // Position - 0x12F2A
{
	return 1;
}

void func_193(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12F33
{
	var unk;
...
BOOL func_194(Ped pedParam0, int iParam1) // Position - 0x131E8
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				num2 = func_199(pedParam0, 11, PV_COMP_INVALID);
			
				if (num2 >= 237)
				{
					componentHash = func_195(joaat("MP_M_Freemode_01"), num2, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				num3 = func_199(pedParam0, 11, PV_COMP_INVALID);
			
				if (num3 >= 256)
				{
					componentHash2 = func_195(joaat("MP_F_Freemode_01"), num3, 11, 4);
...
Hash func_195(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x134A8
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = iParam1 - func_198(hParam0);
	...
	else
	{
		...
		componentId2 = iParam1 - func_196(hParam0, func_197(iParam2));
		...
		num2 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_197(iParam2));
...
int func_196(Hash hParam0, int iParam1) // Position - 0x135C2
{
	switch (hParam0)
	{
...
ePedComponentType func_197(int iParam0) // Position - 0x13969
{
	switch (iParam0)
	{
		case 0:
...
int func_198(Hash hParam0) // Position - 0x13A19
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_199(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13A7A
{
	int i;
	int j;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (iParam1 == 12)
		{
			for (i = 0; i <= 53; i = i + 1)
			{
				if (func_208(pedParam0, iParam1, i))
					return i;
			}
		}
		else if (iParam1 == 13)
		{
			for (j = 0; j <= 19; j = j + 1)
			{
				if (func_208(pedParam0, iParam1, j))
					return j;
			}
		...
		else if (iParam1 == 14)
		{
			...
			{
				return func_202(pedParam0, epctParam2);
			}
		}
		else
		{
			return func_200(pedParam0, iParam1);
		}
	}
...
int func_200(Ped pedParam0, int iParam1) // Position - 0x13B1B
{
	...
	return func_201(pedParam0, pedDrawableVariation, pedTextureVariation, iParam1);
}

int func_201(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13B7B
{
	ePedComponentType componentId;
...
int func_202(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13BD2
{
	int pedPropIndex;
	...
	if (pedPropIndex == -1)
		return func_207(epctParam1);

	pedPropTextureIndex = PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, epctParam1);
	return func_203(pedParam0, pedPropIndex, pedPropTextureIndex, epctParam1);
}

int func_203(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x13C19
{
	Hash entityModel;
	...
	if (hashNameForProp != -1 && hashNameForProp != 0)
		if (entityModel == joaat("MP_M_Freemode_01"))
			return func_205(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 3);
		else if (entityModel == joaat("MP_F_Freemode_01"))
			return func_205(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 4);
	...
	for (i = 0; i <= numberOfPedPropDrawableVariations - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= numberOfPedPropTextureVariations - 1; j = j + 1)
			{
				...
				{
					num = num + func_204(pedParam0, epctParam3);
					return num;
				}
				else
				{
...
int func_204(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13D15
{
	Hash entityModel;
...
int func_205(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13E53
{
	var outfit;
	int i;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		if (shopPedQueryPropIndex != -1)
			return func_198(hParam0) + shopPedQueryPropIndex;
	}
	else
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_197(iParam2));
		shopPedQueryComponentIndex = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(hParam1);
	
		if (shopPedQueryComponentIndex != -1)
			return func_196(hParam0, func_197(iParam2)) + shopPedQueryComponentIndex;
	}

	return -99;
}

int func_206(Hash hParam0) // Position - 0x13F0E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_207(ePedComponentType epctParam0) // Position - 0x13F6D
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_208(Ped pedParam0, int iParam1, int iParam2) // Position - 0x13FF3
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_224(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
		unk = { func_220(entityModel, iParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num2] != -99)
			{
				if (!func_208(pedParam0, num2, unk[num2]))
				{
					Global_2883588 = hash;
					...
					if (num2 == 13)
					{
						unk18 = { func_217(entityModel, unk[num2]) };
					
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_208(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79347[2 /*14*/] = { func_224(entityModel, 14, j, -1) };
								
									if (Global_79347[2 /*14*/].f_12 == i)
									{
										if (func_208(pedParam0, 14, j))
										{
											if (!func_212(entityModel, iParam2, 14, j, &unk, &Global_79347[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					{
						num = func_200(pedParam0, num2);
						Global_79347[2 /*14*/] = { func_224(entityModel, num2, num, -1) };
					
						if (!func_212(entityModel, iParam2, num2, num, &unk, &Global_79347[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_94(1759, Global_79344) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		unk28 = { func_217(entityModel, iParam2) };
	
		for (l = 0; l <= 8; l = l + 1)
		{
			if (!func_208(pedParam0, 14, unk28[l]))
				return false;
		}
	...
	else if (iParam1 == 14)
	{
		...
		if (Global_79347[1 /*14*/].f_12 == PV_COMP_HEAD && IS_BIT_SET(Global_79347[1 /*14*/].f_6, 6) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HELMET"), 1) && FILES::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_2883588) > 0)
		{
			...
			for (m = 0; m < shopPedApparelVariantPropCount; m = m + 1)
			{
				...
				if (nameHash != 0 && nameHash != joaat("0"))
				{
					...
					if (outProp.f_3 == PED::GET_PED_PROP_INDEX(pedParam0, Global_79347[1 /*14*/].f_12, 1) && outProp.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_79347[1 /*14*/].f_12))
						return true;
				}
			}
		}
	...
	{
		if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_197(iParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_197(iParam1)))
			return true;
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79346 == 1)
				if (func_211(entityModel, 11, func_200(pedParam0, 11), -1))
					if (func_210(entityModel, 4, iParam2, &num3))
						return func_208(pedParam0, 4, num3);
				else if (func_209(entityModel, 4, iParam2, &num3))
					return func_208(pedParam0, 4, num3);
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14450
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						componentHash = func_195(hParam0, iParam2, iParam1, 4);
							...
							for (i = 0; i < shopPedApparelVariantComponentCount; i = i + 1)
							{
								...
								if (componentType == 4)
								{
									if (nameHash != 0 && nameHash != joaat("0"))
									{
										...
										{
											*uParam3 = func_205(hParam0, nameHash, iParam1, 4);
											return true;
										}
									}
								}
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x144F9
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x145A1
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, iParam2, 11, 4);
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x145F4
{
	var unk;
	int i;
	...
	if (iParam2 == 14)
	{
		unk = { func_217(hParam0, uParam4->[13]) };
	...
	if (func_216(hParam0, iParam2, iParam3))
		return true;

	if (hParam0 == joaat("Player_Zero"))
	{
		if (func_215(hParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_214(hParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_213(hParam0, iParam2, iParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14BF8
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, iParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, iParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, iParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_195(hParam0, iParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_195(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_214(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14E75
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_215(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1529A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_216(Hash hParam0, int iParam1, int iParam2) // Position - 0x1558D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_217(Hash hParam0, int iParam1) // Position - 0x15626
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			{
				case 31:
					func_219(&unk, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 0:
					func_219(&unk, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_219(&unk, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_219(&unk, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_219(&unk, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_219(&unk, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_219(&unk, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_219(&unk, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_219(&unk, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_219(&unk, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 9:
					func_219(&unk, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				default:
					func_218(&unk, hParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_219(&unk, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_219(&unk, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_219(&unk, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_219(&unk, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_219(&unk, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_219(&unk, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_219(&unk, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				default:
					func_218(&unk, hParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 0:
					func_219(&unk, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_219(&unk, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_219(&unk, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_219(&unk, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_219(&unk, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_219(&unk, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_219(&unk, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_219(&unk, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_219(&unk, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_219(&unk, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_219(&unk, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_219(&unk, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_219(&unk, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_219(&unk, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_219(&unk, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_219(&unk, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_219(&unk, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 9:
					func_219(&unk, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 10:
					func_219(&unk, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_219(&unk, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 13:
					func_219(&unk, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 14:
					func_219(&unk, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 15:
					func_219(&unk, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 16:
					func_219(&unk, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 17:
					func_219(&unk, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 18:
					func_219(&unk, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 19:
					func_219(&unk, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 20:
					func_219(&unk, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 21:
					func_219(&unk, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				default:
					func_218(&unk, hParam0, iParam1, 25);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_219(&unk, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_219(&unk, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_219(&unk, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_219(&unk, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_219(&unk, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_219(&unk, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_219(&unk, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_219(&unk, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_219(&unk, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 10:
					func_219(&unk, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 11:
					func_219(&unk, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 12:
					func_219(&unk, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 13:
					func_219(&unk, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
			
				case 14:
					func_219(&unk, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_219(&unk, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 17:
					func_219(&unk, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 18:
					func_219(&unk, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 19:
					func_219(&unk, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 20:
					func_219(&unk, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 21:
					func_219(&unk, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 22:
					func_219(&unk, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 23:
					func_219(&unk, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15F55
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
			...
			for (i = 0; i < itemHash.f_3; i = i + 1)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 != -1)
					if (outPropVariant != 0 && outPropVariant != -1 && outPropVariant != joaat("0"))
						uParam0->[outPropVariant.f_2] = func_205(hParam1, outPropVariant, 14, num);
...
void func_219(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1607F
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_220(Hash hParam0, int iParam1) // Position - 0x160C7
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
			...
			switch (iParam1)
			{
				case 0:
					if (Global_114162.f_9089.f_99.f_58[120])
						func_223(&unk, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					else
						func_223(&unk, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_223(&unk, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
			
				case 2:
					func_223(&unk, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
			
				case 3:
					func_223(&unk, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
			
				case 4:
					func_223(&unk, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
			
				case 5:
					func_223(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[0], Global_114162.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
			
				case 6:
					func_223(&unk, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 7:
					func_223(&unk, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 8:
					func_223(&unk, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 9:
					func_223(&unk, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_223(&unk, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
			
				case 11:
					func_223(&unk, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
			
				case 12:
					func_223(&unk, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_223(&unk, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_223(&unk, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
			
				case 15:
					func_223(&unk, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
			
				case 16:
					func_223(&unk, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_223(&unk, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_223(&unk, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
			
				case 19:
					func_223(&unk, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_223(&unk, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_223(&unk, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_223(&unk, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_223(&unk, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 24:
					func_223(&unk, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
			
				case 25:
					func_223(&unk, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 26:
					func_223(&unk, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 27:
					func_223(&unk, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 28:
					func_223(&unk, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
			
				case 29:
					func_223(&unk, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_223(&unk, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_223(&unk, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
			
				case 32:
					func_223(&unk, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 33:
					func_223(&unk, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 34:
					func_223(&unk, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
			
				case 35:
					func_223(&unk, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 36:
					func_223(&unk, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_223(&unk, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_223(&unk, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_223(&unk, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_223(&unk, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_223(&unk, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_223(&unk, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_223(&unk, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_223(&unk, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 45:
					func_223(&unk, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 46:
					func_223(&unk, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 47:
					func_223(&unk, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 48:
					func_223(&unk, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 49:
					func_223(&unk, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 50:
					func_223(&unk, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
			
				case 51:
					func_223(&unk, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 52:
					func_223(&unk, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				default:
					func_221(&unk, hParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			...
			{
				case 0:
					func_223(&unk, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_223(&unk, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 2:
					func_223(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[1], Global_114162.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
			
				case 3:
					func_223(&unk, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
			
				case 4:
					func_223(&unk, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
			
				case 5:
					func_223(&unk, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 6:
					func_223(&unk, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 7:
					func_223(&unk, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
			
				case 8:
					func_223(&unk, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
			
				case 9:
					func_223(&unk, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_223(&unk, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 11:
					func_223(&unk, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 12:
					func_223(&unk, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_223(&unk, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_223(&unk, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_223(&unk, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 16:
					func_223(&unk, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_223(&unk, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_223(&unk, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
			
				case 19:
					func_223(&unk, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_223(&unk, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_223(&unk, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
			
				case 22:
					func_223(&unk, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
			
				case 23:
					func_223(&unk, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
			
				case 24:
					func_223(&unk, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
			
				case 25:
					func_223(&unk, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
			
				case 26:
					func_223(&unk, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
			
				case 27:
					func_223(&unk, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
			
				case 28:
					func_223(&unk, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
			
				case 29:
					func_223(&unk, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
			
				case 30:
					func_223(&unk, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
			
				case 31:
					func_223(&unk, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
			
				case 32:
					func_223(&unk, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
			
				case 33:
					func_223(&unk, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
			
				case 34:
					func_223(&unk, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
			
				case 35:
					func_223(&unk, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
			
				case 36:
					func_223(&unk, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
			
				case 37:
					func_223(&unk, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
			
				case 38:
					func_223(&unk, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_223(&unk, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_223(&unk, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_223(&unk, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_223(&unk, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_223(&unk, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
			
				case 44:
					func_223(&unk, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
			
				case 45:
					func_223(&unk, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
			
				case 46:
					func_223(&unk, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
			
				default:
					func_221(&unk, hParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_223(&unk, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_223(&unk, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
			
				case 2:
					func_223(&unk, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
			
				case 3:
					func_223(&unk, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
			
				case 4:
					func_223(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[2], Global_114162.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 5:
					func_223(&unk, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
			
				case 6:
					func_223(&unk, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
			
				case 7:
					func_223(&unk, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
			
				case 8:
					func_223(&unk, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
			
				case 9:
					func_223(&unk, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_223(&unk, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 11:
					func_223(&unk, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
			
				case 12:
					func_223(&unk, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_223(&unk, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_223(&unk, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_223(&unk, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 16:
					func_223(&unk, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_223(&unk, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_223(&unk, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 19:
					func_223(&unk, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_223(&unk, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_223(&unk, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_223(&unk, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_223(&unk, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 24:
					func_223(&unk, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 25:
					func_223(&unk, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 26:
					func_223(&unk, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 27:
					func_223(&unk, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 28:
					func_223(&unk, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 29:
					func_223(&unk, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_223(&unk, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_223(&unk, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 32:
					func_223(&unk, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 33:
					func_223(&unk, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 34:
					func_223(&unk, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 35:
					func_223(&unk, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 36:
					func_223(&unk, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_223(&unk, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_223(&unk, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_223(&unk, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_223(&unk, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_223(&unk, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_223(&unk, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_223(&unk, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_223(&unk, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 45:
					func_223(&unk, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
			
				case 46:
					func_223(&unk, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 47:
					func_223(&unk, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				default:
					func_221(&unk, hParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_223(&unk, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_223(&unk, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_223(&unk, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
			
				case 3:
					func_223(&unk, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
			
				case 4:
					func_223(&unk, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_223(&unk, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_223(&unk, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_223(&unk, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_223(&unk, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
			
				case 9:
					func_223(&unk, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
			
				case 10:
					func_223(&unk, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_223(&unk, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_223(&unk, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_223(&unk, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_223(&unk, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_223(&unk, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_223(&unk, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_223(&unk, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
			
				case 18:
					func_223(&unk, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
			
				case 19:
					func_223(&unk, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
			
				case 20:
					func_223(&unk, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_223(&unk, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
			
				case 22:
					func_223(&unk, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
			
				case 23:
					func_223(&unk, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_223(&unk, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
			
				case 25:
					func_223(&unk, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
			
				default:
					func_221(&unk, hParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_223(&unk, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
			
				case 1:
					func_223(&unk, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
			
				case 2:
					func_223(&unk, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_223(&unk, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
			
				case 4:
					func_223(&unk, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
			
				case 5:
					func_223(&unk, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
			
				case 6:
					func_223(&unk, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
			
				case 7:
					func_223(&unk, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
			
				case 8:
					func_223(&unk, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
			
				case 9:
					func_223(&unk, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
			
				case 10:
					func_223(&unk, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
			
				case 11:
					func_223(&unk, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
			
				case 12:
					func_223(&unk, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
			
				case 13:
					func_223(&unk, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
			
				case 14:
					func_223(&unk, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
			
				case 15:
					func_223(&unk, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
			
				case 16:
					func_223(&unk, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
			
				case 17:
					func_223(&unk, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
			
				case 18:
					func_223(&unk, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
			
				case 19:
					func_223(&unk, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
			
				case 20:
					func_223(&unk, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
			
				case 21:
					func_223(&unk, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
			
				case 22:
					func_223(&unk, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
			
				case 23:
					func_223(&unk, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
			
				case 24:
					func_223(&unk, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
			
				case 25:
					func_223(&unk, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
			
				case 26:
					func_223(&unk, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
			
				case 27:
					func_223(&unk, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
			
				default:
					func_221(&unk, hParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_221(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17F0F
{
	int num;
	Hash outfit;
		...
		for (i = 0; i < outfit.f_4; i = i + 1)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(outfit.f_1, i, &outComponentVariant))
			{
				if (outComponentVariant != 0 && outComponentVariant != -1 && outComponentVariant != joaat("0"))
				{
					...
					{
						uParam0->[func_222(outComponentVariant.f_2)] = outComponentVariant;
						uParam0->f_16 = 1;
					}
					else
					{
						uParam0->[func_222(outComponentVariant.f_2)] = func_205(hParam1, outComponentVariant, func_222(outComponentVariant.f_2), num);
					}
				}
				else if (outComponentVariant.f_1 != -1)
				{
					uParam0->[func_222(outComponentVariant.f_2)] = outComponentVariant.f_1;
				}
			}
		}
...
int func_222(int iParam0) // Position - 0x180FA
{
	switch (iParam0)
	{
		case 0:
...
void func_223(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x181AA
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_224(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1821B
{
	func_270();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_254(iParam1, iParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_225(iParam1, iParam2, hParam3);

	return Global_79347[0 /*14*/];
}

void func_225(int iParam0, int iParam1, Hash hParam2) // Position - 0x1825C
{
	switch (iParam0)
	{
		case 2:
...
void func_226(int iParam0) // Position - 0x18368
{
	BOOL flag;
	int num;
	var unk;
	...
	func_227(&Global_79347[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_227(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x18523
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_232(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_232(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_231(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_231(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_231(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_94(func_230(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_94(func_229(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_228(iParam1, iParam0->f_2, &num2))
			{
...
BOOL func_228(int iParam0, int iParam1, var uParam2) // Position - 0x188C5
{
	*uParam2 = 979;
...
int func_229(int iParam0, int iParam1) // Position - 0x18CCA
{
	switch (iParam1)
	{
		case 0:
...
int func_230(int iParam0, int iParam1) // Position - 0x190C5
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_231(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x194C0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_232(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A363
{
	int num;
	int num2;
	int num3;
	...
	if (func_233(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_233(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A3A1
{
...
BOOL func_234(int iParam0) // Position - 0x1CFC6
{
	return Global_44199 == iParam0;
}

int func_235(int iParam0) // Position - 0x1CFD4
{
	switch (iParam0)
	{
		case -1:
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D0A8
{
	int num;

	num = 0;
	Global_79347[0 /*14*/].f_5 = 4;
	func_237(num, iParam0, 0, hParam1);
	return;
}

void func_237(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D0C8
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_227(&Global_79347[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_227(&Global_79347[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_227(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_227(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_197(iParam0));
...
void func_238(int iParam0, Hash hParam1) // Position - 0x1D34F
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num6, iParam0, 9, hParam1);
			return;
	}
...
void func_239(int iParam0, Hash hParam1) // Position - 0x1D452
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num6, iParam0, 28, hParam1);
			return;
	}
...
void func_240(int iParam0, Hash hParam1) // Position - 0x1D731
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_237(num5, iParam0, 327, hParam1);
	...
	{
		func_227(&Global_79347[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_241(int iParam0, Hash hParam1) // Position - 0x20507
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num6, iParam0, 6, hParam1);
			return;
	}
...
void func_242(int iParam0, Hash hParam1) // Position - 0x2060C
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num5, iParam0, 55, hParam1);
...
void func_243(int iParam0, Hash hParam1) // Position - 0x20DE8
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num5, iParam0, 26, hParam1);
...
void func_244(int iParam0, Hash hParam1) // Position - 0x210CD
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_237(num5, iParam0, 256, hParam1);
...
void func_245(int iParam0, Hash hParam1) // Position - 0x226F4
{
	BOOL flag;
	int value;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x23D53
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_237(num6, iParam0, 16, hParam1);
		return;
	}
...
void func_247(int iParam0, Hash hParam1) // Position - 0x23EAE
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_237(num6, iParam0, 36, hParam1);
		return;
	}
...
void func_248(int iParam0, Hash hParam1) // Position - 0x24130
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num5, iParam0, 136, hParam1);
...
BOOL func_249(int iParam0, int iParam1) // Position - 0x254D2
{
	int num;
	int num2;

	if (func_251(iParam0) == 17239)
		return false;

	num = func_250(iParam0, iParam1);
	num2 = iParam0;
	return IS_BIT_SET(num, func_124(num2));
}

int func_250(int iParam0, int iParam1) // Position - 0x25501
{
	int num;

	num = func_94(func_251(iParam0), iParam1);
	return num;
}

int func_251(int iParam0) // Position - 0x25519
{
	int num;
	int num2;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x25894
{
	BOOL flag;
	int value;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x26FF9
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_237(num5, iParam0, 92, hParam1);
			return;
	}
...
void func_254(int iParam0, int iParam1, Hash hParam2) // Position - 0x27ECA
{
	switch (iParam0)
	{
		case 2:
...
void func_255(int iParam0) // Position - 0x27FD6
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x281AC
{
	int num;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x281CC
{
	BOOL flag;
	int num;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x282CF
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_237(num6, iParam0, 26, hParam1);
			return;
	}
...
void func_259(int iParam0, Hash hParam1) // Position - 0x28580
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2B33F
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_237(num6, iParam0, 7, hParam1);
			return;
	}
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2B460
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2BD58
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2C010
{
	BOOL flag;
	int value;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2D64D
{
	BOOL flag;
	int value;
	var unk;
...
void func_265(int iParam0, Hash hParam1) // Position - 0x2EC80
{
	BOOL flag;
	int num;
	var unk;
...
void func_266(int iParam0, Hash hParam1) // Position - 0x2EDD7
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_237(num6, iParam0, 46, hParam1);
			return;
	}
...
void func_267(int iParam0, Hash hParam1) // Position - 0x2F0F3
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 3;
		func_237(num5, iParam0, 241, hParam1);
...
void func_268(int iParam0, Hash hParam1) // Position - 0x315E5
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 3;
		func_237(num5, iParam0, 237, hParam1);
...
void func_269(int iParam0, Hash hParam1) // Position - 0x32B70
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_237(num5, iParam0, 91, hParam1);
			return;
	}
...
void func_270() // Position - 0x33A2A
{
...
BOOL func_271(Ped pedParam0) // Position - 0x33AA3
{
	int num;

	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		num = Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_97.f_28;
	
		if (num != -1 && num < 4)
			if (func_272(num) != -1 && func_272(num) != 0)
				return 1;
	}
...
int func_272(int iParam0) // Position - 0x33B1F
{
	if (func_273(true))
	...
	return Global_2685663.f_6386[iParam0];
}

BOOL func_273(BOOL bParam0) // Position - 0x33B56
{
	if (func_277(bParam0) || func_275() || func_274(*Global_4718592.f_194133))
		return true;

	return false;
}

BOOL func_274(int iParam0) // Position - 0x33B8A
{
	return iParam0 == 87;
}

BOOL func_275() // Position - 0x33B97
{
	return func_276(*Global_4718592.f_134976);
}

int func_276(int iParam0) // Position - 0x33BAD
{
	int i;
...
BOOL func_277(BOOL bParam0) // Position - 0x33BE7
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_186929, 12) && func_278();

	return IS_BIT_SET(*Global_4718592.f_186929, 12);
}

BOOL func_278() // Position - 0x33C1D
{
...
BOOL func_279(Ped pedParam0, BOOL bParam1) // Position - 0x33C4B
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 7:
						case 12:
							num = func_280(joaat("MP_M_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_120(PLAYER::PLAYER_ID(), true) && Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num3 = func_199(pedParam0, 8, PV_COMP_INVALID);
					
						if (num3 >= 241)
						{
							componentHash2 = func_195(joaat("MP_M_Freemode_01"), num3, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num4 = func_280(joaat("MP_F_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num5 = func_199(pedParam0, 11, PV_COMP_INVALID);
					
						if (num5 >= 256)
						{
							componentHash3 = func_195(joaat("MP_F_Freemode_01"), num5, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num6 = func_280(joaat("MP_F_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num7 = func_280(joaat("MP_F_Freemode_01"), 11, func_199(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num8 = func_199(pedParam0, 8, PV_COMP_INVALID);
					
						if (num8 >= 136)
						{
							componentHash4 = func_195(joaat("MP_F_Freemode_01"), num8, 8, 4);
...
int func_280(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34486
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_195(hParam0, iParam2, 11, 3);
				...
				if (componentHash != -1)
				{
					...
					{
						if (iParam3 == 0)
							iParam3 = func_94(1759, -1);
					
						return func_281(iParam3, 3);
					}
				}
			}
		}
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_195(hParam0, iParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_195(hParam0, iParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_195(hParam0, iParam2, 8, 4);
...
int func_281(int iParam0, Hash hParam1) // Position - 0x34CA6
{
...
int func_282(Ped pedParam0) // Position - 0x34CC8
{
...
Player func_283() // Position - 0x34D2B
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x34D49
{
	return Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_285(BOOL bParam0) // Position - 0x34D5E
{
	return func_286(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_286(Player plParam0, BOOL bParam1) // Position - 0x34D70
{
	if (!func_11(plParam0))
		return false;
	...
	return func_11(Global_1887694[plParam0 /*611*/].f_10);
}

BOOL func_287(Player plParam0) // Position - 0x34DA8
{
	if (func_11(plParam0))
		if (func_11(Global_1887694[plParam0 /*611*/].f_10))
...
BOOL func_289(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34DFF
{
...
int func_290(var uParam0) // Position - 0x34E56
{
	return *uParam0;
}

void func_291() // Position - 0x34E61
{
...
void func_292(int iParam0) // Position - 0x34EAC
{
	if (func_46())
		return;
...
void func_293(BOOL bParam0) // Position - 0x34EDF
{
	if (bParam0)
		func_295();
...
void func_294(int iParam0, int iParam1) // Position - 0x34F30
{
	MISC::SET_BIT(&(Global_1673706.f_&_NETWORK_IS_PLAYER_VALID), iParam0);
...
void func_295() // Position - 0x34F66
{
	Global_2739945.f_4668 = 0;
	return;
}

BOOL func_296() // Position - 0x34F76
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x34F8A
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x3500E
{
	switch (func_98())
	{
		case 0:
...
Hash func_299() // Position - 0x35041
{
...
BOOL func_300() // Position - 0x35065
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x35074
{
...
BOOL func_302() // Position - 0x3508B
{
	return Global_2696433;
}

BOOL func_303() // Position - 0x35097
{
	return Global_2684721.f_695;
}

void func_304() // Position - 0x350A6
{
	SYSTEM::WAIT(0);
	return;
}

void func_305() // Position - 0x350B3
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_313(&uLocal_120, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_120, 1);
	func_311(&uLocal_120, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_NIMB_LSA_ISD", 0, 1, 1023, 0);
...
void func_306() // Position - 0x3513B
{
...
void func_307() // Position - 0x3517A
{
	Global_79536 = 0;
	Global_79537 = -1;
	Global_79538 = -1;
...
BOOL func_308() // Position - 0x351A0
{
	return func_309(PLAYER::PLAYER_PED_ID());
}

BOOL func_309(Ped pedParam0) // Position - 0x351B0
{
	int pedDrawableVariation;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x35280
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
void func_311(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x3529E
{
	func_312(uParam0, sParam7, iParam8, iParam9, iParam10);
	uParam0->f_9 = { fParam1 };
...
void func_312(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x352CE
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_313(var uParam0, int iParam1, char* sParam2) // Position - 0x352FB
{
