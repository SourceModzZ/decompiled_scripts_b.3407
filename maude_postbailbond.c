...
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_15(iParam3), iParam4);
	return;
}
...
{
	if (IS_BIT_SET(Global_114135.f_24990, 3))
		return "BB4_loiter";
	else if (IS_BIT_SET(Global_114135.f_24990, 2))
		return "BB3_loiter";
	else if (IS_BIT_SET(Global_114135.f_24990, 1))
		return "BB2_loiter";
	else if (IS_BIT_SET(Global_114135.f_24990, 0))
		return "BB1_loiter";
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1369
{
