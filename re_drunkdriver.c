...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x8B8
{
...
BOOL func_11(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xA2B
{
	Global_22443 = 0;
...
BOOL func_14(Player plParam0) // Position - 0xD93
{
	return func_15(plParam0, 20);
}

BOOL func_15(Player plParam0, int iParam1) // Position - 0xDA3
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0xDBB
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xF49
{
	if (func_28(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xFEB
{
	func_23();
...
BOOL func_24(eCharacter echParam0) // Position - 0x1101
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x110D
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x114A
{
...
Hash func_27(eCharacter echParam0) // Position - 0x116F
{
...
BOOL func_33(char* sParam0) // Position - 0x12C7
{
	var string2;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x13F9
{
...
void func_40(int iParam0, int iParam1) // Position - 0x1421
{
	if (iParam0 == -1)
		iParam0 = func_58();
...
BOOL func_45(int iParam0, int iParam1) // Position - 0x1AE2
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1B33
{
	if (iParam2 == -1)
		iParam2 = func_47();
...
BOOL func_49(int iParam0) // Position - 0x1ED1
{
	switch (iParam0)
	{
		case 29:
...
void func_52(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1F62
{
	int i;
...
BOOL func_55(int iParam0) // Position - 0x2291
{
	int num;
	int i;
...
int func_59(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x23BA
{
...
BOOL func_60() // Position - 0x2594
{
	return true;
}

BOOL func_61() // Position - 0x259D
{
	if (Global_33345)
	{
		func_41(4);
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2605
{
...
int func_70(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2684
{
	int num;
	int num2;
	int num3;
...
int func_72(Entity eParam0) // Position - 0x277A
{
	int i;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (Global_45165[i /*6*/].f_1 == eParam0)
			return i;
	}
...
int func_73(Entity eParam0) // Position - 0x27AB
{
	int i;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (eParam0 == Global_45196[i /*5*/].f_1)
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x29A1
{
...
void func_78(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4BB2
{
	int outValue;
	Hash statHash;
...
void func_82(int iParam0) // Position - 0x555F
{
	int num;
	BOOL flag;
	var txdName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x5729
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x5867
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x5883
{
	Hash statHash;
	int outValue;
...
Hash func_87(int iParam0) // Position - 0x58A1
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_88(int iParam0) // Position - 0x58C3
{
	switch (iParam0)
	{
		case 38:
...
int func_89(int iParam0) // Position - 0x58E0
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_90(int iParam0) // Position - 0x59E5
{
	switch (iParam0)
	{
		case 18:
...
void func_91(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x5A74
{
	Hash statName;
...
Hash func_92(int iParam0, int iParam1) // Position - 0x5AA2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_93(iParam1));
}

int func_93(int iParam0) // Position - 0x5AB7
{
	int num;
	int num2;
...
void func_94(int iParam0) // Position - 0x5AEB
{
	func_113(93, iParam0);
	func_113(29, iParam0);
	func_113(30, iParam0);
...
BOOL func_95(int iParam0) // Position - 0x5B0B
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_96(int iParam0, int iParam1) // Position - 0x5D16
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x5D45
{
	if (iParam1 == -1)
		iParam1 = func_47();
...
int func_98(BOOL bParam0) // Position - 0x5D61
{
	var outValue;
	int value;
	int outValue2;
...
int func_99(int iParam0, int iParam1) // Position - 0x5E18
{
	if (iParam0 >= 78)
		return 0;
...
int func_100(int iParam0, int iParam1) // Position - 0x5E33
{
	...
	if (func_110(&Global_4546323))
	{
		if (func_108(&Global_4546323, iParam0))
			return 0;
...
BOOL func_101(var uParam0, int iParam1) // Position - 0x5ED0
{
	int i;
	var unk;
...
int func_102(var uParam0, int iParam1) // Position - 0x5F81
{
	int i;
...
BOOL func_103(var uParam0, int iParam1) // Position - 0x5FFC
{
	return uParam0->[iParam1] == 78;
}

void func_104(var uParam0) // Position - 0x600D
{
	int i;
	...
	func_106(uParam0, Global_4546322 - 0.5f);
	return;
}

void func_105(var uParam0, int iParam1) // Position - 0x6041
{
	uParam0->[iParam1] = 78;
	return;
}

void func_106(var uParam0, int iParam1) // Position - 0x6051
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_107(var uParam0) // Position - 0x606E
{
	return uParam0->f_80;
}

BOOL func_108(var uParam0, int iParam1) // Position - 0x607A
{
	return func_109(uParam0, iParam1) != -1;
}

int func_109(var uParam0, int iParam1) // Position - 0x608C
{
	int i;
...
BOOL func_110(var uParam0) // Position - 0x60B9
{
	return uParam0->f_79 == 1;
}

BOOL func_111(int iParam0) // Position - 0x60C7
{
	switch (iParam0)
	{
		case 60:
...
void func_112(Hash hParam0, int iParam1) // Position - 0x6117
{
	int outValue;
...
void func_113(int iParam0, int iParam1) // Position - 0x613A
{
	int outValue;
...
int func_115(eCharacter echParam0) // Position - 0x620C
{
	return Global_2201[echParam0 /*29*/].f_17;
}

void func_116() // Position - 0x621D
{
...
BOOL func_118(int iParam0) // Position - 0x6AB2
{
...
void func_120(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6B2E
{
	if (bParam0)
	{
...
BOOL func_121() // Position - 0x6C7D
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_122(Player plParam0, int iParam1) // Position - 0x6C97
{
	BOOL flag;
...
int func_123(int iParam0, BOOL bParam1) // Position - 0x6CF0
{
	int num;
	int num2;
...
BOOL func_124(Player plParam0) // Position - 0x6D31
{
	Player player;
...
BOOL func_125(Player plParam0) // Position - 0x6D53
{
...
BOOL func_126() // Position - 0x6D92
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_127(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6DA0
{
	int num;
...
void func_128(int iParam0) // Position - 0x6DD3
{
	if (iParam0 == 1)
...
BOOL func_132(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7449
{
	Vehicle vehiclePedIsIn;
...
void func_136() // Position - 0x7D7D
{
	Global_23848.f_134 = 1;
	return;
}

BOOL func_137() // Position - 0x7D8B
{
	Vehicle vehiclePedIsIn;
...
BOOL func_138(int iParam0) // Position - 0x7E08
{
	int num;
	int num2;
...
BOOL func_140(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x7ED3
{
	if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
	{
		if (func_65() && !Global_33347)
		{
			if (fLocal_45 == -1f)
...
void func_143(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x81AF
{
...
Vector3 func_144(float fParam0, var uParam1, var uParam2, int iParam3) // Position - 0x8392
{
	float num;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x8BC8
{
...
Blip func_150(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x8BDF
{
	Blip blip;
...
var func_151(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C0B
{
	if (bParam0)
		return uParam1;
...
float func_153(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0x8D46
{
...
void func_155(Ped pedParam0, var uParam1) // Position - 0x8DC0
{
	switch (*uParam1)
	{
		case 0:
...
Blip func_158(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9055
{
	return func_159(veParam0, !bParam1, bParam2);
}

Blip func_159(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9068
{
	Blip blip;
...
void func_164(BOOL bParam0) // Position - 0x91FC
{
	if (bParam0)
	{
...
int func_165(BOOL bParam0) // Position - 0x9228
{
	if (func_168())
	{
		Global_114152 = true;
		...
		if (func_49(Global_114151))
			func_166(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_49(Global_114151))
...
void func_166(int iParam0) // Position - 0x927B
{
	switch (iParam0)
	{
		case 0:
...
char* func_167(int iParam0) // Position - 0x9356
{
	char* str;
...
BOOL func_168() // Position - 0x9398
{
	switch (func_169(&Global_33165, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_169(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x93CE
{
	int i;
...
void func_170(var uParam0, int iParam1) // Position - 0x9505
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x9554
{
	return func_172(iParam0, Global_44199);
}

BOOL func_172(int iParam0, int iParam1) // Position - 0x9565
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_173(int iParam0) // Position - 0x9746
{
	if (Global_44199 == 15)
		return false;
...
int func_174(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x9768
{
	func_32(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
...
Blip func_175(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0x97BB
{
	Blip blip;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9F48
{
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x9FE3
{
	if (bParam1)
...
void func_183(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA01A
{
	int address;
...
int func_184(int iParam0) // Position - 0xA08A
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA441
{
	int address;
...
BOOL func_186(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA4B1
{
	if (iParam0 == -1)
		return false;
...
BOOL func_189() // Position - 0xA7CA
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_200())
			return false;
	}
...
int func_190(float fParam0, BOOL bParam1) // Position - 0xA850
{
	var unk;
	int num;
	int num2;
...
void func_191(int iParam0, var uParam1) // Position - 0xA901
{
	switch (iParam0)
	{
		case 0:
...
int func_193(int iParam0) // Position - 0xBB07
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_194(int iParam0) // Position - 0xBE4D
{
	var unk;
	var unk3;
...
struct<2> func_195(int iParam0) // Position - 0xBE83
{
	var unk;
...
BOOL func_197() // Position - 0xC470
{
	return Global_113880 > 0;
}

BOOL func_198() // Position - 0xC47E
{
	if (Global_98610 != -1)
		return true;
...
BOOL func_202() // Position - 0xC535
{
	if (Global_114151 == func_58() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114152)
		return true;

	return false;
}

void func_203(int iParam0) // Position - 0xC560
{
	if (iParam0 == -1)
		iParam0 = func_58();
...
void func_205(int iParam0) // Position - 0xC5D3
{
	Global_114151 = iParam0;
	return;
}

BOOL func_206(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xC5E1
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (!func_242(Global_114162.f_24999.f_43[iParam3]))
			return false;
...
BOOL func_207(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC97B
{
	if (bParam6)
...
BOOL func_208(eCharacter echParam0) // Position - 0xC9C2
{
	int num;
...
BOOL func_209(int iParam0) // Position - 0xC9E3
{
	return func_210(iParam0, 1);
}

int func_210(int iParam0, int iParam1) // Position - 0xC9F2
{
	var unk;
	var unk2;
	int num;
...
void func_211(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xCA45
{
	func_212(func_223(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_212(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xCA63
{
	int num;
	int num2;
	int num3;
	...
	while (num5 < 0)
	{
		...
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_213(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_213(float fParam0, float fParam1, float fParam2) // Position - 0xCC64
{
	float num;
...
int func_214(int iParam0, int iParam1) // Position - 0xCCA6
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_215(int iParam0) // Position - 0xCD48
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_216(int iParam0) // Position - 0xCD5B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_217(int iParam0) // Position - 0xCD6E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_218(int iParam0) // Position - 0xCD81
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_219(int iParam0) // Position - 0xCD93
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_220(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCDB5
{
	if (bParam0)
		return uParam1;
...
int func_221(int iParam0) // Position - 0xCDCC
{
	return iParam0 & 15;
}

BOOL func_222(int iParam0, int iParam1) // Position - 0xCDD9
{
	int num;
	int num2;
...
void func_224(var uParam0, int iParam1) // Position - 0xCF2B
{
	if (iParam1 <= 0)
		return;
...
void func_225(var uParam0, int iParam1) // Position - 0xCFB1
{
...
void func_226(var uParam0, int iParam1) // Position - 0xCFE4
{
	int num;
	int num2;
...
void func_227(var uParam0, int iParam1) // Position - 0xD035
{
...
void func_228(var uParam0, int iParam1) // Position - 0xD06F
{
...
void func_229(var uParam0, int iParam1) // Position - 0xD0AA
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_230(int iParam0) // Position - 0xD0E6
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(int iParam0, int iParam1) // Position - 0xD1C2
{
...
BOOL func_232(int iParam0) // Position - 0xD1E2
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_240() || Global_113209 || Global_33108 || func_239() || func_30(8, -1) || func_238() || func_237() || func_236() || func_235() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_240() || Global_33108 || func_239() || func_30(8, -1) || func_236() || func_238() || func_237() || func_235() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_240() || Global_113209 || Global_33108 || func_239() || func_30(8, -1) || func_236() || func_238() || func_237() || func_235() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_240() || Global_113209 || Global_33108 || func_239() || func_30(8, -1) || func_238() || func_237() || func_235() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_240() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_30(8, -1) || func_235() || func_234() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_240() || Global_33108 || func_239() || func_30(8, -1) || func_237() || func_236() || func_235() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_240() || func_237() || Global_113209 || Global_33108 || func_239() || Global_45410 || func_30(8, -1) || func_236() || func_234() || func_235() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_240() || Global_113209 || Global_33108 || func_239() || func_30(8, -1) || func_236() || func_234() || func_238() || func_237() || func_235())
							return false;
						break;
				}
			}
...
BOOL func_233() // Position - 0xD8FF
{
	return Global_101752.f_1;
}

BOOL func_234() // Position - 0xD90D
{
	if (Global_98610 != -1)
...
BOOL func_237() // Position - 0xD974
{
	return Global_101765.f_400 > 0;
}

BOOL func_238() // Position - 0xD985
{
	return Global_101765.f_399 > 0;
}

BOOL func_239() // Position - 0xD996
{
	return Global_1575086;
}

BOOL func_240() // Position - 0xD9A2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_242(int iParam0) // Position - 0xD9E6
{
	return func_222(func_223(), iParam0);
}

BOOL func_243(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xD9F8
{
	BOOL num;
	eCharacter character;
...
int func_244(eCharacter echParam0) // Position - 0xDADC
{
...
BOOL func_245(int iParam0) // Position - 0xDB00
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xDB9C
{
	int profileSetting;
...
void func_249(int iParam0) // Position - 0xDEE8
{
	var name;
	...
	if (func_202())
	{
		...
		func_252(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_251(Global_114151, true), 64);
	
		if (func_57(Global_114151) > 0)
		{
	...
	func_250(&Global_33165);
	Global_114152 = false;
	func_205(-1);
	return;
}

void func_250(var uParam0) // Position - 0xDF9A
{
	if (*uParam0 == -1)
		return;
...
char* func_251(int iParam0, BOOL bParam1) // Position - 0xDFD7
{
	switch (iParam0)
	{
		case 0:
...
void func_252(int iParam0) // Position - 0xE220
{
	Global_44750 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_253(int iParam0) // Position - 0xE232
{
	func_254(iParam0, 0, func_259(iParam0));
	return;
}

void func_254(int iParam0, int iParam1, int iParam2) // Position - 0xE247
{
	int unk;
	var unk2;
...
struct<16> func_255(var uParam0) // Position - 0xE276
{
	var unk;
	int num;
...
void func_256(int iParam0, var uParam1) // Position - 0xE345
{
	Global_114162.f_24999.f_43[iParam0] = *uParam1;
	return;
}

void func_257(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE35D
{
	int num;
	int i;
	int num2;
...
void func_258(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE4DF
{
...
int func_259(int iParam0) // Position - 0xE517
{
	int num;
...
int func_260(Vehicle veParam0, int iParam1, eCharacter echParam2) // Position - 0xE6BA
{
	var script;
...
void func_261(Vehicle veParam0, int iParam1) // Position - 0xE6FA
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_262(veParam0, &(Global_114162.f_32754.f_5510));
	return;
}

void func_262(Vehicle veParam0, var uParam1) // Position - 0xE8FC
{
	int i;
...
int func_263(int iParam0) // Position - 0xEBA7
{
	switch (iParam0)
	{
		case 1:
...
int func_264(var uParam0, var uParam1, var uParam2) // Position - 0xEC57
{
	int i;
	int modType;
...
BOOL func_265(int iParam0) // Position - 0xEE4A
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_266(var uParam0) // Position - 0xEE6A
{
	int i;
...
BOOL func_267(Vehicle veParam0) // Position - 0xEF19
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_284(veParam0, 0, false) || func_284(veParam0, 1, false) || func_284(veParam0, 2, false) || func_283(veParam0) != 145 || func_282(veParam0) || func_281(veParam0) || func_280(veParam0) || func_279(veParam0) || !func_268(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_281(veParam0);
		func_281(veParam0);
...
BOOL func_268(Hash hParam0) // Position - 0xEFF6
{
	if (hParam0 == 0)
		return false;
...
BOOL func_269(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xF1B4
{
	int i;
	Hash outData;
...
BOOL func_270(Hash hParam0) // Position - 0xF339
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xF405
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_272(Hash hParam0, int iParam1) // Position - 0xF41C
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xF649
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xF65F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_275() // Position - 0xF675
{
	return false;
}

BOOL func_276() // Position - 0xF67E
{
	return true;
}

BOOL func_277() // Position - 0xF687
{
	return true;
}

BOOL func_278() // Position - 0xF690
{
...
BOOL func_279(Vehicle veParam0) // Position - 0xF6A9
{
	Hash entityModel;
...
BOOL func_280(Vehicle veParam0) // Position - 0xF6F0
{
	int i;
...
BOOL func_281(Vehicle veParam0) // Position - 0xF72B
{
	int i;
...
BOOL func_282(Vehicle veParam0) // Position - 0xF7A7
{
	int i;
...
int func_283(Vehicle veParam0) // Position - 0xF88F
{
	int i;
...
BOOL func_284(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xF8F2
{
	int i;
	var garageName;
	int num;
...
BOOL func_285(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xF960
{
...
void func_287(BOOL bParam0) // Position - 0xFA53
{
	int i;
...
Vector3 func_288() // Position - 0xFA76
{
	float distanceBetweenCoords;
