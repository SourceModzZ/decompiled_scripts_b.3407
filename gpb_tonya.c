...
void main() // Position - 0x0
{
	...
	if (MISC::GET_GAME_TIMER() < Global_33370 + 10000 && !func_107())
		func_115(0);
	...
	Global_33370 = MISC::GET_GAME_TIMER();
	...
	while (num == 1)
	{
		...
		if (bLocal_502)
		{
			...
			TEXT_LABEL_APPEND_INT(&text, Global_114107[iLocal_249], 64);
			...
			TEXT_LABEL_APPEND_INT(&text, uLocal_253[Global_114107[iLocal_249]], 64);
		...
		switch (iLocal_248)
		{
			...
			case 8:
				...
				else if (!func_62())
				{
					...
					if (iLocal_295 < uLocal_253[Global_114107[iLocal_249]] && flag4)
					{
						func_63();
						iLocal_248 = 7;
					}
				...
				else if (bLocal_438 == true)
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_238, &uLocal_370, &uLocal_354, 3))
						func_52(Global_114107[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_238, &uLocal_370, &uLocal_354));
				}
				break;
			...
			case 9:
				...
				{
					if (bLocal_501)
						Global_114107[iLocal_249] = iLocal_500;
					else
						Global_114107[iLocal_249] = Global_114107[iLocal_249] + 1;
				
					if (!(Global_114107[iLocal_249] < iLocal_250))
						Global_114107[iLocal_249] = 0;
...
void func_17() // Position - 0x162F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(character) && !func_18(14) || Global_113110)
			{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1746
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1783
{
...
Hash func_22(eCharacter echParam0) // Position - 0x17A8
{
...
BOOL func_37(Player plParam0) // Position - 0x1ECD
{
	return func_38(plParam0, 20);
}

BOOL func_38(Player plParam0, int iParam1) // Position - 0x1EDD
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2244
{
...
void func_52(int iParam0, int iParam1, float fParam2) // Position - 0x231F
{
	return;
}
...
void func_54() // Position - 0x2336
{
	...
	func_57(Global_114107[iLocal_249] + 1, &unk, &animationName);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(pedLocal_238, false, false);
	func_55(Global_114107[iLocal_249]);
	return;
}
...
void func_56(const char* sParam0) // Position - 0x23B4
{
...
int func_58() // Position - 0x2444
{
	...
	unk = { uLocal_306 };
	TEXT_LABEL_APPEND_INT(&unk, Global_114107[iLocal_249] + 1, 16);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_35, 3, pedLocal_238, &uLocal_234, 0, 1);
...
void func_66(char* sParam0) // Position - 0x257D
{
	...
	TEXT_LABEL_APPEND_INT(sParam0, Global_114107[iLocal_249] + 1, 16);
	return;
}

void func_67(Hash hParam0, BOOL bParam1) // Position - 0x259B
{
	int num;
...
void func_68(int iParam0, BOOL bParam1) // Position - 0x25BC
{
	...
	if (offset >= 0 && offset <= 31)
	{
		if (func_77(iParam0))
		{
			if (!func_75(iParam0))
			{
				MISC::SET_BIT(&(Global_114162.f_26438.f_2), offset);
...
{
	if (func_77(iParam0))
		return IS_BIT_SET(Global_114162.f_26438.f_2, iParam0);
...
BOOL func_76(int iParam0) // Position - 0x2AA0
{
	...
	if (num >= 0 && num <= 31)
		return IS_BIT_SET(Global_114162.f_26438.f_2, num);
...
int func_78(Hash hParam0) // Position - 0x2AFA
{
	switch (hParam0)
	{
...
void func_79(Blip* pblParam0) // Position - 0x2BB8
{
	if (iLocal_445 == 1)
...
Blip func_81(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0x2C2A
{
	Blip blip;
...
Blip func_82(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C74
{
	Blip blip;
...
float func_84(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x2D2F
{
	Vector3 entityCoords;
...
BOOL func_85(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x2D8D
{
	var unk;
...
int func_88(Ped pedParam0) // Position - 0x2E7E
{
	int weaponHash;
...
float func_96(Ped pedParam0, Ped pedParam1) // Position - 0x2F1D
{
...
void func_97(int iParam0) // Position - 0x2F2E
{
	...
	func_100(&(Global_114162.f_20121), iParam0);
	num = func_98(iParam0);
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x30C6
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
{
	if (IS_BIT_SET(Global_114162.f_18578[58 /*6*/], 0) && !IS_BIT_SET(Global_114162.f_18578[58 /*6*/], 3))
		return true;
...
{
	if (IS_BIT_SET(Global_114162.f_18578[60 /*6*/], 0) && !IS_BIT_SET(Global_114162.f_18578[60 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114162.f_18578[61 /*6*/], 0) && !IS_BIT_SET(Global_114162.f_18578[61 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114162.f_18578[62 /*6*/], 3))
		return false;

	if (IS_BIT_SET(Global_114162.f_18578[58 /*6*/], 2) || IS_BIT_SET(Global_114162.f_18578[59 /*6*/], 2) || IS_BIT_SET(Global_114162.f_18578[62 /*6*/], 2))
		return true;
...
{
	return func_113(Global_114162.f_20121, iParam0);
}
...
int func_114(const char* sParam0) // Position - 0x3311
{
...
void func_116(Blip* pblParam0) // Position - 0x3507
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
