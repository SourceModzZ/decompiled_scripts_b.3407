	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A31
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28DC
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2964
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48AC
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x562D
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5668
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58DC
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E67
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B0E
{
	int i;
...
int func_97() // Position - 0x8879
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8889
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88A6
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88B6
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BF9
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8C0A
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C50
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CD6
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D09
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D5A
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DFC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E1E
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E35
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E42
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E7C
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8EB7
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8EF3
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F0C
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F6F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F85
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F9B
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FDD
{
...
struct<2> func_119(int iParam0) // Position - 0x9005
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9452
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA72A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA70
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB15
{
	var name;
...
void func_125(int iParam0) // Position - 0xABB0
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAC0E
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC67
{
...
int func_129(Ped pedParam0) // Position - 0xACEA
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD1B
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD30
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADE3
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADFE
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE4A
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE93
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAEB3
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAED4
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAFA4
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFF7
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0ED
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB158
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB197
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2E6
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB300
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB359
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB39A
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB3BC
{
...
BOOL func_150() // Position - 0xB3FB
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB409
{
	int num;
...
void func_153(int iParam0) // Position - 0xB463
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB486
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB52A
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5B9
{
...
void func_161(Vehicle veParam0) // Position - 0xB610
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB63C
{
...
void func_164(int iParam0) // Position - 0xB7DE
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB811
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB89B
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB90F
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB91D
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB974
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB983
{
...
BOOL func_171(int iParam0) // Position - 0xB9C4
{
	int num;
...
void func_172(int iParam0) // Position - 0xBA09
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA3B
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBB72
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBC1
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBBD2
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBDB3
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBDD5
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBDE6
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE2F
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBE53
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC637
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC652
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC6E0
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC744
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC7DB
{
...
BOOL func_187(int iParam0) // Position - 0xC805
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCF22
{
	return Global_101752.f_1;
}

BOOL func_189() // Position - 0xCF30
{
	if (Global_98610 != -1)
...
BOOL func_192() // Position - 0xCF97
{
	return Global_101765.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCFA8
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCFE0
{
	return Global_1575086;
}

BOOL func_195() // Position - 0xCFEC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD008
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD090
{
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD0CB
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD121
{
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD1BC
{
	Vector3 entityCoords;
...
void func_201(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD1F6
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_202(int iParam0, BOOL bParam1) // Position - 0xD2E7
{
	if (iParam0 == -1)
		return;
...
int func_203(int iParam0) // Position - 0xD323
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_204(var uParam0, int iParam1) // Position - 0xD35C
{
	BOOL flag;
	int i;
...
BOOL func_205() // Position - 0xD3FA
{
	return Global_98997;
}

void func_206(var uParam0) // Position - 0xD406
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(uParam0);
...
void func_207(var uParam0) // Position - 0xD41D
{
	BOOL flag;
	int num;
	int i;
...
void func_208(int iParam0) // Position - 0xD505
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD52D
{
	var unk;
	...
	if (func_246(*panParam0) || func_244(*panParam0) || Global_79810 == 1)
		return true;
...
void func_210(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD79D
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_211(int iParam0) // Position - 0xDAF5
{
...
BOOL func_212(var uParam0) // Position - 0xDB15
{
...
BOOL func_213(var uParam0) // Position - 0xDB2D
{
...
void func_214(var uParam0) // Position - 0xDB52
{
	int i;
	int taskSequenceId;
...
void func_215(Object* pobParam0) // Position - 0xDE56
{
...
void func_216(var uParam0) // Position - 0xDE81
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDF01
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_218(Ped pedParam0, Vehicle veParam1) // Position - 0xE0BF
{
...
BOOL func_219(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0EF
{
	int i;
	int num;
...
BOOL func_220(int iParam0) // Position - 0xE3AB
{
...
BOOL func_221(Ped pedParam0, int iParam1) // Position - 0xE3DF
{
	float xSize;
...
BOOL func_222(Ped pedParam0, int iParam1) // Position - 0xE455
{
	return func_223(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE46D
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_224(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE52E
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_225(Ped pedParam0, int iParam1) // Position - 0xE65A
{
...
BOOL func_227(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE769
{
	var unk;
...
float func_228(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE7FA
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_229(float fParam0, var uParam1, var uParam2) // Position - 0xE81B
{
	float num;
	float num2;
...
void func_230(var uParam0) // Position - 0xE85A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(Ped pedParam0, Ped pedParam1) // Position - 0xE875
{
	int i;
...
BOOL func_232(Ped pedParam0) // Position - 0xE8B4
{
...
BOOL func_233(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8DC
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_234(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9D7
{
	float entityCoords;
	float num;
...
BOOL func_235(Ped pedParam0, float fParam1) // Position - 0xEAE3
{
	var outProjectile;
	var outCoords;
...
BOOL func_236(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB78
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_237(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEC06
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_238(int iParam0) // Position - 0xEC4E
{
...
void func_239(Vehicle veParam0) // Position - 0xEC98
{
	int taskSequenceId;
...
BOOL func_240(int iParam0) // Position - 0xED35
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_241(int iParam0) // Position - 0xEDCA
{
...
BOOL func_244(int iParam0) // Position - 0xEE49
{
	if (func_245() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_245() // Position - 0xEE7D
{
...
BOOL func_246(int iParam0) // Position - 0xEEBB
{
...
BOOL func_247(var uParam0) // Position - 0xEEE3
{
	switch (*uParam0)
	{
		case 25:
...
BOOL func_248(var uParam0) // Position - 0xEF2A
{
	int num;
	int i;
	BOOL flag;
...
void func_249(Vehicle* pveParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xF15F
{
...
void func_250(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF1C5
{
	func_251(pveParam0);
...
void func_251(Vehicle* pveParam0) // Position - 0xF208
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_252(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF2A4
{
...
BOOL func_253(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF300
{
	Hash model;
...
int func_254(var uParam0, eCharacter echParam1) // Position - 0xF38E
{
	int num;
...
BOOL func_255(var uParam0) // Position - 0xF3D4
{
	int i;
...
BOOL func_256(var uParam0) // Position - 0xF405
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_257(var uParam0) // Position - 0xF6BB
{
	if (func_213(uParam0))
	{
...
void func_258(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF6E5
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_259(int iParam0) // Position - 0xF721
{
	var unk;
	eCharacter character;
...
BOOL func_260(int iParam0) // Position - 0xF772
{
	const char* string2;
...
BOOL func_261(int iParam0) // Position - 0xF82B
{
	var unk;
...
BOOL func_262(int iParam0) // Position - 0xF8EC
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_263(int iParam0, char* sParam1) // Position - 0xF971
{
...
BOOL func_264(int iParam0) // Position - 0xFA53
{
...
BOOL func_265(int iParam0) // Position - 0xFA7E
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_266(int iParam0) // Position - 0xFAA9
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_267(int iParam0) // Position - 0xFAD4
{
	if (func_241(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_269(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xFB23
{
	int i;
...
BOOL func_270(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xFB88
{
	int num;
	char* str;
...
BOOL func_271(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFC00
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xFC7B
{
	if (bParam1)
	{
...
void func_273(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFCC8
{
...
void func_274(var uParam0, BOOL bParam1) // Position - 0xFCE8
{
	func_275(&(uParam0->f_41), bParam1);
	return;
}

void func_275(var uParam0, BOOL bParam1) // Position - 0xFCFA
{
	int i;
...
void func_276(Object* pobParam0, BOOL bParam1) // Position - 0xFD38
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_277(var uParam0, BOOL bParam1) // Position - 0xFD73
{
	func_278(&(uParam0->f_35), bParam1);
	return;
}

void func_278(var uParam0, BOOL bParam1) // Position - 0xFD85
{
	int i;
...
void func_279(Vehicle* pveParam0) // Position - 0xFDC2
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_280(var uParam0, int iParam1) // Position - 0xFDFA
{
	func_281(&(uParam0->f_28), iParam1);
	return;
}

void func_281(var uParam0, int iParam1) // Position - 0xFE0C
{
	int i;
...
void func_282(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFE4D
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_283(Ped* ppedParam0) // Position - 0xFE9D
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_284(int iParam0) // Position - 0xFEDE
{
	if (*iParam0 == -1)
		return;
...
void func_285(char* sParam0) // Position - 0xFF1B
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_286(var uParam0) // Position - 0xFF2D
{
	*uParam0 = -1;
...
Hash func_288(eCharacter echParam0) // Position - 0xFF7A
{
	if (!func_36(echParam0))
