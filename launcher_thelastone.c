...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_264(&unk64, &num, unk61, 1f))
	{
		func_263();
	...
	while (true)
	{
		...
		func_210(num);
		func_203(&iLocal_91, &uLocal_92, &(num.f_9), unk61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_196(&num, unk61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
void func_3(int iParam0, var uParam1) // Position - 0x30D
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xB8F
{
	var unk;
...
void func_21(var uParam0) // Position - 0xC86
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCB6
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x198F
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x283A
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x28C2
{
...
BOOL func_29(var uParam0) // Position - 0x2902
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2930
{
...
int func_31(var uParam0) // Position - 0x2A0C
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A4E
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2AB1
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B3F
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2DE9
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3408
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3537
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x367E
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36BB
{
...
int func_47(eCharacter echParam0) // Position - 0x36E0
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x36EF
{
...
var func_50(int iParam0, int iParam1) // Position - 0x38B8
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3931
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3946
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E8F
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x41F5
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x42E8
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x4809
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x558A
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x55C5
{
	int num;
...
void func_67(int iParam0) // Position - 0x5839
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5875
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC4
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E08
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6587
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65CE
{
...
BOOL func_73(int iParam0) // Position - 0x6629
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6639
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6699
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A50
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6A5B
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A6B
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B0D
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_86(Player plParam0) // Position - 0x75FF
{
...
BOOL func_94(Player plParam0) // Position - 0x84B6
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
int func_97() // Position - 0x879E
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x87AE
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x87CB
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x87DB
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_115() // Position - 0x8E94
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8EAA
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8EC0
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F02
{
...
struct<2> func_119(int iParam0) // Position - 0x8F2A
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9377
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA64F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA995
{
	int num;
...
void func_124(int iParam0) // Position - 0xAA3A
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAAD5
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAB33
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB8C
{
...
int func_129(int iParam0) // Position - 0xAC0F
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC40
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC55
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD08
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD23
{
	int i;
...
int func_135(int iParam0) // Position - 0xAD6F
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xADB8
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xADD8
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xADF9
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAEC9
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAF1C
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0BC
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB20B
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB225
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB27E
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB2BF
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2E1
{
...
BOOL func_150() // Position - 0xB320
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB32E
{
	int num;
...
void func_153(int iParam0) // Position - 0xB388
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB3AB
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB44F
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4DE
{
...
void func_161(var uParam0) // Position - 0xB535
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB561
{
...
void func_164(int iParam0) // Position - 0xB703
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB736
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB7C0
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB834
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB842
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB899
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB8A8
{
...
BOOL func_171(int iParam0) // Position - 0xB8E9
{
	int num;
...
void func_172(int iParam0) // Position - 0xB92E
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB960
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA97
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAE6
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBAF7
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBCD8
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBCFA
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBD0B
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD54
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD78
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC55F
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC57A
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC608
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC66C
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC703
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC72D
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCE4A
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCE58
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCEBF
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCED0
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCF08
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCF14
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_196(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xCF30
{
	var unk;
	...
	if (func_187(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_202(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
			{
				unk = 16;
		...
		else if (func_197(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
				if (func_202(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
					func_155();
		}
	}
...
BOOL func_197(char* sParam0) // Position - 0xCFF2
{
	var unk;
...
struct<6> func_198() // Position - 0xD012
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD036
{
...
void func_200(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD071
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0C7
{
...
float func_202(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD162
{
	var unk;
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD19C
{
	float num;
	float num2;
	float num3;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_202(unk_0x4A8C381C258A124D(), uParam3, 1) <= 100f)
					func_206(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_202(unk_0x4A8C381C258A124D(), fParam6, 1);
					num2 = func_202(unk_0x4A8C381C258A124D(), fParam9, 1);
					num3 = num - num2;
				...
				if (func_202(unk_0x4A8C381C258A124D(), uParam3, 1) > 120f)
					func_207(uParam0);
			}
		}
	}
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD2BA
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD2F6
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD32F
{
	BOOL flag;
	int i;
...
void func_207(var uParam0) // Position - 0xD3CD
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_208(uParam0);
...
void func_208(var uParam0) // Position - 0xD3E4
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_209() // Position - 0xD4CC
{
	return Global_98972;
}

void func_210(int iParam0) // Position - 0xD4D8
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD500
{
	var unk;
...
void func_212(int iParam0, var uParam1, int iParam2) // Position - 0xD770
{
	var unk;
	var unk2;
...
BOOL func_213(int iParam0) // Position - 0xDAC8
{
...
BOOL func_214(var uParam0) // Position - 0xDAE8
{
...
BOOL func_215(var uParam0) // Position - 0xDB00
{
...
void func_216(var uParam0) // Position - 0xDB25
{
	int i;
	var unk;
...
void func_217(var uParam0) // Position - 0xDE29
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_218(var uParam0) // Position - 0xDE54
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDED4
{
	int i;
	int num;
	var unk;
...
BOOL func_220(var uParam0, var uParam1) // Position - 0xE092
{
	var unk;
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE0C2
{
	int i;
	int num;
...
BOOL func_222(int iParam0) // Position - 0xE37E
{
...
BOOL func_223(var uParam0, int iParam1) // Position - 0xE3B2
{
	float num;
...
BOOL func_224(var uParam0, int iParam1) // Position - 0xE428
{
	return func_225(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_225(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE440
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE501
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_227(var uParam0, int iParam1) // Position - 0xE62D
{
	int num;
...
BOOL func_229(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE73C
{
	var unk;
	var unk4;
	float num;
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE7CD
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE7EE
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE82D
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(var uParam0, var uParam1) // Position - 0xE848
{
	int i;
...
int func_234(var uParam0) // Position - 0xE887
{
...
BOOL func_235(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8AF
{
	float num;
	float num2;
	int num3;
...
BOOL func_236(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE9AA
{
	float num;
	float num2;
...
BOOL func_237(var uParam0, float fParam1) // Position - 0xEAB6
{
	var unk;
	var unk2;
...
BOOL func_238(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEB4B
{
	var unk;
	var unk4;
	float num;
...
BOOL func_239(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEBD9
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_240(int iParam0) // Position - 0xEC21
{
...
void func_241(var uParam0) // Position - 0xEC6B
{
	var unk;
...
BOOL func_242(int iParam0) // Position - 0xED08
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xED9D
{
...
BOOL func_246(int iParam0) // Position - 0xEE1C
{
...
BOOL func_248(int iParam0) // Position - 0xEE8E
{
...
BOOL func_249(var uParam0) // Position - 0xEEB6
{
	if (!func_250(uParam0))
		return false;
...
BOOL func_250(var uParam0) // Position - 0xEED5
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_253(&num) || !unk_0xE100DD4F82A51BDE("rcmlastone1") || !unk_0x92A65766A892EFC6(joaat("WEAPON_PUMPSHOTGUN")) || !unk_0x92A65766A892EFC6(joaat("WEAPON_SNIPERRIFLE")))
				return false;
		...
		case 2:
			flag = true;
			uParam0->f_28[0] = unk_0xB1DBFEB95C0EFB88(25, iLocal_90, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
void func_251(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF0C1
{
	func_252(uParam0);
...
void func_252(var uParam0) // Position - 0xF104
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_253(var uParam0) // Position - 0xF1A0
{
	int i;
...
BOOL func_254(int iParam0) // Position - 0xF1D1
{
	var unk;
	eCharacter character;
...
BOOL func_255(int iParam0) // Position - 0xF222
{
	var unk;
...
BOOL func_256(int iParam0) // Position - 0xF2DB
{
	var unk;
...
BOOL func_257(int iParam0) // Position - 0xF39C
{
	int i;
	var unk;
	int num;
...
BOOL func_258(int iParam0, char* sParam1) // Position - 0xF421
{
...
BOOL func_261(int iParam0) // Position - 0xF559
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_262(int iParam0) // Position - 0xF584
{
	if (func_243(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF5D3
{
	int i;
...
BOOL func_265(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF638
{
	int num;
	char* str;
...
BOOL func_266(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF6B0
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_267(var uParam0, BOOL bParam1) // Position - 0xF72B
{
	if (bParam1)
	{
...
int func_268(var uParam0) // Position - 0xF781
{
	if (func_215(uParam0))
	{
...
void func_269(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF7B7
{
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xF7D7
{
	func_271(&(uParam0->f_41), bParam1);
	return;
}

void func_271(var uParam0, BOOL bParam1) // Position - 0xF7E9
{
	int i;
...
void func_272(var uParam0, BOOL bParam1) // Position - 0xF827
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_273(var uParam0, BOOL bParam1) // Position - 0xF862
{
	func_274(&(uParam0->f_35), bParam1);
	return;
}

void func_274(var uParam0, BOOL bParam1) // Position - 0xF874
{
	int i;
...
void func_275(var uParam0) // Position - 0xF8B1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_276(var uParam0, int iParam1) // Position - 0xF8E9
{
	func_277(&(uParam0->f_28), iParam1);
	return;
}

void func_277(var uParam0, int iParam1) // Position - 0xF8FB
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_278(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_278(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF93C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_279(var uParam0) // Position - 0xF98C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_280(int iParam0) // Position - 0xF9CD
{
	if (*iParam0 == -1)
		return;
...
void func_281(char* sParam0) // Position - 0xFA0A
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_282(var uParam0) // Position - 0xFA1C
{
	*uParam0 = -1;
