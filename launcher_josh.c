...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_318(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_298(&unk64, &num, unk61, 1f))
	{
		func_297();
	...
	else if (num == 30)
	{
		...
		uLocal_260 = unk_0x1DD05E817C89C737();
	}
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_229(unk_0x4A8C381C258A124D(), -1102.7241f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_227(num);
		func_220(&iLocal_93, &(num.f_9), unk61);
	
		if (num == 27)
		{
			func_218(&num, unk61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_218(&num, unk61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_218(&num, unk61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_263 == 0)
			{
				if (unk_0xB3FA103AA6383C28())
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[1]))
					{
						...
						unk_0x2F19C4305F0B8DA7("Cop_standing_idle", num.f_28[1], 0);
					}
				
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[2]))
					{
						func_319("Josh 4: Trying to set Cop 2 component variation");
						unk_0x2F19C4305F0B8DA7("Cop_with_notepad", num.f_28[2], 0);
					}
...
void func_3(int iParam0, var uParam1) // Position - 0x497
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xD19
{
	var unk;
...
void func_21(var uParam0) // Position - 0xE10
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xE40
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1B19
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29C4
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2A4C
{
...
BOOL func_29(var uParam0) // Position - 0x2A8C
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2ABA
{
...
int func_31(var uParam0) // Position - 0x2B96
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2BD8
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2C3B
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2CC9
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2F73
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3592
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x36C1
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x3808
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3845
{
...
int func_47(eCharacter echParam0) // Position - 0x386A
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3879
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3A42
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3ABB
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AD0
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x401B
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x4380
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x4473
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x4994
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x5715
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5750
{
	int num;
...
void func_67(int iParam0) // Position - 0x59C4
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5A00
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F4F
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F93
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6712
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6759
{
...
BOOL func_73(int iParam0) // Position - 0x67B4
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x67C4
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6824
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6BDB
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6BE6
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BF6
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C98
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7412
{
...
int func_81() // Position - 0x770D
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x771C
{
...
int func_83() // Position - 0x7746
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x775E
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7773
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x778A
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x77E2
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x788C
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7921
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7965
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7AE9
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7AF7
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x85BF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8641
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8699
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x86A2
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8929
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x8939
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8956
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8966
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8CA9
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8CBA
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8D00
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D86
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8DB9
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8E0A
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8EAC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8ECE
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8EE5
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EF2
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8F2C
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F67
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8FA3
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8FBC
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x901F
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x9035
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x904B
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x908D
{
...
struct<2> func_119(int iParam0) // Position - 0x90B5
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9502
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA7DA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAB20
{
	int num;
...
void func_124(int iParam0) // Position - 0xABC5
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAC60
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xACBE
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAD17
{
...
int func_129(int iParam0) // Position - 0xAD9A
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xADCB
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADE0
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE93
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAEAE
{
	int i;
...
int func_135(int iParam0) // Position - 0xAEFA
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAF43
{
...
BOOL func_137(int iParam0) // Position - 0xAF63
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xB033
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xB086
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB17C
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB1E7
{
	var unk;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB226
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB375
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_145(int iParam0, int iParam1) // Position - 0xB38F
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB3E8
{
	int num;
	int num2;
...
BOOL func_147(int iParam0) // Position - 0xB429
{
	int num;
...
BOOL func_148(int iParam0) // Position - 0xB44B
{
...
BOOL func_149() // Position - 0xB48A
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB498
{
	int num;
...
void func_152(int iParam0) // Position - 0xB4F2
{
	if (iParam0 == 1)
...
BOOL func_153(var uParam0) // Position - 0xB515
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5B9
{
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB648
{
...
void func_160(var uParam0) // Position - 0xB69F
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB6CB
{
...
void func_163(int iParam0) // Position - 0xB86D
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB8A0
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB92A
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB99E
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_167(int iParam0) // Position - 0xB9AC
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xBA03
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_169(int iParam0) // Position - 0xBA12
{
...
BOOL func_170(int iParam0) // Position - 0xBA53
{
	int num;
...
void func_171(int iParam0) // Position - 0xBA98
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBACA
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBC01
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC50
{
	return func_175(iParam0, Global_44181);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBC61
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBE42
{
	if (Global_44181 == 15)
		return false;
...
int func_177() // Position - 0xBE64
{
	return func_178(unk_0x1AF90EB93E0012D6(), 0);
}

int func_178(var uParam0, int iParam1) // Position - 0xBE75
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBEBE
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBEE2
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC353
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC37F
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC396
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0) // Position - 0xC425
{
	if (*uParam0 == 30)
	{
...
float func_185(var uParam0, var uParam1, int iParam2) // Position - 0xC4A4
{
	var unk;
	var unk4;
...
BOOL func_186(var uParam0) // Position - 0xC502
{
	if (*uParam0 == 29)
	{
		if (func_229(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if (!func_187(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_159(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 1f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
BOOL func_187(var uParam0, int iParam1) // Position - 0xC595
{
	if (func_136(uParam0))
...
int func_188(var uParam0) // Position - 0xC5C8
{
	if (*uParam0 == 28)
	{
		if (func_229(unk_0x4A8C381C258A124D(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if (!func_187(unk_0x4A8C381C258A124D(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) && func_159(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 4f, 1, 1056964608, 0, true, false))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
...
int func_189(var uParam0, int iParam1) // Position - 0xC65F
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_190() // Position - 0xCE42
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_191(var uParam0) // Position - 0xCE5D
{
	float num;
...
void func_192(int iParam0, var uParam1) // Position - 0xCEEB
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_193(BOOL bParam0) // Position - 0xCF4F
{
	var unk;
...
BOOL func_194(var uParam0) // Position - 0xCFE6
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_195(int iParam0) // Position - 0xD010
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_203() || Global_113182 || Global_33090 || func_202() || func_201(8, -1) || func_101() || func_200() || func_199() || func_198() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_203() || Global_33090 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_203() || Global_113182 || Global_33090 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_203() || Global_113182 || Global_33090 || func_202() || func_201(8, -1) || func_101() || func_200() || func_198() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_203() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_201(8, -1) || func_198() || func_197() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_196() // Position - 0xD72D
{
	return Global_101727.f_1;
}

BOOL func_197() // Position - 0xD73B
{
	if (Global_98585 != -1)
...
BOOL func_200() // Position - 0xD7A2
{
	return Global_101740.f_400 > 0;
}

BOOL func_201(int iParam0, int iParam1) // Position - 0xD7B3
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_202() // Position - 0xD7EB
{
	return Global_1575084;
}

BOOL func_203() // Position - 0xD7F7
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_204() // Position - 0xD813
{
	switch (iLocal_94)
	{
		case 0:
			if (unk_0x1DD05E817C89C737() - uLocal_260 > 100 && bLocal_261 == false)
				iLocal_94 = 1;
			break;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD8DF
{
...
BOOL func_206(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD92D
{
	Global_22426 = 0;
...
BOOL func_209(int iParam0) // Position - 0xDC95
{
	return func_210(iParam0, 20);
}

BOOL func_210(int iParam0, int iParam1) // Position - 0xDCA5
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

void func_211() // Position - 0xDCBD
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDE1D
{
	if (func_59(14))
	{
		if (!unk_0x1C2F771CDC87A3A5(unk_0x4A8C381C258A124D(), 0))
...
void func_216(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF17
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xDF6D
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
int func_218(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDF8E
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_229(unk_0x4A8C381C258A124D(), uParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE016
{
...
void func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE051
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_229(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_223(uParam0, 1);
			}
			else
			{
				...
				if (func_229(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_225(uParam0);
			}
		}
	}
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE142
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE17E
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE1B7
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE255
{
	return Global_98972;
}

void func_225(var uParam0) // Position - 0xE261
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE278
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE360
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
void func_228(var uParam0) // Position - 0xE388
{
	int i;
...
float func_229(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0xE408
{
	var unk;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE442
{
	var unk;
	...
	if (func_266(*panParam0) || func_264(*panParam0) || Global_79785 == 1)
		return true;
...
void func_231(int iParam0, var uParam1, int iParam2) // Position - 0xE6B2
{
	var unk;
	var unk2;
...
BOOL func_232(int iParam0) // Position - 0xEA0A
{
...
BOOL func_233(var uParam0) // Position - 0xEA2A
{
...
BOOL func_234(var uParam0) // Position - 0xEA42
{
...
void func_235(var uParam0) // Position - 0xEA67
{
	int i;
	var unk;
...
void func_236(var uParam0) // Position - 0xED6B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xED96
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_238(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_238(var uParam0, var uParam1) // Position - 0xEF54
{
	var unk;
...
BOOL func_239(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEF84
{
	int i;
	int num;
...
BOOL func_240(int iParam0) // Position - 0xF240
{
...
BOOL func_241(var uParam0, int iParam1) // Position - 0xF274
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_252(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_242(var uParam0, int iParam1) // Position - 0xF2EA
{
	return func_243(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_243(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF302
{
	BOOL flag;
	var unk;
	int num;

	num = func_251(uParam0, uParam1);
	...
	if (!func_247(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_244(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_244(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF3C3
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_245(var uParam0, int iParam1) // Position - 0xF4EF
{
	int num;
...
BOOL func_247(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF5FE
{
	var unk;
	var unk4;
	float num;

	unk = { func_249(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_249(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_248(unk4, unk);
...
float func_248(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF68F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_249(float fParam0, var uParam1, var uParam2) // Position - 0xF6B0
{
	float num;
	float num2;
...
void func_250(var uParam0) // Position - 0xF6EF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_251(var uParam0, var uParam1) // Position - 0xF70A
{
	int i;
...
int func_252(var uParam0) // Position - 0xF749
{
...
BOOL func_253(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF771
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_257(uParam0, bParam1, num, num2))
				return true;
		
			if (func_254(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_254(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF86C
{
	float num;
	float num2;
...
BOOL func_255(var uParam0, float fParam1) // Position - 0xF978
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_256(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_256(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFA0D
{
	var unk;
	var unk4;
	float num;

	unk = { func_249(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_257(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFA9B
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_258(int iParam0) // Position - 0xFAE3
{
...
void func_259(var uParam0) // Position - 0xFB2D
{
	var unk;
...
BOOL func_260(int iParam0) // Position - 0xFBCA
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_261(int iParam0) // Position - 0xFC5F
{
...
BOOL func_264(int iParam0) // Position - 0xFCDE
{
	if (func_265() && Global_101688.f_11 == 6 && iParam0 == func_178(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_265() // Position - 0xFD12
{
...
BOOL func_266(int iParam0) // Position - 0xFD50
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFD78
{
...
BOOL func_268(var uParam0) // Position - 0xFE13
{
	switch (*uParam0)
	{
		case 27:
...
BOOL func_269(var uParam0) // Position - 0xFE88
{
	int num;
	int i;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				func_273(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				func_273(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
...
void func_270(var uParam0, BOOL bParam1) // Position - 0x1027E
{
	var unk;
	float num;
	...
	func_271(uParam0, iLocal_91, unk, num);
...
void func_271(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x102F2
{
	func_272(uParam0);
...
void func_272(var uParam0) // Position - 0x10335
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_273(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x103D1
{
	func_274(uParam0);
...
void func_274(var uParam0) // Position - 0x103F2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_275(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10433
{
	if (func_276(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_276(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1048F
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_322(echParam1);
...
int func_277(var uParam0, eCharacter echParam1) // Position - 0x1051D
{
	int num;
...
BOOL func_278(BOOL bParam0, BOOL bParam1) // Position - 0x10563
{
	int num;
...
BOOL func_279(BOOL bParam0, BOOL bParam1) // Position - 0x105D1
{
	int num;
...
BOOL func_280(var uParam0) // Position - 0x10677
{
	if (func_234(uParam0))
	{
...
BOOL func_281(var uParam0) // Position - 0x106A1
{
	int i;
...
void func_282(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x106D2
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_283(var uParam0) // Position - 0x1070E
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_281(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh3"))
				return false;
...
void func_284(var uParam0) // Position - 0x108F6
{
	func_271(uParam0, iLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	unk_0x20DD46D27530FAC7(*uParam0, 4);
...
BOOL func_285(var uParam0) // Position - 0x1093C
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_281(&num) || !unk_0xE100DD4F82A51BDE("rcmjosh2"))
				return false;
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				uLocal_92 = unk_0x2EC137C692A52458(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xBF3497E24DEAD835(uLocal_92, 1);
				unk_0x3DA436E63AB0F541(uParam0->f_28[0], uLocal_92, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
BOOL func_286(var uParam0) // Position - 0x10B5F
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_287(BOOL bParam0, BOOL bParam1) // Position - 0x10CCC
{
	int num;
...
BOOL func_288(int iParam0) // Position - 0x10D3A
{
	var unk;
	eCharacter character;
...
BOOL func_289(int iParam0) // Position - 0x10D8B
{
	var unk;
...
BOOL func_290(int iParam0) // Position - 0x10E44
{
	var unk;
...
BOOL func_291(int iParam0) // Position - 0x10F05
{
	int i;
	var unk;
	int num;
...
BOOL func_292(int iParam0, char* sParam1) // Position - 0x10F8A
{
...
BOOL func_293(int iParam0) // Position - 0x1106C
{
...
BOOL func_294(int iParam0) // Position - 0x11097
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_295(int iParam0) // Position - 0x110C2
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_296(int iParam0) // Position - 0x110ED
{
	if (func_261(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_297() // Position - 0x11122
{
...
BOOL func_298(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1113C
{
	int i;
...
BOOL func_299(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x111A1
{
	int num;
	char* str;
...
BOOL func_300(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11219
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_301(var uParam0, BOOL bParam1) // Position - 0x11294
{
	char* str;
	...
	if (unk_0xC450B06E5AAA0985(uLocal_262))
		unk_0xFE54B8568B2ABD12(&uLocal_262);
...
void func_302(char* sParam0) // Position - 0x11342
{
...
void func_303() // Position - 0x11361
{
	Global_21291 = 0;
	func_304();
	return;
...
void func_304() // Position - 0x11371
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
BOOL func_305(char* sParam0) // Position - 0x11392
{
	var unk;
...
struct<6> func_306() // Position - 0x113B2
{
	var unk;
...
int func_307(var uParam0) // Position - 0x113D6
{
	if (func_234(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_308(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1140C
{
...
void func_309(var uParam0, BOOL bParam1) // Position - 0x1142C
{
	func_310(&(uParam0->f_41), bParam1);
	return;
}

void func_310(var uParam0, BOOL bParam1) // Position - 0x1143E
{
	int i;
...
void func_311(var uParam0, BOOL bParam1) // Position - 0x1147C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_312(var uParam0, BOOL bParam1) // Position - 0x114B7
{
	func_313(&(uParam0->f_35), bParam1);
	return;
}

void func_313(var uParam0, BOOL bParam1) // Position - 0x114C9
{
	int i;
...
void func_314(var uParam0) // Position - 0x11506
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_315(var uParam0, int iParam1) // Position - 0x1153E
{
	func_316(&(uParam0->f_28), iParam1);
	return;
}

void func_316(var uParam0, int iParam1) // Position - 0x11550
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_317(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_317(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11591
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_318(int iParam0) // Position - 0x115E1
{
	if (*iParam0 == -1)
		return;
...
void func_319(char* sParam0) // Position - 0x1161E
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_320(var uParam0) // Position - 0x11630
{
	*uParam0 = -1;
...
void func_321() // Position - 0x11663
{
...
int func_322(eCharacter echParam0) // Position - 0x1167D
{
	if (!func_36(echParam0))
