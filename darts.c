...
void main() // Position - 0x0
{
	...
	num4 = SYSTEM::TO_FLOAT(iLocal_293) / 100f;
	value = num4 * 1200f;
			...
			switch (num)
			{
				...
				case 8:
					...
					switch (num3)
					{
						case 0:
							...
							{
								if (!IS_BIT_SET(Global_114123, 10))
									MISC::SET_BIT(&Global_114123, 10);
								else
									MISC::CLEAR_BIT(&Global_114123, 10);
				...
				case 9:
					if (func_346(&num, &scaleform, &unk504))
					{
						...
						if (Global_114162.f_18974.f_5 >= 5 && Global_114162.f_18974.f_7 >= 0.8f)
							num.f_249.f_4 = 2;
						else if (Global_114162.f_18974.f_5 >= 3 && Global_114162.f_18974.f_7 >= 0.66f)
							num.f_249.f_4 = 1;
						else
							num.f_249.f_4 = 0;
					
						if (func_345(Global_114162.f_18974.f_5, &iLocal_294))
							func_344(&(unk504.f_666), 24, true);
					
						fLocal_88 = func_343(Global_114162.f_18974.f_5);
						fLocal_89 = func_342(Global_114162.f_18974.f_5);
						fLocal_86 = fLocal_88;
						fLocal_87 = fLocal_89;
...
char* func_23(int iParam0, BOOL bParam1) // Position - 0x38E6
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23987.f_7680[iParam0 /*16*/]))
	{
		...
		{
			return func_24(&Global_23987.f_7680[iParam0 /*16*/]);
		}
	}
...
char* func_26(int iParam0) // Position - 0x3E31
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23987.f_6623[iParam0 /*16*/]))
	{
		...
		{
			return func_24(&Global_23987.f_6623[iParam0 /*16*/]);
		}
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x618B
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x62CB
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x62E7
{
	Hash statHash;
	int outValue;
...
Hash func_65(int iParam0) // Position - 0x6305
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_66(int iParam0) // Position - 0x6327
{
	switch (iParam0)
	{
		case 38:
...
int func_67(int iParam0) // Position - 0x6344
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_68(int iParam0) // Position - 0x6449
{
	switch (iParam0)
	{
		case 18:
...
void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x64D8
{
	Hash statName;
...
Hash func_70(int iParam0, int iParam1) // Position - 0x6506
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(iParam1));
}

int func_71(int iParam0) // Position - 0x651B
{
	int num;
	int num2;
...
int func_72() // Position - 0x654F
{
	return Global_1574926;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x655B
{
	if (iParam2 == -1)
		iParam2 = func_72();
...
void func_74(int iParam0) // Position - 0x6579
{
	func_95(93, iParam0);
	func_95(29, iParam0);
	func_95(30, iParam0);
...
BOOL func_75(int iParam0) // Position - 0x6599
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_76(int iParam0, int iParam1) // Position - 0x67A4
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x67D3
{
	if (iParam1 == -1)
		iParam1 = func_72();
...
int func_78(BOOL bParam0) // Position - 0x67EF
{
	var outValue;
	int value;
	int outValue2;
...
int func_79(int iParam0, int iParam1) // Position - 0x68A6
{
	if (iParam0 >= 78)
		return 0;
...
int func_80(int iParam0, int iParam1) // Position - 0x68C1
{
...
BOOL func_81(var uParam0, int iParam1) // Position - 0x695E
{
	int i;
	var unk;
...
int func_82(var uParam0, int iParam1) // Position - 0x6A0F
{
	int i;
...
BOOL func_83(var uParam0, int iParam1) // Position - 0x6A8A
{
	return uParam0->[iParam1] == 78;
}

void func_84(var uParam0) // Position - 0x6A9B
{
	int i;
...
void func_85(var uParam0, int iParam1) // Position - 0x6ACF
{
	uParam0->[iParam1] = 78;
	return;
}

void func_86(var uParam0, int iParam1) // Position - 0x6ADF
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_87(var uParam0) // Position - 0x6AFC
{
	return uParam0->f_80;
}

BOOL func_88(var uParam0, int iParam1) // Position - 0x6B08
{
	return func_89(uParam0, iParam1) != -1;
}

int func_89(var uParam0, int iParam1) // Position - 0x6B1A
{
	int i;
...
BOOL func_90(var uParam0) // Position - 0x6B47
{
	return uParam0->f_79 == 1;
}

BOOL func_91(int iParam0) // Position - 0x6B55
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_92(int iParam0) // Position - 0x6BA5
{
	return Global_44199 == iParam0;
}

BOOL func_93(int iParam0, int iParam1) // Position - 0x6BB3
{
...
void func_94(Hash hParam0, int iParam1) // Position - 0x6C04
{
	int outValue;
...
void func_95(int iParam0, int iParam1) // Position - 0x6C27
{
	int outValue;
...
int func_97(eCharacter echParam0) // Position - 0x6CF9
{
	return Global_2201[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x6D0A
{
	func_99();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_99() // Position - 0x6D23
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_100(character) && !func_92(14) || Global_113110)
			{
...
BOOL func_100(eCharacter echParam0) // Position - 0x6E20
{
	return echParam0 < CHAR_MULTIPLAYER;
}

Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6E2C
{
...
Hash func_102(eCharacter echParam0) // Position - 0x6E51
{
	return Global_2201[echParam0 /*29*/];
}

void func_103(var uParam0) // Position - 0x6E60
{
...
void func_104(var uParam0, int iParam1) // Position - 0x6E93
{
	if (uParam0->f_4 != 0)
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6F3E
{
	uParam0->f_1 = 0;
	return;
}

void func_106() // Position - 0x6F4B
{
	int i;
	int j;
	var unk;
...
void func_107(int iParam0) // Position - 0x70B7
{
	int i;
...
void func_108(var uParam0) // Position - 0x710F
{
	var unk;
	int i;
	int j;
...
void func_109(var uParam0) // Position - 0x71F1
{
	int i;
	var unk;
...
void func_110(var uParam0) // Position - 0x7279
{
	int i;
	var unk;
...
void func_111(var uParam0, var uParam1, var uParam2) // Position - 0x7347
{
	*uParam0 = 0;
	*uParam1 = 0;
...
void func_113(Any* panParam0) // Position - 0x7417
{
	*panParam0 = 0;
	panParam0->f_1 = 0;
	panParam0->f_2 = 0;
...
void func_114(Any* panParam0) // Position - 0x745F
{
	int i;
...
void func_115(var uParam0) // Position - 0x749A
{
	func_48(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
void func_116() // Position - 0x74C4
{
	CAM::SET_CAM_ACTIVE(caLocal_124, true);
	return;
}

int func_117(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x74D3
{
...
void func_119() // Position - 0x773F
{
	Global_33250 = 1;
	return;
}

void func_120(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15) // Position - 0x774B
{
	int num;
	int i;
...
BOOL func_121(const char* sParam0) // Position - 0x789D
{
...
var func_122(BOOL bParam0, var uParam1, var uParam2) // Position - 0x78D7
{
	if (bParam0)
		return uParam1;
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x78EE
{
	if (bParam0)
		return uParam1;
...
void func_124(var uParam0, BOOL bParam1) // Position - 0x7905
{
	if (bParam1)
...
void func_125(var uParam0, int iParam1) // Position - 0x792B
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_126(var uParam0, int iParam1) // Position - 0x7940
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

int func_127(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7951
{
	int num;
	int num2;
...
void func_128(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7A1A
{
	if (*uParam0 == 0)
...
BOOL func_129(var uParam0) // Position - 0x7A94
{
...
void func_130(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x7AC8
{
...
var func_131(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7D82
{
	if (bParam0)
		return uParam1;
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x7D99
{
	return iParam0 && iParam1 != false;
}

BOOL func_133(var uParam0) // Position - 0x7DA8
{
	if (*uParam0 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
...
void func_134(var uParam0, var uParam1) // Position - 0x7DCF
{
	func_135(uParam1, uParam0);
	return;
}

void func_135(var uParam0, var uParam1) // Position - 0x7DDF
{
	int i;
	int j;
	var unk;
...
void func_136(var uParam0, var uParam1) // Position - 0x8DA9
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_137(var uParam0, eControlAction ecaParam1) // Position - 0x913F
{
	var unk;
	int num;
	var unk2;
...
void func_138(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x91DE
{
...
void func_139(int iParam0, int iParam1, int iParam2) // Position - 0x92B3
{
...
float func_142(float fParam0) // Position - 0x9404
{
	return fParam0 / 0.3048f;
}

float func_143(float fParam0) // Position - 0x9414
{
	return fParam0 / 1609.344f;
}

void func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, Hash hParam44, BOOL bParam45, BOOL bParam46) // Position - 0x9424
{
	var componentType;
			...
			if (bParam45)
			{
				...
				if (!MISC::SHOULD_USE_METRIC_MEASUREMENTS())
					if (uParam0.f_29[iParam43] == 15 || uParam0.f_29[iParam43] == 16)
						hParam44 = SYSTEM::FLOOR(func_143(SYSTEM::TO_FLOAT(hParam44)));
					else
						hParam44 = SYSTEM::FLOOR(func_142(SYSTEM::TO_FLOAT(hParam44)));
...
int func_145(Hash hParam0) // Position - 0x982C
{
	Hash value;
	float num;
	int num2;
	...
	return SYSTEM::FLOOR(func_146(-num5, -num6, num7, true));
}

float func_146(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0x98D2
{
	if (bParam3)
...
int func_147(int iParam0) // Position - 0x9916
{
	float num;
	float num2;
...
struct<4> func_148(Hash hParam0) // Position - 0x9957
{
	var unk;
...
char* func_149(int iParam0, BOOL bParam1) // Position - 0x9990
{
	var unk;
...
char* func_150(var uParam0) // Position - 0xA962
{
	return uParam0;
}

int func_151(int iParam0, Any* panParam1) // Position - 0xA96C
{
	int i;
	int numDlcWeapons;
...
int func_152(Hash hParam0) // Position - 0xA9A7
{
	if (hParam0 == 600)
...
void func_153(int iParam0, int iParam1, int iParam2, int iParam3, const char* sParam4, const char* sParam5) // Position - 0xAB1A
{
...
BOOL func_154(Any* panParam0, Any* panParam1) // Position - 0xAB6C
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xABA6
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_156(var uParam0, var uParam1) // Position - 0xABB6
{
	int i;
	int j;
	var unk;
...
void func_157(var uParam0, var uParam1) // Position - 0xAD21
{
	var unk;
	var unk2;
	var unk3;
...
void func_158(var uParam0) // Position - 0xADD0
{
	int i;
	int j;
	int num;
...
void func_159(int iParam0) // Position - 0xAFE1
{
	var unk;
	int i;
...
BOOL func_160(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xB057
{
	int num;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0xB300
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xB35E
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
void func_163(int iParam0, int iParam1, int iParam2, const char* sParam3) // Position - 0xB3A3
{
...
BOOL func_164(var uParam0) // Position - 0xB3D7
{
	if (!Global_2097532)
	{
...
void func_165(var uParam0) // Position - 0xB590
{
	int i;
	int j;
	int num;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0xB777
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_167(int iParam0, int iParam1) // Position - 0xB78A
{
	int i;
...
int func_168(int iParam0) // Position - 0xB806
{
	int i;
	int num;
	int num2;
...
BOOL func_169(var uParam0) // Position - 0xB899
{
	int i;
	int j;
...
BOOL func_170(var uParam0, int iParam1, Any* panParam2, var uParam3) // Position - 0xBA46
{
	var unk;
	int i;
...
void func_171(Any* panParam0, char* sParam1) // Position - 0xBAFF
{
	NETWORK::NETWORK_CLAN_GET_UI_FORMATTED_TAG(panParam0, 35, sParam1);
	return;
}

BOOL func_172(Any* panParam0, Any* panParam1) // Position - 0xBB11
{
	int i;
...
BOOL IS_XBOX_PLATFORM() // Position - 0xBB50
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xBB66
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_175(var uParam0) // Position - 0xBB7C
{
	int i;
...
BOOL func_176(var uParam0) // Position - 0xBBED
{
	int i;
...
BOOL func_177(var uParam0, Any* panParam1, char* sParam2) // Position - 0xBC5B
{
	if (*uParam0 == 2)
		return true;
...
BOOL func_178(var uParam0) // Position - 0xBD6C
{
...
BOOL func_179(var uParam0) // Position - 0xBF02
{
	int i;
...
BOOL func_180(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, char* sParam17) // Position - 0xBF9F
{
	var gamerHandle;
...
BOOL func_181(var uParam0, const char* sParam1, char* sParam2, Any anParam3, var uParam4) // Position - 0xC0C4
{
	int displaynamesFromHandles;
	var unk;
...
BOOL func_182(var uParam0) // Position - 0xC1CA
{
	var unk;
	var unk99;
	int i;
...
void func_183(int iParam0, int iParam1) // Position - 0xCFEE
{
	int i;
...
BOOL func_184(var uParam0, var uParam1, Any* panParam2, int iParam3, int iParam4) // Position - 0xD113
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_189(int iParam0) // Position - 0xD26F
{
...
void func_190(var uParam0, char* sParam1, int iParam2) // Position - 0xD2CD
{
	int num;
	int i;
...
void func_191(var uParam0) // Position - 0xD3D7
{
	int i;
...
void func_192(var uParam0, var uParam1) // Position - 0xD485
{
	*uParam0 = *uParam1;
...
BOOL func_193(var uParam0, var uParam1, Any* panParam2, int iParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xD4A0
{
	int any;
	float num;
...
BOOL func_195(var uParam0) // Position - 0xD5F2
{
	var unk;
	var unk99;
	int i;
...
BOOL func_196(var uParam0, var uParam1, Any* panParam2, Any* panParam3, Any anParam4, BOOL bParam5, int iParam6, int iParam7) // Position - 0xDFEC
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_197(var uParam0) // Position - 0xE0A8
{
	var unk;
	var unk14;
	var unk112;
...
BOOL func_198(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68) // Position - 0xEED4
{
	int i;
...
void func_199(var uParam0) // Position - 0xEF6C
{
	int cacheTime;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xEFBC
{
	return uParam0->f_1;
}

void func_201(int iParam0) // Position - 0xEFC8
{
...
void func_202(int iParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEFE8
{
	char* componentType;
	var clanDesc;
	var unk35;
...
void func_203(int iParam0, char* sParam1, var uParam2, int iParam3) // Position - 0xF2C0
{
	int i;
...
void func_204(int iParam0, char* sParam1, const char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xF302
{
...
BOOL func_205(int iParam0) // Position - 0xF392
{
...
void func_206(int iParam0, int iParam1) // Position - 0xF3B4
{
...
int func_207() // Position - 0xF3D1
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("SC_LEADERBOARD");
}

BOOL func_208() // Position - 0xF3E1
{
	return func_209(PLAYER::PLAYER_ID());
}

BOOL func_209(Player plParam0) // Position - 0xF3F1
{
...
int func_210(Player plParam0) // Position - 0xF451
{
	return Global_1845270[plParam0 /*892*/].f_193;
}

void func_211(int iParam0) // Position - 0xF464
{
	Global_1577952 = iParam0;
	return;
}

void func_212(int iParam0) // Position - 0xF472
{
	Global_1675263.f_1163 = iParam0;
	return;
}

void func_213(BOOL bParam0) // Position - 0xF483
{
	if (bParam0)
		func_215();
...
void func_214(int iParam0, int iParam1) // Position - 0xF4D4
{
...
void func_215() // Position - 0xF50A
{
	Global_2739945.f_4668 = 0;
	return;
}

void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xF51A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
int func_217(int* piParam0, BOOL bParam1) // Position - 0xF557
{
	...
	if (IS_PLAYSTATION_PLATFORM() && npUnavailableReason == 4 || npUnavailableReason == 2 || npUnavailableReason == 1 || npUnavailableReason == 5 || !func_223() && NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
...
void func_218(var uParam0, BOOL bParam1) // Position - 0xF9B6
{
	func_219(uParam0);
...
void func_219(var uParam0) // Position - 0xF9D3
{
	var unk;
...
void func_220(var uParam0, int iParam1) // Position - 0xF9EE
{
	if (iParam1 == 1)
	{
		*uParam0 = 0;
...
void func_221(var uParam0) // Position - 0xFAEC
{
	uParam0->f_35 = 0;
	return;
}

int func_222(var uParam0) // Position - 0xFAF9
{
	return uParam0->f_35;
}

BOOL func_223() // Position - 0xFB05
{
	if (func_224())
		return false;
...
BOOL func_224() // Position - 0xFB25
{
	return Global_2696947;
}

void func_225(BOOL bParam0) // Position - 0xFB31
{
	HUD::BUSYSPINNER_OFF();
...
BOOL func_226(var uParam0, BOOL bParam1, var uParam2) // Position - 0xFB46
{
	if (!bLocal_257)
	{
...
BOOL func_227(var uParam0) // Position - 0xFBAF
{
	var unk;
	var unk99;
	int num;
...
BOOL func_228() // Position - 0xFFD3
{
	return IS_BIT_SET(Global_1048576.f_10, 1);
}

BOOL func_229() // Position - 0xFFE3
{
	return Global_2693687.f_3;
}

BOOL func_230(int iParam0) // Position - 0xFFF1
{
	switch (iParam0)
	{
		case 817:
...
void func_231() // Position - 0x100CA
{
...
BOOL func_232(int iParam0, int iParam1, int iParam2) // Position - 0x1012A
{
	int columnType;
...
BOOL func_233(int iParam0, int iParam1) // Position - 0x1022C
{
...
BOOL func_234(var uParam0, var uParam1, Any* panParam2, Any* panParam3) // Position - 0x10287
{
	switch (*uParam0)
	{
		case 0:
...
void func_235(int iParam0, BOOL bParam1) // Position - 0x1033B
{
	var unk;
	var unk8;
...
void func_236(int iParam0, int iParam1, int iParam2, float fParam3, BOOL bParam4) // Position - 0x1042B
{
	int offset;
	int i;
...
BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10546
{
	int num;
	int i;
	var gamerHandle;
...
void func_238(var uParam0, BOOL bParam1) // Position - 0x1067A
{
	int num;
...
void func_239(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x106A2
{
	var unk;
	var unk9;
	int i;
	...
	switch (iParam1)
	{
		...
		case 0:
			...
			else
			{
				...
				if (func_245(*Global_4718592.f_194133) || func_242(*Global_4718592.f_194133))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
				...
				else if (func_241(*Global_4718592.f_194133))
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[1 /*6*/], "SCLB_C_DEATH" /*DEATHS*/, 24);
					TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[2 /*6*/], "SCLB_C_RANK" /*POSITION*/, 24);
...
struct<6> func_240(int iParam0) // Position - 0x15ADE
{
	var unk;
...
BOOL func_241(int iParam0) // Position - 0x15B8D
{
	return iParam0 == 74;
}

BOOL func_242(int iParam0) // Position - 0x15B9A
{
	return func_244(iParam0) || func_243(iParam0);
}

BOOL func_243(int iParam0) // Position - 0x15BB4
{
	return iParam0 == 44;
}

BOOL func_244(int iParam0) // Position - 0x15BC1
{
	return iParam0 == 45;
}

BOOL func_245(int iParam0) // Position - 0x15BCE
{
	return iParam0 == 12;
}

struct<6> func_246(int iParam0) // Position - 0x15BDB
{
	var unk;
...
Hash func_247(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0x15D64
{
	var unk;
...
BOOL func_248() // Position - 0x15DD6
{
...
BOOL func_249(var uParam0, int iParam1) // Position - 0x15F0C
{
...
void func_250(var uParam0, int iParam1) // Position - 0x1600F
{
...
void func_251(var uParam0) // Position - 0x16035
{
	int randomIntInRange;
...
void func_252(var uParam0, BOOL bParam1) // Position - 0x160AE
{
	int randomIntInRange;
...
void func_254(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x161AB
{
	char* methodName;
...
char* func_255(int iParam0) // Position - 0x1620B
{
	switch (iParam0)
	{
		case 0:
...
void func_256(var uParam0, int iParam1) // Position - 0x1627A
{
...
int func_257(Object* pobParam0) // Position - 0x16298
{
...
void func_258(Ped pedParam0) // Position - 0x162E8
{
...
void func_259(var uParam0, var uParam1, var uParam2, var uParam3, int* piParam4) // Position - 0x1634C
{
	BOOL flag;
		...
		if (!bLocal_274)
		{
			...
			else if (!bLocal_162)
			{
				if (func_3(&(uParam3->f_666), 18))
				{
					...
					{
						if (!IS_BIT_SET(Global_114123, 3))
						{
							_DISPLAY_HELP_TEXT("DARTS_INSTR_W", -1);
							MISC::SET_BIT(&Global_114123, 3);
						}
					...
					{
						if (!IS_BIT_SET(Global_114123, 4))
						{
							_DISPLAY_HELP_TEXT("DARTS_INSTR_B", -1);
							MISC::SET_BIT(&Global_114123, 4);
						}
			...
			if (iLocal_28 == 0)
			{
				...
				if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_SHT_USE") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_AIM_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_STD_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						MISC::SET_BIT(&(Global_114162.f_18974.f_6), iLocal_294);
...
void func_260(var uParam0, var uParam1) // Position - 0x167A6
{
...
void func_261(var uParam0, var uParam1, var uParam2) // Position - 0x16C2F
{
	var entityCoords;
	int i;
...
void func_262(var uParam0, int iParam1, int iParam2) // Position - 0x17048
{
...
BOOL func_263(BOOL bParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1706C
{
	int address;
	int randomIntInRange;
...
BOOL func_264(BOOL bParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1725D
{
	int address;
	int randomIntInRange;
	int randomIntInRange2;
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x174AA
{
	iParam2 = iParam2;
...
void func_266(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x174C3
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
void func_267() // Position - 0x174E2
{
...
void func_268(var uParam0, var uParam1) // Position - 0x174F8
{
	uParam0->f_455 = 0;
...
void func_269(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x17A95
{
	iParam4 = iParam4;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam1);
...
void func_270(Ped pedParam0) // Position - 0x17ABA
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_271(Ped pedParam0, BOOL bParam1) // Position - 0x17AD8
{
	int randomIntInRange;
...
BOOL _GET_RANDOM_BOOL() // Position - 0x17B57
{
...
BOOL func_273(Ped pedParam0, BOOL bParam1) // Position - 0x17B75
{
	int randomIntInRange;
...
int func_274(Ped pedParam0) // Position - 0x17BF4
{
	int randomIntInRange;
	BOOL flag;
...
BOOL func_275(Ped pedParam0) // Position - 0x17C37
{
	int randomIntInRange;
...
void func_276(var uParam0, int iParam1) // Position - 0x17C63
{
	uParam0->f_679 = 1;
...
BOOL func_277(Ped pedParam0) // Position - 0x17C78
{
	BOOL flag;
...
void func_278(int iParam0) // Position - 0x17CA4
{
	switch (iParam0)
	{
		case 0:
			Global_114162.f_18974 = Global_114162.f_18974 + 1;
			func_279("DARTS_STAT_NUM_BULLSEYES", Global_114162.f_18974);
			break;
	
		case 1:
			Global_114162.f_18974.f_1 = Global_114162.f_18974.f_1 + 1;
			func_279("DARTS_STAT_NUM_180S", Global_114162.f_18974.f_1);
			break;
	
		case 2:
			Global_114162.f_18974.f_2 = Global_114162.f_18974.f_2 + 1;
			func_279("DARTS_STAT_NUM_WINS", Global_114162.f_18974.f_2);
			break;
	
		case 3:
			Global_114162.f_18974.f_3 = Global_114162.f_18974.f_3 + 1;
			func_279("DARTS_STAT_NUM_LOSS", Global_114162.f_18974.f_3);
			break;
	
		case 4:
			Global_114162.f_18974.f_4 = Global_114162.f_18974.f_4 + 1;
			func_279("DARTS_STAT_DARTS_THROWN", Global_114162.f_18974.f_4);
			break;
	
		case 5:
			Global_114162.f_18974.f_5 = Global_114162.f_18974.f_5 + 1;
			func_279("DARTS_STAT_NUM_GAMES", Global_114162.f_18974.f_5);
			break;
	
		case 7:
			Global_114162.f_18974.f_7 = SYSTEM::TO_FLOAT(Global_114162.f_18974.f_2) / SYSTEM::TO_FLOAT(Global_114162.f_18974.f_5);
			break;
	
		case 8:
			Global_114162.f_18974.f_8 = SYSTEM::TO_FLOAT(Global_114162.f_18974.f_4) / SYSTEM::TO_FLOAT(Global_114162.f_18974.f_5);
			break;
	}
...
void func_279(char* sParam0, int iParam1) // Position - 0x17E1B
{
	return;
}

void func_280(var uParam0) // Position - 0x17E23
{
	if (!uParam0->f_460)
		uParam0->f_460 = 1;
...
void func_281(BOOL bParam0) // Position - 0x17FCC
{
	char* audioName;
...
BOOL func_282(var uParam0) // Position - 0x18040
{
	int num;
	int num2;
...
void func_283(var uParam0, var uParam1, BOOL bParam2) // Position - 0x18102
{
	float num;
...
float func_284(float fParam0, var uParam1, var uParam2) // Position - 0x18336
{
	return SYSTEM::SQRT((fParam0 * fParam0) + (fParam0.f_2 * fParam0.f_2));
}

int func_285(var uParam0) // Position - 0x18351
{
	int i;
...
BOOL func_286(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x18417
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
	var unk3;
	float frameTime;
...
void func_287(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0x18537
{
	float num;
...
float func_288(float fParam0) // Position - 0x1863E
{
	return fParam0;
}

float func_289(float fParam0) // Position - 0x18648
{
	return fParam0;
}

BOOL func_290() // Position - 0x18652
{
	if (func_291())
		return true;
...
BOOL func_291() // Position - 0x18691
{
	return Global_1574604;
}

void func_292(var uParam0) // Position - 0x1869D
{
	uParam0->f_4 = 128;
	uParam0->f_5 = 128;
	uParam0->f_6 = 128;
...
void func_293(var uParam0) // Position - 0x186B7
{
	uParam0->f_7 = 2;
	return;
}

void func_294(var uParam0) // Position - 0x186C4
{
	uParam0->f_7 = 5;
	return;
}

void func_295(var uParam0) // Position - 0x186D1
{
	uParam0->f_4 = 0;
	uParam0->f_5 = 0;
	uParam0->f_6 = 0;
...
void func_296(var uParam0) // Position - 0x186EE
{
	uParam0->f_4 = 0;
	uParam0->f_5 = 0;
	uParam0->f_6 = 0;
...
void func_297(var uParam0) // Position - 0x1870B
{
...
void func_298(var uParam0) // Position - 0x18734
{
...
void func_299(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1875C
{
	float randomFloatInRange;
	float randomFloatInRange2;
...
void func_300(var uParam0) // Position - 0x18AB5
{
	Vector3 vector;
	float num;
	float headingFromVector2d;
...
int func_301(var uParam0) // Position - 0x18B61
{
	switch (uParam0->f_4)
	{
		case 0:
...
void func_302(var uParam0, var uParam1) // Position - 0x18B95
{
	int i;
...
int func_303(Ped pedParam0) // Position - 0x18CE7
{
	int randomIntInRange;
...
void func_304(int* piParam0) // Position - 0x18D13
{
	func_305(piParam0, 0f);
	return;
}

void func_305(int* piParam0, float fParam1) // Position - 0x18D22
{
...
BOOL func_306(var uParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x18D4D
{
	float randomFloatInRange;
	int randomIntInRange;
...
BOOL func_307(var uParam0) // Position - 0x18FC2
{
	BOOL num;
	float controlNormal;
...
void func_308() // Position - 0x19180
{
	fLocal_68.f_4 = 210;
	fLocal_68.f_5 = 23;
	fLocal_68.f_6 = 19;
...
void func_309() // Position - 0x1919A
{
	fLocal_68.f_4 = 183;
	fLocal_68.f_5 = 137;
	fLocal_68.f_6 = 0;
...
void func_310() // Position - 0x191B3
{
	fLocal_68.f_4 = 16;
	fLocal_68.f_5 = 184;
	fLocal_68.f_6 = 10;
...
void func_311(var uParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x191CD
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
void func_312(var uParam0, int iParam1) // Position - 0x1927C
{
	float frameTime;
	float randomFloatInRange;
	float randomFloatInRange2;
...
void func_313() // Position - 0x196BF
{
	if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_RB))
		fLocal_90 = 0.3f;
	else
	...
	if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_RT))
	{
		...
		else if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_FST_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_AIM_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_CLOCK") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_STD_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B") && !bLocal_93)
		{
			...
			if (!IS_BIT_SET(Global_114123, 1))
			{
				_DISPLAY_HELP_TEXT("DARTS_SHT_USE", -1);
				MISC::SET_BIT(&Global_114123, 1);
			}
		}
	}
	else if (bLocal_92)
...
void func_314(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x197CE
{
	float num;
...
BOOL func_315(var uParam0, var uParam1, BOOL bParam2) // Position - 0x19822
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x19959
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_317(int iParam0, BOOL bParam1) // Position - 0x1996C
{
	if (iParam0 == 0)
	{
		if (!IS_BIT_SET(Global_114123, 9))
		{
			if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_SHT_USE") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B"))
			{
				...
				MISC::SET_BIT(&Global_114123, 9);
			}
		}
		else if (bParam1 && !IS_BIT_SET(Global_114123, 7))
		{
			if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_AIM_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B"))
			{
				...
				MISC::SET_BIT(&Global_114123, 7);
			}
		}
	}
	else if (iParam0 == 1)
	{
		if (!IS_BIT_SET(Global_114123, 8))
		{
			if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_SHT_USE") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B"))
			{
				_DISPLAY_HELP_TEXT("DARTS_STD_HLP", -1);
				MISC::SET_BIT(&Global_114123, 8);
			}
		}
	}
	else if (iParam0 == 2)
	{
		...
		{
			if (!IS_BIT_SET(Global_114123, 2))
			{
				_DISPLAY_HELP_TEXT("DARTS_FST_HLP", -1);
				MISC::SET_BIT(&Global_114123, 2);
			}
...
BOOL func_318(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x19AB5
{
	Vector3 vector;
...
void func_319() // Position - 0x19B26
{
...
void func_320(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x19B42
{
	Vector3 vector;
...
Vector3 func_321(int iParam0) // Position - 0x19B84
{
	float num;
	float num2;
...
float func_322(float fParam0) // Position - 0x19BC8
{
	float num;
	float num2;
...
float func_323(float fParam0) // Position - 0x19BE4
{
	float num;
	float num2;
...
float func_324(int iParam0) // Position - 0x19C00
{
	int i;
	int num;
	float num2;
...
BOOL func_325(var uParam0) // Position - 0x19C3C
{
	switch (*uParam0)
	{
		case 0:
...
void func_326(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x19D2F
{
	var unk;
	float controlUnboundNormal;
	float controlUnboundNormal2;
...
int func_327(int iParam0, int iParam1, int iParam2) // Position - 0x1A283
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_328(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A2A8
{
...
void func_329(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15) // Position - 0x1A3AC
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_330() // Position - 0x1A4A4
{
	if (bLocal_259)
		return;
...
void func_331() // Position - 0x1A4C6
{
...
void func_332(BOOL bParam0) // Position - 0x1A4E9
{
	if (bParam0)
...
void func_333(var uParam0) // Position - 0x1A513
{
	if (uParam0->f_679)
	{
		if (uParam0->f_681 == 2)
...
void func_334(var uParam0) // Position - 0x1A598
{
	uParam0->f_8 = 0;
	func_445(&(uParam0->f_2));
	func_445(&(uParam0->f_5));
...
char* func_335(int iParam0) // Position - 0x1A5B5
{
	switch (iParam0)
	{
		case 0:
...
void func_336(var uParam0) // Position - 0x1A5E2
{
	if (!bLocal_97)
		if (!PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT))
			bLocal_97 = true;
...
void func_337(var uParam0, int iParam1) // Position - 0x1A63A
{
	if (!HUD::IS_PAUSE_MENU_ACTIVE())
	{
		if (iParam1 == 0)
...
int func_338(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1A8F6
{
	int num;
...
void func_339(var uParam0) // Position - 0x1A9C1
{
	if (!HUD::IS_PAUSE_MENU_ACTIVE())
	{
...
void func_340(var uParam0) // Position - 0x1AAD3
{
	BOOL flag;
...
void func_341(Ped pedParam0) // Position - 0x1AB76
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
float func_342(int iParam0) // Position - 0x1AB94
{
	if (iParam0 < 10)
		return 0.107f;
...
float func_343(int iParam0) // Position - 0x1ABE9
{
	if (iParam0 < 10)
		return 0.08f;
...
void func_344(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x1AC3E
{
	if (bParam2)
...
BOOL func_345(int iParam0, var uParam1) // Position - 0x1AC5E
{
	if (iParam0 >= 10)
	{
		if (!IS_BIT_SET(Global_114162.f_18974.f_6, 12))
		{
			*uParam1 = 12;
			return true;
		}
...
BOOL func_346(var uParam0, var uParam1, var uParam2) // Position - 0x1AC87
{
	int i;
	int j;
...
void func_347(BOOL bParam0) // Position - 0x1AD73
{
...
void func_348(BOOL bParam0) // Position - 0x1ADC4
{
	if (bParam0)
		CAM::SET_CAM_ACTIVE(caLocal_118, true);
...
void func_349() // Position - 0x1ADD8
{
	CAM::SET_CAM_ACTIVE(caLocal_120, true);
	return;
}

void func_350(var uParam0) // Position - 0x1ADE7
{
	func_351();
	uParam0->f_670 = 3;
	func_344(&(uParam0->f_666), 15, false);
...
void func_351() // Position - 0x1AE1D
{
	int i;
...
void func_352() // Position - 0x1AE8D
{
	SYSTEM::SETTIMERA(0);
	bLocal_97 = false;
	HUD::CLEAR_SMALL_PRINTS();
...
void func_353(BOOL bParam0, int iParam1) // Position - 0x1AEA1
{
	int num;
	...
	if (bParam0)
	{
		func_354(&Global_23987.f_6263[num /*10*/]);
...
void func_354(int iParam0) // Position - 0x1AF67
{
	if (iParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam0))
...
BOOL func_355(var uParam0, BOOL bParam1, int iParam2) // Position - 0x1AF93
{
	var unk;
	Hash hashKey;
	int i;
...
void func_356(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1B030
{
...
BOOL func_357(var uParam0, var uParam1, var uParam2) // Position - 0x1B060
{
	char* gxt;
	int num;
	int num2;
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		else if (func_420() && MISC::GET_GAME_TIMER() > Global_4542451)
		{
			if (Global_4542450 == uParam0->f_660)
			{
				num2 = func_419(0);
...
void func_358(BOOL bParam0, BOOL bParam1) // Position - 0x1B470
{
	int i;
	int j;
	float aspectRatio;
	...
	Global_23987.f_9117 = func_359(false);
	Global_23984 = 0.05f;
	Global_23985 = 0.05f;
	Global_23986 = 0.225f;
	aspectRatio = GRAPHICS::GET_ASPECT_RATIO(false);
...
float func_359(BOOL bParam0) // Position - 0x1B952
{
	float aspectRatio;
...
BOOL func_360() // Position - 0x1B97D
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
...
void func_361(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x1B99C
{
	int num;
	int r;
	int g;
	...
	if (Global_23987)
		if (func_19(29, true, true, &num26, &num27, bParam7))
			num39 = num27 / num26;
		else
			Global_23987 = false;
	...
	if (bParam3)
	{
		...
		{
			func_390(Global_23987.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (i == 1 && Global_23987.f_6331)
		{
			...
			else
			{
				if (Global_23987)
				{
					TEXT_LABEL_ASSIGN_STRING(&unk5, func_26(29), 64);
					TEXT_LABEL_ASSIGN_STRING(&unk21, func_23(29, true), 64);
				
					if (MISC::GET_HASH_KEY(&Global_23987.f_7680[29 /*16*/]) == joaat("CREW_LOGO"))
					{
						func_389(Global_23984, Global_23985, iParam5, num38, 0, 0, 0, 255);
						func_388(&unk5, &unk21, Global_23984 + (iParam5 * 0.5f), Global_23985 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
					}
					else
					{
						func_388(&unk5, &unk21, Global_23984 + (iParam5 * 0.5f), Global_23985 + (num38 * 0.5f), iParam5, num38, 0f, 255, 255, 255, 255, false, 0);
				...
				func_389(Global_23984, Global_23985 + num38, iParam5, 0.034722f, r, g, b, a);
				...
				if (MISC::GET_HASH_KEY(&(Global_23987.f_1)) != 0)
				{
					...
					func_386(Global_23984 + 0.00390625f, Global_23985 + num38 + 0.00416664f, 0);
				}
			
				if (Global_23987.f_6338)
				{
					func_387();
					func_384((Global_23984 + iParam5) - 0.00390625f - func_385("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23987.f_6339, Global_23987.f_6340), Global_23985 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23987.f_6339, Global_23987.f_6340);
				}
				else if (Global_23987.f_6334 > Global_23987.f_5828)
				{
					...
					{
						func_387();
						func_384((Global_23984 + iParam5) - 0.00390625f - func_385("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23987.f_6337, Global_23987.f_6336), Global_23985 + num38 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23987.f_6337, Global_23987.f_6336);
					}
				}
			}
			...
			func_388("CommonMenu", "Gradient_Bgd", Global_23984 + (iParam5 * 0.5f), (num42 + ((num36 - num42) * 0.5f)) - 0.00138888f, iParam5, num36 - num42, 0f, 255, 255, 255, 255, false, 0);
			...
			if (Global_23987.f_6334 > Global_23987.f_5828)
			{
				...
				func_389(Global_23984, num36 + 0f, iParam5, 0.034722f, r, g, b, a);
				...
				func_388("CommonMenu", "shop_arrows_upANDdown", Global_23984 + (iParam5 * 0.5f), num36 + 0f + (0.034722f * 0.5f), (textureResolution / 1280f) * num41, (textureResolution.f_1 / 720f) * num41, 0f, r, g, b, a, false, 0);
			...
			if (MISC::GET_HASH_KEY(&(Global_23987.f_5241)) != 0 && Global_23987.f_5323 != -1)
			{
				...
				{
					func_19(Global_23987.f_5325, true, true, &num26, &num27, bParam7);
				...
				func_389(Global_23984, num36 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_19(Global_23987.f_5325, true, true, &num26, &num27, bParam7);
					func_382(Global_23987.f_5325, true, &num32, &num33, &num34, &num35);
					func_388(func_26(Global_23987.f_5325), func_23(Global_23987.f_5325, true), Global_23984 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542374.f_21)) != 0 && Global_4542374.f_65 != -1)
			{
				...
				{
					func_19(Global_4542374.f_67, true, true, &num26, &num27, bParam7);
					x = (Global_23984 + num26 + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_19(Global_4542374.f_67, true, true, &num26, &num27, bParam7);
					func_382(Global_4542374.f_67, true, &num32, &num33, &num34, &num35);
					func_388(func_26(Global_4542374.f_67), func_23(Global_4542374.f_67, true), Global_23984 + (num26 * 0.5f) + (0.00078125f * 2f), (num36 + (num27 * 0.5f)) - (0.00138888f * 4f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
				}
		...
		if (i == 1 || !Global_23987.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_388("CommonMenu", "Gradient_Nav", Global_23984 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
						...
						switch (Global_23987.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0)
										{
											...
											func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, num46, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_19(Global_23987.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													num29 = num29 + num26;
									...
									if (flag6)
									{
										if (func_19(26, true, false, &num26, &num27, bParam7))
										{
											if (Global_23987.f_5686[k] == 2)
												x = x - (num26 * 2f);
											...
											if (func_19(26, true, true, &num26, &num27, bParam7))
											{
												func_382(26, true, &num32, &num33, &num34, &num35);
											
												if (i == 1)
													func_388(func_26(26), func_23(26, true), num24 + x + num30, (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
											}
										}
										...
										if (func_19(27, true, false, &num26, &num27, bParam7))
										{
											...
											if (func_19(27, true, true, &num26, &num27, bParam7))
											{
												...
												if (i == 1)
													func_388(func_26(27), func_23(27, true), num24 + x + num30 + num28 + num29, (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
									...
									if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23987.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_19(Global_23987.f_4984[num14 + num20], flag, false, &num26, &num27, bParam7))
												{
													x = x + (num26 * 0.5f);
												
													if (func_19(Global_23987.f_4984[num14 + num20], flag, true, &num26, &num27, bParam7))
													{
														func_382(Global_23987.f_4984[num14 + num20], flag, &num32, &num33, &num34, &num35);
													
														if (i == 1)
															if (Global_23987.f_5686[k] == 2)
																func_388(func_26(Global_23987.f_4984[num14 + num20]), func_23(Global_23987.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_388(func_26(Global_23987.f_4984[num14 + num20]), func_23(Global_23987.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_373(false, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, 0, flag5, flag4);
													...
													func_386(num24 - num49, num25 + num48, 0);
													num22 = num22 + 1;
												}
											}
										}
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23987.f_4984[num14 + l] != 2 && Global_23987.f_4984[num14 + l] != 54 && Global_23987.f_4984[num14 + l] != 64)
											{
												if (func_19(Global_23987.f_4984[num14 + l], flag, false, &num26, &num27, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_19(Global_23987.f_4984[num14 + l], flag, true, &num26, &num27, bParam7))
														{
															func_382(Global_23987.f_4984[num14 + l], flag, &num32, &num33, &num34, &num35);
														
															if (Global_23987.f_4984[num14 + l] == 30)
																func_388(func_26(Global_23987.f_4984[num14 + l]), func_23(Global_23987.f_4984[num14 + l], flag), Global_23984 + (num26 * 0.5f), (num25 + 0.00277776f + (num27 * 0.5f)) - (0.00078125f * 11f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else if (Global_23987.f_5686[k] == 2)
																func_388(func_26(Global_23987.f_4984[num14 + l]), func_23(Global_23987.f_4984[num14 + l], flag), ((num24 + x + num28) - (0.00078125f * 8f)) + (0.00078125f * 4f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
															else
																func_388(func_26(Global_23987.f_4984[num14 + l]), func_23(Global_23987.f_4984[num14 + l], flag), (num24 + x + num28) - (0.00078125f * 12f), (num25 - 0.00277776f) + (num37 * 0.5f), num26, num27, 0f, num32, num33, num34, num35, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, 0, false, false);
										func_367(num24 + x, num25, "NUMBER" /*~1~*/, Global_23987.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									if (flag6)
									{
										if (func_19(26, true, false, &num26, &num27, false))
										{
											if (Global_23987.f_5686[k] == 2)
												x = x - (num26 * 2f);
									...
									func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, 0, false, false);
									func_363(num24 + x, num25, "NUMBER" /*~1~*/, Global_23987.f_4726[num13], Global_23987.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_19(Global_23987.f_4984[num14], flag, false, &num26, &num27, bParam7))
									{
										if (!Global_23987.f_6332)
										{
											num29 = num26;
										...
										if (i == 1)
										{
											if (func_19(Global_23987.f_4984[num14], flag, true, &num26, &num27, bParam7))
											{
												func_382(Global_23987.f_4984[num14], flag, &num32, &num33, &num34, &num35);
												func_388(func_26(Global_23987.f_4984[num14]), func_23(Global_23987.f_4984[num14], flag), num24 + x + (num26 * 0.5f), (num25 - 0.00277776f) + (num37 * 0.5f), num26 * func_362(Global_23987.f_4984[num14]), num27 * func_362(Global_23987.f_4984[num14]), 0f, num32, num33, num34, num35, false, 0);
											}
										}
									}
								}
...
float func_362(int iParam0) // Position - 0x1EB5B
{
	switch (iParam0)
	{
		case 35:
...
void func_363(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x1EBCA
{
...
float func_364(float fParam0) // Position - 0x1EBED
{
	fParam0 = fParam0 * func_365();
	return fParam0;
}

float func_365() // Position - 0x1EC00
{
	return 1.7777778f / func_366();
}

float func_366() // Position - 0x1EC12
{
	return Global_23987.f_9117;
}

void func_367(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x1EC20
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x1EC42
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_369(BOOL bParam0) // Position - 0x1EC53
{
	int r;
	int g;
	int b;
...
float func_370(BOOL bParam0) // Position - 0x1EC99
{
	return func_371(HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(bParam0));
}

float func_371(float fParam0) // Position - 0x1ECAB
{
	fParam0 = fParam0 * func_372();
	return fParam0;
}

float func_372() // Position - 0x1ECBE
{
	return func_366() / 1.7777778f;
}

void func_373(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1ECD0
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_375(Global_23987.f_6614[iParam4], &r, &g, &b);
...
void func_374(float fParam0, float fParam1) // Position - 0x1EE7E
{
	HUD::SET_TEXT_WRAP(func_364(fParam0), func_364(fParam1));
	return;
}

void func_375(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1EE96
{
	switch (iParam0)
	{
		case 0:
...
void func_376(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x1F120
{
	int num;
	int i;
	int j;
...
BOOL func_377(Player plParam0, int iParam1) // Position - 0x1F625
{
	BOOL flag;
...
int func_378(int iParam0, BOOL bParam1) // Position - 0x1F67E
{
	int num;
	int num2;
...
BOOL func_379(Player plParam0) // Position - 0x1F6BF
{
	Player player;
...
BOOL func_380() // Position - 0x1F6E1
{
	var position;
...
BOOL func_381() // Position - 0x1F74F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_382(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x1F769
{
...
void func_383(float fParam0) // Position - 0x1F88A
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_374(fParam0, (Global_23984 + Global_23986) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_384(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x1F8E9
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_385(char* sParam0, int iParam1, int iParam2) // Position - 0x1F910
{
	if (!MISC::IS_STRING_NULL(sParam0))
...
void func_386(float fParam0, float fParam1, int iParam2) // Position - 0x1F952
{
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(func_364(fParam0), fParam1, iParam2);
	return;
}

void func_387() // Position - 0x1F968
{
	int r;
	int g;
	int b;
	...
	HUD::SET_TEXT_SCALE(0f, 0.35f);
	HUD::SET_TEXT_COLOUR(r, g, b, a);
	func_374(Global_23984 + 0.0046875f, (Global_23984 + Global_23986) - 0.0046875f);
	HUD::SET_TEXT_CENTRE(false);
	HUD::SET_TEXT_DROPSHADOW(0, 0, 0, 0, 0);
	HUD::SET_TEXT_EDGE(0, 0, 0, 0, 0);
	return;
...
void func_388(char* sParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, int iParam12) // Position - 0x1F9F2
{
...
void func_389(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1FA20
{
...
void func_390(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1FA57
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_393(Global_23987.f_5821, true);
	else
		func_393(Global_23987.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_392(&Global_23987.f_79[Global_23987.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_391(&Global_23987.f_79[Global_23987.f_5823 /*6*/]);
...
float func_391(char* sParam0) // Position - 0x1FC73
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_392(char* sParam0) // Position - 0x1FC8F
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
void func_393(int iParam0, BOOL bParam1) // Position - 0x1FCCC
{
	int num;
...
BOOL func_394(BOOL bParam0, BOOL bParam1) // Position - 0x1FD18
{
	if (Global_2672942.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_396(8, -1) && func_395() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79825 || Global_23987.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101765.f_1490)
		return false;

	return true;
}

int func_395() // Position - 0x1FDB5
{
	return Global_1575014;
}

BOOL func_396(int iParam0, int iParam1) // Position - 0x1FDC1
{
	switch (iParam0)
	{
		case 5:
...
int func_397(int iParam0, BOOL bParam1) // Position - 0x1FDF9
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_398(int* piParam0, int iParam1, int iParam2) // Position - 0x1FE80
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
	...
	if (func_419(0) == 1 && Global_4542450 == iParam1)
	{
		if (!func_444(piParam0))
		{
			func_399(piParam0);
...
void func_399(int* piParam0) // Position - 0x1FEF8
{
	if (!func_444(piParam0))
		func_459(piParam0);
...
int func_400(int* piParam0) // Position - 0x1FF10
{
	float controlNormal;
...
void func_401(var uParam0) // Position - 0x1FF95
{
	var r;
	var g;
	var b;
	...
	func_390(0, "DARTS_LEGS", 0, true, 0, false, 0);
	func_405(0, func_397(uParam0->f_662 + 1, true), false);
	func_390(1, "DARTS_SETS", 0, true, 0, false, 0);
	func_405(1, func_397(uParam0->f_664 + 1, false), false);
	func_404(2, 141, 141, 1);
	func_390(2, "DARTS_START", 0, true, 0, false, 0);
	func_403(0);
	func_422(uParam0->f_660, true, 1);
...
void func_402(eControlAction ecaParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x20090
{
	const char* controlInstructionalButtonsString;
...
void func_403(int iParam0) // Position - 0x20145
{
	Global_23987.f_6341 = iParam0;
	return;
}

void func_404(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x20155
{
	Global_23987.f_9112 = iParam3;
	Global_23987.f_9109[0] = iParam1;
	Global_23987.f_9109[1] = iParam2;
	Global_23987.f_9113 = iParam0;
	return;
}

void func_405(int iParam0, int iParam1, BOOL bParam2) // Position - 0x20183
{
	int num;
	float num2;
	float num3;
	...
	if (num != 2)
	{
		while (Global_23987.f_5822 < 4 && num != 2)
		{
			Global_23987.f_5822 = Global_23987.f_5822 + 1;
			num = Global_23987.f_5659[Global_23987.f_5822];
		}
	...
	Global_23987.f_4469[Global_23987.f_5825] = iParam1;
	Global_23987.f_5825 = Global_23987.f_5825 + 1;
	num2 = func_407("NUMBER" /*~1~*/, iParam1);
	...
	if (bParam2)
	{
		num4 = func_406("NUMBER" /*~1~*/, iParam1);
	...
	MISC::SET_BIT(&Global_23987.f_5692[iParam0], Global_23987.f_5822);
	Global_23987.f_5822 = Global_23987.f_5822 + 1;
	Global_23987.f_6347 = 2;
	return;
}

float func_406(char* sParam0, int iParam1) // Position - 0x20302
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	iParam1 == 0;
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
...
float func_407(char* sParam0, int iParam1) // Position - 0x20324
{
...
void func_408(int iParam0, char* sParam1, char* sParam2) // Position - 0x20356
{
	Global_23987 = iParam0;
	func_409(29, sParam1, sParam2);
	return;
}

void func_409(int iParam0, char* sParam1, char* sParam2) // Position - 0x2036D
{
...
void func_410(char* sParam0) // Position - 0x20391
{
	int i;
...
void func_411(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x203DC
{
...
void func_412(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2041B
{
...
void func_413(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2045A
{
...
void func_414(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x20504
{
	Global_23987.f_9086 = iParam4;
	Global_23987.f_9082 = uParam0;
	Global_23987.f_9083 = uParam1;
	Global_23987.f_9084 = uParam2;
	Global_23987.f_9085 = uParam3;
	return;
}

int func_415(int* piParam0, int iParam1, int iParam2) // Position - 0x20534
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
int func_416(int* piParam0) // Position - 0x205AC
{
	float controlNormal;
...
BOOL func_417(int* piParam0) // Position - 0x20624
{
	float controlNormal;
...
BOOL func_418(int* piParam0) // Position - 0x2069C
{
	float controlNormal;
...
int func_419(int iParam0) // Position - 0x20714
{
	float x;
	float y;
	float x2;
...
BOOL func_420() // Position - 0x207E1
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
...
void func_421(char* sParam0, int iParam1, int iParam2) // Position - 0x207FC
{
	int i;
...
void func_422(int iParam0, BOOL bParam1, int iParam2) // Position - 0x20861
{
	int i;
	int num;
...
BOOL func_423() // Position - 0x209B3
{
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		if (Global_4542450 > -1)
...
int func_424(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x209DA
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
void func_425(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20ABA
{
	float x;
	float y;
	float x2;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_389(num, num2 + ((float)num10 * 0.034722f), Global_23986, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_426(BOOL bParam0) // Position - 0x20D66
{
	float num;
	float num2;
	float num3;
	...
	if (Global_4542450 == -2)
		func_389(num, num2, Global_23986, num3, 255, 255, 255, num4);
	else if (Global_4542450 == -3)
		func_389(num, num2 + num3, Global_23986, num3, 255, 255, 255, num4);

	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
	return;
}

void func_427() // Position - 0x20DEF
{
...
float func_428(float fParam0) // Position - 0x20E37
{
	if (fParam0 < 1.3f)
		return 35f;
...
void func_429(var uParam0) // Position - 0x20E6D
{
	var r;
	var g;
	var b;
...
void func_430() // Position - 0x20F5D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_431(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5) // Position - 0x20F7B
{
	int i;
	int j;
...
void func_432(Object* pobParam0) // Position - 0x21397
{
	Vector3 vector;
...
void func_433(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x213D7
{
...
BOOL func_434(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x21420
{
	if (!func_444(&(uParam0->f_2)))
		func_459(&(uParam0->f_2));
...
void func_435(var uParam0, char* sParam1, const char* sParam2, int iParam3, eHudColour ehcParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x214B2
{
	char* methodName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x21541
{
	switch (iParam0)
	{
		case 0:
...
void func_437() // Position - 0x215BC
{
	CAM::SET_CAM_ACTIVE(caLocal_118, true);
	CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
...
// Unhandled jump detected. Output should be considered invalid
char* func_438(int iParam0) // Position - 0x21637
{
	if (iLocal_302 == 1)
	{
		switch (iParam0)
...
void func_439(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, BOOL bParam11) // Position - 0x216CA
{
...
Vector3 func_440(BOOL bParam0) // Position - 0x21722
{
	if (bParam0)
...
Vector3 func_441(int iParam0) // Position - 0x2174B
{
	switch (iParam0)
	{
		case 0:
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x217D5
{
...
int func_443(Ped pedParam0) // Position - 0x217EC
{
	if (!ENTITY::IS_ENTITY_DEAD(func_522(), false))
...
BOOL func_444(int* piParam0) // Position - 0x2181F
{
	return IS_BIT_SET(*piParam0, 1);
}

void func_445(int* piParam0) // Position - 0x2182C
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
void func_446(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x21842
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

float func_447(int* piParam0) // Position - 0x21859
{
	if (func_444(piParam0))
		if (func_9(piParam0))
			return piParam0->f_2;
...
void func_448(int* piParam0) // Position - 0x21892
{
	if (!func_444(piParam0))
		func_399(piParam0);
	else
...
void func_449() // Position - 0x218B3
{
	Global_21308 = 0;
	func_450();
	return;
...
void func_450() // Position - 0x218C3
{
...
void func_451(int iParam0) // Position - 0x2191A
{
	if (func_43())
		return;
...
BOOL func_452() // Position - 0x219A4
{
...
void func_453(BOOL bParam0, BOOL bParam1) // Position - 0x219CB
{
	if (bParam0)
	{
		if (func_42(0))
...
BOOL func_454() // Position - 0x21A3F
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_455() // Position - 0x21A4D
{
	if (HUD::IS_PAUSE_MENU_ACTIVE())
		return false;
...
BOOL func_456(var uParam0) // Position - 0x21A7F
{
...
BOOL func_457(Vehicle veParam0) // Position - 0x21AF2
{
...
void func_458(var uParam0, int iParam1) // Position - 0x21B35
{
	iParam1 = iParam1 + 1;
...
void func_459(int* piParam0) // Position - 0x21B59
{
	func_460(piParam0, 0f);
	return;
}

void func_460(int* piParam0, float fParam1) // Position - 0x21B68
{
	piParam0->f_1 = func_8(IS_BIT_SET(*piParam0, 4)) - fParam1;
	MISC::SET_BIT(piParam0, 1);
	MISC::CLEAR_BIT(piParam0, 2);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x21B93
{
...
void func_462(var uParam0, char* sParam1, char* sParam2) // Position - 0x21C2E
{
...
void func_463(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, Any* panParam7, var uParam8) // Position - 0x21C52
{
	int _int;
	Hash entityModel;
...
void func_464(Hash hParam0) // Position - 0x21E4B
{
	int randomIntInRange;
...
BOOL func_465(Any* panParam0) // Position - 0x21EEA
{
	int i;
...
eCharacter func_466(Ped pedParam0) // Position - 0x21FD3
{
	eCharacter i;
	Hash entityModel;
	eCharacter character;
...
Hash func_467(eCharacter echParam0) // Position - 0x22019
{
...
char* func_469(char* sParam0) // Position - 0x22061
{
...
void func_470(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2219B
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
...
void func_471(var uParam0, var uParam1) // Position - 0x22203
{
...
void func_472(var uParam0, var uParam1) // Position - 0x2223E
{
...
BOOL func_473(var uParam0, var uParam1) // Position - 0x22290
{
...
BOOL func_474(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x22374
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_475(int iParam0) // Position - 0x22482
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_476(var uParam0, var uParam1) // Position - 0x22524
{
...
int func_477() // Position - 0x22592
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
}

int func_478() // Position - 0x225A2
{
	return GRAPHICS::REQUEST_SCALEFORM_MOVIE("MP_BIG_MESSAGE_FREEMODE");
}

void func_479(var uParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x225B2
{
	int i;
	int j;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x226CE
{
...
void func_481(int iParam0) // Position - 0x226F8
{
	int num;
...
void func_482(var uParam0, int iParam1) // Position - 0x227CB
{
	if (iParam1 == 0)
...
void func_483() // Position - 0x227F2
{
	int i;
...
void func_484(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2281B
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
void func_485(var uParam0, var uParam1) // Position - 0x22A7E
{
	uParam0->f_1 = { *uParam1 };
...
void func_486() // Position - 0x22B3A
{
	Global_23848.f_6 = 1;
	return;
}

void func_487(int iParam0, BOOL bParam1) // Position - 0x22B48
{
	if (bParam1)
...
int func_488(eCharacter echParam0, int iParam1) // Position - 0x22B6A
{
	var outValue;
	Hash statHash;
...
Hash func_489(eCharacter echParam0, int iParam1) // Position - 0x22B88
{
	var unk;
	var unk2;
...
void func_490(eCharacter echParam0, int iParam1, var uParam2, var uParam3) // Position - 0x22B9E
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_491(BOOL bParam0) // Position - 0x22DF5
{
	if (bParam0)
	{
		func_492();
...
void func_492() // Position - 0x22E58
{
...
void func_493(var uParam0, var uParam1, var uParam2) // Position - 0x22E81
{
	int i;
	int j;
...
void func_494() // Position - 0x22FD0
{
	func_495();
	return;
}

int func_495() // Position - 0x22FDD
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x23028
{
...
void func_497(int iParam0, int iParam1, int iParam2) // Position - 0x23050
{
	BOOL flag;
...
void func_498() // Position - 0x23136
{
	int num;
	float num2;
	float num3;
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_114162.f_10198.f_3853))
		func_93(13, SYSTEM::FLOOR(Global_114162.f_10198.f_3853));
...
int func_499() // Position - 0x235F4
{
	return Global_33105;
}

void func_500(int iParam0, BOOL bParam1) // Position - 0x235FF
{
	var unk;
	var unk8;
...
void func_501(var uParam0, int iParam1) // Position - 0x236AA
{
	if (uParam0->f_1 != 0)
	{
...
void func_502(var uParam0) // Position - 0x23759
{
...
Vector3 func_503(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x23891
{
	if (bParam0)
		return uParam1;
...
void func_504(int iParam0, int iParam1) // Position - 0x238AC
{
...
int func_505() // Position - 0x238D4
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_506(int* piParam0) // Position - 0x238E4
{
...
void func_507(var uParam0) // Position - 0x23900
{
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uParam0);
	return;
}

void func_508() // Position - 0x2390E
{
	HUD::CLEAR_HELP(true);
...
void func_509() // Position - 0x2392F
{
...
void func_510(var uParam0) // Position - 0x23946
{
	Vehicle vehicle;
...
void func_511() // Position - 0x2397D
{
	int num;
...
void func_512() // Position - 0x239EE
{
	Global_101748 = 1;
...
BOOL func_513(int iParam0) // Position - 0x23ADD
{
	int num;
	int num2;
	...
	PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID(), 0);
	func_514(&(Global_114162.f_2367.f_539), num2);
...
void func_514(var uParam0, int iParam1) // Position - 0x23BED
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_516(Global_114162.f_18537[i], &unk, &num2))
			{
...
void func_515(var uParam0) // Position - 0x23DB3
{
	*uParam0 = -15;
	return;
}

BOOL func_516(int iParam0, var uParam1, var uParam2) // Position - 0x23DC1
{
	switch (iParam0)
	{
		case 11:
...
void func_517(int iParam0, BOOL bParam1) // Position - 0x24731
{
	if (bParam1)
...
BOOL func_519() // Position - 0x247A1
{
...
void func_520(int iParam0, BOOL bParam1) // Position - 0x247DF
{
...
Ped func_521() // Position - 0x24844
{
	return Global_97521;
}

Ped func_522() // Position - 0x24850
{
	return Global_97520;
}

void func_523() // Position - 0x2485C
{
	if (bLocal_258 == true)
		return;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2487F
{
	eCharacter i;
	Hash entityModel;
