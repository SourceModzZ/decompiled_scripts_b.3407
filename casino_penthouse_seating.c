...
int func_69() // Position - 0x1F89
{
	return Global_1574633.f_18;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1F97
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x201B
{
	switch (func_73())
	{
		case 0:
...
int func_73() // Position - 0x2072
{
	return Global_33105;
}

BOOL func_74() // Position - 0x207D
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x208C
{
...
BOOL func_76() // Position - 0x20A3
{
	return Global_2696433;
}

BOOL func_77() // Position - 0x20AF
{
	return Global_2684721.f_695;
}

int func_78() // Position - 0x20BE
{
	return func_79(PLAYER::PLAYER_ID());
}

int func_79(Player plParam0) // Position - 0x20CE
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_80(Player plParam0) // Position - 0x20EB
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		if (func_82(plParam0) && !func_81(plParam0))
			return true;

	return false;
}

BOOL func_81(Player plParam0) // Position - 0x2124
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_82(Player plParam0) // Position - 0x2155
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_83(Player plParam0) // Position - 0x2186
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_84(Global_2657994[plParam0 /*467*/].f_324.f_8) == 15;

	return false;
}

int func_84(int iParam0) // Position - 0x21CD
{
	switch (iParam0)
	{
		case 0:
...
void func_86() // Position - 0x2714
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_87(var uParam0) // Position - 0x2720
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x277F
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_98(PLAYER::PLAYER_ID(), 0) && !func_97() && !func_96(PLAYER::PLAYER_ID()))
			...
			else
			{
				if (!func_92(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_89(*Global_4718592.f_194133))
...
BOOL func_89(int iParam0) // Position - 0x2C33
{
	return iParam0 == 17;
}

void func_90() // Position - 0x2C40
{
	var unk;
...
BOOL func_92(Ped pedParam0) // Position - 0x2CCB
{
	int scriptTaskStatus;
...
void func_93(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2CFC
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2DCC
{
	Hash statName;
...
BOOL func_96(Player plParam0) // Position - 0x2E40
{
...
BOOL func_97() // Position - 0x2E7F
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_98(Player plParam0, int iParam1) // Position - 0x2E8D
{
	BOOL flag;
...
int func_99(int iParam0, BOOL bParam1) // Position - 0x2EE6
{
	int num;
	int num2;
...
int func_100() // Position - 0x2F27
{
	return Global_1574926;
}

BOOL func_101(Player plParam0) // Position - 0x2F33
{
	Player player;
...
void func_104() // Position - 0x2FB7
{
	func_105(0, &uLocal_136, 0, 3);
	func_105(1, &uLocal_136, 1, 3);
	func_105(2, &uLocal_136, 2, 3);
	func_105(3, &uLocal_136, 3, 1);
	func_105(4, &uLocal_136, 4, 1);
	func_105(5, &uLocal_136, 5, 1);
	func_105(6, &uLocal_136, 6, 1);
	func_105(7, &uLocal_136, 7, 1);
	func_105(8, &uLocal_136, 8, 1);
	func_105(9, &uLocal_136, 9, 1);
	func_105(10, &uLocal_136, 10, 1);
	func_105(11, &uLocal_136, 11, 1);
	func_105(12, &uLocal_136, 12, 1);
	func_105(13, &uLocal_136, 13, 1);
	func_105(14, &uLocal_136, 14, 1);
	func_105(15, &uLocal_136, 15, 1);
	func_105(16, &uLocal_136, 16, 1);
	func_105(17, &uLocal_136, 17, 1);
	func_105(18, &uLocal_136, 18, 1);
	func_105(19, &uLocal_136, 19, 1);
	return;
}

void func_105(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x308B
{
	var unk;
	float num;
...
Vector3 func_106() // Position - 0x311C
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_107(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x312F
{
	float num;
	float num2;
	float num3;
...
float func_108(int iParam0, float fParam1) // Position - 0x3173
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_109() // Position - 0x31AC
{
	return -0.5f, -0.5f, 0f;
}

void func_110(int iParam0, var uParam1, var uParam2) // Position - 0x31BF
{
	if (func_4())
	{
		switch (iParam0)
...
void func_111() // Position - 0x377F
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x3787
{
	int i;
...
BOOL func_113(BOOL bParam0) // Position - 0x389D
{
	bParam0;
	return Global_1575058;
}

int func_114() // Position - 0x38AE
{
	int unk;
