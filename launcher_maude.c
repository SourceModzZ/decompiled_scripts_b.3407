	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x194A
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27F5
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x287D
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x47C5
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5546
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5581
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57F5
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D80
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A27
{
	int i;
...
int func_97() // Position - 0x8792
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x87A2
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x87BF
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x87CF
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8B12
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8B23
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8B69
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8BEF
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8C22
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8C73
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8D15
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D37
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8D4E
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8D5B
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8D95
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8DD0
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E0C
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8E25
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E88
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E9E
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8EB4
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EF6
{
...
struct<2> func_119(int iParam0) // Position - 0x8F1E
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x936B
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA643
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA989
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAA2E
{
	var name;
...
void func_125(int iParam0) // Position - 0xAAC9
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAB27
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB80
{
...
int func_129(Ped pedParam0) // Position - 0xAC03
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAC34
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC49
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xACFC
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD17
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAD63
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xADAC
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xADCC
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xADED
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAEBD
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF10
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB006
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB071
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0B0
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB1FF
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB219
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB272
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB2B3
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB2D5
{
...
BOOL func_150() // Position - 0xB314
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB322
{
	int num;
...
void func_153(int iParam0) // Position - 0xB37C
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB39F
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB443
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4D2
{
...
void func_161(Vehicle veParam0) // Position - 0xB529
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB555
{
...
void func_164(int iParam0) // Position - 0xB6F7
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB72A
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB7B4
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB828
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_168(int iParam0) // Position - 0xB836
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB88D
{
	return IS_BIT_SET(Global_1958240, 19);
}

BOOL func_170(int iParam0) // Position - 0xB89C
{
...
BOOL func_171(int iParam0) // Position - 0xB8DD
{
	int num;
...
void func_172(int iParam0) // Position - 0xB922
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB954
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA8B
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBADA
{
	return func_176(iParam0, Global_44199);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBAEB
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBCCC
{
	if (Global_44199 == 15)
		return false;
...
int func_178() // Position - 0xBCEE
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBCFF
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD48
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD6C
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCF21
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xD012
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xD04E
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xD087
{
	BOOL flag;
	int i;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD125
{
...
BOOL func_201() // Position - 0xD15F
{
	return Global_98997;
}

void func_202(var uParam0) // Position - 0xD16B
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD182
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD26A
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD292
{
	var unk;
	...
	if (func_242(*panParam0) || func_240(*panParam0) || Global_79810 == 1)
		return true;
...
void func_206(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD502
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_207(int iParam0) // Position - 0xD85A
{
...
BOOL func_208(var uParam0) // Position - 0xD87A
{
...
BOOL func_209(var uParam0) // Position - 0xD892
{
...
void func_210(var uParam0) // Position - 0xD8B7
{
	int i;
	int taskSequenceId;
...
void func_211(Object* pobParam0) // Position - 0xDBBB
{
...
void func_212(var uParam0) // Position - 0xDBE6
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC66
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_214(Ped pedParam0, Vehicle veParam1) // Position - 0xDE24
{
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDE54
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE110
{
...
BOOL func_217(Ped pedParam0, int iParam1) // Position - 0xE144
{
	float xSize;
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE1BA
{
	return func_219(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_219(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE1D2
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_220(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE293
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_221(Ped pedParam0, int iParam1) // Position - 0xE3BF
{
...
BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE4CE
{
	var unk;
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE55F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE580
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE5BF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(Ped pedParam0, Ped pedParam1) // Position - 0xE5DA
{
	int i;
...
BOOL func_228(Ped pedParam0) // Position - 0xE619
{
...
BOOL func_229(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE641
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE73C
{
	float entityCoords;
	float num;
...
BOOL func_231(Ped pedParam0, float fParam1) // Position - 0xE848
{
	var outProjectile;
	var outCoords;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8DD
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_233(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE96B
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_234(int iParam0) // Position - 0xE9B3
{
...
void func_235(Ped pedParam0) // Position - 0xE9FD
{
	int taskSequenceId;
...
BOOL func_236(int iParam0) // Position - 0xEA9A
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEB2F
{
...
BOOL func_240(int iParam0) // Position - 0xEBAE
{
	if (func_241() && Global_101713.f_11 == 6 && iParam0 == func_179(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_241() // Position - 0xEBE2
{
...
BOOL func_242(int iParam0) // Position - 0xEC20
{
...
BOOL func_243(var uParam0) // Position - 0xEC48
{
	if (!func_244(uParam0))
		return false;
...
BOOL func_244(var uParam0) // Position - 0xEC67
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_245(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEEFF
{
...
BOOL func_246(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEF5B
{
	Hash model;
...
int func_247(var uParam0, eCharacter echParam1) // Position - 0xEFE9
{
	int num;
...
void func_248(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF02F
{
	func_211(pobParam0);
...
BOOL func_249(var uParam0) // Position - 0xF056
{
	int i;
...
void func_250(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF087
{
	Vector3 vector;
	Vector3 vector2;
...
Hash func_251(eCharacter echParam0) // Position - 0xF188
{
	if (!func_36(echParam0))
...
BOOL func_252(int iParam0) // Position - 0xF1AE
{
	var unk;
	eCharacter character;
...
BOOL func_253(int iParam0) // Position - 0xF1FF
{
	const char* string2;
...
BOOL func_254(int iParam0) // Position - 0xF2B8
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF379
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_256(int iParam0, char* sParam1) // Position - 0xF3FE
{
...
BOOL func_257(int iParam0) // Position - 0xF4E0
{
...
BOOL func_258(int iParam0) // Position - 0xF50B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF536
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF561
{
	if (func_237(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF5B0
{
	int i;
...
BOOL func_263(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF615
{
	int num;
	char* str;
...
BOOL func_264(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF68D
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF708
{
	if (bParam1)
	{
...
int func_266(var uParam0) // Position - 0xF76D
{
	if (func_209(uParam0))
	{
...
void func_267(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF7A3
{
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xF7C3
{
	func_269(&(uParam0->f_41), bParam1);
	return;
}

void func_269(var uParam0, BOOL bParam1) // Position - 0xF7D5
{
	int i;
...
void func_270(Object* pobParam0, BOOL bParam1) // Position - 0xF813
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xF84E
{
	func_272(&(uParam0->f_35), bParam1);
	return;
}

void func_272(var uParam0, BOOL bParam1) // Position - 0xF860
{
	int i;
...
void func_273(Vehicle* pveParam0) // Position - 0xF89D
{
...
void func_274(Vehicle* pveParam0) // Position - 0xF8D5
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_275(var uParam0, int iParam1) // Position - 0xF971
{
	func_276(&(uParam0->f_28), iParam1);
	return;
}

void func_276(var uParam0, int iParam1) // Position - 0xF983
{
	int i;
...
void func_277(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF9C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_278(Ped* ppedParam0) // Position - 0xFA14
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_279(var uParam0) // Position - 0xFA55
{
...
BOOL func_280(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xFAC6
{
...
void func_281(int iParam0) // Position - 0xFAF9
{
	if (*iParam0 == -1)
		return;
...
void func_282(char* sParam0) // Position - 0xFB36
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_283(var uParam0) // Position - 0xFB48
{
	*uParam0 = -1;
