...
BOOL func_21(Ped pedParam0) // Position - 0xB8D
{
...
void func_22(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0xBBE
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0xC8E
{
	Hash statName;
...
void func_37(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEA5
{
	if (bParam0)
	{
...
int func_39(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x100E
{
	int num;
...
void func_49(BOOL bParam0) // Position - 0x1273
{
	int i;
...
void func_61(Vehicle veParam0) // Position - 0x14D6
{
...
BOOL func_62(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1572
{
	int i;
	int num;
	Ped ped;
...
Ped func_64(Vehicle veParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x165F
{
	Ped pedInVehicleSeat;
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A32
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C22
{
	Hash entityModel;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_140(veParam0, uParam1, bParam2, bParam3);
			...
			if (func_139(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (uParam1->f_9[44] == 2)
			...
			if (func_138(ENTITY::GET_ENTITY_MODEL(veParam0)))
			{
				if (IS_BIT_SET(uParam1->f_103, 0) || func_137(ENTITY::GET_ENTITY_MODEL(veParam0)))
				{
					VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, false, true);
					func_136(veParam0);
				}
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2184
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Vehicle veParam0) // Position - 0x2194
{
	Hash entityModel;
...
BOOL func_80(Hash hParam0) // Position - 0x21DA
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_81(Hash hParam0) // Position - 0x2284
{
	return func_139(hParam0) && !func_82(hParam0);
}

BOOL func_82(Hash hParam0) // Position - 0x229E
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x22D3
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x23DA
{
	Hash entityModel;
...
void func_85(var uParam0, var uParam1, var uParam2) // Position - 0x2465
{
	Hash eventData;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24A6
{
	int address;
	int i;
	Player player;
...
BOOL func_87(int iParam0) // Position - 0x250B
{
	int i;
...
BOOL func_88(int iParam0) // Position - 0x2546
{
	return func_89(iParam0, 6, true);
}

BOOL func_89(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2556
{
	if (iParam0 == -1)
		return false;
...
int func_90(int iParam0, int iParam1) // Position - 0x25B6
{
	Hash statHash;
	int outValue;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x25E5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_92(iParam1));
}

int func_92(int iParam0) // Position - 0x25FA
{
	int num;
	int num2;
...
int func_93(int iParam0) // Position - 0x262E
{
	switch (iParam0)
	{
		case 0:
...
int func_94() // Position - 0x29E5
{
	return Global_33105;
}

int func_95(int iParam0) // Position - 0x29F0
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_96() // Position - 0x2D33
{
	return Global_101765.f_400 > 0;
}

int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2D44
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2DC1
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2E4E
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2EAA
{
	func_104();
	...
	func_102(*uParam0, &Global_1944325, &(Global_1944325.f_1), &(Global_1944325.f_4), &(Global_1944325.f_7), &(Global_1944325.f_10));
	...
	{
		if (func_101(uParam0, plParam1, Global_1944325, Global_1944325.f_1, Global_1944325.f_4, Global_1944325.f_7, Global_1944325.f_10, 0, Global_1944325.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1944325.f_23 == 0 && func_101(uParam0, plParam1, Global_1944325, Global_1944325.f_1, Global_1944325.f_4, Global_1944325.f_7, Global_1944325.f_10, 0, Global_1944325.f_13) || Global_1944325.f_23 != 0 && Global_1944325.f_24 == 0 && func_101(uParam0, plParam1, Global_1944325, Global_1944325.f_14, Global_1944325.f_17, Global_1944325.f_20, Global_1944325.f_10, 1, Global_1944325.f_13) || Global_1944325.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577967 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3155
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x317E
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_103(Global_1944351, 0f, 0f, 0f, false) && !func_103(Global_1944354, 0f, 0f, 0f, false) && !func_103(Global_1944357, 0f, 0f, 0f, false) && !(Global_1944360 == 0f))
	{
...
BOOL func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8F4A
{
	if (bParam6)
...
BOOL func_105(Vehicle veParam0) // Position - 0x900A
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x9042
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x908A
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x91E7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x9532
{
...
int func_110(Player plParam0) // Position - 0x955E
{
...
int func_111(Player plParam0) // Position - 0x957B
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x959E
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x95E2
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
BOOL func_115(BOOL bParam0) // Position - 0x961B
{
	return func_116(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x962D
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x963E
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x969A
{
	if (func_11(plParam0))
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x96E9
{
	int num;
	int num2;
...
int func_120(int iParam0) // Position - 0x9747
{
	return iParam0 % 32;
}

int func_121(int iParam0) // Position - 0x9754
{
	int num;
...
int func_122(int iParam0) // Position - 0x976B
{
	int num;
	int num2;
...
int func_123(int iParam0) // Position - 0x9798
{
	return iParam0 / 32;
}

BOOL func_124(Player plParam0) // Position - 0x97A5
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_125(plParam0) && Global_2657994[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_125(Player plParam0) // Position - 0x97DA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_126(Global_2657994[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_126(int iParam0) // Position - 0x9821
{
	switch (iParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9D56
{
	int num;
	int num2;
...
BOOL func_128(int iParam0, var uParam1) // Position - 0x9D77
{
	*uParam1 = -1;
...
int func_129(int iParam0) // Position - 0xA039
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1, int iParam2) // Position - 0xA0D7
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_131() && Global_1576242)
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA301
{
	var gamerHandle;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA316
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA337
{
	*uParam1 = -1f;
...
void func_135(Vehicle veParam0) // Position - 0xA638
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA66A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA69E
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA6BB
{
...
BOOL func_139(Hash hParam0) // Position - 0xAC0C
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAC9B
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_161(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_160())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
			func_149(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_143() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_142(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_141(veParam0, 5f))
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xB39E
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xB40F
{
	if (bParam0)
...
BOOL func_143() // Position - 0xB429
{
	...
	if (func_147(7))
		if (func_145(Global_2672942.f_4.f_16) || func_144(Global_2672942.f_4.f_16))
			return false;

	return true;
}

BOOL func_144(int iParam0) // Position - 0xB4B8
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xB4DC
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xB4FA
{
	return IS_BIT_SET(Global_1887694[iParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_147(int iParam0) // Position - 0xB512
{
	return func_148(&(Global_2672942.f_194), iParam0);
}

BOOL func_148(var uParam0, int iParam1) // Position - 0xB526
{
	int num;
	int num2;
	int num3;
...
int func_149(var uParam0, var uParam1, var uParam2) // Position - 0xB549
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_156(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_154(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_152(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_152(*uParam0, uParam1->[38] - 1), false);
...
BOOL func_150(Vehicle veParam0) // Position - 0xB747
{
	int i;
	int modType;
	Hash hashKey;
...
void func_151(var uParam0) // Position - 0xB821
{
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xB88C
{
	int value;
	int value2;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		value = func_153(veParam0, 38) + 1;
		value2 = func_153(veParam0, 24) + 1;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xB975
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_156(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_154(Hash hParam0) // Position - 0xB9D7
{
	if (func_155(hParam0, 1))
		return true;
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xBA02
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBDE1
{
	if (!func_157() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_157() // Position - 0xBE05
{
	return true;
}

void func_158(Vehicle veParam0, int iParam1) // Position - 0xBE12
{
	int vehicleMod;
...
BOOL func_159(int iParam0) // Position - 0xBE8A
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_160() // Position - 0xBEAA
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_161(Vehicle veParam0) // Position - 0xBEBB
{
	int _int;
...
int func_162(var uParam0) // Position - 0xBF00
{
...
BOOL func_163(int iParam0) // Position - 0xBF20
{
	switch (iParam0)
	{
		case 161:
...
int func_164(int iParam0) // Position - 0xBF73
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_165(Vehicle veParam0) // Position - 0xC024
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC0AB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC0F8
{
...
void func_168(var uParam0) // Position - 0xC119
{
...
void func_169(var uParam0) // Position - 0xC167
{
	if (func_286(PLAYER::PLAYER_ID(), false, false))
		return;
	...
	if (!uParam0->f_15)
		if (!STREAMING::NEW_LOAD_SCENE_START(uParam0->f_9, func_170(uParam0->f_12), 4000f, 0))
			return;
		else
			uParam0->f_15 = 1;
...
Vector3 func_170(float fParam0, var uParam1, var uParam2) // Position - 0xC221
{
	return -SYSTEM::SIN(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::COS(fParam0.f_2) * SYSTEM::COS(fParam0), SYSTEM::SIN(fParam0);
}

BOOL func_171(var uParam0) // Position - 0xC24E
{
	Player player;
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(func_285(), false, false, true, true);
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(func_285(), false, false, false, false);
	
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23))
			return false;
	
		func_172(uParam0->f_23, &Global_1880027[player /*55*/], false, -1);
	}
...
void func_172(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC326
{
	var unk;
	int characterType;
	BOOL flag;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		characterType = func_279(pedParam0);
		flag = func_276(pedParam0, false);
		flag2 = func_268(pedParam0);
		flag3 = func_191(pedParam0, iParam3);
		...
		for (i = 0; i < 127; i = i + 1)
		{
			if (IS_BIT_SET(uParam1->[i / 32], i % 32))
				if (func_181(&unk, i, characterType, pedParam0, -1))
					if (func_174(pedParam0, &unk, i, unk.f_4, unk.f_8, flag, flag2, bParam2, flag3))
		...
		for (j = 0; j < numTattooShopDlcItems; j = j + 1)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(characterType, j, &outComponent))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(outComponent))
				{
					...
					{
						if (func_174(pedParam0, &(outComponent.f_7), num, outComponent.f_2, outComponent.f_6, flag, flag2, bParam2, flag3))
						{
							PED::ADD_PED_DECORATION_FROM_HASHES_IN_CORONA(pedParam0, outComponent.f_2, outComponent.f_3);
							func_173(pedParam0, outComponent.f_2, outComponent.f_3);
						}
					}
				}
			}
...
void func_173(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC48F
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_174(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD766
{
	Hash entityModel;
	int num;
	...
	if (hParam4 == 0)
	{
		num = func_180(entityModel, sParam1, hParam4);
		hParam4 = MISC::GET_HASH_KEY(func_179(num));
	}
				...
				if (!bParam6)
				{
					if (Global_4542048 == -1)
					{
						if (!Global_101765.f_1589)
						{
							...
							else if (func_175(14, -1))
							{
								return false;
							}
							else if (func_175(15, -1))
							{
								return false;
							}
							else if (func_175(16, -1))
							{
								return false;
							}
							else if (func_175(71, -1))
							{
								return false;
							}
							else if (func_175(72, -1))
							{
							}
						}
					}
...
BOOL func_175(int iParam0, int iParam1) // Position - 0xDF8C
{
	int num;
	int num2;
...
int func_176(int iParam0, int iParam1) // Position - 0xDFCB
{
	int num;
	int num2;
...
int func_177() // Position - 0xE011
{
	return Global_33106;
}

int func_178(int iParam0) // Position - 0xE01C
{
	int num;
	int num2;
	...
	if (func_94() == 0 || func_177() == 0 || func_94() == 999 && func_177() == 999)
	{
		switch (num2)
		{
			case 0:
...
char* func_179(int iParam0) // Position - 0xE3BD
{
	switch (iParam0)
	{
		case 0:
...
int func_180(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE9FA
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_181(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xFA2C
{
	Hash entityModel;
	int num;
	...
	switch (iParam2)
	{
		case 0:
			...
			{
				case 0:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_01", "singleplayer_overlays", "MK_000", "", iParam2, 300, 3);
					break;
			
				case 1:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_02", "singleplayer_overlays", "MK_001", "", iParam2, 450, 0);
					break;
			
				case 2:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_03", "singleplayer_overlays", "MK_002", "", iParam2, 250, 4);
					break;
			
				case 3:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_04", "singleplayer_overlays", "MK_003", "", iParam2, 175, 0);
					break;
			
				case 4:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_06", "singleplayer_overlays", "MK_005", "", iParam2, 380, 0);
					break;
			
				case 5:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_07", "singleplayer_overlays", "MK_006", "", iParam2, 180, 0);
					break;
			
				case 6:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_08", "singleplayer_overlays", "MK_007", "", iParam2, 240, 0);
					break;
			
				case 7:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_10", "singleplayer_overlays", "MK_009", "", iParam2, 195, 0);
					break;
			
				case 8:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_11", "singleplayer_overlays", "MK_010", "", iParam2, 280, 6);
					break;
				...
				case 9:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, pedParam3, "TAT_MIC_12", "singleplayer_overlays", "MK_011", "", iParam2, num, 2);
					}
					break;
			
				case 10:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_13", "singleplayer_overlays", "MK_012", "", iParam2, 320, 3);
					break;
			
				case 11:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_14", "singleplayer_overlays", "MK_013", "", iParam2, 500, 2);
					break;
			
				case 12:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_16", "singleplayer_overlays", "MK_015", "", iParam2, 220, 0);
					break;
			
				case 13:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_17", "singleplayer_overlays", "MK_016", "", iParam2, 320, 4);
					break;
			
				case 14:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_18", "singleplayer_overlays", "MK_017", "", iParam2, 140, 2);
					break;
			
				case 15:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_20", "singleplayer_overlays", "MK_019", "", iParam2, 350, 0);
					break;
			
				case 16:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_21", "singleplayer_overlays", "MK_020", "", iParam2, 350, 0);
					break;
			
				case 17:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_05", "singleplayer_overlays", "MK_004", "", iParam2, 120, 1);
					break;
			
				case 18:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_09", "singleplayer_overlays", "MK_008", "", iParam2, 99, 1);
					break;
			
				case 19:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_15", "singleplayer_overlays", "MK_014", "", iParam2, 400, 1);
					break;
			
				case 20:
					func_190(sParam0, iParam1, pedParam3, "TAT_MIC_19", "singleplayer_overlays", "MK_018", "", iParam2, 420, 1);
					break;
			
				default:
					func_182(sParam0, iParam2, iParam1, 21);
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 0:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, pedParam3, "TAT_FRA_01", "singleplayer_overlays", "fr_000", "", iParam2, num, 0);
					}
					break;
			
				case 1:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_02", "singleplayer_overlays", "fr_001", "", iParam2, 230, 0);
					break;
			
				case 2:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_03", "singleplayer_overlays", "fr_002", "", iParam2, 310, 0);
					break;
			
				case 3:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_04", "singleplayer_overlays", "fr_003", "", iParam2, 260, 0);
					break;
			
				case 4:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_07", "singleplayer_overlays", "fr_006", "", iParam2, 240, 2);
					break;
			
				case 5:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_08", "singleplayer_overlays", "fr_007", "", iParam2, 190, 3);
					break;
			
				case 6:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_09", "singleplayer_overlays", "fr_008", "", iParam2, 200, 2);
					break;
			
				case 7:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_10", "singleplayer_overlays", "fr_009", "", iParam2, 225, 0);
					break;
			
				case 8:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_12", "singleplayer_overlays", "fr_011", "", iParam2, 195, 0);
					break;
			
				case 9:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_13", "singleplayer_overlays", "fr_012", "", iParam2, 275, 2);
					break;
			
				case 10:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_14", "singleplayer_overlays", "fr_013", "", iParam2, 80, 0);
					break;
			
				case 11:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_15", "singleplayer_overlays", "fr_014", "", iParam2, 95, 0);
					break;
			
				case 12:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_16", "singleplayer_overlays", "fr_015", "", iParam2, 300, 3);
					break;
			
				case 13:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_17", "singleplayer_overlays", "fr_016", "", iParam2, 450, 3);
					break;
			
				case 14:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_18", "singleplayer_overlays", "fr_017", "", iParam2, 345, 3);
					break;
			
				case 15:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_19", "singleplayer_overlays", "fr_018", "", iParam2, 550, 0);
					break;
			
				case 16:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_20", "singleplayer_overlays", "fr_019", "", iParam2, 200, 0);
					break;
			
				case 17:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_21", "singleplayer_overlays", "fr_020", "", iParam2, 180, 0);
					break;
			
				case 18:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_22", "singleplayer_overlays", "fr_021", "", iParam2, 140, 0);
					break;
			
				case 19:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_24", "singleplayer_overlays", "fr_023", "", iParam2, 245, 0);
					break;
				...
				case 21:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_26", "singleplayer_overlays", "fr_025", "", iParam2, 370, 0);
					break;
			
				case 22:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_27", "singleplayer_overlays", "fr_026", "", iParam2, 350, 0);
					break;
			
				case 23:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_28", "singleplayer_overlays", "fr_027", "", iParam2, 310, 0);
					break;
			
				case 24:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_29", "singleplayer_overlays", "fr_028", "", iParam2, 210, 0);
					break;
			
				case 25:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_30", "singleplayer_overlays", "fr_029", "", iParam2, 245, 0);
					break;
			
				case 26:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_31", "singleplayer_overlays", "fr_030", "", iParam2, 85, 0);
					break;
			
				case 27:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_32", "singleplayer_overlays", "fr_031", "", iParam2, 210, 0);
					break;
			
				case 28:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_33", "singleplayer_overlays", "fr_032", "", iParam2, 225, 0);
					break;
			
				case 29:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_34", "singleplayer_overlays", "fr_033", "", iParam2, 145, 0);
					break;
			
				case 30:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_35", "singleplayer_overlays", "fr_034", "", iParam2, 230, 0);
					break;
			
				case 31:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_36", "singleplayer_overlays", "fr_035", "", iParam2, 195, 0);
					break;
			
				case 32:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_37", "singleplayer_overlays", "fr_036", "", iParam2, 255, 0);
					break;
			
				case 33:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_38", "singleplayer_overlays", "fr_037", "", iParam2, 300, 0);
					break;
			
				case 34:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_40", "singleplayer_overlays", "fr_039", "", iParam2, 300, 0);
					break;
			
				case 35:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_05", "singleplayer_overlays", "fr_004", "", iParam2, 255, 1);
					break;
			
				case 36:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_06", "singleplayer_overlays", "fr_005", "", iParam2, 175, 1);
					break;
			
				case 37:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_11", "singleplayer_overlays", "fr_010", "", iParam2, 520, 1);
					break;
			
				case 38:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_23", "singleplayer_overlays", "fr_022", "", iParam2, 125, 1);
					break;
			
				case 39:
					func_190(sParam0, iParam1, pedParam3, "TAT_FRA_39", "singleplayer_overlays", "fr_038", "", iParam2, 365, 1);
					break;
			
				default:
					func_182(sParam0, iParam2, iParam1, 40);
					break;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_01", "singleplayer_overlays", "tp_000", "", iParam2, 120, 0);
					break;
			
				case 1:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_02", "singleplayer_overlays", "tp_001", "", iParam2, 150, 3);
					break;
			
				case 2:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_03", "singleplayer_overlays", "tp_002", "", iParam2, 100, 0);
					break;
			
				case 3:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_04", "singleplayer_overlays", "tp_003", "", iParam2, 140, 0);
					break;
			
				case 4:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_05", "singleplayer_overlays", "tp_004", "", iParam2, 250, 0);
					break;
				...
				case 5:
					if (func_189() || func_188())
					{
						...
						func_190(sParam0, iParam1, pedParam3, "TAT_TRV_06", "singleplayer_overlays", "tp_005", "", iParam2, num, 3);
					}
					break;
			
				case 6:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_07", "singleplayer_overlays", "tp_006", "", iParam2, 120, 0);
					break;
			
				case 7:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_08", "singleplayer_overlays", "tp_007", "", iParam2, 250, 0);
					break;
			
				case 8:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_09", "singleplayer_overlays", "tp_008", "", iParam2, 50, 3);
					break;
			
				case 9:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_10", "singleplayer_overlays", "tp_009", "", iParam2, 135, 2);
					break;
			
				case 10:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_11", "singleplayer_overlays", "tp_010", "", iParam2, 245, 0);
					break;
			
				case 11:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_12", "singleplayer_overlays", "tp_011", "", iParam2, 280, 0);
					break;
			
				case 12:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_13", "singleplayer_overlays", "tp_012", "", iParam2, 65, 0);
					break;
			
				case 13:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_14", "singleplayer_overlays", "tp_013", "", iParam2, 150, 6);
					break;
			
				case 14:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_15", "singleplayer_overlays", "tp_014", "", iParam2, 200, 0);
					break;
			
				case 15:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_16", "singleplayer_overlays", "tp_015", "", iParam2, 145, 0);
					break;
			
				case 16:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_17", "singleplayer_overlays", "tp_016", "", iParam2, 290, 0);
					break;
			
				case 17:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_18", "singleplayer_overlays", "tp_017", "", iParam2, 350, 3);
					break;
			
				case 18:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_19", "singleplayer_overlays", "tp_018", "", iParam2, 70, 0);
					break;
			
				case 19:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_20", "singleplayer_overlays", "tp_019", "", iParam2, 180, 6);
					break;
			
				case 20:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_21", "singleplayer_overlays", "tp_020", "", iParam2, 230, 0);
					break;
			
				case 21:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_22", "singleplayer_overlays", "tp_021", "", iParam2, 200, 0);
					break;
			
				case 22:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_24", "singleplayer_overlays", "tp_023", "", iParam2, 240, 0);
					break;
			
				case 23:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_25", "singleplayer_overlays", "tp_024", "", iParam2, 195, 0);
					break;
			
				case 24:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_26", "singleplayer_overlays", "tp_025", "", iParam2, 225, 2);
					break;
			
				case 25:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_28", "singleplayer_overlays", "tp_027", "", iParam2, 175, 0);
					break;
			
				case 26:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_29", "singleplayer_overlays", "tp_028", "", iParam2, 65, 0);
					break;
			
				case 27:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_30", "singleplayer_overlays", "tp_029", "", iParam2, 50, 0);
					break;
			
				case 28:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_31", "singleplayer_overlays", "tp_030", "", iParam2, 70, 0);
					break;
			
				case 29:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_34", "singleplayer_overlays", "tp_033", "", iParam2, 70, 0);
					break;
			
				case 30:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_23", "singleplayer_overlays", "tp_022", "", iParam2, 500, 1);
					break;
			
				case 31:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_27", "singleplayer_overlays", "tp_026", "", iParam2, 300, 1);
					break;
			
				case 32:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_32", "singleplayer_overlays", "tp_031", "", iParam2, 190, 1);
					break;
			
				case 33:
					func_190(sParam0, iParam1, pedParam3, "TAT_TRV_33", "singleplayer_overlays", "tp_032", "", iParam2, 129, 1);
					break;
			
				default:
					func_182(sParam0, iParam2, iParam1, 34);
					break;
			}
			break;
		...
		case 4:
			...
			{
				case 0:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(20000) * Global_262145.f_2825), 0);
					break;
			
				case 1:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1400) * Global_262145.f_2826), 2);
					break;
			
				case 2:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(9750) * Global_262145.f_2827), 3);
					break;
			
				case 3:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2150) * Global_262145.f_2828), 0);
					break;
			
				case 4:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2829), 0);
					break;
			
				case 54:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12400) * Global_262145.f_2830), 1);
					break;
			
				case 5:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2831), 0);
					break;
			
				case 6:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2832), 2);
					break;
			
				case 55:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1350) * Global_262145.f_2833), 1);
					break;
			
				case 7:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1450) * Global_262145.f_2834), 0);
					break;
			
				case 8:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2700) * Global_262145.f_2835), 7);
					break;
			
				case 9:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1200) * Global_262145.f_2836), 0);
					break;
			
				case 10:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1500) * Global_262145.f_2837), 0);
					break;
			
				case 11:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2650) * Global_262145.f_2838), 0);
					break;
			
				case 56:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2839), 1);
					break;
			
				case 12:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2840), 2);
					break;
			
				case 57:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2841), 1);
					break;
			
				case 58:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2842), 1);
					break;
			
				case 59:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7400) * Global_262145.f_2843), 1);
					break;
			
				case 60:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2844), 1);
					break;
			
				case 17:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2400) * Global_262145.f_2849), 2);
					break;
			
				case 18:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2850), 2);
					break;
			
				case 19:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3600) * Global_262145.f_2851), 2);
					break;
			
				case 20:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2852), 3);
					break;
			
				case 21:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12500) * Global_262145.f_2853), 3);
					break;
			
				case 22:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2854), 3);
					break;
			
				case 23:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2855), 3);
					break;
			
				case 24:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2856), 3);
					break;
			
				case 25:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2857), 2);
					break;
			
				case 26:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3750) * Global_262145.f_2858), 3);
					break;
			
				case 27:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4800) * Global_262145.f_2859), 3);
					break;
			
				case 28:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3500) * Global_262145.f_2860), 3);
					break;
			
				case 61:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12350) * Global_262145.f_2861), 1);
					break;
			
				case 62:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1900) * Global_262145.f_2862), 1);
					break;
			
				case 63:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4500) * Global_262145.f_2863), 1);
					break;
			
				case 64:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2864), 1);
					break;
			
				case 65:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12300) * Global_262145.f_2865), 1);
					break;
			
				case 29:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2866), 0);
					break;
			
				case 30:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2867), 0);
					break;
			
				case 31:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2868), 0);
					break;
			
				case 66:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2869), 1);
					break;
			
				case 32:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2870), 2);
					break;
			
				case 33:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2871), 3);
					break;
			
				case 34:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7250) * Global_262145.f_2872), 2);
					break;
			
				case 35:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(11900) * Global_262145.f_2873), 0);
					break;
			
				case 36:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2750) * Global_262145.f_2874), 0);
					break;
			
				case 37:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1750) * Global_262145.f_2875), 0);
					break;
			
				case 38:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7300) * Global_262145.f_2876), 3);
					break;
			
				case 39:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(3250) * Global_262145.f_2877), 2);
					break;
			
				case 40:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1000) * Global_262145.f_2878), 0);
					break;
			
				case 67:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2879), 1);
					break;
			
				case 41:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2880), 2);
					break;
			
				case 68:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2881), 1);
					break;
			
				case 42:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5050) * Global_262145.f_2882), 0);
					break;
			
				case 43:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2450) * Global_262145.f_2883), 2);
					break;
			
				case 44:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(4950) * Global_262145.f_2884), 0);
					break;
			
				case 45:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5100) * Global_262145.f_2885), 0);
					break;
			
				case 46:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(12250) * Global_262145.f_2886), 0);
					break;
			
				case 47:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1150) * Global_262145.f_2887), 3);
					break;
			
				case 48:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2888), 3);
					break;
			
				case 49:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7600) * Global_262145.f_2889), 3);
					break;
			
				case 50:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2600) * Global_262145.f_2890), 2);
					break;
			
				case 51:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2891), 3);
					break;
			
				case 52:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7450) * Global_262145.f_2892), 3);
					break;
			
				case 53:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(7500) * Global_262145.f_2893), 0);
					break;
			
				case 69:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2894), 1);
					break;
			
				case 70:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(2500) * Global_262145.f_2895), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				...
				{
					case 73:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_001", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 74:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_002", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 75:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_003", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 76:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_004", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 77:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_005", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 78:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_006", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 79:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_009", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 80:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_013", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 81:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_014", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 82:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_015", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 83:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_016", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 84:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_019", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 85:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_020", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 86:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_036", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 90:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_017", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 91:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_018", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 124:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_046", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 125:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_045", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 87:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
				
					case 93:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 94:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_002", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 95:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_003", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 96:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_004", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 97:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_005", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 98:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_006", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 99:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_007", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 100:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_008", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 101:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_009", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 102:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_010", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 103:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_011", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 104:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_012", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 105:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_013", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 106:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_014", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 107:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_M_Hair_015", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 108:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 109:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 110:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 111:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 112:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 113:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_M_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 114:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGInd_M_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 115:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "not_in_use", "hairOverlay", iParam2, 100, 0);
						break;
					...
					case 123:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "mpBeach_overlays", "FM_Hair_Fuzz", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 13:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2845), 0);
						break;
				
					case 14:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_190(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2848), 0);
						break;
				
					case 71:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				
					case 72:
						func_190(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				...
				{
					case 73:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_027_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 74:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_028_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 75:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_034_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 76:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_036_f", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 77:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_048", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 78:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_052", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 79:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_053", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 80:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_054", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 81:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_055", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 82:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_056", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 83:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_058", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 84:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_067", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 85:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_068", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 92:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "mp_fm_branding_051", "torsoDecal", iParam2, 100, 0);
						break;
				
					case 87:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
				
					case 93:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 94:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_002", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 95:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_003", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 96:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_004", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 97:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_005", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 98:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_006", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 99:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_007", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 100:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_008", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 101:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_009", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 102:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_010", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 103:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_011", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 104:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_012", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 105:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_013", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 106:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_014", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 107:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NG_F_Hair_015", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 108:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 109:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBea_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 110:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 111:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGBus_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 112:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 113:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGHip_F_Hair_001", "hairOverlay", iParam2, 100, 0);
						break;
				
					case 114:
						func_190(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "NGInd_F_Hair_000", "hairOverlay", iParam2, 100, 0);
						break;
					...
					case 14:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(5000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_190(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			break;
	...
	if (iParam2 == 3 || iParam2 == 4 && iParam1 >= 129)
		func_182(sParam0, iParam2, iParam1, 129);
...
void func_182(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12999
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_183() // Position - 0x12A2B
{
...
BOOL func_184() // Position - 0x12A5D
{
	return true;
}

int func_185() // Position - 0x12A66
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x12C55
{
	int profileSetting;
...
int func_188() // Position - 0x12D0D
{
	return 1;
}

int func_189() // Position - 0x12D16
{
	return 1;
}

void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12D1F
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x12FD4
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				num2 = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (num2 >= 237)
				{
					componentHash = func_192(joaat("MP_M_Freemode_01"), num2, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				num3 = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (num3 >= 256)
				{
					componentHash2 = func_192(joaat("MP_F_Freemode_01"), num3, 11, 4);
...
Hash func_192(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13294
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = iParam1 - func_195(hParam0);
	...
	else
	{
		...
		componentId2 = iParam1 - func_193(hParam0, func_194(iParam2));
		...
		num2 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_194(iParam2));
...
int func_193(Hash hParam0, int iParam1) // Position - 0x133AE
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x13755
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x13805
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13866
{
	int i;
	int j;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (iParam1 == 12)
		{
			for (i = 0; i <= 53; i = i + 1)
			{
				if (func_205(pedParam0, iParam1, i))
					return i;
			}
		}
		else if (iParam1 == 13)
		{
			for (j = 0; j <= 19; j = j + 1)
			{
				if (func_205(pedParam0, iParam1, j))
					return j;
			}
		...
		else if (iParam1 == 14)
		{
			...
			{
				return func_199(pedParam0, epctParam2);
			}
		}
		else
		{
...
int func_197(Ped pedParam0, int iParam1) // Position - 0x13907
{
	...
	return func_198(pedParam0, pedDrawableVariation, pedTextureVariation, iParam1);
}

int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13967
{
	ePedComponentType componentId;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x139BE
{
	int pedPropIndex;
	...
	if (pedPropIndex == -1)
		return func_204(epctParam1);

	pedPropTextureIndex = PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, epctParam1);
	return func_200(pedParam0, pedPropIndex, pedPropTextureIndex, epctParam1);
}

int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x13A05
{
	Hash entityModel;
	...
	if (hashNameForProp != -1 && hashNameForProp != 0)
		if (entityModel == joaat("MP_M_Freemode_01"))
			return func_202(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 3);
		else if (entityModel == joaat("MP_F_Freemode_01"))
			return func_202(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 4);
	...
	for (i = 0; i <= numberOfPedPropDrawableVariations - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= numberOfPedPropTextureVariations - 1; j = j + 1)
			{
				...
				{
					num = num + func_201(pedParam0, epctParam3);
					return num;
				}
				else
				{
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13B01
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13C3F
{
	var outfit;
	int i;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		if (shopPedQueryPropIndex != -1)
			return func_195(hParam0) + shopPedQueryPropIndex;
	}
	else
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_194(iParam2));
		shopPedQueryComponentIndex = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(hParam1);
	
		if (shopPedQueryComponentIndex != -1)
			return func_193(hParam0, func_194(iParam2)) + shopPedQueryComponentIndex;
	}

	return -99;
}

int func_203(Hash hParam0) // Position - 0x13CFA
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x13D59
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, int iParam2) // Position - 0x13DDF
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_221(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
		unk = { func_217(entityModel, iParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num2] != -99)
			{
				if (!func_205(pedParam0, num2, unk[num2]))
				{
					Global_2883588 = hash;
					...
					if (num2 == 13)
					{
						unk18 = { func_214(entityModel, unk[num2]) };
					
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_205(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79347[2 /*14*/] = { func_221(entityModel, 14, j, -1) };
								
									if (Global_79347[2 /*14*/].f_12 == i)
									{
										if (func_205(pedParam0, 14, j))
										{
											if (!func_209(entityModel, iParam2, 14, j, &unk, &Global_79347[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					{
						num = func_197(pedParam0, num2);
						Global_79347[2 /*14*/] = { func_221(entityModel, num2, num, -1) };
					
						if (!func_209(entityModel, iParam2, num2, num, &unk, &Global_79347[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_90(1759, Global_79344) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		unk28 = { func_214(entityModel, iParam2) };
	
		for (l = 0; l <= 8; l = l + 1)
		{
			if (!func_205(pedParam0, 14, unk28[l]))
				return false;
		}
	...
	{
		if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_194(iParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_194(iParam1)))
			return true;
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79346 == 1)
				if (func_208(entityModel, 11, func_197(pedParam0, 11), -1))
					if (func_207(entityModel, 4, iParam2, &num3))
						return func_205(pedParam0, 4, num3);
				else if (func_206(entityModel, 4, iParam2, &num3))
					return func_205(pedParam0, 4, num3);
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1423B
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						componentHash = func_192(hParam0, iParam2, iParam1, 4);
							...
							for (i = 0; i < shopPedApparelVariantComponentCount; i = i + 1)
							{
								...
								if (componentType == 4)
								{
									if (nameHash != 0 && nameHash != joaat("0"))
									{
										...
										{
											*uParam3 = func_202(hParam0, nameHash, iParam1, 4);
											return true;
										}
									}
								}
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x142E4
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1438C
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, iParam2, 11, 4);
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x143DF
{
	var unk;
	int i;
	...
	if (iParam2 == 14)
	{
		unk = { func_214(hParam0, uParam4->[13]) };
	...
	if (func_213(hParam0, iParam2, iParam3))
		return true;

	if (hParam0 == joaat("Player_Zero"))
	{
		if (func_212(hParam0, iParam2, iParam3, -1))
		{
		...
		else if (func_210(hParam0, iParam2, iParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x149E3
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, iParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, iParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, iParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, iParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14C60
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15085
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2) // Position - 0x15378
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15411
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				default:
					func_215(&unk, hParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				default:
					func_215(&unk, hParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_215(&unk, hParam0, iParam1, 25);
					break;
			}
			break;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15D40
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
			...
			for (i = 0; i < itemHash.f_3; i = i + 1)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 != -1)
					if (outPropVariant != 0 && outPropVariant != -1 && outPropVariant != joaat("0"))
						uParam0->[outPropVariant.f_2] = func_202(hParam1, outPropVariant, 14, num);
...
void func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x15E6A
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x15EB2
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_220(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[0], Global_114162.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				...
				default:
					func_218(&unk, hParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_220(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[1], Global_114162.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
				...
				default:
					func_218(&unk, hParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_220(&unk, -99, -99, Global_114162.f_2367.f_539.f_196[2], Global_114162.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				default:
					func_218(&unk, hParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_218(&unk, hParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_218(&unk, hParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17CFA
{
	int num;
	Hash outfit;
		...
		for (i = 0; i < outfit.f_4; i = i + 1)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(outfit.f_1, i, &outComponentVariant))
			{
				if (outComponentVariant != 0 && outComponentVariant != -1 && outComponentVariant != joaat("0"))
				{
					...
					{
						uParam0->[func_219(outComponentVariant.f_2)] = outComponentVariant;
						uParam0->f_16 = 1;
					}
					else
					{
						uParam0->[func_219(outComponentVariant.f_2)] = func_202(hParam1, outComponentVariant, func_219(outComponentVariant.f_2), num);
					}
				}
				else if (outComponentVariant.f_1 != -1)
				{
					uParam0->[func_219(outComponentVariant.f_2)] = outComponentVariant.f_1;
				}
			}
		}
...
int func_219(int iParam0) // Position - 0x17EE4
{
	switch (iParam0)
	{
		case 0:
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17F94
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x18007
{
	func_267();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_251(iParam1, iParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_222(iParam1, iParam2, hParam3);

	return Global_79347[0 /*14*/];
}

void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x18048
{
	switch (iParam0)
	{
		case 2:
...
void func_223(int iParam0) // Position - 0x18154
{
	BOOL flag;
	int num;
	var unk;
	...
	func_224(&Global_79347[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_224(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1830F
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_90(func_227(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_90(func_226(iParam1, iParam0->f_2), Global_79344);
...
BOOL func_225(int iParam0, int iParam1, var uParam2) // Position - 0x186B1
{
	*uParam2 = 979;
...
int func_226(int iParam0, int iParam1) // Position - 0x18AB6
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1) // Position - 0x18EB1
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_228(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x192AC
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A14F
{
	int num;
	int num2;
	int num3;
	...
	if (func_230(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A18D
{
...
BOOL func_231(int iParam0) // Position - 0x1CDB1
{
	return Global_44199 == iParam0;
}

int func_232(int iParam0) // Position - 0x1CDBF
{
	switch (iParam0)
	{
		case -1:
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1CE93
{
	int num;

	num = 0;
	Global_79347[0 /*14*/].f_5 = 4;
	func_234(num, iParam0, 0, hParam1);
	return;
}

void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CEB3
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_224(&Global_79347[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_224(&Global_79347[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_224(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_224(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_194(iParam0));
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D13A
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num6, iParam0, 9, hParam1);
			return;
	}
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D23D
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num6, iParam0, 28, hParam1);
			return;
	}
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1D51C
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_234(num5, iParam0, 327, hParam1);
	...
	{
		func_224(&Global_79347[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_238(int iParam0, Hash hParam1) // Position - 0x20313
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num6, iParam0, 6, hParam1);
			return;
	}
...
void func_239(int iParam0, Hash hParam1) // Position - 0x20418
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num5, iParam0, 55, hParam1);
...
void func_240(int iParam0, Hash hParam1) // Position - 0x20BF4
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num5, iParam0, 26, hParam1);
...
void func_241(int iParam0, Hash hParam1) // Position - 0x20ED9
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_234(num5, iParam0, 256, hParam1);
...
void func_242(int iParam0, Hash hParam1) // Position - 0x22500
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x23B5F
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_234(num6, iParam0, 16, hParam1);
		return;
	}
...
void func_244(int iParam0, Hash hParam1) // Position - 0x23CBA
{
	BOOL flag;
	int num;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 4;
		func_234(num6, iParam0, 36, hParam1);
		return;
	}
...
void func_245(int iParam0, Hash hParam1) // Position - 0x23F3A
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num5, iParam0, 136, hParam1);
...
int func_247(int iParam0, int iParam1) // Position - 0x253B3
{
	...
	num = func_90(func_248(iParam0), iParam1);
	return num;
}
...
void func_249(int iParam0, Hash hParam1) // Position - 0x25746
{
	BOOL flag;
	int value;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x26EAB
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 4;
			func_234(num5, iParam0, 92, hParam1);
			return;
	}
...
void func_251(int iParam0, int iParam1, Hash hParam2) // Position - 0x27D7C
{
	switch (iParam0)
	{
		case 2:
...
void func_253(int iParam0, Hash hParam1) // Position - 0x28053
{
	int num;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x28073
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x28176
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_234(num6, iParam0, 26, hParam1);
			return;
	}
...
void func_256(int iParam0, Hash hParam1) // Position - 0x28427
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2B1E6
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_234(num6, iParam0, 7, hParam1);
			return;
	}
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2B307
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2BBFF
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2BEB6
{
	BOOL flag;
	int value;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2D4F5
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2EB28
{
	BOOL flag;
	int num;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x2EC7F
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_234(num6, iParam0, 46, hParam1);
			return;
	}
...
void func_264(int iParam0, Hash hParam1) // Position - 0x2EF9B
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 3;
		func_234(num5, iParam0, 241, hParam1);
...
void func_265(int iParam0, Hash hParam1) // Position - 0x3148D
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		Global_79347[0 /*14*/].f_5 = 3;
		func_234(num5, iParam0, 237, hParam1);
...
void func_266(int iParam0, Hash hParam1) // Position - 0x32A18
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			Global_79347[0 /*14*/].f_5 = 3;
			func_234(num5, iParam0, 91, hParam1);
			return;
	}
...
BOOL func_268(Ped pedParam0) // Position - 0x3394B
{
	int num;
...
{
	if (func_274(bParam0) || func_272() || func_271(*Global_4718592.f_194133))
		return true;
...
{
	return func_273(*Global_4718592.f_134976);
}
...
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_186929, 12) && func_275();
...
BOOL func_276(Ped pedParam0, BOOL bParam1) // Position - 0x33AF3
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 7:
						case 12:
							num = func_277(joaat("MP_M_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_116(PLAYER::PLAYER_ID(), true) && Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num3 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (num3 >= 241)
						{
							componentHash2 = func_192(joaat("MP_M_Freemode_01"), num3, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num4 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num5 = func_196(pedParam0, 11, PV_COMP_INVALID);
					
						if (num5 >= 256)
						{
							componentHash3 = func_192(joaat("MP_F_Freemode_01"), num5, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num6 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				case 1:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num7 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						num8 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (num8 >= 136)
						{
							componentHash4 = func_192(joaat("MP_F_Freemode_01"), num8, 8, 4);
...
int func_277(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3432D
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_192(hParam0, iParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_192(hParam0, iParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_192(hParam0, iParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_192(hParam0, iParam2, 8, 4);
...
int func_278(int iParam0, Hash hParam1) // Position - 0x34B4D
{
...
int func_279(Ped pedParam0) // Position - 0x34B6F
{
...
BOOL func_283(Player plParam0, BOOL bParam1) // Position - 0x34C17
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_284(Player plParam0) // Position - 0x34C4F
{
	if (func_11(plParam0))
		if (func_11(Global_1887694[plParam0 /*611*/].f_10))
...
BOOL func_286(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34CA6
{
...
Hash func_296() // Position - 0x34EE8
{
...
void func_302() // Position - 0x34F5A
{
	...
	func_305(&uLocal_120, joaat("nimbus"), "Plane_1");
	ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	uLocal_120.f_8 = 0;
	randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 100);

	if (randomIntInRange < 50)
		func_303(&uLocal_120, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	else
		func_303(&uLocal_120, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);

	return;
}

void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x34FF2
{
	func_304(uParam0, sParam7, iParam8, iParam9, iParam10);
	uParam0->f_9 = { fParam1 };
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x35022
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x3504F
{
