...
void func_5() // Position - 0x1FA
{
	...
	if (bLocal_119)
	{
		if (unk_0x2645430E708CBFAC(2, Global_21035))
			bLocal_119 = false;
...
void func_13(int iParam0) // Position - 0x44F
{
	...
	if (iParam0 != -1)
	{
		if (Global_1882240.f_7[iParam0 /*8*/].f_1 == 1)
		{
			...
			unk_0x8744D2E3FC95740E(&(Global_1887549[unk_0x259BE71D8A81D4FA() /*611*/].f_10.f_22), Global_1882240.f_7[iParam0 /*8*/].f_2);
			unk_0xFE3A52C5B7AE3101(Global_1882240.f_7[iParam0 /*8*/].f_4);
			func_17();
			func_15(0);
		}
...
{
	if (!func_16(iParam0))
		unk_0x0B0C9A0F9AAEB7F0(&(Global_1882240.f_3), iParam0);
...
void func_21(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0xB8F
{
...
{
	if (Global_1887549[unk_0x259BE71D8A81D4FA() /*611*/].f_10.f_26 == _INVALID_PLAYER_INDEX())
	{
		if (unk_0x762604C40829DB72(plParam0))
		{
			Global_1887549[unk_0x259BE71D8A81D4FA() /*611*/].f_10.f_26 = plParam0;
...
{
	unk_0x0B0C9A0F9AAEB7F0(&Global_1836156, 15);
	func_13(iParam0);
	Global_1882240.f_6 = 0;
	func_7(0);
	return;
...
BOOL func_36(var uParam0) // Position - 0xEC6
{
	...
	if (!unk_0x875A214D5EBCA509(2, Global_21035))
		return false;
...
BOOL func_40(var uParam0) // Position - 0xF8A
{
	...
	if (!unk_0x875A214D5EBCA509(2, Global_21038))
		return false;
...
BOOL func_41(var uParam0) // Position - 0xFCE
{
	...
	if (!unk_0x875A214D5EBCA509(2, Global_21036))
		return false;
...
void func_43(var uParam0) // Position - 0x1034
{
	...
	if (unk_0x875A214D5EBCA509(2, Global_21042) || unk_0x875A214D5EBCA509(2, 181))
	{
		func_46();
		uParam0->f_1 = unk_0x1DD05E817C89C737() + 50;
	}

	if (unk_0x875A214D5EBCA509(2, Global_21043) || unk_0x875A214D5EBCA509(2, 180))
	{
		func_44();
		uParam0->f_1 = unk_0x1DD05E817C89C737() + 50;
	}
...
void func_49() // Position - 0x11C1
{
	...
	if (func_36(&uLocal_120))
	{
		...
		iLocal_117 = unk_0x5DEF122A58D4F685(unk);
		num = func_31(iLocal_117, 0);
	...
	if (func_40(&uLocal_120))
	{
		...
		iLocal_117 = unk_0x5DEF122A58D4F685(unk2);
...
{
	if (func_16(iParam0))
		unk_0x8744D2E3FC95740E(&(Global_1882240.f_3), iParam0);
...
void func_51() // Position - 0x12EA
{
	...
	if (Global_1882240.f_7[num2 /*8*/] == 0)
	{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1887549[player /*611*/].f_10.f_11[i] != _INVALID_PLAYER_INDEX())
					{
						...
						{
							unk18[num3] = Global_1887549[player /*611*/].f_10.f_11[i];
							num3 = num3 + 1;
						}
					}
				}
		...
		else
		{
			...
			unk_0x511D14ED2DA887E1(Global_1882240.f_88[num2 /*5*/]);
			unk_0x511D14ED2DA887E1(func_78(player));
			unk_0x511D14ED2DA887E1(Global_1882240.f_88[num2 /*5*/].f_3);
			unk_0x511D14ED2DA887E1(Global_1882240.f_88[num2 /*5*/].f_4);
			unk_0xCFAD3D478C87321A();
		}
	}
	else if (Global_1882240.f_7[num2 /*8*/] == 1)
	{
		...
		unk_0x4E5A3D96808F7F84(func_80(Global_1882240.f_7[num2 /*8*/].f_2));
		unk_0x60D332F23943B34F(func_63(Global_1882240.f_7[num2 /*8*/].f_2));
		unk_0xCFAD3D478C87321A();
	}
...
void func_52(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, char* sParam5, var uParam6) // Position - 0x1639
{
...
void func_53(int iParam0, int iParam1, char* sParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1669
{
	if (iParam1 == 1)
	{
...
void func_54(int iParam0, BOOL bParam1) // Position - 0x170E
{
	...
	if (bParam1)
	{
		unk_0x0B0C9A0F9AAEB7F0(&Global_8919, iParam0);
		return;
	}

	unk_0x8744D2E3FC95740E(&Global_8919, iParam0);
	return;
}
...
void func_56(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6) // Position - 0x1752
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	func_22(sParam2);
...
char* func_63(Player plParam0) // Position - 0x19E3
{
	char* str;
	Player player;
...
struct<13> func_67(Player plParam0) // Position - 0x1B9D
{
	var unk;
...
BOOL func_68(Player plParam0) // Position - 0x1BB4
{
	var unk;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x1C6E
{
	return unk_0xA8F635A578C0CE07(&uParam0, 13);
}

BOOL func_70(var uParam0) // Position - 0x1C7E
{
	int i;
...
BOOL func_71(Player plParam0, int iParam1) // Position - 0x1CD2
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

char* func_72(var uParam0) // Position - 0x1CEA
{
	return uParam0;
}

char* func_73(Player plParam0, BOOL bParam1) // Position - 0x1CF4
{
	if (!bParam1)
...
var func_74() // Position - 0x1D1B
{
	return unk_0xFACCDE46E24AD056("GB_REST_ACCM" /*Motorcycle Club*/);
}

BOOL func_75(Player plParam0, BOOL bParam1) // Position - 0x1D2B
{
	return func_76(plParam0, bParam1, 1);
}

BOOL func_76(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1D3C
{
	Player player;
...
BOOL func_77(Player plParam0, int iParam1) // Position - 0x1D98
{
	if (func_30(plParam0))
...
int func_78(Player plParam0) // Position - 0x1DE7
{
...
BOOL func_79(Player plParam0) // Position - 0x1E0D
{
	if (!func_30(plParam0))
		return false;
...
int func_80(Player plParam0) // Position - 0x1E34
{
	int num;
...
int func_83(Player plParam0) // Position - 0x1F2E
{
	if (func_30(plParam0))
...
BOOL func_84(Player plParam0, BOOL bParam1) // Position - 0x1F5E
{
	if (!func_30(plParam0))
		return false;
...
BOOL func_85(Player plParam0) // Position - 0x1F96
{
	if (func_30(plParam0))
		if (func_30(Global_1887549[plParam0 /*611*/].f_10))
...
struct<16> func_86(Player plParam0) // Position - 0x1FCB
{
	var unk;
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x222B
{
	var unk;
	int num;
	int num2;
	...
	unk_0x330108B080A2132F(-1);
	num = 1;
	num2 = func_83(Global_1882240.f_7[iParam0 /*8*/].f_2);
...
void func_93(var uParam0) // Position - 0x22DA
{
	unk_0xCE3E870AC37B4253(uParam0);
	return;
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x22E8
{
	var unk;
	BOOL flag;
	int num;
	...
	num = func_78(Global_1882240.f_7[iParam0 /*8*/].f_2);
	...
	unk_0x330108B080A2132F(-1);
	num2 = 1;
	num3 = func_83(Global_1882240.f_7[iParam0 /*8*/].f_2);
...
void func_99(var uParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x25E5
{
	unk_0x88F483FBD433696A(uParam0, sParam1);
	unk_0x330108B080A2132F(SYSTEM::ROUND(fParam2));
