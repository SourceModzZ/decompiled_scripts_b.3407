...
void main() // Position - 0x0
{
	...
	if (unk_0x486FF5D06E9659F1(joaat("ambient_tonya")) > 1)
...
{
	if (!unk_0xF40767E41852FB72(iLocal_246))
	{
		if (func_200(61))
			iLocal_77 = 6;
		else
...
BOOL func_3(int iParam0) // Position - 0x1CA
{
	...
	TEXT_LABEL_COPY(&unk33, { func_119(iParam0) }, 4);
	func_118(&unk33, unk.f_3, 0);
	func_115(iParam0);
...
void func_4(int iParam0, var uParam1) // Position - 0x24C
{
	func_22(uParam1);
...
void func_5(int iParam0) // Position - 0x304
{
	...
	TEXT_LABEL_COPY(&Global_64323, { func_10(iParam0) }, 4);
	Global_64311 = 0;
	Global_64310 = 0;
...
{
	Global_64327 = 0;
	Global_64331 = func_16(joaat("SP0_SHOTS"));
	Global_64330 = func_16(joaat("SP0_HITS"));
	Global_64333 = func_16(joaat("SP1_SHOTS"));
	Global_64332 = func_16(joaat("SP1_HITS"));
	Global_64335 = func_16(joaat("SP2_SHOTS"));
	Global_64334 = func_16(joaat("SP2_HITS"));
	return;
}

var func_16(int iParam0) // Position - 0xAC8
{
	var unk;
...
void func_22(var uParam0) // Position - 0xBBD
{
...
void func_24(char* sParam0, int iParam1, int iParam2) // Position - 0xBED
{
	if (Global_101688 != 10 && Global_101688 != 9)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_104688, sParam0, 32);
		func_26(&Global_104696, sParam0, 0, "Start", iParam1, iParam2);
		func_25();
		Global_95841 = 0;
	}
...
void func_26(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x18C5
{
	int i;
	eCharacter j;
...
void func_28(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2770
{
	var unk;
...
int func_29(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x27F8
{
...
BOOL func_30(var uParam0) // Position - 0x2838
{
	int i;
...
void func_31(var uParam0, var uParam1, int iParam2) // Position - 0x2866
{
...
int func_32(var uParam0) // Position - 0x2942
{
	int i;
...
eCharacter func_33(var uParam0) // Position - 0x2984
{
	int i;
...
int func_34(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x29E7
{
	int i;
...
int func_35(eCharacter echParam0, int iParam1) // Position - 0x2A75
{
	int num;
...
void func_38(var uParam0, var uParam1) // Position - 0x2D1A
{
	int i;
...
BOOL func_43(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3336
{
	var unk;
...
BOOL func_44(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3462
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x35A2
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x35DF
{
...
int func_48(eCharacter echParam0) // Position - 0x3604
{
	return Global_2201[echParam0 /*29*/];
}

void func_49(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3613
{
	eCharacter character;
	int i;
...
var func_51(int iParam0, int iParam1) // Position - 0x37DC
{
...
var func_55(int iParam0, int iParam1) // Position - 0x3855
{
	return unk_0xD69CE161FE614531(2, iParam0, func_52(iParam1));
}

void func_56(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x386A
{
	eCharacter character;
...
void func_57(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3DB3
{
	eCharacter character;
...
void func_59() // Position - 0x4010
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (_GET_CHARACTER_MODEL(Global_114135.f_2367.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_37(character) && !func_60(14) || Global_113083)
			{
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x411B
{
	eCharacter character;
	var unk;
	int i;
	...
	if (func_37(character) && !unk_0x4FAFF4BCB7633475(uParam0))
	{
		...
		{
			func_62(uParam0, &Global_114135.f_2367.f_539.f_298[character /*477*/]);
...
void func_62(var uParam0, var uParam1) // Position - 0x420E
{
	int i;
	int j;
	int k;
...
int func_65(int iParam0, int iParam1) // Position - 0x472F
{
	int num;
	int num2;
	int i;
...
int func_66(int iParam0, var uParam1) // Position - 0x54B0
{
	int i;
	int num;
...
int func_67(int iParam0) // Position - 0x54EB
{
	int num;
...
void func_68(var uParam0) // Position - 0x575F
{
	eCharacter character;
...
void func_69(var uParam0, int iParam1) // Position - 0x579B
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_70(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5CEA
{
	var unk;
	var unk2;
...
BOOL func_71(int iParam0, var uParam1, var uParam2) // Position - 0x5D2E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_72(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64AD
{
	if (bParam6)
...
BOOL func_73(var uParam0) // Position - 0x64F4
{
...
BOOL func_74(int iParam0) // Position - 0x654F
{
	return func_75(iParam0, 0, true);
}

BOOL func_75(int iParam0, int iParam1, BOOL bParam2) // Position - 0x655F
{
	if (iParam0 == -1)
		return false;
...
int func_76(int iParam0) // Position - 0x65BF
{
	switch (iParam0)
	{
		case 0:
...
int func_77() // Position - 0x6976
{
	return Global_33087;
}

BOOL func_78(int iParam0) // Position - 0x6981
{
	return func_75(iParam0, 5, true);
}

int func_79(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6991
{
	int i;
	float num;
	float num2;
...
Vector3 func_80(int iParam0, BOOL bParam1) // Position - 0x6A33
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_97(Global_103852);
	
		case 46:
			if (Global_1845051 != _INVALID_PLAYER_INDEX())
				if (func_95(Global_1845051))
					return func_88(2, 2);
				else if (func_87(Global_1845051))
					return func_88(45, 3);
				else
...
Vector3 func_81() // Position - 0x71AD
{
...
int func_82() // Position - 0x74A8
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74B7
{
...
int func_84() // Position - 0x74E1
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_85(float fParam0, float fParam1, float fParam2) // Position - 0x74F9
{
	return unk_0xF10F2A2453AF1DFB(func_86(), 0f, fParam0);
}

Vector3 func_86() // Position - 0x750E
{
	return -880f, -2770f, -50f;
}

BOOL func_87(Player plParam0) // Position - 0x7525
{
...
Vector3 func_88(int iParam0, int iParam1) // Position - 0x757D
{
	var unk;
	var unk7;
...
BOOL func_89(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7627
{
	var unk;
	var unk7;
	var unk13;
	...
	unk19 = { unk13 - unk };
	unk19 = { func_90(unk19, -unk.f_3.f_2) };
	unk19 = { func_90(unk19, unk7.f_3.f_2) };
	*uParam2 = { unk_0xF10F2A2453AF1DFB(unk7, 0f, unk19) };
	uParam2->f_3 = { unk13.f_3 };
	return true;
}

Vector3 func_90(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76BC
{
	float num;
	float num2;
	float num3;
...
struct<6> func_91(int iParam0) // Position - 0x7700
{
	var unk;
...
struct<6> func_92(int iParam0) // Position - 0x7884
{
	return func_93(iParam0);
}

struct<6> func_93(int iParam0) // Position - 0x7892
{
	var unk;
...
BOOL func_94(int iParam0, var uParam1) // Position - 0x8359
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_95(Player plParam0) // Position - 0x83DB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8433
{
	return -1;
}

Vector3 func_97(int iParam0) // Position - 0x843C
{
	switch (iParam0)
	{
		case 1:
...
int func_98() // Position - 0x86C3
{
	return func_99(unk_0x259BE71D8A81D4FA());
}

int func_99(int iParam0) // Position - 0x86D3
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x86F0
{
	return func_75(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8700
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8A43
{
	return Global_101740.f_399 > 0;
}

var func_103() // Position - 0x8A54
{
	var unk;

	func_113(&unk, unk_0x4BA5A16068183C5E());
	func_112(&unk, unk_0x18E502A71E28968C());
	func_111(&unk, unk_0x5295501D0862870D());
	func_106(&unk, unk_0xB12880C92EA6EE15());
	func_105(&unk, unk_0x8825A6E0A30BDCB8());
	func_104(&unk, unk_0x7598FE4545010A75());
	return unk;
}

void func_104(var uParam0, int iParam1) // Position - 0x8A9A
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8B20
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8B53
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x8BA4
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x8C46
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C68
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x8C7F
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x8C8C
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8CC6
{
...
void func_113(var uParam0, int iParam1) // Position - 0x8D01
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8D3D
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_115(int iParam0) // Position - 0x8D61
{
	int num;
	var unk;
	...
	else if (unk_0x0BA1A956D36B210F() || func_116() || unk_0x761778199FE1211C())
	{
...
BOOL func_116() // Position - 0x8DC4
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_117() // Position - 0x8DDA
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_118(char* sParam0, var uParam1, int iParam2) // Position - 0x8DF0
{
...
struct<2> func_119(int iParam0) // Position - 0x8E31
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x927D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA4C1
{
	switch (iParam0)
	{
		case 0:
...
void func_123(int iParam0) // Position - 0xA807
{
	char* scriptName;
	...
	func_124(iParam0);
	iLocal_246 = SYSTEM::START_NEW_SCRIPT(scriptName, 63500);
	unk_0xFD49725F3FE7EE13(scriptName);
	return;
}

void func_124(int iParam0) // Position - 0xA859
{
	var unk;
...
void func_125(int iParam0) // Position - 0xA8F4
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xA952
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xA9AB
{
...
int func_129(int iParam0) // Position - 0xAA2E
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAA5F
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAA74
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAB27
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAB42
{
	int i;
...
int func_135(int iParam0) // Position - 0xAB8E
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xABD7
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(var uParam0) // Position - 0xABF7
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
...
BOOL func_138(int iParam0) // Position - 0xAC18
{
	switch (iParam0)
	{
		case 5:
...
void func_140(char* sParam0) // Position - 0xACE8
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

BOOL func_141(int iParam0) // Position - 0xACFA
{
	if (iParam0 == -1)
		iParam0 = func_151();
...
BOOL func_142(int iParam0) // Position - 0xAD8F
{
...
BOOL func_145(int iParam0) // Position - 0xAE0E
{
	if (func_147() && Global_101688.f_11 == 6 && iParam0 == func_146(&(Global_101688.f_3), 0))
		return true;

	return false;
}

int func_146(var uParam0, int iParam1) // Position - 0xAE42
{
	int num;
	var unk;
	var unk33;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xAEC9
{
	return func_149(iParam0, Global_44181);
}

BOOL func_149(int iParam0, int iParam1) // Position - 0xAEDA
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_150(int iParam0) // Position - 0xB0BB
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
...
int func_151() // Position - 0xB0E3
{
	return func_146(unk_0x1AF90EB93E0012D6(), 0);
}

BOOL func_152(int iParam0) // Position - 0xB0F4
{
	int num;
	...
	num = func_154(&(Global_113222[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_153(int iParam0) // Position - 0xB139
{
	Global_113222[iParam0 /*10*/].f_4 = 1;
	Global_113222[iParam0 /*10*/].f_5 = 0;
	Global_113222[iParam0 /*10*/].f_6 = 0;
	Global_113222[iParam0 /*10*/] = 0;
	return;
}

int func_154(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB16B
{
	int i;
...
void func_155(var uParam0, int iParam1) // Position - 0xB2A2
{
	int i;
...
BOOL func_156(int iParam0) // Position - 0xB2F1
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_157(int iParam0) // Position - 0xB313
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_165() || Global_113182 || Global_33090 || func_164() || func_163(8, -1) || func_102() || func_162() || func_161() || func_160() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_165() || Global_33090 || func_164() || func_163(8, -1) || func_161() || func_102() || func_162() || func_160() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_165() || Global_113182 || Global_33090 || func_164() || func_163(8, -1) || func_161() || func_102() || func_162() || func_160() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_165() || Global_113182 || Global_33090 || func_164() || func_163(8, -1) || func_102() || func_162() || func_160() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_165() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_163(8, -1) || func_160() || func_159() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_158() // Position - 0xBA30
{
	return Global_101727.f_1;
}

BOOL func_159() // Position - 0xBA3E
{
	if (Global_98585 != -1)
...
BOOL func_162() // Position - 0xBAA5
{
	return Global_101740.f_400 > 0;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0xBAB6
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_164() // Position - 0xBAEE
{
	return Global_1575084;
}

BOOL func_165() // Position - 0xBAFA
{
	if (!unk_0x76CD105BCAC6EB9F())
...
BOOL func_167(int iParam0) // Position - 0xBB2E
{
	...
	switch (iLocal_78)
	{
		case 0:
			if (!func_186())
			{
				if (func_167(103))
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_79, 1, unk_0x4A8C381C258A124D(), "FRANKLIN", 0, 1);
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xBC7E
{
...
BOOL func_170(int iParam0) // Position - 0xBCA0
{
	if (Global_120[iParam0 /*10*/].f_8 != 184)
...
int func_171(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0xBCDE
{
...
int func_172(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xBD3D
{
	Global_22426 = 0;
...
BOOL func_175(int iParam0) // Position - 0xC0A8
{
	return func_176(iParam0, 20);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xC0B8
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

void func_177() // Position - 0xC0D0
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC256
{
	if (func_60(14))
	{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC3A6
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC3FC
{
...
BOOL func_189(int iParam0) // Position - 0xC568
{
...
BOOL func_190(int iParam0) // Position - 0xC595
{
	int i;
...
void func_192(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xC613
{
	int num;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xC80C
{
	return Global_2201[character /*29*/].f_3;
}

int func_195(eCharacter echParam0, int iParam1) // Position - 0xC81F
{
...
int func_196(eCharacter echParam0, int iParam1) // Position - 0xC849
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_197(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC873
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_198(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC8B8
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xC8FD
{
	func_59();
	return Global_114135.f_2367.f_539.f_4321;
}

BOOL func_200(int iParam0) // Position - 0xC916
{
...
BOOL func_201(int iParam0, int iParam1) // Position - 0xC941
{
	BOOL flag;
...
int func_202(int iParam0) // Position - 0xC98B
{
	int num;
	int num2;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC9E2
{
