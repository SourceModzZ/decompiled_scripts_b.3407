		...
		if (!_IS_MISSION_REPEAT_ACTIVE(false) && !func_105(14))
		{
			if (iLocal_45 == 0)
			{
				if (func_115())
				{
					...
					bLocal_459 = IS_BIT_SET(Global_8920, 28);
						...
						if (num < fLocal_44)
						{
							...
							if (num4 >= 0.35f && func_99(unk, 0f, 1f) && func_99(unk4, 0f, 1f) && func_99(unk7, 0f, 1f) && func_99(unk10, 0f, 1f) || num4 < 0.35f && func_99(unk, 0.05f, 0.95f) && func_99(unk4, 0.05f, 0.95f) && func_99(unk7, 0.05f, 0.95f) && func_99(unk10, 0.05f, 0.95f))
							{
								if (num2 >= 0.08f && num3 >= 0.101f)
								{
									...
									while (num5 < 10 && !flag)
									{
										flag = unk_0x8018AA59F97FA9E3(iLocal_47) && unk_0x8018AA59F97FA9E3(iLocal_48) && unk_0x8018AA59F97FA9E3(iLocal_49) && unk_0x8018AA59F97FA9E3(iLocal_50) && unk_0x8018AA59F97FA9E3(iLocal_51);
										num5 = num5 + 1;
										SYSTEM::WAIT(0);
									}
...
{
	Global_114135.f_10053.f_135[1] = -1;
	return;
}

void func_2(int iParam0, BOOL bParam1) // Position - 0x3AD
{
	int num;
	...
	{
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_24999), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_114135.f_24999), num);
	}
	else
	{
		num = num - 31;
		...
		if (bParam1)
			unk_0x0B0C9A0F9AAEB7F0(&(Global_114135.f_24999.f_1), num);
		else
			unk_0x8744D2E3FC95740E(&(Global_114135.f_24999.f_1), num);
	}

	return;
}

BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x412
{
	var unk;
...
{
	if (bParam0 == 1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_8920, 28);
	else
		unk_0x8744D2E3FC95740E(&Global_8920, 28);

	return;
}

int func_5() // Position - 0x4ED
{
...
int func_8(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6E1
{
	Global_79322[1 /*14*/] = { func_10(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79322[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 2, Global_79322[1 /*14*/].f_1, 0, 1);
		else
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 2, Global_79322[1 /*14*/].f_1, 1, 0);
...
BOOL func_9(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x777
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_10(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x161A
{
	func_79();
...
void func_11(int iParam0, int iParam1) // Position - 0x166C
{
	switch (iParam0)
	{
		case 0:
...
void func_12(int iParam0) // Position - 0x175C
{
	BOOL flag;
	int num;
	var unk;
	...
	func_13(&Global_79322[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_13(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x2949
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_16(func_20(iParam1, iParam0->f_2), Global_79319);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				unk_0x0B0C9A0F9AAEB7F0(&(iParam0->f_6), 1);
		
			num = func_16(func_15(iParam1, iParam0->f_2), Global_79319);
...
BOOL func_14(int iParam0, int iParam1, var uParam2) // Position - 0x2CE9
{
	*uParam2 = 979;
...
int func_15(int iParam0, int iParam1) // Position - 0x30EE
{
	switch (iParam1)
	{
		case 0:
...
int func_16(int iParam0, int iParam1) // Position - 0x34E9
{
	var unk;
	int num;
...
var func_17(int iParam0, int iParam1) // Position - 0x3518
{
	return unk_0xD69CE161FE614531(0, iParam0, func_18(iParam1));
}

int func_18(int iParam0) // Position - 0x352D
{
	int num;
	int num2;
...
int func_19() // Position - 0x3561
{
	return Global_1574926;
}

int func_20(int iParam0, int iParam1) // Position - 0x356D
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_21(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x3968
{
	int num;
	int num2;
	int num3;
	...
	if (func_22(uParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_22(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x39A6
{
	int value;
...
int func_23(int iParam0) // Position - 0x6642
{
	switch (iParam0)
	{
		case -1:
...
void func_24(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6716
{
	int num;
	int unk;
	var unk2;
	...
	if (iParam0 == 12)
	{
		...
		if (num2 >= 0)
		{
			...
			if (num3 > num2)
			{
				...
				Global_2883589 = unk2;
				func_13(&Global_79322[0 /*14*/], iParam0, iParam1, &(unk2.f_7), 0, 0, unk2.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_13(&Global_79322[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (num5 >= 0)
		{
			...
			if (num6 > num5)
			{
				...
				func_13(&Global_79322[0 /*14*/], iParam0, iParam1, &(unk17.f_9), unk17.f_3, unk17.f_4, unk17.f_5, unk_0x304A39EB177D246B(unk17.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, unk17.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79520)
		{
			...
			func_13(&Global_79322[0 /*14*/], iParam0, iParam1, &(unk34.f_9), unk34.f_3, unk34.f_4, unk34.f_5, unk_0x304A39EB177D246B(unk34.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, unk34.f_1 != 0);
			return;
		}
		...
		if (num7 >= 0)
		{
			num8 = unk_0x7B6C0A0D604E68FA(unk, 10, -1, 0, -1, func_25(iParam0));
...
int func_25(int iParam0) // Position - 0x699B
{
	switch (iParam0)
	{
		case 0:
...
void func_26(int iParam0) // Position - 0x6A4B
{
	BOOL flag;
	int num;
	var unk;
...
void func_27(int iParam0) // Position - 0x6B8E
{
	BOOL flag;
	int num;
	var unk;
...
void func_28(int iParam0) // Position - 0x709A
{
	BOOL flag;
	int num;
	var unk;
...
void func_29(int iParam0) // Position - 0x710D
{
	BOOL flag;
	int num;
	var unk;
...
void func_31(int iParam0) // Position - 0x7266
{
	BOOL flag;
	int num;
	var unk;
...
void func_32(int iParam0) // Position - 0x7587
{
	BOOL flag;
	int num;
	var unk;
...
void func_33(int iParam0) // Position - 0x7786
{
	BOOL flag;
	int num;
	var unk;
...
void func_34(int iParam0) // Position - 0x7996
{
	BOOL flag;
	int num;
	var unk;
...
void func_35(int iParam0) // Position - 0x7A98
{
	BOOL flag;
	int num;
	var unk;
...
void func_36(int iParam0) // Position - 0x841F
{
	BOOL flag;
	int num;
	var unk;
...
void func_37(int iParam0) // Position - 0x8F5C
{
	if (iParam0 < 136)
		func_39(iParam0);
	else
...
void func_38(int iParam0) // Position - 0x8F91
{
	BOOL flag;
	int num;
	var unk;
...
void func_39(int iParam0) // Position - 0x9B95
{
	BOOL flag;
	int num;
	var unk;
...
void func_40(int iParam0) // Position - 0xAA87
{
	BOOL flag;
	int num;
	var unk;
...
void func_41(int iParam0) // Position - 0xABB4
{
	BOOL flag;
	int num;
	var unk;
...
void func_42(int iParam0, int iParam1) // Position - 0xACA4
{
	switch (iParam0)
	{
		case 0:
...
void func_43(int iParam0) // Position - 0xAD94
{
	BOOL flag;
	int num;
	var unk;
...
void func_44(int iParam0) // Position - 0xC23F
{
	BOOL flag;
	int num;
	var unk;
...
void func_45(int iParam0) // Position - 0xC37C
{
	BOOL flag;
	int num;
	var unk;
...
void func_46(int iParam0) // Position - 0xC885
{
	BOOL flag;
	int num;
	var unk;
...
void func_47(int iParam0) // Position - 0xCEE9
{
	BOOL flag;
	int num;
	var unk;
...
void func_48(int iParam0) // Position - 0xCF5B
{
	BOOL flag;
	int num;
	var unk;
...
void func_49(int iParam0) // Position - 0xD02B
{
	BOOL flag;
	int num;
	var unk;
...
void func_50(int iParam0) // Position - 0xD4F1
{
	BOOL flag;
	int num;
	var unk;
...
void func_51(int iParam0) // Position - 0xD67C
{
	BOOL flag;
	int num;
	var unk;
...
void func_52(int iParam0) // Position - 0xDE5C
{
	BOOL flag;
	int num;
	var unk;
...
void func_53(int iParam0) // Position - 0xDF5E
{
	BOOL flag;
	int num;
	var unk;
...
void func_54(int iParam0) // Position - 0xEE79
{
	BOOL flag;
	int num;
	var unk;
...
void func_55(int iParam0) // Position - 0xFB16
{
	if (iParam0 < 107)
		func_58(iParam0);
	else if (iParam0 < 227)
...
void func_56(int iParam0) // Position - 0xFB5C
{
	BOOL flag;
	int num;
	var unk;
...
void func_57(int iParam0) // Position - 0x10602
{
	BOOL flag;
	int num;
	var unk;
...
void func_58(int iParam0) // Position - 0x113EF
{
	BOOL flag;
	int num;
	var unk;
...
void func_59(int iParam0) // Position - 0x12024
{
	BOOL flag;
	int num;
	var unk;
...
void func_60(int iParam0) // Position - 0x1229B
{
	BOOL flag;
	int num;
	var unk;
...
void func_61(int iParam0, int iParam1) // Position - 0x123CD
{
	switch (iParam0)
	{
		case 0:
...
void func_62(int iParam0) // Position - 0x124BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_63(int iParam0) // Position - 0x131EF
{
	BOOL flag;
	int num;
	var unk;
...
void func_64(int iParam0) // Position - 0x13353
{
	BOOL flag;
	int num;
	var unk;
...
void func_65(int iParam0) // Position - 0x138BE
{
	BOOL flag;
	int num;
	var unk;
...
void func_66(int iParam0) // Position - 0x13DE4
{
	BOOL flag;
	int num;
	var unk;
...
void func_67(int iParam0) // Position - 0x13E56
{
	BOOL flag;
	int num;
	var unk;
...
void func_68(int iParam0) // Position - 0x13F26
{
	BOOL flag;
	int num;
	var unk;
...
void func_69(int iParam0) // Position - 0x14460
{
	BOOL flag;
	int num;
	var unk;
...
void func_70(int iParam0) // Position - 0x146AD
{
	BOOL flag;
	int num;
	var unk;
...
void func_71(int iParam0) // Position - 0x14957
{
	BOOL flag;
	int num;
	var unk;
...
void func_72(int iParam0) // Position - 0x14B04
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0x1563C
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0x16256
{
	if (iParam0 < 60)
		func_76(iParam0);
	else
...
void func_75(int iParam0) // Position - 0x1628B
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0x17011
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0x17689
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x1776E
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x178D5
{
	if (iParam2 == -99)
		return;
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			if (!bParam3 || IS_BIT_SET(Global_114135.f_7233[1], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_2367.f_539.f_3816[0 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	
		case joaat("Player_Two"):
			if (!bParam3 || IS_BIT_SET(Global_114135.f_7233[3], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_2367.f_539.f_3816[1 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
		
			if (!bParam3 || IS_BIT_SET(Global_114135.f_7233[4], 0))
				unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_2367.f_539.f_3816[2 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	}
...
int func_81(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x179B5
{
	int num;
	int i;
	int j;
	...
	if (IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79322[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 1, Global_79322[1 /*14*/].f_1, 1, 0);
		...
		{
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 1, Global_79322[1 /*14*/].f_1, 0, 1);
		}
...
struct<10> func_82(int iParam0, int iParam1) // Position - 0x17D97
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x186C7
{
	int num;
	var unk;
	int num2;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x187F1
{
	var unk;
	int i;
	int num;
	...
	else
	{
		...
		if (num3 != -1)
			return func_85(iParam0, func_25(iParam2)) + num3;
	}

	return -99;
}

int func_85(int iParam0, int iParam1) // Position - 0x188AC
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(int iParam0) // Position - 0x18C53
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_87(int iParam0) // Position - 0x18CB4
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_88(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x18D13
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_89(int iParam0, int iParam1) // Position - 0x18D5B
{
	int i;
	var unk;
...
void func_90(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1ABA3
{
	int num;
	var unk;
	int num2;
		...
		for (i = 0; i < unk.f_4; i = i + 1)
		{
			if (unk_0xABE43EB6EBE5F2F5(unk.f_1, i, &num2))
			{
				if (num2 != 0 && num2 != -1 && num2 != joaat("0"))
				{
					...
					{
						uParam0->[func_91(num2.f_2)] = func_84(iParam1, num2, func_91(num2.f_2), num);
					}
				}
				else if (num2.f_1 != -1)
				{
...
int func_91(int iParam0) // Position - 0x1AD8D
{
	switch (iParam0)
	{
		case 0:
...
void func_92(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1AE3D
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
int func_93(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1AEAE
{
	Global_79322[1 /*14*/] = { func_10(iParam0, iParam1, iParam2, -1) };
	...
	{
		if (bParam3)
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 0, Global_79322[1 /*14*/].f_1, 1, 0);
		else
			func_9(iParam1, Global_79322[1 /*14*/].f_5, Global_79322[1 /*14*/].f_2, 0, Global_79322[1 /*14*/].f_1, 0, 1);
...
BOOL func_95(int iParam0) // Position - 0x1AF73
{
	int num;
	int num2;

	func_96(iParam0, &num, &num2);
	return IS_BIT_SET(Global_114135.f_10053.f_135[num], num2);
}

void func_96(int iParam0, var uParam1, var uParam2) // Position - 0x1AF95
{
	*uParam1 = iParam0 / 32;
	*uParam2 = iParam0 % 32;
	return;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1AFAD
{
	int num;
	var unk;

	func_96(iParam0, &num, &unk);

	if (bParam1)
		unk_0x0B0C9A0F9AAEB7F0(&Global_114135.f_10053.f_135[num], unk);
	else
		unk_0x8744D2E3FC95740E(&Global_114135.f_10053.f_135[num], unk);

	return;
}

void func_98(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1AFED
{
	*uParam0 = unk_0x5008F9D1AD061D8C();
	...
	{
		unk_0x9C0020A372AF7F16(*uParam0, uParam1, fParam4);
	}

	return;
}

BOOL func_99(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x1B013
{
	float num;
	float num2;

	if (unk_0x2F8A75C70AF54208(uParam0, &num, &num2))
		if (num >= fParam3 && num <= fParam4)
			if (num2 >= fParam3 && num2 <= fParam4)
				return true;

	return false;
}

void func_100(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x1B053
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;

	unk_0x2F8A75C70AF54208(uParam0, &vector, &(vector.f_1));
	unk_0x2F8A75C70AF54208(uParam3, &vector2, &(vector2.f_1));
	unk_0x2F8A75C70AF54208(uParam6, &vector3, &(vector3.f_1));
	*uParam9 = SYSTEM::VDIST(vector, vector2);
	*uParam10 = SYSTEM::VDIST(vector, vector3);
	return;
}

void func_101(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1B0A6
{
	var unk;
	var unk4;
	var unk7;
	...
	if (iParam0 == 29 && unk.f_2 <= 35f)
	{
		unk4 = { -95.402f, -744.506f, 37.2165f };
		unk7 = { 0.9047f, 0.4261f, 0f };
		num = 0.51f;
		num2 = 0.35f;
	}
	else if (iParam0 == 29 && unk.f_2 <= 36f)
	{
		unk4 = { -95.4013f, -744.5073f, 37.1846f };
		unk7 = { 0.9047f, 0.4261f, 0f };
		num = 0.51f;
		num2 = 0.43f;
	}
	...
	{
		unk4 = { uLocal_52[iParam0 /*8*/] };
		unk7 = { uLocal_52[iParam0 /*8*/].f_3 };
	...
	num4 = num / 2f;
	num5 = num2 / 2f;
	unk10 = { func_102(func_103(unk7, 0f, 0f, -1f)) };
	unk13 = { func_102(func_103(unk7, unk10)) };
	*uParam1 = { unk4 + ({ num4, num4, num4 } * unk10) + ({ num5, num5, num5 } * unk13) + (unk7 * { num3, num3, num3 }) };
	*uParam2 = { unk4 + ({ num4, num4, num4 } * -unk10) + ({ num5, num5, num5 } * unk13) + (unk7 * { num3, num3, num3 }) };
	*uParam3 = { unk4 + ({ num4, num4, num4 } * unk10) + ({ num5, num5, num5 } * -unk13) + (unk7 * { num3, num3, num3 }) };
	*uParam4 = { unk4 + ({ num4, num4, num4 } * -unk10) + ({ num5, num5, num5 } * -unk13) + (unk7 * { num3, num3, num3 }) };
	return;
}

Vector3 func_102(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1B247
{
	float num;
...
Vector3 func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1B261
{
...
int func_104(var uParam0) // Position - 0x1B29A
{
	int i;
	int num;
	Vector3 vector;
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (!func_95(i))
		{
			num2 = SYSTEM::VDIST2(vector, uLocal_52[i /*8*/]);
...
BOOL func_105(int iParam0) // Position - 0x1B2FF
{
	return Global_44181 == iParam0;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1B30D
{
...
BOOL func_107() // Position - 0x1B335
{
	int num;
	int num2;
	int i;

	if (Global_114135.f_10053.f_135[1] == -1)
		return true;
	...
	if (num > 0)
	{
		...
		{
			if (Global_114135.f_10053.f_135[i] != -1)
				return false;
		}
	}

	if (num2 == 31)
		return Global_114135.f_10053.f_135[num] == -1;

	return Global_114135.f_10053.f_135[num] == SYSTEM::ROUND(SYSTEM::POW(2f, SYSTEM::TO_FLOAT(num2 + 1))) - 1;
}

void func_108() // Position - 0x1B3C8
{
	if (bLocal_458)
	{
		if (unk_0xA0C7B98BCF1EEF9E(uLocal_457))
			unk_0x6D16B99FEB0AFFF1(uLocal_457, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
	
		switch (iLocal_456)
		{
			case 0:
				iLocal_460 = unk_0x1DD05E817C89C737() + 2000;
				iLocal_456 = iLocal_456 + 1;
				break;
		
			case 1:
				if (iLocal_460 < unk_0x1DD05E817C89C737())
				{
					if (!func_114())
					{
						uLocal_457 = unk_0x8DE4F68A9728925E("MIDSIZED_MESSAGE");
						iLocal_460 = unk_0x1DD05E817C89C737() + 5000;
						iLocal_456 = iLocal_456 + 1;
					}
				}
				break;
			...
			case 2:
				if (unk_0xA0C7B98BCF1EEF9E(uLocal_457) || iLocal_460 < unk_0x1DD05E817C89C737())
				{
					if (iLocal_460 < unk_0x1DD05E817C89C737())
					{
						bLocal_458 = false;
			...
			case 3:
				unk_0x88F483FBD433696A(uLocal_457, "SHOW_BRIDGES_KNIVES_PROGRESS");
				...
				iLocal_460 = unk_0x1DD05E817C89C737() + 7500;
				unk_0xBF3D28CA44F3BE2D(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", 1);
				iLocal_456 = iLocal_456 + 1;
				break;
		
			case 4:
				if (iLocal_460 < unk_0x1DD05E817C89C737() || unk_0x15CCE8886267624F() || !unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()) || func_114() || !unk_0xE916D57851F785AB(unk_0x259BE71D8A81D4FA()) || func_112() || func_111())
				{
					unk_0x88F483FBD433696A(uLocal_457, "SHARD_ANIM_OUT");
					unk_0x330108B080A2132F(1);
					unk_0x74BF156C860580D4(0.33f);
					unk_0xE6B753D52F4CA222();
					iLocal_460 = unk_0x1DD05E817C89C737() + 500;
					iLocal_456 = iLocal_456 + 1;
				}
				break;
			...
			case 6:
				unk_0xD314260005F064BF(&uLocal_457);
			
				if (func_107())
				{
					iLocal_460 = unk_0x1DD05E817C89C737() + 1000;
					iLocal_456 = iLocal_456 + 1;
				}
				else
				{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1B649
{
...
BOOL func_110(int iParam0) // Position - 0x1B660
{
...
BOOL func_111() // Position - 0x1B68C
{
...
BOOL func_112() // Position - 0x1B6B9
{
...
void func_113(char* sParam0) // Position - 0x1B6F7
{
...
BOOL func_114() // Position - 0x1B709
{
	if (Global_79800)
		return true;
...
BOOL func_115() // Position - 0x1B733
{
	if (Global_23461)
		return true;
...
void func_116() // Position - 0x1B749
{
...
void func_117(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8) // Position - 0x1BF99
{
...
void func_118(var uParam0) // Position - 0x1BFCF
{
	if (*uParam0 != -1)
	{
		unk_0x4FD2A45FD634CE58(*uParam0);
		*uParam0 = -1;
	}
