	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113249[num /*10*/].f_9 != -1)
			{
				...
				func_322(&(Global_113249[num /*10*/].f_9));
			}
		}
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A8F
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x293A
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x29C2
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x490A
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x568B
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x56C6
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x593A
{
	eCharacter character;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EC5
{
...
int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B6C
{
	int i;
...
int func_97() // Position - 0x88D8
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x88E8
{
	return MISC::GET_BITS_IN_RANGE(Global_2657994[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8905
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8915
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C58
{
	return Global_101765.f_399 > 0;
}

var func_102() // Position - 0x8C69
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8CAF
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D35
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D68
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8DB9
{
	if (iParam1 < 0)
		iParam1 = 0;
...
var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E7D
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E94
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EA1
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8EDB
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F16
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F52
{
	func_58();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F6B
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8FCE
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8FE4
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8FFA
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x903C
{
...
struct<2> func_119(int iParam0) // Position - 0x9064
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x94B1
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA789
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAACF
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAB74
{
	var name;
...
void func_125(int iParam0) // Position - 0xAC0F
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAC6D
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xACC6
{
...
int func_129(Ped pedParam0) // Position - 0xAD49
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD7A
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD8F
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE42
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE5D
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAEA9
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAEF2
{
...
BOOL func_137(int iParam0) // Position - 0xAF12
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAFE2
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB035
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB12B
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB196
{
	Player playerIndex;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB1D5
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB324
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

BOOL func_145(Player plParam0, int iParam1) // Position - 0xB33E
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB397
{
	int num;
	int num2;
...
BOOL func_147(Player plParam0) // Position - 0xB3D8
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB3FA
{
...
BOOL func_149() // Position - 0xB439
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB447
{
	int num;
...
void func_152(int iParam0) // Position - 0xB4A1
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB4C4
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB568
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5F7
{
...
void func_160(Vehicle veParam0) // Position - 0xB64E
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB67A
{
...
void func_163(int iParam0) // Position - 0xB81C
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB84F
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB8D9
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB94D
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_167(int iParam0) // Position - 0xB95B
{
	if (iParam0 == 1)
...
BOOL func_170(int iParam0) // Position - 0xBA02
{
	int num;
...
void func_171(int iParam0) // Position - 0xBA47
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA79
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBBB0
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBFF
{
	return func_175(iParam0, Global_44199);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBC10
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBDF1
{
	if (Global_44199 == 15)
		return false;
...
int func_177() // Position - 0xBE13
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBE24
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE6D
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE91
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC300
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC32C
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC343
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC3D2
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_185() // Position - 0xCBB5
{
	func_27(&(Global_104723.f_2890), &Global_104723, 0, 1, 1, 0);
	return;
}

BOOL func_186(var uParam0) // Position - 0xCBD0
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCC5E
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCCC2
{
...
BOOL func_189(Vehicle veParam0) // Position - 0xCD59
{
...
BOOL func_190(int iParam0) // Position - 0xCD83
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_198() || Global_113209 || Global_33108 || func_197() || func_196(8, -1) || func_101() || func_195() || func_194() || func_193() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_198() || Global_33108 || func_197() || func_196(8, -1) || func_194() || func_101() || func_195() || func_193() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_198() || Global_113209 || Global_33108 || func_197() || func_196(8, -1) || func_194() || func_101() || func_195() || func_193() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_198() || Global_113209 || Global_33108 || func_197() || func_196(8, -1) || func_101() || func_195() || func_193() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_198() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_196(8, -1) || func_193() || func_192() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_198() || Global_33108 || func_197() || func_196(8, -1) || func_195() || func_194() || func_193() || Global_114162.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_198() || func_195() || Global_113209 || Global_33108 || func_197() || Global_45410 || func_196(8, -1) || func_194() || func_192() || func_193() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_198() || Global_113209 || Global_33108 || func_197() || func_196(8, -1) || func_194() || func_192() || func_101() || func_195() || func_193())
							return false;
						break;
				}
			}
...
BOOL func_191() // Position - 0xD4A0
{
	return Global_101752.f_1;
}

BOOL func_192() // Position - 0xD4AE
{
	if (Global_98610 != -1)
...
BOOL func_195() // Position - 0xD515
{
	return Global_101765.f_400 > 0;
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xD526
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_197() // Position - 0xD55E
{
	return Global_1575086;
}

BOOL func_198() // Position - 0xD56A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_199(int iParam0) // Position - 0xD586
{
	switch (iParam0)
	{
		case 5:
...
void func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD5A9
{
	switch (*uParam0)
	{
		case 0:
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD646
{
...
BOOL func_202(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD694
{
	Global_22443 = 0;
...
BOOL func_205(Player plParam0) // Position - 0xD9FC
{
	return func_206(plParam0, 20);
}

BOOL func_206(Player plParam0, int iParam1) // Position - 0xDA0C
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_207() // Position - 0xDA24
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDB84
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_212(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC7E
{
...
float func_213(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDCD4
{
...
void func_214(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDD0E
{
	int taskSequenceId;
	int num;
...
BOOL func_215(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDDAB
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDE33
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDE6E
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_218(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDE8F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_219(int iParam0, BOOL bParam1) // Position - 0xDF80
{
	if (iParam0 == -1)
		return;
...
int func_220(int iParam0) // Position - 0xDFBC
{
	if (Global_79560 == iParam0)
		if (Global_79561 == -1)
...
void func_221(var uParam0, int iParam1) // Position - 0xDFF5
{
	BOOL flag;
	int i;
...
BOOL func_222() // Position - 0xE093
{
	return Global_98997;
}

void func_223(var uParam0) // Position - 0xE09F
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_224(uParam0);
...
void func_224(var uParam0) // Position - 0xE0B6
{
	BOOL flag;
	int num;
	int i;
...
void func_225(int iParam0) // Position - 0xE19E
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE1C6
{
	var unk;
	...
	if (func_263(*panParam0) || func_261(*panParam0) || Global_79810 == 1)
		return true;
...
void func_227(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE436
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_228(int iParam0) // Position - 0xE78E
{
...
BOOL func_229(var uParam0) // Position - 0xE7AE
{
...
BOOL func_230(var uParam0) // Position - 0xE7C6
{
...
void func_231(var uParam0) // Position - 0xE7EB
{
	int i;
	int taskSequenceId;
...
void func_232(Object* pobParam0) // Position - 0xEAEF
{
...
void func_233(var uParam0) // Position - 0xEB1A
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB9A
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_235(Ped pedParam0, Vehicle veParam1) // Position - 0xED58
{
...
BOOL func_236(var uParam0, BOOL bParam1, int iParam2) // Position - 0xED88
{
	int i;
	int num;
...
BOOL func_237(int iParam0) // Position - 0xF044
{
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF078
{
	float xSize;
...
BOOL func_239(Ped pedParam0, int iParam1) // Position - 0xF0EE
{
	return func_240(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_240(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF106
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_241(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF1C7
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_242(Ped pedParam0, int iParam1) // Position - 0xF2F3
{
...
BOOL func_244(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF402
{
	var unk;
...
float func_245(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF493
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_246(float fParam0, var uParam1, var uParam2) // Position - 0xF4B4
{
	float num;
	float num2;
...
void func_247(var uParam0) // Position - 0xF4F3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_248(Ped pedParam0, Ped pedParam1) // Position - 0xF50E
{
	int i;
...
BOOL func_249(Ped pedParam0) // Position - 0xF54D
{
...
BOOL func_250(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF575
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_251(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF670
{
	float entityCoords;
	float num;
...
BOOL func_252(Ped pedParam0, float fParam1) // Position - 0xF77C
{
	var outProjectile;
	var outCoords;
...
BOOL func_253(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF811
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_254(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF89F
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_255(int iParam0) // Position - 0xF8E7
{
...
void func_256(Vehicle veParam0) // Position - 0xF931
{
	int taskSequenceId;
...
BOOL func_257(int iParam0) // Position - 0xF9CE
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_258(int iParam0) // Position - 0xFA63
{
...
BOOL func_261(int iParam0) // Position - 0xFAE2
{
	if (func_262() && Global_101713.f_11 == 6 && iParam0 == func_178(&(Global_101713.f_3), 0))
		return true;

	return false;
}

BOOL func_262() // Position - 0xFB16
{
...
BOOL func_263(int iParam0) // Position - 0xFB54
{
...
BOOL func_265(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFBBF
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void func_266(var uParam0) // Position - 0xFBDD
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
...
void func_267(var uParam0) // Position - 0xFC4D
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFCE7
{
...
void func_271(var uParam0, char* sParam1) // Position - 0xFE93
{
...
void func_272(var uParam0) // Position - 0xFEBC
{
	int i;
...
BOOL func_273(var uParam0) // Position - 0xFEE9
{
	uParam0->f_16 = 3;
...
BOOL func_274(var uParam0) // Position - 0xFF14
{
	int num;
	var unk4;
	var unk7;
...
void func_275(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1019C
{
	func_232(pobParam0);
...
void func_276(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x101C3
{
	func_277(pveParam0);
...
void func_277(Vehicle* pveParam0) // Position - 0x10206
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_278(var uParam0) // Position - 0x102A2
{
	int i;
...
BOOL func_279(var uParam0) // Position - 0x102D3
{
	int num;
	var unk5;
	Vector3 vector;
...
void func_280(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0x10623
{
	func_281(ppedParam0);
...
void func_281(Ped* ppedParam0) // Position - 0x10644
{
...
BOOL func_282(var uParam0) // Position - 0x10685
{
	int num;
	var unk3;
	float num2;
...
BOOL func_283(Ped* ppedParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x1087D
{
...
BOOL func_284(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x108D9
{
	Hash model;
...
int func_285(var uParam0, eCharacter echParam1) // Position - 0x10967
{
	int num;
...
BOOL func_286(var uParam0) // Position - 0x109AD
{
	if (func_230(uParam0))
	{
...
void func_287(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x109D7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_288(var uParam0) // Position - 0x10A13
{
	int num;
	Vector3 vector;
	float heading;
...
void func_289(Object* pobParam0, Hash hParam1) // Position - 0x10DB2
{
	var unk;
	float num;
...
float func_290(float fParam0) // Position - 0x10DE2
{
	return fParam0 * 57.29578f;
}

BOOL func_291(var uParam0) // Position - 0x10DF2
{
	int num;
	Vector3 vector;
	float heading;
...
BOOL func_292(int iParam0) // Position - 0x11251
{
	var unk;
	eCharacter character;
...
BOOL func_293(int iParam0) // Position - 0x112A2
{
	const char* string2;
...
BOOL func_294(int iParam0) // Position - 0x1135B
{
	var unk;
...
BOOL func_295(int iParam0) // Position - 0x1141C
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_296(int iParam0, char* sParam1) // Position - 0x114A1
{
...
BOOL func_297(int iParam0) // Position - 0x11583
{
...
BOOL func_298(int iParam0) // Position - 0x115AE
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_299(int iParam0) // Position - 0x115D9
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_300(int iParam0) // Position - 0x11604
{
	if (func_258(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_301() // Position - 0x11639
{
...
BOOL func_302(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x11653
{
	int num;
	int i;
...
BOOL func_303(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x116E4
{
	int num;
	char* str;
...
BOOL func_304(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1175C
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_305(var uParam0, BOOL bParam1) // Position - 0x117D7
{
	char* str;
...
void func_306(char* sParam0) // Position - 0x1186C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_309(sParam0))
			func_307();
...
void func_307() // Position - 0x1188B
{
	Global_21308 = 0;
	func_308();
	return;
...
void func_308() // Position - 0x1189B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23453 = 0;
...
BOOL func_309(char* sParam0) // Position - 0x118BC
{
	var string1;
...
struct<6> func_310() // Position - 0x118DC
{
	var unk;
...
int func_311(var uParam0) // Position - 0x11900
{
	if (func_230(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_312(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11936
{
...
void func_313(var uParam0, BOOL bParam1) // Position - 0x11956
{
	func_314(&(uParam0->f_41), bParam1);
	return;
}

void func_314(var uParam0, BOOL bParam1) // Position - 0x11968
{
	int i;
...
void func_315(Object* pobParam0, BOOL bParam1) // Position - 0x119A6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x119E1
{
	func_317(&(uParam0->f_35), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x119F3
{
	int i;
...
void func_318(Vehicle* pveParam0) // Position - 0x11A30
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_319(var uParam0, int iParam1) // Position - 0x11A68
{
	func_320(&(uParam0->f_28), iParam1);
	return;
}

void func_320(var uParam0, int iParam1) // Position - 0x11A7A
{
	int i;
...
void func_321(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11ABB
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_322(int iParam0) // Position - 0x11B0B
{
	if (*iParam0 == -1)
		return;
...
void func_323(char* sParam0) // Position - 0x11B48
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_324(var uParam0) // Position - 0x11B5A
{
	*uParam0 = -1;
...
void func_325() // Position - 0x11B8D
{
...
Hash func_326(eCharacter echParam0) // Position - 0x11BA7
{
	if (!func_36(echParam0))
