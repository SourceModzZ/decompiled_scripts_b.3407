...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		{
			...
			unk_0x693ACD1AA0BDB375(num - 2000f, num.f_1 - 2000f, num + 2000f, num.f_1 + 2000f);
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x917
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, int iParam1, int iParam2) // Position - 0x99B
{
	if (iParam2 == -1)
		iParam2 = func_12();
...
BOOL func_14(int iParam0) // Position - 0xD39
{
	switch (iParam0)
	{
		case 29:
...
void func_17(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xDCB
{
	int i;
...
BOOL func_22(eCharacter echParam0) // Position - 0x1206
{
...
int func_25(eCharacter echParam0) // Position - 0x1274
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_26(int iParam0) // Position - 0x1283
{
	int num;
	int i;
...
int func_30(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x13AC
{
...
BOOL func_33() // Position - 0x159C
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
			num = 0;
	}
...
int func_34() // Position - 0x15CC
{
	...
	if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		for (i = 0; i < 3; i = i + 1)
		{
			if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
			{
				if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), unk_0xD1A6A821F5AC81DB(uLocal_83[i], 0)) < 400f)
				{
					if (!bLocal_60)
					{
						if (iLocal_81 == 2)
						...
						if (unk_0x9B3D4335E0EDB0BE(uLocal_83[i], unk_0x4A8C381C258A124D(), 1) || unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uLocal_83[i]) || unk_0xE5D813FA6F741B01(unk_0x259BE71D8A81D4FA(), uLocal_83[i]))
						{
							bLocal_60 = true;
							bLocal_63 = true;
							bLocal_62 = true;
					...
					if (!bLocal_60 || iLocal_81 < 3)
					{
						...
						{
							if (!unk_0xCE6BB45648900227(uLocal_83[i]))
							{
								func_54(&uLocal_97, 1);
					...
					{
						if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !unk_0xCE6BB45648900227(uLocal_83[i]))
						{
							unk_0xD414C47AFF81382A(5, uLocal_95, joaat("PLAYER"));
							unk_0xBE8796DB2B90A437(uLocal_83[i], 2, 1);
							func_54(&uLocal_97, 1);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 1, uLocal_83[i], "BorderPatrol", 0, 1);
					...
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						...
						if (SYSTEM::TIMERA() > 5000 && !unk_0xCE6BB45648900227(uLocal_83[i]))
						{
							func_54(&uLocal_97, 1);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 1, uLocal_83[i], "BorderPatrol", 0, 1);
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x194F
{
	func_20();
	return Global_114135.f_2367.f_539.f_4321;
}

int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1968
{
...
BOOL func_41(int iParam0, int iParam1) // Position - 0x1D2E
{
	return IS_BIT_SET(Global_1887549[iParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1D46
{
	return -1;
}
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1ED5
{
	if (func_21(14))
	{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x205D
{
...
BOOL _GET_RANDOM_BOOL() // Position - 0x20B3
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x20D1
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2189
{
...
BOOL func_56() // Position - 0x21AB
{
	...
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
			if (SYSTEM::VDIST2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), unk_0xD1A6A821F5AC81DB(uLocal_83[i], 0)) < 62500f)
				return true;
			else
...
void func_57() // Position - 0x2205
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
		{
			...
			{
				if (unk_0x7F420695E3F776FB(uLocal_83[i], 0))
				{
					if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !uLocal_65[i])
					{
						if (!unk_0x1C2F771CDC87A3A5(uLocal_87[i], 0))
							unk_0xB3DA477F44309390(uLocal_83[i], uLocal_87[i], unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), i + 10, 30f, 786469, 10f, 5f, 1);
						...
						if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
						{
							if (unk_0x7F420695E3F776FB(uLocal_83[i], 0))
							{
								unk_0xD83588CA24829967(uLocal_83[i], unk_0x4A8C381C258A124D(), 0, 0f, 0f, 0f, 1000f, 60, 1, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
								unk_0x44FB298D6382876D(uLocal_83[i], 1);
							}
						}
					...
					else if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !uLocal_69[i])
					{
						if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]) && !unk_0x1C2F771CDC87A3A5(uLocal_87[i], 0))
						{
							unk_0x13DE13EA38996410(uLocal_83[i], uLocal_87[i], unk_0x4A8C381C258A124D(), i + 10, 30f, 786469, 10f, 5f, 1);
				...
				else if (!unk_0x7F420695E3F776FB(uLocal_83[i], 0))
				{
					unk_0x62A5310368A20EFA(uLocal_83[i], unk_0x4A8C381C258A124D(), 0, 16);
					unk_0x44FB298D6382876D(uLocal_83[i], 1);
				}
			}
			else if (unk_0x7F420695E3F776FB(uLocal_83[i], 0))
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !uLocal_73[i])
				{
					if (unk_0x9B5C1660CCDF7189(uLocal_83[i], joaat("SCRIPT_TASK_VEHICLE_CHASE")) != 1 && unk_0x9B5C1660CCDF7189(uLocal_83[i], joaat("SCRIPT_TASK_VEHICLE_CHASE")) != 0)
					{
						unk_0x974022927CB47E68(uLocal_83[i]);
					
						if (!unk_0x1C2F771CDC87A3A5(uLocal_87[i], 0))
						{
							unk_0xB3DA477F44309390(uLocal_83[i], uLocal_87[i], unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), i + 10, 30f, 786469, 10f, 5f, 1);
							unk_0xE67051907958B5EB(uLocal_83[i], unk_0x4A8C381C258A124D(), -1, 2096, 4);
						}
				...
				else if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && !uLocal_77[i])
				{
					if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !unk_0x1C2F771CDC87A3A5(uLocal_87[i], 0))
					{
						unk_0x974022927CB47E68(uLocal_83[i]);
						unk_0x13DE13EA38996410(uLocal_83[i], uLocal_87[i], unk_0x4A8C381C258A124D(), i + 10, 30f, 786469, 10f, 5f, 1);
						unk_0xE67051907958B5EB(uLocal_83[i], unk_0x4A8C381C258A124D(), -1, 2096, 4);
			...
			{
				unk_0x329B82704ED2A3E3(uLocal_83[i], unk_0x4A8C381C258A124D(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
		
			if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
			{
				if (unk_0x69799E0840A34AFB(uLocal_83[i]))
				{
					if (unk_0x7F420695E3F776FB(uLocal_83[i], 0))
						unk_0x092B9247AF00F5CF(uLocal_83[i], 0, 0);
				
					if (!unk_0x1B32E388988DD296(uLocal_83[i], 0))
						unk_0x62A5310368A20EFA(uLocal_83[i], unk_0x4A8C381C258A124D(), 0, 16);
				}
			}
		
			if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0) && unk_0x7F420695E3F776FB(uLocal_83[i], 0))
				if (unk_0xDF93B3CFAC96698F(unk_0x4A8C381C258A124D()) > 13f)
					if (unk_0x685171EED42BC4DF(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), unk_0x6EF03BE64E058E2F(uLocal_83[i], 0)))
						unk_0x68F395D64BC35E68(uLocal_83[i], 3);
					else
						unk_0x68F395D64BC35E68(uLocal_83[i], 1);
				else
					unk_0x68F395D64BC35E68(uLocal_83[i], 1);
		
			if (func_133())
				unk_0xD844F5E50DAB6FF7(uLocal_83[i], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
		}
		else if (unk_0xFC8BFE4B41177C22(uLocal_83[i]))
		{
			bLocal_63 = true;
			bLocal_62 = true;
		}
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]))
			if (bLocal_61 || bLocal_60)
				if (!unk_0xC450B06E5AAA0985(uLocal_91[i]))
					uLocal_91[i] = func_59(uLocal_83[i], true, 145);
		else if (unk_0xC450B06E5AAA0985(uLocal_91[i]))
			unk_0xFE54B8568B2ABD12(&uLocal_91[i]);
	}

	return;
}

int func_59(var uParam0, BOOL bParam1, int iParam2) // Position - 0x274F
{
	int num;
...
int func_60(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2799
{
	int num;
...
var func_61(BOOL bParam0, var uParam1, var uParam2) // Position - 0x283D
{
	if (bParam0)
		return uParam1;
...
int func_62(BOOL bParam0) // Position - 0x2854
{
	if (func_66())
	{
		Global_114125 = true;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x2981
{
...
BOOL func_66() // Position - 0x29D8
{
	switch (func_67(&Global_33147, 0, 5, false, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return true;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2B94
{
	return func_70(iParam0, Global_44181);
}

BOOL func_70(int iParam0, int iParam1) // Position - 0x2BA5
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_71(int iParam0) // Position - 0x2D86
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_72() // Position - 0x2DA8
{
	...
	num3 = joaat("sanchez");
	num4 = joaat("blazer");
	num5 = joaat("A_M_M_Hillbilly_02");
	unk_0xEC9DAA34BBB4658C(num5);
	unk_0xEC9DAA34BBB4658C(num3);
	unk_0xEC9DAA34BBB4658C(num4);

	if (unk_0x6252BC0DD8A320DB(num5) && unk_0x6252BC0DD8A320DB(num3) && unk_0x6252BC0DD8A320DB(num4))
	{
		if (unk_0xD9F5E1FEFD1329E4(uLocal_87[0], 0) && unk_0xD9F5E1FEFD1329E4(uLocal_87[1], 0) && unk_0xD9F5E1FEFD1329E4(uLocal_87[2], 0))
		{
			return true;
		}
		else
		{
			...
			{
				unk_0x7F8B389881024657(unk_0x0D1381B6E0F3987D(unk_0x4A8C381C258A124D(), 0f, -25f, 0f), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 1, &num, &unk3, 1, 1077936128, 0);
			
				if (!unk_0x7B780C491DEC834E(num, 5f))
				{
					unk_0x06CD913C241C765E("re_border badGuys", &uLocal_95);
					unk_0xD414C47AFF81382A(3, uLocal_95, joaat("PLAYER"));
				
					for (i = 0; i < 3; i = i + 1)
					{
						num = num + SYSTEM::TO_FLOAT(i);
						num.f_1 = num.f_1 + SYSTEM::TO_FLOAT(i);
						num2 = unk_0xC5935DFB3F39785A(0, 5);
					
						if (num2 > 1)
							uLocal_87[i] = unk_0x5779387E956077A6(num3, num, unk3, 1, 1, 0);
						else
							uLocal_87[i] = unk_0x5779387E956077A6(num4, num, unk3, 1, 1, 0);
					
						uLocal_83[i] = unk_0x8728A378EF2B46B2(uLocal_87[i], 22, num5, -1, 1, 1);
						unk_0xE67051907958B5EB(uLocal_83[i], unk_0x4A8C381C258A124D(), -1, 2096, 4);
						unk_0x44FB298D6382876D(uLocal_83[i], 1);
						unk_0xAAA71DD7E9059338(uLocal_83[i], 1);
						unk_0x3CEA1FD137ACE2D9(uLocal_83[i], uLocal_95);
						unk_0xB41DEC3AAC1AA107(uLocal_83[i], joaat("WEAPON_SAWNOFFSHOTGUN"), -1, 1, 1);
						unk_0x93C337B66C95C99B(uLocal_87[i], unk_0xDF93B3CFAC96698F(unk_0x4A8C381C258A124D()));
						unk_0xD0764B65C2DFEDCA(uLocal_83[i], 2);
						unk_0xBE8796DB2B90A437(uLocal_83[i], 50, 1);
						unk_0xBE8796DB2B90A437(uLocal_83[i], 2, 1);
						unk_0xBE8796DB2B90A437(uLocal_83[i], 1, 1);
						unk_0xBE8796DB2B90A437(uLocal_83[i], 52, 1);
						unk_0xC652B7E19CE29859(uLocal_83[i], 5);
						unk_0x675B6F5098262382(uLocal_83[i], joaat("FIRING_PATTERN_SINGLE_SHOT"));
						unk_0x39256A89E9D7464A(uLocal_83[i], unk_0xC5935DFB3F39785A(50, 100));
						unk_0x68F395D64BC35E68(uLocal_83[i], 1);
						unk_0x0428AFDCAA63B06E(uLocal_83[i], 42, 1);
						unk_0xECF7FE1783A38672(uLocal_83[i], 0);
						unk_0x886FA295C1257AAA(uLocal_83[i], 233);
						unk_0x397CF4F4C8B17365(uLocal_83[i], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
						unk_0xFD61BB3B8F1CDB6D(uLocal_83[i], 1);
					}
				
					unk_0x20DD46D27530FAC7(uLocal_87[0], 0);
					unk_0x20DD46D27530FAC7(uLocal_87[1], 1);
					unk_0x20DD46D27530FAC7(uLocal_87[2], 2);
				}
			}
			...
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_97, 0, unk_0x4A8C381C258A124D(), sLocal_96, 0, 1);
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x4C64
{
...
BOOL func_91(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4D00
{
	BOOL flag;
	Vector3 vector;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (func_22(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_115(num))
					if (func_93(i))
						if (!func_92(vector2, 0f, 0f, 0f, false))
...
BOOL func_92(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x509A
{
	if (bParam6)
...
BOOL func_93(eCharacter echParam0) // Position - 0x50E1
{
	int num;
...
BOOL func_94(int iParam0) // Position - 0x5102
{
...
var func_105(BOOL bParam0, var uParam1, var uParam2) // Position - 0x54D4
{
	if (bParam0)
		return uParam1;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x54F8
{
	int num;
	int num2;
...
int func_108() // Position - 0x5604
{
	...
	func_111(&unk, unk_0xB12880C92EA6EE15());
	func_110(&unk, unk_0x8825A6E0A30BDCB8());
	func_109(&unk, unk_0x7598FE4545010A75());
	return unk;
}
...
BOOL func_115(int iParam0) // Position - 0x5805
{
	int num;
	int num2;
	int num3;
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x58E1
{
...
BOOL func_117(int iParam0) // Position - 0x5901
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_125() || Global_113182 || Global_33090 || func_124() || func_49(8, -1) || func_123() || func_122() || func_121() || func_120() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_125() || Global_33090 || func_124() || func_49(8, -1) || func_121() || func_123() || func_122() || func_120() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_125() || Global_113182 || Global_33090 || func_124() || func_49(8, -1) || func_121() || func_123() || func_122() || func_120() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_125() || Global_113182 || Global_33090 || func_124() || func_49(8, -1) || func_123() || func_122() || func_120() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_125() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_49(8, -1) || func_120() || func_119() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_118() // Position - 0x601E
{
	return Global_101727.f_1;
}

BOOL func_119() // Position - 0x602C
{
	if (Global_98585 != -1)
...
BOOL func_124() // Position - 0x60B5
{
	return Global_1575084;
}

BOOL func_125() // Position - 0x60C1
{
...
BOOL func_128(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x6117
{
	BOOL num;
	eCharacter character;
...
int func_129(eCharacter echParam0) // Position - 0x61FB
{
...
BOOL func_130(int iParam0) // Position - 0x621F
{
	int num;
	BOOL flag;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x62BB
{
	var unk;
...
BOOL func_133() // Position - 0x6373
{
	if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (unk_0xD9F5E1FEFD1329E4(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 0))
				if (unk_0x0595DAC15F5513F9(unk_0x4A8C381C258A124D(), joaat("rhino")) || unk_0x0595DAC15F5513F9(unk_0x4A8C381C258A124D(), joaat("ambulance")) || unk_0x0595DAC15F5513F9(unk_0x4A8C381C258A124D(), joaat("firetruk")) || unk_0x84F50401806477CE(unk_0x4A8C381C258A124D()) || unk_0x1F7A48429F9F64CE(unk_0x4A8C381C258A124D()) || Global_113182 == true)
					return true;
...
void func_134() // Position - 0x6407
{
	...
	if (bLocal_59)
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			if (!unk_0x4FAFF4BCB7633475(uLocal_83[i]) && !unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				unk_0xD844F5E50DAB6FF7(uLocal_83[i], unk_0x4A8C381C258A124D(), 1000f, -1, 0, 0);
				unk_0x44FB298D6382876D(uLocal_83[i], 1);
			}
...
void func_135(int iParam0) // Position - 0x6484
{
	...
	if (func_85())
	{
		...
		func_138(30000);
		TEXT_LABEL_ASSIGN_STRING(&unk, func_137(Global_114124, true), 64);
...
Vector3 func_146() // Position - 0x6C57
{
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		num = unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_49, 1);
		iLocal_58 = 1;
	
		if (unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_52, 1) < num)
		{
			num = unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_52, 1);
			iLocal_58 = 2;
		}
	
		if (unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_55, 1) < num)
		{
			num = unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), uLocal_55, 1);
			iLocal_58 = 3;
		}
