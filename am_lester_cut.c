...
void main() // Position - 0x0
{
	...
	fLocal_63 = 0f;
	bLocal_442 = true;
	sLocal_444 = "MP_INTRO_MCS_13";
	func_342(uScriptParam_0);
	...
	while (true)
	{
		...
		func_325(&Global_1929232);
	
		switch (func_324(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_323() == 2)
					uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				else if (func_323() == 6)
					uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				break;
			...
			case 2:
				if (func_323() == 2)
				{
					...
					else if (HUD::DOES_BLIP_EXIST(Global_1929232))
					{
						func_12();
						HUD::SET_BLIP_ROUTE(Global_1929232, false);
						HUD::REMOVE_BLIP(&Global_1929232);
					
						if (IS_BIT_SET(iLocal_443, 3))
							CUTSCENE::REMOVE_CUTSCENE();
					
						MISC::SET_BIT(&(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
				
					if (func_8(PLAYER::PLAYER_ID()))
					{
						uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 3;
						Global_2739945.f_1849 = 0;
					}
				}
				else if (func_323() == 6)
				{
			...
			case 5:
				func_6(&(iLocal_94.f_3));
			
				if (func_5(&(iLocal_94.f_3)))
					uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				break;
...
void func_3() // Position - 0x22D
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (plLocal_173 == 0)
		{
			MISC::CLEAR_BIT(&iLocal_443, 0);
			MISC::SET_BIT(&iLocal_443, 1);
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(player))
		{
			...
			if (!IS_BIT_SET(uLocal_174[plLocal_173 /*3*/].f_2, 0))
				MISC::CLEAR_BIT(&iLocal_443, 1);
		
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
			{
				if (IS_BIT_SET(uLocal_174[plLocal_173 /*3*/].f_2, 1))
				{
					MISC::SET_BIT(&iLocal_443, 12);
				
					if (iLocal_94.f_2 == -1)
						if (iLocal_94.f_2 != plLocal_173)
							iLocal_94.f_2 = plLocal_173;
				}
				else if (iLocal_94.f_2 == plLocal_173)
				{
					iLocal_94.f_2 = -1;
				}
			}
		...
		plLocal_173 = plLocal_173 + 1;
	
		if (plLocal_173 == 32)
		{
			if (IS_BIT_SET(iLocal_443, 1))
				MISC::SET_BIT(&(iLocal_94.f_1), 0);
		
			if (!IS_BIT_SET(iLocal_443, 12))
				if (iLocal_94.f_2 != -1)
					iLocal_94.f_2 = -1;
		
			MISC::SET_BIT(&iLocal_443, 0);
			plLocal_173 = 0;
		}
	}
...
void func_19() // Position - 0x833
{
	...
	switch (uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_443, 2))
				if (!IS_BIT_SET(iLocal_443, 5))
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
						if (!func_320())
							if (!func_318())
								if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
									if (!func_317(0))
										if (!func_314(PLAYER::PLAYER_ID(), true, false))
											if (!func_313())
												func_312() == 0;
		
			if (!IS_BIT_SET(iLocal_443, 5))
			{
				if (func_314(PLAYER::PLAYER_ID(), true, false) || func_313() || func_312() > 0 || func_311() || func_306() || func_305() || func_277(false) || func_276(PLAYER::PLAYER_ID(), 21) || func_276(PLAYER::PLAYER_ID(), 25))
				{
					MISC::SET_BIT(&iLocal_443, 5);
					func_12();
				
					if (HUD::DOES_BLIP_EXIST(Global_1929232))
					{
						HUD::SET_BLIP_ROUTE(Global_1929232, false);
						HUD::REMOVE_BLIP(&Global_1929232);
					}
				...
				else
				{
					if (HUD::DOES_BLIP_EXIST(Global_1929232))
					{
						if (!IS_BIT_SET(iLocal_443, 14))
						{
							if (iLocal_94.f_2 != -1)
							{
								if (iLocal_94.f_2 != NETWORK::PARTICIPANT_ID_TO_INT())
								{
									HUD::SET_BLIP_COLOUR(Global_1929232, 39);
									HUD::SET_BLIP_SCALE(Global_1929232, 0.7f);
									MISC::SET_BIT(&iLocal_443, 14);
								}
							}
						}
						else if (iLocal_94.f_2 == -1 || iLocal_94.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
						{
							HUD::SET_BLIP_COLOUR(Global_1929232, 0);
							HUD::SET_BLIP_SCALE(Global_1929232, 1f);
							MISC::CLEAR_BIT(&iLocal_443, 14);
						}
					}
				
					if (IS_BIT_SET(iLocal_443, 8))
						MISC::CLEAR_BIT(&iLocal_443, 8);
				
					if (func_275())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							if (bLocal_441 && CUTSCENE::HAS_CUTSCENE_LOADED() || !bLocal_441)
							{
								if (!IS_BIT_SET(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
									MISC::SET_BIT(&(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								...
								if (IS_BIT_SET(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (iLocal_94.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										MISC::SET_BIT(&iLocal_443, 25);
										MISC::CLEAR_AREA(1274.854f, -1721.1538f, 53.6808f, 2f, true, false, false, true);
									
										if (bLocal_442)
										{
											func_271();
											iLocal_451 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
										}
									
										uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 1;
									}
									else if (iLocal_94.f_2 != -1)
									{
										if (!IS_BIT_SET(iLocal_443, 13))
										{
											if (func_265(true, true, true, true))
											{
					...
					{
						if (!IS_BIT_SET(iLocal_443, 9))
						{
							if (func_265(false, true, true, true))
							{
								if (!func_311())
								{
									...
									if (!HUD::DOES_BLIP_EXIST(Global_1929232))
									{
										Global_1929232 = HUD::ADD_BLIP_FOR_COORD(Global_1929233);
										HUD::SET_BLIP_SPRITE(Global_1929232, BLIP_LESTER_FAMILY);
										HUD::SET_BLIP_FLASHES(Global_1929232, true);
										HUD::SET_BLIP_FLASH_TIMER(Global_1929232, 7000);
									}
								
									MISC::SET_BIT(&iLocal_443, 2);
									MISC::SET_BIT(&iLocal_443, 9);
								}
							}
						}
					
						if (IS_BIT_SET(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
							MISC::CLEAR_BIT(&(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
					
						if (IS_BIT_SET(iLocal_443, 13))
							MISC::CLEAR_BIT(&iLocal_443, 13);
					}
				}
			}
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_314(PLAYER::PLAYER_ID(), true, false) && !func_313() && func_312() == 0 && !func_311() && !func_306() && !func_277(false) && !func_276(PLAYER::PLAYER_ID(), 21) && !func_276(PLAYER::PLAYER_ID(), 25))
						{
							if (!_STOPWATCH_IS_INITIALIZED(&uLocal_446))
							{
								_STOPWATCH_INITIALIZE(&uLocal_446, false, false);
							}
							else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_446, 10, false))
							{
								MISC::CLEAR_BIT(&iLocal_443, 5);
								MISC::CLEAR_BIT(&iLocal_443, 2);
								MISC::CLEAR_BIT(&iLocal_443, 3);
								MISC::CLEAR_BIT(&iLocal_443, 8);
								_STOPWATCH_DESTROY(&uLocal_446);
		...
		case 1:
			if (bLocal_441)
				if (func_259())
					uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			else if (func_219())
				uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			break;
		...
		case 2:
			if (func_164())
				uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 3;
			break;
	
		case 3:
			if (!IS_BIT_SET(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				MISC::SET_BIT(&(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			break;
	}
	...
	if (func_163())
	{
		...
		func_12();
		address = func_162(1304, -1);
		MISC::SET_BIT(&address, 2);
		MISC::SET_BIT(&(uLocal_174[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
		func_160(1304, address, -1, true);
		func_274(12, false);
...
void func_20(BOOL bParam0) // Position - 0xD84
{
	...
	num = func_147(PLAYER::PLAYER_ID(), bParam0);
	num2 = func_144(num, bParam0);
	...
	if (!func_123(true))
	{
		func_116(func_117(59, false, false), false);
		func_43(func_117(135, false, false), true);
		func_41(func_117(22, false, false), func_117(73, false, false));
	}
	else
	{
		func_41(false, false);
...
void func_21(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF5F
{
	if (bParam1)
	{
...
void func_22(int iParam0) // Position - 0x101E
{
...
void func_23(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1038
{
	int address;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			address = func_162(func_24(iParam0), -1);
			MISC::CLEAR_BIT(&address, iParam1);
			func_160(func_24(iParam0), address, -1, true);
		}
	}
	else
	{
...
int func_24(int iParam0) // Position - 0x10A8
{
	switch (iParam0)
	{
		case 0:
...
int func_25() // Position - 0x145F
{
	return Global_33105;
}

void func_26(int iParam0, int iParam1, BOOL bParam2) // Position - 0x146A
{
	int address;
...
void func_27(int iParam0) // Position - 0x14DA
{
...
BOOL func_28(int iParam0) // Position - 0x1501
{
	return func_30(iParam0, 5, true);
}

int func_29(int iParam0) // Position - 0x1511
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_30(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1854
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_25() == 0)
			return IS_BIT_SET(func_162(func_24(iParam0), -1), iParam1);
	else
...
void func_31(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x18B4
{
	Hash statName;
...
Hash func_32(int iParam0, int iParam1) // Position - 0x18D7
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_33(iParam1));
}

int func_33(int iParam0) // Position - 0x18EC
{
	int num;
	int num2;
...
int func_34() // Position - 0x1920
{
	return Global_1574926;
}

BOOL func_35() // Position - 0x192C
{
	return Global_1575074;
}

BOOL func_36() // Position - 0x1938
{
	return Global_1575076;
}

void func_37(BOOL bParam0) // Position - 0x1944
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
void func_38(BOOL bParam0) // Position - 0x1996
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x19D6
{
	Hash statHash;
	BOOL outValue;
...
void func_41(BOOL bParam0, BOOL bParam1) // Position - 0x1A1B
{
	BOOL flag;
...
void func_42(int iParam0, BOOL bParam1) // Position - 0x1B43
{
	if (bParam1)
...
void func_43(BOOL bParam0, BOOL bParam1) // Position - 0x1B69
{
	BOOL flag;
	...
	if (Global_262145.f_61 == 1 && func_117(135, false, false))
		bParam0 = true;
...
int func_44(int iParam0) // Position - 0x1BEF
{
	int num;

	if (Global_1939321[iParam0 /*8*/] == -1)
	{
		num = func_162(func_114(iParam0), -1);
...
void func_45(int iParam0, int iParam1) // Position - 0x1C32
{
	Global_1939321[iParam0 /*8*/] = iParam1;
	func_46(func_114(iParam0), iParam1, -1);
	return;
}

void func_46(int iParam0, int iParam1, int iParam2) // Position - 0x1C51
{
	BOOL flag;
	int num;
	...
	{
		func_160(iParam0, iParam1, iParam2, true);
		return;
	}
	...
	if (!func_112(num, iParam1 == func_162(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_111(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_109(iParam0, &num))
			flag = false;
	}
...
void func_47(var uParam0) // Position - 0x1CE5
{
	uParam0->f_6 = func_92(*uParam0, uParam0->f_2);
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		if (func_72(*uParam0, uParam0->f_1, false, false))
		{
			func_58(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2739945.f_7118.f_1 && func_111(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_48(var uParam0) // Position - 0x1DC9
{
	var unk;
	BOOL flag;
	...
	unk = 10;
	flag = false;
	func_53(*uParam0, uParam0->f_2, &unk, &flag);

	if (uParam0->f_6 <= uParam0->f_2.f_1)
		return false;

	if (!flag)
		if (func_52(&unk, uParam0->f_2.f_1, uParam0->f_6, &(uParam0->f_2.f_3)))
			if (func_49(*uParam0, uParam0->f_2, uParam0->f_2.f_3))
				return false;
		else
			return false;
...
BOOL func_49(var uParam0, var uParam1, var uParam2) // Position - 0x1E39
{
	int num;

	num = func_51(uParam0, uParam1, uParam2);
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1E61
{
	if (iParam1 == -1)
		iParam1 = func_34();
...
int func_51(int iParam0, int iParam1, int iParam2) // Position - 0x1E7D
{
	switch (iParam0)
	{
		case 17:
...
BOOL func_52(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1F96
{
	int num;
	int i;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x1FE8
{
	int i;
	int j;
...
void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x31DD
{
	int i;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x33F9
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
void func_58(int iParam0, int iParam1) // Position - 0x349B
{
	int num;
	BOOL address;
	int offset;
...
void func_59(int iParam0, int iParam1) // Position - 0x34EC
{
	int num;
	int offset;
...
int func_60(int iParam0) // Position - 0x35A7
{
	return func_61(iParam0) / 8;
}

int func_61(int iParam0) // Position - 0x35B8
{
	switch (iParam0)
	{
		case 2:
...
void func_62(int iParam0, int iParam1) // Position - 0x372B
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_63(int iParam0) // Position - 0x377E
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "PROGRESS_HUB_PACK_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_64(iParam0), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_64(int iParam0) // Position - 0x379D
{
	switch (iParam0)
	{
		case 0:
...
Hash func_65(int iParam0) // Position - 0x3957
{
	switch (iParam0)
	{
		case 0:
...
Hash func_66() // Position - 0x39C3
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_67() // Position - 0x39D3
{
	if (Global_1668413 == 0)
		func_68();
...
int func_69(int iParam0, int iParam1) // Position - 0x3A1A
{
	if (iParam1 == 4)
		iParam1 = 3;

	return (func_70(iParam0) * 4) + iParam1;
}

int func_70(int iParam0) // Position - 0x3A36
{
	return func_61(iParam0) % 8;
}

int func_71(int iParam0) // Position - 0x3A47
{
	int num;
...
BOOL func_72(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3A9D
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_78(iParam0, iParam1, 0);
	num3 = (num2 + func_75(iParam0, iParam1)) - 1;
	i = 0;
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x3B3A
{
	BOOL flag;
	BOOL flag2;

	flag = func_74(iParam0, iParam1);
	flag2 = func_92(iParam0, iParam1);
	return flag2 >= flag;
}

int func_74(int iParam0, int iParam1) // Position - 0x3B5B
{
	int i;
...
BOOL func_76(int iParam0) // Position - 0x4CB6
{
	int num;
...
int func_77(int iParam0) // Position - 0x4CDE
{
	switch (iParam0)
	{
		case 25:
...
int func_78(int iParam0, int iParam1, int iParam2) // Position - 0x4DDE
{
	int num;
	int i;
	int num2;
...
int func_79(int iParam0) // Position - 0x4E4A
{
	if (func_76(iParam0))
		return 13;
...
void func_80(int iParam0) // Position - 0x4E65
{
	int num;
	int num2;
	int offset;
...
int func_81(int iParam0) // Position - 0x4EA3
{
	return iParam0 % 32;
}

int func_82(int iParam0) // Position - 0x4EB0
{
	return iParam0 / 32;
}

int func_83(int iParam0) // Position - 0x4EBD
{
	switch (iParam0)
	{
		case 16:
...
void func_84(var uParam0) // Position - 0x5EA0
{
	int num;
	int num2;
	int num3;
...
int func_85(int iParam0) // Position - 0x5EDC
{
	switch (iParam0)
	{
		case 2:
...
void func_86(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6A05
{
	var entityCoords;
	int num;
	Hash hash;
...
Hash func_87(int iParam0, var uParam1, int iParam2) // Position - 0x6A6E
{
	var unk;
	...
	TEXT_LABEL_APPEND_STRING(&unk, func_90(uParam1), 64);
	TEXT_LABEL_APPEND_STRING(&unk, "_OBJ_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_88((iParam2 - func_78(iParam0, uParam1, 0)) + 1), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_88(int iParam0) // Position - 0x6D5C
{
	var unk;
...
char* func_89(var uParam0) // Position - 0x6D77
{
	return uParam0;
}

char* func_90(int iParam0) // Position - 0x6D81
{
	switch (iParam0)
	{
		case 0:
...
Hash func_91(BOOL bParam0) // Position - 0x6DD5
{
	if (bParam0)
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x6DF8
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 79:
					...
					{
						flag = flag + func_107(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_107(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 11:
			switch (iParam1)
			{
				...
				case 103:
					flag = func_162(12044, -1);
					flag = flag + func_162(12042, -1);
					break;
		...
		case 30:
			switch (iParam1)
			{
				...
				case 327:
					flag = func_102(40, -1) + func_102(41, -1);
					break;
			
				case 328:
					flag = func_162(11920, -1);
					break;
		...
		case 12:
			switch (iParam1)
			{
				...
				case 118:
					flag = func_162(11928, -1);
					break;
			
				case 119:
					flag = func_162(11927, -1);
					break;
		...
		case 32:
			switch (iParam1)
			{
				...
				case 352:
					flag = func_104(func_162(11964, -1));
					break;
		...
		case 20:
			switch (iParam1)
			{
				...
				case 225:
					flag = func_162(9622, -1);
					break;
			
				case 226:
					flag = func_162(11932, -1);
					break;
		...
		case 22:
			switch (iParam1)
			{
				...
				case 248:
					flag = func_162(11933, -1);
					break;
			
				case 249:
					flag = func_104(func_162(9586, -1));
					break;
			...
			switch (iParam1)
			{
				...
				case 144:
					if (_STAT_GET_PACKED_BOOL(41989, -1))
						...
						flag = func_162(7212, -1);
					break;
			
				case 145:
					flag = func_162(7231, -1);
					break;
				...
				case 147:
					flag = func_162(7230, -1);
					break;
			
				case 148:
					flag = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_162(12025, -1) / 60));
					break;
			
				case 149:
					flag = func_162(7234, -1);
					break;
			}
			break;
		...
		case 15:
			switch (iParam1)
			{
				...
				case 162:
					flag = func_162(6119, -1);
					flag = flag + func_162(6120, -1);
					break;
			}
			break;
		...
		case 17:
			switch (iParam1)
			{
				...
				case 181:
					flag = func_162(11940, -1);
					break;
			
				case 182:
					flag = func_162(5332, -1);
					break;
				...
				case 187:
					flag = func_162(11941, -1);
					break;
			
				case 188:
					flag = func_162(5333, -1);
					break;
			}
			break;
		...
		case 18:
			switch (iParam1)
			{
				...
				case 197:
					flag = func_162(10411, -1);
					break;
			
				case 198:
					flag = flag + func_162(3954, -1);
					flag = flag + func_162(3955, -1);
					flag = flag + func_162(3956, -1);
					flag = flag + func_162(3957, -1);
					flag = flag + func_162(3958, -1);
					break;
			
				case 199:
					flag = func_162(11943, -1);
					break;
			
				case 200:
					flag = func_162(11969, -1);
					break;
			
				case 201:
					flag = func_162(11942, -1);
					break;
			}
			break;
		...
		case 19:
			switch (iParam1)
			{
				...
				case 213:
					flag = flag + func_162(11970, -1);
					break;
			
				case 214:
					flag = func_162(3671, -1);
					break;
			}
			break;
		...
		case 29:
			switch (iParam1)
			{
				...
				case 319:
					flag = func_162(819, -1);
					flag = flag + func_162(12029, -1);
					flag = flag + func_162(12030, -1);
					break;
				...
				case 321:
					flag = flag + func_104(func_162(11929, -1));
					flag = flag + func_104(func_162(11966, -1));
					flag = flag + func_104(func_162(11967, -1));
					flag = flag + func_104(func_162(11968, -1));
					break;
...
BOOL func_93(int iParam0, int iParam1) // Position - 0xC4A1
{
	Hash statHash;
	BOOL outValue;
...
Hash func_94(int iParam0, int iParam1) // Position - 0xC4C5
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_33(iParam1));
}

BOOL func_95() // Position - 0xC4DB
{
	int num;
	BOOL flag;
...
void func_96(int iParam0, BOOL bParam1, int iParam2) // Position - 0xC522
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
BOOL func_98() // Position - 0xC5C3
{
	...
	for (i = 0; i < 103; i = i + 1)
	{
		...
		else if (IS_BIT_SET(func_162(num, -1), i % 32))
		{
	...
	return func_104(address);
}

int func_99(int iParam0) // Position - 0xC6B9
{
	iParam0 = iParam0 / 32;
...
Hash func_100(int iParam0) // Position - 0xC72C
{
	switch (iParam0)
	{
		case 34:
...
var func_101(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCD6D
{
	if (bParam0)
		return uParam1;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0xCD84
{
	Hash statHash;
	int outValue;
...
Hash func_103(int iParam0, int iParam1) // Position - 0xCDA8
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_33(iParam1));
}

BOOL func_104(BOOL bParam0) // Position - 0xCDBE
{
	int num;
	BOOL flag;
...
void func_105(var uParam0, int iParam1) // Position - 0xCDFE
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_106() // Position - 0xCE13
{
	int num;
	int num2;
	...
	func_96(41247, num2, -1);
	return num2;
}

int func_107(BOOL bParam0) // Position - 0xD058
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xD06A
{
	if (iParam1 == -1)
		iParam1 = func_34();
...
BOOL func_109(int iParam0, var uParam1) // Position - 0xD086
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_110(iParam0, *uParam1, i);
	
		if (uParam1->f_2 != -1)
		{
			uParam1->f_2.f_2 = func_74(*uParam1, uParam1->f_2);
			uParam1->f_2.f_1 = func_92(*uParam1, uParam1->f_2);
...
int func_110(int iParam0, int iParam1, int iParam2) // Position - 0xD0FE
{
	switch (iParam1)
	{
		case 0:
...
int func_111(int iParam0) // Position - 0xE044
{
	int num;
	int num2;
	int num3;
...
BOOL func_112(int iParam0, BOOL bParam1) // Position - 0xE08A
{
	if (iParam0 == -1)
		return false;
...
int func_113(int iParam0) // Position - 0xE0A6
{
	switch (iParam0)
	{
		case 12460:
...
int func_114(int iParam0) // Position - 0xE4BC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_115(BOOL bParam0) // Position - 0xE4DA
{
	int num;
...
void func_116(BOOL bParam0, BOOL bParam1) // Position - 0xE534
{
	BOOL flag;
...
BOOL func_117(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE5E5
{
	int num;
	int num2;

	if (func_123(false) && iParam0 == 60)
		return true;
	...
	if (Global_262145.f_8337 == 1)
	{
		...
		if (func_119(PLAYER::PLAYER_ID(), 85))
...
BOOL func_119(Player plParam0, int iParam1) // Position - 0xE7C3
{
	if (!func_40())
		return false;
	...
	return func_120(&(Global_1845270[plParam0 /*892*/].f_826), func_121(iParam1));
}

BOOL func_120(var uParam0, int iParam1) // Position - 0xE803
{
	int num;
	int num2;
	int num3;
...
int func_121(int iParam0) // Position - 0xE826
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_122() // Position - 0xEA12
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_144, 3);
}

BOOL func_123(BOOL bParam0) // Position - 0xEA29
{
	if (bParam0)
		return func_126();

	return func_124(func_125());
}

BOOL func_124(int iParam0) // Position - 0xEA45
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_125() // Position - 0xEA5A
{
	return Global_1907308[PLAYER::PLAYER_ID() /*310*/].f_270;
}

BOOL func_126() // Position - 0xEA70
{
	return func_39(526, -1) || unk_0xB233964AC562A357() && func_128() != 0 && !func_127(0);
}

BOOL func_127(int iParam0) // Position - 0xEAA0
{
	int num;

	num = func_162(15491, -1);
	return IS_BIT_SET(num, iParam0);
}

int func_128() // Position - 0xEAB7
{
	return unk_0xA0A0D77ECEDD4136();
}

void func_129(int iParam0, BOOL bParam1) // Position - 0xEAC3
{
	int offset;
	int num;
...
void func_131(BOOL bParam0) // Position - 0xEB8E
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_140, 25))
		{
			func_132(PLAYER::PLAYER_ID(), 12);
...
void func_132(Player plParam0, int iParam1) // Position - 0xEBF5
{
	func_133(&(Global_1845270[plParam0 /*892*/].f_826), func_121(iParam1));
	return;
}

int func_133(var uParam0, int iParam1) // Position - 0xEC14
{
	int num;
	int num2;
	int offset;
...
BOOL func_137(int iParam0) // Position - 0xECF0
{
	if (func_138())
		return true;
...
BOOL func_138() // Position - 0xED0B
{
	return func_139() != -1;
}

int func_139() // Position - 0xED19
{
	return Global_2684721.f_767;
}

BOOL func_140(int iParam0) // Position - 0xED28
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 130:
			num2 = iParam0;
			num2 = num2 % 32;
			num = func_162(func_141(iParam0), -1);
...
int func_141(int iParam0) // Position - 0xEF56
{
	int num;
...
int func_142(int iParam0) // Position - 0xF023
{
	if (func_36())
		return 1;
...
BOOL func_143(int iParam0) // Position - 0xF2EB
{
	if (Global_1574612)
		return true;
...
int func_144(int iParam0, BOOL bParam1) // Position - 0xF31C
{
	bParam1;
	return func_145(iParam0, 0);
}

int func_145(int iParam0, int iParam1) // Position - 0xF330
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_146(num) == iParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_146(num) < iParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
// Unhandled jump detected. Output should be considered invalid
int func_146(int iParam0) // Position - 0xF3EB
{
	int num;
	int num2;
...
int func_147(Player plParam0, BOOL bParam1) // Position - 0xF926
{
	bParam1;
	return func_148(plParam0);
}

int func_148(Player plParam0) // Position - 0xF939
{
	if (Global_1574633.f_9 == 0)
		if (plParam0 > -1)
			if (plParam0 == PLAYER::PLAYER_ID())
				return func_162(640, -1);
			else if (func_149(plParam0))
...
BOOL func_149(Player plParam0) // Position - 0xF990
{
	if (!func_150(plParam0))
		return false;

	return IS_BIT_SET(Global_2672942.f_1, plParam0);
}

BOOL func_150(Player plParam0) // Position - 0xF9AF
{
	Player player;
...
void func_152() // Position - 0xFA01
{
	if (!func_159(1, -1))
		func_157(1, -1);

	if (func_311() && func_25() == 0)
	{
	}
	else
	{
...
var func_154(int iParam0) // Position - 0xFA89
{
	return Global_1574538[iParam0];
}

var func_155() // Position - 0xFA99
{
	return func_154(func_34() + 1);
}

BOOL func_156(int iParam0) // Position - 0xFAAB
{
	return Global_1929468.f_16[iParam0 /*44*/].f_3;
}

void func_157(int iParam0, int iParam1) // Position - 0xFABF
{
	int profileSetting;
	int profileSetting2;
	...
	switch (iParam0)
	{
		case 0:
			...
			profileSetting2 = func_158(iParam1);
	...
	switch (iParam0)
	{
		case 0:
			...
			func_160(1304, 0, iParam1, true);
			func_160(7236, 0, iParam1, true);
			break;
	}
...
int func_158(int iParam0) // Position - 0xFBA0
{
	int num;
...
BOOL func_159(int iParam0, int iParam1) // Position - 0xFC03
{
	int profileSetting;
	int profileSetting2;
	...
	profileSetting = func_158(iParam1);
	profileSetting2 = MISC::GET_PROFILE_SETTING(profileSetting);
	return IS_BIT_SET(profileSetting2, iParam0);
}

void func_160(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xFC2C
{
	Hash statName;
...
Hash func_161(int iParam0, int iParam1) // Position - 0xFC5A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_33(iParam1));
}

BOOL func_162(int iParam0, int iParam1) // Position - 0xFC6F
{
	Hash statHash;
	int outValue;
...
BOOL func_164() // Position - 0xFCBA
{
	switch (iLocal_271)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_443, 18))
			{
				if (!PED::IS_PED_INJURED(pedLocal_272))
				{
					blLocal_445 = HUD::ADD_BLIP_FOR_ENTITY(pedLocal_272);
					HUD::SET_BLIP_AS_FRIENDLY(blLocal_445, true);
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_445, "FM_LEST_BLP" /*Lester*/);
					func_213("FM_LEST_GTL" /*~s~Go to ~b~Lester.*/, false);
					MISC::SET_BIT(&iLocal_443, 18);
				}
			}
		
			if (!IS_BIT_SET(iLocal_443, 20))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(pedLocal_272))
					{
						...
						{
							iLocal_275 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_272, iLocal_275, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_274, iLocal_275, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
							MISC::SET_BIT(&iLocal_443, 20);
						}
					}
				}
			}
			...
			if (!IS_BIT_SET(iLocal_443, 3))
			{
				CUTSCENE::REQUEST_CUTSCENE(sLocal_444, 8);
				MISC::SET_BIT(&iLocal_443, 3);
			}
			else if (!IS_BIT_SET(iLocal_443, 10))
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					CUTSCENE::SET_CUTSCENE_ENTITY_STREAMING_FLAGS("MP_1", 0, 1);
					MISC::SET_BIT(&iLocal_443, 10);
				}
			}
		...
		case 4:
			...
			{
				func_167(true, true, false, true);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
				NETWORK::NETWORK_SET_VOICE_ACTIVE(true);
			
				if (IS_BIT_SET(iLocal_443, 25))
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), false);
			
				if (inLocal_448 != 0)
					INTERIOR::UNPIN_INTERIOR(inLocal_448);
	...
	if (!IS_BIT_SET(iLocal_443, 11))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MP_1", 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				MISC::SET_BIT(&iLocal_443, 11);
			}
		}
	}

	if (!IS_BIT_SET(iLocal_443, 26))
	{
		if (iLocal_271 > 2)
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					MISC::SET_BIT(&iLocal_443, 26);
				}
			}
		}
	}

	if (IS_BIT_SET(iLocal_443, 19))
	{
...
void func_165() // Position - 0x10089
{
	int num;

	num = func_166(53);
	Global_2645379[num /*83*/] = 53;
	TEXT_LABEL_ASSIGN_STRING(&Global_2645379[num /*83*/].f_18[0 /*16*/], "-StraightIntoFreemode", 64);
	return;
}

int func_166(int iParam0) // Position - 0x100B6
{
	int num;
	int i;
...
void func_167(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10103
{
	func_192();
	...
	func_183(false, true, true, false, false, bParam2, false);
	func_182();
	func_181(12, false, -1);
	func_180(1);
	...
	if (func_311() == false && func_178() == false && bParam1 && !func_176(PLAYER::PLAYER_ID()) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_174())
...
void func_168() // Position - 0x101D5
{
	int i;
	Player player;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && _STOPWATCH_IS_INITIALIZED(&Global_2749998))
	{
		if (!_STOPWATCH_HAS_TIME_PASSED(&Global_2749998, 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_173())
			{
				...
				else if (!func_170(PLAYER::PLAYER_ID(), 0))
				{
...
void func_169(Player plParam0) // Position - 0x102F8
{
...
BOOL func_170(Player plParam0, int iParam1) // Position - 0x103C7
{
	BOOL flag;
...
int func_171(int iParam0, BOOL bParam1) // Position - 0x10420
{
	int num;
	int num2;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x10461
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL func_173() // Position - 0x1049E
{
...
BOOL func_174() // Position - 0x104BC
{
	if (func_175() == 0)
		return true;
...
int func_175() // Position - 0x104D1
{
	return Global_1574633.f_18;
}

BOOL func_176(Player plParam0) // Position - 0x104DF
{
	if (func_170(plParam0, 0))
		return true;
...
BOOL func_177() // Position - 0x1051E
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_178() // Position - 0x1052C
{
	return IS_BIT_SET(Global_2684721, 7);
}

void func_179() // Position - 0x1053A
{
	Global_23848.f_5 = 0;
	return;
}

void func_180(int iParam0) // Position - 0x10548
{
	Global_2739945.f_4667 = iParam0;
	return;
}

void func_181(int iParam0, BOOL bParam1, int iParam2) // Position - 0x10559
{
	switch (iParam0)
	{
		case 5:
...
void func_182() // Position - 0x105A8
{
	func_180(1);
	func_181(4, 0, -1);
	func_181(6, false, -1);
...
void func_183(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x105FF
{
	if (bParam0)
	{
		...
		func_185(true, bParam3, bParam2, false);
		Global_64332 = 1;
		Global_76661 = 1;
		Global_79562 = 1;
	}
	else
	{
		...
		func_185(false, bParam3, bParam2, false);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_176(PLAYER::PLAYER_ID()) && !func_170(PLAYER::PLAYER_ID(), 0) && !func_184() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_176(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5)
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, 0);
...
BOOL func_184() // Position - 0x1074E
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 14);
}

int func_185(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10768
{
	int num;
...
BOOL func_186() // Position - 0x1079B
{
...
void func_187() // Position - 0x107C2
{
	func_188(false);
	return;
}

void func_188(BOOL bParam0) // Position - 0x107CF
{
	if (bParam0)
	{
		func_189();
...
void func_189() // Position - 0x10832
{
...
void func_190(BOOL bParam0) // Position - 0x1085B
{
	int i;
...
void func_191(int iParam0) // Position - 0x10889
{
...
void func_192() // Position - 0x108F3
{
	if (!Global_1574755)
		return;
...
void func_193() // Position - 0x1090A
{
...
void func_194() // Position - 0x10929
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_195() // Position - 0x1095F
{
	Ped entity;

	if (HUD::DOES_BLIP_EXIST(blLocal_445))
		HUD::REMOVE_BLIP(&blLocal_445);
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_274))
	{
		entity = pedLocal_274;
		ENTITY::DELETE_ENTITY(&entity);
	}
	...
	func_12();
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_196(CHAR_LESTER));
...
Hash func_196(eCharacter echParam0) // Position - 0x109C1
{
	if (!func_198(echParam0))
		return func_197(echParam0);
	else
...
Hash func_197(eCharacter echParam0) // Position - 0x109E7
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_198(eCharacter echParam0) // Position - 0x109F6
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_199(int iParam0) // Position - 0x10A02
{
	if (func_202())
		return;
...
void func_200(BOOL bParam0, BOOL bParam1) // Position - 0x10A8C
{
	if (bParam0)
	{
		if (func_317(0))
...
BOOL func_201() // Position - 0x10B00
{
	return IS_BIT_SET(Global_1958240, 5);
}

BOOL func_202() // Position - 0x10B0E
{
	return IS_BIT_SET(Global_1958240, 19);
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x10B1D
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_170(PLAYER::PLAYER_ID(), 0) && !func_177() && !func_176(PLAYER::PLAYER_ID()))
			...
			if (bParam1)
			{
				...
				if (!func_207(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
					if (!flag20)
			...
			else
			{
				if (!func_207(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_204(*Global_4718592.f_194133))
...
BOOL func_204(int iParam0) // Position - 0x10FD1
{
	return iParam0 == 17;
}

void func_205() // Position - 0x10FDE
{
	var unk;
...
void func_206() // Position - 0x1102B
{
...
BOOL func_207(Ped pedParam0) // Position - 0x11069
{
...
void func_208(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x1109A
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x1116A
{
	Hash statName;
...
void func_210() // Position - 0x11186
{
	eViewModeContext i;
...
BOOL func_211() // Position - 0x111DE
{
...
void func_212(int iParam0) // Position - 0x1120F
{
	if (iParam0 == 1)
...
void func_213(char* sParam0, BOOL bParam1) // Position - 0x11232
{
...
void func_214() // Position - 0x1129D
{
	MISC::SET_BIT(&(Global_1574765.f_59), 1);
	return;
}

void func_215(BOOL bParam0) // Position - 0x112B0
{
	if (bParam0)
	{
...
void func_216() // Position - 0x112D6
{
...
BOOL func_217(char* sParam0) // Position - 0x112FB
{
	if (!func_18())
		return false;
...
BOOL func_218(char* sParam0) // Position - 0x1133F
{
	if (!func_18())
		return false;
...
BOOL func_219() // Position - 0x11371
{
	switch (iLocal_450)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_451) && func_271())
			{
				func_252();
				func_251();
				func_248(false, false, true, false, true, true, false);
				...
				func_245(true, true, false, true);
			
				if (!PED::IS_PED_INJURED(pedLocal_273))
				{
					MISC::CLEAR_AREA(1273.8845f, -1718.0037f, 53.7715f, 3f, true, false, false, false);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(pedLocal_273);
					ENTITY::SET_ENTITY_COORDS(pedLocal_273, 1275.2563f, -1722.3683f, 53.655f, true, false, false, true);
					ENTITY::SET_ENTITY_HEADING(pedLocal_273, 12.6638f);
					PED::FORCE_PED_MOTION_STATE(pedLocal_273, joaat("MotionState_Walk"), false, 0, false);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
					WEAPON::SET_CURRENT_PED_WEAPON(pedLocal_273, joaat("WEAPON_UNARMED"), true);
				}
			
				caLocal_452 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
				CAM::SET_CAM_ACTIVE(caLocal_452, true);
				CAM::SET_CAM_PARAMS(caLocal_452, 1276.4088f, -1719.9183f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_451, "SET_DETAILS");
				func_244("FM_LEST_CAM" /*~s~CAM: 02*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_451, "SET_LOCATION");
				func_244("FM_LEST_CAM2" /*~s~FRONT DOOR*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			
				if (GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() == -1)
					GRAPHICS::SET_TIMECYCLE_MODIFIER("scanline_cam");
			
				MISC::SET_BIT(&iLocal_443, 15);
				_STOPWATCH_INITIALIZE(&uLocal_453, false, false);
				STREAMING::REQUEST_MODEL(func_196(12));
				STREAMING::REQUEST_MODEL(joaat("prop_wheelchair_01_s"));
				STREAMING::REQUEST_ANIM_DICT("MissLester1ALeadInOut");
				MISC::SET_BIT(&iLocal_443, 23);
			
				if (!IS_BIT_SET(iLocal_443, 17))
				{
					if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(208246292))
					{
						OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(208246292, 0, false, false);
						MISC::SET_BIT(&iLocal_443, 17);
					}
				}
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_273))
			{
				if (!IS_BIT_SET(iLocal_443, 21))
				{
					if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_453, 1000, false))
					{
						TASK::TASK_LOOK_AT_COORD(pedLocal_273, 1276.4088f, -1719.9183f, 56.1054f, -1, 0, 2);
						MISC::SET_BIT(&iLocal_443, 21);
					}
				}
			}
		
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_453, 1500, false))
			{
				if (IS_BIT_SET(iLocal_443, 17))
				{
					if (!PED::IS_PED_INJURED(pedLocal_273))
					{
						if (!PED::IS_PED_INJURED(pedLocal_272))
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_276, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0))
							{
								_STOPWATCH_DESTROY(&uLocal_453);
								_STOPWATCH_INITIALIZE(&uLocal_453, false, false);
								iLocal_450 = iLocal_450 + 1;
							}
						}
					}
				}
		...
		case 2:
			if (!PED::IS_PED_INJURED(pedLocal_273))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					PED::SET_PED_CONFIG_FLAG(pedLocal_273, 104, true);
					MISC::SET_BIT(&iLocal_443, 22);
					TASK::TASK_CLEAR_LOOK_AT(pedLocal_273);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_273, 1273.5762f, -1718.4594f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					_STOPWATCH_DESTROY(&uLocal_453);
					_STOPWATCH_INITIALIZE(&uLocal_453, false, false);
					iLocal_450 = iLocal_450 + 1;
				}
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_273))
			{
				if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_453, 5000, false) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedLocal_273, 1275.1378f, -1718.4255f, 53.729942f, 1272.4507f, -1719.6267f, 55.45897f, 1.5625f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
	...
	if (IS_BIT_SET(iLocal_443, 15))
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_451))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_451, "SET_TIME");
			...
			if (CLOCK::GET_CLOCK_HOURS() >= 0 && CLOCK::GET_CLOCK_HOURS() < 12)
				func_244("FM_LEST_AM" /*~s~AM*/);
			else
				func_244("FM_LEST_PM" /*~s~PM*/);
		
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_451, 255, 255, 255, 255, 0);
		}
	}

	if (IS_BIT_SET(iLocal_443, 22))
	{
		if (!PED::IS_PED_INJURED(pedLocal_273))
		{
			PED::SET_PED_CONFIG_FLAG(pedLocal_273, 104, true);
			PED::SET_PED_RESET_FLAG(pedLocal_273, 60, true);
			PED::SET_PED_RESET_FLAG(pedLocal_273, 342, true);
			PED::SET_PED_RESET_FLAG(pedLocal_273, 348, true);
		}
	}

	if (IS_BIT_SET(iLocal_443, 23))
		if (func_220())
			MISC::CLEAR_BIT(&iLocal_443, 23);

	return false;
}

BOOL func_220() // Position - 0x118A8
{
	BOOL flag;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_272))
	{
		if (STREAMING::HAS_MODEL_LOADED(func_196(12)))
		{
			if (func_222(&pedLocal_272, CHAR_LESTER, 1276.39f, -1712.845f, 54.372f, 338.0729f, true))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_272, true);
				ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_272, true, 0);
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_276, 8, pedLocal_272, "Lester", 0, 1);
				PED::SET_PED_PROP_INDEX(pedLocal_272, 1, 0, 0, false, 1);
			}
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_274))
		if (STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s")))
			pedLocal_274 = OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, false, false, false);

	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_272))
		return false;

	if (!PED::IS_PED_INJURED(pedLocal_272))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_272))
			return false;
	...
	{
		iLocal_275 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_272, iLocal_275, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_274, iLocal_275, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_275, true);
		flag = true;
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x11A36
{
...
BOOL func_222(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x11AD1
{
	Hash model;

	if (!func_198(echParam1))
	{
		model = func_196(echParam1);
...
int func_223(var uParam0, eCharacter echParam1) // Position - 0x11B5F
{
	int num;
...
void func_224() // Position - 0x11BA5
{
	Ped ped;

	if (CAM::DOES_CAM_EXIST(caLocal_452))
	{
		CAM::SET_CAM_ACTIVE(caLocal_452, false);
		CAM::DESTROY_CAM(caLocal_452, false);
	}

	MISC::CLEAR_BIT(&iLocal_443, 15);
	CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_273))
	{
		ped = pedLocal_273;
		ENTITY::DELETE_ENTITY(&ped);
	}

	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_451);
	GRAPHICS::CLEAR_TIMECYCLE_MODIFIER();
	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x11BFC
{
...
BOOL func_226(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x11C4A
{
	Global_22443 = 0;
...
void func_227() // Position - 0x11F18
{
	if (!func_228())
		return;
...
BOOL func_228() // Position - 0x11F4F
{
...
BOOL func_229(Player plParam0) // Position - 0x11FB2
{
	return func_10(plParam0, 20);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x11FC2
{
	return -1;
}

void func_231() // Position - 0x11FCB
{
	int i;
...
void func_232() // Position - 0x11FFC
{
...
BOOL func_233() // Position - 0x12091
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1212A
{
	if (func_239(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x121CC
{
	func_236();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_236() // Position - 0x121E5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_198(character) && !func_239(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_198(Global_114162.f_2367.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x122E2
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1231F
{
	if (func_198(character))
		return func_197(character);
	else
...
BOOL func_239(int iParam0) // Position - 0x12344
{
	return Global_44199 == iParam0;
}

void func_240() // Position - 0x12352
{
	int i;
...
BOOL func_241(int iParam0, int iParam1) // Position - 0x123A9
{
	switch (iParam0)
	{
		case 5:
...
void func_242() // Position - 0x123E1
{
...
void func_243(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x12438
{
...
void func_244(char* sParam0) // Position - 0x1248E
{
...
void func_245(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x124A0
{
	func_247();
	func_190(true);
	HUD::CLEAR_HELP(true);
	HUD::CLEAR_PRINTS();
	func_183(true, true, true, false, false, false, bParam2);
	func_246();
	func_181(12, true, -1);
	func_180(0);
...
void func_246() // Position - 0x12515
{
	func_180(0);
	func_181(4, true, -1);
	func_181(6, true, -1);
...
void func_247() // Position - 0x1256C
{
	Global_1574755 = true;
...
void func_248(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12595
{
...
void func_249() // Position - 0x12624
{
	Global_23848.f_5 = 1;
	return;
}

void func_250() // Position - 0x12632
{
	func_199(0);
	func_188(true);
	return;
...
void func_251() // Position - 0x12644
{
	Global_2672942.f_1023.f_9 = 1;
	return;
}

void func_252() // Position - 0x12656
{
...
void func_253() // Position - 0x12677
{
	if (!_IS_FMMC_ACTIVE() && !func_254() && Global_2685662)
		Global_4718592.f_134976 = 0;

	return;
}

BOOL func_254() // Position - 0x126A5
{
	return Global_2684721.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x126B4
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_193 != 0;
}

void func_256() // Position - 0x126CB
{
	Global_2684721.f_758 = 1;
	return;
}

BOOL func_257() // Position - 0x126DB
{
	return Global_2684721.f_737;
}

BOOL func_258() // Position - 0x126EA
{
	return IS_BIT_SET(Global_2684721.f_2, 11);
}

BOOL func_259() // Position - 0x126FB
{
	switch (iLocal_271)
	{
		case 0:
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x1281C
{
	uParam0->f_1 = 0;
	return;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x12829
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x12887
{
	return uParam0->f_1;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x12893
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x128A6
{
...
BOOL func_265(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x128BD
{
...
BOOL func_266() // Position - 0x129B6
{
	return Global_2708542;
}

BOOL func_267() // Position - 0x129C2
{
	return Global_2684721.f_850;
}

BOOL func_268() // Position - 0x129D1
{
	return Global_2672942.f_2914.f_582;
}

BOOL func_269(Player plParam0) // Position - 0x129E3
{
...
BOOL func_270() // Position - 0x129FF
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

BOOL func_271() // Position - 0x12A14
{
	Hash entityModel;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_273))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			pedLocal_273 = PED::CREATE_PED(PED_TYPE_CIVMALE, entityModel, 1273.8271f, -1717.8727f, 53.7715f, 19.2225f, false, false);
			ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_273, true, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_273, true);
			PED::CLONE_PED_TO_TARGET(PLAYER::PLAYER_PED_ID(), pedLocal_273);
		}
	}
	...
	if (!PED::IS_PED_INJURED(pedLocal_273))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_273))
			return false;

	return true;
}

void func_272() // Position - 0x12AA3
{
...
void func_273(int iParam0, int iParam1) // Position - 0x12AD6
{
	int profileSetting;
	int profileSetting2;
...
void func_274(int iParam0, BOOL bParam1) // Position - 0x12B67
{
	if (bParam1)
...
BOOL func_275() // Position - 0x12BC4
{
	Ped ped;
...
BOOL func_276(Player plParam0, int iParam1) // Position - 0x12C5B
{
	return IS_BIT_SET(Global_2657994[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_277(BOOL bParam0) // Position - 0x12C71
{
	Player player;

	player = PLAYER::PLAYER_ID();

	if (func_303(player) || func_302(player) || func_301(player) || func_300(player) || func_299(player) || func_298(player) || func_297(player) || func_296(player) || func_295(player) || func_292(player) && func_291(player) || func_290(player) || func_289(player) || func_288(player) || func_287(player) || func_286(player) || func_285(player) || func_284(player))
		return true;

	if (bParam0)
		if (func_283(player))
			return true;
	else if (func_278(player))
		return true;

	return false;
}

BOOL func_278(Player plParam0) // Position - 0x12D7A
{
	if (func_283(plParam0) || func_282(plParam0) || func_281(plParam0) || _IS_PLAYER_IN_MUSIC_LOCKER(plParam0))
		return true;

	return false;
}

BOOL _IS_PLAYER_IN_MUSIC_LOCKER(Player plParam0) // Position - 0x12DB4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 19;

	return false;
}

int func_280(int iParam0) // Position - 0x12DFB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_281(Player plParam0) // Position - 0x13330
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 15;

	return false;
}

BOOL func_282(Player plParam0) // Position - 0x13377
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 16;

	return false;
}

BOOL func_283(Player plParam0) // Position - 0x133BE
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 14;

	return false;
}

BOOL func_284(Player plParam0) // Position - 0x13405
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 33;

	return false;
}

BOOL func_285(Player plParam0) // Position - 0x1344C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 32;

	return false;
}

BOOL func_286(Player plParam0) // Position - 0x13493
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 31;

	return false;
}

BOOL func_287(Player plParam0) // Position - 0x134DA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			return Global_2657994[plParam0 /*467*/].f_324.f_8 == 161;

	return false;
}

BOOL func_288(Player plParam0) // Position - 0x1350B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_289(Player plParam0) // Position - 0x1353C
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 29;

	return false;
}

BOOL func_290(Player plParam0) // Position - 0x13583
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 28;

	return false;
}

BOOL func_291(Player plParam0) // Position - 0x135CA
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_292(Player plParam0) // Position - 0x135F0
{
	if (func_294(plParam0) && func_293(plParam0) == plParam0)
		return true;

	return false;
}

Player func_293(Player plParam0) // Position - 0x13614
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_294(Player plParam0) // Position - 0x13638
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 25;

	return false;
}

BOOL func_295(Player plParam0) // Position - 0x13698
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_296(Player plParam0) // Position - 0x136DF
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 21;

	return false;
}

BOOL func_297(Player plParam0) // Position - 0x13726
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 24;

	return false;
}

BOOL func_298(Player plParam0) // Position - 0x1376D
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

BOOL func_299(Player plParam0) // Position - 0x137B4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 23;

	return false;
}

BOOL func_300(Player plParam0) // Position - 0x137FB
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_301(Player plParam0) // Position - 0x13842
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 17;

	return false;
}

BOOL func_302(Player plParam0) // Position - 0x13889
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_280(Global_2657994[plParam0 /*467*/].f_324.f_8) == 20;

	return false;
}

BOOL func_303(Player plParam0) // Position - 0x138E9
{
	return func_304(&(Global_2657994[plParam0 /*467*/].f_446), 0);
}

BOOL func_304(var uParam0, int iParam1) // Position - 0x13902
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_305() // Position - 0x13910
{
	return Global_1941987;
}

BOOL func_306() // Position - 0x1391C
{
	return false;
}

BOOL func_307(int iParam0) // Position - 0x13936
{
	BOOL flag;
	...
	if (iParam0 >= 0 && iParam0 <= 16 && func_309())
		return true;
	else if (iParam0 >= 17 && iParam0 <= 31 && func_308())
		return true;
...
BOOL func_308() // Position - 0x139D0
{
	return IS_BIT_SET(func_162(2482, -1), 2);
}

BOOL func_309() // Position - 0x139E2
{
	return IS_BIT_SET(func_162(2482, -1), 1);
}

BOOL func_310(Player plParam0) // Position - 0x139F4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_311() // Position - 0x13A1A
{
	return Global_1575086;
}

int func_312() // Position - 0x13A26
{
	return Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_194;
}

BOOL func_313() // Position - 0x13A3B
{
	return IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_36.f_18, 0);
}

BOOL func_314(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13A54
{
	if (bParam1)
...
BOOL func_315(Player plParam0) // Position - 0x13A86
{
	return func_316(plParam0);
}

BOOL func_316(Player plParam0) // Position - 0x13A94
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_11.f_1, 0);
}

BOOL func_317(int iParam0) // Position - 0x13AAB
{
	if (iParam0 == 1)
		if (Global_21083.f_1 > 3)
...
BOOL func_318() // Position - 0x13B02
{
	return func_319();
}

BOOL func_319() // Position - 0x13B0E
{
	return Global_1668461.f_40 == 3;
}

BOOL func_320() // Position - 0x13B1E
{
	if (Global_22442 == 4)
		if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
			return true;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x13B43
{
...
BOOL func_322(Player plParam0) // Position - 0x13B65
{
	if (func_36())
		return true;
...
int func_323() // Position - 0x13B91
{
	return iLocal_94;
}

int func_324(int iParam0) // Position - 0x13B9B
{
	return uLocal_174[iParam0 /*3*/];
}

void func_325(Blip blParam0) // Position - 0x13BA9
{
	if (func_327(true))
	{
	...
	else if (HUD::DOES_BLIP_EXIST(*blParam0) && HUD::IS_BLIP_SHORT_RANGE(*blParam0) && !func_326())
	{
...
BOOL func_326() // Position - 0x13C1B
{
	return false;
}

BOOL func_327(BOOL bParam0) // Position - 0x13C24
{
	return func_328(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_328(Player plParam0, BOOL bParam1) // Position - 0x13C36
{
	if (!func_150(plParam0))
		return false;
	...
	return func_150(Global_1887694[plParam0 /*611*/].f_10);
}

BOOL func_329(Player plParam0) // Position - 0x13C6E
{
	if (func_150(plParam0))
		if (func_150(Global_1887694[plParam0 /*611*/].f_10))
			return Global_1887694[plParam0 /*611*/].f_10 == plParam0;

	return false;
}

void func_330() // Position - 0x13CA3
{
	Entity entity;
...
void func_331() // Position - 0x13D98
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_332() // Position - 0x13DA4
{
	Global_2672942.f_1023.f_9 = 0;
	return;
}

BOOL func_333() // Position - 0x13DB6
{
	return Global_2672942.f_1023.f_9;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x13DC7
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x13E4B
{
	switch (func_25())
	{
		case 0:
...
Hash func_336() // Position - 0x13E7E
{
...
BOOL func_337() // Position - 0x13EA2
{
	return Global_2684721.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x13EB1
{
...
BOOL func_339() // Position - 0x13EC8
{
	return Global_2696433;
}

BOOL func_340() // Position - 0x13ED4
{
	return Global_2684721.f_695;
}

void func_341() // Position - 0x13EE3
{
	SYSTEM::WAIT(0);
	return;
}

void func_342(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x13EF0
{
	func_346(func_347(uParam0), uParam0);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_94, 79, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_174, 97, 0);
...
BOOL func_343() // Position - 0x13F32
{
	var unk;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x13F90
{
	int i;
...
BOOL func_345(BOOL bParam0) // Position - 0x140A7
{
	bParam0;
	return Global_1575058;
}

void func_346(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x140B8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_331();
...
int func_347(int iParam0) // Position - 0x140D7
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_348(func_349(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_348(int iParam0) // Position - 0x14895
{
	switch (iParam0)
	{
		case 150:
...
int func_349(int iParam0, BOOL bParam1) // Position - 0x14BCF
{
	switch (iParam0)
	{
		case 229:
