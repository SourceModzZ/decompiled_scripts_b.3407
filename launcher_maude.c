...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_262(&unk64, &num, unk61, 1f))
	{
		func_261();
	...
	while (true)
	{
		...
		func_204(num);
		func_196(&iLocal_91, &(num.f_9), unk61);
...
void func_3(int iParam0, var uParam1) // Position - 0x2CE
{
	func_21(uParam1);
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xC71
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x287D
{
...
BOOL func_29(var uParam0) // Position - 0x28BD
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x28EB
{
...
int func_31(var uParam0) // Position - 0x29C7
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A09
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2A6C
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2AFA
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2DA4
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x33C3
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x34F2
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x3639
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3676
{
...
int func_47(eCharacter echParam0) // Position - 0x369B
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3873
{
...
var func_54(int iParam0, int iParam1) // Position - 0x38EC
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3901
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E4A
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x41B1
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x42A4
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x47C5
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x5546
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5581
{
	int num;
...
void func_67(int iParam0) // Position - 0x57F5
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5831
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D80
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5DC4
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6543
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x658A
{
...
BOOL func_73(int iParam0) // Position - 0x65E5
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65F5
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6655
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A0C
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6A17
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A27
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6AC9
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7243
{
...
int func_81() // Position - 0x753E
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x754D
{
...
int func_83() // Position - 0x7577
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x758F
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x75A4
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x75BB
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7613
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76BD
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7752
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7796
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x791A
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7928
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x83F3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8475
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84CD
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x84D6
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x875D
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x876D
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x878A
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x879A
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8ADD
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8AEE
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8B34
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8BBA
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8BED
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8C3E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8CE0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D02
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8D19
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8D26
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8D60
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8D9B
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DD7
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8DF0
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8E53
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8E69
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x8E7F
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EC1
{
...
struct<2> func_119(int iParam0) // Position - 0x8EE9
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9336
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA60E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA954
{
	int num;
...
void func_125(int iParam0) // Position - 0xAA94
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAAF2
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB4B
{
...
int func_129(int iParam0) // Position - 0xABCE
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xABFF
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC14
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xACC7
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xACE2
{
	int i;
...
int func_135(int iParam0) // Position - 0xAD2E
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAD77
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD97
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xADB8
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAE88
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEDB
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAFD1
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB03C
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB07B
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB1CA
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB1E4
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB23D
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB27E
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB2A0
{
...
BOOL func_150() // Position - 0xB2DF
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2ED
{
	int num;
...
void func_153(int iParam0) // Position - 0xB347
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB36A
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB40E
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB49D
{
...
void func_161(var uParam0) // Position - 0xB4F4
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB520
{
...
void func_164(int iParam0) // Position - 0xB6C2
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB6F5
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB77F
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB7F3
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB801
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB858
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB867
{
...
BOOL func_171(int iParam0) // Position - 0xB8A8
{
	int num;
...
void func_172(int iParam0) // Position - 0xB8ED
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB91F
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA56
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAA5
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBAB6
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBC97
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBCB9
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBCCA
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD13
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD37
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC51D
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC538
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC5C6
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC62A
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC6C1
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC6EB
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCE08
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCE16
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCE7D
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCE8E
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCEC6
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCED2
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCEEE
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xCFDF
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xD01B
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xD054
{
	BOOL flag;
	int i;
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0F2
{
	var unk;
...
BOOL func_201() // Position - 0xD12C
{
	return Global_98972;
}

void func_202(var uParam0) // Position - 0xD138
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD14F
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD237
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD25F
{
	var unk;
	...
	if (func_242(*panParam0) || func_240(*panParam0) || Global_79785 == 1)
		return true;
...
void func_206(int iParam0, var uParam1, int iParam2) // Position - 0xD4CF
{
	var unk;
	var unk2;
...
BOOL func_207(int iParam0) // Position - 0xD827
{
...
BOOL func_208(var uParam0) // Position - 0xD847
{
...
BOOL func_209(var uParam0) // Position - 0xD85F
{
...
void func_210(var uParam0) // Position - 0xD884
{
	int i;
	var unk;
...
void func_211(var uParam0) // Position - 0xDB88
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_212(var uParam0) // Position - 0xDBB3
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC33
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_214(var uParam0, var uParam1) // Position - 0xDDF1
{
	var unk;
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDE21
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE0DD
{
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE111
{
	float num;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		if (func_228(uParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), uParam0))
		{
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE187
{
	return func_219(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_219(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE19F
{
	BOOL flag;
	var unk;
	int num;

	num = func_227(uParam0, uParam1);
	...
	if (!func_223(uParam0, uParam1, iParam2, iParam3))
		return false;
	...
	flag = func_220(&iLocal_35[num /*4*/], unk, uParam1, &(iLocal_35[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE260
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_221(var uParam0, int iParam1) // Position - 0xE38C
{
	int num;
...
BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE49B
{
	var unk;
	var unk4;
	float num;

	unk = { func_225(unk_0xD1A6A821F5AC81DB(uParam1, 1) - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	...
	if (iParam3 == 0)
		...
		unk4 = { func_225(unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(uParam0, 31086, 0f, 0f, 0f)) };

	num = func_224(unk4, unk);
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE52C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE54D
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE58C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(var uParam0, var uParam1) // Position - 0xE5A7
{
	int i;
...
int func_228(var uParam0) // Position - 0xE5E6
{
...
BOOL func_229(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE60E
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_233(uParam0, bParam1, num, num2))
				return true;
		
			if (func_230(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_230(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE709
{
	float num;
	float num2;
...
BOOL func_231(var uParam0, float fParam1) // Position - 0xE815
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_232(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE8AA
{
	var unk;
	var unk4;
	float num;

	unk = { func_225(uParam1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
...
BOOL func_233(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE938
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_234(int iParam0) // Position - 0xE980
{
...
void func_235(var uParam0) // Position - 0xE9CA
{
	var unk;
...
BOOL func_236(int iParam0) // Position - 0xEA67
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEAFC
{
...
{
	if (func_241() && Global_101688.f_11 == 6 && iParam0 == func_179(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_241() // Position - 0xEBAF
{
...
BOOL func_242(int iParam0) // Position - 0xEBED
{
...
BOOL func_243(var uParam0) // Position - 0xEC15
{
	if (!func_244(uParam0))
		return false;
...
BOOL func_244(var uParam0) // Position - 0xEC34
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_249(&num) || !unk_0xE100DD4F82A51BDE("special_ped@maude@base"))
				return false;
...
BOOL func_245(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEECC
{
	if (func_246(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_246(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEF28
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_251(echParam1);
...
int func_247(var uParam0, eCharacter echParam1) // Position - 0xEFB6
{
	int num;
...
void func_248(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEFFC
{
	func_211(uParam0);
...
BOOL func_249(var uParam0) // Position - 0xF023
{
	int i;
...
void func_250(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF054
{
	var unk;
	var unk4;
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_90 = unk_0xA7B0B03284E7503C(unk, unk4, 0, 1, 1, 1, 1);
...
int func_251(eCharacter echParam0) // Position - 0xF155
{
	if (!func_36(echParam0))
...
BOOL func_252(int iParam0) // Position - 0xF17B
{
	var unk;
	eCharacter character;
...
BOOL func_253(int iParam0) // Position - 0xF1CC
{
	var unk;
...
BOOL func_254(int iParam0) // Position - 0xF285
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF346
{
	int i;
	var unk;
	int num;
...
BOOL func_256(int iParam0, char* sParam1) // Position - 0xF3CB
{
...
BOOL func_257(int iParam0) // Position - 0xF4AD
{
...
BOOL func_258(int iParam0) // Position - 0xF4D8
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF503
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF52E
{
	if (func_237(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF57D
{
	int i;
...
BOOL func_263(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF5E2
{
	int num;
	char* str;
...
BOOL func_264(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF65A
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF6D5
{
	if (bParam1)
	{
...
int func_266(var uParam0) // Position - 0xF73A
{
	if (func_209(uParam0))
	{
...
void func_267(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF770
{
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xF790
{
	func_269(&(uParam0->f_41), bParam1);
	return;
}

void func_269(var uParam0, BOOL bParam1) // Position - 0xF7A2
{
	int i;
...
void func_270(var uParam0, BOOL bParam1) // Position - 0xF7E0
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xF81B
{
	func_272(&(uParam0->f_35), bParam1);
	return;
}

void func_272(var uParam0, BOOL bParam1) // Position - 0xF82D
{
	int i;
...
void func_273(var uParam0) // Position - 0xF86A
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_274(var uParam0) // Position - 0xF8A2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_275(var uParam0, int iParam1) // Position - 0xF93E
{
	func_276(&(uParam0->f_28), iParam1);
	return;
}

void func_276(var uParam0, int iParam1) // Position - 0xF950
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_277(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_277(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF991
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_278(var uParam0) // Position - 0xF9E1
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_279(var uParam0) // Position - 0xFA22
{
...
BOOL func_280(var uParam0, int iParam1) // Position - 0xFA93
{
	if (func_136(uParam0))
...
void func_281(int iParam0) // Position - 0xFAC6
{
	if (*iParam0 == -1)
		return;
...
void func_282(char* sParam0) // Position - 0xFB03
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_283(var uParam0) // Position - 0xFB15
{
	*uParam0 = -1;
