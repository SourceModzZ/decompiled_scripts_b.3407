...
void func_9() // Position - 0x973
{
	...
	if (func_22(&uLocal_37, uLocal_65, Global_25, 1, iLocal_94, sLocal_102, "", sLocal_103, true, 0, true, -1))
	{
...
BOOL func_78(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41B1
{
	...
	if (func_86() || func_85(*Global_4718592.f_187633) || func_84())
	{
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
		{
			unk = unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0);
...
{
	if (unk_0xD9F5E1FEFD1329E4(Global_112842.f_222[iParam0], 0))
	{
		unk_0xEE0BCDB1B5E36BCB(Global_112842.f_222[iParam0], 1, 1);
		return Global_112842.f_222[iParam0];
	}
...
{
	return func_114(Global_112842.f_20, Global_112842.f_29);
}
...
void func_117(var uParam0, int iParam1) // Position - 0x5A15
{
	...
	func_118(uParam0, &(Global_114135.f_32754.f_5510));
	return;
}
...
BOOL func_129() // Position - 0x6941
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_130() // Position - 0x6957
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

BOOL func_131() // Position - 0x696D
{
	return false;
}

BOOL func_132() // Position - 0x6976
{
	return true;
}

BOOL func_133() // Position - 0x697F
{
	return true;
}

BOOL func_134() // Position - 0x6988
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x69A1
{
	var unk;
...
BOOL func_136(var uParam0) // Position - 0x6A59
{
	int num;
	var unk;
...
BOOL func_137(var uParam0) // Position - 0x6AA0
{
	int i;
...
BOOL func_138(var uParam0) // Position - 0x6ADB
{
	int i;
...
BOOL func_139(var uParam0) // Position - 0x6B57
{
	int i;
...
int func_140(var uParam0) // Position - 0x6C3F
{
	int i;
...
BOOL func_141(var uParam0, int iParam1, BOOL bParam2) // Position - 0x6CA2
{
	int i;
	var unk;
	int num;
...
BOOL func_142(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6D10
{
...
void func_143(int iParam0) // Position - 0x6DE8
{
