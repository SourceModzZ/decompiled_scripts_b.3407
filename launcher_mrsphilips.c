...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_271(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_255(&unk64, &num, unk61, 1f))
	{
		func_254();
	...
	func_243(&num);
	uLocal_90 = unk_0xA7B0B03284E7503C(unk61 - { 20f, 20f, 20f }, unk61 + { 20f, 20f, 20f }, 0, 1, 1, 1, 1);
	...
	while (true)
	{
		...
		func_204(num);
		func_196(&iLocal_89, &(num.f_9), unk61);
...
void func_3(int iParam0, var uParam1) // Position - 0x341
{
	func_21(uParam1);
...
var func_15(int iParam0) // Position - 0xBBD
{
	var unk;
...
void func_21(var uParam0) // Position - 0xCB2
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xCE2
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x19BA
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2865
{
	var unk;
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x28ED
{
...
BOOL func_29(var uParam0) // Position - 0x292D
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x295B
{
...
int func_31(var uParam0) // Position - 0x2A37
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2A79
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADC
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2B6A
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2E13
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3431
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3560
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x36A6
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E3
{
...
int func_47(eCharacter echParam0) // Position - 0x3708
{
	return Global_2201[echParam0 /*29*/];
}

void func_48(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3717
{
...
var func_50(int iParam0, int iParam1) // Position - 0x38E0
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3959
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396E
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB7
{
	eCharacter character;
...
void func_60(int iParam0, BOOL bParam1) // Position - 0x421C
{
	eCharacter character;
	var unk;
	int i;
...
void func_61(int iParam0, var uParam1) // Position - 0x430F
{
	int i;
	int j;
	int k;
...
int func_64(int iParam0, int iParam1) // Position - 0x4830
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x55B1
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x55EC
{
	int num;
...
void func_67(int iParam0) // Position - 0x5860
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x589C
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DEB
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E2F
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65AE
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65F5
{
...
BOOL func_73(int iParam0) // Position - 0x6650
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6660
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66C0
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A77
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6A82
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A92
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B34
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72AE
{
...
int func_81() // Position - 0x75A9
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75B8
{
...
int func_83() // Position - 0x75E2
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x75FA
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x760F
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7626
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x767E
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7728
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77BD
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7801
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7985
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7993
{
	var unk;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F29
{
...
struct<2> func_119(int iParam0) // Position - 0x8F51
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x939D
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA5E3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA929
{
	int num;
...
void func_124(int iParam0) // Position - 0xA9CE
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAA69
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAAC7
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB20
{
...
int func_129(int iParam0) // Position - 0xABA3
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xABD4
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xABE9
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAC9C
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xACB7
{
	int i;
...
int func_135(int iParam0) // Position - 0xAD03
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAD4C
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAD6C
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAD8D
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAE5D
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xAEB0
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAFA6
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB011
{
	var unk;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB050
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB19F
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB1B9
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB212
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB253
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB275
{
...
BOOL func_150() // Position - 0xB2B4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xB2C2
{
	int num;
...
void func_153(int iParam0) // Position - 0xB31C
{
	if (iParam0 == 1)
...
BOOL func_154(var uParam0) // Position - 0xB33F
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB3E3
{
...
BOOL func_160(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB472
{
...
void func_161(var uParam0) // Position - 0xB4C9
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB4F5
{
...
void func_164(int iParam0) // Position - 0xB697
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB6CA
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB754
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB7C8
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_168(int iParam0) // Position - 0xB7D6
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB82D
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_170(int iParam0) // Position - 0xB83C
{
...
BOOL func_171(int iParam0) // Position - 0xB87D
{
	int num;
...
void func_172(int iParam0) // Position - 0xB8C2
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8F4
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA2B
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA7A
{
	return func_176(iParam0, Global_44181);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBA8B
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBC6C
{
	if (Global_44181 == 15)
		return false;
...
int func_178() // Position - 0xBC8E
{
	return func_179(unk_0x1AF90EB93E0012D6(), 0);
}

int func_179(var uParam0, int iParam1) // Position - 0xBC9F
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBCE8
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBD0C
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC4F1
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC50C
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC59A
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC5FE
{
	var unk;
...
BOOL func_186(var uParam0) // Position - 0xC695
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_187(int iParam0) // Position - 0xC6BF
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCDDC
{
	return Global_101727.f_1;
}

BOOL func_189() // Position - 0xCDEA
{
	if (Global_98585 != -1)
...
BOOL func_192() // Position - 0xCE51
{
	return Global_101740.f_400 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCE62
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCE9A
{
	return Global_1575084;
}

BOOL func_195() // Position - 0xCEA6
{
	if (!unk_0x76CD105BCAC6EB9F())
...
void func_196(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCEC2
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xCFB3
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xCFEF
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xD028
{
	BOOL flag;
	int i;
...
float func_200(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD0C6
{
	var unk;
...
BOOL func_201() // Position - 0xD100
{
	return Global_98972;
}

void func_202(var uParam0) // Position - 0xD10C
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD123
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD20B
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD233
{
	var unk;
...
void func_206(int iParam0, var uParam1, int iParam2) // Position - 0xD4A3
{
	var unk;
	var unk2;
...
BOOL func_207(int iParam0) // Position - 0xD7FB
{
...
BOOL func_208(var uParam0) // Position - 0xD81B
{
...
BOOL func_209(var uParam0) // Position - 0xD833
{
...
void func_210(var uParam0) // Position - 0xD858
{
	int i;
	var unk;
...
void func_211(var uParam0) // Position - 0xDB5C
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_212(var uParam0) // Position - 0xDB87
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDC07
{
	int i;
	int num;
	var unk;
...
BOOL func_214(var uParam0, var uParam1) // Position - 0xDDC5
{
	var unk;
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDDF5
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE0B1
{
...
BOOL func_217(var uParam0, int iParam1) // Position - 0xE0E5
{
	float num;
...
BOOL func_218(var uParam0, int iParam1) // Position - 0xE15B
{
	return func_219(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_219(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE173
{
	BOOL flag;
	var unk;
	int num;
...
BOOL func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xE234
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_221(var uParam0, int iParam1) // Position - 0xE360
{
	int num;
...
BOOL func_223(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xE46F
{
	var unk;
	var unk4;
	float num;
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE500
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE521
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE560
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(var uParam0, var uParam1) // Position - 0xE57B
{
	int i;
...
int func_228(var uParam0) // Position - 0xE5BA
{
...
BOOL func_229(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE5E2
{
	float num;
	float num2;
	int num3;
...
BOOL func_230(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE6DD
{
	float num;
	float num2;
...
BOOL func_231(var uParam0, float fParam1) // Position - 0xE7E9
{
	var unk;
	var unk2;
...
BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE87E
{
	var unk;
	var unk4;
	float num;
...
BOOL func_233(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE90C
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_234(int iParam0) // Position - 0xE954
{
...
void func_235(var uParam0) // Position - 0xE99E
{
	var unk;
...
BOOL func_236(int iParam0) // Position - 0xEA3B
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEAD0
{
...
BOOL func_240(int iParam0) // Position - 0xEB4F
{
...
BOOL func_242(int iParam0) // Position - 0xEBC1
{
...
void func_243(var uParam0) // Position - 0xEBE9
{
	if (!unk_0x173751E886F8E9AB())
	{
...
void func_244(var uParam0) // Position - 0xEC16
{
	uParam0->f_16 = 5;
...
BOOL func_245(int iParam0) // Position - 0xEC6B
{
	var unk;
	eCharacter character;
...
BOOL func_246(int iParam0) // Position - 0xECBC
{
	var unk;
...
BOOL func_247(int iParam0) // Position - 0xED75
{
	var unk;
...
BOOL func_248(int iParam0) // Position - 0xEE36
{
	int i;
	var unk;
	int num;
...
BOOL func_249(int iParam0, char* sParam1) // Position - 0xEEBB
{
...
BOOL func_250(int iParam0) // Position - 0xEF9B
{
...
BOOL func_251(int iParam0) // Position - 0xEFC6
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_252(int iParam0) // Position - 0xEFF1
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_253(int iParam0) // Position - 0xF01C
{
	if (func_237(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF06B
{
	int i;
...
BOOL func_256(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF0D0
{
	int num;
	char* str;
...
BOOL func_257(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF148
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_258(var uParam0, BOOL bParam1) // Position - 0xF1C3
{
	if (bParam1)
	{
...
void func_259(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF217
{
...
void func_260(var uParam0, BOOL bParam1) // Position - 0xF237
{
	func_261(&(uParam0->f_41), bParam1);
	return;
}

void func_261(var uParam0, BOOL bParam1) // Position - 0xF249
{
	int i;
...
void func_262(var uParam0, BOOL bParam1) // Position - 0xF287
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_263(var uParam0, BOOL bParam1) // Position - 0xF2C2
{
	func_264(&(uParam0->f_35), bParam1);
	return;
}

void func_264(var uParam0, BOOL bParam1) // Position - 0xF2D4
{
	int i;
...
void func_265(var uParam0) // Position - 0xF311
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_266(var uParam0) // Position - 0xF349
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_267(var uParam0, int iParam1) // Position - 0xF3E5
{
	func_268(&(uParam0->f_28), iParam1);
	return;
}

void func_268(var uParam0, int iParam1) // Position - 0xF3F7
{
	int i;
...
void func_269(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF438
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_270(var uParam0) // Position - 0xF488
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
void func_271(int iParam0) // Position - 0xF4C9
{
	if (*iParam0 == -1)
		return;
...
void func_272(char* sParam0) // Position - 0xF506
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_273(var uParam0) // Position - 0xF518
{
	*uParam0 = -1;
