...
void main() // Position - 0x0
{
	...
	fLocal_63 = 0f;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_95, "CELL_206" /*BACK*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_99, "CELL_214" /*OPTIONS*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_103, "CELL_243" /*ACCEPT JOB*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_107, "CELL_244" /*CANCEL JOB*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_111, "CELL_265" /*INVITATION*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_115, "CELL_300" /*CHAR_DEFAULT*/, 16);
	MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
	func_102(&uLocal_122);
	iLocal_119 = 0;
	func_100();
	func_99(Global_21064, "SET_THEME", SYSTEM::TO_FLOAT(5), -1082130432, -1082130432, -1082130432, -1082130432);
	func_89(false);
...
void func_5() // Position - 0x1FA
{
	...
	Global_1882385.f_6 = 1;

	if (bLocal_121)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, Global_21052))
			bLocal_121 = false;
...
void func_6(int iParam0) // Position - 0x261
{
	...
	player = Global_1882385.f_7[iParam0 /*8*/].f_2;

	if (Global_1882385.f_7[iParam0 /*8*/].f_1 == 1 && plLocal_120 == player)
	{
		func_27(player, Global_1882385.f_7[iParam0 /*8*/].f_6);
		func_13(iParam0);
	}
...
void func_13(int iParam0) // Position - 0x44F
{
	...
	if (iParam0 != -1)
	{
		if (Global_1882385.f_7[iParam0 /*8*/].f_1 == 1)
		{
			if (IS_BIT_SET(Global_1882385.f_7[iParam0 /*8*/].f_5, 0))
			{
				func_26();
			
				if (Global_1882385.f_7[iParam0 /*8*/].f_7 == 0)
				{
					func_26();
				}
				else
				{
					Global_1882385.f_4 = Global_1882385.f_4 - 1;
				
					if (Global_1882385.f_4 < 0)
						Global_1882385.f_4 = 0;
				
					func_18();
				}
			}
		
			MISC::CLEAR_BIT(&(Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_22), Global_1882385.f_7[iParam0 /*8*/].f_2);
			HUD::THEFEED_REMOVE_ITEM(Global_1882385.f_7[iParam0 /*8*/].f_4);
			func_17();
			func_15(0);
		}
		...
		{
			Global_1882385.f_7[i /*8*/] = { Global_1882385.f_7[i + 1 /*8*/] };
		}
	
		Global_1882385.f_7[9 /*8*/].f_1 = 0;
		Global_1882385.f_7[9 /*8*/].f_2 = _INVALID_PLAYER_INDEX();
	}
...
{
	if (!func_16(iParam0))
		MISC::SET_BIT(&(Global_1882385.f_3), iParam0);
...
{
	return IS_BIT_SET(Global_1882385.f_3, iParam0);
}

void func_17() // Position - 0x579
{
	Global_1882385 = Global_1882385 - 1;
	return;
}
...
void func_19() // Position - 0x5AD
{
	if (!Global_21302 && !IS_BIT_SET(Global_8921, 9))
	{
		...
		{
			func_99(Global_21064, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_20(1);
			func_99(Global_21064, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_21063), -1082130432, -1082130432, -1082130432);
		}
	}
				...
				if (iParam0 == Global_8926[num /*15*/].f_11)
				{
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9520[i] == 0)
						{
							...
							if (Global_2696428)
								if (num == 14)
									func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23505), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8926[num /*15*/].f_4)
					{
						if (Global_9520[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23510), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79564)
								{
									...
									func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21083)
									...
									func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8926[num /*15*/].f_10 == 57 && num == 25)
							{
								...
								func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_21(Global_21064, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8926[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8926[num /*15*/], 0, 0, 0, 0);
							}
...
{
	Global_1882385.f_1 = Global_1882385.f_1 - 1;

	if (Global_1882385.f_1 < 0)
		Global_1882385.f_1 = 0;
...
{
	if (Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_26 == _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
		{
			Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10.f_26 = plParam0;
			Global_2739945.f_5266.f_228 = uParam1;
...
int func_31(int iParam0, int iParam1) // Position - 0xD84
{
	...
	{
		if (Global_1882385.f_7[i /*8*/].f_7 == iParam1)
		{
			iParam0 = iParam0 - 1;
...
void func_33() // Position - 0xDD0
{
	...
	player = Global_1882385.f_7[num /*8*/].f_2;

	if (!_NETWORK_IS_PLAYER_VALID(player, false, true) || plLocal_120 != player)
	{
		func_89(true);
		return;
	}
	...
	if (func_41(&uLocal_122))
	{
		func_89(true);
		return;
	}

	if (func_40(&uLocal_122))
	{
		func_13(num);
		func_89(true);
		return;
	...
	if (func_36(&uLocal_122))
	{
		...
		else if (Global_1882385.f_7[num /*8*/] == 0)
		{
			func_6(num);
		}
		else if (Global_1882385.f_7[num /*8*/] == 1)
		{
			func_34(num);
		}
		else
...
{
	MISC::SET_BIT(&Global_1836205, 15);
	func_13(iParam0);
	Global_1882385.f_6 = 0;
	func_7(0);
	return;
...
BOOL func_36(var uParam0) // Position - 0xEC6
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21052))
		return false;
...
BOOL func_41(var uParam0) // Position - 0xFCE
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21053))
		return false;
...
void func_43(var uParam0) // Position - 0x1034
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21059) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_BACKWARD))
	{
		func_46();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21060) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_FORWARD))
	{
		func_44();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
...
{
	func_99(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_99(Global_21064, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21072, true);
	func_47();
	return;
}
...
void func_49() // Position - 0x11C1
{
	...
	if (func_36(&uLocal_122))
	{
		...
		iLocal_119 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(methodReturn);
		num = func_31(iLocal_119, 0);
	
		switch (Global_1882385.f_7[num /*8*/].f_1)
		{
			case 0:
				return;
	...
	if (func_40(&uLocal_122))
	{
		...
		iLocal_119 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(methodReturn2);
		num2 = func_31(iLocal_119, 0);
	
		switch (Global_1882385.f_7[num2 /*8*/].f_1)
		{
			case 0:
				return;
...
{
	if (func_16(iParam0))
		MISC::CLEAR_BIT(&(Global_1882385.f_3), iParam0);
...
void func_51() // Position - 0x12EA
{
	...
	func_99(Global_21064, "SET_DATA_SLOT_EMPTY", SYSTEM::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	flag = false;
	num2 = func_31(iLocal_119, 0);
	plLocal_120 = Global_1882385.f_7[num2 /*8*/].f_2;
	player = Global_1882385.f_7[num2 /*8*/].f_2;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21064, "SET_DATA_SLOT");
	...
	if (Global_1882385.f_7[num2 /*8*/] == 0)
	{
		if (Global_262145.f_15371)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1887694[player /*611*/].f_10.f_11[i] != _INVALID_PLAYER_INDEX())
					{
						if (_NETWORK_IS_PLAYER_VALID(Global_1887694[player /*611*/].f_10.f_11[i], false, true))
						{
							unk16[num3] = Global_1887694[player /*611*/].f_10.f_11[i];
							num3 = num3 + 1;
						}
					}
				}
		...
		{
			if (Global_1882385.f_88[num2 /*5*/].f_1)
				if (Global_1882385.f_88[num2 /*5*/].f_2)
			...
			else if (Global_1882385.f_88[num2 /*5*/].f_2)
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882385.f_88[num2 /*5*/]);
			HUD::ADD_TEXT_COMPONENT_INTEGER(func_78(player));
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882385.f_88[num2 /*5*/].f_3);
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882385.f_88[num2 /*5*/].f_4);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		}
	}
	else if (Global_1882385.f_7[num2 /*8*/] == 1)
	{
		...
		HUD::SET_COLOUR_OF_NEXT_TEXT_COMPONENT(func_80(Global_1882385.f_7[num2 /*8*/].f_2));
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_63(Global_1882385.f_7[num2 /*8*/].f_2));
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}

	if (flag)
	{
		num = func_57(Global_1882385.f_7[num2 /*8*/].f_2);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_99(Global_21064, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	func_55(&uLocal_111);
	func_52(13, &uLocal_103, 12, &uLocal_107, 4, &uLocal_95, &uLocal_122);
	iLocal_94 = 1;
	return;
}
...
void func_53(int iParam0, int iParam1, const char* sParam2, int iParam3, int* piParam4, int iParam5) // Position - 0x1669
{
	if (iParam1 == 1)
	{
		func_21(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 0f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_21071)
	{
		func_21(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		MISC::SET_BIT(piParam4, iParam3);
		func_54(iParam5, true);
		return;
	}

	func_21(Global_21064, "SET_SOFT_KEYS", SYSTEM::TO_FLOAT(iParam0), 1f, SYSTEM::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	MISC::SET_BIT(piParam4, iParam3);
	func_54(iParam5, true);
	return;
}
...
{
	func_56(Global_21064, "SET_HEADER", sParam0, 0, 0, 0, 0);
	return;
}
...
BOOL func_76(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1D46
{
	...
	if (func_30(player) && Global_1887694[player /*611*/].f_10.f_431 == iParam2)
		return 1;
...
int func_83(Player plParam0) // Position - 0x1F38
{
	if (func_30(plParam0))
		if (func_84(plParam0, true))
			return Global_2648917.f_818.f_11[func_65(plParam0)];
...
void func_89(BOOL bParam0) // Position - 0x2038
{
	...
	plLocal_120 = _INVALID_PLAYER_INDEX();
	...
	func_90();
	func_99(Global_21064, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(25), SYSTEM::TO_FLOAT(value), -1082130432, -1082130432, -1082130432);
	...
	if (flag)
		func_52(13, &uLocal_99, 12, &uLocal_107, 4, &uLocal_95, &uLocal_122);
	else
		func_52(1, "", 1, "", 4, &uLocal_95, &uLocal_122);
...
void func_90() // Position - 0x2122
{
	...
	func_99(Global_21064, "SET_DATA_SLOT_EMPTY", SYSTEM::TO_FLOAT(25), -1082130432, -1082130432, -1082130432, -1082130432);

	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1882385.f_7[i /*8*/].f_1 == 1 && Global_1882385.f_7[i /*8*/].f_7 == 0)
		{
			switch (Global_1882385.f_7[i /*8*/])
			{
				case 0:
					if (func_94(i, num))
						num = num + 1;
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x2235
{
	...
	if (Global_1882385.f_7[iParam0 /*8*/].f_2 == _INVALID_PLAYER_INDEX() || !_NETWORK_IS_PLAYER_VALID(Global_1882385.f_7[iParam0 /*8*/].f_2, false, true))
		return false;

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21064, "SET_DATA_SLOT");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(25);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	unk = { func_86(Global_1882385.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	...
	num = func_83(Global_1882385.f_7[iParam0 /*8*/].f_2);
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x22F2
{
	...
	unk = { func_86(Global_1882385.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	flag = func_79(Global_1882385.f_7[iParam0 /*8*/].f_2);
	value = func_78(Global_1882385.f_7[iParam0 /*8*/].f_2);
...
int func_98() // Position - 0x25BA
{
	...
	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1882385.f_7[i /*8*/].f_7 == 1)
			num = num + 1;
	}
