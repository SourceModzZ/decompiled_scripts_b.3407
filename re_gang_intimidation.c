...
int func_1(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, Ped pedParam7, var uParam8, var uParam9, var uParam10) // Position - 0x8FE
{
	int i;
...
BOOL func_10(int iParam0, int iParam1) // Position - 0x17D7
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1828
{
	if (iParam2 == -1)
		iParam2 = func_12();
...
void func_20() // Position - 0x1F8A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_22(character) && !func_21(14) || Global_113110)
			{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x20A1
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x20DE
{
...
Hash func_25(eCharacter echParam0) // Position - 0x2103
{
...
BOOL func_35(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, Ped pedParam6, var uParam7) // Position - 0x24FD
{
	switch (iLocal_250)
	{
		case 0:
...
BOOL func_36(int iParam0, int iParam1) // Position - 0x27BD
{
	int gameTimer;
	int num;
...
Blip func_38(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x2837
{
	Blip blip;
...
Blip func_39(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2881
{
	Blip blip;
...
void func_41(Blip blParam0) // Position - 0x293C
{
...
void func_42(var uParam0, Ped pedParam1) // Position - 0x2953
{
	int i;
...
BOOL func_49(Player plParam0) // Position - 0x2DE3
{
	return func_50(plParam0, 20);
}

BOOL func_50(Player plParam0, int iParam1) // Position - 0x2DF3
{
...
BOOL func_60(Ped pedParam0, var uParam1) // Position - 0x3123
{
	switch (iLocal_253)
	{
		case 0:
...
void func_61(Ped pedParam0) // Position - 0x3806
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		TASK::CLEAR_PED_TASKS(pedParam0);
...
void func_62(Ped pedParam0, var uParam1) // Position - 0x386F
{
	int i;
...
int func_64(BOOL bParam0) // Position - 0x3AAA
{
	if (func_68())
	{
		...
		if (func_14(Global_114151))
			func_65(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_14(Global_114151))
...
{
	switch (func_69(&Global_33165, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
{
	return func_72(iParam0, Global_44199);
}
...
BOOL func_78(Ped pedParam0, int iParam1) // Position - 0x4088
{
...
BOOL func_80(Ped pedParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, int iParam5, int iParam6) // Position - 0x411E
{
...
void func_84(Ped pedParam0) // Position - 0x43A5
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4422
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_113209 || Global_33108 || func_99() || func_58(8, -1) || func_98() || func_97() || func_96() || func_95() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_100() || Global_33108 || func_99() || func_58(8, -1) || func_96() || func_98() || func_97() || func_95() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_113209 || Global_33108 || func_99() || func_58(8, -1) || func_96() || func_98() || func_97() || func_95() || Global_114162.f_7692.f_919[character] == 5 || Global_44746 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_113209 || Global_33108 || func_99() || func_58(8, -1) || func_98() || func_97() || func_95() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_100() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_58(8, -1) || func_95() || func_94() || Global_114162.f_7692.f_919[character] == 5)
							return false;
						break;
...
{
	if (Global_114151 == func_29() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114152)
		return true;
...
BOOL func_119(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6B80
{
	...
	if (!flag)
	{
		...
		if (!func_146(Global_114162.f_24999.f_43[iParam3]))
			return false;
...
void func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, Ped pedParam8) // Position - 0x7A17
{
	int i;
...
void func_153(int iParam0) // Position - 0x7AC8
{
	...
	if (func_114())
	{
		...
		func_156(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_155(Global_114151, true), 64);
	
		if (func_28(Global_114151) > 0)
		{
