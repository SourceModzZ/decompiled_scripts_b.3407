...
void main() // Position - 0x0
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (num != -1)
		{
			if (Global_113222[num /*10*/].f_9 != -1)
			{
				...
				func_328(&(Global_113222[num /*10*/].f_9));
			}
		}
	...
	if (!func_307(&unk125, &num, unk61, 1f))
	{
		func_306();
	...
	while (true)
	{
		...
		func_227(num);
		func_220(&iLocal_106, &(num.f_9), unk61);
		...
		if (num == 37)
		{
			func_210(&num, unk61, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_108);
		}
		else if (num == 42)
		{
			func_205(&num, unk61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (num == 43)
		{
		...
		if (num == 41)
			if (func_201(&num, &unk64) || func_200(&num))
				flag = true;
...
void func_3(int iParam0, var uParam1) // Position - 0x45F
{
	func_21(uParam1);
...
void func_21(var uParam0) // Position - 0xDD8
{
...
void func_23(char* sParam0, int iParam1, int iParam2) // Position - 0xE08
{
...
int func_28(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2A14
{
...
BOOL func_29(var uParam0) // Position - 0x2A54
{
	int i;
...
void func_30(var uParam0, var uParam1, int iParam2) // Position - 0x2A82
{
...
int func_31(var uParam0) // Position - 0x2B5E
{
	int i;
...
eCharacter func_32(var uParam0) // Position - 0x2BA0
{
	int i;
...
int func_33(var uParam0, eCharacter echParam1, int iParam2) // Position - 0x2C03
{
	int i;
...
int func_34(eCharacter echParam0, int iParam1) // Position - 0x2C91
{
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x2F3B
{
	int i;
...
BOOL func_42(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x355A
{
	var unk;
...
BOOL func_43(var uParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3689
{
	int i;
	var unk;
	int num;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(int iParam0) // Position - 0x37D0
{
	eCharacter i;
	int num;
...
int _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x380D
{
...
int func_47(eCharacter echParam0) // Position - 0x3832
{
...
var func_50(int iParam0, int iParam1) // Position - 0x3A0A
{
...
var func_54(int iParam0, int iParam1) // Position - 0x3A83
{
	return unk_0xD69CE161FE614531(2, iParam0, func_51(iParam1));
}

void func_55(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A98
{
	eCharacter character;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3FE1
{
	eCharacter character;
...
int func_64(int iParam0, int iParam1) // Position - 0x495B
{
	int num;
	int num2;
	int i;
...
int func_65(int iParam0, var uParam1) // Position - 0x56DC
{
	int i;
	int num;
...
int func_66(int iParam0) // Position - 0x5717
{
	int num;
...
void func_67(int iParam0) // Position - 0x598B
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x59C7
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(var uParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F16
{
	var unk;
	var unk2;
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F5A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66D9
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6720
{
...
BOOL func_73(int iParam0) // Position - 0x677B
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x678B
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x67EB
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6BA2
{
	return Global_33087;
}

BOOL func_77(int iParam0) // Position - 0x6BAD
{
	return func_74(iParam0, 5, true);
}

int func_78(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BBD
{
	int i;
	float num;
	float num2;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C5F
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x73D9
{
...
int func_81() // Position - 0x76D4
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76E3
{
...
int func_83() // Position - 0x770D
{
	return Global_2657991[unk_0x259BE71D8A81D4FA() /*467*/].f_324.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7725
{
	return unk_0xF10F2A2453AF1DFB(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x773A
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7751
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x77A9
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7853
{
	var unk;
	var unk7;
	var unk13;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x78E8
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x792C
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7AB0
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7ABE
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8586
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x8608
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8660
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8669
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x88F0
{
	return func_98(unk_0x259BE71D8A81D4FA());
}

int func_98(int iParam0) // Position - 0x8900
{
	return unk_0x8B5B2BE72A7C0CF6(Global_2657991[iParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x891D
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x892D
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C70
{
	return Global_101740.f_399 > 0;
}

var func_102() // Position - 0x8C81
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8CC7
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8D4D
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D80
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8DD1
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8E73
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E95
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8EAC
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8EB9
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8EF3
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8F2E
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F6A
{
	func_58();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F83
{
	int num;
	var unk;
...
BOOL func_115() // Position - 0x8FE6
{
	return unk_0x3B880DE16766E9C3() || unk_0x716271729B9FB8E6();
}

BOOL func_116() // Position - 0x8FFC
{
	return unk_0xFD5A25A8B9488D42() || unk_0x6823557BDD18031C();
}

void func_117(char* sParam0, var uParam1, int iParam2) // Position - 0x9012
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9054
{
...
struct<2> func_119(int iParam0) // Position - 0x907C
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x94C9
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA7A1
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAAE7
{
	int num;
	...
	if (func_153(&(panParam0->f_1)))
	{
		...
		{
			func_143(true);
			func_141(panParam0, 1, func_142(*panParam0));
		}
...
void func_124(int iParam0) // Position - 0xAB8C
{
	var unk;
...
void func_125(int iParam0) // Position - 0xAC27
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(int iParam0) // Position - 0xAC85
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xACDE
{
...
int func_129(int iParam0) // Position - 0xAD61
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD92
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADA7
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAE5A
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE75
{
	int i;
...
int func_135(int iParam0) // Position - 0xAEC1
{
	int i;
...
BOOL func_136(var uParam0) // Position - 0xAF0A
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(int iParam0) // Position - 0xAF2A
{
	if (unk_0xFC8BFE4B41177C22(iParam0))
...
BOOL func_138(int iParam0) // Position - 0xAF4B
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xB01B
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xB06E
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB164
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB1CF
{
	var unk;
	...
	func_144(true, true, false, 0, false, false, false);
	return;
}

void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB20E
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB35D
{
	return IS_BIT_SET(Global_1845221[unk_0x259BE71D8A81D4FA() /*889*/].f_36.f_18, 14);
}

BOOL func_146(int iParam0, int iParam1) // Position - 0xB377
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB3D0
{
	int num;
	int num2;
...
BOOL func_148(int iParam0) // Position - 0xB411
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xB433
{
...
BOOL func_150() // Position - 0xB472
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_151() // Position - 0xB480
{
...
void func_152(int iParam0) // Position - 0xB4A7
{
	if (iParam0 == 1)
...
BOOL func_153(var uParam0) // Position - 0xB4CA
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB56E
{
...
void func_158() // Position - 0xB5A5
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			if (func_159(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10.5f, 1, 1056964608, 0, true, false))
...
BOOL func_159(var uParam0, float fParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5FD
{
...
void func_160(var uParam0) // Position - 0xB654
{
	if (!unk_0x1C2F771CDC87A3A5(uParam0, 0))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB680
{
...
void func_163(int iParam0) // Position - 0xB822
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB855
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB8DF
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB953
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_167(int iParam0) // Position - 0xB961
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB9B8
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_169(int iParam0) // Position - 0xB9C7
{
...
BOOL func_170(int iParam0) // Position - 0xBA08
{
	int num;
	...
	num = func_172(&(Global_113222[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_171(int iParam0) // Position - 0xBA4D
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA7F
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBBB6
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBC05
{
	return func_175(iParam0, Global_44181);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBC16
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBDF7
{
	if (Global_44181 == 15)
		return false;
...
int func_177() // Position - 0xBE19
{
	return func_178(unk_0x1AF90EB93E0012D6(), 0);
}

int func_178(var uParam0, int iParam1) // Position - 0xBE2A
{
	int num;
	var unk;
	var unk33;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE73
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE97
{
	switch (iParam0)
	{
		case 0:
...
var func_181(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0xC30A
{
	var unk;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC336
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC34D
{
	switch (iParam0)
	{
		case 0:
...
int func_184(int iParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xC3DC
{
	int num;
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC40F
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCBF2
{
	func_27(&(Global_104696.f_2890), &Global_104696, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCC0D
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCC9B
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCCFF
{
	var unk;
...
BOOL func_190(var uParam0) // Position - 0xCD96
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
		if (unk_0xD9F5E1FEFD1329E4(uParam0, 0))
...
BOOL func_191(int iParam0) // Position - 0xCDC0
{
	eCharacter character;
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_199() || Global_113182 || Global_33090 || func_198() || func_197(8, -1) || func_101() || func_196() || func_195() || func_194() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_199() || Global_33090 || func_198() || func_197(8, -1) || func_195() || func_101() || func_196() || func_194() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D()) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D()) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA()) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_199() || Global_113182 || Global_33090 || func_198() || func_197(8, -1) || func_195() || func_101() || func_196() || func_194() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D()) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0) || func_199() || Global_113182 || Global_33090 || func_198() || func_197(8, -1) || func_101() || func_196() || func_194() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_199() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0 || func_197(8, -1) || func_194() || func_193() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_192() // Position - 0xD4DD
{
	return Global_101727.f_1;
}

BOOL func_193() // Position - 0xD4EB
{
	if (Global_98585 != -1)
...
BOOL func_196() // Position - 0xD552
{
	return Global_101740.f_400 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD563
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD59B
{
	return Global_1575084;
}

BOOL func_199() // Position - 0xD5A7
{
	if (!unk_0x76CD105BCAC6EB9F())
...
int func_200(var uParam0) // Position - 0xD5C3
{
	int i;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()))
	{
		for (i = 0; i <= uParam0->f_28 - 1; i = i + 1)
		{
			if (unk_0xFC8BFE4B41177C22(uParam0->f_28[i]))
			{
				...
				{
					if (unk_0x9B3D4335E0EDB0BE(uParam0->f_28[i], unk_0x4A8C381C258A124D(), 1) || unk_0x398315D0C90DE6F6(unk_0xD1A6A821F5AC81DB(uParam0->f_28[i], 1), 7.5f, 1))
					{
						if (func_191(2))
						{
							func_188(uParam0->f_27, *uParam0);
...
int func_201(var uParam0, var uParam1) // Position - 0xD687
{
...
BOOL func_202(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xD6C4
{
	BOOL flag;
	int num;
	int num2;
...
void func_203(var uParam0, var uParam1, var uParam2) // Position - 0xD780
{
		...
		switch (*uParam0)
		{
			case 0:
				if (unk_0xD7E1DF759CD0FFF2("CAR_TRUNK_THUMPS", 0, -1))
				{
					...
					uParam0->f_3 = unk_0xC5935DFB3F39785A(6000, 12000);
					*uParam0 = 1;
				}
				break;
		
			case 1:
				if (unk_0x1DD05E817C89C737() - uParam0->f_2 > uParam0->f_3)
				{
					unk_0xF37CDE164C892195(uParam0->f_1, "TRUNK_THUMPS", unk_0x0D1381B6E0F3987D(*uParam1, 0f, -2.2f, 0.5f), 0, 0, 0, 0);
					unk_0x4CAD907F190E6F10(*uParam2, "NIGE3_CXAA", "DINAPOLI", AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(0), 0);
					uParam0->f_4 = unk_0xC5935DFB3F39785A(3, 7);
					uParam0->f_5 = 0;
					uParam0->f_6 = unk_0x1DD05E817C89C737();
					uParam0->f_7 = unk_0xC5935DFB3F39785A(100, 250);
					*uParam0 = 2;
				}
				break;
		
			case 2:
				if (unk_0x1DD05E817C89C737() - uParam0->f_6 > uParam0->f_7)
				{
					uParam0->f_8 = unk_0xC5935DFB3F39785A(-200, -120);
					uParam0->f_9 = 0.5f * SYSTEM::TO_FLOAT(unk_0xC5935DFB3F39785A(-2, 3));
					unk_0xE592D924D5438108(*uParam1, 1, 0f, 0f, (float)uParam0->f_8, uParam0->f_9, -1.5f, 0f, 0, 1, 1, 0, 1, 1);
					uParam0->f_5 = uParam0->f_5 + 1;
				
					if (uParam0->f_5 < uParam0->f_4)
					{
						uParam0->f_6 = unk_0x1DD05E817C89C737();
						uParam0->f_7 = unk_0xC5935DFB3F39785A(150, 280);
					}
					else
					{
						uParam0->f_2 = unk_0x1DD05E817C89C737();
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD8EB
{
	char* str;
...
int func_205(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDAE0
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && unk_0x1DD05E817C89C737() - uParam0->f_60 > iParam8 && func_209(unk_0x4A8C381C258A124D(), fParam1, 1) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB68
{
...
void func_207(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBA3
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDBF9
{
...
float func_209(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xDC94
{
	var unk;
...
int func_210(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xDCCE
{
	var unk;
	...
	if (!(*uParam10 == 3))
	{
		if (func_191(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_209(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f)
				{
			...
			else if (func_212(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && func_209(unk_0x4A8C381C258A124D(), uParam1, 1) >= 20f)
			{
			...
			if (func_209(unk_0x4A8C381C258A124D(), uParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_211(int iParam0) // Position - 0xDE19
{
	Global_23436 = iParam0;
	return;
}

BOOL func_212(char* sParam0) // Position - 0xDE26
{
	var unk;
...
struct<6> func_213() // Position - 0xDE46
{
	var unk;
...
void func_214(int iParam0, var uParam1, int iParam2) // Position - 0xDE6A
{
	var unk;
	var unk2;
...
BOOL func_215(int iParam0) // Position - 0xE1C2
{
...
BOOL func_216(var uParam0) // Position - 0xE1E2
{
...
BOOL func_217(var uParam0) // Position - 0xE1FA
{
...
int func_218() // Position - 0xE21F
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_219() // Position - 0xE22C
{
	return "Al_DiNapoli";
}

void func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE238
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam1))
		{
			...
			{
				if (func_209(unk_0x4A8C381C258A124D(), uParam2, 1) <= 100f)
					func_223(uParam0, 1);
			}
			else
			{
				...
				if (func_209(unk_0x4A8C381C258A124D(), uParam2, 1) > 120f)
					func_225(uParam0);
			}
		}
	}
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE329
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE365
{
	if (Global_79535 == iParam0)
		if (Global_79536 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE39E
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE43C
{
	return Global_98972;
}

void func_225(var uParam0) // Position - 0xE448
{
	unk_0xB479965CBAA3EAE1(0);
	unk_0xDD291722ADDCBD60();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE45F
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE547
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE56F
{
	var unk;
	...
	if (func_261(*panParam0) || func_259(*panParam0) || Global_79785 == 1)
		return true;
...
void func_229(var uParam0) // Position - 0xE7DF
{
	int i;
	var unk;
...
void func_230(var uParam0) // Position - 0xEAE3
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_231(var uParam0) // Position - 0xEB0E
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB8E
{
	int i;
	int num;
	var unk;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_233(unk_0x4A8C381C258A124D(), uParam0->f_35[i]))
							{
...
BOOL func_233(var uParam0, var uParam1) // Position - 0xED4C
{
	var unk;
...
BOOL func_234(var uParam0, BOOL bParam1, int iParam2) // Position - 0xED7C
{
	int i;
	int num;
...
BOOL func_235(int iParam0) // Position - 0xF038
{
...
BOOL func_236(var uParam0, int iParam1) // Position - 0xF06C
{
	float num;
...
BOOL func_237(var uParam0, int iParam1) // Position - 0xF0E2
{
	return func_238(uParam0, unk_0x4A8C381C258A124D(), iParam1, 1, 250, 7);
}

BOOL func_238(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF0FA
{
	BOOL flag;
	var unk;
	int num;
	...
	flag = func_239(&iLocal_47[num /*4*/], unk, uParam1, &(iLocal_47[num /*4*/].f_3), uParam0, iParam5);
	return flag || unk_0x1DD05E817C89C737() - iLocal_47[num /*4*/].f_3 < iParam4;
}

BOOL func_239(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0xF1BB
{
	var unk;
	var unk2;
	var unk5;
...
Vector3 func_240(var uParam0, int iParam1) // Position - 0xF2E7
{
	int num;
...
BOOL func_242(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0xF3F6
{
	var unk;
	var unk4;
	float num;
...
float func_243(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF487
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_244(float fParam0, var uParam1, var uParam2) // Position - 0xF4A8
{
	float num;
	float num2;
...
void func_245(var uParam0) // Position - 0xF4E7
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_246(var uParam0, var uParam1) // Position - 0xF502
{
	int i;
...
int func_247(var uParam0) // Position - 0xF541
{
...
BOOL func_248(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF569
{
	float num;
	float num2;
	int num3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(unk_0x4A8C381C258A124D()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_252(uParam0, bParam1, num, num2))
				return true;
		
			if (func_249(uParam0, num2, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_249(var uParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF664
{
	float num;
	float num2;
...
BOOL func_250(var uParam0, float fParam1) // Position - 0xF770
{
	var unk;
	var unk2;
	...
	if (unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_GRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_BZGAS"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &unk2, &unk, 0) || unk_0xF67924A428A734EC(uParam0, joaat("WEAPON_MOLOTOV"), fParam1, &unk2, &unk, 0))
		if (func_251(uParam0, unk2, 90f, 0))
			return true;

	return false;
}

BOOL func_251(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF805
{
	var unk;
	var unk4;
	float num;
...
BOOL func_252(var uParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF893
{
	if (bParam1)
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
BOOL func_253(int iParam0) // Position - 0xF8DB
{
...
void func_254(var uParam0) // Position - 0xF925
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF9C2
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_256(int iParam0) // Position - 0xFA57
{
...
BOOL func_259(int iParam0) // Position - 0xFAD6
{
	if (func_260() && Global_101688.f_11 == 6 && iParam0 == func_178(&(Global_101688.f_3), 0))
		return true;

	return false;
}

BOOL func_260() // Position - 0xFB0A
{
...
BOOL func_261(int iParam0) // Position - 0xFB48
{
...
BOOL func_262(var uParam0, var uParam1) // Position - 0xFB70
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_263(var uParam0) // Position - 0xFC2C
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_265(&uParam0->f_35[0], iLocal_93, -39.9688f, -1285.9615f, 28.3505f, 181.02f);
...
BOOL func_264(var uParam0, var uParam1) // Position - 0xFE13
{
	var unk;
	var unk4;
	float num;

	if (unk_0xFC8BFE4B41177C22(*uParam1) && unk_0x6252BC0DD8A320DB(iLocal_92))
	{
		*uParam0 = unk_0xB1DBFEB95C0EFB88(26, joaat("U_M_M_Aldinapoli"), -59.7094f, -1330.1289f, 32.1963f, 0, 1, 1);
		unk_0xEB418CA245FFE897(*uParam0, "NI3_LNCH_CELEB");
		unk_0xD1C578C204015E1F(*uParam0, 4, 0, 0, 0);
		unk_0xAAA71DD7E9059338(*uParam0, 1);
		unk = { unk_0x0D1381B6E0F3987D(*uParam1, -0.2f, -1.8f, -1f) };
		num = -90f + unk_0xCFC0C995455A6204(*uParam1);
		unk4 = { 0f, 0f, num };
		unk_0x62C438C53BB57AFD(*uParam0, unk, 0, 0, 1);
		unk_0xCF39804E8C88080E(*uParam0, unk4, 2, 1);
...
void func_265(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFEE8
{
	func_266(uParam0);
...
void func_266(var uParam0) // Position - 0xFF2B
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
BOOL func_267(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFFC7
{
	if (func_268(uParam0, echParam1, fParam2, fParam5, true))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_268(var uParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10024
{
	int num;

	if (!func_36(echParam1))
	{
		num = func_332(echParam1);
...
int func_269(var uParam0, eCharacter echParam1) // Position - 0x100B2
{
	int num;
...
BOOL func_270(var uParam0) // Position - 0x100F8
{
	if (func_217(uParam0))
	{
...
BOOL func_271(var uParam0) // Position - 0x10122
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x10153
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_273(var uParam0) // Position - 0x1018F
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_265(&uParam0->f_35[0], iLocal_93, -1304.01f, -644.58f, 25.91f, 127.67f);
...
void func_274(int iParam0, BOOL bParam1) // Position - 0x103AA
{
	switch (iParam0)
	{
		case 37:
		...
		case 38:
			if (bParam1)
			{
				uLocal_105 = unk_0xA7B0B03284E7503C(-577.27405f, 270.65054f, 77f, -543.17926f, 315.29727f, 94f, 0, 1, 1, 1, 1);
				unk_0x470041F66BF345BA("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0x470041F66BF345BA("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0x470041F66BF345BA("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				uLocal_105 = unk_0xA7B0B03284E7503C(-1073.19f, 342.05f, 63.328316f, -966.24f, 411.05f, 84.820435f, 0, 1, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				uLocal_105 = unk_0xA7B0B03284E7503C(-1122.2018f, 48.5724f, 51.4652f, -1076.2333f, 92.1041f, 60.0617f, 0, 1, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				uLocal_105 = unk_0xA7B0B03284E7503C(-1319.5663f, -650.07697f, 23.53715f, -1301.7892f, -634.0721f, 38.18122f, 0, 1, 1, 1, 1);
...
void func_275(BOOL bParam0) // Position - 0x107C4
{
	var unk;
	var unk4;
	var unk7;
...
BOOL func_278(var uParam0, var uParam1) // Position - 0x108AE
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_271(&num) || !unk_0xE100DD4F82A51BDE(uParam0->f_48) || !unk_0xE100DD4F82A51BDE(str))
				return false;
		...
		case 2:
			func_274(41, true);
			uParam0->f_28[0] = unk_0xB1DBFEB95C0EFB88(26, num[3], -1096.855f, 67.6858f, 52.952f, 112f, 1, 1);
			...
			uParam0->f_41[0] = unk_0x4E55EAB577C13329(num[1], -1096.855f, 67.6858f, 52.952f, 1, 1, 0);
			...
			unk_0xC58DD79B4CA8487F(unk8, 1);
			unk_0x93C0674FC00824D0(unk8);
			unk_0x4BD42B0527065BB6(uParam0->f_28[0], unk8);
			unk_0xD0557B139A542F12(&unk8);
			uParam0->f_28[1] = unk_0xB1DBFEB95C0EFB88(26, num[4], -1096.2576f, 69.723f, 53.0107f, 163f, 1, 1);
			...
			uParam0->f_41[1] = unk_0x4E55EAB577C13329(num[2], -1096.2576f, 69.723f, 53.0107f, 1, 1, 0);
			...
			uParam0->f_28[2] = unk_0xB1DBFEB95C0EFB88(26, num[0], -1105.6224f, 66.4609f, 53.07f, 118f, 1, 1);
			uParam0->f_28[3] = unk_0xB1DBFEB95C0EFB88(26, num[0], -1090.0902f, 64.3905f, 52.5607f, 238f, 1, 1);
			uParam0->f_28[4] = unk_0xB1DBFEB95C0EFB88(26, num[0], -1093.736f, 73.8568f, 53.0388f, 319f, 1, 1);
		
			for (i = 2; i <= 4; i = i + 1)
			{
				unk_0xAAA71DD7E9059338(uParam0->f_28[i], 1);
				unk_0xB41DEC3AAC1AA107(uParam0->f_28[i], joaat("WEAPON_PISTOL"), -1, 0, 1);
				unk_0x1F7539C841C2A71F(uParam0->f_28[i], 1);
				unk_0x3F58BFCF656F0DF1(uParam0->f_28[i], 1);
				unk_0x9E6CC93E007219AC(uParam0->f_28[i], 1);
				unk_0xF24ADF73381B85C1(uParam0->f_28[i], 1);
				unk_0xA1F44380A2D59F2B(num[0], 1);
			}
		
			uParam0->f_35[0] = unk_0x5779387E956077A6(num[5], -1099.91f, 61.2608f, 52.8124f, 243f, 1, 1, 0);
			...
			unk_0xCCA6D8A84EE8C88A(num[5], 1);
			uParam0->f_41[2] = unk_0x4E55EAB577C13329(num[6], -1099.91f, 63.2608f, 52.8124f, 1, 1, 0);
			unk_0x4D306DD94DD6FDBA(uParam0->f_41[2], uParam0->f_35[0], 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
			uParam0->f_35[1] = unk_0x5779387E956077A6(num[5], -1102.3347f, 75.7757f, 53.2591f, 293f, 1, 1, 0);
			uParam0->f_35[2] = unk_0x5779387E956077A6(num[5], -1103.0232f, 65.6267f, 53.056f, 203f, 1, 1, 0);
		
			for (i = 1; i <= 2; i = i + 1)
			{
				unk_0x1DE99C193C7EC64B(uParam0->f_35[i], 1084227584);
			}
...
void func_279(var uParam0) // Position - 0x10EA2
{
	int i;
	float num;
...
void func_280(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x10F42
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_281(var uParam0) // Position - 0x10F73
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
BOOL func_282(var uParam0) // Position - 0x10F9A
{
	int num;
	int i;
	char* str;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_271(&num) || !unk_0xE100DD4F82A51BDE(str))
				return false;
...
BOOL func_283(var uParam0) // Position - 0x112C8
{
	int num;
	int i;
	char* str;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
			{
				num2 = unk_0x7BFB76C576628F3D(uParam0->f_35[0], 2);
			
				if (!unk_0x6B0915C0DDD2954F(uParam0->f_35[0], 2) && num2 < 0.8f)
					unk_0x3E13A302AA0F06BF(uParam0->f_35[0], 2, 0, 1f);
				else
					iLocal_89 = 3;
			}
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
			{
				if (!unk_0x13CCB1AD131C1082(uParam0->f_35[0], str, "idle_speedo", 3))
				{
					if (unk_0xE100DD4F82A51BDE(str))
					{
						unk_0x3D98759970C5FCC9(uParam0->f_35[0], str, "idle_speedo");
						return false;
					}
					else
					{
			...
			func_285(&uParam0->f_28[0], num[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			if (func_136(uParam0->f_28[0]))
			{
				...
				unk_0x10425721983AE158(uParam0->f_28[0], str, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
		
			func_285(&uParam0->f_28[1], num[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			...
			func_285(&uParam0->f_28[2], num[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			...
			if (func_136(uParam0->f_28[2]))
			{
				...
				if (unk_0xE100DD4F82A51BDE(str))
					unk_0x10425721983AE158(uParam0->f_28[2], str, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
			}
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
				...
				unk_0x935364B4448CD584(uParam0->f_41[0], 1, 0);
...
void func_284(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1182C
{
	func_230(uParam0);
...
void func_285(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6) // Position - 0x11853
{
	func_286(uParam0);
...
void func_286(var uParam0) // Position - 0x11874
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
BOOL func_287(var uParam0) // Position - 0x118B5
{
	int num;
	int i;
	var unk8;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_59 = -1;
			func_274(38, true);
			unk8 = unk_0x0556019E7EE8EC9A(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
		
			if (unk_0xF8A8852F99E201DD(unk8))
				unk_0xEEC112F70F9E6543(unk8);
		...
		case 1:
			if (!func_271(&num) || !unk_0xE100DD4F82A51BDE(uParam0->f_48))
				return false;
		...
		case 2:
			func_285(&uParam0->f_28[0], num[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_285(&uParam0->f_28[1], num[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			...
			func_285(&uParam0->f_28[2], num[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_285(&uParam0->f_28[3], num[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_285(&uParam0->f_28[4], num[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_285(&uParam0->f_28[5], num[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
...
void func_288(int iParam0, BOOL bParam1) // Position - 0x11E03
{
	char* str;
	int num;
	int num2;
...
BOOL func_289(int iParam0) // Position - 0x11ECA
{
	int num;
...
struct<2> func_290(int iParam0) // Position - 0x11EFB
{
	int num;
...
void func_291(int iParam0, BOOL bParam1) // Position - 0x11F28
{
	var unk;

	unk = { func_290(iParam0) };
...
char* func_292(int iParam0, var uParam1) // Position - 0x11F6B
{
	var unk;
...
struct<5> func_293(int iParam0) // Position - 0x11F90
{
	var unk;
	var unk6;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_294(&Global_4718592.f_225053[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_225053[1 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_225053[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_225053[2 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_225053[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_225053[3 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_225053[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_225053[4 /*160*/].f_16 };
			unk.f_3 = func_294(&Global_4718592.f_225053[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
var func_294(var uParam0) // Position - 0x14BF2
{
	return uParam0;
}

struct<6> func_295(int iParam0, BOOL bParam1) // Position - 0x14BFC
{
	var unk;
...
BOOL func_296(var uParam0) // Position - 0x157B2
{
	int num;
	int i;
	var unk4;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_265(&uParam0->f_35[0], iLocal_93, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
BOOL func_297(int iParam0) // Position - 0x15A53
{
	var unk;
	eCharacter character;
...
BOOL func_298(int iParam0) // Position - 0x15AA4
{
	var unk;
...
BOOL func_299(int iParam0) // Position - 0x15B5D
{
	var unk;
...
BOOL func_300(int iParam0) // Position - 0x15C1E
{
	int i;
	var unk;
	int num;
...
BOOL func_301(int iParam0, char* sParam1) // Position - 0x15CA3
{
...
BOOL func_302(int iParam0) // Position - 0x15D85
{
...
BOOL func_303(int iParam0) // Position - 0x15DB0
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_304(int iParam0) // Position - 0x15DDB
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x15E06
{
	if (func_256(iParam0))
		return false;
	else if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
...
void func_306() // Position - 0x15E3B
{
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x15E55
{
	int i;
...
BOOL func_308(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x15EBA
{
	int num;
	char* str;
...
BOOL func_309(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x15F32
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_310(var uParam0, var uParam1, BOOL bParam2) // Position - 0x15FAD
{
	char* str;
	...
	if (unk_0xC450B06E5AAA0985(uLocal_107))
		unk_0xFE54B8568B2ABD12(&uLocal_107);
	...
	switch (*uParam0)
	{
		case 43:
			if (uParam1->f_1 != -1)
				unk_0x394AFAC073E1F277(uParam1->f_1);
			break;
	}
...
void func_311(char* sParam0) // Position - 0x16097
{
...
void func_312() // Position - 0x160B6
{
	Global_21291 = 0;
	func_313();
	return;
...
void func_313() // Position - 0x160C6
{
	unk_0xC78B293A5F4EACF9();
	Global_23436 = 0;
...
int func_314(var uParam0) // Position - 0x160E7
{
	if (func_217(uParam0))
	{
		if (unk_0xE100DD4F82A51BDE(*uParam0))
...
void func_315(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1611D
{
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x1613D
{
	func_317(&(uParam0->f_41), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x1614F
{
	int i;
...
void func_318(var uParam0, BOOL bParam1) // Position - 0x1618D
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (unk_0x5B9219522937741D(*uParam0))
...
void func_319(var uParam0, BOOL bParam1) // Position - 0x161C8
{
	func_320(&(uParam0->f_35), bParam1);
	return;
}

void func_320(var uParam0, BOOL bParam1) // Position - 0x161DA
{
	int i;
...
void func_321(var uParam0) // Position - 0x16217
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_322(var uParam0, int iParam1) // Position - 0x1624F
{
	func_323(&(uParam0->f_28), iParam1);
	return;
}

void func_323(var uParam0, int iParam1) // Position - 0x16261
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_324(&uParam0->[i], 0, 1, 0);
	}

	return;
}

void func_324(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x162A2
{
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
		if (!unk_0x4FAFF4BCB7633475(*uParam0))
...
void func_325(var uParam0) // Position - 0x162F2
{
...
BOOL func_326(var uParam0, int iParam1) // Position - 0x16343
{
	if (func_136(uParam0))
...
void func_327(var uParam0) // Position - 0x16376
{
	if (unk_0x5266F1D2AEF6F73A(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[0]))
...
void func_328(int iParam0) // Position - 0x16405
{
	if (*iParam0 == -1)
		return;
...
void func_329(char* sParam0) // Position - 0x16442
{
	!unk_0xD6F9DEE4765092A9(sParam0);
	return;
}

void func_330(var uParam0) // Position - 0x16454
{
	*uParam0 = -1;
...
void func_331() // Position - 0x16487
{
...
int func_332(eCharacter echParam0) // Position - 0x164A1
{
	if (!func_36(echParam0))
