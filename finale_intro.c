...
void func_6() // Position - 0x1F6
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(playersLastVehicle))
		if (!func_129(playersLastVehicle, CHAR_FRANKLIN, 1))
			func_118(12.5881f, 545.7901f, 174.9232f, 5f, false);
	else
		func_118(12.5881f, 545.7901f, 174.9232f, 5f, false);
	...
	while (CUTSCENE::IS_CUTSCENE_PLAYING() || !flag)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(eLocal_28))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(playersLastVehicle))
				if (!func_129(playersLastVehicle, CHAR_FRANKLIN, 1) && !func_100(CHAR_FRANKLIN, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
					func_8(&eLocal_28, CHAR_FRANKLIN, -1.3389f, 544.1759f, 172.7673f, 124.3018f, true, 1);
			else if (!func_100(CHAR_FRANKLIN, 1, -1.3389f, 544.1759f, 172.7673f, -1f))
				func_8(&eLocal_28, CHAR_FRANKLIN, -1.3389f, 544.1759f, 172.7673f, 124.3018f, true, 1);
		}
...
int func_8(var uParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x4B6
{
	...
	if (func_99(echParam1))
	{
		model.f_11 = 12;
		model.f_31 = 49;
		model.f_81 = 2;
		func_98(echParam1, &model, iParam7);
		...
		if (Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/], fParam2, fParam5, false, false, false);
				...
				if (func_97(&plateText, &plateIndex))
				{
				...
				func_87(uParam0, &(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/], fParam2, fParam5, false, false, false);
				...
				func_87(uParam0, &(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(model))
			{
				...
				*uParam0 = VEHICLE::CREATE_VEHICLE(model, fParam2, fParam5, true, true, false);
				...
				func_87(uParam0, &(model.f_31), &(model.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_9(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x12D9
{
	...
	if (func_99(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_13(uParam1, &(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114162.f_20122[echParam0 /*43*/].f_31 = func_12(*uParam1);
				...
				func_10(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114162.f_20122[echParam0 /*43*/].f_1));
				...
				func_10(Global_114162.f_2367.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114162.f_20122[echParam0 /*43*/].f_2));
			}
		}
	}
...
BOOL func_14(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x36C6
{
	...
	*uParam2 = 0;
	...
	if (!func_58(entityModel, bParam1, uParam2) && !func_57(PLAYER::PLAYER_ID()) && !func_30(veParam0))
		return false;
	...
	if (func_26(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(entityModel) || VEHICLE::IS_THIS_MODEL_A_PLANE(entityModel))
		flag = true;

	if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_23(veParam0) && !flag && !(func_22(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_21(PLAYER::PLAYER_ID())) && !(func_20(ENTITY::GET_ENTITY_MODEL(veParam0)) && func_16(PLAYER::PLAYER_ID())))
	{
...
BOOL func_15(Vehicle veParam0) // Position - 0x3851
{
	int i;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 32;
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3E08
{
	Player player;
...
Player _INVALID_PLAYER_INDEX() // Position - 0x3E68
{
	return -1;
}

BOOL func_20(Hash hParam0) // Position - 0x3E71
{
...
BOOL func_21(Player plParam0) // Position - 0x3E88
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 11;

	return false;
}

BOOL func_22(Hash hParam0) // Position - 0x3ECF
{
...
BOOL func_23(Vehicle veParam0) // Position - 0x3F11
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_24(Player plParam0) // Position - 0x3FD9
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 26;

	return false;
}

BOOL func_25(Player plParam0) // Position - 0x4022
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 13;

	return false;
}

BOOL func_26(Player plParam0) // Position - 0x4069
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 7;

	return false;
}

BOOL func_27(Hash hParam0) // Position - 0x40AF
{
	BOOL flag;
	...
	if (!func_29(PLAYER::PLAYER_ID()) && hParam0 != joaat("thruster") && hParam0 != joaat("avenger") && hParam0 != func_28(true) && !flag)
		return false;

	return true;
}

Hash func_28(BOOL bParam0) // Position - 0x4140
{
	if (bParam0)
...
BOOL func_29(Player plParam0) // Position - 0x415A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_30(Vehicle veParam0) // Position - 0x4180
{
...
BOOL func_31(Vehicle veParam0) // Position - 0x41AF
{
	...
	if (func_35(veParam0, false))
		return true;

	if (func_34(PLAYER::PLAYER_ID()) && !func_27(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel1")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("openwheel2")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula")) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("formula2")))
		return false;
...
BOOL func_32(Vehicle veParam0) // Position - 0x4317
{
	Hash entityModel;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_23(veParam0) || func_33(entityModel))
			return true;
...
BOOL func_33(Hash hParam0) // Position - 0x4394
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_34(Player plParam0) // Position - 0x43F0
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_57(plParam0) && Global_2657994[plParam0 /*467*/].f_324.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_35(Vehicle veParam0, BOOL bParam1) // Position - 0x4429
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_37(ENTITY::GET_ENTITY_MODEL(veParam0), 0))
				if (Global_2739945.f_307 == veParam0)
					return true;
				else if (func_36(veParam0) != -1 && !bParam1)
					return true;
			break;
	}
...
int func_36(Vehicle veParam0) // Position - 0x4484
{
	int i;
...
BOOL func_37(Hash hParam0, int iParam1) // Position - 0x44BD
{
	if (iParam1 == 0)
...
BOOL func_47(Vehicle veParam0) // Position - 0x4DA3
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_51(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > 0 || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
...
BOOL func_48(Vehicle veParam0) // Position - 0x4E9C
{
...
int func_49() // Position - 0x4EB5
{
	return Global_2359296[func_50() /*5571*/].f_681.f_2;
}

int func_50() // Position - 0x4ECD
{
	int num;
...
BOOL func_51(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4EDA
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_52(Player plParam0) // Position - 0x4F3E
{
...
BOOL func_53() // Position - 0x4F6F
{
	return func_54() != -1;
}

int func_54() // Position - 0x4F7D
{
	return Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

BOOL func_55(Player plParam0) // Position - 0x4F95
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 5;

	return false;
}

BOOL func_56(Player plParam0) // Position - 0x4FF4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1 && Global_2657994[plParam0 /*467*/].f_324.f_11 != _INVALID_PLAYER_INDEX())
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 8;

	return false;
}

BOOL func_57(Player plParam0) // Position - 0x5054
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657994[plParam0 /*467*/].f_324.f_8 != -1)
				return func_17(Global_2657994[plParam0 /*467*/].f_324.f_8) == 9;

	return false;
}

BOOL func_58(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x509B
{
	BOOL flag;
	...
	if (func_26(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(hParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(hParam0))
		flag = true;
...
BOOL func_59(Hash hParam0) // Position - 0x548C
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
void func_60(Vehicle veParam0, eCharacter echParam1) // Position - 0x54C1
{
	...
	func_61(veParam0, &(Global_114162.f_32754.f_5510));
	return;
}

void func_61(Vehicle veParam0, var uParam1) // Position - 0x56C3
{
	int i;
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_62(i + 1));
		}
...
int func_62(int iParam0) // Position - 0x596E
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_63(int iParam0) // Position - 0x5A1E
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_64(var uParam0) // Position - 0x5A3E
{
	int i;
...
BOOL func_65(Vehicle veParam0) // Position - 0x5AEF
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_82(veParam0, CHAR_MICHAEL, false) || func_82(veParam0, CHAR_FRANKLIN, false) || func_82(veParam0, CHAR_TREVOR, false) || func_81(veParam0) != _CHAR_NULL || func_80(veParam0) || func_79(veParam0) || func_15(veParam0) || func_78(veParam0) || !func_66(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_79(veParam0);
		func_79(veParam0);
		func_82(veParam0, CHAR_MICHAEL, false);
		func_82(veParam0, CHAR_FRANKLIN, false);
		func_82(veParam0, CHAR_TREVOR, false);
		func_81(veParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_66(Hash hParam0) // Position - 0x5BCC
{
	if (hParam0 == 0)
		return false;

	if (!func_67(hParam0, false, -1))
		return false;
...
BOOL func_67(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x5D8A
{
	int i;
	Hash outData;
...
BOOL func_68(Hash hParam0) // Position - 0x5F0F
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x5FDB
{
...
BOOL func_70(Hash hParam0, int iParam1) // Position - 0x5FF2
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x621F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x6235
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_73() // Position - 0x624B
{
	return false;
}

BOOL func_74() // Position - 0x6254
{
	return true;
}

BOOL func_75() // Position - 0x625D
{
	return true;
}

BOOL func_76() // Position - 0x6266
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x627F
{
	int profileSetting;
...
BOOL func_78(Vehicle veParam0) // Position - 0x6337
{
	Hash entityModel;
	...
	if (!func_67(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_79(Vehicle veParam0) // Position - 0x637E
{
	int i;
...
BOOL func_80(Vehicle veParam0) // Position - 0x63FA
{
	int i;
...
eCharacter func_81(Vehicle veParam0) // Position - 0x64E2
{
	int i;
...
BOOL func_82(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x6545
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_83(echParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_83(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x65B3
{
...
void func_84(Vehicle veParam0, eCharacter echParam1) // Position - 0x668C
{
	int i;
...
void func_85(var uParam0) // Position - 0x670E
{
	if (!func_86(*uParam0))
...
BOOL func_86(Vehicle veParam0) // Position - 0x6739
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_87(var uParam0, var uParam1, var uParam2) // Position - 0x6748
{
	int i;
	int modType;
...
BOOL func_88(Vehicle veParam0) // Position - 0x6946
{
	int i;
	int modType;
	Hash hashKey;
...
void func_89(var uParam0) // Position - 0x6A22
{
...
int func_90(Vehicle veParam0, int iParam1) // Position - 0x6A8D
{
	int value;
	int value2;
	float num;
...
int func_91(Vehicle veParam0, int iParam1) // Position - 0x6B76
{
	int i;
...
BOOL func_92(Hash hParam0) // Position - 0x6BD8
{
	if (func_46(hParam0, 1))
		return true;
...
BOOL func_93(Vehicle veParam0) // Position - 0x6C03
{
	Hash entityModel;
...
BOOL func_94(Hash hParam0) // Position - 0x6C49
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_95(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x6CF3
{
...
BOOL func_96() // Position - 0x6D17
{
	return true;
}

BOOL func_97(var uParam0, var uParam1) // Position - 0x6D24
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_98(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x6D65
{
	int num;
...
BOOL func_99(eCharacter echParam0) // Position - 0x6FC1
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_100(eCharacter echParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x6FCD
{
	int i;
	Hash hash;
	Hash hash2;

	if (!func_99(echParam0))
		return false;
	...
	hash.f_81 = 2;
	hash2 = 0;
	func_98(echParam0, &hash, iParam1);
	hash2 = hash;
		...
		for (i = 0; i < 9; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_99019[i]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_99019[i], false))
				if (ENTITY::GET_ENTITY_MODEL(Global_99019[i]) == hash2 && Global_99029[i] == echParam0)
					if (fParam5 == -1f || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_99019[i], false), fParam2, true) <= fParam5)
						return true;
		}
	}
...
void func_101(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0x7092
{
	func_102(fParam0, fParam3, fParam6, fParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
	return;
}

void func_102(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x70BB
{
	Vehicle playersLastVehicle;
	BOOL flag;
	BOOL flag2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
		{
			...
			else
			{
				...
				if (entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)
					if (func_110(playersLastVehicle, vParam0, vParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_82(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74B1
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x74DB
{
	func_105();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_105() // Position - 0x74F4
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114162.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_99(character) && !func_106(14) || Global_113110)
			{
				if (Global_114162.f_2367.f_539.f_4321 != character && func_99(Global_114162.f_2367.f_539.f_4321))
...
BOOL func_106(int iParam0) // Position - 0x75F1
{
	return Global_44199 == iParam0;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x75FF
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x763C
{
...
Hash func_109(eCharacter echParam0) // Position - 0x7661
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_110(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x7670
{
	float num;
	var unk3;
	var unk6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_111(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk9) || func_111(unk18[0 /*3*/], unk18[1 /*3*/], unk9, unk15) || func_111(unk18[0 /*3*/], unk18[1 /*3*/], unk12, unk15) || func_111(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk12) || func_111(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk9) || func_111(unk18[1 /*3*/], unk18[3 /*3*/], unk9, unk15) || func_111(unk18[1 /*3*/], unk18[3 /*3*/], unk12, unk15) || func_111(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk12) || func_111(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk9) || func_111(unk18[3 /*3*/], unk18[2 /*3*/], unk9, unk15) || func_111(unk18[3 /*3*/], unk18[2 /*3*/], unk12, unk15) || func_111(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk12) || func_111(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk9) || func_111(unk18[2 /*3*/], unk18[0 /*3*/], unk9, unk15) || func_111(unk18[2 /*3*/], unk18[0 /*3*/], unk12, unk15) || func_111(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk12))
			return true;
	}
...
BOOL func_111(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x7966
{
	float num;
	float num2;
	float num3;
...
Vector3 func_112(float fParam0, var uParam1, var uParam2) // Position - 0x7A1A
{
	float num;
	float num2;
...
void func_113(Vehicle veParam0) // Position - 0x7A59
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
void func_114(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x7ABE
{
	func_102(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

BOOL func_115(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7AE8
{
	return func_116(Global_104723.f_2890.f_12.f_66, uParam0, iParam3);
}

BOOL func_116(Hash hParam0, float fParam1, var uParam2, var uParam3, int iParam4) // Position - 0x7B05
{
	var minimum;
	float maximum;
...
Vector3 func_117() // Position - 0x7B6F
{
	return 2.55f, 5.665f, 2.55f;
}

void func_118(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x7B86
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_126(&Global_78354.f_555[0 /*21*/], i))
...
void func_119(int iParam0) // Position - 0x7BD6
{
	BOOL flag;
	...
	if (func_126(&Global_78354.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_125(iParam0, 0) && Global_79263.f_66 == 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] != 0 && Global_114162.f_32754.f_1958[Global_78354.f_555[0 /*21*/].f_14] > 3 && !func_123(0, Global_78354.f_555[0 /*21*/].f_12) || !func_123(1, Global_78354.f_555[0 /*21*/].f_12))
			{
				func_122(&Global_114162.f_32754.f_69[Global_78354.f_555[0 /*21*/].f_14 /*78*/], &Global_79263);
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x7D45
{
	if (iParam0 == -1)
		return;
...
void func_121(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7DA2
{
	if (iParam0 == -1)
		return;
...
void func_122(var uParam0, var uParam1) // Position - 0x7DDD
{
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x7EA9
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_124(&Global_114162.f_32754.f_5038[num /*157*/]))
		return false;

	return func_67(Global_114162.f_32754.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_124(var uParam0) // Position - 0x7F1C
{
	return *uParam0;
}

BOOL func_125(int iParam0, int iParam1) // Position - 0x7F27
{
	if (iParam0 == -1)
		return false;
...
BOOL func_126(var uParam0, int iParam1) // Position - 0x7F47
{
	BOOL num;
	int num2;
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_128(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_128(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_128(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_128(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
...
Hash func_128(eCharacter echParam0, int iParam1) // Position - 0x96E3
{
	Hash num;
...
BOOL func_129(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x9725
{
	int i;
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_99019[i]))
			if (Global_99019[i] == veParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_99029[i])
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(veParam0) == func_128(echParam1, iParam2))
						return true;
	}
...
void func_130() // Position - 0x97B3
{
	...
	while (!CUTSCENE::HAS_CUTSCENE_LOADED())
	{
		...
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			func_131("FRANKLIN", PLAYER::PLAYER_PED_ID(), 0, 2);
...
void func_131(char* sParam0, Ped pedParam1, Hash hParam2, int iParam3) // Position - 0x97F3
{
	var unk;
	int i;
	...
	unk.f_39 = 9;
	unk.f_49 = 9;
	func_132(pedParam1, &unk, iParam3);
...
void func_132(Ped pedParam0, var uParam1, int iParam2) // Position - 0x98AE
{
	int i;
	var unk;
	var unk2;
	...
	unk2.f_49 = 9;
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	func_217(pedParam0, &unk2, 0, -1);
	func_217(pedParam0, uParam1, iParam2, -1);
	num = 0;
	num2 = 0;
	...
	for (i = 0; i < 12; i = i + 1)
	{
		...
		{
			if (func_214(entityModel, func_216(i), func_215(pedParam0, unk2.f_13[i], unk2[i], func_216(i)), &unk))
			{
				unk67 = { func_144(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
				num = 1;
			}
		
			if (func_142(entityModel, func_216(i), func_215(pedParam0, unk2.f_13[i], unk2[i], func_216(i)), &unk))
			{
				unk67 = { func_144(entityModel, 1, uParam1->f_62, -1) };
	...
	for (i = 0; i < 9; i = i + 1)
	{
		...
		{
			if (func_214(entityModel, 14, func_134(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_144(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
			...
			if (func_142(entityModel, 14, func_134(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_144(entityModel, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = unk67.f_3;
				uParam1->[1] = unk67.f_4;
	...
	if (num2 || num)
	{
		num3 = func_215(pedParam0, uParam1->f_13[1], uParam1->[1], 1);
		num4 = func_215(pedParam0, uParam1->f_13[2], uParam1->[2], 2);
		num5 = func_133(entityModel, num4, num3);
	
		if (num5 != -99)
		{
			unk67 = { func_144(entityModel, 0, num5, -1) };
...
int func_133(Hash hParam0, int iParam1, int iParam2) // Position - 0x9B23
{
	switch (hParam0)
	{
...
int func_134(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9C7A
{
	Hash entityModel;
	...
	for (i = 0; i <= numberOfPedPropDrawableVariations - 1; i = i + 1)
	{
		...
		else
		{
			for (j = 0; j <= numberOfPedPropTextureVariations - 1; j = j + 1)
			{
				...
				{
					num = num + func_135(pedParam0, iParam3);
					return num;
				}
				else
				{
...
int func_135(Ped pedParam0, int iParam1) // Position - 0x9D76
{
	Hash entityModel;
...
int func_136(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9EB4
{
	var outfit;
	int i;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		if (shopPedQueryPropIndex != -1)
			return func_139(hParam0) + shopPedQueryPropIndex;
	}
	else
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_138(iParam2));
		shopPedQueryComponentIndex = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(hParam1);
	
		if (shopPedQueryComponentIndex != -1)
			return func_137(hParam0, func_138(iParam2)) + shopPedQueryComponentIndex;
	}

	return -99;
}

int func_137(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9F6F
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_138(int iParam0) // Position - 0xA316
{
	switch (iParam0)
	{
		case 0:
...
int func_139(Hash hParam0) // Position - 0xA3C6
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_140(Hash hParam0) // Position - 0xA427
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_142(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xA50C
{
	int num;
...
int func_143(Hash hParam0) // Position - 0xA796
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_144(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA7D1
{
	func_213();
...
void func_146(int iParam0) // Position - 0xA913
{
	...
	switch (iParam0)
	{
		...
		default:
			func_159(num6, iParam0, 155, -1);
			return;
	}

	func_147(&Global_79347[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_150(func_154(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_150(func_149(iParam1, iParam0->f_2), Global_79344);
			...
			{
				num = func_150(num2, Global_79344);
...
Hash func_151(int iParam0, int iParam1) // Position - 0xC75C
{
...
BOOL func_156(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xDA4F
{
	int num;
	int num2;
	int num3;
	...
	if (func_157(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
		num4 = func_150(num3, num);
...
BOOL func_157(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xDA8D
{
...
int func_158(int iParam0) // Position - 0x10740
{
	switch (iParam0)
	{
		case -1:
...
void func_159(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10814
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_147(&Global_79347[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_147(&Global_79347[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_147(&Global_79347[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79545)
		{
			...
			func_147(&Global_79347[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_138(iParam0));
...
void func_160(int iParam0) // Position - 0x10A9B
{
	BOOL flag;
	int num;
	var unk;
...
void func_161(int iParam0) // Position - 0x10BF2
{
	BOOL flag;
	int num;
	var unk;
...
void func_162(int iParam0) // Position - 0x11100
{
	BOOL flag;
	int num;
	var unk;
...
void func_163(int iParam0) // Position - 0x11175
{
	BOOL flag;
	int num;
	var unk;
...
void func_164(int iParam0) // Position - 0x111E9
{
	BOOL flag;
	int num;
	var unk;
...
void func_165(int iParam0) // Position - 0x112D0
{
	BOOL flag;
	int num;
	var unk;
...
void func_166(int iParam0) // Position - 0x11633
{
	BOOL flag;
	int num;
	var unk;
...
void func_167(int iParam0) // Position - 0x11844
{
	BOOL flag;
	int num;
	var unk;
...
void func_168(int iParam0) // Position - 0x11A74
{
	BOOL flag;
	int num;
	var unk;
...
void func_169(int iParam0) // Position - 0x11B84
{
	BOOL flag;
	int num;
	var unk;
...
void func_170(int iParam0) // Position - 0x12523
{
	BOOL flag;
	int num;
	var unk;
...
void func_171(int iParam0) // Position - 0x13096
{
	if (iParam0 < 136)
		func_173(iParam0);
	else
...
void func_172(int iParam0) // Position - 0x130CB
{
	BOOL flag;
	int num;
	var unk;
...
void func_173(int iParam0) // Position - 0x13CCF
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_214(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x21FBC
{
	int num;
...
int func_215(Ped pedParam0, int iParam1, var uParam2, int iParam3) // Position - 0x222C3
{
...
void func_217(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x223CA
{
	eCharacter character;
	ePedComponentType i;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			func_221(pedParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = PV_COMP_HEAD; i < PV_COMP_TASK; i = i + 1)
		{
			func_220(pedParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
BOOL func_218(int iParam0, int iParam1) // Position - 0x22564
{
	...
	statHash = func_219(iParam0, iParam1);
...
Hash func_219(int iParam0, int iParam1) // Position - 0x22588
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_152(iParam1));
}

void func_220(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x2259D
{
	eCharacter character;
...
void func_221(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x22AE6
{
	eCharacter character;
...
BOOL func_226(int iParam0) // Position - 0x22EFB
{
	...
	func_227(&(Global_114162.f_2367.f_539), num2);
...
void func_227(var uParam0, int iParam1) // Position - 0x2300B
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_229(Global_114162.f_18537[i], &unk, &num2))
			{
				Global_114162.f_18537[i] = 318;
				func_228(&uParam0->f_2296[i]);
