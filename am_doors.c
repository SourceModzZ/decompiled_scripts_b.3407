	...
	while (true)
	{
		...
		if (unk_0xF859473E4AD09F30())
			if (unk_0x69617275A0B1B72D(unk_0x259BE71D8A81D4FA()) == 32)
				if (uScriptParam_0.f_16 != 50 + unk_0x259BE71D8A81D4FA())
					func_36(2);
			else if (uScriptParam_0.f_16 != unk_0x69617275A0B1B72D(unk_0x259BE71D8A81D4FA()))
				func_36(2);
		...
		switch (func_34(unk_0xAE032CEDCF23C6D5()))
		{
			case 0:
				...
				if (!Global_39540 && func_33() != -1 && func_33() != 999)
				{
					if (!bLocal_143)
					{
						if (func_32(&iLocal_148, iLocal_147))
						{
							bLocal_143 = true;
							iLocal_148 = 0;
						}
					...
					else if (!bLocal_145)
					{
						if (!bLocal_144)
						{
							if (func_30(&iLocal_148, iLocal_147))
							{
								iLocal_148 = 0;
								bLocal_144 = true;
							}
						}
						else if (func_28(&iLocal_148, iLocal_147))
						{
							iLocal_148 = 0;
							bLocal_145 = true;
						}
...
void func_1() // Position - 0x24E
{
	...
	for (iLocal_202 = 0; iLocal_202 < 3; iLocal_202 = iLocal_202 + 1)
	{
		if (_NETWORK_IS_PLAYER_VALID(unk_0xB23E0F9B63D009A8(iLocal_201), false, true))
		{
			if (IS_BIT_SET(uLocal_239[iLocal_201 /*4*/].f_2, iLocal_202))
				unk_0x0B0C9A0F9AAEB7F0(&iLocal_204.f_2[iLocal_202], iLocal_201);
			else
				unk_0x8744D2E3FC95740E(&iLocal_204.f_2[iLocal_202], iLocal_201);
		}
		else
		{
			unk_0x8744D2E3FC95740E(&iLocal_204.f_6[iLocal_202], iLocal_201);
			unk_0x8744D2E3FC95740E(&iLocal_204.f_6[iLocal_202], iLocal_201);
		}
	
		if (iLocal_204.f_6[iLocal_202] != 0)
		{
			if (uLocal_149[iLocal_202 /*17*/][0] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][0], 5);
		
			if (uLocal_149[iLocal_202 /*17*/][1] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][1], 5);
		}
		else if (iLocal_204.f_2[iLocal_202] != 0)
		{
			if (uLocal_149[iLocal_202 /*17*/][0] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][0], 0);
		
			if (uLocal_149[iLocal_202 /*17*/][1] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][1], 0);
		}
		else
		{
			if (uLocal_149[iLocal_202 /*17*/][0] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][0], 1);
		
			if (uLocal_149[iLocal_202 /*17*/][1] != 0)
				func_2(iLocal_202, uLocal_149[iLocal_202 /*17*/][1], 1);
		}
	}
...
void func_2(int iParam0, var uParam1, int iParam2) // Position - 0x3A2
{
	int num;
	...
	if (uLocal_228[iParam0] == 0)
	{
		if (unk_0xE2A2194077783E19(uParam1) == -1)
		{
			if (unk_0x117BCCA03F7A311A(uParam1) != iParam2)
			{
				...
				{
					unk_0x0B0C9A0F9AAEB7F0(&uLocal_228[iParam0], num);
					unk_0xEBB2809684978887(uParam1, iParam2, 1, 1);
					_STOPWATCH_RESET(&uLocal_232[iParam0 /*2*/], true, false);
				}
				else
				{
	...
	if (_STOPWATCH_IS_INITIALIZED(&uLocal_232[iParam0 /*2*/]))
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_232[iParam0 /*2*/], 1000, true))
		{
			_STOPWATCH_DESTROY(&uLocal_232[iParam0 /*2*/]);
			uLocal_228[iParam0] = 0;
		}
	}
...
BOOL _NETWORK_IS_PLAYER_VALID(int player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x538
{
	int num;
...
void func_9() // Position - 0x5A4
{
	...
	{
		if (IS_BIT_SET(Global_2749845, iLocal_203))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
	
		if (IS_BIT_SET(Global_2749845.f_1, iLocal_203))
			unk_0x8744D2E3FC95740E(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
	
		if (IS_BIT_SET(Global_2749845.f_2, iLocal_203))
			unk_0x0B0C9A0F9AAEB7F0(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_3), iLocal_203);
	}
	else if (num <= 20f)
	{
		if (unk_0x26715B0ED6702C87(vector, uLocal_149[iLocal_203 /*17*/].f_3, uLocal_149[iLocal_203 /*17*/].f_6, uLocal_149[iLocal_203 /*17*/].f_9, 0, 1))
			if (!IS_BIT_SET(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_203))
				unk_0x0B0C9A0F9AAEB7F0(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
	
		if (iLocal_203 == 0 || iLocal_203 == 1 || iLocal_203 == 2)
			if (_GET_ACTIVE_PV_SLOT() >= 0)
				if (func_10(29))
					if (!IS_BIT_SET(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_203))
						unk_0x0B0C9A0F9AAEB7F0(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
				else if (IS_BIT_SET(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_203) && !unk_0x26715B0ED6702C87(vector, uLocal_149[iLocal_203 /*17*/].f_3, uLocal_149[iLocal_203 /*17*/].f_6, uLocal_149[iLocal_203 /*17*/].f_9, 0, 1))
					unk_0x8744D2E3FC95740E(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
	}
	else if (IS_BIT_SET(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2, iLocal_203))
	{
		unk_0x8744D2E3FC95740E(&(uLocal_239[unk_0x259BE71D8A81D4FA() /*4*/].f_2), iLocal_203);
	}
...
Vector3 _GET_PLAYER_COORDS(var uParam0) // Position - 0x7EA
{
...
void func_14() // Position - 0x7FD
{
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		if (unk_0xED977E2AE2CB16EE(_GET_PLAYER_COORDS(unk_0x259BE71D8A81D4FA()), unk.f_1, 1) < 150f)
		{
			flag = false;
		
			for (j = 0; j < 32; j = j + 1)
			{
				player = unk_0xB23E0F9B63D009A8(j);
			
				if (_NETWORK_IS_PLAYER_VALID(player, true, true))
				{
					if (func_15(player) && unk_0x5105BE70DEF1F5FB(unk_0x56E414973C2A8C0E(player), unk.f_4[0 /*3*/], unk.f_4[1 /*3*/], unk.f_11, 0, 1, 0))
					{
						flag = true;
						j = 32;
					}
			...
			if (flag)
			{
				if (uLocal_368[i] != 1f)
				{
					uLocal_368[i] = uLocal_368[i] + (unk.f_12 * SYSTEM::TIMESTEP());
				
					if (uLocal_368[i] > 1f)
						uLocal_368[i] = 1f;
				
					unk_0x60F1DCFB89B4F353(unk, 1);
					unk_0x3A15B21067339E98(unk, uLocal_368[i], 0, 0);
...
int func_15(Player plParam0) // Position - 0x95B
{
	int num;
	Player player;
	int num2;
...
void func_31(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15) // Position - 0x5796
{
	if (iParam0 != 0)
	{
		unk_0xB80B2E08713B8BC6(iParam0, iParam0.f_2, iParam0.f_3, 0, iParam15, iParam0.f_11, 0);
	
		if (iParam0.f_9)
			unk_0x0EBFE569715DB18F(iParam0, 1);
	
		if (iParam0.f_12 != 0f)
			unk_0x3A15B21067339E98(iParam0, iParam0.f_12, 0, iParam15);
	
		if (!iParam0.f_6)
			if (iParam0.f_7)
				unk_0xEBB2809684978887(iParam0, iParam0.f_8, iParam15, 0);
	
		if (iParam0.f_10)
			unk_0xB80A7611D19E162B(iParam0, 1);
	
		if (iParam0.f_14 != 0f)
			unk_0xDD0EDCD573B965E2(iParam0, iParam0.f_14, iParam15, 0);
	
		if (iParam0.f_13 != 0f)
			unk_0x57A602C0620BEFF2(iParam0, iParam0.f_13, iParam15, 0);
	}
...
{
	uLocal_239[unk_0xAE032CEDCF23C6D5() /*4*/] = iParam0;
	return;
}
...
BOOL func_40(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x5A25
{
	...
	unk_0x6F4A865F87C7A3AD(&iLocal_204, 24, 0);
	unk_0x7B13DC83218D9AF5(&uLocal_239, 129, 0);
...
void func_52(int iParam0) // Position - 0x6E81
{
	...
	for (i = 0; i < 315; i = i + 1)
	{
		unk = { func_29(i, iParam0) };
	
		if (unk.f_1 == 99 || unk.f_1 == iParam0)
			if (unk_0x116053132936EA1F(unk))
				if (unk.f_11)
					unk_0x19B3B7AC049E8354(unk, 0);
	}
...
int _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x6F5C
{
	switch (func_33())
	{
		case 0:
